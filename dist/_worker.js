var Js=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var ea=(e,t,s)=>t in e?Js(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var N=(e,t,s)=>ea(e,typeof t!="symbol"?t+"":t,s),Mt=(e,t,s)=>t.has(e)||Vt("Cannot "+s);var h=(e,t,s)=>(Mt(e,t,"read from private field"),s?s.call(e):t.get(e)),P=(e,t,s)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),$=(e,t,s,a)=>(Mt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),q=(e,t,s)=>(Mt(e,t,"access private method"),s);var Gt=(e,t,s,a)=>({set _(n){$(e,t,n,s)},get _(){return h(e,t,a)}});var qt=(e,t,s)=>(a,n)=>{let r=-1;return i(0);async function i(l){if(l<=r)throw new Error("next() called multiple times");r=l;let o,c=!1,d;if(e[l]?(d=e[l][0][0],a.req.routeIndex=l):d=l===e.length&&n||void 0,d)try{o=await d(a,()=>i(l+1))}catch(u){if(u instanceof Error&&t)a.error=u,o=await t(u,a),c=!0;else throw u}else a.finalized===!1&&s&&(o=await s(a));return o&&(a.finalized===!1||c)&&(a.res=o),a}},ta=Symbol(),sa=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,r=(e instanceof ps?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?aa(e,{all:s,dot:a}):{}};async function aa(e,t){const s=await e.formData();return s?na(s,t):{}}function na(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?ra(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(ia(s,a,n),delete s[a])}),s}var ra=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},ia=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((r,i)=>{i===n.length-1?a[r]=s:((!a[r]||typeof a[r]!="object"||Array.isArray(a[r])||a[r]instanceof File)&&(a[r]=Object.create(null)),a=a[r])})},os=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},oa=e=>{const{groups:t,path:s}=la(e),a=os(s);return ca(a,t)},la=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},ca=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},Et={},da=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return Et[a]||(s[2]?Et[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Et[a]=[e,s[1],!0]),Et[a]}return null},Ht=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},ua=e=>Ht(e,decodeURI),ls=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const r=t.indexOf("?",a),i=t.slice(s,r===-1?void 0:r);return ua(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(n===63)break}return t.slice(s,a)},pa=e=>{const t=ls(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ge=(e,t,...s)=>(s.length&&(t=Ge(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),cs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const r=n.replace("?","");a+="/"+r,s.push(a)}else a+="/"+n}),s.filter((n,r,i)=>i.indexOf(n)===r)},Nt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ht(e,us):e):e,ds=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const l=e.charCodeAt(i+t.length+1);if(l===61){const o=i+t.length+2,c=e.indexOf("&",o);return Nt(e.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";i=e.indexOf(`&${t}`,i+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const i=e.indexOf("&",r+1);let l=e.indexOf("=",r);l>i&&i!==-1&&(l=-1);let o=e.slice(r+1,l===-1?i===-1?void 0:i:l);if(a&&(o=Nt(o)),r=i,o==="")continue;let c;l===-1?c="":(c=e.slice(l+1,i===-1?void 0:i),a&&(c=Nt(c))),s?(n[o]&&Array.isArray(n[o])||(n[o]=[]),n[o].push(c)):n[o]??(n[o]=c)}return t?n[t]:n},ma=ds,ga=(e,t)=>ds(e,t,!0),us=decodeURIComponent,zt=e=>Ht(e,us),Xe,ue,we,ms,gs,Pt,ke,ts,ps=(ts=class{constructor(e,t="/",s=[[]]){P(this,we);N(this,"raw");P(this,Xe);P(this,ue);N(this,"routeIndex",0);N(this,"path");N(this,"bodyCache",{});P(this,ke,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(r=>(n==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,$(this,ue,s),$(this,Xe,{})}param(e){return e?q(this,we,ms).call(this,e):q(this,we,gs).call(this)}query(e){return ma(this.url,e)}queries(e){return ga(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await sa(this,e))}json(){return h(this,ke).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,ke).call(this,"text")}arrayBuffer(){return h(this,ke).call(this,"arrayBuffer")}blob(){return h(this,ke).call(this,"blob")}formData(){return h(this,ke).call(this,"formData")}addValidatedData(e,t){h(this,Xe)[e]=t}valid(e){return h(this,Xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[ta](){return h(this,ue)}get matchedRoutes(){return h(this,ue)[0].map(([[,e]])=>e)}get routePath(){return h(this,ue)[0].map(([[,e]])=>e)[this.routeIndex].path}},Xe=new WeakMap,ue=new WeakMap,we=new WeakSet,ms=function(e){const t=h(this,ue)[0][this.routeIndex][1][e],s=q(this,we,Pt).call(this,t);return s&&/\%/.test(s)?zt(s):s},gs=function(){const e={},t=Object.keys(h(this,ue)[0][this.routeIndex][1]);for(const s of t){const a=q(this,we,Pt).call(this,h(this,ue)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?zt(a):a)}return e},Pt=function(e){return h(this,ue)[1]?h(this,ue)[1][e]:e},ke=new WeakMap,ts),fa={Stringify:1},fs=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(n?n[0]+=e:n=[e],Promise.all(r.map(l=>l({phase:t,buffer:n,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(o=>fs(o,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},_a="text/plain; charset=UTF-8",Ft=(e,t)=>({"Content-Type":e,...t}),ct,dt,ye,Ke,be,de,ut,Ze,Qe,Oe,pt,mt,Le,qe,ss,ha=(ss=class{constructor(e,t){P(this,Le);P(this,ct);P(this,dt);N(this,"env",{});P(this,ye);N(this,"finalized",!1);N(this,"error");P(this,Ke);P(this,be);P(this,de);P(this,ut);P(this,Ze);P(this,Qe);P(this,Oe);P(this,pt);P(this,mt);N(this,"render",(...e)=>(h(this,Ze)??$(this,Ze,t=>this.html(t)),h(this,Ze).call(this,...e)));N(this,"setLayout",e=>$(this,ut,e));N(this,"getLayout",()=>h(this,ut));N(this,"setRenderer",e=>{$(this,Ze,e)});N(this,"header",(e,t,s)=>{this.finalized&&$(this,de,new Response(h(this,de).body,h(this,de)));const a=h(this,de)?h(this,de).headers:h(this,Oe)??$(this,Oe,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});N(this,"status",e=>{$(this,Ke,e)});N(this,"set",(e,t)=>{h(this,ye)??$(this,ye,new Map),h(this,ye).set(e,t)});N(this,"get",e=>h(this,ye)?h(this,ye).get(e):void 0);N(this,"newResponse",(...e)=>q(this,Le,qe).call(this,...e));N(this,"body",(e,t,s)=>q(this,Le,qe).call(this,e,t,s));N(this,"text",(e,t,s)=>!h(this,Oe)&&!h(this,Ke)&&!t&&!s&&!this.finalized?new Response(e):q(this,Le,qe).call(this,e,t,Ft(_a,s)));N(this,"json",(e,t,s)=>q(this,Le,qe).call(this,JSON.stringify(e),t,Ft("application/json",s)));N(this,"html",(e,t,s)=>{const a=n=>q(this,Le,qe).call(this,n,t,Ft("text/html; charset=UTF-8",s));return typeof e=="object"?fs(e,fa.Stringify,!1,{}).then(a):a(e)});N(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});N(this,"notFound",()=>(h(this,Qe)??$(this,Qe,()=>new Response),h(this,Qe).call(this,this)));$(this,ct,e),t&&($(this,be,t.executionCtx),this.env=t.env,$(this,Qe,t.notFoundHandler),$(this,mt,t.path),$(this,pt,t.matchResult))}get req(){return h(this,dt)??$(this,dt,new ps(h(this,ct),h(this,mt),h(this,pt))),h(this,dt)}get event(){if(h(this,be)&&"respondWith"in h(this,be))return h(this,be);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,be))return h(this,be);throw Error("This context has no ExecutionContext")}get res(){return h(this,de)||$(this,de,new Response(null,{headers:h(this,Oe)??$(this,Oe,new Headers)}))}set res(e){if(h(this,de)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,de).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=h(this,de).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}$(this,de,e),this.finalized=!0}get var(){return h(this,ye)?Object.fromEntries(h(this,ye)):{}}},ct=new WeakMap,dt=new WeakMap,ye=new WeakMap,Ke=new WeakMap,be=new WeakMap,de=new WeakMap,ut=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,Oe=new WeakMap,pt=new WeakMap,mt=new WeakMap,Le=new WeakSet,qe=function(e,t,s){const a=h(this,de)?new Headers(h(this,de).headers):h(this,Oe)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,l]of r)i.toLowerCase()==="set-cookie"?a.append(i,l):a.set(i,l)}if(s)for(const[r,i]of Object.entries(s))if(typeof i=="string")a.set(r,i);else{a.delete(r);for(const l of i)a.append(r,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ke);return new Response(e,{status:n,headers:a})},ss),te="ALL",ya="all",ba=["get","post","put","delete","options","patch"],_s="Can not add a route since the matcher is already built.",hs=class extends Error{},Ea="__COMPOSED_HANDLER",va=e=>e.text("404 Not Found",404),Xt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,se,ys,me,Me,vt,wt,Je,wa=(Je=class{constructor(t={}){P(this,se);N(this,"get");N(this,"post");N(this,"put");N(this,"delete");N(this,"options");N(this,"patch");N(this,"all");N(this,"on");N(this,"use");N(this,"router");N(this,"getPath");N(this,"_basePath","/");P(this,pe,"/");N(this,"routes",[]);P(this,me,va);N(this,"errorHandler",Xt);N(this,"onError",t=>(this.errorHandler=t,this));N(this,"notFound",t=>($(this,me,t),this));N(this,"fetch",(t,...s)=>q(this,se,wt).call(this,t,s[1],s[0],t.method));N(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ge("/",t)}`,s),a,n)));N(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(q(this,se,wt).call(this,t.request,t,void 0,t.request.method))})});[...ba,ya].forEach(r=>{this[r]=(i,...l)=>(typeof i=="string"?$(this,pe,i):q(this,se,Me).call(this,r,h(this,pe),i),l.forEach(o=>{q(this,se,Me).call(this,r,h(this,pe),o)}),this)}),this.on=(r,i,...l)=>{for(const o of[i].flat()){$(this,pe,o);for(const c of[r].flat())l.map(d=>{q(this,se,Me).call(this,c.toUpperCase(),h(this,pe),d)})}return this},this.use=(r,...i)=>(typeof r=="string"?$(this,pe,r):($(this,pe,"*"),i.unshift(r)),i.forEach(l=>{q(this,se,Me).call(this,te,h(this,pe),l)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??ls:pa}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var i;let r;s.errorHandler===Xt?r=n.handler:(r=async(l,o)=>(await qt([],s.errorHandler)(l,()=>n.handler(l,o))).res,r[Ea]=n.handler),q(i=a,se,Me).call(i,n.method,n.path,r)}),this}basePath(t){const s=q(this,se,ys).call(this);return s._basePath=Ge(this._basePath,t),s}mount(t,s,a){let n,r;a&&(typeof a=="function"?r=a:(r=a.optionHandler,a.replaceRequest===!1?n=o=>o:n=a.replaceRequest));const i=r?o=>{const c=r(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};n||(n=(()=>{const o=Ge(this._basePath,t),c=o==="/"?0:o.length;return d=>{const u=new URL(d.url);return u.pathname=u.pathname.slice(c)||"/",new Request(u,d)}})());const l=async(o,c)=>{const d=await s(n(o.req.raw),...i(o));if(d)return d;await c()};return q(this,se,Me).call(this,te,Ge(t,"*"),l),this}},pe=new WeakMap,se=new WeakSet,ys=function(){const t=new Je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,$(t,me,h(this,me)),t.routes=this.routes,t},me=new WeakMap,Me=function(t,s,a){t=t.toUpperCase(),s=Ge(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},vt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},wt=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await q(this,se,wt).call(this,t,s,a,"GET")))();const r=this.getPath(t,{env:a}),i=this.router.match(n,r),l=new ha(t,{path:r,matchResult:i,env:a,executionCtx:s,notFoundHandler:h(this,me)});if(i[0].length===1){let c;try{c=i[0][0][0][0](l,async()=>{l.res=await h(this,me).call(this,l)})}catch(d){return q(this,se,vt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:h(this,me).call(this,l))).catch(d=>q(this,se,vt).call(this,d,l)):c??h(this,me).call(this,l)}const o=qt(i[0],this.errorHandler,h(this,me));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return q(this,se,vt).call(this,c,l)}})()},Je),bs=[];function Sa(e,t){const s=this.buildAllMatchers(),a=((n,r)=>{const i=s[n]||s[te],l=i[2][r];if(l)return l;const o=r.match(i[0]);if(!o)return[[],bs];const c=o.indexOf("",1);return[i[1][c],o]});return this.match=a,a(e,t)}var Tt="[^/]+",it=".*",ot="(?:|/.*)",ze=Symbol(),xa=new Set(".\\+*[^]$()");function Ta(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===it||e===ot?1:t===it||t===ot?-1:e===Tt?1:t===Tt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ce,Be,ge,He,ka=(He=class{constructor(){P(this,Ce);P(this,Be);P(this,ge,Object.create(null))}insert(t,s,a,n,r){if(t.length===0){if(h(this,Ce)!==void 0)throw ze;if(r)return;$(this,Ce,s);return}const[i,...l]=t,o=i==="*"?l.length===0?["","",it]:["","",Tt]:i==="/*"?["","",ot]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const d=o[1];let u=o[2]||Tt;if(d&&o[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw ze;if(c=h(this,ge)[u],!c){if(Object.keys(h(this,ge)).some(m=>m!==it&&m!==ot))throw ze;if(r)return;c=h(this,ge)[u]=new He,d!==""&&$(c,Be,n.varIndex++)}!r&&d!==""&&a.push([d,h(c,Be)])}else if(c=h(this,ge)[i],!c){if(Object.keys(h(this,ge)).some(d=>d.length>1&&d!==it&&d!==ot))throw ze;if(r)return;c=h(this,ge)[i]=new He}c.insert(l,s,a,n,r)}buildRegExpStr(){const s=Object.keys(h(this,ge)).sort(Ta).map(a=>{const n=h(this,ge)[a];return(typeof h(n,Be)=="number"?`(${a})@${h(n,Be)}`:xa.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof h(this,Ce)=="number"&&s.unshift(`#${h(this,Ce)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ce=new WeakMap,Be=new WeakMap,ge=new WeakMap,He),Rt,gt,as,La=(as=class{constructor(){P(this,Rt,{varIndex:0});P(this,gt,new ka)}insert(e,t,s){const a=[],n=[];for(let i=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const c=`@\\${i}`;return n[i]=[c,o],i++,l=!0,c}),!l)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=n.length-1;i>=0;i--){const[l]=n[i];for(let o=r.length-1;o>=0;o--)if(r[o].indexOf(l)!==-1){r[o]=r[o].replace(l,n[i][1]);break}}return h(this,gt).insert(r,t,a,h(this,Rt),s),a}buildRegExp(){let e=h(this,gt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,r,i)=>r!==void 0?(s[++t]=Number(r),"$()"):(i!==void 0&&(a[Number(i)]=++t),"")),[new RegExp(`^${e}`),s,a]}},Rt=new WeakMap,gt=new WeakMap,as),Ra=[/^$/,[],Object.create(null)],St=Object.create(null);function Es(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Ia(){St=Object.create(null)}function Aa(e){var c;const t=new La,s=[];if(e.length===0)return Ra;const a=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,u],[m,p])=>d?1:m?-1:u.length-p.length),n=Object.create(null);for(let d=0,u=-1,m=a.length;d<m;d++){const[p,g,f]=a[d];p?n[g]=[f.map(([y])=>[y,Object.create(null)]),bs]:u++;let _;try{_=t.insert(g,u,p)}catch(y){throw y===ze?new hs(g):y}p||(s[u]=f.map(([y,E])=>{const S=Object.create(null);for(E-=1;E>=0;E--){const[b,x]=_[E];S[b]=x}return[y,S]}))}const[r,i,l]=t.buildRegExp();for(let d=0,u=s.length;d<u;d++)for(let m=0,p=s[d].length;m<p;m++){const g=(c=s[d][m])==null?void 0:c[1];if(!g)continue;const f=Object.keys(g);for(let _=0,y=f.length;_<y;_++)g[f[_]]=l[g[f[_]]]}const o=[];for(const d in i)o[d]=s[i[d]];return[r,o,n]}function Ve(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(Es(s).test(t))return[...e[s]]}}var Re,Ie,It,vs,ns,Da=(ns=class{constructor(){P(this,It);N(this,"name","RegExpRouter");P(this,Re);P(this,Ie);N(this,"match",Sa);$(this,Re,{[te]:Object.create(null)}),$(this,Ie,{[te]:Object.create(null)})}add(e,t,s){var l;const a=h(this,Re),n=h(this,Ie);if(!a||!n)throw new Error(_s);a[e]||[a,n].forEach(o=>{o[e]=Object.create(null),Object.keys(o[te]).forEach(c=>{o[e][c]=[...o[te][c]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Es(t);e===te?Object.keys(a).forEach(c=>{var d;(d=a[c])[t]||(d[t]=Ve(a[c],t)||Ve(a[te],t)||[])}):(l=a[e])[t]||(l[t]=Ve(a[e],t)||Ve(a[te],t)||[]),Object.keys(a).forEach(c=>{(e===te||e===c)&&Object.keys(a[c]).forEach(d=>{o.test(d)&&a[c][d].push([s,r])})}),Object.keys(n).forEach(c=>{(e===te||e===c)&&Object.keys(n[c]).forEach(d=>o.test(d)&&n[c][d].push([s,r]))});return}const i=cs(t)||[t];for(let o=0,c=i.length;o<c;o++){const d=i[o];Object.keys(n).forEach(u=>{var m;(e===te||e===u)&&((m=n[u])[d]||(m[d]=[...Ve(a[u],d)||Ve(a[te],d)||[]]),n[u][d].push([s,r-c+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Ie)).concat(Object.keys(h(this,Re))).forEach(t=>{e[t]||(e[t]=q(this,It,vs).call(this,t))}),$(this,Re,$(this,Ie,void 0)),Ia(),e}},Re=new WeakMap,Ie=new WeakMap,It=new WeakSet,vs=function(e){const t=[];let s=e===te;return[h(this,Re),h(this,Ie)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(r=>[r,a[e][r]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==te&&t.push(...Object.keys(a[te]).map(r=>[r,a[te][r]]))}),s?Aa(t):null},ns),Ae,Ee,rs,$a=(rs=class{constructor(e){N(this,"name","SmartRouter");P(this,Ae,[]);P(this,Ee,[]);$(this,Ae,e.routers)}add(e,t,s){if(!h(this,Ee))throw new Error(_s);h(this,Ee).push([e,t,s])}match(e,t){if(!h(this,Ee))throw new Error("Fatal error");const s=h(this,Ae),a=h(this,Ee),n=s.length;let r=0,i;for(;r<n;r++){const l=s[r];try{for(let o=0,c=a.length;o<c;o++)l.add(...a[o]);i=l.match(e,t)}catch(o){if(o instanceof hs)continue;throw o}this.match=l.match.bind(l),$(this,Ae,[l]),$(this,Ee,void 0);break}if(r===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(h(this,Ee)||h(this,Ae).length!==1)throw new Error("No active router has been determined yet.");return h(this,Ae)[0]}},Ae=new WeakMap,Ee=new WeakMap,rs),rt=Object.create(null),De,le,Pe,et,ie,ve,Ne,tt,Ma=(tt=class{constructor(t,s,a){P(this,ve);P(this,De);P(this,le);P(this,Pe);P(this,et,0);P(this,ie,rt);if($(this,le,a||Object.create(null)),$(this,De,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},$(this,De,[n])}$(this,Pe,[])}insert(t,s,a){$(this,et,++Gt(this,et)._);let n=this;const r=oa(s),i=[];for(let l=0,o=r.length;l<o;l++){const c=r[l],d=r[l+1],u=da(c,d),m=Array.isArray(u)?u[0]:c;if(m in h(n,le)){n=h(n,le)[m],u&&i.push(u[1]);continue}h(n,le)[m]=new tt,u&&(h(n,Pe).push(u),i.push(u[1])),n=h(n,le)[m]}return h(n,De).push({[t]:{handler:a,possibleKeys:i.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,et)}}),n}search(t,s){var o;const a=[];$(this,ie,rt);let r=[this];const i=os(s),l=[];for(let c=0,d=i.length;c<d;c++){const u=i[c],m=c===d-1,p=[];for(let g=0,f=r.length;g<f;g++){const _=r[g],y=h(_,le)[u];y&&($(y,ie,h(_,ie)),m?(h(y,le)["*"]&&a.push(...q(this,ve,Ne).call(this,h(y,le)["*"],t,h(_,ie))),a.push(...q(this,ve,Ne).call(this,y,t,h(_,ie)))):p.push(y));for(let E=0,S=h(_,Pe).length;E<S;E++){const b=h(_,Pe)[E],x=h(_,ie)===rt?{}:{...h(_,ie)};if(b==="*"){const M=h(_,le)["*"];M&&(a.push(...q(this,ve,Ne).call(this,M,t,h(_,ie))),$(M,ie,x),p.push(M));continue}const[v,O,V]=b;if(!u&&!(V instanceof RegExp))continue;const L=h(_,le)[v],T=i.slice(c).join("/");if(V instanceof RegExp){const M=V.exec(T);if(M){if(x[O]=M[0],a.push(...q(this,ve,Ne).call(this,L,t,h(_,ie),x)),Object.keys(h(L,le)).length){$(L,ie,x);const I=((o=M[0].match(/\//))==null?void 0:o.length)??0;(l[I]||(l[I]=[])).push(L)}continue}}(V===!0||V.test(u))&&(x[O]=u,m?(a.push(...q(this,ve,Ne).call(this,L,t,x,h(_,ie))),h(L,le)["*"]&&a.push(...q(this,ve,Ne).call(this,h(L,le)["*"],t,x,h(_,ie)))):($(L,ie,x),p.push(L)))}}r=p.concat(l.shift()??[])}return a.length>1&&a.sort((c,d)=>c.score-d.score),[a.map(({handler:c,params:d})=>[c,d])]}},De=new WeakMap,le=new WeakMap,Pe=new WeakMap,et=new WeakMap,ie=new WeakMap,ve=new WeakSet,Ne=function(t,s,a,n){const r=[];for(let i=0,l=h(t,De).length;i<l;i++){const o=h(t,De)[i],c=o[s]||o[te],d={};if(c!==void 0&&(c.params=Object.create(null),r.push(c),a!==rt||n&&n!==rt))for(let u=0,m=c.possibleKeys.length;u<m;u++){const p=c.possibleKeys[u],g=d[c.score];c.params[p]=n!=null&&n[p]&&!g?n[p]:a[p]??(n==null?void 0:n[p]),d[c.score]=!0}}return r},tt),Ue,is,Na=(is=class{constructor(){N(this,"name","TrieRouter");P(this,Ue);$(this,Ue,new Ma)}add(e,t,s){const a=cs(t);if(a){for(let n=0,r=a.length;n<r;n++)h(this,Ue).insert(e,a[n],s);return}h(this,Ue).insert(e,t,s)}match(e,t){return h(this,Ue).search(e,t)}},Ue=new WeakMap,is),he=class extends wa{constructor(e={}){super(e),this.router=e.router??new $a({routers:[new Da,new Na]})}},Fa=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(r=>typeof r=="string"?r==="*"?()=>r:i=>r===i?i:null:typeof r=="function"?r:i=>r.includes(i)?i:null)(s.origin),n=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(s.allowMethods);return async function(i,l){var d;function o(u,m){i.res.headers.set(u,m)}const c=await a(i.req.header("origin")||"",i);if(c&&o("Access-Control-Allow-Origin",c),s.credentials&&o("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),i.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const u=await n(i.req.header("origin")||"",i);u.length&&o("Access-Control-Allow-Methods",u.join(","));let m=s.allowHeaders;if(!(m!=null&&m.length)){const p=i.req.header("Access-Control-Request-Headers");p&&(m=p.split(/\s*,\s*/))}return m!=null&&m.length&&(o("Access-Control-Allow-Headers",m.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((a,n)=>a+n,0)/t}function kt(e,t){if(e.length<t)return 0;const s=2/(t+1);let a=Fe(e.slice(0,t),t);for(let n=t;n<e.length;n++)a=(e[n]-a)*s+a;return a}function Oa(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let a=0,n=0;for(let o=0;o<t;o++)s[o]>0?a+=s[o]:n+=Math.abs(s[o]);let r=a/t,i=n/t;for(let o=t;o<s.length;o++){const c=s[o];r=(r*(t-1)+(c>0?c:0))/t,i=(i*(t-1)+(c<0?Math.abs(c):0))/t}return i===0?100:100-100/(1+r/i)}function Ca(e){const t=kt(e,12),s=kt(e,26),a=t-s,n=a*.9,r=a-n;return{macd:a,signal:n,histogram:r}}function Ba(e,t=20,s=2){const a=Fe(e,t),r=e.slice(-t).reduce((l,o)=>l+Math.pow(o-a,2),0)/t,i=Math.sqrt(r);return{upper:a+i*s,middle:a,lower:a-i*s}}function Pa(e,t=14){if(e.length<t+1)return 10;const s=[];for(let r=1;r<e.length;r++){const i=e[r].high,l=e[r].low,o=e[r-1].close,c=Math.max(i-l,Math.abs(i-o),Math.abs(l-o));s.push(c)}const a=Fe(s,t);return Math.max(a,10)}function Ua(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const a=e.slice(-t),n=a.map(u=>u.high),r=a.map(u=>u.low),i=e[e.length-1].close,l=Math.max(...n),o=Math.min(...r),c=(i-o)/(l-o)*100;return{k:c,d:c}}function Ha(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,a=0,n=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,u=e[c].low,m=e[c-1].high,p=e[c-1].low,g=e[c-1].close,f=d-m,_=p-u;f>_&&f>0&&(s+=f),_>f&&_>0&&(a+=_),n+=Math.max(d-u,Math.abs(d-g),Math.abs(u-g))}const r=n>0?s/n*100:0,i=n>0?a/n*100:0;return{adx:r+i>0?Math.abs(r-i)/(r+i)*100:0,plusDI:r,minusDI:i}}function ja(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),a=Math.max(...s.map(y=>y.high)),n=Math.min(...s.map(y=>y.low)),r=(a+n)/2,i=Math.min(26,e.length),l=e.slice(-i),o=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(o+c)/2,u=(r+d)/2,m=Math.min(52,e.length),p=e.slice(-m),g=Math.max(...p.map(y=>y.high)),f=Math.min(...p.map(y=>y.low)),_=(g+f)/2;return{tenkan:r,kijun:d,senkouA:u,senkouB:_}}function Wa(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const a=e[e.length-1],n=e[e.length-2];return a.close>n.close?a.low*.98:a.high*1.02}function Ya(e){if(e.length===0)return 0;let t=0,s=0;for(const a of e){const n=(a.high+a.low+a.close)/3,r=a.volume||1;t+=n*r,s+=r}return s>0?t/s:e[e.length-1].close}function Va(e,t=50){const s=e.slice(-Math.min(t,e.length)),a=s.map(o=>o.high),n=s.map(o=>o.low),r=Math.max(...a),i=Math.min(...n),l=r-i;return{fib_0:r,fib_236:r-l*.236,fib_382:r-l*.382,fib_500:r-l*.5,fib_618:r-l*.618,fib_100:i}}function _e(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=Ca(t),a=Ba(t),n=Ua(e,14,3),r=Ha(e,14),i=ja(e),l=Wa(e),o=Ya(e),c=Va(e,50);return{rsi_14:Oa(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:kt(t,12),ema_26:kt(t,26),bb_upper:a.upper,bb_middle:a.middle,bb_lower:a.lower,atr_14:Pa(e,14),stochastic_k:n.k,stochastic_d:n.d,adx:r.adx,plus_di:r.plusDI,minus_di:r.minusDI,ichimoku_tenkan:i.tenkan,ichimoku_kijun:i.kijun,ichimoku_senkou_a:i.senkouA,ichimoku_senkou_b:i.senkouB,parabolic_sar:l,vwap:o,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function ae(e,t,s){const a=[];let n=0,r=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(a.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?n+=2:r+=2),t.stochastic_k<20?(a.push("Stochastic oversold (<20)"),n+=2):t.stochastic_k<30?(a.push("Stochastic approaching oversold"),n+=1):t.stochastic_k>80?(a.push("Stochastic overbought (>80)"),r+=3):t.stochastic_k>70&&(a.push("Stochastic approaching overbought"),r+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(a.push("Stochastic bullish crossover"),n+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(a.push("Stochastic bearish crossover"),r+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(a.push("Price above Ichimoku Cloud (bullish)"),n+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(a.push("Price below Ichimoku Cloud (bearish)"),r+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(a.push("Ichimoku bullish (Tenkan > Kijun)"),n+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(a.push("Ichimoku bearish (Tenkan < Kijun)"),r+=1),e>t.vwap?(a.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),n+=1):e<t.vwap&&(a.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),r+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(a.push("Near 61.8% Fibonacci support"),n+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(a.push("Near 38.2% Fibonacci resistance"),r+=2),t.rsi_14<30?(a.push("RSI oversold (<30)"),n+=2):t.rsi_14<40?(a.push("RSI below 40"),n+=1):t.rsi_14>70?(a.push("RSI overbought (>70)"),r+=3):t.rsi_14>65?(a.push("RSI approaching overbought (>65)"),r+=2):t.rsi_14>60&&(a.push("RSI above 60"),r+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(a.push("MACD bullish crossover"),n+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(a.push("MACD bearish crossover"),r+=2),e>t.sma_20&&e>t.sma_50?(a.push("Price above SMA20 and SMA50"),n+=1):e<t.sma_20&&e<t.sma_50&&(a.push("Price below SMA20 and SMA50"),r+=1),e>t.sma_200?(a.push("Uptrend (above SMA200)"),n+=1):(a.push("Downtrend (below SMA200)"),r+=1),e<=t.bb_lower?(a.push("Price at lower Bollinger Band"),n+=2):e>=t.bb_upper&&(a.push("Price at upper Bollinger Band"),r+=2);const i=n+r,l=i>0?n/i*100:50;let o="HOLD",c=50;n>r+1?(o="BUY",c=Math.min(l,95)):r>n+1&&(o="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(n-r)>4&&(c=Math.min(c+5,95),a.push("High conviction signal"));const d=s==="day_trade"?1.5:2,u=s==="day_trade"?3:4,m=s==="day_trade"?4:5.5,p=s==="day_trade"?5:7,f=e*(1/100);let _,y,E,S;if(o==="BUY"){const b=e-t.atr_14*d;_=Math.max(b,e-f),y=e+t.atr_14*u,E=e+t.atr_14*m,S=e+t.atr_14*p}else if(o==="SELL"){const b=e+t.atr_14*d;_=Math.min(b,e+f),y=e-t.atr_14*u,E=e-t.atr_14*m,S=e-t.atr_14*p}else _=e,y=e,E=e,S=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(_.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(E.toFixed(2)),take_profit_3:parseFloat(S.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:a.join(", ")}}async function K(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const n=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return n.ok||console.error("[Telegram] Send failed:",JSON.stringify(n)),n.ok===!0}catch(a){return console.error("Failed to send Telegram message:",a),!1}}function Ga(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function lt(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
⏰ ${new Date().toLocaleString()}
  `.trim()}function ws(e,t){if(!e)throw console.error("[determineTrend] indicators is null/undefined!"),new Error("Indicators is undefined");if(e.rsi_14===void 0)throw console.error("[determineTrend] rsi_14 is undefined! Indicators:",Object.keys(e)),new Error("rsi_14 is undefined in indicators");let s=0,a=0,n=0;e.macd>e.macd_signal&&e.macd_histogram>0?s+=3:e.macd<e.macd_signal&&e.macd_histogram<0&&(a+=3),n+=3,t>e.sma_20?s+=2:a+=2,n+=2,t>e.sma_50?s+=2:a+=2,n+=2,t>e.sma_200?s+=3:a+=3,n+=3,e.adx&&e.adx>25&&e.plus_di&&e.minus_di&&(e.plus_di>e.minus_di?s+=2:a+=2,n+=2),e.rsi_14>50?s+=1:a+=1,n+=1;const r=s/n*100,i=a/n*100,l=Math.abs(r-i);let o,c;return r>60?(o="BULLISH",c=r):i>60?(o="BEARISH",c=i):(o="NEUTRAL",c=50),{timeframe:"1h",trend:o,strength:l,confidence:c}}function jt(e,t){console.log("[analyzeTimeframeAlignment] START"),console.log("[analyzeTimeframeAlignment] indicators keys:",Object.keys(e||{})),console.log("[analyzeTimeframeAlignment] currentPrice:",t);const s=[],a=["5m","15m","1h","4h","daily"];for(const d of a){console.log(`[analyzeTimeframeAlignment] Processing ${d}`);const u=e[d];if(u){console.log(`[analyzeTimeframeAlignment] ${d} has indicators, calling determineTrend`),console.log(`[analyzeTimeframeAlignment] ${d} rsi_14:`,u.rsi_14,typeof u.rsi_14);const m=ws(u,t);m.timeframe=d,s.push(m)}else console.log(`[analyzeTimeframeAlignment] ${d} missing indicators`)}const n=s.filter(d=>d.trend==="BULLISH").length,r=s.filter(d=>d.trend==="BEARISH").length;s.filter(d=>d.trend==="NEUTRAL").length;const i=s.length,l=Math.max(n,r);let o,c;return n===i?(o="ALL_BULLISH",c=20):r===i?(o="ALL_BEARISH",c=20):n>=i*.8?(o="ALL_BULLISH",c=15):r>=i*.8?(o="ALL_BEARISH",c=15):n>=i*.6||r>=i*.6?(o="MIXED",c=10):(o="CONFLICTING",c=0),{score:l,type:o,confidenceBoost:c,trends:s}}function Ut(e,t){if(e==="HOLD")return{isValid:!1,confidence:50,reason:"HOLD signal - no trade"};const{trends:s,type:a,confidenceBoost:n}=t,r=s.find(u=>u.timeframe==="daily"),i=s.find(u=>u.timeframe==="4h"),l=s.find(u=>u.timeframe==="1h"),o=s.find(u=>u.timeframe==="15m"),c=s.find(u=>u.timeframe==="5m"),d=e==="BUY"&&(c==null?void 0:c.trend)==="BULLISH"&&(o==null?void 0:o.trend)==="BULLISH"&&(l==null?void 0:l.trend)==="BULLISH"&&(c.strength>70||o.strength>70||l.strength>70)||e==="SELL"&&(c==null?void 0:c.trend)==="BEARISH"&&(o==null?void 0:o.trend)==="BEARISH"&&(l==null?void 0:l.trend)==="BEARISH"&&(c.strength>70||o.strength>70||l.strength>70);return e==="BUY"?r&&r.trend==="BEARISH"&&r.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BEARISH - opposing BUY signal"}:i&&i.trend==="BEARISH"&&i.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BEARISH - opposing BUY signal"}:l&&l.trend==="BEARISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BEARISH - weak BUY setup"}:a==="ALL_BULLISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BULLISH - high probability BUY (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BULLISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned BUY - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip BUY (${t.score}/${s.length})`}:e==="SELL"?r&&r.trend==="BULLISH"&&r.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BULLISH - opposing SELL signal"}:i&&i.trend==="BULLISH"&&i.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BULLISH - opposing SELL signal"}:l&&l.trend==="BULLISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BULLISH - weak SELL setup"}:a==="ALL_BEARISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BEARISH - high probability SELL (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BEARISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned SELL - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip SELL (${t.score}/${s.length})`}:{isValid:!1,confidence:50,reason:"Unknown signal type"}}function qa(e){const t=[`Multi-Timeframe Alignment: ${e.type}`];t.push(`Score: ${e.score}/${e.trends.length}`),t.push(`Confidence Boost: +${e.confidenceBoost}%`),t.push(""),t.push("Timeframe Analysis:");for(const s of e.trends){const a=s.trend==="BULLISH"?"📈":s.trend==="BEARISH"?"📉":"➡️";t.push(`  ${a} ${s.timeframe.padEnd(6)}: ${s.trend.padEnd(8)} (${s.confidence.toFixed(0)}% confident, ${s.strength.toFixed(0)}% strength)`)}return t.join(`
`)}const Ss=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:jt,determineTrend:ws,formatAlignmentReport:qa,validateMultiTimeframeSignal:Ut},Symbol.toStringTag,{value:"Module"}));function Kt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((r,i)=>r-i),a=Math.floor((1-t)*s.length);return Math.abs(s[a]||0)}function za(e,t){const s=Kt(e,.95),a=Kt(e,.99),n=t*s,r=t*a;return{var_95:parseFloat(n.toFixed(2)),var_99:parseFloat(r.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Xa(e,t,s,a){const n=t-e,r=n/t*100;let i=0;for(let c=a.length-1;c>=0&&a[c].balance<t;c--)i++;const l=r<=s,o=r>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(n.toFixed(2)),current_drawdown_pct:parseFloat(r.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:i}}function Ka(e,t,s=5){let a=0;const n=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,u=d/t*100;a+=d,n.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(u.toFixed(2))})}const r=a/t*100,i=r<=s,l=t*(s/100)-a;return{total_open_positions:e.length,total_risk_amount:parseFloat(a.toFixed(2)),total_risk_pct:parseFloat(r.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:n}}function Za(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),a=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&a.push({index:o,value:s[o]});if(a.length<3)return null;const n=a.slice(-3),[r,i,l]=n;if(i.value>r.value&&i.value>l.value&&Math.abs(r.value-l.value)/r.value<.02){const c=Math.min(r.value,l.value)*.995,d=c-(i.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function Qa(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),a=s.slice(0,10),n=s.slice(10);if((a[a.length-1]-a[0])/a[0]>.02&&(Math.max(...n)-Math.min(...n))/n[0]<.015){const o=s[s.length-1],c=a[a.length-1]-a[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function Ja(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),a=t.map(c=>c.low),r=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=a.slice(0,6),l=a.slice(-6),o=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(r<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,u=c+(c-Math.min(...a));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function en(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),a=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&a.push({index:o,value:s[o]});if(a.length<2)return null;const n=a.slice(-2),[r,i]=n;if(Math.abs(r.value-i.value)/r.value<.015){const o=Math.max(...s.slice(r.index,i.index))*1.005,c=o+(o-r.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:66}}return null}function tn(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),a=s[0],n=Math.min(...s.slice(10,25)),r=s[25];if(Math.abs(a-r)/a<.02&&n<a*.95){const l=s.slice(25),o=Math.min(...l),c=(r-o)/r;if(c>.01&&c<.05){const d=a-n,u=r+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function sn(e){const t=[],s=Za(e);s&&t.push(s);const a=Qa(e);a&&t.push(a);const n=Ja(e);n&&t.push(n);const r=en(e);r&&t.push(r);const i=tn(e);i&&t.push(i);let l=0,o=0,c=0;for(const p of t)p.direction==="bullish"?(l++,c+=p.confidence):p.direction==="bearish"&&(o++,c+=p.confidence);let d="neutral",u=0;l>o?(d="bullish",u=Math.min(c/l/10,15)):o>l&&(d="bearish",u=Math.min(c/o/10,15));let m="";if(t.length===0)m="No significant chart patterns detected";else{const p=t.map(g=>g.pattern_type).join(", ");m=`Detected ${t.length} pattern(s): ${p}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(u.toFixed(1)),summary:m}}function an(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function nn(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const n=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=n*10}const a=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(a*10,30),Math.min(Math.round(s),100)}function rn(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const a=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(a>.9||a<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function on(e,t,s){const a=an(t.atr_14,s),n=nn(t,s),r=rn(t,s);let i,l,o,c,d,u;const m=e.slice(-10),p=m.map(y=>y.volume||0),g=p.reduce((y,E)=>y+E,0)/p.length,_=(m[m.length-1].volume||0)>g*1.5;return a==="EXTREME"&&_?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,u="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,u="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,o=!1,c="Wait for direction",d=.5,u="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&n>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,u="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,u="Strong bearish trend - avoid long positions"):t.adx>20&&n>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,u="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,u="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,r>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,u="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,u="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:a,trend_strength:n,mean_reversion_score:r,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:u}}function ln(e){const t=e.length;let s=0,a=0,n=0,r=0;for(let o=0;o<t;o++)s+=o,a+=e[o],n+=o*e[o],r+=o*o;const i=(t*n-s*a)/(t*r-s*s),l=(a-i*s)/t;return{slope:i,intercept:l}}function cn(e,t,s){const a=e.map(l=>l.close),n=2/(t+1);let r=a[0];for(let l=1;l<a.length;l++)r=(a[l]-r)*n+r;const i=(a[a.length-1]-a[a.length-10])/10;return r+i*s}function dn(e,t){const s=e.map(l=>l.close).slice(-20),a=[];for(let l=1;l<s.length;l++)a.push(s[l]-s[l-1]);const i=a.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function un(e,t,s){const a=e[e.length-1].close;e.map(i=>i.close).slice(-20);let n=0;t.rsi_14>50?n+=t.rsi_14-50:n-=50-t.rsi_14,t.macd>t.macd_signal?n+=20:n-=20,a>t.sma_20&&(n+=10),a>t.sma_50&&(n+=10);const r=n/100*s;return a+t.atr_14*r}function pn(e,t){const s=e.map(m=>m.close),a=s[s.length-1],n=10,r=s.slice(-n),i=Math.min(...r),l=Math.max(...r),o=r.map(m=>(m-i)/(l-i));let c={index:0,similarity:-1/0};for(let m=n;m<s.length-n-t;m++){const p=s.slice(m-n,m),g=Math.min(...p),f=Math.max(...p),_=p.map(S=>(S-g)/(f-g));let y=0;for(let S=0;S<n;S++)y+=Math.pow(o[S]-_[S],2);const E=-y;E>c.similarity&&(c={index:m,similarity:E})}const u=(s[c.index+t]-s[c.index])*(a/s[c.index]);return a+u}function Ot(e,t,s){const a=[],n=[],r=e.map(v=>v.close),{slope:i,intercept:l}=ln(r.slice(-20)),o=i*(r.length-1+s)+l;a.push(o),n.push(1);const c=cn(e,12,s);a.push(c),n.push(1.5);const d=dn(e,s);a.push(d),n.push(1.2);const u=un(e,t,s);a.push(u),n.push(1.8);const m=pn(e,s);a.push(m),n.push(1.3);const p=n.reduce((v,O)=>v+O,0),f=a.reduce((v,O,V)=>v+O*n[V],0)/p,_=a.reduce((v,O)=>v+O,0)/a.length,y=a.reduce((v,O)=>v+Math.pow(O-_,2),0)/a.length,E=Math.sqrt(y),S=e[e.length-1].close,b=1-E/S,x=Math.max(50,Math.min(95,b*100));return{prediction:f,confidence:x}}function mn(e,t){const s=e[e.length-1].close,a=[],n=Ot(e,t,1),r=n.prediction-s,i=r/s*100;a.push({timeframe:"1h",predicted_price:parseFloat(n.prediction.toFixed(2)),confidence_interval_upper:parseFloat((n.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((n.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(n.confidence.toFixed(1)),direction:r>.5?"UP":r<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Ot(e,t,4),o=l.prediction-s,c=o/s*100;a.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Ot(e,t,24),u=d.prediction-s,m=u/s*100;a.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:u>5?"UP":u<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(m.toFixed(2)),method:"Ensemble (5 models)"});const p=a.filter(E=>E.direction==="UP").length,g=a.filter(E=>E.direction==="DOWN").length;let f,_=0;p>g?(f="BULLISH",_=Math.min(p*5,15)):g>p?(f="BEARISH",_=Math.min(g*5,15)):f="NEUTRAL";const y=`ML models predict ${f} movement. 1h: ${a[0].direction} (${a[0].expected_move_pct.toFixed(2)}%), 4h: ${a[1].direction} (${a[1].expected_move_pct.toFixed(2)}%), 24h: ${a[2].direction} (${a[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:a,overall_direction:f,confidence_boost:parseFloat(_.toFixed(1)),summary:y}}function Ct(e,t,s,a,n){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const o=(a-50)/10;l+=o;const c=(n-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function gn(e,t,s,a,n){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,n==="BUY"){const o=(a-50)/10;l-=o}else{const o=(a-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function fn(e,t,s,a,n,r){const i=(s-e)*.5,l=(a-e)*.3,o=(n-e)*.2,c=t-e;return r.tp1/100*i+r.tp2/100*l+r.tp3/100*o+r.sl/100*c}function _n(e,t,s){const a=e.price,n=t.atr_14;let r=50;e.signal_type==="BUY"?(a>t.sma_20&&(r+=10),a>t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(r+=10)):e.signal_type==="SELL"&&(a<t.sma_20&&(r+=10),a<t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(r+=10)),r=Math.min(100,r);const i=s.slice(-50),l=[];for(let S=14;S<i.length;S++){const b=i.slice(S-14,S);let x=0;for(let v=1;v<b.length;v++){const O=Math.max(b[v].high-b[v].low,Math.abs(b[v].high-b[v-1].close),Math.abs(b[v].low-b[v-1].close));x+=O}l.push(x/14)}const o=l.reduce((S,b)=>S+b,0)/l.length,c=n/o,d=Ct(a,e.take_profit_1,n,r,c),u=Ct(a,e.take_profit_2,n,r,c),m=Ct(a,e.take_profit_3,n,r,c),p=gn(a,e.stop_loss,n,r,e.signal_type),g=fn(a,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:u,tp3:m,sl:p}),_=(d+u+m)/3/p;let y;d>70&&g>5&&_>2?y="STRONG_TRADE":d>60&&g>0&&_>1.5?y="GOOD_TRADE":d>50&&g>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const E=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${_.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(u.toFixed(1)),tp3_probability:parseFloat(m.toFixed(1)),stop_loss_probability:parseFloat(p.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(_.toFixed(2)),recommendation:y,summary:E}}function xs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=hn(e),s=yn(),a=bn(e,s.session),n=En(t,s.session),r=vn(t,s),i=wn(t,s,a,r),l=Sn(i,t,s,a),o=xn(i);return{liquidity_score:Math.round(i),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:a.spread_pips,price_impact_bps:Math.round(n),market_depth_score:Math.round(r),optimal_for_trading:i>=70&&l.length===0,warnings:l,recommendation:o}}function hn(e){const t=e.slice(-10),s=e.slice(-20,-10),a=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,n=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,r=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,i=n/a;let l;n>r*1.2?l="INCREASING":n<r*.8?l="DECREASING":l="STABLE";const o=Math.min(100,i*100);return{avg_volume:a,current_volume:n,volume_ratio:i,volume_spike:i>2,volume_drought:i<.5,trend:l,percentile:o}}function yn(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),a=t*60+s;let n,r;return a>=780&&a<960?(n="OVERLAP",r="HIGH"):a>=480&&a<780?(n="LONDON",r="HIGH"):a>=960&&a<1320?(n="NEW_YORK",r="HIGH"):a>=0&&a<480?(n="ASIA",r="MEDIUM"):(n="OFF_HOURS",r="LOW"),{zone:r,session:n}}function bn(e,t){const s=e.slice(-20);let a=0;for(const d of s){const u=d.high-d.low;a+=u}const n=a/s.length,r=s[s.length-1].close,i=n/r*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+i*2,c=l*o;return{spread_pips:Math.round(c)}}function En(e,t){let s=10;const n={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,r=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*n*r}function vn(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function wn(e,t,s,a){const n=e.percentile*.3,r=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,i=Math.max(0,100-s.spread_pips)*.2,l=a*.2;return n+r+i+l}function Sn(e,t,s,a){const n=[];return e<50&&n.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&n.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&n.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),a.spread_pips>50&&n.push(`⚠️ WIDE SPREADS: Estimated ${a.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&n.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),n}function xn(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Wt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Tn(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function At(e=30){const t=[],s=new Date;for(const n of Wt){const r=new Date(n),i=Math.floor((r.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:n,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:n,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let n=0;n<=e;n++){const r=new Date(s.getTime()+n*24*60*60*1e3),i=r.getFullYear(),l=r.getMonth(),o=r.getDate(),c=r.getDay();if(o===Tn(i,l)&&c===5){const d=r.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((n,r,i)=>r===i.findIndex(l=>l.date===n.date&&l.time===n.time&&l.title===n.title)).sort((n,r)=>{const i=new Date(`${n.date}T${n.time}:00Z`),l=new Date(`${r.date}T${r.time}:00Z`);return i.getTime()-l.getTime()})}function ft(e=new Date,t=[]){const s=[...At(7),...t],a=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),n=e.toISOString().split("T")[0];if(s.filter(i=>i.date===n&&i.impact==="high"),Wt.includes(n))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:a,nextSafeTime:kn(n)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:a,nextSafeTime:void 0}}const r=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>r&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:a}}function kn(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function xt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let a="🔴";return e.impact==="medium"&&(a="🟡"),e.impact==="low"&&(a="🟢"),`${a} ${e.date} ${s} UTC - ${e.title}`}function Ln(e){const t=e.toISOString().split("T")[0];return Wt.includes(t)?!0:At(30).filter(n=>n.date===t&&n.impact==="high").length>=2}function Rn(){const e=new Date().toISOString().split("T")[0];return At(7).filter(s=>s.date===e)}function Ts(e=new Date){const t=ft(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const ks=new he;ks.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const a={},n={};for(const B of["5m","15m","1h","4h","daily"]){const D=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(B).first();D&&(a[B]=D);const G=await t.prepare(`
        SELECT timestamp, open, high, low, close, volume 
        FROM market_data 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(B).all();G.results&&G.results.length>0&&(n[B]=G.results.map(w=>({timestamp:w.timestamp,open:w.open,high:w.high,low:w.low,close:w.close,volume:w.volume||0})))}if(Object.keys(a).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(a).length}. Please fetch multi-timeframe data first.`},400);const r=[];if(a["1h"]&&a["1h"].timestamp){const B=new Date(a["1h"].timestamp).getTime(),G=(Date.now()-B)/(1e3*60);G>60?r.push(`⚠️ WARNING: 1h data is ${G.toFixed(0)} minutes old (>60 min)`):G>30&&r.push(`⚠️ CAUTION: 1h data is ${G.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${G.toFixed(1)} minutes old`)}const i=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(i==null?void 0:i.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(i!=null&&i.timestamp){const B=new Date(i.timestamp).getTime(),D=(Date.now()-B)/(1e3*60);D>60&&r.push(`⚠️ WARNING: Price data is ${D.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${D.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ft(),c=Ts();let d=null,u=!1;o.riskLevel==="danger"?(u=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const m=a["1h"];if(!m)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(a).join(", ")}`},400);const p=jt(a,l),g=ae(l,m,"day_trade"),f=ae(l,m,"swing_trade"),_=Ut(g.signal_type,p),y=Ut(f.signal_type,p),E={...g,base_confidence:g.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:p.score,alignment_type:p.type},S={...f,base_confidence:f.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:p.score,alignment_type:p.type};let b=0,x="",v=[];if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20){try{const D=sn(n["1h"]);v=(D==null?void 0:D.patterns)||[]}catch(D){console.error("[ENHANCED] Pattern detection error:",D.message)}const B=v.filter(D=>D.confidence>=70&&D.endIndex>=n["1h"].length-5);for(const D of B)D.type==="bullish"&&E.signal_type==="BUY"?(b+=D.confidence*.1,x+=`${D.name} (${D.confidence.toFixed(0)}%), `):D.type==="bearish"&&E.signal_type==="SELL"&&(b+=D.confidence*.1,x+=`${D.name} (${D.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let O=0,V="",L=null;if(n["1h"]&&n["1h"].length>=50){const B=_e(n["1h"]);B&&(L=on(n["1h"],B),L.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(O=10,V="Strong Uptrend"):L.trend==="UPTREND"&&E.signal_type==="BUY"?(O=5,V="Uptrend"):L.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(O=10,V="Strong Downtrend"):L.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(O=5,V="Downtrend"))}let T=0,M="",I=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{I=mn(n["1h"],l),I.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(T=I.confidence_boost,M=`ML predicts +${((I.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):I.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(T=I.confidence_boost,M=`ML predicts ${((I.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(B){console.error("[ENHANCED] ML prediction error:",B.message)}let W=0,H="",X=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{const B=_e(n["1h"]);B&&(X=_n(E,B,n["1h"]),X.tp1_probability>70?(W=10,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`):X.tp1_probability>60&&(W=5,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`))}catch(B){console.error("[ENHANCED] Probability of Profit error:",B.message)}let R=null,Y=0,ce=0;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20)try{R=xs(n["1h"]),R.liquidity_score>=80?Y=5:R.liquidity_score>=70?Y=0:R.liquidity_score>=50?ce=-5:ce=-10,console.log(`[LIQUIDITY] Score: ${R.liquidity_score}/100, Session: ${R.session}, Adjust: ${Y+ce}%`)}catch(B){console.error("[ENHANCED] Liquidity Analysis error:",B.message)}let A=0,z=0,ee=0,ne=0,re="";try{const B=await t.prepare(`
      ...
      `).all(),G=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(B&&D.results&&D.results.length>=10){const w=za(D.results,B.balance);A=w.var_95,z=w.var_99;const oe=Xa(B.balance,D.results);if(ee=oe.current_drawdown_pct,oe.is_within_limit||(re+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),G.results){const C=Ka(G.results,B.balance);ne=C.total_risk_pct,C.is_within_limit||(re+=`⚠️ Portfolio heat ${ne.toFixed(1)}% exceeds limit. `)}}}catch(B){console.error("[ENHANCED] Risk metrics error (optional):",B.message)}const k=b+O+T+W+Y+ce,j={...E,pattern_boost:b,regime_boost:O,ml_boost:T,pop_boost:W,total_boost:k,enhanced_confidence:Math.min(98,E.final_confidence+k),var_95:A,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ne,risk_warning:re||null},F={...S,pattern_boost:b,regime_boost:O,ml_boost:T,pop_boost:W,total_boost:k,enhanced_confidence:Math.min(98,S.final_confidence+k),var_95:A,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ne,risk_warning:re||null};u?(j.signal_type="HOLD",F.signal_type="HOLD",j.enhanced_confidence=50,F.enhanced_confidence=50,j.reasoning=d||"Economic event nearby - trading paused",F.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(j.enhanced_confidence=Math.max(50,j.enhanced_confidence+c.adjustment),F.enhanced_confidence=Math.max(50,F.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),j.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(B=>xt(B))},F.calendar_check=j.calendar_check;let Se=!1;try{const B=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),D={};for(const G of B.results||[])D[G.setting_key]=G.setting_value;if(D.telegram_bot_token&&D.telegram_chat_id){const G=new Date().toLocaleString("en-US",{timeZone:"UTC"});let w=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${G} UTC

`;if(r.length>0){w+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const J of r)w+=`${J}
...
`;for(const J of p.trends){const Z=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";w+=`${Z} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}if(w+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,w+=`📈 *DAY TRADE SIGNAL*
`,w+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`),w+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",w.length,"characters");const oe=await K({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},w);let C=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━
...
`,S+=`⏰ ${E}`,console.log("[SIMPLE] Sending Telegram message, length:",S.length),g=await K({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},S),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:g,day_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(c),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"day_trade"},swing_trade:{signal_type:p.signal_type,confidence:Number(p.confidence),price:Number(c),stop_loss:Number(p.stop_loss),take_profit_1:Number(p.take_profit_1),take_profit_2:Number(p.take_profit_2),take_profit_3:Number(p.take_profit_3),reason:String(p.reason),trading_style:"swing_trade"}})}catch(i){return console.error("[SIMPLE] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function In(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function An(e=new Date){const t=e.getUTCDay(),a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${a} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${a} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${a} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${a} (market closed)`}:{hasBoost:!1,boost:0,reason:`${a} (standard day)`}}function Dn(e,t){return e>t*1.1}function $n(e){let t=0,s=0,a=0;for(const l of e){const o=l.volume||0;a+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const n=s>0?t/s:t>0?10:1;let r="NEUTRAL";n>1.5?r="BUYING":n<.67&&(r="SELLING");let i=0;return n>3?i=100:n>1.5?i=50+(n-1.5)/1.5*50:n>.67?i=(n-.67)/.83*50:n>.33?i=50+(.67-n)/.34*50:i=100,{uptickVolume:t,downtickVolume:s,totalVolume:a,pressureRatio:n,signal:r,strength:Math.round(i)}}function Rs(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Mn(e,t){const a=Rs(e,t)?"✅":"❌";return e.signal==="BUYING"?`${a} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${a} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${a} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Nn(e){if(e.length<3)return[];const t=[],s=e[e.length-3],a=e[e.length-2],n=e[e.length-1];return Fn(n)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),On(n)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Cn(a,n)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Bn(a,n)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Pn(s,a,n)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Un(s,a,n)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Hn(s,a,n)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),jn(s,a,n)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Wn(n)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Yn(n)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Fn(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>=t*2&&a<=t*.1&&t>0}function On(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Cn(e,t){const s=e.close<e.open,a=t.close>t.open;return s&&a&&t.open<e.close&&t.close>e.open}function Bn(e,t){const s=e.close>e.open,a=t.close<t.open;return s&&a&&t.open>e.close&&t.close<e.open}function Pn(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),i=e.close<e.open,l=s.close>s.open;return i&&n<a*.5&&l&&r>a*.6&&s.close>(e.open+e.close)/2}function Un(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),i=e.close>e.open,l=s.close<s.open;return i&&n<a*.5&&l&&r>a*.6&&s.close<(e.open+e.close)/2}function Hn(e,t,s){const a=e.close>e.open&&t.close>t.open&&s.close>s.open,n=t.high>e.high&&s.high>t.high,r=t.low>e.low&&s.low>t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&r&&i>c&&l>c&&o>c}function jn(e,t,s){const a=e.close<e.open&&t.close<t.open&&s.close<s.open,n=t.high<e.high&&s.high<t.high,r=t.low<e.low&&s.low<t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&r&&i>c&&l>c&&o>c}function Wn(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Yn(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,a=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&a>t*.5&&n>t*.5}function Vn(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const a of e)a.strength>s.strength&&(s=a);if(t==="BUY"){const a=e.some(n=>n.type==="BULLISH_REVERSAL"||n.type==="BULLISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}if(t==="SELL"){const a=e.some(n=>n.type==="BEARISH_REVERSAL"||n.type==="BEARISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}return{aligned:!1,strongestPattern:null}}function Gn(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),u=Math.max(...d.map(p=>p.high)),m=Math.min(...d.map(p=>p.low));s.push({level:u,type:"RESISTANCE",strength:85,distance:u-t,distancePercent:(u-t)/t*100}),s.push({level:m,type:"SUPPORT",strength:85,distance:t-m,distancePercent:(t-m)/t*100})}const a=e.slice(-50),n=Zt(a,"HIGH"),r=Zt(a,"LOW");if(n.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),r.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),qn(t).forEach(d=>{const u=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:u,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),u=zn(d);s.push({level:u.pp,type:"PIVOT",strength:80,distance:Math.abs(u.pp-t),distancePercent:Math.abs(u.pp-t)/t*100}),s.push({level:u.r1,type:"RESISTANCE",strength:70,distance:u.r1-t,distancePercent:(u.r1-t)/t*100}),s.push({level:u.s1,type:"SUPPORT",strength:70,distance:t-u.s1,distancePercent:(t-u.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((d,u)=>Math.abs(u.distancePercent)<Math.abs(d.distancePercent)?u:d),c=Xn(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:c,strength:o.strength,description:Kn(o,c)}}function Zt(e,t){const s=[];for(let r=5;r<e.length-5;r++){const i=t==="HIGH"?e[r].high:e[r].low;let l=!0;for(let o=r-5;o<=r+5;o++){if(o===r)continue;const c=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&c>=i){l=!1;break}if(t==="LOW"&&c<=i){l=!1;break}}l&&s.push(i)}return Array.from(new Set(s)).slice(-3)}function qn(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const a=Math.floor(e/50)*50;return t.includes(a)||t.push(a),t.includes(a+50)||t.push(a+50),t.filter(n=>Math.abs((n-e)/e)*100<=2)}function zn(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),a=e[e.length-1].close,n=(t+s+a)/3,r=2*n-s,i=2*n-t,l=n+(t-s),o=n-(t-s);return{pp:n,r1:r,s1:i,r2:l,s2:o}}function Xn(e,t,s){if(e.length<3)return"NONE";const a=e.slice(-3),n=a[1];if(a[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&n.close<=s.level)return"BREAKOUT";if(t<s.level&&n.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&n.close>=s.level)return"BREAKOUT";if(t>s.level&&n.close<=s.level)return"BOUNCE"}return"NONE"}function Kn(e,t){const s=e.level.toFixed(2),a=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${a}% away)`}function Zn(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function Qn(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),a=t.slice(-10),n=Jn(a);if(n.highs.length<2&&n.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const r=er(s,n),i=tr(s,n);return r.type!=="NONE"&&i.type===r.type?{type:r.type,category:r.category,indicator:"BOTH",strength:95,description:`${r.type} ${r.category} (RSI+MACD)`,confidence:90}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"RSI",strength:80,description:`${r.type} ${r.category} (RSI)`,confidence:75}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"MACD",strength:70,description:`${i.type} ${i.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function Jn(e){const t=[],s=[];for(let n=2;n<e.length-2;n++){const r=e[n];let i=!0;for(let o=n-2;o<=n+2;o++)if(o!==n&&e[o].high>=r.high){i=!1;break}i&&t.push({index:n,price:r.high});let l=!0;for(let o=n-2;o<=n+2;o++)if(o!==n&&e[o].low<=r.low){l=!1;break}l&&s.push({index:n,price:r.low})}return{highs:t,lows:s}}function er(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[a,n]=s,r=e[a.index].rsi,i=e[n.index].rsi;if(n.price<a.price&&i>r)return{type:"BULLISH",category:"REGULAR"};if(n.price>a.price&&i<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[a,n]=s,r=e[a.index].rsi,i=e[n.index].rsi;if(n.price>a.price&&i<r)return{type:"BEARISH",category:"REGULAR"};if(n.price<a.price&&i>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function tr(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[a,n]=s,r=e[a.index].macd_histogram,i=e[n.index].macd_histogram;if(n.price<a.price&&i>r)return{type:"BULLISH",category:"REGULAR"};if(n.price>a.price&&i<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[a,n]=s,r=e[a.index].macd_histogram,i=e[n.index].macd_histogram;if(n.price>a.price&&i<r)return{type:"BEARISH",category:"REGULAR"};if(n.price<a.price&&i>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function sr(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function ar(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",a=e.type,n=e.category,r=e.indicator;return`${s} Layer 14: ${a} ${n} divergence (${r}, ${e.strength}/100)`}function nr(e,t,s,a){const n=(_,y)=>{const E=parseFloat(String(_));return isNaN(E)?y:E},r=n(e.ema_12,a),i=n(t.ema_26,a),l=n(s.sma_200,a),o=Bt(a,r),c=Bt(a,i),d=Bt(a,l),u=o===c&&c===d&&o!=="NEUTRAL",m=o===c&&o!=="NEUTRAL"||o===d&&o!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let p=0,g="",f="";return u?(p=100,g=`ALL ${o}`,f=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):m?(p=65,o===c?(g=`5M+15M ${o}`,f=`5m & 15m ${o.toLowerCase()} (1h ${d.toLowerCase()})`):o===d?(g=`5M+1H ${o}`,f=`5m & 1h ${o.toLowerCase()} (15m ${c.toLowerCase()})`):(g=`15M+1H ${c}`,f=`15m & 1h ${c.toLowerCase()} (5m ${o.toLowerCase()})`)):(p=30,g="MIXED",f=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:o,tf15m:c,tf1h:d,allAligned:u,twoAligned:m,alignment:g,strength:p,description:f}}function Bt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function rr(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function ir(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function or(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],a=e[0],n=s.close,r=(s.close-a.close)/a.close*100;let i="FLAT";r>.1?i="UP":r<-.1&&(i="DOWN");let l="NEUTRAL";i==="DOWN"?l="BULLISH":i==="UP"&&(l="BEARISH");const o=Math.abs(r);let c=-.8,d=0;o>.3?d=90:o>.2?d=75:o>.1?d=60:d=40;const u=new Date(s.timestamp),p=Math.floor((new Date().getTime()-u.getTime())/6e4),g=cr(n,r,i,l,d);return{dxyPrice:n,dxyChange:r,dxyTrend:i,goldSignalSupport:l,correlation:c,strength:d,description:g,dataAge:p}}function lr(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function cr(e,t,s,a,n){const r=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${r} → Gold BULLISH (${n}/100)`:s==="UP"?`DXY up ${r} → Gold BEARISH (${n}/100)`:`DXY flat ${r} → Neutral (${n}/100)`}async function dr(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[DXY] No data returned from API"),[]):a.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function ur(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function pr(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function mr(e,t,s=15){const a=await pr(e);if(a.length>0){const r=new Date(a[a.length-1].timestamp),l=(new Date().getTime()-r.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),a}console.log("[DXY] Fetching fresh DXY data from API...");const n=await dr(t);return n.length>0?(await ur(e,n),n):(console.log("[DXY] Fetch failed, using stale cache"),a)}function gr(e,t,s){const a=Qt("Silver (XAG/USD)",e),n=Qt("Crude Oil (WTI)",t);let r=0;a&&Lt(a.trend,s)&&r++,n&&Lt(n.trend,s)&&r++;let i=0;const l=r>=1;r===2?i=95:r===1?i=70:i=30;const o=fr(a,n,r,s);return{silver:a,oil:n,aligned:l,alignmentCount:r,strength:i,description:o}}function Qt(e,t){if(t.length<2)return null;const s=t[t.length-1],a=t[0],n=s.close,r=(s.close-a.close)/a.close*100;let i="FLAT";r>.2?i="UP":r<-.2&&(i="DOWN");const l=Math.abs(r);let o=0;return l>1?o=90:l>.5?o=75:l>.2?o=60:o=40,{symbol:e,price:n,change:r,trend:i,strength:o}}function Lt(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function fr(e,t,s,a){if(s===2)return`Silver & Oil both ${a==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&Lt(e.trend,a))return`Silver ${e.trend.toLowerCase()} confirms Gold ${a}`;if(t&&Lt(t.trend,a))return`Oil ${t.trend.toLowerCase()} confirms Gold ${a}`}const n=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",r=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${n}, ${r} (mixed signals)`}async function _r(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[SILVER] No data returned from API"),[]):a.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function hr(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[OIL] No data returned from API"),[]):a.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function yr(e,t,s){try{const a=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const n of s)await e.prepare(`
      ...
      DELETE FROM ${a}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(a){console.error(`[${t}] Error storing data:`,a.message)}}async function br(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",a=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!a.results||a.results.length===0?[]:a.results.map(n=>({close:n.close,timestamp:n.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function Jt(e,t,s,a=15){const n=await br(e,s);if(n.length>0){const i=new Date(n[n.length-1].timestamp),o=(new Date().getTime()-i.getTime())/6e4;if(o<a)return console.log(`[${s}] Using cached data (${o.toFixed(1)}min old)`),n}console.log(`[${s}] Fetching fresh data from API...`);const r=s==="SILVER"?await _r(t):await hr(t);return r.length>0?(await yr(e,s,r),r):(console.log(`[${s}] Fetch failed, using stale cache`),n)}function Er(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),n=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let r="NEUTRAL",i="NEUTRAL",l=50;const o=e.percentile;if(o>=90?(r="EXTREME_BULLISH",i="BULLISH",l=95):o>=70?(r="BULLISH",i="BULLISH",l=80):o<=30?(r="BEARISH",i="BEARISH",l=80):o<=10?(r="EXTREME_BEARISH",i="BEARISH",l=95):(r="NEUTRAL",i="NEUTRAL",l=50),e.largeSpecNet>0){const d=vr(e.largeSpecNet);d>=95?i==="BEARISH"?l+=10:i==="BULLISH"&&(l-=15):d<=5&&(i==="BULLISH"?l+=10:i==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const c=Sr(r,o,n);return{currentPosition:e,positioning:r,goldSignalSupport:i,strength:l,description:c,dataAge:n}}function vr(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function wr(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Sr(e,t,s){const a=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${a}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${a}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${a}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${a}]`:`COT: Neutral positioning (${t}th percentile) [${a}]`}async function xr(){return null}async function Tr(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function kr(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function Lr(e){const t=await kr(e);if(t){const a=new Date(t.timestamp),r=(new Date().getTime()-a.getTime())/(1e3*60*60*24);if(r<7)return console.log(`[COT] Using cached data (${r.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await xr();return s?(await Tr(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Rr(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const _t=new he;_t.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const a=s.toISOString();console.log("[5M-SCANNER] Starting scan at",a),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).first(),i=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(console.log("[5M-SCANNER] Step 6: Indicators fetched, checking data"),!n||!r||!i)return console.log("[5M-SCANNER] Missing data, skipping scan"),e.json({success:!1,message:"Insufficient data for scan"});const o=(await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = '5m'
      ORDER BY timestamp DESC 
      LIMIT 100
    `).all()).results.map(g=>({timestamp:g.timestamp,open:Number(g.open),high:Number(g.high),low:Number(g.low),close:Number(g.close),volume:Number(g.volume)||0})).reverse(),c=o[o.length-1].close;console.log("[5M-SCANNER] Step 7: Starting 7-layer analysis");const d=await Ir(t,n,r,i,o,c);console.log("[5M-SCANNER] Step 8: Analysis complete:",{grade:d.grade,score:d.score,signal:d.signal}),console.log("[5M-SCANNER] Step 9: Saving to database");const u=new Date().toISOString();console.log("[5M-SCANNER] Step 10: Timestamp created:",u),await t.prepare(`
    ...
    `).all(),i=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:a.results,session_stats:n.results,best_hours:r.results,recent_a_grade:i.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});_t.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});_t.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),a={};for(const c of s.results||[])a[c.setting_key]=c.setting_value;if(!a.telegram_bot_token||!a.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const n=4386.5,r=15,i={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:n-r,tp1:n+r*2,tp2:n+r*3,tp3:n+r*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Is(i,n),o=await K({botToken:a.telegram_bot_token,chatId:a.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Ir(e,t,s,a,n,r){console.log("[ANALYZE] Starting analysis");let i=0,l=0;const o=[],c=(Q,Ye)=>{const bt=parseFloat(String(Q));return isNaN(bt)?Ye:bt};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,r),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},u={ema50:c(s.ema_26,r)},m={sma200:c(a.sma_200,r)},p=r>d.ema20&&r>u.ema50&&r>m.sma200,g=r<d.ema20&&r<u.ema50&&r<m.sma200;p||g?(i+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${p?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const f=d.rsi>=40&&d.rsi<=60,_=d.macd>d.macd_signal&&d.macd_histogram>0,y=d.macd<d.macd_signal&&d.macd_histogram<0;f&&(p?_:y)?(i+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${p?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${f?"no crossover":"extreme"}`);const E=n.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,S=n[n.length-1].volume;S>E*1.5?(i+=15,l++,o.push(`✅ Layer 3: Volume spike ${(S/E).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(S/E).toFixed(1)}x (need 1.5x+)`);const x=Math.max(...n.slice(-20).map(Q=>Q.high)),v=Math.min(...n.slice(-20).map(Q=>Q.low)),O=r>x*.999,V=r<v*1.001;p&&O||g&&V?(i+=15,l++,o.push(`✅ Layer 4: ${p?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let L=null;try{L=await xs(n),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const T=(L==null?void 0:L.liquidity_score)||50,M=(L==null?void 0:L.session)||"UNKNOWN";T>=70?(i+=15,l++,o.push(`✅ Layer 5: Liquidity ${T}/100 (${M} session)`)):o.push(`❌ Layer 5: Liquidity ${T}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const W=ft();console.log("[ANALYZE] Calendar check complete"),W.riskLevel==="safe"?(i+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${W.reason}`);const X=d.adx>25,R=d.adx>70;X&&!R?(i+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):R?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let Y="HOLD";(p||g)&&l>=5&&(Y=p?"BUY":"SELL");const ce=new Date,A=In(ce);A.hasBoost?(i+=8,l++,o.push(`✅ Layer 8: ${A.reason} (+${A.boost}% win)`)):o.push(`ℹ️ Layer 8: ${A.reason}`);const z=An(ce);z.hasBoost?(i+=5,l++,o.push(`✅ Layer 9: ${z.reason} (+${z.boost}% win)`)):o.push(`ℹ️ Layer 9: ${z.reason}`);const ee=c(t.atr_14,r*.01),ne=n.slice(-20).reduce((Q,Ye)=>{const bt=Ye.high-Ye.low;return Q+bt},0)/20;if(Dn(ee,ne)){i+=7,l++;const Q=((ee/ne-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-ee/ne)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const k=$n(n.slice(-20));Rs(k,Y)&&k.strength>=60&&(i+=10,l++),o.push(Mn(k,Y));const F=Nn(n.slice(-3)),{aligned:Se,strongestPattern:B}=Vn(F,Y);Se&&B?(i+=12,l++,o.push(`✅ Layer 12: ${B.name} (${B.strength}/100)`)):F.length>0&&F[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${F[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const D=Gn(n,r);Zn(D,Y)&&D.nearZone?(i+=8,l++,o.push(`✅ Layer 13: ${D.description}`)):D.nearZone?o.push(`⚠️ Layer 13: ${D.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const oe=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),C=Qn(oe,n.slice(-10)),J=sr(C,Y,p?"BULLISH":g?"BEARISH":"NEUTRAL");J&&C.strength>=70&&(i+=9,l++),o.push(ar(C,J));const Z=nr(t,s,a,r),Yt=rr(Z,Y);Yt&&(Z.allAligned||Z.twoAligned)&&(i+=6,l++),o.push(ir(Z,Yt));const Dt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),$t=(Dt==null?void 0:Dt.setting_value)||"70140f57bea54c5e90768de696487d8f",Vs=await mr(e,$t,15),nt=or(Vs);lr(nt,Y)&&nt.strength>=60?(i+=5,l++,o.push(`✅ Layer 18: ${nt.description}`)):nt.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${nt.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Gs=await Jt(e,$t,"SILVER",15),qs=await Jt(e,$t,"OIL",15),We=gr(Gs,qs,Y);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;i+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const zs=await Lr(e)||Rr(),xe=Er(zs);if(wr(xe,Y)&&xe.strength>=70){const Q=xe.positioning.includes("EXTREME")?7:4;i+=Q,l++,o.push(`✅ Layer 20: ${xe.description} (${xe.strength}/100)`)}else xe.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${xe.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${xe.description}`);let yt="C";i>=162?yt="A+":i>=144?yt="A":i>=126&&(yt="B"),(p||g)&&l>=7&&(Y=p?"BUY":"SELL");const Te=Math.max(ee*1.5,r*.003),Xs=Y==="BUY"?r-Te:r+Te,Ks=Y==="BUY"?r+Te*2:r-Te*2,Zs=Y==="BUY"?r+Te*3:r-Te*3,Qs=Y==="BUY"?r+Te*4:r-Te*4;return{grade:yt,score:i,signal:Y,confidence:i,layersPassed:l,layers:o,stopLoss:Xs,tp1:Ks,tp2:Zs,tp3:Qs,liquidityScore:T,session:M,adx:d.adx,rsi:d.rsi,volumeRatio:S/E}}function Is(e,t){const s=e.signal==="BUY"?"🟢":"🔴",a=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",n=new Date,r=`${n.getUTCHours().toString().padStart(2,"0")}:${n.getUTCMinutes().toString().padStart(2,"0")}`;let i=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,i+="Next scan in 5 minutes...",i}async function st(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(e).first();if(!n)return{success:!1,error:"Trade not found or already closed"};const r=n.trade_type==="BUY"?t-n.entry_price:n.entry_price-t,i=r*n.position_size,l=r/n.entry_price*100,o=i>0?1:0;await a.prepare(`
      UPDATE live_trades
      SET exit_price = ?,
          exit_time = ?,
          exit_reason = ?,
      ...
      WHERE id = ?
    `).bind(t,new Date().toISOString(),s,i,l,o,e).run();const d=(await st(a)).current_balance+i;return await a.prepare(`
      UPDATE risk_limits
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await Ms(a),await Dr(a),await $r(a),{success:!0,profit_loss:i}}catch(n){return{success:!1,error:n.message}}}async function Ms(e){const t=await st(e),s=await e.prepare(`
    SELECT position_size, entry_price, stop_loss FROM live_trades WHERE status = 'OPEN'
  `).all();let a=0;for(const r of s.results||[]){const i=r,o=Math.abs(i.entry_price-i.stop_loss)*i.position_size;a+=o}const n=a/t.current_balance*100;await e.prepare(`
    UPDATE risk_limits
    SET current_portfolio_risk = ?,
        updated_at = CURRENT_TIMESTAMP
    WHERE id = 1
  `).bind(n).run()}async function Dr(e){const t=new Date().toISOString().split("T")[0],s=await e.prepare(`
    SELECT * FROM live_trades 
    WHERE DATE(exit_time) = ? AND status = 'CLOSED'
  `).bind(t).all();if(s.results.length===0)return;const a=s.results,n=a.length,r=a.filter(p=>p.win===1).length,i=a.filter(p=>p.win===0).length,l=r/n*100,o=a.reduce((p,g)=>p+(g.profit_loss||0),0),c=Math.max(...a.map(p=>p.profit_loss||0)),d=Math.min(...a.map(p=>p.profit_loss||0)),u=a.reduce((p,g)=>p+(g.confidence||0),0)/n,m=a.reduce((p,g)=>p+(g.mtf_score||0),0)/n;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,n,r,i,l,o,c,d,u,m).run()}async function $r(e){const t=await st(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,a=new Date().toISOString().split("T")[0],n=await e.prepare(`
    SELECT total_profit_loss FROM daily_performance WHERE trade_date = ?
  `).bind(a).first(),r=(n==null?void 0:n.total_profit_loss)<0?Math.abs(n.total_profit_loss/t.starting_balance*100):0;await e.prepare(`
    UPDATE risk_limits
  ...
  `).bind(s,r).run();let i=!1,l="";s>=t.max_drawdown_pct?(i=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):r>=t.max_daily_loss_pct&&(i=!0,l=`Daily loss ${r.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),i&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s).run(),e.json({success:!0,message:"Event deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});function Os(e,t,s){const a=s.find(y=>t.confidence>=y.confidence_min&&t.confidence<=y.confidence_max);if(!a)return{units:0,value:0,risk_amount:0,risk_pct:0,position_pct:0,stop_loss_distance:0,reward_risk_ratio:0,is_valid:!1,warning:`No position sizing rule found for confidence ${t.confidence}%`};const n=Math.abs(t.entry_price-t.stop_loss),i=e.current_balance*(a.risk_pct/100)/n,l=i*t.entry_price;l/e.current_balance*100;const o=e.current_balance*(a.max_position_pct/100);let c=i,d=l,u=a.risk_pct,m;l>o&&(d=o,c=o/t.entry_price,u=c*n/e.current_balance*100,m=`Position reduced to ${a.max_position_pct}% max position size`);const g=Math.abs(t.take_profit_1-t.entry_price)/n;let f=!0;const _=[];return m&&_.push(m),g<1.5&&_.push(`Low reward:risk ratio (${g.toFixed(2)}:1). Recommended: >1.5:1`),u>e.max_daily_loss_pct&&(f=!1,_.push(`Risk ${u.toFixed(2)}% exceeds max daily loss ${e.max_daily_loss_pct}%`)),c<.01&&(f=!1,_.push("Position size too small (minimum 0.01 lots)")),{units:parseFloat(c.toFixed(2)),value:parseFloat(d.toFixed(2)),risk_amount:parseFloat((c*n).toFixed(2)),risk_pct:parseFloat(u.toFixed(2)),position_pct:parseFloat((d/e.current_balance*100).toFixed(2)),stop_loss_distance:parseFloat(n.toFixed(2)),reward_risk_ratio:parseFloat(g.toFixed(2)),is_valid:f,warning:_.length>0?_.join("; "):void 0}}function Cs(e,t,s,a,n=0){let r;a==="BUY"?r=(t-e)*s:r=(e-t)*s,r-=n;const i=(t-e)/e*100,l=Math.abs(t-e)/.01;return{profit_loss:parseFloat(r.toFixed(2)),profit_loss_pct:parseFloat(i.toFixed(2)),pips:parseFloat(l.toFixed(1))}}function Mr(e,t){const s=t.filter(l=>l.profit_loss<0).reduce((l,o)=>l+o.profit_loss,0),a=Math.abs(s/e.current_balance)*100,n=a>=e.max_daily_loss_pct,i=e.current_balance*(e.max_daily_loss_pct/100)-Math.abs(s);return{current_loss:parseFloat(s.toFixed(2)),current_loss_pct:parseFloat(a.toFixed(2)),limit_exceeded:n,remaining:parseFloat(i.toFixed(2))}}function Nr(e){const t=e.filter(f=>f.status==="CLOSED"),s=t.filter(f=>f.profit_loss>0),a=t.filter(f=>f.profit_loss<0),n=s.reduce((f,_)=>f+_.profit_loss,0),r=Math.abs(a.reduce((f,_)=>f+_.profit_loss,0)),i=n-r,l=s.length>0?n/s.length:0,o=a.length>0?r/a.length:0,c=t.length>0?s.length/t.length*100:0,d=r>0?n/r:n,u=100-c,m=c/100*l-u/100*o,p=s.length>0?Math.max(...s.map(f=>f.profit_loss)):0,g=a.length>0?Math.min(...a.map(f=>f.profit_loss)):0;return{total_trades:t.length,winning_trades:s.length,losing_trades:a.length,win_rate:parseFloat(c.toFixed(2)),total_profit:parseFloat(n.toFixed(2)),total_loss:parseFloat(r.toFixed(2)),net_profit:parseFloat(i.toFixed(2)),avg_win:parseFloat(l.toFixed(2)),avg_loss:parseFloat(o.toFixed(2)),profit_factor:parseFloat(d.toFixed(2)),expectancy:parseFloat(m.toFixed(2)),largest_win:parseFloat(p.toFixed(2)),largest_loss:parseFloat(g.toFixed(2))}}function Fr(e){return e.is_valid?`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ht=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Nr,calculatePositionSize:Os,calculateProfitLoss:Cs,checkDailyLossLimit:Mr,formatPositionSize:Fr},Symbol.toStringTag,{value:"Module"}));async function Bs(e,t,s){const a=Date.now(),n=[],r=[];let i=t.starting_balance,l=t.starting_balance;const o=e.filter(A=>{const z=new Date(A.timestamp);return z>=new Date(t.start_date)&&z<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:i,max_daily_loss_pct:2};for(let A=200;A<o.length;A++){const z=o.slice(A-200,A),ee=_e(z);if(!ee)continue;const ne=o[A],re=ne.close,k=ae(re,ee,"day_trade"),j=ae(re,ee,"swing_trade");for(const F of[k,j]){if(F.signal_type==="HOLD"||F.confidence<t.min_confidence)continue;c.current_balance=i;const Se=Os(c,{entry_price:F.price,stop_loss:F.stop_loss,take_profit_1:F.take_profit_1,take_profit_2:F.take_profit_2,take_profit_3:F.take_profit_3,confidence:F.confidence,signal_type:F.signal_type,trading_style:F.trading_style},s);if(!Se.is_valid)continue;const B=ne.timestamp,D=F.price;let G=null,w=null,oe="UNKNOWN";const C=Math.min(50,o.length-A-1);for(let J=1;J<=C;J++){const Z=o[A+J];if(F.signal_type==="BUY"){if(Z.low<=F.stop_loss){G=F.stop_loss,w=Z.timestamp,oe="STOP_LOSS";break}if(Z.high>=F.take_profit_3){G=F.take_profit_3,w=Z.timestamp,oe="TP3";break}if(Z.high>=F.take_profit_2){G=F.take_profit_2,w=Z.timestamp,oe="TP2";break}if(Z.high>=F.take_profit_1){G=F.take_profit_1,w=Z.timestamp,oe="TP1";break}}else{if(Z.high>=F.stop_loss){G=F.stop_loss,w=Z.timestamp,oe="STOP_LOSS";break}if(Z.low<=F.take_profit_3){G=F.take_profit_3,w=Z.timestamp,oe="TP3";break}if(Z.low<=F.take_profit_2){G=F.take_profit_2,w=Z.timestamp,oe="TP2";break}if(Z.low<=F.take_profit_1){G=F.take_profit_1,w=Z.timestamp,oe="TP1";break}}}if(!G||!w)continue;const je=Cs(D,G,Se.units,F.signal_type,t.commission_per_trade);i+=je.profit_loss,i>l&&(l=i),n.push({entry_time:B,entry_price:D,exit_time:w,exit_price:G,signal_type:F.signal_type,trading_style:F.trading_style,position_size:Se.units,profit_loss:je.profit_loss,profit_loss_pct:je.profit_loss_pct,exit_reason:oe,confidence:F.confidence}),r.push({date:w,balance:i})}}const d=n.filter(A=>A.profit_loss>0),u=n.filter(A=>A.profit_loss<0),m=d.reduce((A,z)=>A+z.profit_loss,0),p=Math.abs(u.reduce((A,z)=>A+z.profit_loss,0)),g=i-t.starting_balance,f=n.length>0?d.length/n.length*100:0,_=d.length>0?m/d.length:0,y=u.length>0?p/u.length:0,E=d.length>0?Math.max(...d.map(A=>A.profit_loss)):0,S=u.length>0?Math.min(...u.map(A=>A.profit_loss)):0,b=p>0?m/p:m,x=100-f,v=f/100*_-x/100*y;let O=0,V=0,L=t.starting_balance;for(const A of r){A.balance>L&&(L=A.balance);const z=L-A.balance,ee=z/L*100;z>O&&(O=z,V=ee)}const T=n.map(A=>A.profit_loss_pct),M=T.reduce((A,z)=>A+z,0)/T.length,I=Math.sqrt(T.reduce((A,z)=>A+Math.pow(z-M,2),0)/T.length),W=I>0?M/I:0;let H=0,X=0,R=0,Y=0;for(const A of n)A.profit_loss>0?(R++,Y=0,H=Math.max(H,R)):(Y++,R=0,X=Math.max(X,Y));const ce=Date.now()-a;return{config:t,total_trades:n.length,winning_trades:d.length,losing_trades:u.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(_.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(E.toFixed(2)),largest_loss:parseFloat(S.toFixed(2)),max_drawdown:parseFloat(O.toFixed(2)),max_drawdown_pct:parseFloat(V.toFixed(2)),profit_factor:parseFloat(b.toFixed(2)),sharpe_ratio:parseFloat(W.toFixed(2)),expectancy:parseFloat(v.toFixed(2)),max_consecutive_wins:H,max_consecutive_losses:X,starting_balance:t.starting_balance,ending_balance:parseFloat(i.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:n,equity_curve:r,execution_time_ms:ce}}function Ps(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Or=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Ps,runBacktest:Bs},Symbol.toStringTag,{value:"Module"})),at=new he;at.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp ASC
    `).all();if(a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Have ${a.results.length} candles, need at least 200. System has been collecting data since Dec 26 - wait a few more days or reduce timeframe.`},400);const n=a.results.map(d=>({timestamp:d.timestamp,open:d.open,high:d.high,low:d.low,close:d.close,volume:d.volume||0})),r={start_date:s.start_date||new Date(Date.now()-365*24*60*60*1e3).toISOString(),end_date:s.end_date||new Date().toISOString(),starting_balance:s.starting_balance||1e4,min_confidence:s.min_confidence||75,use_mtf_confirmation:s.use_mtf_confirmation!==!1,use_news_filter:s.use_news_filter!==!1,timeframe:s.timeframe||"1h",commission_per_trade:s.commission_per_trade||0},l=await Bs(n,r,[{confidence_min:90,confidence_max:100,risk_pct:2,max_position_pct:10},{confidence_min:80,confidence_max:89,risk_pct:1.5,max_position_pct:7.5},{confidence_min:75,confidence_max:79,risk_pct:1,max_position_pct:5},{confidence_min:70,confidence_max:74,risk_pct:.5,max_position_pct:2.5}]),o=await t.prepare(`
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Hs=new he;Hs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
    ...
    `).all();let a="";for(const T of s.results||[])T.setting_key==="twelve_data_api_key"&&(a=T.setting_value);let n=[];if(a&&a!=="your_api_key_here")try{const T=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,I=await(await fetch(T)).json();I.values&&I.values.length>=50&&(n=I.values.reverse().map(W=>({timestamp:W.datetime,open:parseFloat(W.open),high:parseFloat(W.high),low:parseFloat(W.low),close:parseFloat(W.close),volume:parseFloat(W.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",n.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(n.length===0){const T=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!T.results||T.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);n=T.results.reverse().map(M=>({timestamp:M.timestamp,open:M.open,high:M.high,low:M.low,close:M.close,volume:M.volume||0}))}const r=_e(n);if(!r)return e.json({success:!1,error:"Failed to calculate indicators"},400);const i=n[n.length-1].close,l=ae(i,r,"day_trade");console.log("[AI-ANALYSIS] Current price:",i,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const T of["5m","15m","1h","4h","daily"]){const M=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(T).first();M&&(o[T]=M)}const c=jt(o,i),d=n.slice(-50),u=d.map(T=>T.high).sort((T,M)=>M-T),m=d.map(T=>T.low).sort((T,M)=>T-M),p=[Math.max(...u.slice(0,10))],g=[Math.min(...m.slice(0,10))];i>r.sma_20?g.push(r.sma_20):p.push(r.sma_20),i>r.sma_50?g.push(r.sma_50):p.push(r.sma_50),i>r.vwap?g.push(r.vwap):p.push(r.vwap);const f=Math.round(i/10)*10;f>i?p.push(f):g.push(f);const _=[...new Set(p)].sort((T,M)=>T-M).filter(T=>T>i).slice(0,3),y=[...new Set(g)].sort((T,M)=>M-T).filter(T=>T<i).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",_);const E=r.atr_14/i*100;let S="NORMAL";E>3?S="EXTREME":E>1.5?S="HIGH":E<.5&&(S="LOW");const b=[];let x=30,v=30,O=40;c.type==="ALL_BULLISH"?(x=60,v=20,O=20):c.type==="ALL_BEARISH"?(x=20,v=60,O=20):c.score>=4&&(c.trends.filter(T=>T.trend==="BULLISH").length>=4?(x=50,v=25,O=25):(x=25,v=50,O=25)),_.length>0&&b.push({name:"📈 BULLISH CONTINUATION",probability:x,description:`Price breaks above $${_[0].toFixed(2)} and rallies toward $${(_[_.length-1]||i*1.02).toFixed(2)}`,trigger:`Breakout above $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||i*1.02}),y.length>0&&b.push({name:"📉 BEARISH CORRECTION",probability:v,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||i*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||i*.98}),b.push({name:"↔️ CONTINUED RANGING",probability:O,description:`Price oscillates between $${(y[0]||i*.99).toFixed(2)} and $${(_[0]||i*1.01).toFixed(2)} with choppy action`,trigger:S==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),b.sort((T,M)=>M.probability-T.probability);let V={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?V={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(i-5).toFixed(2)}-${i.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(V={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${i.toFixed(2)}-${(i+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):S==="EXTREME"?V.reason=`⚠️ EXTREME volatility (ADX ${r.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(V.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${_[0]?`breakout above $${_[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let L=!1;try{const T=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,I+=`${V.reason}`,L=await K({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},I),console.log("[AI-ANALYSIS] Telegram sent:",L)}}catch(T){console.error("[AI-ANALYSIS] Telegram error:",T.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:i,signal:l.signal_type,confidence:l.confidence,volatility:S,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:_,support:y},scenarios:b,recommendation:V,telegram_sent:L}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const U=new he;U.use("/api/*",Fa());U.route("/api/signals/enhanced",ks);U.route("/api/signals/simple",Ls);U.route("/api/scanner",_t);U.route("/api/trades",fe);U.route("/api/calendar",$e);U.route("/api/backtest",at);U.route("/api/telegram",Us);U.route("/api/ai",Hs);U.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));U.get("/api/signals/recent",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),a={};for(const n of s.results||[])a[n.setting_key]=n.setting_value;return e.json({success:!0,settings:a})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/settings",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[a,n]of Object.entries(s))await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),a={};for(const r of s.results||[])a[r.setting_key]=r.setting_value;const n=await K({botToken:a.telegram_bot_token,chatId:a.telegram_chat_id},`🔔 <b>Test Alert</b>
...
✅ Telegram alerts are active.`);return e.json({success:n})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,o=await(await fetch(i)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=o.values,d=c.map(g=>t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(g.datetime,parseFloat(g.open)||0,parseFloat(g.high)||0,parseFloat(g.low)||0,parseFloat(g.close)||0,parseInt(g.volume||"0")||0,"1h"));await t.batch(d);const u=c.length,m=c[0],p=parseFloat(m.close);return e.json({success:!0,count:u,price:p,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});U.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,o=await(await fetch(i)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const d=o.values.map(p=>({timestamp:p.datetime,open:parseFloat(p.open)||0,high:parseFloat(p.high)||0,low:parseFloat(p.low)||0,close:parseFloat(p.close)||0,volume:0})),u=d.map(p=>t.prepare(`
      ...
      `).bind(p.timestamp,p.open,p.high,p.low,p.close,p.volume));await t.batch(u);const m=d.length;if(d.length>=50){const p=_e(d.reverse());if(p){await t.prepare(`
        ...
        `).bind(p.rsi_14,p.macd,p.macd_signal,p.macd_histogram,p.sma_20,p.sma_50,p.sma_200,p.ema_12,p.ema_26,p.bb_upper,p.bb_middle,p.bb_lower,p.atr_14,p.stochastic_k,p.stochastic_d,p.adx,p.plus_di,p.minus_di,p.ichimoku_tenkan,p.ichimoku_kijun,p.ichimoku_senkou_a,p.ichimoku_senkou_b,p.parabolic_sar,p.vwap,p.fib_382||0,p.fib_500||0,p.fib_618||0).run();const g=d[d.length-1].close,f=ae(g,p,"day_trade"),_=ae(g,p,"swing_trade"),y=70;for(const E of[f,_])if(E.confidence>=y&&E.signal_type!=="HOLD"){await t.prepare(`
              INSERT INTO signals 
            ...
            `).bind(E.signal_type,E.trading_style,E.price,E.stop_loss,E.take_profit_1,E.take_profit_2,E.take_profit_3,E.confidence,E.reason).run();const S=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),b={};for(const x of S.results||[])b[x.setting_key]=x.setting_value;b.telegram_bot_token&&b.telegram_chat_id&&await K({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},lt(E))}}}return e.json({success:!0,count:m})}catch(s){return e.json({success:!1,error:s.message},500)}});U.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),a={};for(const v of s.results)a[v.setting_key]=v.setting_value;const n=a.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",r=a.telegram_bot_token,i=a.telegram_chat_id,c=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,u=await(await fetch(c)).json();if(u.code&&u.status==="error")return e.json({success:!1,error:u.message||"API error",telegram_sent:!1});if(!u.values||!Array.isArray(u.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const p=u.values.map(v=>({timestamp:v.datetime,open:parseFloat(v.open)||0,high:parseFloat(v.high)||0,low:parseFloat(v.low)||0,close:parseFloat(v.close)||0,volume:parseInt(v.volume||"0")||0})),g=p.map(v=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(v.timestamp,v.open,v.high,v.low,v.close,v.volume,"1h"));await t.batch(g);const f=_e(p);if(!f)return e.json({success:!0,count:p.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});const _=p[p.length-1].close,y=ae(_,f,"day_trade"),E=ae(_,f,"swing_trade"),S=70;let b=!1;const x=[];if(r&&i&&r!=="your_bot_token_here"){if(y.confidence>=S&&y.signal_type!=="HOLD"){const v=y.signal_type==="BUY"?"🟢":"🔴",O=`${v} GOLD/USD ${y.signal_type} SIGNAL ${v}
...
⏰ ${new Date().toLocaleString()}`;await K({botToken:r,chatId:i},O)&&(b=!0,x.push("Day Trade"))}if(E.confidence>=80&&E.signal_type!=="HOLD"){const v=E.signal_type==="BUY"?"🟢":"🔴",O=`${v} GOLD/USD ${E.signal_type} SIGNAL ${v}
...
⏰ ${new Date().toLocaleString()}`;await K({botToken:r,chatId:i},O)&&(b=!0,x.push("Swing Trade"))}}return console.log(`[CRON] Processed ${p.length} candles, Telegram: ${b?"SENT":"NOT SENT"}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:p.length,latest_price:_},signals:{day_trade:{type:y.signal_type,confidence:y.confidence,price:_},swing_trade:{type:E.signal_type,confidence:E.confidence,price:_}},telegram:{configured:!!(r&&i),sent:b,alerts:x},message:b?`✅ Alerts sent: ${x.join(", ")}`:"⚪ No alerts (criteria not met or market in HOLD)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});U.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const n="XAU/USD",r=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let i=0;const l={};for(const o of r){const c=`https://api.twelvedata.com/time_series?symbol=${n}&interval=${o.interval}&apikey=${a}&outputsize=${o.outputsize}`,u=await(await fetch(c)).json();if(u.code&&u.status==="error"){l[o.dbKey]={success:!1,error:u.message,count:0};continue}if(!u.values||!Array.isArray(u.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const m=u.values;let p=0;const g=[];for(const f of m){const _={timestamp:f.datetime,open:parseFloat(f.open),high:parseFloat(f.high),low:parseFloat(f.low),close:parseFloat(f.close),volume:0};g.push(_),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(_.timestamp,_.open,_.high,_.low,_.close,_.volume,o.dbKey).run(),p++}if(g.length>=50){const f=_e(g.reverse());f&&await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const a=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),n=_e(a);if(!n)return e.json({success:!1,error:"Failed to calculate indicators"});const r=a[a.length-1].close,i=ae(r,n,"day_trade"),l=ae(r,n,"swing_trade");return e.json({success:!0,signals:{day_trade:i,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:a,formatAlignmentReport:n}=await Promise.resolve().then(()=>Ss),r=["5m","15m","1h","4h","daily"],i={};for(const v of r){const O=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(v).first();O&&(i[v]=O)}const l=Object.keys(i).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(i)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(i,c),u=i["1h"],m=ae(c,u,"day_trade"),p=ae(c,u,"swing_trade"),g=a(m.signal_type,d),f=a(p.signal_type,d),_={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${g.reason}`},y={...p,base_confidence:p.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${p.reason}, MTF: ${f.reason}`},E=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),S={};for(const v of E.results||[])S[v.setting_key]=v.setting_value;let b=!1,x=[];S.telegram_bot_token&&S.telegram_chat_id&&(_.isValid&&_.signal_type!=="HOLD"&&await K({botToken:S.telegram_bot_token,chatId:S.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({..._,timestamp:new Date().toISOString()})}

📊 ${n(d)}`)&&(x.push("day_trade"),b=!0),await new Promise(v=>setTimeout(v,1e3)),y.isValid&&y.signal_type!=="HOLD"&&await K({botToken:S.telegram_bot_token,chatId:S.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...y,timestamp:new Date().toISOString()})}

📊 ${n(d)}`)&&(x.push("swing_trade"),b=!0));for(const v of[_,y])v.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(v.signal_type,v.trading_style,v.price,v.stop_loss,v.take_profit_1,v.take_profit_2,v.take_profit_3,v.base_confidence,v.mtf_confidence,v.final_confidence,v.alignment_score,v.alignment_type,v.reason,b?1:0).run();return e.json({success:!0,signals:{day_trade:_,swing_trade:y},alignment:d,alignment_report:n(d),telegram_sent:b,sent_to_telegram:x,available_timeframes:Object.keys(i)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});U.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('twelve_data_api_key')
    `).all();let a="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(a=g.setting_value);let n,r=!1;if(a&&a!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,_=await(await fetch(g)).json();_.values&&_.values.length>=50?(n=_.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),r=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",n[n.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!n){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!g.results||g.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});n=g.results.reverse().map(f=>({timestamp:f.timestamp,open:f.open,high:f.high,low:f.low,close:f.close,volume:f.volume}))}const i=_e(n);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"});const l=n[n.length-1].close,o=ae(l,i,"day_trade"),c=ae(l,i,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",o.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),u={};for(const g of d.results||[])u[g.setting_key]=g.setting_value;let m=!1,p=[];u.telegram_bot_token&&u.telegram_chat_id&&(await K({botToken:u.telegram_bot_token,chatId:u.telegram_chat_id},lt({...o,timestamp:new Date().toISOString()}))&&(p.push("day_trade"),m=!0),await new Promise(_=>setTimeout(_,1e3)),await K({botToken:u.telegram_bot_token,chatId:u.telegram_chat_id},lt({...c,timestamp:new Date().toISOString()}))&&(p.push("swing_trade"),m=!0));for(const g of[o,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason, telegram_sent)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(g.signal_type,g.trading_style,g.price,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.confidence,g.reason,m?1:0).run();return e.json({success:!0,signals:{day_trade:o,swing_trade:c},telegram_sent:m,sent_to_telegram:p})}catch(s){return e.json({success:!1,error:s.message},500)}});U.get("/api/trading/account/:id",async e=>{const{DB:t}=e.env,s=e.req.param("id");try{const a=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(s).first();return a?e.json({success:!0,account:a}):e.json({success:!1,error:"Account not found"},404)}catch(a){return e.json({success:!1,error:a.message},500)}});U.post("/api/trading/calculate-position",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:a,signal:n}=s,r=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(a).first();if(!r)return e.json({success:!1,error:"Account not found"},404);const i=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = ? AND is_active = 1
      ORDER BY confidence_min DESC
    `).bind(a).all(),{calculatePositionSize:l,formatPositionSize:o}=await Promise.resolve().then(()=>ht),c=l(r,n,i.results);return e.json({success:!0,position:c,formatted:o(c)})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/trading/execute",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:a,signal_id:n,entry_price:r,stop_loss:i,take_profit_1:l,take_profit_2:o,take_profit_3:c,position_size:d,signal_type:u,trading_style:m,confidence:p}=s,g=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(a).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const f=new Date().toISOString().split("T")[0],_=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(a,f).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>ht),E=y(g,_.results);if(E.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${E.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const S=d*r,b=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(a,n||null,u,m,r,d,S,i,l,o,c,p).run();return e.json({success:!0,trade_id:b.meta.last_row_id,message:"Trade executed successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/trading/close/:trade_id",async e=>{const{DB:t}=e.env,s=e.req.param("trade_id");try{const a=await e.req.json(),{exit_price:n,exit_reason:r}=a,i=await t.prepare(`
      SELECT * FROM trades WHERE id = ?
    `).bind(s).first();if(!i)return e.json({success:!1,error:"Trade not found"},404);if(i.status==="CLOSED")return e.json({success:!1,error:"Trade already closed"},400);const{calculateProfitLoss:l}=await Promise.resolve().then(()=>ht),o=l(i.entry_price,n,i.position_size,i.trade_type,i.commission||0);return await t.prepare(`
      UPDATE trades 
      SET exit_price = ?,
      ...
      WHERE id = ?
    `).bind(n,r,o.profit_loss,o.profit_loss_pct,o.pips,s).run(),await t.prepare(`
      UPDATE trading_accounts 
      SET current_balance = current_balance + ?,
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(o.profit_loss,i.account_id).run(),e.json({success:!0,profit_loss:o.profit_loss,profit_loss_pct:o.profit_loss_pct,pips:o.pips})}catch(a){return e.json({success:!1,error:a.message},500)}});U.get("/api/trading/trades/open",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1";try{const a=await t.prepare(`
      SELECT * FROM trades 
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:n}=await Promise.resolve().then(()=>ht),r=n(a.results);return e.json({success:!0,stats:r})}catch(a){return e.json({success:!1,error:a.message},500)}});U.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const a=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    `).bind(a.timeframe||"1h").all();if(!n.results||n.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=n.results)==null?void 0:s.length)||0}`},400);const r=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:i,formatBacktestResults:l}=await Promise.resolve().then(()=>Or),o=await i(n.results,{start_date:a.start_date||"2024-01-01",end_date:a.end_date||new Date().toISOString().split("T")[0],starting_balance:a.starting_balance||1e4,min_confidence:a.min_confidence||75,use_mtf_confirmation:a.use_mtf_confirmation!==!1,use_news_filter:a.use_news_filter!==!1,timeframe:a.timeframe||"1h",commission_per_trade:a.commission_per_trade||0},r.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
    ...
    `).bind(a.run_name||`Backtest ${new Date().toISOString()}`,o.config.start_date,o.config.end_date,o.starting_balance,o.config.min_confidence,o.config.use_mtf_confirmation?1:0,o.config.use_news_filter?1:0,o.config.timeframe,o.total_trades,o.winning_trades,o.win_rate,o.net_profit,o.total_return_pct,o.max_drawdown_pct,o.profit_factor,o.sharpe_ratio,JSON.stringify(o.trades),JSON.stringify(o.equity_curve)).run(),e.json({success:!0,result:o,formatted:l(o)})}catch(a){return e.json({success:!1,error:a.message,stack:a.stack},500)}});U.get("/api/trading/backtest/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      ...
      ORDER BY created_at DESC 
      LIMIT 20
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const a=(await e.req.json().catch(()=>({}))).force_fresh||!1,n={timestamp:new Date().toISOString(),steps:[]};n.steps.push({step:1,name:"Fetching All 5 Timeframes (100 candles each)",status:"running"});const r=await t.prepare(`
      SELECT COUNT(*) as count FROM multi_timeframe_indicators 
      WHERE timestamp > datetime('now', '-5 minutes')
    `).first(),i=!a&&(r==null?void 0:r.count)>0;let l=0;if(i)l=0,n.steps[0].cached=!0;else{n.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",n.steps[0].fetching=!0;const H=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),X=(H==null?void 0:H.setting_value)||"70140f57bea54c5e90768de696487d8f",R=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const Y of R)try{const ce=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${Y.interval}&apikey=${X}&outputsize=100`,A=new AbortController,z=setTimeout(()=>A.abort(),1e4),ee=await fetch(ce,{signal:A.signal});clearTimeout(z);const ne=await ee.json();if(ne.values&&Array.isArray(ne.values)){const re=[];for(const k of ne.values)re.push({timestamp:k.datetime,open:parseFloat(k.open),high:parseFloat(k.high),low:parseFloat(k.low),close:parseFloat(k.close),volume:0});for(const k of re)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind(k.timestamp,k.open,k.high,k.low,k.close,k.volume,Y.dbKey).run();if(re.length>=50){const k=_e(re.reverse());k&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),p=(m==null?void 0:m.close)||0,g=o(u,p),f=u["1h"],_=ae(p,f,"day_trade"),y=ae(p,f,"swing_trade"),E=c(_.signal_type,g),S=c(y.signal_type,g),b={..._,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:g.score,alignment_type:g.type},x={...y,final_confidence:Math.min(95,S.confidence),isValid:S.isValid,mtf_reason:S.reason,alignment_score:g.score,alignment_type:g.type};n.steps[1].status="completed",n.steps[1].data={dayTrade:b,swingTrade:x,alignment:g},n.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const v=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),O=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:V}=await Promise.resolve().then(()=>ht),L=V(v,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},O.results),T=V(v,{entry_price:x.price,stop_loss:x.stop_loss,take_profit_1:x.take_profit_1,take_profit_2:x.take_profit_2,take_profit_3:x.take_profit_3,confidence:x.final_confidence,signal_type:x.signal_type,trading_style:x.trading_style},O.results);n.steps[2].status="completed",n.steps[2].data={dayPosition:L,swingPosition:T},n.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const M=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
${x.isValid?"✅":"❌"} *${x.signal_type}* (${x.final_confidence}% confidence)

*Entry:* $${x.price.toFixed(2)}
*Stop Loss:* $${x.stop_loss.toFixed(2)} (${((x.stop_loss/x.price-1)*100).toFixed(2)}%)
*TP1:* $${x.take_profit_1.toFixed(2)} (${((x.take_profit_1/x.price-1)*100).toFixed(2)}%)
*TP2:* $${x.take_profit_2.toFixed(2)} (${((x.take_profit_2/x.price-1)*100).toFixed(2)}%)
*TP3:* $${x.take_profit_3.toFixed(2)} (${((x.take_profit_3/x.price-1)*100).toFixed(2)}%)
...
${x.isValid&&x.signal_type!=="HOLD"?`✅ Swing Trade: EXECUTE ${x.signal_type}`:`⚠️ Swing Trade: SKIP (${x.mtf_reason})`}

🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();W=await K({botToken:I.telegram_bot_token,chatId:I.telegram_chat_id},H)}if(n.steps[3].status=W?"completed":"failed",n.steps[3].data={telegramSent:W},b.isValid||x.isValid)for(const H of[b,x])H.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(H.signal_type,H.trading_style,H.price,H.stop_loss,H.take_profit_1,H.take_profit_2,H.take_profit_3,H.confidence,H.final_confidence,H.final_confidence,H.alignment_score,H.alignment_type,H.reason,W?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:n,signals:{day_trade:b,swing_trade:x},positions:{day_trade:L,swing_trade:T},alignment:g,telegram_sent:W})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});const es=new he,Cr=Object.assign({"/src/index.tsx":U});let js=!1;for(const[,e]of Object.entries(Cr))e&&(es.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),es.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),js=!0);if(!js)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Br=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],Pr=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function Ws(e){const t=e.toLowerCase();let s=0,a=0;for(const l of Br)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of Pr)t.includes(l)&&(a+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(a+=1));const n=s+a;let r=0;n>0&&(r=(s-a)/n*100);let i="neutral";return r>20?i="bullish":r<-20&&(i="bearish"),{sentiment:i,score:r}}function Ur(e){let t=0,s=0,a=0,n=0;const r=e.map(o=>{const c=`${o.title} ${o.description||""}`,d=Ws(c);return d.sentiment==="bullish"?t++:d.sentiment==="bearish"?s++:a++,n+=d.score,{...o,sentiment:d.sentiment,score:d.score}}),i=e.length>0?n/e.length:0;let l="neutral";return i>20?l="bullish":i<-20&&(l="bearish"),{overall:l,score:Math.round(i),bullishCount:t,bearishCount:s,neutralCount:a,articles:r.slice(0,10)}}async function Hr(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,n=await(await fetch(s)).json();return n.status!=="ok"?(console.error("NewsAPI error:",n.message),[]):n.articles.map(r=>({title:r.title,description:r.description,url:r.url,publishedAt:r.publishedAt,source:r.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function jr(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(a=>{const n=new Date(a.date);return n>=e&&n<=t})}const Ys=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:Ur,analyzeSentiment:Ws,fetchGoldNews:Hr,getEconomicEvents:jr},Symbol.toStringTag,{value:"Module"}));export{es as default};
