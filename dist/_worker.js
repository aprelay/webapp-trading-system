...
`)}const Jt=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Qt,determineTrend:Gs,formatAlignmentReport:ua,validateMultiTimeframeSignal:Kt},Symbol.toStringTag,{value:"Module"}));function rs(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((o,i)=>o-i),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function _a(e,t){const s=rs(e,.95),n=rs(e,.99),a=t*s,o=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(o.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function ga(e,t,s,n){const a=t-e,o=a/t*100;let i=0;for(let d=n.length-1;d>=0&&n[d].balance<t;d--)i++;const l=o<=s,r=o>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(o.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:i}}function fa(e,t,s=5){let n=0;const a=[];for(const r of e){const c=Math.abs(r.entry_price-r.stop_loss)*r.position_size,_=c/t*100;n+=c,a.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(_.toFixed(2))})}const o=n/t*100,i=o<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(o.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:a}}function ha(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),n=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&n.push({index:r,value:s[r]});if(n.length<3)return null;const a=n.slice(-3),[o,i,l]=a;if(i.value>o.value&&i.value>l.value&&Math.abs(o.value-l.value)/o.value<.02){const d=Math.min(o.value,l.value)*.995,c=d-(i.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function ya(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const r=s[s.length-1],d=n[n.length-1]-n[0],c=r+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function Ea(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),n=t.map(d=>d.low),o=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=n.slice(0,6),l=n.slice(-6),r=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(o<.01&&r>.015){const d=Math.max(...s),c=t[t.length-1].close,_=d+(d-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(_.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function ba(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),n=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&n.push({index:r,value:s[r]});if(n.length<2)return null;const a=n.slice(-2),[o,i]=a;if(Math.abs(o.value-i.value)/o.value<.015){const r=Math.max(...s.slice(o.index,i.index))*1.005,d=r+(r-o.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:66}}return null}function wa(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),o=s[25];if(Math.abs(n-o)/n<.02&&a<n*.95){const l=s.slice(25),r=Math.min(...l),d=(o-r)/o;if(d>.01&&d<.05){const c=n-a,_=o+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(_.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function Ta(e){const t=[],s=ha(e);s&&t.push(s);const n=ya(e);n&&t.push(n);const a=Ea(e);a&&t.push(a);const o=ba(e);o&&t.push(o);const i=wa(e);i&&t.push(i);let l=0,r=0,d=0;for(const m of t)m.direction==="bullish"?(l++,d+=m.confidence):m.direction==="bearish"&&(r++,d+=m.confidence);let c="neutral",_=0;l>r?(c="bullish",_=Math.min(d/l/10,15)):r>l&&(c="bearish",_=Math.min(d/r/10,15));let p="";if(t.length===0)p="No significant chart patterns detected";else{const m=t.map(u=>u.pattern_type).join(", ");p=`Detected ${t.length} pattern(s): ${m}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(_.toFixed(1)),summary:p}}function va(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Sa(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function xa(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function ka(e,t,s){const n=va(t.atr_14,s),a=Sa(t,s),o=xa(t,s);let i,l,r,d,c,_;const p=e.slice(-10),m=p.map(f=>f.volume||0),u=m.reduce((f,y)=>f+y,0)/m.length,h=(p[p.length-1].volume||0)>u*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,r=!0,d="Trend-following (aggressive entry)",c=1.3,_="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,r=!1,d="Wait for stabilization",c=.5,_="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,r=!1,d="Wait for direction",c=.5,_="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,r=!0,d="Trend-following (buy dips, trail stops)",c=1.5,_="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,r=!1,d="Stay in cash or short",c=.3,_="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,r=!0,d="Trend-following (selective entries)",c=1,_="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,r=!1,d="Reduce exposure or stay flat",c=.5,_="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,o>60?(r=!0,d="Mean-reversion (fade extremes)",c=.8,_="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,d="Wait for trend to develop",c=.5,_="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:o,should_trade:r,recommended_strategy:d,risk_adjustment:c,description:_}}function Ra(e){const t=e.length;let s=0,n=0,a=0,o=0;for(let r=0;r<t;r++)s+=r,n+=e[r],a+=r*e[r],o+=r*r;const i=(t*a-s*n)/(t*o-s*s),l=(n-i*s)/t;return{slope:i,intercept:l}}function La(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let o=n[0];for(let l=1;l<n.length;l++)o=(n[l]-o)*a+o;const i=(n[n.length-1]-n[n.length-10])/10;return o+i*s}function Ia(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const i=n.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function $a(e,t,s){const n=e[e.length-1].close;e.map(i=>i.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const o=a/100*s;return n+t.atr_14*o}function Aa(e,t){const s=e.map(p=>p.close),n=s[s.length-1],a=10,o=s.slice(-a),i=Math.min(...o),l=Math.max(...o),r=o.map(p=>(p-i)/(l-i));let d={index:0,similarity:-1/0};for(let p=a;p<s.length-a-t;p++){const m=s.slice(p-a,p),u=Math.min(...m),g=Math.max(...m),h=m.map(w=>(w-u)/(g-u));let f=0;for(let w=0;w<a;w++)f+=Math.pow(r[w]-h[w],2);const y=-f;y>d.similarity&&(d={index:p,similarity:y})}const _=(s[d.index+t]-s[d.index])*(n/s[d.index]);return n+_}function Gt(e,t,s){const n=[],a=[],o=e.map(E=>E.close),{slope:i,intercept:l}=Ra(o.slice(-20)),r=i*(o.length-1+s)+l;n.push(r),a.push(1);const d=La(e,12,s);n.push(d),a.push(1.5);const c=Ia(e,s);n.push(c),a.push(1.2);const _=$a(e,t,s);n.push(_),a.push(1.8);const p=Aa(e,s);n.push(p),a.push(1.3);const m=a.reduce((E,k)=>E+k,0),g=n.reduce((E,k,S)=>E+k*a[S],0)/m,h=n.reduce((E,k)=>E+k,0)/n.length,f=n.reduce((E,k)=>E+Math.pow(k-h,2),0)/n.length,y=Math.sqrt(f),w=e[e.length-1].close,b=1-y/w,v=Math.max(50,Math.min(95,b*100));return{prediction:g,confidence:v}}function Da(e,t){const s=e[e.length-1].close,n=[],a=Gt(e,t,1),o=a.prediction-s,i=o/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:o>.5?"UP":o<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Gt(e,t,4),r=l.prediction-s,d=r/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Gt(e,t,24),_=c.prediction-s,p=_/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:_>5?"UP":_<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(p.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(y=>y.direction==="UP").length,u=n.filter(y=>y.direction==="DOWN").length;let g,h=0;m>u?(g="BULLISH",h=Math.min(m*5,15)):u>m?(g="BEARISH",h=Math.min(u*5,15)):g="NEUTRAL";const f=`ML models predict ${g} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:g,confidence_boost:parseFloat(h.toFixed(1)),summary:f}}function Vt(e,t,s,n,a){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const r=(n-50)/10;l+=r;const d=(a-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function Na(e,t,s,n,a){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,a==="BUY"){const r=(n-50)/10;l-=r}else{const r=(n-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function Ma(e,t,s,n,a,o){const i=(s-e)*.5,l=(n-e)*.3,r=(a-e)*.2,d=t-e;return o.tp1/100*i+o.tp2/100*l+o.tp3/100*r+o.sl/100*d}function Oa(e,t,s){const n=e.price,a=t.atr_14;let o=50;e.signal_type==="BUY"?(n>t.sma_20&&(o+=10),n>t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(o+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(o+=10),n<t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(o+=10)),o=Math.min(100,o);const i=s.slice(-50),l=[];for(let w=14;w<i.length;w++){const b=i.slice(w-14,w);let v=0;for(let E=1;E<b.length;E++){const k=Math.max(b[E].high-b[E].low,Math.abs(b[E].high-b[E-1].close),Math.abs(b[E].low-b[E-1].close));v+=k}l.push(v/14)}const r=l.reduce((w,b)=>w+b,0)/l.length,d=a/r,c=Vt(n,e.take_profit_1,a,o,d),_=Vt(n,e.take_profit_2,a,o,d),p=Vt(n,e.take_profit_3,a,o,d),m=Na(n,e.stop_loss,a,o,e.signal_type),u=Ma(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:_,tp3:p,sl:m}),h=(c+_+p)/3/m;let f;c>70&&u>5&&h>2?f="STRONG_TRADE":c>60&&u>0&&h>1.5?f="GOOD_TRADE":c>50&&u>-2?f="MARGINAL_TRADE":f="AVOID_TRADE";const y=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${u.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${f.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(_.toFixed(1)),tp3_probability:parseFloat(p.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(u.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:f,summary:y}}const es=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ca(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Bt(e=30){const t=[],s=new Date;for(const a of es){const o=new Date(a),i=Math.floor((o.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const o=new Date(s.getTime()+a*24*60*60*1e3),i=o.getFullYear(),l=o.getMonth(),r=o.getDate(),d=o.getDay();if(r===Ca(i,l)&&d===5){const c=o.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,o,i)=>o===i.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,o)=>{const i=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${o.date}T${o.time}:00Z`);return i.getTime()-l.getTime()})}function xt(e=new Date,t=[]){const s=[...Bt(7),...t],n=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(i=>i.date===a&&i.impact==="high"),es.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Fa(a)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const o=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>o&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Fa(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Mt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Ua(e){const t=e.toISOString().split("T")[0];return es.includes(t)?!0:Bt(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Ha(){const e=new Date().toISOString().split("T")[0];return Bt(7).filter(s=>s.date===e)}function Vs(e=new Date){const t=xt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const qs=new ge;qs.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const B of["5m","15m","1h","4h","daily"]){const C=await t.prepare(`
    ...
    `).first(),d=(r==null?void 0:r.setting_value)||"70140f57bea54c5e90768de696487d8f";try{console.log("[ENHANCED] Fetching real-time price...");const C=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${d}`,{signal:AbortSignal.timeout(5e3)})).json();if(C.price){const z=parseFloat(C.price),$=l,de=Math.abs(z-$)/z*100;console.log(`[ENHANCED] Real-time: $${z}, Last candle: $${$}, Diff: ${de.toFixed(2)}%`),de<2?(l=z,console.log(`[ENHANCED] ✅ Using real-time price: $${z}`)):console.log(`[ENHANCED] ⚠️ Price diff too large (${de.toFixed(2)}%), using candle close`)}}catch(B){console.log("[ENHANCED] Real-time price fetch failed, using candle close:",B.message)}if(i!=null&&i.timestamp){const B=new Date(i.timestamp).getTime(),C=(Date.now()-B)/(1e3*60);C>60&&o.push(`⚠️ WARNING: Price data is ${C.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${C.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const c=xt(),_=Vs();let p=null,m=!1;c.riskLevel==="danger"?(m=!0,p=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",c.reason)):c.riskLevel==="caution"?(p=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",c.reason)):console.log("[ENHANCED] ✅ Calendar safe:",c.reason);const u=n["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const g=Qt(n,l),h=le(l,u,"day_trade"),f=le(l,u,"swing_trade"),y=Kt(h.signal_type,g),w=Kt(f.signal_type,g),b={...h,base_confidence:h.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:g.score,alignment_type:g.type},v={...f,base_confidence:f.confidence,mtf_confidence:w.confidence,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:g.score,alignment_type:g.type};let E=0,k="",S=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const C=Ta(a["1h"]);S=(C==null?void 0:C.patterns)||[]}catch(C){console.error("[ENHANCED] Pattern detection error:",C.message)}const B=S.filter(C=>C.confidence>=70&&C.endIndex>=a["1h"].length-5);for(const C of B)C.type==="bullish"&&b.signal_type==="BUY"?(E+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `):C.type==="bearish"&&b.signal_type==="SELL"&&(E+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `);E=Math.min(15,E)}let D=0,R="",I=null;if(a["1h"]&&a["1h"].length>=50){const B=ue(a["1h"]);B&&(I=ka(a["1h"],B),I.trend==="STRONG_UPTREND"&&b.signal_type==="BUY"?(D=10,R="Strong Uptrend"):I.trend==="UPTREND"&&b.signal_type==="BUY"?(D=5,R="Uptrend"):I.trend==="STRONG_DOWNTREND"&&b.signal_type==="SELL"?(D=10,R="Strong Downtrend"):I.trend==="DOWNTREND"&&b.signal_type==="SELL"&&(D=5,R="Downtrend"))}let U=0,j="",L=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{L=Da(a["1h"],l),L.overall_direction==="BULLISH"&&b.signal_type==="BUY"?(U=L.confidence_boost,j=`ML predicts +${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):L.overall_direction==="BEARISH"&&b.signal_type==="SELL"&&(U=L.confidence_boost,j=`ML predicts ${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(B){console.error("[ENHANCED] ML prediction error:",B.message)}let O=0,A="",H=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const B=ue(a["1h"]);B&&(H=Oa(b,B,a["1h"]),H.tp1_probability>70?(O=10,A=`PoP: TP1 ${H.tp1_probability.toFixed(0)}%`):H.tp1_probability>60&&(O=5,A=`PoP: TP1 ${H.tp1_probability.toFixed(0)}%`))}catch(B){console.error("[ENHANCED] Probability of Profit error:",B.message)}let P=null,M=0,F=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{P=Ht(a["1h"]),P.liquidity_score>=80?M=5:P.liquidity_score>=70?M=0:P.liquidity_score>=50?F=-5:F=-10,console.log(`[LIQUIDITY] Score: ${P.liquidity_score}/100, Session: ${P.session}, Adjust: ${M+F}%`)}catch(B){console.error("[ENHANCED] Liquidity Analysis error:",B.message)}let V=0,Q=0,ee=0,te=0,se="";try{const B=await t.prepare(`
      ...
      `).all(),z=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(B&&C.results&&C.results.length>=10){const $=_a(C.results,B.balance);V=$.var_95,Q=$.var_99;const he=ga(B.balance,C.results);if(ee=he.current_drawdown_pct,he.is_within_limit||(se+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),z.results){const de=fa(z.results,B.balance);te=de.total_risk_pct,de.is_within_limit||(se+=`⚠️ Portfolio heat ${te.toFixed(1)}% exceeds limit. `)}}}catch(B){console.error("[ENHANCED] Risk metrics error (optional):",B.message)}const x=E+D+U+O+M+F,N={...b,pattern_boost:E,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,b.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null},pe={...v,pattern_boost:E,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,v.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null};m?(N.signal_type="HOLD",pe.signal_type="HOLD",N.enhanced_confidence=50,pe.enhanced_confidence=50,N.reasoning=p||"Economic event nearby - trading paused",pe.reasoning=p||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):_.adjustment<0&&(N.enhanced_confidence=Math.max(50,N.enhanced_confidence+_.adjustment),pe.enhanced_confidence=Math.max(50,pe.enhanced_confidence+_.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",_.adjustment)),N.calendar_check={risk_level:c.riskLevel,should_trade:c.shouldTrade,reason:c.reason,confidence_adjustment:_.adjustment,upcoming_events:c.upcomingEvents.slice(0,3).map(B=>Mt(B))},pe.calendar_check=N.calendar_check;let fe=!1;try{const B=await t.prepare(`
...
`;const he=candles1h.slice(-20),de=he.map(J=>J.high).sort((J,Te)=>Te-J),ne=he.map(J=>J.low).sort((J,Te)=>J-Te),Rt=de.slice(0,3),ut=ne.slice(0,3);if($+=`📊 *Key Levels:*
...
`;for(const J of c.upcomingEvents.slice(0,3))X+=`• ${Mt(J)}
`;X+=`
`}X+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`,S+=`⏰ ${k}`,console.log("[SIMPLE] Sending Telegram message, length:",S.length),h=await K({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},S),console.log("[SIMPLE] Telegram sent:",h),h||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}try{await t.prepare(`
    ...
    `).bind(_,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let p=!1;if(c.grade==="A"||c.grade==="A+")try{const u=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),g={};for(const h of u.results||[])g[h.setting_key]=h.setting_value;if(g.telegram_bot_token&&g.telegram_chat_id){const h=Zs(c,d);p=await K({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},h),await t.prepare(`
...
`,i+="Next scan in 5 minutes...",i}async function dt(e){const t=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,o=n.filter(m=>m.win===1).length,i=n.filter(m=>m.win===0).length,l=o/a*100,r=n.reduce((m,u)=>m+(u.profit_loss||0),0),d=Math.max(...n.map(m=>m.profit_loss||0)),c=Math.min(...n.map(m=>m.profit_loss||0)),_=n.reduce((m,u)=>m+(u.confidence||0),0)/a,p=n.reduce((m,u)=>m+(u.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,o,i,l,r,d,c,_,p).run()}async function Wo(e){const t=await dt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
...
📅 Backtest ID: ${r.meta.last_row_id}
    ...
    `).first();if(!i)return e.json({ok:!0});const l={botToken:i.setting_value,chatId:a.toString()};if(o.startsWith("/log_trade")){const r=o.split(" ");if(r.length<5)return await K(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const d=r[1].toUpperCase(),c=parseFloat(r[2]),_=parseFloat(r[3]),p=parseFloat(r[4]),m=await Js({trade_type:d,trading_style:"day_trade",entry_price:c,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:_,take_profit_1:p,take_profit_2:p*1.002,take_profit_3:p*1.003,status:"OPEN",confidence:85},t);m.success?await K(l,`✅ *Trade #${m.trade_id} Logged*

${d} @ $${c}
Stop: $${_}
TP1: $${p}`):await K(l,`❌ Error: ${m.error}`)}else if(o.startsWith("/close_trade")){const r=o.split(" ");if(r.length<4)return await K(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const d=parseInt(r[1]),c=parseFloat(r[2]),_=r[3],p=await en(d,c,_,t);if(p.success){const m=p.profit_loss||0,u=m>0?"💰":"❌";await K(l,`${u} *Trade #${d} Closed*

Exit: $${c}
P&L: ${m>0?"+":""}$${m.toFixed(2)}
Result: ${m>0?"WIN ✅":"LOSS ❌"}`)}else await K(l,`❌ Error: ${p.error}`)}else if(o==="/open"){const r=await nn(t);if(r.length===0)await K(l,"📊 No open positions");else{let d=`📊 *Open Positions (${r.length})*
...
`,f+=`Signal #${l} | ${h}`,f}kt.get("/scan",async e=>{var n;const{DB:t}=e.env,s={success:!1,message:"",data:{}};try{console.log("[MICRO] Starting 5-minute scan...");const a=await ni(t);if(!a.allowed)return console.log("[MICRO] Daily limit check failed:",a.reason),s.message=a.reason,s.data={signals_sent_today:a.signals_sent_today,max_signals:a.max_signals},e.json(s);console.log(`[MICRO] Daily limit check passed: ${a.signals_sent_today}/${a.max_signals} signals sent`);const o=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = '5m'
      ORDER BY timestamp DESC 
    ...
    `).all();if(!o.results||o.results.length<20)return s.message="Insufficient 5m candle data",e.json(s);const i=o.results.map(E=>({timestamp:E.timestamp,open:E.open,high:E.high,low:E.low,close:E.close,volume:E.volume||1})).reverse(),l=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 60
    `).all();if(!l.results||l.results.length<50)return s.message=`Insufficient 15m candle data (have ${((n=l.results)==null?void 0:n.length)||0}, need 50)`,e.json(s);const r=l.results.map(E=>({timestamp:E.timestamp,open:E.open,high:E.high,low:E.low,close:E.close,volume:E.volume||1})).reverse(),d=ue(i),c=ue(r);if(!d)return console.error("[MICRO] Failed to calculate 5m indicators - data length:",i.length),s.message="Failed to calculate 5m indicators",s.data={candles5m_count:i.length,first_candle:i[0],last_candle:i[i.length-1]},e.json(s);if(!c)return console.error("[MICRO] Failed to calculate 15m indicators - data length:",r.length),s.message="Failed to calculate 15m indicators",s.data={candles15m_count:r.length},e.json(s);const _=i[i.length-1].close,p=si(i,d,r,c);if(!p)return console.log("[MICRO] No valid setup detected"),s.success=!0,s.message="No signal - waiting for setup",s.data={currentPrice:_},e.json(s);if(console.log(`[MICRO] Signal detected: ${p.signal_type} ${p.setup_type} (${p.confidence}%)`),p.confidence<60)return console.log(`[MICRO] Confidence too low: ${p.confidence}%`),s.success=!0,s.message=`Signal below threshold (${p.confidence}% < 60%)`,s.data={signal:p},e.json(s);const m=Ht(i);if(m.liquidity_score<60)return console.log(`[MICRO] Liquidity too low: ${m.liquidity_score}`),s.success=!0,s.message=`Low liquidity (${m.liquidity_score} < 60)`,s.data={signal:p,liquidity:m},e.json(s);const u=ai(p,m.liquidity_score,m.optimal_for_trading),g=new Date(Date.now()+900*1e3).toISOString(),h=new Date().toISOString().split("T")[0],f=await t.prepare(`
    ...
    `).bind(p.signal_type,p.price,p.stop_loss,p.take_profit_1,p.take_profit_2,p.take_profit_3,p.confidence,p.setup_type,p.trend_5m,p.trend_15m,p.indicators_5m.rsi,p.indicators_5m.macd,p.indicators_5m.macd_signal,p.indicators_5m.macd_histogram,p.indicators_5m.adx,p.indicators_5m.stochastic_k,p.indicators_5m.stochastic_d,p.indicators_5m.ema_20,p.indicators_5m.volume,m.liquidity_score,m.session,m.time_zone,m.volume_trend,m.volume_percentile,m.estimated_spread_pips,m.price_impact_bps,m.market_depth_score,m.optimal_for_trading?1:0,u.multiplier,u.lots,u.risk_amount,u.risk_percent,g,p.reason).run(),console.log("[MICRO] Signal saved to database");const w=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),b={};for(const E of w.results||[])b[E.setting_key]=E.setting_value;let v=!1;if(b.telegram_bot_token&&b.telegram_chat_id){const E=oi(p,m.liquidity_score,m.session,m.volume_trend,m.volume_percentile,m.estimated_spread_pips,u,y);v=await K({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},E),v&&(await t.prepare(`
        ...
        `).bind(h).run(),await t.prepare(`
          ...
          ON CONFLICT(date) DO UPDATE SET
            ...
            updated_at = datetime('now')
        `).bind(h,p.signal_type==="BUY"?1:0,p.signal_type==="SELL"?1:0,p.confidence,m.liquidity_score,m.session==="ASIA"?1:0,m.session==="LONDON"?1:0,m.session==="NEW_YORK"?1:0,m.session==="OVERLAP"?1:0,p.setup_type==="BREAKOUT"?1:0,p.setup_type==="CONTINUATION"?1:0,p.setup_type==="REVERSAL"?1:0,p.setup_type==="BOUNCE"?1:0,p.setup_type==="PATTERN"?1:0).run(),console.log("[MICRO] Telegram alert sent successfully"))}return s.success=!0,s.message=v?"Signal generated and sent to Telegram":"Signal generated (Telegram not configured)",s.data={signal:p,liquidity:m,position:u,signalNumber:y,limitsCheck:a,telegramSent:v},e.json(s)}catch(a){return console.error("[MICRO] Error:",a),s.message=a.message||"Unknown error",e.json(s,500)}});kt.get("/signals/recent",async e=>{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"20");try{const n=await t.prepare(`
      SELECT * FROM micro_trade_signals 
      ORDER BY created_at DESC 
      LIMIT ?
    `).bind(s).all();return e.json({success:!0,signals:n.results})}catch(n){return e.json({success:!1,error:n.message},500)}});kt.get("/stats/daily",async e=>{const{DB:t}=e.env,s=e.req.query("date")||new Date().toISOString().split("T")[0];try{const n=await t.prepare(`
      SELECT * FROM micro_trade_daily_stats WHERE date = ?
    `).bind(s).first(),a=await t.prepare(`
      SELECT * FROM micro_trade_limits WHERE date = ?
    `).bind(s).first();return e.json({success:!0,date:s,stats:n||null,limits:a||null})}catch(n){return e.json({success:!1,error:n.message},500)}});kt.get("/debug/data-check",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),i=await t.prepare(`
      ...
      GROUP BY timeframe
      ORDER BY timeframe
    `).all();return e.json({success:!0,data:{candles_5m:{count:(s==null?void 0:s.count)||0,latest:(n==null?void 0:n.timestamp)||null,price:(n==null?void 0:n.close)||null},candles_15m:{count:(a==null?void 0:a.count)||0,latest:(o==null?void 0:o.timestamp)||null,price:(o==null?void 0:o.close)||null},all_timeframes:i.results||[]}})}catch(s){return e.json({success:!1,error:s.message},500)}});const G=new ge;G.use("/api/*",na());G.route("/api/signals/enhanced",qs);G.route("/api/signals/simple",zs);G.route("/api/scanner",ct);G.route("/api/trades",we);G.route("/api/calendar",Fe);G.route("/api/backtest",pt);G.route("/api/telegram",cn);G.route("/api/ai",Pt);G.route("/api/monitoring",Ue);G.route("/api/micro",kt);G.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume));await t.batch(_);const p=c.length;if(c.length>=50){const m=ue(c.reverse());if(m){await t.prepare(`
        ...
        `).bind(m.rsi_14,m.macd,m.macd_signal,m.macd_histogram,m.sma_20,m.sma_50,m.sma_200,m.ema_12,m.ema_26,m.bb_upper,m.bb_middle,m.bb_lower,m.atr_14,m.stochastic_k,m.stochastic_d,m.adx,m.plus_di,m.minus_di,m.ichimoku_tenkan,m.ichimoku_kijun,m.ichimoku_senkou_a,m.ichimoku_senkou_b,m.parabolic_sar,m.vwap,m.fib_382||0,m.fib_500||0,m.fib_618||0).run();const u=c[c.length-1].close,g=le(u,m,"day_trade"),h=le(u,m,"swing_trade"),f=70;for(const y of[g,h])if(y.confidence>=f&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const w=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),b={};for(const v of w.results||[])b[v.setting_key]=v.setting_value;b.telegram_bot_token&&b.telegram_chat_id&&await K({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},lt(y))}}}return e.json({success:!0,count:p})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
...
⏰ ${new Date().toLocaleString()}`,j=await K({botToken:o,chatId:i},U);k.day_trade_send_result=j,console.log("[AUTO-FETCH] Day trade alert result:",j),j?(v=!0,E.push("Day Trade"),R&&y.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${D}
...
⏰ ${new Date().toLocaleString()}`,j=await K({botToken:o,chatId:i},U);k.swing_trade_send_result=j,j&&(v=!0,E.push("Swing Trade"),R&&w.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${D}
...
🌐 Dashboard: ${e.req.url.replace("/api/cron/hedge-fund","")}
    ...
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const d=r.close,c=s(i,d),_=i["1h"],p=le(d,_,"day_trade"),m=le(d,_,"swing_trade"),u=n(p.signal_type,c),g=n(m.signal_type,c),h={...p,base_confidence:p.confidence,mtf_confidence:u.confidence,final_confidence:Math.min(95,u.confidence),isValid:u.isValid,mtf_reason:u.reason,alignment_score:c.score,alignment_type:c.type,reason:`${p.reason}, MTF: ${u.reason}`},f={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:c.score,alignment_type:c.type,reason:`${m.reason}, MTF: ${g.reason}`},y=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),w={};for(const E of y.results||[])w[E.setting_key]=E.setting_value;let b=!1,v=[];w.telegram_bot_token&&w.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await K({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...h,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(v.push("day_trade"),b=!0),await new Promise(E=>setTimeout(E,1e3)),f.isValid&&f.signal_type!=="HOLD"&&await K({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED
...
📊 ${a(c)}`)&&(v.push("swing_trade"),b=!0));for(const E of[h,f])E.isValid&&await t.prepare(`
    ...
    `).all();let n="";for(const b of s.results||[])b.setting_key==="twelve_data_api_key"&&(n=b.setting_value);let a,o=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const b=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,E=await(await fetch(b)).json();E.values&&E.values.length>=50?(a=E.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open)||0,high:parseFloat(k.high)||0,low:parseFloat(k.low)||0,close:parseFloat(k.close)||0,volume:parseFloat(k.volume)||0})),o=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(b){console.error("[GENERATE-NOW] API fetch failed:",b.message)}}if(!a||a.length===0){console.log("[GENERATE-NOW] Using database data (may be stale)");const b=await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const b of _.results||[])p[b.setting_key]=b.setting_value;let m=!1,u=[];const g=a.slice(-20),h=g.map(b=>b.high).sort((b,v)=>v-b),f=g.map(b=>b.low).sort((b,v)=>b-v),y=h.length>=3?[h[0],h[1],h[2]]:h.length>=1?[h[0]]:[],w=f.length>=3?[f[0],f[1],f[2]]:f.length>=1?[f[0]]:[];console.log("[GENERATE-NOW] S/R calculated - Resistance:",y,"Support:",w),p.telegram_bot_token&&p.telegram_chat_id&&(await K({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...d,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(u.push("day_trade"),m=!0),await new Promise(E=>setTimeout(E,1e3)),await K({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...c,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(u.push("swing_trade"),m=!0));for(const b of[d,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();O=await K({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},M)}if(a.steps[3].status=O?"completed":"failed",a.steps[3].data={telegramSent:O},E.isValid||k.isValid)for(const A of[E,k])A.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim(),{sendTelegramMessage:P}=await Promise.resolve().then(()=>Ys);j=await P({botToken:U.telegram_bot_token,chatId:U.telegram_chat_id},H)}if(a.steps[3].status=j?"completed":"failed",a.steps[3].data={telegramSent:j},b.isValid||v.isValid)for(const L of[b,v])L.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
