var tn=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var sn=(e,t,s)=>t in e?tn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var O=(e,t,s)=>sn(e,typeof t!="symbol"?t+"":t,s),Nt=(e,t,s)=>t.has(e)||Vt("Cannot "+s);var y=(e,t,s)=>(Nt(e,t,"read from private field"),s?s.call(e):t.get(e)),W=(e,t,s)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),F=(e,t,s,n)=>(Nt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),X=(e,t,s)=>(Nt(e,t,"access private method"),s);var qt=(e,t,s,n)=>({set _(a){F(e,t,a,s)},get _(){return y(e,t,n)}});var zt=(e,t,s)=>(n,a)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,d=!1,c;if(e[l]?(c=e[l][0][0],n.req.routeIndex=l):c=l===e.length&&a||void 0,c)try{o=await c(n,()=>r(l+1))}catch(p){if(p instanceof Error&&t)n.error=p,o=await t(p,n),d=!0;else throw p}else n.finalized===!1&&s&&(o=await s(n));return o&&(n.finalized===!1||d)&&(n.res=o),n}},nn=Symbol(),an=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,i=(e instanceof ms?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?rn(e,{all:s,dot:n}):{}};async function rn(e,t){const s=await e.formData();return s?on(s,t):{}}function on(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?ln(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(cn(s,n,a),delete s[n])}),s}var ln=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},cn=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((i,r)=>{r===a.length-1?n[i]=s:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},ls=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},dn=e=>{const{groups:t,path:s}=un(e),n=ls(s);return pn(n,t)},un=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},pn=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},Et={},mn=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return Et[n]||(s[2]?Et[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Et[n]=[e,s[1],!0]),Et[n]}return null},Pt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},gn=e=>Pt(e,decodeURI),cs=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),r=t.slice(s,i===-1?void 0:i);return gn(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(a===63)break}return t.slice(s,n)},fn=e=>{const t=cs(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ve=(e,t,...s)=>(s.length&&(t=Ve(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ds=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const i=a.replace("?","");n+="/"+i,s.push(n)}else n+="/"+a}),s.filter((a,i,r)=>r.indexOf(a)===i)},Mt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Pt(e,ps):e):e,us=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,d=e.indexOf("&",o);return Mt(e.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(n&&(o=Mt(o)),i=r,o==="")continue;let d;l===-1?d="":(d=e.slice(l+1,r===-1?void 0:r),n&&(d=Mt(d))),s?(a[o]&&Array.isArray(a[o])||(a[o]=[]),a[o].push(d)):a[o]??(a[o]=d)}return t?a[t]:a},_n=us,hn=(e,t)=>us(e,t,!0),ps=decodeURIComponent,Xt=e=>Pt(e,ps),Xe,ue,Te,gs,fs,Ht,ke,ss,ms=(ss=class{constructor(e,t="/",s=[[]]){W(this,Te);O(this,"raw");W(this,Xe);W(this,ue);O(this,"routeIndex",0);O(this,"path");O(this,"bodyCache",{});W(this,ke,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,F(this,ue,s),F(this,Xe,{})}param(e){return e?X(this,Te,gs).call(this,e):X(this,Te,fs).call(this)}query(e){return _n(this.url,e)}queries(e){return hn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await an(this,e))}json(){return y(this,ke).call(this,"text").then(e=>JSON.parse(e))}text(){return y(this,ke).call(this,"text")}arrayBuffer(){return y(this,ke).call(this,"arrayBuffer")}blob(){return y(this,ke).call(this,"blob")}formData(){return y(this,ke).call(this,"formData")}addValidatedData(e,t){y(this,Xe)[e]=t}valid(e){return y(this,Xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[nn](){return y(this,ue)}get matchedRoutes(){return y(this,ue)[0].map(([[,e]])=>e)}get routePath(){return y(this,ue)[0].map(([[,e]])=>e)[this.routeIndex].path}},Xe=new WeakMap,ue=new WeakMap,Te=new WeakSet,gs=function(e){const t=y(this,ue)[0][this.routeIndex][1][e],s=X(this,Te,Ht).call(this,t);return s&&/\%/.test(s)?Xt(s):s},fs=function(){const e={},t=Object.keys(y(this,ue)[0][this.routeIndex][1]);for(const s of t){const n=X(this,Te,Ht).call(this,y(this,ue)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?Xt(n):n)}return e},Ht=function(e){return y(this,ue)[1]?y(this,ue)[1][e]:e},ke=new WeakMap,ss),yn={Stringify:1},_s=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>_s(o,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},bn="text/plain; charset=UTF-8",Ft=(e,t)=>({"Content-Type":e,...t}),dt,ut,ye,Ke,be,de,pt,Ze,Qe,Oe,mt,gt,Le,qe,ns,En=(ns=class{constructor(e,t){W(this,Le);W(this,dt);W(this,ut);O(this,"env",{});W(this,ye);O(this,"finalized",!1);O(this,"error");W(this,Ke);W(this,be);W(this,de);W(this,pt);W(this,Ze);W(this,Qe);W(this,Oe);W(this,mt);W(this,gt);O(this,"render",(...e)=>(y(this,Ze)??F(this,Ze,t=>this.html(t)),y(this,Ze).call(this,...e)));O(this,"setLayout",e=>F(this,pt,e));O(this,"getLayout",()=>y(this,pt));O(this,"setRenderer",e=>{F(this,Ze,e)});O(this,"header",(e,t,s)=>{this.finalized&&F(this,de,new Response(y(this,de).body,y(this,de)));const n=y(this,de)?y(this,de).headers:y(this,Oe)??F(this,Oe,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});O(this,"status",e=>{F(this,Ke,e)});O(this,"set",(e,t)=>{y(this,ye)??F(this,ye,new Map),y(this,ye).set(e,t)});O(this,"get",e=>y(this,ye)?y(this,ye).get(e):void 0);O(this,"newResponse",(...e)=>X(this,Le,qe).call(this,...e));O(this,"body",(e,t,s)=>X(this,Le,qe).call(this,e,t,s));O(this,"text",(e,t,s)=>!y(this,Oe)&&!y(this,Ke)&&!t&&!s&&!this.finalized?new Response(e):X(this,Le,qe).call(this,e,t,Ft(bn,s)));O(this,"json",(e,t,s)=>X(this,Le,qe).call(this,JSON.stringify(e),t,Ft("application/json",s)));O(this,"html",(e,t,s)=>{const n=a=>X(this,Le,qe).call(this,a,t,Ft("text/html; charset=UTF-8",s));return typeof e=="object"?_s(e,yn.Stringify,!1,{}).then(n):n(e)});O(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});O(this,"notFound",()=>(y(this,Qe)??F(this,Qe,()=>new Response),y(this,Qe).call(this,this)));F(this,dt,e),t&&(F(this,be,t.executionCtx),this.env=t.env,F(this,Qe,t.notFoundHandler),F(this,gt,t.path),F(this,mt,t.matchResult))}get req(){return y(this,ut)??F(this,ut,new ms(y(this,dt),y(this,gt),y(this,mt))),y(this,ut)}get event(){if(y(this,be)&&"respondWith"in y(this,be))return y(this,be);throw Error("This context has no FetchEvent")}get executionCtx(){if(y(this,be))return y(this,be);throw Error("This context has no ExecutionContext")}get res(){return y(this,de)||F(this,de,new Response(null,{headers:y(this,Oe)??F(this,Oe,new Headers)}))}set res(e){if(y(this,de)&&e){e=new Response(e.body,e);for(const[t,s]of y(this,de).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=y(this,de).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}F(this,de,e),this.finalized=!0}get var(){return y(this,ye)?Object.fromEntries(y(this,ye)):{}}},dt=new WeakMap,ut=new WeakMap,ye=new WeakMap,Ke=new WeakMap,be=new WeakMap,de=new WeakMap,pt=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,Oe=new WeakMap,mt=new WeakMap,gt=new WeakMap,Le=new WeakSet,qe=function(e,t,s){const n=y(this,de)?new Headers(y(this,de).headers):y(this,Oe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?n.append(r,l):n.set(r,l)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")n.set(i,r);else{n.delete(i);for(const l of r)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??y(this,Ke);return new Response(e,{status:a,headers:n})},ns),te="ALL",wn="all",Tn=["get","post","put","delete","options","patch"],hs="Can not add a route since the matcher is already built.",ys=class extends Error{},Sn="__COMPOSED_HANDLER",vn=e=>e.text("404 Not Found",404),Kt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,se,bs,me,Ne,wt,Tt,Je,xn=(Je=class{constructor(t={}){W(this,se);O(this,"get");O(this,"post");O(this,"put");O(this,"delete");O(this,"options");O(this,"patch");O(this,"all");O(this,"on");O(this,"use");O(this,"router");O(this,"getPath");O(this,"_basePath","/");W(this,pe,"/");O(this,"routes",[]);W(this,me,vn);O(this,"errorHandler",Kt);O(this,"onError",t=>(this.errorHandler=t,this));O(this,"notFound",t=>(F(this,me,t),this));O(this,"fetch",(t,...s)=>X(this,se,Tt).call(this,t,s[1],s[0],t.method));O(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ve("/",t)}`,s),n,a)));O(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(X(this,se,Tt).call(this,t.request,t,void 0,t.request.method))})});[...Tn,wn].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?F(this,pe,r):X(this,se,Ne).call(this,i,y(this,pe),r),l.forEach(o=>{X(this,se,Ne).call(this,i,y(this,pe),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){F(this,pe,o);for(const d of[i].flat())l.map(c=>{X(this,se,Ne).call(this,d.toUpperCase(),y(this,pe),c)})}return this},this.use=(i,...r)=>(typeof i=="string"?F(this,pe,i):(F(this,pe,"*"),r.unshift(i)),r.forEach(l=>{X(this,se,Ne).call(this,te,y(this,pe),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??cs:fn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var r;let i;s.errorHandler===Kt?i=a.handler:(i=async(l,o)=>(await zt([],s.errorHandler)(l,()=>a.handler(l,o))).res,i[Sn]=a.handler),X(r=n,se,Ne).call(r,a.method,a.path,i)}),this}basePath(t){const s=X(this,se,bs).call(this);return s._basePath=Ve(this._basePath,t),s}mount(t,s,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=o=>o:a=n.replaceRequest));const r=i?o=>{const d=i(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};a||(a=(()=>{const o=Ve(this._basePath,t),d=o==="/"?0:o.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,c)}})());const l=async(o,d)=>{const c=await s(a(o.req.raw),...r(o));if(c)return c;await d()};return X(this,se,Ne).call(this,te,Ve(t,"*"),l),this}},pe=new WeakMap,se=new WeakSet,bs=function(){const t=new Je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,me,y(this,me)),t.routes=this.routes,t},me=new WeakMap,Ne=function(t,s,n){t=t.toUpperCase(),s=Ve(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},wt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Tt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await X(this,se,Tt).call(this,t,s,n,"GET")))();const i=this.getPath(t,{env:n}),r=this.router.match(a,i),l=new En(t,{path:i,matchResult:r,env:n,executionCtx:s,notFoundHandler:y(this,me)});if(r[0].length===1){let d;try{d=r[0][0][0][0](l,async()=>{l.res=await y(this,me).call(this,l)})}catch(c){return X(this,se,wt).call(this,c,l)}return d instanceof Promise?d.then(c=>c||(l.finalized?l.res:y(this,me).call(this,l))).catch(c=>X(this,se,wt).call(this,c,l)):d??y(this,me).call(this,l)}const o=zt(r[0],this.errorHandler,y(this,me));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return X(this,se,wt).call(this,d,l)}})()},Je),Es=[];function kn(e,t){const s=this.buildAllMatchers(),n=((a,i)=>{const r=s[a]||s[te],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],Es];const d=o.indexOf("",1);return[r[1][d],o]});return this.match=n,n(e,t)}var xt="[^/]+",ot=".*",lt="(?:|/.*)",ze=Symbol(),Ln=new Set(".\\+*[^]$()");function Rn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ot||e===lt?1:t===ot||t===lt?-1:e===xt?1:t===xt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ce,Ue,ge,Pe,In=(Pe=class{constructor(){W(this,Ce);W(this,Ue);W(this,ge,Object.create(null))}insert(t,s,n,a,i){if(t.length===0){if(y(this,Ce)!==void 0)throw ze;if(i)return;F(this,Ce,s);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",ot]:["","",xt]:r==="/*"?["","",lt]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const c=o[1];let p=o[2]||xt;if(c&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ze;if(d=y(this,ge)[p],!d){if(Object.keys(y(this,ge)).some(m=>m!==ot&&m!==lt))throw ze;if(i)return;d=y(this,ge)[p]=new Pe,c!==""&&F(d,Ue,a.varIndex++)}!i&&c!==""&&n.push([c,y(d,Ue)])}else if(d=y(this,ge)[r],!d){if(Object.keys(y(this,ge)).some(c=>c.length>1&&c!==ot&&c!==lt))throw ze;if(i)return;d=y(this,ge)[r]=new Pe}d.insert(l,s,n,a,i)}buildRegExpStr(){const s=Object.keys(y(this,ge)).sort(Rn).map(n=>{const a=y(this,ge)[n];return(typeof y(a,Ue)=="number"?`(${n})@${y(a,Ue)}`:Ln.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof y(this,Ce)=="number"&&s.unshift(`#${y(this,Ce)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ce=new WeakMap,Ue=new WeakMap,ge=new WeakMap,Pe),Rt,ft,as,An=(as=class{constructor(){W(this,Rt,{varIndex:0});W(this,ft,new In)}insert(e,t,s){const n=[],a=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const d=`@\\${r}`;return a[r]=[d,o],r++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=a.length-1;r>=0;r--){const[l]=a[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,a[r][1]);break}}return y(this,ft).insert(i,t,n,y(this,Rt),s),n}buildRegExp(){let e=y(this,ft).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(n[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Rt=new WeakMap,ft=new WeakMap,as),$n=[/^$/,[],Object.create(null)],St=Object.create(null);function ws(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Dn(){St=Object.create(null)}function Nn(e){var d;const t=new An,s=[];if(e.length===0)return $n;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[m,u])=>c?1:m?-1:p.length-u.length),a=Object.create(null);for(let c=0,p=-1,m=n.length;c<m;c++){const[u,g,f]=n[c];u?a[g]=[f.map(([_])=>[_,Object.create(null)]),Es]:p++;let h;try{h=t.insert(g,p,u)}catch(_){throw _===ze?new ys(g):_}u||(s[p]=f.map(([_,b])=>{const w=Object.create(null);for(b-=1;b>=0;b--){const[E,S]=h[b];w[E]=S}return[_,w]}))}const[i,r,l]=t.buildRegExp();for(let c=0,p=s.length;c<p;c++)for(let m=0,u=s[c].length;m<u;m++){const g=(d=s[c][m])==null?void 0:d[1];if(!g)continue;const f=Object.keys(g);for(let h=0,_=f.length;h<_;h++)g[f[h]]=l[g[f[h]]]}const o=[];for(const c in r)o[c]=s[r[c]];return[i,o,a]}function Ge(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(ws(s).test(t))return[...e[s]]}}var Re,Ie,It,Ts,is,Mn=(is=class{constructor(){W(this,It);O(this,"name","RegExpRouter");W(this,Re);W(this,Ie);O(this,"match",kn);F(this,Re,{[te]:Object.create(null)}),F(this,Ie,{[te]:Object.create(null)})}add(e,t,s){var l;const n=y(this,Re),a=y(this,Ie);if(!n||!a)throw new Error(hs);n[e]||[n,a].forEach(o=>{o[e]=Object.create(null),Object.keys(o[te]).forEach(d=>{o[e][d]=[...o[te][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=ws(t);e===te?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ge(n[d],t)||Ge(n[te],t)||[])}):(l=n[e])[t]||(l[t]=Ge(n[e],t)||Ge(n[te],t)||[]),Object.keys(n).forEach(d=>{(e===te||e===d)&&Object.keys(n[d]).forEach(c=>{o.test(c)&&n[d][c].push([s,i])})}),Object.keys(a).forEach(d=>{(e===te||e===d)&&Object.keys(a[d]).forEach(c=>o.test(c)&&a[d][c].push([s,i]))});return}const r=ds(t)||[t];for(let o=0,d=r.length;o<d;o++){const c=r[o];Object.keys(a).forEach(p=>{var m;(e===te||e===p)&&((m=a[p])[c]||(m[c]=[...Ge(n[p],c)||Ge(n[te],c)||[]]),a[p][c].push([s,i-d+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(y(this,Ie)).concat(Object.keys(y(this,Re))).forEach(t=>{e[t]||(e[t]=X(this,It,Ts).call(this,t))}),F(this,Re,F(this,Ie,void 0)),Dn(),e}},Re=new WeakMap,Ie=new WeakMap,It=new WeakSet,Ts=function(e){const t=[];let s=e===te;return[y(this,Re),y(this,Ie)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==te&&t.push(...Object.keys(n[te]).map(i=>[i,n[te][i]]))}),s?Nn(t):null},is),Ae,Ee,rs,Fn=(rs=class{constructor(e){O(this,"name","SmartRouter");W(this,Ae,[]);W(this,Ee,[]);F(this,Ae,e.routers)}add(e,t,s){if(!y(this,Ee))throw new Error(hs);y(this,Ee).push([e,t,s])}match(e,t){if(!y(this,Ee))throw new Error("Fatal error");const s=y(this,Ae),n=y(this,Ee),a=s.length;let i=0,r;for(;i<a;i++){const l=s[i];try{for(let o=0,d=n.length;o<d;o++)l.add(...n[o]);r=l.match(e,t)}catch(o){if(o instanceof ys)continue;throw o}this.match=l.match.bind(l),F(this,Ae,[l]),F(this,Ee,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(y(this,Ee)||y(this,Ae).length!==1)throw new Error("No active router has been determined yet.");return y(this,Ae)[0]}},Ae=new WeakMap,Ee=new WeakMap,rs),rt=Object.create(null),$e,le,He,et,re,we,Me,tt,On=(tt=class{constructor(t,s,n){W(this,we);W(this,$e);W(this,le);W(this,He);W(this,et,0);W(this,re,rt);if(F(this,le,n||Object.create(null)),F(this,$e,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},F(this,$e,[a])}F(this,He,[])}insert(t,s,n){F(this,et,++qt(this,et)._);let a=this;const i=dn(s),r=[];for(let l=0,o=i.length;l<o;l++){const d=i[l],c=i[l+1],p=mn(d,c),m=Array.isArray(p)?p[0]:d;if(m in y(a,le)){a=y(a,le)[m],p&&r.push(p[1]);continue}y(a,le)[m]=new tt,p&&(y(a,He).push(p),r.push(p[1])),a=y(a,le)[m]}return y(a,$e).push({[t]:{handler:n,possibleKeys:r.filter((l,o,d)=>d.indexOf(l)===o),score:y(this,et)}}),a}search(t,s){var o;const n=[];F(this,re,rt);let i=[this];const r=ls(s),l=[];for(let d=0,c=r.length;d<c;d++){const p=r[d],m=d===c-1,u=[];for(let g=0,f=i.length;g<f;g++){const h=i[g],_=y(h,le)[p];_&&(F(_,re,y(h,re)),m?(y(_,le)["*"]&&n.push(...X(this,we,Me).call(this,y(_,le)["*"],t,y(h,re))),n.push(...X(this,we,Me).call(this,_,t,y(h,re)))):u.push(_));for(let b=0,w=y(h,He).length;b<w;b++){const E=y(h,He)[b],S=y(h,re)===rt?{}:{...y(h,re)};if(E==="*"){const A=y(h,le)["*"];A&&(n.push(...X(this,we,Me).call(this,A,t,y(h,re))),F(A,re,S),u.push(A));continue}const[v,L,I]=E;if(!p&&!(I instanceof RegExp))continue;const R=y(h,le)[v],x=r.slice(d).join("/");if(I instanceof RegExp){const A=I.exec(x);if(A){if(S[L]=A[0],n.push(...X(this,we,Me).call(this,R,t,y(h,re),S)),Object.keys(y(R,le)).length){F(R,re,S);const D=((o=A[0].match(/\//))==null?void 0:o.length)??0;(l[D]||(l[D]=[])).push(R)}continue}}(I===!0||I.test(p))&&(S[L]=p,m?(n.push(...X(this,we,Me).call(this,R,t,S,y(h,re))),y(R,le)["*"]&&n.push(...X(this,we,Me).call(this,y(R,le)["*"],t,S,y(h,re)))):(F(R,re,S),u.push(R)))}}i=u.concat(l.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},$e=new WeakMap,le=new WeakMap,He=new WeakMap,et=new WeakMap,re=new WeakMap,we=new WeakSet,Me=function(t,s,n,a){const i=[];for(let r=0,l=y(t,$e).length;r<l;r++){const o=y(t,$e)[r],d=o[s]||o[te],c={};if(d!==void 0&&(d.params=Object.create(null),i.push(d),n!==rt||a&&a!==rt))for(let p=0,m=d.possibleKeys.length;p<m;p++){const u=d.possibleKeys[p],g=c[d.score];d.params[u]=a!=null&&a[u]&&!g?a[u]:n[u]??(a==null?void 0:a[u]),c[d.score]=!0}}return i},tt),Be,os,Cn=(os=class{constructor(){O(this,"name","TrieRouter");W(this,Be);F(this,Be,new On)}add(e,t,s){const n=ds(t);if(n){for(let a=0,i=n.length;a<i;a++)y(this,Be).insert(e,n[a],s);return}y(this,Be).insert(e,t,s)}match(e,t){return y(this,Be).search(e,t)}},Be=new WeakMap,os),he=class extends xn{constructor(e={}){super(e),this.router=e.router??new Fn({routers:[new Mn,new Cn]})}},Un=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:r=>i===r?r:null:typeof i=="function"?i:r=>i.includes(r)?r:null)(s.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(r,l){var c;function o(p,m){r.res.headers.set(p,m)}const d=await n(r.req.header("origin")||"",r);if(d&&o("Access-Control-Allow-Origin",d),s.credentials&&o("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await a(r.req.header("origin")||"",r);p.length&&o("Access-Control-Allow-Methods",p.join(","));let m=s.allowHeaders;if(!(m!=null&&m.length)){const u=r.req.header("Access-Control-Request-Headers");u&&(m=u.split(/\s*,\s*/))}return m!=null&&m.length&&(o("Access-Control-Allow-Headers",m.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function kt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Fe(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Hn(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let n=0,a=0;for(let o=0;o<t;o++)s[o]>0?n+=s[o]:a+=Math.abs(s[o]);let i=n/t,r=a/t;for(let o=t;o<s.length;o++){const d=s[o];i=(i*(t-1)+(d>0?d:0))/t,r=(r*(t-1)+(d<0?Math.abs(d):0))/t}return r===0?100:100-100/(1+i/r)}function Bn(e){const t=kt(e,12),s=kt(e,26),n=t-s,a=n*.9,i=n-a;return{macd:n,signal:a,histogram:i}}function Pn(e,t=20,s=2){const n=Fe(e,t),i=e.slice(-t).reduce((l,o)=>l+Math.pow(o-n,2),0)/t,r=Math.sqrt(i);return{upper:n+r*s,middle:n,lower:n-r*s}}function jn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const r=e[i].high,l=e[i].low,o=e[i-1].close,d=Math.max(r-l,Math.abs(r-o),Math.abs(l-o));s.push(d)}const n=Fe(s,t);return Math.max(n,10)}function Wn(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(p=>p.high),i=n.map(p=>p.low),r=e[e.length-1].close,l=Math.max(...a),o=Math.min(...i),d=(r-o)/(l-o)*100;return{k:d,d}}function Yn(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let d=1;d<Math.min(t+1,e.length);d++){const c=e[d].high,p=e[d].low,m=e[d-1].high,u=e[d-1].low,g=e[d-1].close,f=c-m,h=u-p;f>h&&f>0&&(s+=f),h>f&&h>0&&(n+=h),a+=Math.max(c-p,Math.abs(c-g),Math.abs(p-g))}const i=a>0?s/a*100:0,r=a>0?n/a*100:0;return{adx:i+r>0?Math.abs(i-r)/(i+r)*100:0,plusDI:i,minusDI:r}}function Gn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(_=>_.high)),a=Math.min(...s.map(_=>_.low)),i=(n+a)/2,r=Math.min(26,e.length),l=e.slice(-r),o=Math.max(...l.map(_=>_.high)),d=Math.min(...l.map(_=>_.low)),c=(o+d)/2,p=(i+c)/2,m=Math.min(52,e.length),u=e.slice(-m),g=Math.max(...u.map(_=>_.high)),f=Math.min(...u.map(_=>_.low)),h=(g+f)/2;return{tenkan:i,kijun:c,senkouA:p,senkouB:h}}function Vn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function qn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,i=n.volume||1;t+=a*i,s+=i}return s>0?t/s:e[e.length-1].close}function zn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(o=>o.high),a=s.map(o=>o.low),i=Math.max(...n),r=Math.min(...a),l=i-r;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:r}}function _e(e){if(e.length<50)return null;const t=e.map(c=>c.close),s=Bn(t),n=Pn(t),a=Wn(e,14,3),i=Yn(e,14),r=Gn(e),l=Vn(e),o=qn(e),d=zn(e,50);return{rsi_14:Hn(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:kt(t,12),ema_26:kt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:jn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:r.tenkan,ichimoku_kijun:r.kijun,ichimoku_senkou_a:r.senkouA,ichimoku_senkou_b:r.senkouB,parabolic_sar:l,vwap:o,fib_382:d.fib_382,fib_500:d.fib_500,fib_618:d.fib_618}}function ne(e,t,s){const n=[];let a=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:i+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(n.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),i+=2);const r=a+i,l=r>0?a/r*100:50;let o="HOLD",d=50;a>i+1?(o="BUY",d=Math.min(l,95)):i>a+1&&(o="SELL",d=Math.min(100-l,95)),t.adx>30&&Math.abs(a-i)>4&&(d=Math.min(d+5,95),n.push("High conviction signal"));const c=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,m=s==="day_trade"?4:5.5,u=s==="day_trade"?5:7,f=e*(1/100);let h,_,b,w;if(o==="BUY"){const E=e-t.atr_14*c;h=Math.max(E,e-f),_=e+t.atr_14*p,b=e+t.atr_14*m,w=e+t.atr_14*u}else if(o==="SELL"){const E=e+t.atr_14*c;h=Math.min(E,e+f),_=e-t.atr_14*p,b=e-t.atr_14*m,w=e-t.atr_14*u}else h=e,_=e,b=e,w=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(_.toFixed(2)),take_profit_2:parseFloat(b.toFixed(2)),take_profit_3:parseFloat(w.toFixed(2)),confidence:parseFloat(d.toFixed(1)),reason:n.join(", ")}}async function q(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function Xn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ct(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
`)}const vs=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:jt,determineTrend:Ss,formatAlignmentReport:Kn,validateMultiTimeframeSignal:Bt},Symbol.toStringTag,{value:"Module"}));function Zt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function Zn(e,t){const s=Zt(e,.95),n=Zt(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Qn(e,t,s,n){const a=t-e,i=a/t*100;let r=0;for(let d=n.length-1;d>=0&&n[d].balance<t;d--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function Jn(e,t,s=5){let n=0;const a=[];for(const o of e){const c=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=c/t*100;n+=c,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=n/t*100,r=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:a}}function ea(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[i,r,l]=a;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const d=Math.min(i.value,l.value)*.995,c=d-(r.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function ta(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],d=n[n.length-1]-n[0],c=o+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function sa(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),n=t.map(d=>d.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const d=Math.max(...s),c=t[t.length-1].close,p=d+(d-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function na(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[i,r]=a;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,d=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function aa(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),d=(i-o)/i;if(d>.01&&d<.05){const c=n-a,p=i+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function ia(e){const t=[],s=ea(e);s&&t.push(s);const n=ta(e);n&&t.push(n);const a=sa(e);a&&t.push(a);const i=na(e);i&&t.push(i);const r=aa(e);r&&t.push(r);let l=0,o=0,d=0;for(const u of t)u.direction==="bullish"?(l++,d+=u.confidence):u.direction==="bearish"&&(o++,d+=u.confidence);let c="neutral",p=0;l>o?(c="bullish",p=Math.min(d/l/10,15)):o>l&&(c="bearish",p=Math.min(d/o/10,15));let m="";if(t.length===0)m="No significant chart patterns detected";else{const u=t.map(g=>g.pattern_type).join(", ");m=`Detected ${t.length} pattern(s): ${u}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(p.toFixed(1)),summary:m}}function ra(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function oa(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function la(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function ca(e,t,s){const n=ra(t.atr_14,s),a=oa(t,s),i=la(t,s);let r,l,o,d,c,p;const m=e.slice(-10),u=m.map(_=>_.volume||0),g=u.reduce((_,b)=>_+b,0)/u.length,h=(m[m.length-1].volume||0)>g*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,d="Trend-following (aggressive entry)",c=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,d="Wait for stabilization",c=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,d="Wait for direction",c=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,d="Trend-following (buy dips, trail stops)",c=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,d="Stay in cash or short",c=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,d="Trend-following (selective entries)",c=1,p="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,d="Reduce exposure or stay flat",c=.5,p="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,d="Mean-reversion (fade extremes)",c=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,d="Wait for trend to develop",c=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:o,recommended_strategy:d,risk_adjustment:c,description:p}}function da(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],i+=o*o;const r=(t*a-s*n)/(t*i-s*s),l=(n-r*s)/t;return{slope:r,intercept:l}}function ua(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const r=(n[n.length-1]-n[n.length-10])/10;return i+r*s}function pa(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const r=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function ma(e,t,s){const n=e[e.length-1].close;e.map(r=>r.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function ga(e,t){const s=e.map(m=>m.close),n=s[s.length-1],a=10,i=s.slice(-a),r=Math.min(...i),l=Math.max(...i),o=i.map(m=>(m-r)/(l-r));let d={index:0,similarity:-1/0};for(let m=a;m<s.length-a-t;m++){const u=s.slice(m-a,m),g=Math.min(...u),f=Math.max(...u),h=u.map(w=>(w-g)/(f-g));let _=0;for(let w=0;w<a;w++)_+=Math.pow(o[w]-h[w],2);const b=-_;b>d.similarity&&(d={index:m,similarity:b})}const p=(s[d.index+t]-s[d.index])*(n/s[d.index]);return n+p}function Ot(e,t,s){const n=[],a=[],i=e.map(v=>v.close),{slope:r,intercept:l}=da(i.slice(-20)),o=r*(i.length-1+s)+l;n.push(o),a.push(1);const d=ua(e,12,s);n.push(d),a.push(1.5);const c=pa(e,s);n.push(c),a.push(1.2);const p=ma(e,t,s);n.push(p),a.push(1.8);const m=ga(e,s);n.push(m),a.push(1.3);const u=a.reduce((v,L)=>v+L,0),f=n.reduce((v,L,I)=>v+L*a[I],0)/u,h=n.reduce((v,L)=>v+L,0)/n.length,_=n.reduce((v,L)=>v+Math.pow(L-h,2),0)/n.length,b=Math.sqrt(_),w=e[e.length-1].close,E=1-b/w,S=Math.max(50,Math.min(95,E*100));return{prediction:f,confidence:S}}function fa(e,t){const s=e[e.length-1].close,n=[],a=Ot(e,t,1),i=a.prediction-s,r=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=Ot(e,t,4),o=l.prediction-s,d=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Ot(e,t,24),p=c.prediction-s,m=p/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(m.toFixed(2)),method:"Ensemble (5 models)"});const u=n.filter(b=>b.direction==="UP").length,g=n.filter(b=>b.direction==="DOWN").length;let f,h=0;u>g?(f="BULLISH",h=Math.min(u*5,15)):g>u?(f="BEARISH",h=Math.min(g*5,15)):f="NEUTRAL";const _=`ML models predict ${f} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:f,confidence_boost:parseFloat(h.toFixed(1)),summary:_}}function Ct(e,t,s,n,a){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(n-50)/10;l+=o;const d=(a-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function _a(e,t,s,n,a){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function ha(e,t,s,n,a,i){const r=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,d=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*d}function ya(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let w=14;w<r.length;w++){const E=r.slice(w-14,w);let S=0;for(let v=1;v<E.length;v++){const L=Math.max(E[v].high-E[v].low,Math.abs(E[v].high-E[v-1].close),Math.abs(E[v].low-E[v-1].close));S+=L}l.push(S/14)}const o=l.reduce((w,E)=>w+E,0)/l.length,d=a/o,c=Ct(n,e.take_profit_1,a,i,d),p=Ct(n,e.take_profit_2,a,i,d),m=Ct(n,e.take_profit_3,a,i,d),u=_a(n,e.stop_loss,a,i,e.signal_type),g=ha(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:p,tp3:m,sl:u}),h=(c+p+m)/3/u;let _;c>70&&g>5&&h>2?_="STRONG_TRADE":c>60&&g>0&&h>1.5?_="GOOD_TRADE":c>50&&g>-2?_="MARGINAL_TRADE":_="AVOID_TRADE";const b=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${_.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(m.toFixed(1)),stop_loss_probability:parseFloat(u.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:_,summary:b}}function xs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=ba(e),s=Ea(),n=wa(e,s.session),a=Ta(t,s.session),i=Sa(t,s),r=va(t,s,n,i),l=xa(r,t,s,n),o=ka(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function ba(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((d,c)=>d+(c.volume||1),0)/e.length,a=t.reduce((d,c)=>d+(c.volume||1),0)/t.length,i=s.reduce((d,c)=>d+(c.volume||1),0)/s.length,r=a/n;let l;a>i*1.2?l="INCREASING":a<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:n,current_volume:a,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function Ea(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,i;return n>=780&&n<960?(a="OVERLAP",i="HIGH"):n>=480&&n<780?(a="LONDON",i="HIGH"):n>=960&&n<1320?(a="NEW_YORK",i="HIGH"):n>=0&&n<480?(a="ASIA",i="MEDIUM"):(a="OFF_HOURS",i="LOW"),{zone:i,session:a}}function wa(e,t){const s=e.slice(-20);let n=0;for(const c of s){const p=c.high-c.low;n+=p}const a=n/s.length,i=s[s.length-1].close,r=a/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,d=l*o;return{spread_pips:Math.round(d)}}function Ta(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*i}function Sa(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function va(e,t,s,n){const a=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+i+r+l}function xa(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function ka(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Wt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function La(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function At(e=30){const t=[],s=new Date;for(const a of Wt){const i=new Date(a),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),d=i.getDay();if(o===La(r,l)&&d===5){const c=i.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&d>=1&&d<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&d>=1&&d<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,r)=>i===r.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const r=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function _t(e=new Date,t=[]){const s=[...At(7),...t],n=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(r=>r.date===a&&r.impact==="high"),Wt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Ra(a)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Ra(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function vt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Ia(e){const t=e.toISOString().split("T")[0];return Wt.includes(t)?!0:At(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Aa(){const e=new Date().toISOString().split("T")[0];return At(7).filter(s=>s.date===e)}function ks(e=new Date){const t=_t(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const Ls=new he;Ls.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const P of["5m","15m","1h","4h","daily"]){const M=await t.prepare(`
      ...
      `).bind(P).first();M&&(n[P]=M);const z=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(P).all();z.results&&z.results.length>0&&(a[P]=z.results.map(T=>({timestamp:T.timestamp,open:T.open,high:T.high,low:T.low,close:T.close,volume:T.volume||0})))}if(Object.keys(n).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(n).length}. Please fetch multi-timeframe data first.`},400);const i=[];if(n["1h"]&&n["1h"].timestamp){const P=new Date(n["1h"].timestamp).getTime(),z=(Date.now()-P)/(1e3*60);z>60?i.push(`⚠️ WARNING: 1h data is ${z.toFixed(0)} minutes old (>60 min)`):z>30&&i.push(`⚠️ CAUTION: 1h data is ${z.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${z.toFixed(1)} minutes old`)}const r=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const P=new Date(r.timestamp).getTime(),M=(Date.now()-P)/(1e3*60);M>60&&i.push(`⚠️ WARNING: Price data is ${M.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${M.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=_t(),d=ks();let c=null,p=!1;o.riskLevel==="danger"?(p=!0,c=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(c=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const m=n["1h"];if(!m)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const u=jt(n,l),g=ne(l,m,"day_trade"),f=ne(l,m,"swing_trade"),h=Bt(g.signal_type,u),_=Bt(f.signal_type,u),b={...g,base_confidence:g.confidence,mtf_confidence:h.confidence,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:u.score,alignment_type:u.type},w={...f,base_confidence:f.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:u.score,alignment_type:u.type};let E=0,S="",v=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const M=ia(a["1h"]);v=(M==null?void 0:M.patterns)||[]}catch(M){console.error("[ENHANCED] Pattern detection error:",M.message)}const P=v.filter(M=>M.confidence>=70&&M.endIndex>=a["1h"].length-5);for(const M of P)M.type==="bullish"&&b.signal_type==="BUY"?(E+=M.confidence*.1,S+=`${M.name} (${M.confidence.toFixed(0)}%), `):M.type==="bearish"&&b.signal_type==="SELL"&&(E+=M.confidence*.1,S+=`${M.name} (${M.confidence.toFixed(0)}%), `);E=Math.min(15,E)}let L=0,I="",R=null;if(a["1h"]&&a["1h"].length>=50){const P=_e(a["1h"]);P&&(R=ca(a["1h"],P),R.trend==="STRONG_UPTREND"&&b.signal_type==="BUY"?(L=10,I="Strong Uptrend"):R.trend==="UPTREND"&&b.signal_type==="BUY"?(L=5,I="Uptrend"):R.trend==="STRONG_DOWNTREND"&&b.signal_type==="SELL"?(L=10,I="Strong Downtrend"):R.trend==="DOWNTREND"&&b.signal_type==="SELL"&&(L=5,I="Downtrend"))}let x=0,A="",D=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{D=fa(a["1h"],l),D.overall_direction==="BULLISH"&&b.signal_type==="BUY"?(x=D.confidence_boost,A=`ML predicts +${((D.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):D.overall_direction==="BEARISH"&&b.signal_type==="SELL"&&(x=D.confidence_boost,A=`ML predicts ${((D.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(P){console.error("[ENHANCED] ML prediction error:",P.message)}let B=0,Y="",U=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const P=_e(a["1h"]);P&&(U=ya(b,P,a["1h"]),U.tp1_probability>70?(B=10,Y=`PoP: TP1 ${U.tp1_probability.toFixed(0)}%`):U.tp1_probability>60&&(B=5,Y=`PoP: TP1 ${U.tp1_probability.toFixed(0)}%`))}catch(P){console.error("[ENHANCED] Probability of Profit error:",P.message)}let k=null,V=0,ce=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{k=xs(a["1h"]),k.liquidity_score>=80?V=5:k.liquidity_score>=70?V=0:k.liquidity_score>=50?ce=-5:ce=-10,console.log(`[LIQUIDITY] Score: ${k.liquidity_score}/100, Session: ${k.session}, Adjust: ${V+ce}%`)}catch(P){console.error("[ENHANCED] Liquidity Analysis error:",P.message)}let N=0,K=0,ee=0,ae=0,ie="";try{const P=await t.prepare(`
      ...
      `).all(),z=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(P&&M.results&&M.results.length>=10){const T=Zn(M.results,P.balance);N=T.var_95,K=T.var_99;const oe=Qn(P.balance,M.results);if(ee=oe.current_drawdown_pct,oe.is_within_limit||(ie+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),z.results){const H=Jn(z.results,P.balance);ae=H.total_risk_pct,H.is_within_limit||(ie+=`⚠️ Portfolio heat ${ae.toFixed(1)}% exceeds limit. `)}}}catch(P){console.error("[ENHANCED] Risk metrics error (optional):",P.message)}const $=E+L+x+B+V+ce,G={...b,pattern_boost:E,regime_boost:L,ml_boost:x,pop_boost:B,total_boost:$,enhanced_confidence:Math.min(98,b.final_confidence+$),var_95:N,var_99:K,current_drawdown_pct:ee,portfolio_heat_pct:ae,risk_warning:ie||null},C={...w,pattern_boost:E,regime_boost:L,ml_boost:x,pop_boost:B,total_boost:$,enhanced_confidence:Math.min(98,w.final_confidence+$),var_95:N,var_99:K,current_drawdown_pct:ee,portfolio_heat_pct:ae,risk_warning:ie||null};p?(G.signal_type="HOLD",C.signal_type="HOLD",G.enhanced_confidence=50,C.enhanced_confidence=50,G.reasoning=c||"Economic event nearby - trading paused",C.reasoning=c||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):d.adjustment<0&&(G.enhanced_confidence=Math.max(50,G.enhanced_confidence+d.adjustment),C.enhanced_confidence=Math.max(50,C.enhanced_confidence+d.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",d.adjustment)),G.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:d.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(P=>vt(P))},C.calendar_check=G.calendar_check;let Se=!1;try{const P=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),M={};for(const z of P.results||[])M[z.setting_key]=z.setting_value;if(M.telegram_bot_token&&M.telegram_chat_id){const z=new Date().toLocaleString("en-US",{timeZone:"UTC"});let T=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${z} UTC

`;if(i.length>0){T+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const J of i)T+=`${J}
`;T+=`*→ Click "Generate Signal NOW" for fresh data*

`}o.riskLevel==="danger"?(T+=`🚨 *ECONOMIC CALENDAR ALERT*
`,T+=`${o.reason}
`,T+=`*→ NO TRADING RECOMMENDED*

`):o.riskLevel==="caution"?(T+=`⚠️ *ECONOMIC CALENDAR WARNING*
`,T+=`${o.reason}
`,T+=`*→ Reduce position size by 50%*

`):o.upcomingEvents.length>0&&(T+=`📅 *Economic Calendar:* ✅ Safe to trade
`,T+=`Next event: ${vt(o.upcomingEvents[0])}
...
`;for(const J of u.trends){const Z=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";T+=`${Z} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}if(T+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,T+=`📈 *DAY TRADE SIGNAL*
`,T+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,T+=`${G.isValid?"✅":"❌"} *${G.signal_type}* (${G.enhanced_confidence.toFixed(0)}% confidence)

`,T+=`*Entry:* $${G.price.toFixed(2)}
`,T+=`*Stop Loss:* $${G.stop_loss.toFixed(2)} (${((G.stop_loss/G.price-1)*100).toFixed(2)}%)
`,T+=`*TP1:* $${G.take_profit_1.toFixed(2)} (${((G.take_profit_1/G.price-1)*100).toFixed(2)}%)
`,T+=`*TP2:* $${G.take_profit_2.toFixed(2)} (${((G.take_profit_2/G.price-1)*100).toFixed(2)}%)
`,T+=`*TP3:* $${G.take_profit_3.toFixed(2)} (${((G.take_profit_3/G.price-1)*100).toFixed(2)}%)

`,T+=`*📊 Confidence Breakdown:*
`,T+=`Base: ${G.base_confidence.toFixed(0)}%
`,T+=`MTF: ${G.mtf_confidence.toFixed(0)}%
`,E>0&&(T+=`Pattern: +${E.toFixed(0)}%
`),L>0&&(T+=`Regime: +${L.toFixed(0)}%
`),x>0&&(T+=`ML: +${x.toFixed(0)}%
`),B>0&&(T+=`PoP: +${B.toFixed(0)}%
`),V!==0||ce!==0){const J=V+ce;T+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}T+=`*FINAL: ${G.enhanced_confidence.toFixed(0)}%*

`,R&&(T+=`🌡️ *Market Regime:* ${R.trend||"N/A"}
`,T+=`Volatility: ${R.volatility}
`,T+=`Should Trade: ${R.should_trade?"✅ YES":"❌ NO"}

`),D&&D.overall_direction!=="NEUTRAL"&&(T+=`🤖 *ML Prediction:* ${D.overall_direction}
`,(s=D.predictions[0])!=null&&s.predicted_price&&(T+=`1h Target: $${D.predictions[0].predicted_price.toFixed(2)}
`),T+=`
`),U&&(T+=`🎯 *Probability of Profit:*
`,T+=`TP1: ${U.tp1_probability.toFixed(0)}%
`,T+=`TP2: ${U.tp2_probability.toFixed(0)}%
`,T+=`TP3: ${U.tp3_probability.toFixed(0)}%
`,T+=`Expected Value: ${U.expected_value.toFixed(2)}R

`),T+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,T+=`💡 *RECOMMENDATION*
`,T+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,G.isValid&&G.signal_type!=="HOLD"?(T+=`✅ *EXECUTE ${G.signal_type}*
`,T+=`All hedge fund features aligned!
`):(T+=`⚠️ *SKIP TRADE*
`,T+=`Reason: ${G.mtf_reason}
`),T+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",T.length,"characters");const oe=await q({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},T);let H=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━
...
`;for(const J of o.upcomingEvents.slice(0,3))H+=`• ${vt(J)}
`;H+=`
`}H+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,H+=`✅ Signal generated at ${z} UTC
`,H+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",H.length,"characters");const je=await q({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},H);Se=oe&&je}}catch(P){console.error("[ENHANCED] Telegram error (optional):",P.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Se,day_trade:G,swing_trade:C,alignment:{type:u.type,score:u.score,trends:u.trends},patterns:v.length>0?v.slice(0,3):null,regime:R?{trend:R.trend,volatility:R.volatility,should_trade:R.should_trade}:null,ml_prediction:D?{direction:D.overall_direction,predictions:D.predictions}:null,profit_probability:U?{tp1:U.tp1_probability,tp2:U.tp2_probability,tp3:U.tp3_probability,expected_value:U.expected_value}:null,liquidity:k?{score:k.liquidity_score,session:k.session,time_zone:k.time_of_day_zone,volume_trend:k.volume_trend,volume_percentile:k.volume_percentile,estimated_spread_pips:k.estimated_spread_pips,price_impact_bps:k.price_impact_bps,market_depth_score:k.market_depth_score,optimal_for_trading:k.optimal_for_trading,warnings:k.warnings,recommendation:k.recommendation}:null,risk_metrics:{var_95:N,var_99:K,drawdown_pct:ee,portfolio_heat_pct:ae}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Rs=new he;Rs.post("/simple",async e=>{var s,n,a,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,w+=`⏰ ${b}`,console.log("[SIMPLE] Sending Telegram message, length:",w.length),g=await q({botToken:h.telegram_bot_token,chatId:h.telegram_chat_id},w),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:d,telegram_sent:g,day_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(d),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"day_trade"},swing_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(d),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"swing_trade"}})}catch(r){return console.error("[SIMPLE] Error:",r.message,r.stack),e.json({success:!1,error:r.message,stack:r.stack},500)}});function $a(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Da(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Na(e,t){return e>t*1.1}function Ma(e){let t=0,s=0,n=0;for(const l of e){const o=l.volume||0;n+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const a=s>0?t/s:t>0?10:1;let i="NEUTRAL";a>1.5?i="BUYING":a<.67&&(i="SELLING");let r=0;return a>3?r=100:a>1.5?r=50+(a-1.5)/1.5*50:a>.67?r=(a-.67)/.83*50:a>.33?r=50+(.67-a)/.34*50:r=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:i,strength:Math.round(r)}}function Is(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Fa(e,t){const n=Is(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Oa(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Ca(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Ua(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Ha(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Ba(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Pa(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),ja(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Wa(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),Ya(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Ga(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Va(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Ca(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Ua(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Ha(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Ba(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Pa(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close<e.open,l=s.close>s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close>(e.open+e.close)/2}function ja(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close>e.open,l=s.close<s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close<(e.open+e.close)/2}function Wa(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,i=t.low>e.low&&s.low>t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>d&&l>d&&o>d}function Ya(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,i=t.low<e.low&&s.low<t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>d&&l>d&&o>d}function Ga(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Va(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function qa(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function za(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const c=e.slice(-288),p=Math.max(...c.map(u=>u.high)),m=Math.min(...c.map(u=>u.low));s.push({level:p,type:"RESISTANCE",strength:85,distance:p-t,distancePercent:(p-t)/t*100}),s.push({level:m,type:"SUPPORT",strength:85,distance:t-m,distancePercent:(t-m)/t*100})}const n=e.slice(-50),a=Qt(n,"HIGH"),i=Qt(n,"LOW");if(a.forEach(c=>{s.push({level:c,type:"RESISTANCE",strength:75,distance:c-t,distancePercent:(c-t)/t*100})}),i.forEach(c=>{s.push({level:c,type:"SUPPORT",strength:75,distance:t-c,distancePercent:(t-c)/t*100})}),Xa(t).forEach(c=>{const p=c>t?"RESISTANCE":"SUPPORT";s.push({level:c,type:p,strength:70,distance:Math.abs(c-t),distancePercent:Math.abs(c-t)/t*100})}),e.length>=288){const c=e.slice(-288),p=Ka(c);s.push({level:p.pp,type:"PIVOT",strength:80,distance:Math.abs(p.pp-t),distancePercent:Math.abs(p.pp-t)/t*100}),s.push({level:p.r1,type:"RESISTANCE",strength:70,distance:p.r1-t,distancePercent:(p.r1-t)/t*100}),s.push({level:p.s1,type:"SUPPORT",strength:70,distance:t-p.s1,distancePercent:(t-p.s1)/t*100})}const l=s.filter(c=>Math.abs(c.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((c,p)=>Math.abs(p.distancePercent)<Math.abs(c.distancePercent)?p:c),d=Za(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:d,strength:o.strength,description:Qa(o,d)}}function Qt(e,t){const s=[];for(let i=5;i<e.length-5;i++){const r=t==="HIGH"?e[i].high:e[i].low;let l=!0;for(let o=i-5;o<=i+5;o++){if(o===i)continue;const d=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&d>=r){l=!1;break}if(t==="LOW"&&d<=r){l=!1;break}}l&&s.push(r)}return Array.from(new Set(s)).slice(-3)}function Xa(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function Ka(e){const t=Math.max(...e.map(d=>d.high)),s=Math.min(...e.map(d=>d.low)),n=e[e.length-1].close,a=(t+s+n)/3,i=2*a-s,r=2*a-t,l=a+(t-s),o=a-(t-s);return{pp:a,r1:i,s1:r,r2:l,s2:o}}function Za(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function Qa(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function Ja(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function ei(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=ti(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const i=si(s,a),r=ni(s,a);return i.type!=="NONE"&&r.type===i.type?{type:i.type,category:i.category,indicator:"BOTH",strength:95,description:`${i.type} ${i.category} (RSI+MACD)`,confidence:90}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"RSI",strength:80,description:`${i.type} ${i.category} (RSI)`,confidence:75}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"MACD",strength:70,description:`${r.type} ${r.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function ti(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const i=e[a];let r=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].high>=i.high){r=!1;break}r&&t.push({index:a,price:i.high});let l=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].low<=i.low){l=!1;break}l&&s.push({index:a,price:i.low})}return{highs:t,lows:s}}function si(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ni(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ai(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function ii(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,i=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${i}, ${e.strength}/100)`}function ri(e,t,s,n){const a=(h,_)=>{const b=parseFloat(String(h));return isNaN(b)?_:b},i=a(e.ema_12,n),r=a(t.ema_26,n),l=a(s.sma_200,n),o=Ut(n,i),d=Ut(n,r),c=Ut(n,l),p=o===d&&d===c&&o!=="NEUTRAL",m=o===d&&o!=="NEUTRAL"||o===c&&o!=="NEUTRAL"||d===c&&d!=="NEUTRAL";let u=0,g="",f="";return p?(u=100,g=`ALL ${o}`,f=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):m?(u=65,o===d?(g=`5M+15M ${o}`,f=`5m & 15m ${o.toLowerCase()} (1h ${c.toLowerCase()})`):o===c?(g=`5M+1H ${o}`,f=`5m & 1h ${o.toLowerCase()} (15m ${d.toLowerCase()})`):(g=`15M+1H ${d}`,f=`15m & 1h ${d.toLowerCase()} (5m ${o.toLowerCase()})`)):(u=30,g="MIXED",f=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${d.toLowerCase()}, 1h ${c.toLowerCase()}`),{tf5m:o,tf15m:d,tf1h:c,allAligned:p,twoAligned:m,alignment:g,strength:u,description:f}}function Ut(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function oi(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function li(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function ci(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.1?r="UP":i<-.1&&(r="DOWN");let l="NEUTRAL";r==="DOWN"?l="BULLISH":r==="UP"&&(l="BEARISH");const o=Math.abs(i);let d=-.8,c=0;o>.3?c=90:o>.2?c=75:o>.1?c=60:c=40;const p=new Date(s.timestamp),u=Math.floor((new Date().getTime()-p.getTime())/6e4),g=ui(a,i,r,l,c);return{dxyPrice:a,dxyChange:i,dxyTrend:r,goldSignalSupport:l,correlation:d,strength:c,description:g,dataAge:u}}function di(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function ui(e,t,s,n,a){const i=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${i} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${i} → Gold BEARISH (${a}/100)`:`DXY flat ${i} → Neutral (${a}/100)`}async function pi(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function mi(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function gi(e){try{const t=await e.prepare(`
      SELECT timestamp, close
      FROM dxy_cache
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function fi(e,t,s=15){const n=await gi(e);if(n.length>0){const i=new Date(n[n.length-1].timestamp),l=(new Date().getTime()-i.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),n}console.log("[DXY] Fetching fresh DXY data from API...");const a=await pi(t);return a.length>0?(await mi(e,a),a):(console.log("[DXY] Fetch failed, using stale cache"),n)}function _i(e,t,s){const n=Jt("Silver (XAG/USD)",e),a=Jt("Crude Oil (WTI)",t);let i=0;n&&Lt(n.trend,s)&&i++,a&&Lt(a.trend,s)&&i++;let r=0;const l=i>=1;i===2?r=95:i===1?r=70:r=30;const o=hi(n,a,i,s);return{silver:n,oil:a,aligned:l,alignmentCount:i,strength:r,description:o}}function Jt(e,t){if(t.length<2)return null;const s=t[t.length-1],n=t[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.2?r="UP":i<-.2&&(r="DOWN");const l=Math.abs(i);let o=0;return l>1?o=90:l>.5?o=75:l>.2?o=60:o=40,{symbol:e,price:a,change:i,trend:r,strength:o}}function Lt(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function hi(e,t,s,n){if(s===2)return`Silver & Oil both ${n==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&Lt(e.trend,n))return`Silver ${e.trend.toLowerCase()} confirms Gold ${n}`;if(t&&Lt(t.trend,n))return`Oil ${t.trend.toLowerCase()} confirms Gold ${n}`}const a=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",i=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${a}, ${i} (mixed signals)`}async function yi(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[SILVER] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function bi(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[OIL] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function Ei(e,t,s){try{const n=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const a of s)await e.prepare(`
      ...
      DELETE FROM ${n}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(n){console.error(`[${t}] Error storing data:`,n.message)}}async function wi(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",n=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!n.results||n.results.length===0?[]:n.results.map(a=>({close:a.close,timestamp:a.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function es(e,t,s,n=15){const a=await wi(e,s);if(a.length>0){const r=new Date(a[a.length-1].timestamp),o=(new Date().getTime()-r.getTime())/6e4;if(o<n)return console.log(`[${s}] Using cached data (${o.toFixed(1)}min old)`),a}console.log(`[${s}] Fetching fresh data from API...`);const i=s==="SILVER"?await yi(t):await bi(t);return i.length>0?(await Ei(e,s,i),i):(console.log(`[${s}] Fetch failed, using stale cache`),a)}function Ti(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),a=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let i="NEUTRAL",r="NEUTRAL",l=50;const o=e.percentile;if(o>=90?(i="EXTREME_BULLISH",r="BULLISH",l=95):o>=70?(i="BULLISH",r="BULLISH",l=80):o<=30?(i="BEARISH",r="BEARISH",l=80):o<=10?(i="EXTREME_BEARISH",r="BEARISH",l=95):(i="NEUTRAL",r="NEUTRAL",l=50),e.largeSpecNet>0){const c=Si(e.largeSpecNet);c>=95?r==="BEARISH"?l+=10:r==="BULLISH"&&(l-=15):c<=5&&(r==="BULLISH"?l+=10:r==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const d=xi(i,o,a);return{currentPosition:e,positioning:i,goldSignalSupport:r,strength:l,description:d,dataAge:a}}function Si(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function vi(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function xi(e,t,s){const n=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${n}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${n}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${n}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${n}]`:`COT: Neutral positioning (${t}th percentile) [${n}]`}async function ki(){return null}async function Li(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function Ri(e){try{const t=await e.prepare(`
      SELECT 
        timestamp,
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function Ii(e){const t=await Ri(e);if(t){const n=new Date(t.timestamp),i=(new Date().getTime()-n.getTime())/(1e3*60*60*24);if(i<7)return console.log(`[COT] Using cached data (${i.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await ki();return s?(await Li(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Ai(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const st=new he;st.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER] Starting scan at",n),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).bind(p,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let m=!1;if(c.grade==="A"||c.grade==="A+")try{const g=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),f={};for(const h of g.results||[])f[h.setting_key]=h.setting_value;if(f.telegram_bot_token&&f.telegram_chat_id){const h=$s(c,d);m=await q({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},h),await t.prepare(`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all(),r=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:n.results,session_stats:a.results,best_hours:i.results,recent_a_grade:r.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});st.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});st.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const d of s.results||[])n[d.setting_key]=d.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,i=15,r={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-i,tp1:a+i*2,tp2:a+i*3,tp3:a+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=$s(r,a),o=await q({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function As(e,t,s,n,a,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],d=(Q,Ye)=>{const bt=parseFloat(String(Q));return isNaN(bt)?Ye:bt};console.log("[ANALYZE] parseNum defined");const c={ema20:d(t.ema_12,i),rsi:d(t.rsi_14,50),macd:d(t.macd,0),macd_signal:d(t.macd_signal,0),macd_histogram:d(t.macd_histogram,0),adx:d(t.adx,25)},p={ema50:d(s.ema_26,i)},m={sma200:d(n.sma_200,i)},u=i>c.ema20&&i>p.ema50&&i>m.sma200,g=i<c.ema20&&i<p.ema50&&i<m.sma200;u||g?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${u?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const f=c.rsi>=40&&c.rsi<=60,h=c.macd>c.macd_signal&&c.macd_histogram>0,_=c.macd<c.macd_signal&&c.macd_histogram<0;f&&(u?h:_)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${u?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${f?"no crossover":"extreme"}`);const b=a.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,w=a[a.length-1].volume;w>b*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(w/b).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(w/b).toFixed(1)}x (need 1.5x+)`);const S=Math.max(...a.slice(-20).map(Q=>Q.high)),v=Math.min(...a.slice(-20).map(Q=>Q.low)),L=i>S*.999,I=i<v*1.001;u&&L||g&&I?(r+=15,l++,o.push(`✅ Layer 4: ${u?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let R=null;try{R=await xs(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const x=(R==null?void 0:R.liquidity_score)||50,A=(R==null?void 0:R.session)||"UNKNOWN";x>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${x}/100 (${A} session)`)):o.push(`❌ Layer 5: Liquidity ${x}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const B=_t();console.log("[ANALYZE] Calendar check complete"),B.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${B.reason}`);const U=c.adx>25,k=c.adx>70;U&&!k?(r+=10,l++,o.push(`✅ Layer 7: ADX ${c.adx.toFixed(1)} (strong trend)`)):k?o.push(`⚠️ Layer 7: ADX ${c.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${c.adx.toFixed(1)} (weak trend)`);let V="HOLD";(u||g)&&l>=5&&(V=u?"BUY":"SELL");const ce=new Date,N=$a(ce);N.hasBoost?(r+=8,l++,o.push(`✅ Layer 8: ${N.reason} (+${N.boost}% win)`)):o.push(`ℹ️ Layer 8: ${N.reason}`);const K=Da(ce);K.hasBoost?(r+=5,l++,o.push(`✅ Layer 9: ${K.reason} (+${K.boost}% win)`)):o.push(`ℹ️ Layer 9: ${K.reason}`);const ee=d(t.atr_14,i*.01),ae=a.slice(-20).reduce((Q,Ye)=>{const bt=Ye.high-Ye.low;return Q+bt},0)/20;if(Na(ee,ae)){r+=7,l++;const Q=((ee/ae-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-ee/ae)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const $=Ma(a.slice(-20));Is($,V)&&$.strength>=60&&(r+=10,l++),o.push(Fa($,V));const C=Oa(a.slice(-3)),{aligned:Se,strongestPattern:P}=qa(C,V);Se&&P?(r+=12,l++,o.push(`✅ Layer 12: ${P.name} (${P.strength}/100)`)):C.length>0&&C[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${C[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const M=za(a,i);Ja(M,V)&&M.nearZone?(r+=8,l++,o.push(`✅ Layer 13: ${M.description}`)):M.nearZone?o.push(`⚠️ Layer 13: ${M.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const oe=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),H=ei(oe,a.slice(-10)),J=ai(H,V,u?"BULLISH":g?"BEARISH":"NEUTRAL");J&&H.strength>=70&&(r+=9,l++),o.push(ii(H,J));const Z=ri(t,s,n,i),Gt=oi(Z,V);Gt&&(Z.allAligned||Z.twoAligned)&&(r+=6,l++),o.push(li(Z,Gt));const $t=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),Dt=($t==null?void 0:$t.setting_value)||"70140f57bea54c5e90768de696487d8f",qs=await fi(e,Dt,15),it=ci(qs);di(it,V)&&it.strength>=60?(r+=5,l++,o.push(`✅ Layer 18: ${it.description}`)):it.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${it.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const zs=await es(e,Dt,"SILVER",15),Xs=await es(e,Dt,"OIL",15),We=_i(zs,Xs,V);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;r+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const Ks=await Ii(e)||Ai(),ve=Ti(Ks);if(vi(ve,V)&&ve.strength>=70){const Q=ve.positioning.includes("EXTREME")?7:4;r+=Q,l++,o.push(`✅ Layer 20: ${ve.description} (${ve.strength}/100)`)}else ve.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${ve.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${ve.description}`);let yt="C";r>=162?yt="A+":r>=144?yt="A":r>=126&&(yt="B"),(u||g)&&l>=7&&(V=u?"BUY":"SELL");const xe=Math.max(ee*1.5,i*.003),Zs=V==="BUY"?i-xe:i+xe,Qs=V==="BUY"?i+xe*2:i-xe*2,Js=V==="BUY"?i+xe*3:i-xe*3,en=V==="BUY"?i+xe*4:i-xe*4;return{grade:yt,score:r,signal:V,confidence:r,layersPassed:l,layers:o,stopLoss:Zs,tp1:Qs,tp2:Js,tp3:en,liquidityScore:x,session:A,adx:c.adx,rsi:c.rsi,volumeRatio:w/b}}function $s(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,i=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,r+="Next scan in 5 minutes...",r}async function nt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(e).first();if(!a)return{success:!1,error:"Trade not found or already closed"};const i=a.trade_type==="BUY"?t-a.entry_price:a.entry_price-t,r=i*a.position_size,l=i/a.entry_price*100,o=r>0?1:0;await n.prepare(`
      ...
      WHERE id = ?
    `).bind(t,new Date().toISOString(),s,r,l,o,e).run();const c=(await nt(n)).current_balance+r;return await n.prepare(`
      UPDATE risk_limits
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(c).run(),await Fs(n),await Di(n),await Ni(n),{success:!0,profit_loss:r}}catch(a){return{success:!1,error:a.message}}}async function Fs(e){const t=await nt(e),s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,i=n.filter(u=>u.win===1).length,r=n.filter(u=>u.win===0).length,l=i/a*100,o=n.reduce((u,g)=>u+(g.profit_loss||0),0),d=Math.max(...n.map(u=>u.profit_loss||0)),c=Math.min(...n.map(u=>u.profit_loss||0)),p=n.reduce((u,g)=>u+(g.confidence||0),0)/a,m=n.reduce((u,g)=>u+(g.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,i,r,l,o,d,c,p,m).run()}async function Ni(e){const t=await nt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,i).run();let r=!1,l="";s>=t.max_drawdown_pct?(r=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(r=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),r&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});fe.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const De=new he;De.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=At(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:vt(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/today",async e=>{try{const t=Aa(),s=_t();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/check",async e=>{try{const t=_t(),s=ks();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);Ia(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});De.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ht=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Fi,calculatePositionSize:Us,calculateProfitLoss:Hs,checkDailyLossLimit:Mi,formatPositionSize:Oi},Symbol.toStringTag,{value:"Module"}));async function Bs(e,t,s){const n=Date.now(),a=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(N=>{const K=new Date(N.timestamp);return K>=new Date(t.start_date)&&K<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const d={current_balance:r,max_daily_loss_pct:2};for(let N=200;N<o.length;N++){const K=o.slice(N-200,N),ee=_e(K);if(!ee)continue;const ae=o[N],ie=ae.close,$=ne(ie,ee,"day_trade"),G=ne(ie,ee,"swing_trade");for(const C of[$,G]){if(C.signal_type==="HOLD"||C.confidence<t.min_confidence)continue;d.current_balance=r;const Se=Us(d,{entry_price:C.price,stop_loss:C.stop_loss,take_profit_1:C.take_profit_1,take_profit_2:C.take_profit_2,take_profit_3:C.take_profit_3,confidence:C.confidence,signal_type:C.signal_type,trading_style:C.trading_style},s);if(!Se.is_valid)continue;const P=ae.timestamp,M=C.price;let z=null,T=null,oe="UNKNOWN";const H=Math.min(50,o.length-N-1);for(let J=1;J<=H;J++){const Z=o[N+J];if(C.signal_type==="BUY"){if(Z.low<=C.stop_loss){z=C.stop_loss,T=Z.timestamp,oe="STOP_LOSS";break}if(Z.high>=C.take_profit_3){z=C.take_profit_3,T=Z.timestamp,oe="TP3";break}if(Z.high>=C.take_profit_2){z=C.take_profit_2,T=Z.timestamp,oe="TP2";break}if(Z.high>=C.take_profit_1){z=C.take_profit_1,T=Z.timestamp,oe="TP1";break}}else{if(Z.high>=C.stop_loss){z=C.stop_loss,T=Z.timestamp,oe="STOP_LOSS";break}if(Z.low<=C.take_profit_3){z=C.take_profit_3,T=Z.timestamp,oe="TP3";break}if(Z.low<=C.take_profit_2){z=C.take_profit_2,T=Z.timestamp,oe="TP2";break}if(Z.low<=C.take_profit_1){z=C.take_profit_1,T=Z.timestamp,oe="TP1";break}}}if(!z||!T)continue;const je=Hs(M,z,Se.units,C.signal_type,t.commission_per_trade);r+=je.profit_loss,r>l&&(l=r),a.push({entry_time:P,entry_price:M,exit_time:T,exit_price:z,signal_type:C.signal_type,trading_style:C.trading_style,position_size:Se.units,profit_loss:je.profit_loss,profit_loss_pct:je.profit_loss_pct,exit_reason:oe,confidence:C.confidence}),i.push({date:T,balance:r})}}const c=a.filter(N=>N.profit_loss>0),p=a.filter(N=>N.profit_loss<0),m=c.reduce((N,K)=>N+K.profit_loss,0),u=Math.abs(p.reduce((N,K)=>N+K.profit_loss,0)),g=r-t.starting_balance,f=a.length>0?c.length/a.length*100:0,h=c.length>0?m/c.length:0,_=p.length>0?u/p.length:0,b=c.length>0?Math.max(...c.map(N=>N.profit_loss)):0,w=p.length>0?Math.min(...p.map(N=>N.profit_loss)):0,E=u>0?m/u:m,S=100-f,v=f/100*h-S/100*_;let L=0,I=0,R=t.starting_balance;for(const N of i){N.balance>R&&(R=N.balance);const K=R-N.balance,ee=K/R*100;K>L&&(L=K,I=ee)}const x=a.map(N=>N.profit_loss_pct),A=x.reduce((N,K)=>N+K,0)/x.length,D=Math.sqrt(x.reduce((N,K)=>N+Math.pow(K-A,2),0)/x.length),B=D>0?A/D:0;let Y=0,U=0,k=0,V=0;for(const N of a)N.profit_loss>0?(k++,V=0,Y=Math.max(Y,k)):(V++,k=0,U=Math.max(U,V));const ce=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:c.length,losing_trades:p.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(h.toFixed(2)),avg_loss:parseFloat(_.toFixed(2)),largest_win:parseFloat(b.toFixed(2)),largest_loss:parseFloat(w.toFixed(2)),max_drawdown:parseFloat(L.toFixed(2)),max_drawdown_pct:parseFloat(I.toFixed(2)),profit_factor:parseFloat(E.toFixed(2)),sharpe_ratio:parseFloat(B.toFixed(2)),expectancy:parseFloat(v.toFixed(2)),max_consecutive_wins:Y,max_consecutive_losses:U,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:i,execution_time_ms:ce}}function Ps(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Ci=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Ps,runBacktest:Bs},Symbol.toStringTag,{value:"Module"})),at=new he;at.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
...
📅 Backtest ID: ${o.meta.last_row_id}
        `.trim();d=await q({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},f)}}catch(c){console.error("[BACKTEST] Telegram send failed:",c)}return e.json({success:!0,backtest_id:o.meta.last_row_id,result:l,formatted:Ps(l),telegram_sent:d})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});at.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Yt=new he;Yt.post("/market-analysis",async e=>await Ws(e));Yt.get("/auto-ai-scan",async e=>await Ws(e));async function Ws(e){const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
    ...
    `).all();let n="";for(const x of s.results||[])x.setting_key==="twelve_data_api_key"&&(n=x.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const x=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,D=await(await fetch(x)).json();D.values&&D.values.length>=50&&(a=D.values.reverse().map(B=>({timestamp:B.datetime,open:parseFloat(B.open),high:parseFloat(B.high),low:parseFloat(B.low),close:parseFloat(B.close),volume:parseFloat(B.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const x=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!x.results||x.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=x.results.reverse().map(A=>({timestamp:A.timestamp,open:A.open,high:A.high,low:A.low,close:A.close,volume:A.volume||0}))}const i=_e(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=a[a.length-1].close,l=ne(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const x of["5m","15m","1h","4h","daily"]){const A=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();A&&(o[x]=A)}const d=jt(o,r),c=a.slice(-50),p=c.map(x=>x.high).sort((x,A)=>A-x),m=c.map(x=>x.low).sort((x,A)=>x-A),u=[Math.max(...p.slice(0,10))],g=[Math.min(...m.slice(0,10))];r>i.sma_20?g.push(i.sma_20):u.push(i.sma_20),r>i.sma_50?g.push(i.sma_50):u.push(i.sma_50),r>i.vwap?g.push(i.vwap):u.push(i.vwap);const f=Math.round(r/10)*10;f>r?u.push(f):g.push(f);const h=[...new Set(u)].sort((x,A)=>x-A).filter(x=>x>r).slice(0,3),_=[...new Set(g)].sort((x,A)=>A-x).filter(x=>x<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",_,"Resistance:",h);const b=i.atr_14/r*100;let w="NORMAL";b>3?w="EXTREME":b>1.5?w="HIGH":b<.5&&(w="LOW");const E=[];let S=30,v=30,L=40;d.type==="ALL_BULLISH"?(S=60,v=20,L=20):d.type==="ALL_BEARISH"?(S=20,v=60,L=20):d.score>=4&&(d.trends.filter(x=>x.trend==="BULLISH").length>=4?(S=50,v=25,L=25):(S=25,v=50,L=25)),h.length>0&&E.push({name:"📈 BULLISH CONTINUATION",probability:S,description:`Price breaks above $${h[0].toFixed(2)} and rallies toward $${(h[h.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||r*1.02}),_.length>0&&E.push({name:"📉 BEARISH CORRECTION",probability:v,description:`Price breaks below $${_[0].toFixed(2)} and drops toward $${(_[_.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||r*.98}),E.push({name:"↔️ CONTINUED RANGING",probability:L,description:`Price oscillates between $${(_[0]||r*.99).toFixed(2)} and $${(h[0]||r*1.01).toFixed(2)} with choppy action`,trigger:w==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),E.sort((x,A)=>A.probability-x.probability);let I={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=65?l.signal_type==="BUY"?I={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(I={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):w==="EXTREME"?I.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(d.type==="MIXED"||d.type==="CONFLICTING")&&(I.reason=`⏰ Timeframes conflicting (${d.score}/5 aligned). Wait for ${h[0]?`breakout above $${h[0].toFixed(2)}`:_[0]?`breakdown below $${_[0].toFixed(2)}`:"clearer direction"}.`);let R=!1;if(l.confidence>=65)try{const x=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,U+=`💰 *Price:* $${r.toFixed(2)}
`,U+=`⚡ *Volatility:* ${w}
`,U+=`🎯 *MTF Alignment:* ${d.type} (${d.score}/5)

`,U+=`🔴 *Resistance:* ${h.length>0?h.map(k=>`$${k.toFixed(2)}`).join(", "):"N/A"}
`,U+=`🟢 *Support:* ${_.length>0?_.map(k=>`$${k.toFixed(2)}`).join(", "):"N/A"}

`,U+=`*Top Scenario:* ${E[0].name} (${E[0].probability}%)
`,U+=`${E[0].description}
...
`,U+=`🛡️ *Stop Loss:* $${I.stop_loss}`),R=await q({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},U),console.log("[AI-ANALYSIS] Telegram alert sent:",R,"for",l.signal_type,l.confidence+"%"),R&&B&&(l.signal_type==="BUY"||l.signal_type==="SELL")&&(console.log("[AI-ANALYSIS] 🔥 HIGH CONVICTION AI signal! Scheduling reminders..."),setTimeout(async()=>{let k=`${D} *⚠️ REMINDER: AI HIGH CONVICTION* ${D}
...
`),k+="⏰ Don't miss this AI signal!",await q({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},k)},120*1e3),setTimeout(async()=>{let k=`${D} *⚠️ FINAL: AI SIGNAL STILL VALID* ${D}

`;k+=`📊 *${l.signal_type}* (${l.confidence.toFixed(1)}%)
`,k+=`💰 *Current Price:* $${r.toFixed(2)}

`,k+=`🔥 Last chance - ${I.action}!
`,I.entry_range&&(k+=`🎯 *Entry:* $${I.entry_range}
`,k+=`🛡️ *Stop:* $${I.stop_loss}`),await q({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},k)},300*1e3))}}catch(x){console.error("[AI-ANALYSIS] Telegram error:",x.message)}else console.log("[AI-ANALYSIS] No Telegram alert - Confidence:",l.confidence,"Signal:",l.signal_type);return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:w,mtf_alignment:{type:d.type,score:d.score,trends:d.trends},key_levels:{resistance:h,support:_},scenarios:E,recommendation:I,telegram_sent:R}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}}const j=new he;j.use("/api/*",Un());j.route("/api/signals/enhanced",Ls);j.route("/api/signals/simple",Rs);j.route("/api/scanner",st);j.route("/api/trades",fe);j.route("/api/calendar",De);j.route("/api/backtest",at);j.route("/api/telegram",js);j.route("/api/ai",Yt);j.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));j.get("/api/signals/recent",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),n={};for(const a of s.results||[])n[a.setting_key]=a.setting_value;return e.json({success:!0,settings:n})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/settings",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const i of s.results||[])n[i.setting_key]=i.setting_value;const a=await q({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},`🔔 <b>Test Alert</b>
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});j.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Vs),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});j.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),r=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,o=await(await fetch(r)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const d=o.values,c=d.map(g=>t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(g.datetime,parseFloat(g.open)||0,parseFloat(g.high)||0,parseFloat(g.low)||0,parseFloat(g.close)||0,parseInt(g.volume||"0")||0,"1h"));await t.batch(c);const p=d.length,m=d[0],u=parseFloat(m.close)||0;return e.json({success:!0,count:p,price:u,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});j.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(u.timestamp,u.open,u.high,u.low,u.close,u.volume));await t.batch(p);const m=c.length;if(c.length>=50){const u=_e(c.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const g=c[c.length-1].close,f=ne(g,u,"day_trade"),h=ne(g,u,"swing_trade"),_=70;for(const b of[f,h])if(b.confidence>=_&&b.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(b.signal_type,b.trading_style,b.price,b.stop_loss,b.take_profit_1,b.take_profit_2,b.take_profit_3,b.confidence,b.reason).run();const w=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),E={};for(const S of w.results||[])E[S.setting_key]=S.setting_value;E.telegram_bot_token&&E.telegram_chat_id&&await q({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},ct(b))}}}return e.json({success:!0,count:m})}catch(s){return e.json({success:!1,error:s.message},500)}});j.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),n={};for(const L of s.results)n[L.setting_key]=L.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",i=n.telegram_bot_token,r=n.telegram_chat_id;console.log("[AUTO-FETCH] Settings loaded:",{hasApiKey:!!a,hasBotToken:!!i,botTokenLength:i?i.length:0,hasChatId:!!r,chatId:r});const d=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,p=await(await fetch(d)).json();if(p.code&&p.status==="error")return e.json({success:!1,error:p.message||"API error",telegram_sent:!1});if(!p.values||!Array.isArray(p.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const u=p.values.map(L=>({timestamp:L.datetime,open:parseFloat(L.open)||0,high:parseFloat(L.high)||0,low:parseFloat(L.low)||0,close:parseFloat(L.close)||0,volume:parseInt(L.volume||"0")||0})),g=u.map(L=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(L.timestamp,L.open,L.high,L.low,L.close,L.volume,"1h"));await t.batch(g);const f=_e(u);if(!f)return e.json({success:!0,count:u.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});const h=u[u.length-1].close,_=ne(h,f,"day_trade"),b=ne(h,f,"swing_trade");try{await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(_.signal_type,"day_trade",h,_.stop_loss,_.take_profit_1,_.take_profit_2,_.take_profit_3,_.confidence,_.reason).run(),await t.prepare(`
        ...
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(b.signal_type,"swing_trade",h,b.stop_loss,b.take_profit_1,b.take_profit_2,b.take_profit_3,b.confidence,b.reason).run(),console.log("[AUTO-FETCH] Signals saved to database")}catch(L){console.error("[AUTO-FETCH] Error saving signals:",L)}const w=70;let E=!1;const S=[],v={telegram_configured:!1,day_trade_checked:!1,day_trade_send_attempted:!1,day_trade_send_result:null,swing_trade_checked:!1,swing_trade_send_attempted:!1,swing_trade_send_result:null};if(console.log("[AUTO-FETCH] Telegram check:",{botToken:i?"SET":"NOT SET",chatId:r,dayConfidence:_.confidence,dayType:_.signal_type,swingConfidence:b.confidence,swingType:b.signal_type,minConfidence:w}),i&&r&&i!=="your_bot_token_here"){if(v.telegram_configured=!0,console.log("[AUTO-FETCH] Telegram is configured, checking signals..."),console.log("[AUTO-FETCH] Day trade check:",{confidence:_.confidence,minConfidence:w,meetsThreshold:_.confidence>=w,signalType:_.signal_type,notHold:_.signal_type!=="HOLD",willSend:_.confidence>=w&&_.signal_type!=="HOLD"}),v.day_trade_checked=!0,_.confidence>=w){v.day_trade_send_attempted=!0,console.log("[AUTO-FETCH] ✅ Day trade meets criteria! Sending alert...");const L=B=>B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),I=_.signal_type==="BUY"?"🟢":_.signal_type==="SELL"?"🔴":"⚪",R=_.confidence>=80,x=R?"🔥 <b>HIGH CONVICTION</b> 🔥":"",A=`${I} <b>GOLD/USD ${_.signal_type} SIGNAL</b> ${I}
${x}
...
⏰ ${new Date().toLocaleString()}`,D=await q({botToken:i,chatId:r},A);v.day_trade_send_result=D,console.log("[AUTO-FETCH] Day trade alert result:",D),D?(E=!0,S.push("Day Trade"),R&&_.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const B=`${I} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${I}
...
⏰ Don't miss this trade!`;await q({botToken:i,chatId:r},B),console.log("[AUTO-FETCH] First reminder sent")},120*1e3),setTimeout(async()=>{const B=`${I} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${I}
...
🎯 TP1: $${_.take_profit_1.toFixed(2)}
🛡️ Stop: $${_.stop_loss.toFixed(2)}`;await q({botToken:i,chatId:r},B),console.log("[AUTO-FETCH] Final reminder sent")},300*1e3),S.push("High Conviction Reminders (2+5min)"))):console.error("[AUTO-FETCH] Failed to send day trade alert!")}if(v.swing_trade_checked=!0,console.log("[AUTO-FETCH] Checking swing trade...",{confidence:b.confidence,type:b.signal_type,threshold:80}),b.confidence>=80){v.swing_trade_send_attempted=!0,console.log("[AUTO-FETCH] Swing trade meets criteria! Sending alert...");const L=B=>B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),I=b.signal_type==="BUY"?"🟢":b.signal_type==="SELL"?"🔴":"⚪",R=b.confidence>=85,x=R?"🔥 <b>HIGH CONVICTION</b> 🔥":"",A=`${I} <b>GOLD/USD ${b.signal_type} SIGNAL</b> ${I}
${x}
...
⏰ ${new Date().toLocaleString()}`,D=await q({botToken:i,chatId:r},A);v.swing_trade_send_result=D,D&&(E=!0,S.push("Swing Trade"),R&&b.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const B=`${I} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${I}
...
⏰ Don't miss this swing trade!`;await q({botToken:i,chatId:r},B),console.log("[AUTO-FETCH] Swing first reminder sent")},180*1e3),setTimeout(async()=>{const B=`${I} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${I}
...
🎯 TP1: $${b.take_profit_1.toFixed(2)}
🛡️ Stop: $${b.stop_loss.toFixed(2)}`;await q({botToken:i,chatId:r},B),console.log("[AUTO-FETCH] Swing final reminder sent")},420*1e3),S.push("High Conviction Swing Reminders (3+7min)")))}}else console.log("[AUTO-FETCH] Telegram NOT configured or invalid token");return console.log(`[CRON] Processed ${u.length} candles, Telegram: ${E?"SENT":"NOT SENT"}, Alerts: ${S.join(", ")}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:u.length,latest_price:h,data_timestamp:u[0].timestamp},signals:{day_trade:{type:_.signal_type,confidence:_.confidence,price:h},swing_trade:{type:b.signal_type,confidence:b.confidence,price:h}},telegram:{configured:!!(i&&r),bot_token_set:!!i,chat_id_set:!!r,bot_token_valid:i!=="your_bot_token_here",sent:E,alerts:S},debug:{...v,day_trade_check:{confidence:_.confidence,min_confidence:w,meets_threshold:_.confidence>=w,signal_type:_.signal_type,sends_all_signals:!0,should_alert:_.confidence>=w},swing_trade_check:{confidence:b.confidence,min_confidence:80,meets_threshold:b.confidence>=80,signal_type:b.signal_type,sends_all_signals:!0,should_alert:b.confidence>=80}},message:E?`✅ Alerts sent: ${S.join(", ")}`:"⚪ No alerts sent (signals below confidence threshold)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});j.get("/api/test/auto-fetch-settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings 
      WHERE setting_key IN ('twelve_data_api_key', 'telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const l of s.results)n[l.setting_key]=l.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",i=n.telegram_bot_token,r=n.telegram_chat_id;return e.json({success:!0,raw_results:s.results,config_object:n,extracted:{apiKey:a?`${a.substring(0,10)}...`:null,telegramBotToken:i?`${i.substring(0,10)}...`:null,telegramChatId:r,is_configured:!!(i&&r&&i!=="your_bot_token_here")}})}catch(s){return e.json({success:!1,error:s.message},500)}});j.get("/api/cron/auto-ai-scan",async e=>{var s,n,a;const{DB:t}=e.env;try{console.log("[AI-AUTO-SCAN] Starting automatic AI market analysis");const i=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'ai_auto_scan_enabled'
    `).first();if(!((i==null?void 0:i.setting_value)==="1"||(i==null?void 0:i.setting_value)==="true"))return console.log("[AI-AUTO-SCAN] Disabled in settings"),e.json({success:!0,message:"AI auto-scan is disabled",ai_scan_enabled:!1});const l=await((n=(s=e.env.app)==null?void 0:s.fetch)==null?void 0:n.call(s,new Request(new URL("/api/ai/market-analysis",e.req.url).toString(),{method:"POST"})));if(l){const o=await l.json();return console.log("[AI-AUTO-SCAN] Analysis complete:",o.success?"Success":"Failed"),e.json({success:!0,ai_scan_enabled:!0,analysis:o,message:(a=o.analysis)!=null&&a.telegram_sent?"🤖 AI analysis complete - Telegram alert sent":"🤖 AI analysis complete - No alert (confidence < 65% or HOLD)"})}return e.json({success:!1,error:"Failed to run AI analysis"},500)}catch(i){return console.error("[AI-AUTO-SCAN] Error:",i),e.json({success:!1,error:i.message},500)}});j.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let r=0;const l={};for(const o of i){const d=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${o.interval}&apikey=${n}&outputsize=${o.outputsize}`,p=await(await fetch(d)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const m=p.values;let u=0;const g=[];for(const f of m){const h={timestamp:f.datetime,open:parseFloat(f.open)||0,high:parseFloat(f.high)||0,low:parseFloat(f.low)||0,close:parseFloat(f.close)||0,volume:0};g.push(h),await t.prepare(`
        ...
        `).bind(h.timestamp,h.open,h.high,h.low,h.close,h.volume,o.dbKey).run(),u++}if(g.length>=50){const f=_e(g.reverse());f&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,f.rsi_14,f.macd,f.macd_signal,f.macd_histogram,f.sma_20,f.sma_50,f.sma_200,f.ema_12,f.ema_26,f.bb_upper,f.bb_middle,f.bb_lower,f.atr_14,f.stochastic_k,f.stochastic_d,f.adx,f.plus_di,f.minus_di,f.ichimoku_tenkan,f.ichimoku_kijun,f.ichimoku_senkou_a,f.ichimoku_senkou_b,f.parabolic_sar,f.vwap,f.fib_382,f.fib_500,f.fib_618).run()}l[o.dbKey]={success:!0,count:u},r+=u,await new Promise(f=>setTimeout(f,500))}return e.json({success:!0,totalCount:r,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),a=_e(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,r=ne(i,a,"day_trade"),l=ne(i,a,"swing_trade");return e.json({success:!0,signals:{day_trade:r,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>vs),i=["5m","15m","1h","4h","daily"],r={};for(const v of i){const L=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(v).first();L&&(r[v]=L)}const l=Object.keys(r).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(r)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const d=o.close,c=s(r,d),p=r["1h"],m=ne(d,p,"day_trade"),u=ne(d,p,"swing_trade"),g=n(m.signal_type,c),f=n(u.signal_type,c),h={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:c.score,alignment_type:c.type,reason:`${m.reason}, MTF: ${g.reason}`},_={...u,base_confidence:u.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:c.score,alignment_type:c.type,reason:`${u.reason}, MTF: ${f.reason}`},b=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),w={};for(const v of b.results||[])w[v.setting_key]=v.setting_value;let E=!1,S=[];w.telegram_bot_token&&w.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await q({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${ct({...h,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(S.push("day_trade"),E=!0),await new Promise(v=>setTimeout(v,1e3)),_.isValid&&_.signal_type!=="HOLD"&&await q({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${ct({..._,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(S.push("swing_trade"),E=!0));for(const v of[h,_])v.isValid&&await t.prepare(`
    ...
    `).bind(n).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const f=new Date().toISOString().split("T")[0],h=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,f).all(),{checkDailyLossLimit:_}=await Promise.resolve().then(()=>ht),b=_(g,h.results);if(b.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${b.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const w=c*i,E=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>ht),i=a(n.results);return e.json({success:!0,stats:i})}catch(n){return e.json({success:!1,error:n.message},500)}});j.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    `).bind(n.timeframe||"1h").all();if(!a.results||a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=a.results)==null?void 0:s.length)||0}`},400);const i=await t.prepare(`
      ...
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:r,formatBacktestResults:l}=await Promise.resolve().then(()=>Ci),o=await r(a.results,{start_date:n.start_date||"2024-01-01",end_date:n.end_date||new Date().toISOString().split("T")[0],starting_balance:n.starting_balance||1e4,min_confidence:n.min_confidence||75,use_mtf_confirmation:n.use_mtf_confirmation!==!1,use_news_filter:n.use_news_filter!==!1,timeframe:n.timeframe||"1h",commission_per_trade:n.commission_per_trade||0},i.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
    ...
    `).first(),r=!n&&(i==null?void 0:i.count)>0;let l=0;if(r)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const Y=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),U=(Y==null?void 0:Y.setting_value)||"70140f57bea54c5e90768de696487d8f",k=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const V of k)try{const ce=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${V.interval}&apikey=${U}&outputsize=100`,N=new AbortController,K=setTimeout(()=>N.abort(),1e4),ee=await fetch(ce,{signal:N.signal});clearTimeout(K);const ae=await ee.json();if(ae.values&&Array.isArray(ae.values)){const ie=[];for(const $ of ae.values)ie.push({timestamp:$.datetime,open:parseFloat($.open)||0,high:parseFloat($.high)||0,low:parseFloat($.low)||0,close:parseFloat($.close)||0,volume:0});for(const $ of ie)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind($.timestamp,$.open,$.high,$.low,$.close,$.volume,V.dbKey).run();if(ie.length>=50){const $=_e(ie.reverse());$&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(V.dbKey,$.rsi_14,$.macd,$.macd_signal,$.macd_histogram,$.sma_20,$.sma_50,$.sma_200,$.ema_12,$.ema_26,$.bb_upper,$.bb_middle,$.bb_lower,$.atr_14,$.stochastic_k,$.stochastic_d,$.adx,$.plus_di,$.minus_di,$.ichimoku_tenkan,$.ichimoku_kijun,$.ichimoku_senkou_a,$.ichimoku_senkou_b,$.parabolic_sar,$.vwap,$.fib_382,$.fib_500,$.fib_618).run()}l+=ae.values.length}await new Promise(ie=>setTimeout(ie,100))}catch(ce){console.error(`[MTF] Error fetching ${V.dbKey}:`,ce)}}a.steps[0].status="completed",a.steps[0].data={totalCandles:l},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:o,validateMultiTimeframeSignal:d,formatAlignmentReport:c}=await Promise.resolve().then(()=>vs),p={};for(const Y of["5m","15m","1h","4h","daily"]){const U=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(Y).first();U&&(p[Y]=U)}const m=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    ...
    `).first(),L=await t.prepare(`
      ...
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:I}=await Promise.resolve().then(()=>ht),R=I(v,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},L.results),x=I(v,{entry_price:S.price,stop_loss:S.stop_loss,take_profit_1:S.take_profit_1,take_profit_2:S.take_profit_2,take_profit_3:S.take_profit_3,confidence:S.final_confidence,signal_type:S.signal_type,trading_style:S.trading_style},L.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:R,swingPosition:x},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const A=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();B=await q({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},Y)}if(a.steps[3].status=B?"completed":"failed",a.steps[3].data={telegramSent:B},E.isValid||S.isValid)for(const Y of[E,S])Y.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(Y.signal_type,Y.trading_style,Y.price,Y.stop_loss,Y.take_profit_1,Y.take_profit_2,Y.take_profit_3,Y.confidence,Y.final_confidence,Y.final_confidence,Y.alignment_score,Y.alignment_type,Y.reason,B?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:a,signals:{day_trade:E,swing_trade:S},positions:{day_trade:R,swing_trade:x},alignment:g,telegram_sent:B})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});const ts=new he,Ui=Object.assign({"/src/index.tsx":j});let Ys=!1;for(const[,e]of Object.entries(Ui))e&&(ts.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),ts.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Ys=!0);if(!Ys)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Hi=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],Bi=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function Gs(e){const t=e.toLowerCase();let s=0,n=0;for(const l of Hi)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of Bi)t.includes(l)&&(n+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(n+=1));const a=s+n;let i=0;a>0&&(i=(s-n)/a*100);let r="neutral";return i>20?r="bullish":i<-20&&(r="bearish"),{sentiment:r,score:i}}function Pi(e){let t=0,s=0,n=0,a=0;const i=e.map(o=>{const d=`${o.title} ${o.description||""}`,c=Gs(d);return c.sentiment==="bullish"?t++:c.sentiment==="bearish"?s++:n++,a+=c.score,{...o,sentiment:c.sentiment,score:c.score}}),r=e.length>0?a/e.length:0;let l="neutral";return r>20?l="bullish":r<-20&&(l="bearish"),{overall:l,score:Math.round(r),bullishCount:t,bearishCount:s,neutralCount:n,articles:i.slice(0,10)}}async function ji(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,a=await(await fetch(s)).json();return a.status!=="ok"?(console.error("NewsAPI error:",a.message),[]):a.articles.map(i=>({title:i.title,description:i.description,url:i.url,publishedAt:i.publishedAt,source:i.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function Wi(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(n=>{const a=new Date(n.date);return a>=e&&a<=t})}const Vs=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:Pi,analyzeSentiment:Gs,fetchGoldNews:ji,getEconomicEvents:Wi},Symbol.toStringTag,{value:"Module"}));export{ts as default};
