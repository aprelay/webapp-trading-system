var Rs=Object.defineProperty;var Mt=e=>{throw TypeError(e)};var Ls=(e,t,s)=>t in e?Rs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var A=(e,t,s)=>Ls(e,typeof t!="symbol"?t+"":t,s),Et=(e,t,s)=>t.has(e)||Mt("Cannot "+s);var h=(e,t,s)=>(Et(e,t,"read from private field"),s?s.call(e):t.get(e)),H=(e,t,s)=>t.has(e)?Mt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),M=(e,t,s,a)=>(Et(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),z=(e,t,s)=>(Et(e,t,"access private method"),s);var At=(e,t,s,a)=>({set _(n){M(e,t,n,s)},get _(){return h(e,t,a)}});var $t=(e,t,s)=>(a,n)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,c=!1,d;if(e[l]?(d=e[l][0][0],a.req.routeIndex=l):d=l===e.length&&n||void 0,d)try{o=await d(a,()=>r(l+1))}catch(p){if(p instanceof Error&&t)a.error=p,o=await t(p,a),c=!0;else throw p}else a.finalized===!1&&s&&(o=await s(a));return o&&(a.finalized===!1||c)&&(a.res=o),a}},Ds=Symbol(),Is=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof Xt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Fs(e,{all:s,dot:a}):{}};async function Fs(e,t){const s=await e.formData();return s?Ms(s,t):{}}function Ms(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?As(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&($s(s,a,n),delete s[a])}),s}var As=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},$s=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},Yt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ns=e=>{const{groups:t,path:s}=Os(e),a=Yt(s);return Cs(a,t)},Os=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},Cs=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},ut={},Ps=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return ut[a]||(s[2]?ut[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:ut[a]=[e,s[1],!0]),ut[a]}return null},Dt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Hs=e=>Dt(e,decodeURI),zt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const i=t.indexOf("?",a),r=t.slice(s,i===-1?void 0:i);return Hs(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(n===63)break}return t.slice(s,a)},js=e=>{const t=zt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},je=(e,t,...s)=>(s.length&&(t=je(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),qt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const i=n.replace("?","");a+="/"+i,s.push(a)}else a+="/"+n}),s.filter((n,i,r)=>r.indexOf(n)===i)},xt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Dt(e,Kt):e):e,Gt=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,c=e.indexOf("&",o);return xt(e.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(a&&(o=xt(o)),i=r,o==="")continue;let c;l===-1?c="":(c=e.slice(l+1,r===-1?void 0:r),a&&(c=xt(c))),s?(n[o]&&Array.isArray(n[o])||(n[o]=[]),n[o].push(c)):n[o]??(n[o]=c)}return t?n[t]:n},Us=Gt,Bs=(e,t)=>Gt(e,t,!0),Kt=decodeURIComponent,Nt=e=>Dt(e,Kt),We,oe,we,Zt,Qt,Rt,xe,Ht,Xt=(Ht=class{constructor(e,t="/",s=[[]]){H(this,we);A(this,"raw");H(this,We);H(this,oe);A(this,"routeIndex",0);A(this,"path");A(this,"bodyCache",{});H(this,xe,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,M(this,oe,s),M(this,We,{})}param(e){return e?z(this,we,Zt).call(this,e):z(this,we,Qt).call(this)}query(e){return Us(this.url,e)}queries(e){return Bs(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Is(this,e))}json(){return h(this,xe).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,xe).call(this,"text")}arrayBuffer(){return h(this,xe).call(this,"arrayBuffer")}blob(){return h(this,xe).call(this,"blob")}formData(){return h(this,xe).call(this,"formData")}addValidatedData(e,t){h(this,We)[e]=t}valid(e){return h(this,We)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ds](){return h(this,oe)}get matchedRoutes(){return h(this,oe)[0].map(([[,e]])=>e)}get routePath(){return h(this,oe)[0].map(([[,e]])=>e)[this.routeIndex].path}},We=new WeakMap,oe=new WeakMap,we=new WeakSet,Zt=function(e){const t=h(this,oe)[0][this.routeIndex][1][e],s=z(this,we,Rt).call(this,t);return s&&/\%/.test(s)?Nt(s):s},Qt=function(){const e={},t=Object.keys(h(this,oe)[0][this.routeIndex][1]);for(const s of t){const a=z(this,we,Rt).call(this,h(this,oe)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?Nt(a):a)}return e},Rt=function(e){return h(this,oe)[1]?h(this,oe)[1][e]:e},xe=new WeakMap,Ht),Ws={Stringify:1},Jt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(l=>l({phase:t,buffer:n,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(o=>Jt(o,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Vs="text/plain; charset=UTF-8",St=(e,t)=>({"Content-Type":e,...t}),at,nt,fe,Ve,he,ae,it,Ye,ze,Ae,rt,ot,Se,Ue,jt,Ys=(jt=class{constructor(e,t){H(this,Se);H(this,at);H(this,nt);A(this,"env",{});H(this,fe);A(this,"finalized",!1);A(this,"error");H(this,Ve);H(this,he);H(this,ae);H(this,it);H(this,Ye);H(this,ze);H(this,Ae);H(this,rt);H(this,ot);A(this,"render",(...e)=>(h(this,Ye)??M(this,Ye,t=>this.html(t)),h(this,Ye).call(this,...e)));A(this,"setLayout",e=>M(this,it,e));A(this,"getLayout",()=>h(this,it));A(this,"setRenderer",e=>{M(this,Ye,e)});A(this,"header",(e,t,s)=>{this.finalized&&M(this,ae,new Response(h(this,ae).body,h(this,ae)));const a=h(this,ae)?h(this,ae).headers:h(this,Ae)??M(this,Ae,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});A(this,"status",e=>{M(this,Ve,e)});A(this,"set",(e,t)=>{h(this,fe)??M(this,fe,new Map),h(this,fe).set(e,t)});A(this,"get",e=>h(this,fe)?h(this,fe).get(e):void 0);A(this,"newResponse",(...e)=>z(this,Se,Ue).call(this,...e));A(this,"body",(e,t,s)=>z(this,Se,Ue).call(this,e,t,s));A(this,"text",(e,t,s)=>!h(this,Ae)&&!h(this,Ve)&&!t&&!s&&!this.finalized?new Response(e):z(this,Se,Ue).call(this,e,t,St(Vs,s)));A(this,"json",(e,t,s)=>z(this,Se,Ue).call(this,JSON.stringify(e),t,St("application/json",s)));A(this,"html",(e,t,s)=>{const a=n=>z(this,Se,Ue).call(this,n,t,St("text/html; charset=UTF-8",s));return typeof e=="object"?Jt(e,Ws.Stringify,!1,{}).then(a):a(e)});A(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});A(this,"notFound",()=>(h(this,ze)??M(this,ze,()=>new Response),h(this,ze).call(this,this)));M(this,at,e),t&&(M(this,he,t.executionCtx),this.env=t.env,M(this,ze,t.notFoundHandler),M(this,ot,t.path),M(this,rt,t.matchResult))}get req(){return h(this,nt)??M(this,nt,new Xt(h(this,at),h(this,ot),h(this,rt))),h(this,nt)}get event(){if(h(this,he)&&"respondWith"in h(this,he))return h(this,he);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,he))return h(this,he);throw Error("This context has no ExecutionContext")}get res(){return h(this,ae)||M(this,ae,new Response(null,{headers:h(this,Ae)??M(this,Ae,new Headers)}))}set res(e){if(h(this,ae)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,ae).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=h(this,ae).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}M(this,ae,e),this.finalized=!0}get var(){return h(this,fe)?Object.fromEntries(h(this,fe)):{}}},at=new WeakMap,nt=new WeakMap,fe=new WeakMap,Ve=new WeakMap,he=new WeakMap,ae=new WeakMap,it=new WeakMap,Ye=new WeakMap,ze=new WeakMap,Ae=new WeakMap,rt=new WeakMap,ot=new WeakMap,Se=new WeakSet,Ue=function(e,t,s){const a=h(this,ae)?new Headers(h(this,ae).headers):h(this,Ae)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?a.append(r,l):a.set(r,l)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")a.set(i,r);else{a.delete(i);for(const l of r)a.append(i,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ve);return new Response(e,{status:n,headers:a})},jt),Z="ALL",zs="all",qs=["get","post","put","delete","options","patch"],es="Can not add a route since the matcher is already built.",ts=class extends Error{},Gs="__COMPOSED_HANDLER",Ks=e=>e.text("404 Not Found",404),Ot=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},de,Q,ss,ue,Ie,pt,mt,qe,Xs=(qe=class{constructor(t={}){H(this,Q);A(this,"get");A(this,"post");A(this,"put");A(this,"delete");A(this,"options");A(this,"patch");A(this,"all");A(this,"on");A(this,"use");A(this,"router");A(this,"getPath");A(this,"_basePath","/");H(this,de,"/");A(this,"routes",[]);H(this,ue,Ks);A(this,"errorHandler",Ot);A(this,"onError",t=>(this.errorHandler=t,this));A(this,"notFound",t=>(M(this,ue,t),this));A(this,"fetch",(t,...s)=>z(this,Q,mt).call(this,t,s[1],s[0],t.method));A(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${je("/",t)}`,s),a,n)));A(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(z(this,Q,mt).call(this,t.request,t,void 0,t.request.method))})});[...qs,zs].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?M(this,de,r):z(this,Q,Ie).call(this,i,h(this,de),r),l.forEach(o=>{z(this,Q,Ie).call(this,i,h(this,de),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){M(this,de,o);for(const c of[i].flat())l.map(d=>{z(this,Q,Ie).call(this,c.toUpperCase(),h(this,de),d)})}return this},this.use=(i,...r)=>(typeof i=="string"?M(this,de,i):(M(this,de,"*"),r.unshift(i)),r.forEach(l=>{z(this,Q,Ie).call(this,Z,h(this,de),l)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??zt:js}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let i;s.errorHandler===Ot?i=n.handler:(i=async(l,o)=>(await $t([],s.errorHandler)(l,()=>n.handler(l,o))).res,i[Gs]=n.handler),z(r=a,Q,Ie).call(r,n.method,n.path,i)}),this}basePath(t){const s=z(this,Q,ss).call(this);return s._basePath=je(this._basePath,t),s}mount(t,s,a){let n,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?n=o=>o:n=a.replaceRequest));const r=i?o=>{const c=i(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};n||(n=(()=>{const o=je(this._basePath,t),c=o==="/"?0:o.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const l=async(o,c)=>{const d=await s(n(o.req.raw),...r(o));if(d)return d;await c()};return z(this,Q,Ie).call(this,Z,je(t,"*"),l),this}},de=new WeakMap,Q=new WeakSet,ss=function(){const t=new qe({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,M(t,ue,h(this,ue)),t.routes=this.routes,t},ue=new WeakMap,Ie=function(t,s,a){t=t.toUpperCase(),s=je(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},pt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},mt=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await z(this,Q,mt).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),r=this.router.match(n,i),l=new Ys(t,{path:i,matchResult:r,env:a,executionCtx:s,notFoundHandler:h(this,ue)});if(r[0].length===1){let c;try{c=r[0][0][0][0](l,async()=>{l.res=await h(this,ue).call(this,l)})}catch(d){return z(this,Q,pt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:h(this,ue).call(this,l))).catch(d=>z(this,Q,pt).call(this,d,l)):c??h(this,ue).call(this,l)}const o=$t(r[0],this.errorHandler,h(this,ue));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return z(this,Q,pt).call(this,c,l)}})()},qe),as=[];function Zs(e,t){const s=this.buildAllMatchers(),a=((n,i)=>{const r=s[n]||s[Z],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],as];const c=o.indexOf("",1);return[r[1][c],o]});return this.match=a,a(e,t)}var ft="[^/]+",et=".*",tt="(?:|/.*)",Be=Symbol(),Qs=new Set(".\\+*[^]$()");function Js(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===et||e===tt?1:t===et||t===tt?-1:e===ft?1:t===ft?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var $e,Ne,pe,Pe,ea=(Pe=class{constructor(){H(this,$e);H(this,Ne);H(this,pe,Object.create(null))}insert(t,s,a,n,i){if(t.length===0){if(h(this,$e)!==void 0)throw Be;if(i)return;M(this,$e,s);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",et]:["","",ft]:r==="/*"?["","",tt]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const d=o[1];let p=o[2]||ft;if(d&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Be;if(c=h(this,pe)[p],!c){if(Object.keys(h(this,pe)).some(u=>u!==et&&u!==tt))throw Be;if(i)return;c=h(this,pe)[p]=new Pe,d!==""&&M(c,Ne,n.varIndex++)}!i&&d!==""&&a.push([d,h(c,Ne)])}else if(c=h(this,pe)[r],!c){if(Object.keys(h(this,pe)).some(d=>d.length>1&&d!==et&&d!==tt))throw Be;if(i)return;c=h(this,pe)[r]=new Pe}c.insert(l,s,a,n,i)}buildRegExpStr(){const s=Object.keys(h(this,pe)).sort(Js).map(a=>{const n=h(this,pe)[a];return(typeof h(n,Ne)=="number"?`(${a})@${h(n,Ne)}`:Qs.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof h(this,$e)=="number"&&s.unshift(`#${h(this,$e)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},$e=new WeakMap,Ne=new WeakMap,pe=new WeakMap,Pe),yt,lt,Ut,ta=(Ut=class{constructor(){H(this,yt,{varIndex:0});H(this,lt,new ea)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const c=`@\\${r}`;return n[r]=[c,o],r++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[l]=n[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,n[r][1]);break}}return h(this,lt).insert(i,t,a,h(this,yt),s),a}buildRegExp(){let e=h(this,lt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},yt=new WeakMap,lt=new WeakMap,Ut),sa=[/^$/,[],Object.create(null)],_t=Object.create(null);function ns(e){return _t[e]??(_t[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function aa(){_t=Object.create(null)}function na(e){var c;const t=new ta,s=[];if(e.length===0)return sa;const a=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[u,m])=>d?1:u?-1:p.length-m.length),n=Object.create(null);for(let d=0,p=-1,u=a.length;d<u;d++){const[m,g,_]=a[d];m?n[g]=[_.map(([y])=>[y,Object.create(null)]),as]:p++;let f;try{f=t.insert(g,p,m)}catch(y){throw y===Be?new ts(g):y}m||(s[p]=_.map(([y,x])=>{const b=Object.create(null);for(x-=1;x>=0;x--){const[v,B]=f[x];b[v]=B}return[y,b]}))}const[i,r,l]=t.buildRegExp();for(let d=0,p=s.length;d<p;d++)for(let u=0,m=s[d].length;u<m;u++){const g=(c=s[d][u])==null?void 0:c[1];if(!g)continue;const _=Object.keys(g);for(let f=0,y=_.length;f<y;f++)g[_[f]]=l[g[_[f]]]}const o=[];for(const d in r)o[d]=s[r[d]];return[i,o,n]}function He(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(ns(s).test(t))return[...e[s]]}}var ke,Te,bt,is,Bt,ia=(Bt=class{constructor(){H(this,bt);A(this,"name","RegExpRouter");H(this,ke);H(this,Te);A(this,"match",Zs);M(this,ke,{[Z]:Object.create(null)}),M(this,Te,{[Z]:Object.create(null)})}add(e,t,s){var l;const a=h(this,ke),n=h(this,Te);if(!a||!n)throw new Error(es);a[e]||[a,n].forEach(o=>{o[e]=Object.create(null),Object.keys(o[Z]).forEach(c=>{o[e][c]=[...o[Z][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=ns(t);e===Z?Object.keys(a).forEach(c=>{var d;(d=a[c])[t]||(d[t]=He(a[c],t)||He(a[Z],t)||[])}):(l=a[e])[t]||(l[t]=He(a[e],t)||He(a[Z],t)||[]),Object.keys(a).forEach(c=>{(e===Z||e===c)&&Object.keys(a[c]).forEach(d=>{o.test(d)&&a[c][d].push([s,i])})}),Object.keys(n).forEach(c=>{(e===Z||e===c)&&Object.keys(n[c]).forEach(d=>o.test(d)&&n[c][d].push([s,i]))});return}const r=qt(t)||[t];for(let o=0,c=r.length;o<c;o++){const d=r[o];Object.keys(n).forEach(p=>{var u;(e===Z||e===p)&&((u=n[p])[d]||(u[d]=[...He(a[p],d)||He(a[Z],d)||[]]),n[p][d].push([s,i-c+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Te)).concat(Object.keys(h(this,ke))).forEach(t=>{e[t]||(e[t]=z(this,bt,is).call(this,t))}),M(this,ke,M(this,Te,void 0)),aa(),e}},ke=new WeakMap,Te=new WeakMap,bt=new WeakSet,is=function(e){const t=[];let s=e===Z;return[h(this,ke),h(this,Te)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==Z&&t.push(...Object.keys(a[Z]).map(i=>[i,a[Z][i]]))}),s?na(t):null},Bt),Re,ye,Wt,ra=(Wt=class{constructor(e){A(this,"name","SmartRouter");H(this,Re,[]);H(this,ye,[]);M(this,Re,e.routers)}add(e,t,s){if(!h(this,ye))throw new Error(es);h(this,ye).push([e,t,s])}match(e,t){if(!h(this,ye))throw new Error("Fatal error");const s=h(this,Re),a=h(this,ye),n=s.length;let i=0,r;for(;i<n;i++){const l=s[i];try{for(let o=0,c=a.length;o<c;o++)l.add(...a[o]);r=l.match(e,t)}catch(o){if(o instanceof ts)continue;throw o}this.match=l.match.bind(l),M(this,Re,[l]),M(this,ye,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(h(this,ye)||h(this,Re).length!==1)throw new Error("No active router has been determined yet.");return h(this,Re)[0]}},Re=new WeakMap,ye=new WeakMap,Wt),Je=Object.create(null),Le,se,Oe,Ge,ee,be,Fe,Ke,oa=(Ke=class{constructor(t,s,a){H(this,be);H(this,Le);H(this,se);H(this,Oe);H(this,Ge,0);H(this,ee,Je);if(M(this,se,a||Object.create(null)),M(this,Le,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},M(this,Le,[n])}M(this,Oe,[])}insert(t,s,a){M(this,Ge,++At(this,Ge)._);let n=this;const i=Ns(s),r=[];for(let l=0,o=i.length;l<o;l++){const c=i[l],d=i[l+1],p=Ps(c,d),u=Array.isArray(p)?p[0]:c;if(u in h(n,se)){n=h(n,se)[u],p&&r.push(p[1]);continue}h(n,se)[u]=new Ke,p&&(h(n,Oe).push(p),r.push(p[1])),n=h(n,se)[u]}return h(n,Le).push({[t]:{handler:a,possibleKeys:r.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,Ge)}}),n}search(t,s){var o;const a=[];M(this,ee,Je);let i=[this];const r=Yt(s),l=[];for(let c=0,d=r.length;c<d;c++){const p=r[c],u=c===d-1,m=[];for(let g=0,_=i.length;g<_;g++){const f=i[g],y=h(f,se)[p];y&&(M(y,ee,h(f,ee)),u?(h(y,se)["*"]&&a.push(...z(this,be,Fe).call(this,h(y,se)["*"],t,h(f,ee))),a.push(...z(this,be,Fe).call(this,y,t,h(f,ee)))):m.push(y));for(let x=0,b=h(f,Oe).length;x<b;x++){const v=h(f,Oe)[x],B=h(f,ee)===Je?{}:{...h(f,ee)};if(v==="*"){const R=h(f,se)["*"];R&&(a.push(...z(this,be,Fe).call(this,R,t,h(f,ee))),M(R,ee,B),m.push(R));continue}const[E,C,j]=v;if(!p&&!(j instanceof RegExp))continue;const T=h(f,se)[E],S=r.slice(c).join("/");if(j instanceof RegExp){const R=j.exec(S);if(R){if(B[C]=R[0],a.push(...z(this,be,Fe).call(this,T,t,h(f,ee),B)),Object.keys(h(T,se)).length){M(T,ee,B);const I=((o=R[0].match(/\//))==null?void 0:o.length)??0;(l[I]||(l[I]=[])).push(T)}continue}}(j===!0||j.test(p))&&(B[C]=p,u?(a.push(...z(this,be,Fe).call(this,T,t,B,h(f,ee))),h(T,se)["*"]&&a.push(...z(this,be,Fe).call(this,h(T,se)["*"],t,B,h(f,ee)))):(M(T,ee,B),m.push(T)))}}i=m.concat(l.shift()??[])}return a.length>1&&a.sort((c,d)=>c.score-d.score),[a.map(({handler:c,params:d})=>[c,d])]}},Le=new WeakMap,se=new WeakMap,Oe=new WeakMap,Ge=new WeakMap,ee=new WeakMap,be=new WeakSet,Fe=function(t,s,a,n){const i=[];for(let r=0,l=h(t,Le).length;r<l;r++){const o=h(t,Le)[r],c=o[s]||o[Z],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),a!==Je||n&&n!==Je))for(let p=0,u=c.possibleKeys.length;p<u;p++){const m=c.possibleKeys[p],g=d[c.score];c.params[m]=n!=null&&n[m]&&!g?n[m]:a[m]??(n==null?void 0:n[m]),d[c.score]=!0}}return i},Ke),Ce,Vt,la=(Vt=class{constructor(){A(this,"name","TrieRouter");H(this,Ce);M(this,Ce,new oa)}add(e,t,s){const a=qt(t);if(a){for(let n=0,i=a.length;n<i;n++)h(this,Ce).insert(e,a[n],s);return}h(this,Ce).insert(e,t,s)}match(e,t){return h(this,Ce).search(e,t)}},Ce=new WeakMap,Vt),_e=class extends Xs{constructor(e={}){super(e),this.router=e.router??new ra({routers:[new ia,new la]})}},ca=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(i=>typeof i=="string"?i==="*"?()=>i:r=>i===r?r:null:typeof i=="function"?i:r=>i.includes(r)?r:null)(s.origin),n=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(r,l){var d;function o(p,u){r.res.headers.set(p,u)}const c=await a(r.req.header("origin")||"",r);if(c&&o("Access-Control-Allow-Origin",c),s.credentials&&o("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await n(r.req.header("origin")||"",r);p.length&&o("Access-Control-Allow-Methods",p.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const m=r.req.header("Access-Control-Request-Headers");m&&(u=m.split(/\s*,\s*/))}return u!=null&&u.length&&(o("Access-Control-Allow-Headers",u.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}};function Me(e,t){return e.length<t?0:e.slice(-t).reduce((a,n)=>a+n,0)/t}function ht(e,t){if(e.length<t)return 0;const s=2/(t+1);let a=Me(e.slice(0,t),t);for(let n=t;n<e.length;n++)a=(e[n]-a)*s+a;return a}function da(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let a=0,n=0;for(let o=0;o<t;o++)s[o]>0?a+=s[o]:n+=Math.abs(s[o]);let i=a/t,r=n/t;for(let o=t;o<s.length;o++){const c=s[o];i=(i*(t-1)+(c>0?c:0))/t,r=(r*(t-1)+(c<0?Math.abs(c):0))/t}return r===0?100:100-100/(1+i/r)}function ua(e){const t=ht(e,12),s=ht(e,26),a=t-s,n=a*.9,i=a-n;return{macd:a,signal:n,histogram:i}}function pa(e,t=20,s=2){const a=Me(e,t),i=e.slice(-t).reduce((l,o)=>l+Math.pow(o-a,2),0)/t,r=Math.sqrt(i);return{upper:a+r*s,middle:a,lower:a-r*s}}function ma(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const r=e[i].high,l=e[i].low,o=e[i-1].close,c=Math.max(r-l,Math.abs(r-o),Math.abs(l-o));s.push(c)}const a=Me(s,t);return Math.max(a,10)}function _a(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const a=e.slice(-t),n=a.map(p=>p.high),i=a.map(p=>p.low),r=e[e.length-1].close,l=Math.max(...n),o=Math.min(...i),c=(r-o)/(l-o)*100;return{k:c,d:c}}function ga(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,a=0,n=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,p=e[c].low,u=e[c-1].high,m=e[c-1].low,g=e[c-1].close,_=d-u,f=m-p;_>f&&_>0&&(s+=_),f>_&&f>0&&(a+=f),n+=Math.max(d-p,Math.abs(d-g),Math.abs(p-g))}const i=n>0?s/n*100:0,r=n>0?a/n*100:0;return{adx:i+r>0?Math.abs(i-r)/(i+r)*100:0,plusDI:i,minusDI:r}}function fa(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),a=Math.max(...s.map(y=>y.high)),n=Math.min(...s.map(y=>y.low)),i=(a+n)/2,r=Math.min(26,e.length),l=e.slice(-r),o=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(o+c)/2,p=(i+d)/2,u=Math.min(52,e.length),m=e.slice(-u),g=Math.max(...m.map(y=>y.high)),_=Math.min(...m.map(y=>y.low)),f=(g+_)/2;return{tenkan:i,kijun:d,senkouA:p,senkouB:f}}function ha(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const a=e[e.length-1],n=e[e.length-2];return a.close>n.close?a.low*.98:a.high*1.02}function ya(e){if(e.length===0)return 0;let t=0,s=0;for(const a of e){const n=(a.high+a.low+a.close)/3,i=a.volume||1;t+=n*i,s+=i}return s>0?t/s:e[e.length-1].close}function ba(e,t=50){const s=e.slice(-Math.min(t,e.length)),a=s.map(o=>o.high),n=s.map(o=>o.low),i=Math.max(...a),r=Math.min(...n),l=i-r;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:r}}function ve(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=ua(t),a=pa(t),n=_a(e,14,3),i=ga(e,14),r=fa(e),l=ha(e),o=ya(e),c=ba(e,50);return{rsi_14:da(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Me(t,20),sma_50:Me(t,50),sma_200:e.length>=200?Me(t,200):Me(t,Math.min(100,e.length)),ema_12:ht(t,12),ema_26:ht(t,26),bb_upper:a.upper,bb_middle:a.middle,bb_lower:a.lower,atr_14:ma(e,14),stochastic_k:n.k,stochastic_d:n.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:r.tenkan,ichimoku_kijun:r.kijun,ichimoku_senkou_a:r.senkouA,ichimoku_senkou_b:r.senkouB,parabolic_sar:l,vwap:o,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function te(e,t,s){const a=[];let n=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(a.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?n+=2:i+=2),t.stochastic_k<20?(a.push("Stochastic oversold (<20)"),n+=2):t.stochastic_k<30?(a.push("Stochastic approaching oversold"),n+=1):t.stochastic_k>80?(a.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(a.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(a.push("Stochastic bullish crossover"),n+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(a.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(a.push("Price above Ichimoku Cloud (bullish)"),n+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(a.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(a.push("Ichimoku bullish (Tenkan > Kijun)"),n+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(a.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(a.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),n+=1):e<t.vwap&&(a.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(a.push("Near 61.8% Fibonacci support"),n+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(a.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(a.push("RSI oversold (<30)"),n+=2):t.rsi_14<40?(a.push("RSI below 40"),n+=1):t.rsi_14>70?(a.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(a.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(a.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(a.push("MACD bullish crossover"),n+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(a.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(a.push("Price above SMA20 and SMA50"),n+=1):e<t.sma_20&&e<t.sma_50&&(a.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(a.push("Uptrend (above SMA200)"),n+=1):(a.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(a.push("Price at lower Bollinger Band"),n+=2):e>=t.bb_upper&&(a.push("Price at upper Bollinger Band"),i+=2);const r=n+i,l=r>0?n/r*100:50;let o="HOLD",c=50;n>i+1?(o="BUY",c=Math.min(l,95)):i>n+1&&(o="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(n-i)>4&&(c=Math.min(c+5,95),a.push("High conviction signal"));const d=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,_=e*(1/100);let f,y,x,b;if(o==="BUY"){const v=e-t.atr_14*d;f=Math.max(v,e-_),y=e+t.atr_14*p,x=e+t.atr_14*u,b=e+t.atr_14*m}else if(o==="SELL"){const v=e+t.atr_14*d;f=Math.min(v,e+_),y=e-t.atr_14*p,x=e-t.atr_14*u,b=e-t.atr_14*m}else f=e,y=e,x=e,b=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(f.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(x.toFixed(2)),take_profit_3:parseFloat(b.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:a.join(", ")}}async function G(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const n=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return n.ok||console.error("[Telegram] Send failed:",JSON.stringify(n)),n.ok===!0}catch(a){return console.error("Failed to send Telegram message:",a),!1}}function va(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function st(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
⏰ ${new Date().toLocaleString()}
  `.trim()}function rs(e,t){if(!e)throw console.error("[determineTrend] indicators is null/undefined!"),new Error("Indicators is undefined");if(e.rsi_14===void 0)throw console.error("[determineTrend] rsi_14 is undefined! Indicators:",Object.keys(e)),new Error("rsi_14 is undefined in indicators");let s=0,a=0,n=0;e.macd>e.macd_signal&&e.macd_histogram>0?s+=3:e.macd<e.macd_signal&&e.macd_histogram<0&&(a+=3),n+=3,t>e.sma_20?s+=2:a+=2,n+=2,t>e.sma_50?s+=2:a+=2,n+=2,t>e.sma_200?s+=3:a+=3,n+=3,e.adx&&e.adx>25&&e.plus_di&&e.minus_di&&(e.plus_di>e.minus_di?s+=2:a+=2,n+=2),e.rsi_14>50?s+=1:a+=1,n+=1;const i=s/n*100,r=a/n*100,l=Math.abs(i-r);let o,c;return i>60?(o="BULLISH",c=i):r>60?(o="BEARISH",c=r):(o="NEUTRAL",c=50),{timeframe:"1h",trend:o,strength:l,confidence:c}}function It(e,t){console.log("[analyzeTimeframeAlignment] START"),console.log("[analyzeTimeframeAlignment] indicators keys:",Object.keys(e||{})),console.log("[analyzeTimeframeAlignment] currentPrice:",t);const s=[],a=["5m","15m","1h","4h","daily"];for(const d of a){console.log(`[analyzeTimeframeAlignment] Processing ${d}`);const p=e[d];if(p){console.log(`[analyzeTimeframeAlignment] ${d} has indicators, calling determineTrend`),console.log(`[analyzeTimeframeAlignment] ${d} rsi_14:`,p.rsi_14,typeof p.rsi_14);const u=rs(p,t);u.timeframe=d,s.push(u)}else console.log(`[analyzeTimeframeAlignment] ${d} missing indicators`)}const n=s.filter(d=>d.trend==="BULLISH").length,i=s.filter(d=>d.trend==="BEARISH").length;s.filter(d=>d.trend==="NEUTRAL").length;const r=s.length,l=Math.max(n,i);let o,c;return n===r?(o="ALL_BULLISH",c=20):i===r?(o="ALL_BEARISH",c=20):n>=r*.8?(o="ALL_BULLISH",c=15):i>=r*.8?(o="ALL_BEARISH",c=15):n>=r*.6||i>=r*.6?(o="MIXED",c=10):(o="CONFLICTING",c=0),{score:l,type:o,confidenceBoost:c,trends:s}}function Lt(e,t){if(e==="HOLD")return{isValid:!1,confidence:50,reason:"HOLD signal - no trade"};const{trends:s,type:a,confidenceBoost:n}=t,i=s.find(p=>p.timeframe==="daily"),r=s.find(p=>p.timeframe==="4h"),l=s.find(p=>p.timeframe==="1h"),o=s.find(p=>p.timeframe==="15m"),c=s.find(p=>p.timeframe==="5m"),d=e==="BUY"&&(c==null?void 0:c.trend)==="BULLISH"&&(o==null?void 0:o.trend)==="BULLISH"&&(l==null?void 0:l.trend)==="BULLISH"&&(c.strength>70||o.strength>70||l.strength>70)||e==="SELL"&&(c==null?void 0:c.trend)==="BEARISH"&&(o==null?void 0:o.trend)==="BEARISH"&&(l==null?void 0:l.trend)==="BEARISH"&&(c.strength>70||o.strength>70||l.strength>70);return e==="BUY"?i&&i.trend==="BEARISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BEARISH - opposing BUY signal"}:r&&r.trend==="BEARISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BEARISH - opposing BUY signal"}:l&&l.trend==="BEARISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BEARISH - weak BUY setup"}:a==="ALL_BULLISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BULLISH - high probability BUY (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BULLISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned BUY - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip BUY (${t.score}/${s.length})`}:e==="SELL"?i&&i.trend==="BULLISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BULLISH - opposing SELL signal"}:r&&r.trend==="BULLISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BULLISH - opposing SELL signal"}:l&&l.trend==="BULLISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BULLISH - weak SELL setup"}:a==="ALL_BEARISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BEARISH - high probability SELL (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BEARISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned SELL - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip SELL (${t.score}/${s.length})`}:{isValid:!1,confidence:50,reason:"Unknown signal type"}}function wa(e){const t=[`Multi-Timeframe Alignment: ${e.type}`];t.push(`Score: ${e.score}/${e.trends.length}`),t.push(`Confidence Boost: +${e.confidenceBoost}%`),t.push(""),t.push("Timeframe Analysis:");for(const s of e.trends){const a=s.trend==="BULLISH"?"📈":s.trend==="BEARISH"?"📉":"➡️";t.push(`  ${a} ${s.timeframe.padEnd(6)}: ${s.trend.padEnd(8)} (${s.confidence.toFixed(0)}% confident, ${s.strength.toFixed(0)}% strength)`)}return t.join(`
`)}const os=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:It,determineTrend:rs,formatAlignmentReport:wa,validateMultiTimeframeSignal:Lt},Symbol.toStringTag,{value:"Module"}));function Ct(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),a=Math.floor((1-t)*s.length);return Math.abs(s[a]||0)}function Ea(e,t){const s=Ct(e,.95),a=Ct(e,.99),n=t*s,i=t*a;return{var_95:parseFloat(n.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function xa(e,t,s,a){const n=t-e,i=n/t*100;let r=0;for(let c=a.length-1;c>=0&&a[c].balance<t;c--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(n.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function Sa(e,t,s=5){let a=0;const n=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=d/t*100;a+=d,n.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=a/t*100,r=i<=s,l=t*(s/100)-a;return{total_open_positions:e.length,total_risk_amount:parseFloat(a.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:n}}function ka(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),a=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&a.push({index:o,value:s[o]});if(a.length<3)return null;const n=a.slice(-3),[i,r,l]=n;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(r.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function Ta(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),a=s.slice(0,10),n=s.slice(10);if((a[a.length-1]-a[0])/a[0]>.02&&(Math.max(...n)-Math.min(...n))/n[0]<.015){const o=s[s.length-1],c=a[a.length-1]-a[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function Ra(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),a=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=a.slice(0,6),l=a.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,p=c+(c-Math.min(...a));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function La(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),a=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&a.push({index:o,value:s[o]});if(a.length<2)return null;const n=a.slice(-2),[i,r]=n;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,c=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function Da(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),a=s[0],n=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(a-i)/a<.02&&n<a*.95){const l=s.slice(25),o=Math.min(...l),c=(i-o)/i;if(c>.01&&c<.05){const d=a-n,p=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function Ia(e){const t=[],s=ka(e);s&&t.push(s);const a=Ta(e);a&&t.push(a);const n=Ra(e);n&&t.push(n);const i=La(e);i&&t.push(i);const r=Da(e);r&&t.push(r);let l=0,o=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(o++,c+=m.confidence);let d="neutral",p=0;l>o?(d="bullish",p=Math.min(c/l/10,15)):o>l&&(d="bearish",p=Math.min(c/o/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const m=t.map(g=>g.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(p.toFixed(1)),summary:u}}function Fa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Ma(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const n=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=n*10}const a=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(a*10,30),Math.min(Math.round(s),100)}function Aa(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const a=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(a>.9||a<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function $a(e,t,s){const a=Fa(t.atr_14,s),n=Ma(t,s),i=Aa(t,s);let r,l,o,c,d,p;const u=e.slice(-10),m=u.map(y=>y.volume||0),g=m.reduce((y,x)=>y+x,0)/m.length,f=(u[u.length-1].volume||0)>g*1.5;return a==="EXTREME"&&f?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,c="Wait for direction",d=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&n>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&n>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,p="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,p="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:a,trend_strength:n,mean_reversion_score:i,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:p}}function Na(e){const t=e.length;let s=0,a=0,n=0,i=0;for(let o=0;o<t;o++)s+=o,a+=e[o],n+=o*e[o],i+=o*o;const r=(t*n-s*a)/(t*i-s*s),l=(a-r*s)/t;return{slope:r,intercept:l}}function Oa(e,t,s){const a=e.map(l=>l.close),n=2/(t+1);let i=a[0];for(let l=1;l<a.length;l++)i=(a[l]-i)*n+i;const r=(a[a.length-1]-a[a.length-10])/10;return i+r*s}function Ca(e,t){const s=e.map(l=>l.close).slice(-20),a=[];for(let l=1;l<s.length;l++)a.push(s[l]-s[l-1]);const r=a.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function Pa(e,t,s){const a=e[e.length-1].close;e.map(r=>r.close).slice(-20);let n=0;t.rsi_14>50?n+=t.rsi_14-50:n-=50-t.rsi_14,t.macd>t.macd_signal?n+=20:n-=20,a>t.sma_20&&(n+=10),a>t.sma_50&&(n+=10);const i=n/100*s;return a+t.atr_14*i}function Ha(e,t){const s=e.map(u=>u.close),a=s[s.length-1],n=10,i=s.slice(-n),r=Math.min(...i),l=Math.max(...i),o=i.map(u=>(u-r)/(l-r));let c={index:0,similarity:-1/0};for(let u=n;u<s.length-n-t;u++){const m=s.slice(u-n,u),g=Math.min(...m),_=Math.max(...m),f=m.map(b=>(b-g)/(_-g));let y=0;for(let b=0;b<n;b++)y+=Math.pow(o[b]-f[b],2);const x=-y;x>c.similarity&&(c={index:u,similarity:x})}const p=(s[c.index+t]-s[c.index])*(a/s[c.index]);return a+p}function kt(e,t,s){const a=[],n=[],i=e.map(E=>E.close),{slope:r,intercept:l}=Na(i.slice(-20)),o=r*(i.length-1+s)+l;a.push(o),n.push(1);const c=Oa(e,12,s);a.push(c),n.push(1.5);const d=Ca(e,s);a.push(d),n.push(1.2);const p=Pa(e,t,s);a.push(p),n.push(1.8);const u=Ha(e,s);a.push(u),n.push(1.3);const m=n.reduce((E,C)=>E+C,0),_=a.reduce((E,C,j)=>E+C*n[j],0)/m,f=a.reduce((E,C)=>E+C,0)/a.length,y=a.reduce((E,C)=>E+Math.pow(C-f,2),0)/a.length,x=Math.sqrt(y),b=e[e.length-1].close,v=1-x/b,B=Math.max(50,Math.min(95,v*100));return{prediction:_,confidence:B}}function ja(e,t){const s=e[e.length-1].close,a=[],n=kt(e,t,1),i=n.prediction-s,r=i/s*100;a.push({timeframe:"1h",predicted_price:parseFloat(n.prediction.toFixed(2)),confidence_interval_upper:parseFloat((n.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((n.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(n.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=kt(e,t,4),o=l.prediction-s,c=o/s*100;a.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=kt(e,t,24),p=d.prediction-s,u=p/s*100;a.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const m=a.filter(x=>x.direction==="UP").length,g=a.filter(x=>x.direction==="DOWN").length;let _,f=0;m>g?(_="BULLISH",f=Math.min(m*5,15)):g>m?(_="BEARISH",f=Math.min(g*5,15)):_="NEUTRAL";const y=`ML models predict ${_} movement. 1h: ${a[0].direction} (${a[0].expected_move_pct.toFixed(2)}%), 4h: ${a[1].direction} (${a[1].expected_move_pct.toFixed(2)}%), 24h: ${a[2].direction} (${a[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:a,overall_direction:_,confidence_boost:parseFloat(f.toFixed(1)),summary:y}}function Tt(e,t,s,a,n){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(a-50)/10;l+=o;const c=(n-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function Ua(e,t,s,a,n){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,n==="BUY"){const o=(a-50)/10;l-=o}else{const o=(a-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function Ba(e,t,s,a,n,i){const r=(s-e)*.5,l=(a-e)*.3,o=(n-e)*.2,c=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*c}function Wa(e,t,s){const a=e.price,n=t.atr_14;let i=50;e.signal_type==="BUY"?(a>t.sma_20&&(i+=10),a>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(a<t.sma_20&&(i+=10),a<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let b=14;b<r.length;b++){const v=r.slice(b-14,b);let B=0;for(let E=1;E<v.length;E++){const C=Math.max(v[E].high-v[E].low,Math.abs(v[E].high-v[E-1].close),Math.abs(v[E].low-v[E-1].close));B+=C}l.push(B/14)}const o=l.reduce((b,v)=>b+v,0)/l.length,c=n/o,d=Tt(a,e.take_profit_1,n,i,c),p=Tt(a,e.take_profit_2,n,i,c),u=Tt(a,e.take_profit_3,n,i,c),m=Ua(a,e.stop_loss,n,i,e.signal_type),g=Ba(a,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:p,tp3:u,sl:m}),f=(d+p+u)/3/m;let y;d>70&&g>5&&f>2?y="STRONG_TRADE":d>60&&g>0&&f>1.5?y="GOOD_TRADE":d>50&&g>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const x=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${f.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(f.toFixed(2)),recommendation:y,summary:x}}function ls(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=Va(e),s=Ya(),a=za(e,s.session),n=qa(t,s.session),i=Ga(t,s),r=Ka(t,s,a,i),l=Xa(r,t,s,a),o=Za(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:a.spread_pips,price_impact_bps:Math.round(n),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function Va(e){const t=e.slice(-10),s=e.slice(-20,-10),a=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,n=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,r=n/a;let l;n>i*1.2?l="INCREASING":n<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:a,current_volume:n,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function Ya(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),a=t*60+s;let n,i;return a>=780&&a<960?(n="OVERLAP",i="HIGH"):a>=480&&a<780?(n="LONDON",i="HIGH"):a>=960&&a<1320?(n="NEW_YORK",i="HIGH"):a>=0&&a<480?(n="ASIA",i="MEDIUM"):(n="OFF_HOURS",i="LOW"),{zone:i,session:n}}function za(e,t){const s=e.slice(-20);let a=0;for(const d of s){const p=d.high-d.low;a+=p}const n=a/s.length,i=s[s.length-1].close,r=n/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,c=l*o;return{spread_pips:Math.round(c)}}function qa(e,t){let s=10;const n={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*n*i}function Ga(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function Ka(e,t,s,a){const n=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=a*.2;return n+i+r+l}function Xa(e,t,s,a){const n=[];return e<50&&n.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&n.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&n.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),a.spread_pips>50&&n.push(`⚠️ WIDE SPREADS: Estimated ${a.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&n.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),n}function Za(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Ft=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Qa(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function vt(e=30){const t=[],s=new Date;for(const n of Ft){const i=new Date(n),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:n,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:n,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let n=0;n<=e;n++){const i=new Date(s.getTime()+n*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),c=i.getDay();if(o===Qa(r,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((n,i,r)=>i===r.findIndex(l=>l.date===n.date&&l.time===n.time&&l.title===n.title)).sort((n,i)=>{const r=new Date(`${n.date}T${n.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function ct(e=new Date,t=[]){const s=[...vt(7),...t],a=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),n=e.toISOString().split("T")[0];if(s.filter(r=>r.date===n&&r.impact==="high"),Ft.includes(n))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:a,nextSafeTime:Ja(n)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:a,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:a}}function Ja(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function gt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let a="🔴";return e.impact==="medium"&&(a="🟡"),e.impact==="low"&&(a="🟢"),`${a} ${e.date} ${s} UTC - ${e.title}`}function en(e){const t=e.toISOString().split("T")[0];return Ft.includes(t)?!0:vt(30).filter(n=>n.date===t&&n.impact==="high").length>=2}function tn(){const e=new Date().toISOString().split("T")[0];return vt(7).filter(s=>s.date===e)}function cs(e=new Date){const t=ct(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const ds=new _e;ds.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const a={},n={};for(const U of["5m","15m","1h","4h","daily"]){const O=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(U).first();O&&(a[U]=O);const Y=await t.prepare(`
        SELECT timestamp, open, high, low, close, volume 
        FROM market_data 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(U).all();Y.results&&Y.results.length>0&&(n[U]=Y.results.map(w=>({timestamp:w.timestamp,open:w.open,high:w.high,low:w.low,close:w.close,volume:w.volume||0})))}if(Object.keys(a).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(a).length}. Please fetch multi-timeframe data first.`},400);const i=[];if(a["1h"]&&a["1h"].timestamp){const U=new Date(a["1h"].timestamp).getTime(),Y=(Date.now()-U)/(1e3*60);Y>60?i.push(`⚠️ WARNING: 1h data is ${Y.toFixed(0)} minutes old (>60 min)`):Y>30&&i.push(`⚠️ CAUTION: 1h data is ${Y.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${Y.toFixed(1)} minutes old`)}const r=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const U=new Date(r.timestamp).getTime(),O=(Date.now()-U)/(1e3*60);O>60&&i.push(`⚠️ WARNING: Price data is ${O.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${O.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ct(),c=cs();let d=null,p=!1;o.riskLevel==="danger"?(p=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const u=a["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(a).join(", ")}`},400);const m=It(a,l),g=te(l,u,"day_trade"),_=te(l,u,"swing_trade"),f=Lt(g.signal_type,m),y=Lt(_.signal_type,m),x={...g,base_confidence:g.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:m.score,alignment_type:m.type},b={..._,base_confidence:_.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type};let v=0,B="",E=[];if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20){try{const O=Ia(n["1h"]);E=(O==null?void 0:O.patterns)||[]}catch(O){console.error("[ENHANCED] Pattern detection error:",O.message)}const U=E.filter(O=>O.confidence>=70&&O.endIndex>=n["1h"].length-5);for(const O of U)O.type==="bullish"&&x.signal_type==="BUY"?(v+=O.confidence*.1,B+=`${O.name} (${O.confidence.toFixed(0)}%), `):O.type==="bearish"&&x.signal_type==="SELL"&&(v+=O.confidence*.1,B+=`${O.name} (${O.confidence.toFixed(0)}%), `);v=Math.min(15,v)}let C=0,j="",T=null;if(n["1h"]&&n["1h"].length>=50){const U=ve(n["1h"]);U&&(T=$a(n["1h"],U),T.trend==="STRONG_UPTREND"&&x.signal_type==="BUY"?(C=10,j="Strong Uptrend"):T.trend==="UPTREND"&&x.signal_type==="BUY"?(C=5,j="Uptrend"):T.trend==="STRONG_DOWNTREND"&&x.signal_type==="SELL"?(C=10,j="Strong Downtrend"):T.trend==="DOWNTREND"&&x.signal_type==="SELL"&&(C=5,j="Downtrend"))}let S=0,R="",I=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{I=ja(n["1h"],l),I.overall_direction==="BULLISH"&&x.signal_type==="BUY"?(S=I.confidence_boost,R=`ML predicts +${((I.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):I.overall_direction==="BEARISH"&&x.signal_type==="SELL"&&(S=I.confidence_boost,R=`ML predicts ${((I.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(U){console.error("[ENHANCED] ML prediction error:",U.message)}let k=0,re="",q=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{const U=ve(n["1h"]);U&&(q=Wa(x,U,n["1h"]),q.tp1_probability>70?(k=10,re=`PoP: TP1 ${q.tp1_probability.toFixed(0)}%`):q.tp1_probability>60&&(k=5,re=`PoP: TP1 ${q.tp1_probability.toFixed(0)}%`))}catch(U){console.error("[ENHANCED] Probability of Profit error:",U.message)}let F=null,K=0,L=0;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20)try{F=ls(n["1h"]),F.liquidity_score>=80?K=5:F.liquidity_score>=70?K=0:F.liquidity_score>=50?L=-5:L=-10,console.log(`[LIQUIDITY] Score: ${F.liquidity_score}/100, Session: ${F.session}, Adjust: ${K+L}%`)}catch(U){console.error("[ENHANCED] Liquidity Analysis error:",U.message)}let D=0,V=0,ne=0,le=0,ce="";try{const U=await t.prepare(`
      ...
      `).all(),Y=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(U&&O.results&&O.results.length>=10){const w=Ea(O.results,U.balance);D=w.var_95,V=w.var_99;const ie=xa(U.balance,O.results);if(ne=ie.current_drawdown_pct,ie.is_within_limit||(ce+=`⚠️ Drawdown ${ne.toFixed(1)}% exceeds limit. `),Y.results){const P=Sa(Y.results,U.balance);le=P.total_risk_pct,P.is_within_limit||(ce+=`⚠️ Portfolio heat ${le.toFixed(1)}% exceeds limit. `)}}}catch(U){console.error("[ENHANCED] Risk metrics error (optional):",U.message)}const Ee=v+C+S+k+K+L,N={...x,pattern_boost:v,regime_boost:C,ml_boost:S,pop_boost:k,total_boost:Ee,enhanced_confidence:Math.min(98,x.final_confidence+Ee),var_95:D,var_99:V,current_drawdown_pct:ne,portfolio_heat_pct:le,risk_warning:ce||null},$={...b,pattern_boost:v,regime_boost:C,ml_boost:S,pop_boost:k,total_boost:Ee,enhanced_confidence:Math.min(98,b.final_confidence+Ee),var_95:D,var_99:V,current_drawdown_pct:ne,portfolio_heat_pct:le,risk_warning:ce||null};p?(N.signal_type="HOLD",$.signal_type="HOLD",N.enhanced_confidence=50,$.enhanced_confidence=50,N.reasoning=d||"Economic event nearby - trading paused",$.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(N.enhanced_confidence=Math.max(50,N.enhanced_confidence+c.adjustment),$.enhanced_confidence=Math.max(50,$.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),N.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(U=>gt(U))},$.calendar_check=N.calendar_check;let ge=!1;try{const U=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),O={};for(const Y of U.results||[])O[Y.setting_key]=Y.setting_value;if(O.telegram_bot_token&&O.telegram_chat_id){const Y=new Date().toLocaleString("en-US",{timeZone:"UTC"});let w=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${Y} UTC
...
`,w+=`Next event: ${gt(o.upcomingEvents[0])}
...
`;for(const J of m.trends){const X=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";w+=`${X} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}if(w+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,w+=`📈 *DAY TRADE SIGNAL*
`,w+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`),K!==0||L!==0){const J=K+L;w+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}w+=`*FINAL: ${N.enhanced_confidence.toFixed(0)}%*

`,T&&(w+=`🌡️ *Market Regime:* ${T.trend||"N/A"}
`,w+=`Volatility: ${T.volatility}
`,w+=`Should Trade: ${T.should_trade?"✅ YES":"❌ NO"}
...
`),w+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",w.length,"characters");const ie=await G({botToken:O.telegram_bot_token,chatId:O.telegram_chat_id},w);let P=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if(F){const J=F.liquidity_score>=80?"🟢":F.liquidity_score>=70?"🟡":F.liquidity_score>=50?"🟠":"🔴";if(P+=`🌊 *LIQUIDITY ANALYSIS*
`,P+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,P+=`${J} *Score:* ${F.liquidity_score}/100
`,P+=`🕐 *Session:* ${F.session}
`,P+=`📊 *Time Zone:* ${F.time_of_day_zone} LIQUIDITY
`,P+=`📈 *Volume:* ${F.volume_trend} (${F.volume_percentile}%)
`,P+=`💰 *Spread:* ~${F.estimated_spread_pips} pips
`,P+=`📉 *Price Impact:* ~${F.price_impact_bps} bps per $100k
`,P+=`🎯 *Market Depth:* ${F.market_depth_score}/100
`,P+=`✅ *Optimal:* ${F.optimal_for_trading?"YES":"NO"}

`,F.warnings.length>0){P+=`⚠️ *Liquidity Warnings:*
`;for(const X of F.warnings)P+=`• ${X}
`;P+=`
`}P+=`💡 *Recommendation:*
${F.recommendation}
...
`,P+=`• VaR(95%): $${D.toFixed(2)}
`,P+=`• VaR(99%): $${V.toFixed(2)}
`,P+=`• Max Drawdown: ${ne.toFixed(2)}%
`,P+=`• Portfolio Heat: ${le.toFixed(1)}%

`,o.upcomingEvents.length>0){P+=`📅 *Upcoming Events:*
`;for(const J of o.upcomingEvents.slice(0,3))P+=`• ${gt(J)}
`;P+=`
`}P+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,P+=`✅ Signal generated at ${Y} UTC
`,P+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",P.length,"characters");const Qe=await G({botToken:O.telegram_bot_token,chatId:O.telegram_chat_id},P);ge=ie&&Qe}}catch(U){console.error("[ENHANCED] Telegram error (optional):",U.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:ge,day_trade:N,swing_trade:$,alignment:{type:m.type,score:m.score,trends:m.trends},patterns:E.length>0?E.slice(0,3):null,regime:T?{trend:T.trend,volatility:T.volatility,should_trade:T.should_trade}:null,ml_prediction:I?{direction:I.overall_direction,predictions:I.predictions}:null,profit_probability:q?{tp1:q.tp1_probability,tp2:q.tp2_probability,tp3:q.tp3_probability,expected_value:q.expected_value}:null,liquidity:F?{score:F.liquidity_score,session:F.session,time_zone:F.time_of_day_zone,volume_trend:F.volume_trend,volume_percentile:F.volume_percentile,estimated_spread_pips:F.estimated_spread_pips,price_impact_bps:F.price_impact_bps,market_depth_score:F.market_depth_score,optimal_for_trading:F.optimal_for_trading,warnings:F.warnings,recommendation:F.recommendation}:null,risk_metrics:{var_95:D,var_99:V,drawdown_pct:ne,portfolio_heat_pct:le}})}catch(a){return console.error("[ENHANCED] Error:",a.message,a.stack),e.json({success:!1,error:a.message,stack:a.stack},500)}});const us=new _e;us.post("/simple",async e=>{var s,a,n,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,b+=`⏰ ${x}`,console.log("[SIMPLE] Sending Telegram message, length:",b.length),g=await G({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},b),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(_){console.error("[SIMPLE] Telegram error:",_.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:g,day_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"day_trade"},swing_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(c),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"swing_trade"}})}catch(r){return console.error("[SIMPLE] Error:",r.message,r.stack),e.json({success:!1,error:r.message,stack:r.stack},500)}});const wt=new _e;wt.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const a=s.toISOString();console.log("[5M-SCANNER] Starting scan at",a),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).all(),r=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:a.results,session_stats:n.results,best_hours:i.results,recent_a_grade:r.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});wt.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});async function sn(e,t,s,a,n,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],c=(N,$)=>{const ge=parseFloat(String(N));return isNaN(ge)?$:ge};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,i),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},p={ema50:c(s.ema_26,i)},u={sma200:c(a.sma_200,i)},m=i>d.ema20&&i>p.ema50&&i>u.sma200,g=i<d.ema20&&i<p.ema50&&i<u.sma200;m||g?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const _=d.rsi>=40&&d.rsi<=60,f=d.macd>d.macd_signal&&d.macd_histogram>0,y=d.macd<d.macd_signal&&d.macd_histogram<0;_&&(m?f:y)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${_?"no crossover":"extreme"}`);const x=n.slice(-20).reduce((N,$)=>N+$.volume,0)/20,b=n[n.length-1].volume;b>x*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(b/x).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(b/x).toFixed(1)}x (need 1.5x+)`);const B=Math.max(...n.slice(-20).map(N=>N.high)),E=Math.min(...n.slice(-20).map(N=>N.low)),C=i>B*.999,j=i<E*1.001;m&&C||g&&j?(r+=15,l++,o.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let T=null;try{T=await ls(n),console.log("[ANALYZE] Liquidity calculated successfully")}catch(N){console.log("[5M-SCANNER] Liquidity calc failed:",N)}const S=(T==null?void 0:T.liquidity_score)||50,R=(T==null?void 0:T.session)||"UNKNOWN";S>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${S}/100 (${R} session)`)):o.push(`❌ Layer 5: Liquidity ${S}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const k=ct();console.log("[ANALYZE] Calendar check complete"),k.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${k.reason}`);const q=d.adx>25,F=d.adx>70;q&&!F?(r+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):F?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let K="C";r>=90?K="A+":r>=80?K="A":r>=70&&(K="B");let L="HOLD";(m||g)&&l>=5&&(L=m?"BUY":"SELL");const D=c(t.atr_14,i*.01),V=Math.max(D*1.5,i*.003),ne=L==="BUY"?i-V:i+V,le=L==="BUY"?i+V*2:i-V*2,ce=L==="BUY"?i+V*3:i-V*3,Ee=L==="BUY"?i+V*4:i-V*4;return{grade:K,score:r,signal:L,confidence:r,layersPassed:l,layers:o,stopLoss:ne,tp1:le,tp2:ce,tp3:Ee,liquidityScore:S,session:R,adx:d.adx,rsi:d.rsi,volumeRatio:b/x}}function an(e,t){const s=e.signal==="BUY"?"🟢":"🔴",a=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",n=new Date,i=`${n.getUTCHours().toString().padStart(2,"0")}:${n.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,r+="Next scan in 5 minutes...",r}async function Xe(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,r,l,o,e).run();const d=(await Xe(a)).current_balance+r;return await a.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await gs(a),await rn(a),await on(a),{success:!0,profit_loss:r}}catch(n){return{success:!1,error:n.message}}}async function gs(e){const t=await Xe(e),s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const a=s.results,n=a.length,i=a.filter(m=>m.win===1).length,r=a.filter(m=>m.win===0).length,l=i/n*100,o=a.reduce((m,g)=>m+(g.profit_loss||0),0),c=Math.max(...a.map(m=>m.profit_loss||0)),d=Math.min(...a.map(m=>m.profit_loss||0)),p=a.reduce((m,g)=>m+(g.confidence||0),0)/n,u=a.reduce((m,g)=>m+(g.mtf_score||0),0)/n;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,n,i,r,l,o,c,d,p,u).run()}async function on(e){const t=await Xe(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,a=new Date().toISOString().split("T")[0],n=await e.prepare(`
  ...
  `).bind(s,i).run();let r=!1,l="";s>=t.max_drawdown_pct?(r=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(r=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),r&&t.trading_enabled===1&&await e.prepare(`
      ...
      SET trading_enabled = 0,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(l).run()}async function fs(e){return await e.prepare("SELECT * FROM trade_stats").first()||{total_trades:0,winning_trades:0,losing_trades:0,win_rate:0,total_profit_loss:0,avg_win:0,avg_loss:0,largest_win:0,largest_loss:0,avg_confidence:0,avg_mtf_score:0}}async function hs(e){return(await e.prepare("SELECT * FROM open_positions").all()).results||[]}const me=new _e;me.get("/limits",async e=>{try{const{DB:t}=e.env,s=await Xe(t);return e.json({success:!0,limits:s})}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/validate",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await ps({entry_price:s.entry_price,stop_loss:s.stop_loss,take_profit_1:s.take_profit_1,confidence:s.confidence,trade_type:s.trade_type},t);return e.json({success:!0,validation:a})}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/open",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a={signal_id:s.signal_id,trade_type:s.trade_type,trading_style:s.trading_style||"day_trade",entry_price:s.entry_price,entry_time:s.entry_time||new Date().toISOString(),position_size:s.position_size||0,position_value:0,stop_loss:s.stop_loss,take_profit_1:s.take_profit_1,take_profit_2:s.take_profit_2,take_profit_3:s.take_profit_3,confidence:s.confidence,mtf_score:s.mtf_score,regime:s.regime,status:"OPEN",notes:s.notes},n=await ms(a,t);return n.success?e.json({success:!0,message:"Trade logged successfully",trade_id:n.trade_id}):e.json({success:!1,error:n.error},400)}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/close/:id",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.param("id")),a=await e.req.json(),n=await _s(s,a.exit_price,a.exit_reason||"MANUAL",t);return n.success?e.json({success:!0,message:"Trade closed successfully",profit_loss:n.profit_loss}):e.json({success:!1,error:n.error},400)}catch(t){return e.json({success:!1,error:t.message},500)}});me.get("/open",async e=>{try{const{DB:t}=e.env,s=await hs(t);return e.json({success:!0,count:s.length,positions:s})}catch(t){return e.json({success:!1,error:t.message},500)}});me.get("/history",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"50"),a=await t.prepare(`
      SELECT * FROM live_trades 
      WHERE status = 'CLOSED'
      ORDER BY exit_time DESC
      LIMIT ?
    `).bind(s).all();return e.json({success:!0,count:a.results.length,trades:a.results})}catch(t){return e.json({success:!1,error:t.message},500)}});me.get("/stats",async e=>{try{const{DB:t}=e.env,s=await fs(t),a=await Xe(t);return e.json({success:!0,stats:s,account:{starting_balance:a.starting_balance,current_balance:a.current_balance,total_return:a.current_balance-a.starting_balance,total_return_pct:(a.current_balance-a.starting_balance)/a.starting_balance*100}})}catch(t){return e.json({success:!1,error:t.message},500)}});me.get("/daily",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("days")||"30"),a=await t.prepare(`
      SELECT * FROM daily_performance
      ORDER BY trade_date DESC
      LIMIT ?
    `).bind(s).all();return e.json({success:!0,count:a.results.length,daily_performance:a.results})}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/limits/update",async e=>{try{const{DB:t}=e.env,s=await e.req.json();return await t.prepare(`
      UPDATE risk_limits
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const De=new _e;De.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=vt(t);return e.json({success:!0,count:s.length,events:s.map(a=>({...a,formatted:gt(a)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/today",async e=>{try{const t=tn(),s=ct();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/check",async e=>{try{const t=ct(),s=cs();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});De.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let a=0;a<30;a++){const n=new Date(t.getTime()+a*24*60*60*1e3);en(n)&&s.push(n.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});De.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const dt=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:cn,calculatePositionSize:ys,calculateProfitLoss:bs,checkDailyLossLimit:ln,formatPositionSize:dn},Symbol.toStringTag,{value:"Module"}));async function vs(e,t,s){const a=Date.now(),n=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(D=>{const V=new Date(D.timestamp);return V>=new Date(t.start_date)&&V<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:r,max_daily_loss_pct:2};for(let D=200;D<o.length;D++){const V=o.slice(D-200,D),ne=ve(V);if(!ne)continue;const le=o[D],ce=le.close,Ee=te(ce,ne,"day_trade"),N=te(ce,ne,"swing_trade");for(const $ of[Ee,N]){if($.signal_type==="HOLD"||$.confidence<t.min_confidence)continue;c.current_balance=r;const ge=ys(c,{entry_price:$.price,stop_loss:$.stop_loss,take_profit_1:$.take_profit_1,take_profit_2:$.take_profit_2,take_profit_3:$.take_profit_3,confidence:$.confidence,signal_type:$.signal_type,trading_style:$.trading_style},s);if(!ge.is_valid)continue;const U=le.timestamp,O=$.price;let Y=null,w=null,ie="UNKNOWN";const P=Math.min(50,o.length-D-1);for(let J=1;J<=P;J++){const X=o[D+J];if($.signal_type==="BUY"){if(X.low<=$.stop_loss){Y=$.stop_loss,w=X.timestamp,ie="STOP_LOSS";break}if(X.high>=$.take_profit_3){Y=$.take_profit_3,w=X.timestamp,ie="TP3";break}if(X.high>=$.take_profit_2){Y=$.take_profit_2,w=X.timestamp,ie="TP2";break}if(X.high>=$.take_profit_1){Y=$.take_profit_1,w=X.timestamp,ie="TP1";break}}else{if(X.high>=$.stop_loss){Y=$.stop_loss,w=X.timestamp,ie="STOP_LOSS";break}if(X.low<=$.take_profit_3){Y=$.take_profit_3,w=X.timestamp,ie="TP3";break}if(X.low<=$.take_profit_2){Y=$.take_profit_2,w=X.timestamp,ie="TP2";break}if(X.low<=$.take_profit_1){Y=$.take_profit_1,w=X.timestamp,ie="TP1";break}}}if(!Y||!w)continue;const Qe=bs(O,Y,ge.units,$.signal_type,t.commission_per_trade);r+=Qe.profit_loss,r>l&&(l=r),n.push({entry_time:U,entry_price:O,exit_time:w,exit_price:Y,signal_type:$.signal_type,trading_style:$.trading_style,position_size:ge.units,profit_loss:Qe.profit_loss,profit_loss_pct:Qe.profit_loss_pct,exit_reason:ie,confidence:$.confidence}),i.push({date:w,balance:r})}}const d=n.filter(D=>D.profit_loss>0),p=n.filter(D=>D.profit_loss<0),u=d.reduce((D,V)=>D+V.profit_loss,0),m=Math.abs(p.reduce((D,V)=>D+V.profit_loss,0)),g=r-t.starting_balance,_=n.length>0?d.length/n.length*100:0,f=d.length>0?u/d.length:0,y=p.length>0?m/p.length:0,x=d.length>0?Math.max(...d.map(D=>D.profit_loss)):0,b=p.length>0?Math.min(...p.map(D=>D.profit_loss)):0,v=m>0?u/m:u,B=100-_,E=_/100*f-B/100*y;let C=0,j=0,T=t.starting_balance;for(const D of i){D.balance>T&&(T=D.balance);const V=T-D.balance,ne=V/T*100;V>C&&(C=V,j=ne)}const S=n.map(D=>D.profit_loss_pct),R=S.reduce((D,V)=>D+V,0)/S.length,I=Math.sqrt(S.reduce((D,V)=>D+Math.pow(V-R,2),0)/S.length),k=I>0?R/I:0;let re=0,q=0,F=0,K=0;for(const D of n)D.profit_loss>0?(F++,K=0,re=Math.max(re,F)):(K++,F=0,q=Math.max(q,K));const L=Date.now()-a;return{config:t,total_trades:n.length,winning_trades:d.length,losing_trades:p.length,win_rate:parseFloat(_.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(f.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(x.toFixed(2)),largest_loss:parseFloat(b.toFixed(2)),max_drawdown:parseFloat(C.toFixed(2)),max_drawdown_pct:parseFloat(j.toFixed(2)),profit_factor:parseFloat(v.toFixed(2)),sharpe_ratio:parseFloat(k.toFixed(2)),expectancy:parseFloat(E.toFixed(2)),max_consecutive_wins:re,max_consecutive_losses:q,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:n,equity_curve:i,execution_time_ms:L}}function ws(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const un=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:ws,runBacktest:vs},Symbol.toStringTag,{value:"Module"})),Ze=new _e;Ze.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp ASC
    `).all();if(a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Have ${a.results.length} candles, need at least 200. System has been collecting data since Dec 26 - wait a few more days or reduce timeframe.`},400);const n=a.results.map(d=>({timestamp:d.timestamp,open:d.open,high:d.high,low:d.low,close:d.close,volume:d.volume||0})),i={start_date:s.start_date||new Date(Date.now()-365*24*60*60*1e3).toISOString(),end_date:s.end_date||new Date().toISOString(),starting_balance:s.starting_balance||1e4,min_confidence:s.min_confidence||75,use_mtf_confirmation:s.use_mtf_confirmation!==!1,use_news_filter:s.use_news_filter!==!1,timeframe:s.timeframe||"1h",commission_per_trade:s.commission_per_trade||0},l=await vs(n,i,[{confidence_min:90,confidence_max:100,risk_pct:2,max_position_pct:10},{confidence_min:80,confidence_max:89,risk_pct:1.5,max_position_pct:7.5},{confidence_min:75,confidence_max:79,risk_pct:1,max_position_pct:5},{confidence_min:70,confidence_max:74,risk_pct:.5,max_position_pct:2.5}]),o=await t.prepare(`
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const xs=new _e;xs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let a="";for(const S of s.results||[])S.setting_key==="twelve_data_api_key"&&(a=S.setting_value);let n=[];if(a&&a!=="your_api_key_here")try{const S=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,I=await(await fetch(S)).json();I.values&&I.values.length>=50&&(n=I.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open),high:parseFloat(k.high),low:parseFloat(k.low),close:parseFloat(k.close),volume:parseFloat(k.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",n.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(n.length===0){const S=await t.prepare(`
      ...
      `).all();if(!S.results||S.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);n=S.results.reverse().map(R=>({timestamp:R.timestamp,open:R.open,high:R.high,low:R.low,close:R.close,volume:R.volume||0}))}const i=ve(n);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=n[n.length-1].close,l=te(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const S of["5m","15m","1h","4h","daily"]){const R=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(S).first();R&&(o[S]=R)}const c=It(o,r),d=n.slice(-50),p=d.map(S=>S.high).sort((S,R)=>R-S),u=d.map(S=>S.low).sort((S,R)=>S-R),m=[Math.max(...p.slice(0,10))],g=[Math.min(...u.slice(0,10))];r>i.sma_20?g.push(i.sma_20):m.push(i.sma_20),r>i.sma_50?g.push(i.sma_50):m.push(i.sma_50),r>i.vwap?g.push(i.vwap):m.push(i.vwap);const _=Math.round(r/10)*10;_>r?m.push(_):g.push(_);const f=[...new Set(m)].sort((S,R)=>S-R).filter(S=>S>r).slice(0,3),y=[...new Set(g)].sort((S,R)=>R-S).filter(S=>S<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",f);const x=i.atr_14/r*100;let b="NORMAL";x>3?b="EXTREME":x>1.5?b="HIGH":x<.5&&(b="LOW");const v=[];let B=30,E=30,C=40;c.type==="ALL_BULLISH"?(B=60,E=20,C=20):c.type==="ALL_BEARISH"?(B=20,E=60,C=20):c.score>=4&&(c.trends.filter(S=>S.trend==="BULLISH").length>=4?(B=50,E=25,C=25):(B=25,E=50,C=25)),f.length>0&&v.push({name:"📈 BULLISH CONTINUATION",probability:B,description:`Price breaks above $${f[0].toFixed(2)} and rallies toward $${(f[f.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${f[0].toFixed(2)} with volume`,target:f[f.length-1]||r*1.02}),y.length>0&&v.push({name:"📉 BEARISH CORRECTION",probability:E,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||r*.98}),v.push({name:"↔️ CONTINUED RANGING",probability:C,description:`Price oscillates between $${(y[0]||r*.99).toFixed(2)} and $${(f[0]||r*1.01).toFixed(2)} with choppy action`,trigger:b==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),v.sort((S,R)=>R.probability-S.probability);let j={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?j={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(j={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):b==="EXTREME"?j.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(j.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${f[0]?`breakout above $${f[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let T=!1;try{const S=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),R={};for(const I of S.results||[])R[I.setting_key]=I.setting_value;if(R.telegram_bot_token&&R.telegram_chat_id){let I=`🤖 *AI MARKET ANALYSIS*
...
`,I+=`🔴 *Resistance:* ${f.map(k=>`$${k.toFixed(2)}`).join(", ")}
`,I+=`🟢 *Support:* ${y.map(k=>`$${k.toFixed(2)}`).join(", ")}

`,I+=`*Scenarios:*
`;for(const k of v)I+=`${k.name} (${k.probability}%)
`;I+=`
💡 *Recommendation:* ${j.action==="WAIT"?"⏰":j.action==="BUY"?"📈":"📉"} ${j.action}
`,I+=`${j.reason}`,T=await G({botToken:R.telegram_bot_token,chatId:R.telegram_chat_id},I),console.log("[AI-ANALYSIS] Telegram sent:",T)}}catch(S){console.error("[AI-ANALYSIS] Telegram error:",S.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:b,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:f,support:y},scenarios:v,recommendation:j,telegram_sent:T}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const W=new _e;W.use("/api/*",ca());W.route("/api/signals/enhanced",ds);W.route("/api/signals/simple",us);W.route("/api/scanner",wt);W.route("/api/trades",me);W.route("/api/calendar",De);W.route("/api/backtest",Ze);W.route("/api/telegram",Es);W.route("/api/ai",xs);W.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:n})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),a=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:a.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});W.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Ts),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});W.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume).run(),d++}if(p.length>=50){const u=ve(p.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const m=p[p.length-1].close,g=te(m,u,"day_trade"),_=te(m,u,"swing_trade"),f=70;for(const y of[g,_])if(y.confidence>=f&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const x=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),b={};for(const v of x.results||[])b[v.setting_key]=v.setting_value;b.telegram_bot_token&&b.telegram_chat_id&&await G({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},st(y))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const n="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let r=0;const l={};for(const o of i){const c=`https://api.twelvedata.com/time_series?symbol=${n}&interval=${o.interval}&apikey=${a}&outputsize=${o.outputsize}`,p=await(await fetch(c)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const u=p.values;let m=0;const g=[];for(const _ of u){const f={timestamp:_.datetime,open:parseFloat(_.open),high:parseFloat(_.high),low:parseFloat(_.low),close:parseFloat(_.close),volume:0};g.push(f),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(f.timestamp,f.open,f.high,f.low,f.close,f.volume,o.dbKey).run(),m++}if(g.length>=50){const _=ve(g.reverse());_&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,_.rsi_14,_.macd,_.macd_signal,_.macd_histogram,_.sma_20,_.sma_50,_.sma_200,_.ema_12,_.ema_26,_.bb_upper,_.bb_middle,_.bb_lower,_.atr_14,_.stochastic_k,_.stochastic_d,_.adx,_.plus_di,_.minus_di,_.ichimoku_tenkan,_.ichimoku_kijun,_.ichimoku_senkou_a,_.ichimoku_senkou_b,_.parabolic_sar,_.vwap,_.fib_382,_.fib_500,_.fib_618).run()}l[o.dbKey]={success:!0,count:m},r+=m,await new Promise(_=>setTimeout(_,500))}return e.json({success:!0,totalCount:r,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const a=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),n=ve(a);if(!n)return e.json({success:!1,error:"Failed to calculate indicators"});const i=a[a.length-1].close,r=te(i,n,"day_trade"),l=te(i,n,"swing_trade");return e.json({success:!0,signals:{day_trade:r,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:a,formatAlignmentReport:n}=await Promise.resolve().then(()=>os),i=["5m","15m","1h","4h","daily"],r={};for(const E of i){const C=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(E).first();C&&(r[E]=C)}const l=Object.keys(r).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(r)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(r,c),p=r["1h"],u=te(c,p,"day_trade"),m=te(c,p,"swing_trade"),g=a(u.signal_type,d),_=a(m.signal_type,d),f={...u,base_confidence:u.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${g.reason}`},y={...m,base_confidence:m.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${_.reason}`},x=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),b={};for(const E of x.results||[])b[E.setting_key]=E.setting_value;let v=!1,B=[];b.telegram_bot_token&&b.telegram_chat_id&&(f.isValid&&f.signal_type!=="HOLD"&&await G({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED
...
📊 ${n(d)}`)&&(B.push("swing_trade"),v=!0));for(const E of[f,y])E.isValid&&await t.prepare(`
    ...
    `).all();let a="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(a=g.setting_value);let n,i=!1;if(a&&a!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,f=await(await fetch(g)).json();f.values&&f.values.length>=50?(n=f.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",n[n.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!n){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const g of d.results||[])p[g.setting_key]=g.setting_value;let u=!1,m=[];p.telegram_bot_token&&p.telegram_chat_id&&(await G({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},st({...o,timestamp:new Date().toISOString()}))&&(m.push("day_trade"),u=!0),await new Promise(f=>setTimeout(f,1e3)),await G({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},st({...c,timestamp:new Date().toISOString()}))&&(m.push("swing_trade"),u=!0));for(const g of[o,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(a).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const _=new Date().toISOString().split("T")[0],f=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(a,_).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>dt),x=y(g,f.results);if(x.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${x.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const b=d*i,v=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(s).first();if(!r)return e.json({success:!1,error:"Trade not found"},404);if(r.status==="CLOSED")return e.json({success:!1,error:"Trade already closed"},400);const{calculateProfitLoss:l}=await Promise.resolve().then(()=>dt),o=l(r.entry_price,n,r.position_size,r.trade_type,r.commission||0);return await t.prepare(`
      UPDATE trades 
      SET exit_price = ?,
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:n}=await Promise.resolve().then(()=>dt),i=n(a.results);return e.json({success:!0,stats:i})}catch(a){return e.json({success:!1,error:a.message},500)}});W.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const a=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    ...
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Fetch MTF Data",status:"running"});const a=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),n=(a==null?void 0:a.setting_value)||"70140f57bea54c5e90768de696487d8f",i=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];let r=0;for(const k of i){const re=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${k.interval}&apikey=${n}&outputsize=100`,F=await(await fetch(re)).json();if(F.values&&Array.isArray(F.values)){const K=[];for(const L of F.values){const D={timestamp:L.datetime,open:parseFloat(L.open),high:parseFloat(L.high),low:parseFloat(L.low),close:parseFloat(L.close),volume:0};K.push(D),await t.prepare(`
            INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT DO NOTHING
          `).bind(D.timestamp,D.open,D.high,D.low,D.close,D.volume,k.dbKey).run()}if(K.length>=50){const L=ve(K.reverse());L&&await t.prepare(`
              INSERT INTO multi_timeframe_indicators 
              (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
               sma_20, sma_50, sma_200, ema_12, ema_26,
               bb_upper, bb_middle, bb_lower, atr_14,
               ...
               parabolic_sar, vwap, fib_382, fib_500, fib_618)
              VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `).bind(k.dbKey,L.rsi_14,L.macd,L.macd_signal,L.macd_histogram,L.sma_20,L.sma_50,L.sma_200,L.ema_12,L.ema_26,L.bb_upper,L.bb_middle,L.bb_lower,L.atr_14,L.stochastic_k,L.stochastic_d,L.adx,L.plus_di,L.minus_di,L.ichimoku_tenkan,L.ichimoku_kijun,L.ichimoku_senkou_a,L.ichimoku_senkou_b,L.parabolic_sar,L.vwap,L.fib_382,L.fib_500,L.fib_618).run()}r+=F.values.length}await new Promise(K=>setTimeout(K,500))}s.steps[0].status="completed",s.steps[0].data={totalCandles:r},s.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:l,validateMultiTimeframeSignal:o,formatAlignmentReport:c}=await Promise.resolve().then(()=>os),d={};for(const k of["5m","15m","1h","4h","daily"]){const re=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(k).first();re&&(d[k]=re)}const p=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(p==null?void 0:p.close)||0,m=l(d,u),g=d["1h"],_=te(u,g,"day_trade"),f=te(u,g,"swing_trade"),y=o(_.signal_type,m),x=o(f.signal_type,m),b={..._,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type},v={...f,final_confidence:Math.min(95,x.confidence),isValid:x.isValid,mtf_reason:x.reason,alignment_score:m.score,alignment_type:m.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:b,swingTrade:v,alignment:m},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const B=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),E=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:C}=await Promise.resolve().then(()=>dt),j=C(B,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},E.results),T=C(B,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},E.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:j,swingPosition:T},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const S=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),R={};for(const k of S.results||[])R[k.setting_key]=k.setting_value;let I=!1;if(R.telegram_bot_token&&R.telegram_chat_id){const k=`
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();I=await G({botToken:R.telegram_bot_token,chatId:R.telegram_chat_id},k)}if(s.steps[3].status=I?"completed":"failed",s.steps[3].data={telegramSent:I},b.isValid||v.isValid)for(const k of[b,v])k.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
