var en=Object.defineProperty;var Gt=e=>{throw TypeError(e)};var tn=(e,t,s)=>t in e?en(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var F=(e,t,s)=>tn(e,typeof t!="symbol"?t+"":t,s),Nt=(e,t,s)=>t.has(e)||Gt("Cannot "+s);var h=(e,t,s)=>(Nt(e,t,"read from private field"),s?s.call(e):t.get(e)),P=(e,t,s)=>t.has(e)?Gt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),N=(e,t,s,n)=>(Nt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),q=(e,t,s)=>(Nt(e,t,"access private method"),s);var Vt=(e,t,s,n)=>({set _(a){N(e,t,a,s)},get _(){return h(e,t,n)}});var qt=(e,t,s)=>(n,a)=>{let r=-1;return i(0);async function i(l){if(l<=r)throw new Error("next() called multiple times");r=l;let o,d=!1,c;if(e[l]?(c=e[l][0][0],n.req.routeIndex=l):c=l===e.length&&a||void 0,c)try{o=await c(n,()=>i(l+1))}catch(p){if(p instanceof Error&&t)n.error=p,o=await t(p,n),d=!0;else throw p}else n.finalized===!1&&s&&(o=await s(n));return o&&(n.finalized===!1||d)&&(n.res=o),n}},sn=Symbol(),nn=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,r=(e instanceof ps?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?an(e,{all:s,dot:n}):{}};async function an(e,t){const s=await e.formData();return s?rn(s,t):{}}function rn(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?on(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(ln(s,n,a),delete s[n])}),s}var on=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},ln=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((r,i)=>{i===a.length-1?n[r]=s:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},os=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},cn=e=>{const{groups:t,path:s}=dn(e),n=os(s);return un(n,t)},dn=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},un=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},Et={},pn=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return Et[n]||(s[2]?Et[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Et[n]=[e,s[1],!0]),Et[n]}return null},Ht=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},mn=e=>Ht(e,decodeURI),ls=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const r=t.indexOf("?",n),i=t.slice(s,r===-1?void 0:r);return mn(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(a===63)break}return t.slice(s,n)},gn=e=>{const t=ls(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ve=(e,t,...s)=>(s.length&&(t=Ve(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),cs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const r=a.replace("?","");n+="/"+r,s.push(n)}else n+="/"+a}),s.filter((a,r,i)=>i.indexOf(a)===r)},$t=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ht(e,us):e):e,ds=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const l=e.charCodeAt(i+t.length+1);if(l===61){const o=i+t.length+2,d=e.indexOf("&",o);return $t(e.slice(o,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";i=e.indexOf(`&${t}`,i+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const i=e.indexOf("&",r+1);let l=e.indexOf("=",r);l>i&&i!==-1&&(l=-1);let o=e.slice(r+1,l===-1?i===-1?void 0:i:l);if(n&&(o=$t(o)),r=i,o==="")continue;let d;l===-1?d="":(d=e.slice(l+1,i===-1?void 0:i),n&&(d=$t(d))),s?(a[o]&&Array.isArray(a[o])||(a[o]=[]),a[o].push(d)):a[o]??(a[o]=d)}return t?a[t]:a},fn=ds,_n=(e,t)=>ds(e,t,!0),us=decodeURIComponent,zt=e=>Ht(e,us),Xe,ue,ve,ms,gs,Pt,Le,ts,ps=(ts=class{constructor(e,t="/",s=[[]]){P(this,ve);F(this,"raw");P(this,Xe);P(this,ue);F(this,"routeIndex",0);F(this,"path");F(this,"bodyCache",{});P(this,Le,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(r=>(a==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,N(this,ue,s),N(this,Xe,{})}param(e){return e?q(this,ve,ms).call(this,e):q(this,ve,gs).call(this)}query(e){return fn(this.url,e)}queries(e){return _n(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await nn(this,e))}json(){return h(this,Le).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,Le).call(this,"text")}arrayBuffer(){return h(this,Le).call(this,"arrayBuffer")}blob(){return h(this,Le).call(this,"blob")}formData(){return h(this,Le).call(this,"formData")}addValidatedData(e,t){h(this,Xe)[e]=t}valid(e){return h(this,Xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[sn](){return h(this,ue)}get matchedRoutes(){return h(this,ue)[0].map(([[,e]])=>e)}get routePath(){return h(this,ue)[0].map(([[,e]])=>e)[this.routeIndex].path}},Xe=new WeakMap,ue=new WeakMap,ve=new WeakSet,ms=function(e){const t=h(this,ue)[0][this.routeIndex][1][e],s=q(this,ve,Pt).call(this,t);return s&&/\%/.test(s)?zt(s):s},gs=function(){const e={},t=Object.keys(h(this,ue)[0][this.routeIndex][1]);for(const s of t){const n=q(this,ve,Pt).call(this,h(this,ue)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?zt(n):n)}return e},Pt=function(e){return h(this,ue)[1]?h(this,ue)[1][e]:e},Le=new WeakMap,ts),hn={Stringify:1},fs=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(a?a[0]+=e:a=[e],Promise.all(r.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>fs(o,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},yn="text/plain; charset=UTF-8",Ft=(e,t)=>({"Content-Type":e,...t}),dt,ut,ye,Ke,be,de,pt,Ze,Qe,Oe,mt,gt,Re,qe,ss,bn=(ss=class{constructor(e,t){P(this,Re);P(this,dt);P(this,ut);F(this,"env",{});P(this,ye);F(this,"finalized",!1);F(this,"error");P(this,Ke);P(this,be);P(this,de);P(this,pt);P(this,Ze);P(this,Qe);P(this,Oe);P(this,mt);P(this,gt);F(this,"render",(...e)=>(h(this,Ze)??N(this,Ze,t=>this.html(t)),h(this,Ze).call(this,...e)));F(this,"setLayout",e=>N(this,pt,e));F(this,"getLayout",()=>h(this,pt));F(this,"setRenderer",e=>{N(this,Ze,e)});F(this,"header",(e,t,s)=>{this.finalized&&N(this,de,new Response(h(this,de).body,h(this,de)));const n=h(this,de)?h(this,de).headers:h(this,Oe)??N(this,Oe,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});F(this,"status",e=>{N(this,Ke,e)});F(this,"set",(e,t)=>{h(this,ye)??N(this,ye,new Map),h(this,ye).set(e,t)});F(this,"get",e=>h(this,ye)?h(this,ye).get(e):void 0);F(this,"newResponse",(...e)=>q(this,Re,qe).call(this,...e));F(this,"body",(e,t,s)=>q(this,Re,qe).call(this,e,t,s));F(this,"text",(e,t,s)=>!h(this,Oe)&&!h(this,Ke)&&!t&&!s&&!this.finalized?new Response(e):q(this,Re,qe).call(this,e,t,Ft(yn,s)));F(this,"json",(e,t,s)=>q(this,Re,qe).call(this,JSON.stringify(e),t,Ft("application/json",s)));F(this,"html",(e,t,s)=>{const n=a=>q(this,Re,qe).call(this,a,t,Ft("text/html; charset=UTF-8",s));return typeof e=="object"?fs(e,hn.Stringify,!1,{}).then(n):n(e)});F(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});F(this,"notFound",()=>(h(this,Qe)??N(this,Qe,()=>new Response),h(this,Qe).call(this,this)));N(this,dt,e),t&&(N(this,be,t.executionCtx),this.env=t.env,N(this,Qe,t.notFoundHandler),N(this,gt,t.path),N(this,mt,t.matchResult))}get req(){return h(this,ut)??N(this,ut,new ps(h(this,dt),h(this,gt),h(this,mt))),h(this,ut)}get event(){if(h(this,be)&&"respondWith"in h(this,be))return h(this,be);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,be))return h(this,be);throw Error("This context has no ExecutionContext")}get res(){return h(this,de)||N(this,de,new Response(null,{headers:h(this,Oe)??N(this,Oe,new Headers)}))}set res(e){if(h(this,de)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,de).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=h(this,de).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}N(this,de,e),this.finalized=!0}get var(){return h(this,ye)?Object.fromEntries(h(this,ye)):{}}},dt=new WeakMap,ut=new WeakMap,ye=new WeakMap,Ke=new WeakMap,be=new WeakMap,de=new WeakMap,pt=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,Oe=new WeakMap,mt=new WeakMap,gt=new WeakMap,Re=new WeakSet,qe=function(e,t,s){const n=h(this,de)?new Headers(h(this,de).headers):h(this,Oe)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,l]of r)i.toLowerCase()==="set-cookie"?n.append(i,l):n.set(i,l)}if(s)for(const[r,i]of Object.entries(s))if(typeof i=="string")n.set(r,i);else{n.delete(r);for(const l of i)n.append(r,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ke);return new Response(e,{status:a,headers:n})},ss),te="ALL",En="all",wn=["get","post","put","delete","options","patch"],_s="Can not add a route since the matcher is already built.",hs=class extends Error{},vn="__COMPOSED_HANDLER",Sn=e=>e.text("404 Not Found",404),Xt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,se,ys,me,Ne,wt,vt,Je,Tn=(Je=class{constructor(t={}){P(this,se);F(this,"get");F(this,"post");F(this,"put");F(this,"delete");F(this,"options");F(this,"patch");F(this,"all");F(this,"on");F(this,"use");F(this,"router");F(this,"getPath");F(this,"_basePath","/");P(this,pe,"/");F(this,"routes",[]);P(this,me,Sn);F(this,"errorHandler",Xt);F(this,"onError",t=>(this.errorHandler=t,this));F(this,"notFound",t=>(N(this,me,t),this));F(this,"fetch",(t,...s)=>q(this,se,vt).call(this,t,s[1],s[0],t.method));F(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ve("/",t)}`,s),n,a)));F(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(q(this,se,vt).call(this,t.request,t,void 0,t.request.method))})});[...wn,En].forEach(r=>{this[r]=(i,...l)=>(typeof i=="string"?N(this,pe,i):q(this,se,Ne).call(this,r,h(this,pe),i),l.forEach(o=>{q(this,se,Ne).call(this,r,h(this,pe),o)}),this)}),this.on=(r,i,...l)=>{for(const o of[i].flat()){N(this,pe,o);for(const d of[r].flat())l.map(c=>{q(this,se,Ne).call(this,d.toUpperCase(),h(this,pe),c)})}return this},this.use=(r,...i)=>(typeof r=="string"?N(this,pe,r):(N(this,pe,"*"),i.unshift(r)),i.forEach(l=>{q(this,se,Ne).call(this,te,h(this,pe),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ls:gn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var i;let r;s.errorHandler===Xt?r=a.handler:(r=async(l,o)=>(await qt([],s.errorHandler)(l,()=>a.handler(l,o))).res,r[vn]=a.handler),q(i=n,se,Ne).call(i,a.method,a.path,r)}),this}basePath(t){const s=q(this,se,ys).call(this);return s._basePath=Ve(this._basePath,t),s}mount(t,s,n){let a,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?a=o=>o:a=n.replaceRequest));const i=r?o=>{const d=r(o);return Array.isArray(d)?d:[d]}:o=>{let d;try{d=o.executionCtx}catch{}return[o.env,d]};a||(a=(()=>{const o=Ve(this._basePath,t),d=o==="/"?0:o.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,c)}})());const l=async(o,d)=>{const c=await s(a(o.req.raw),...i(o));if(c)return c;await d()};return q(this,se,Ne).call(this,te,Ve(t,"*"),l),this}},pe=new WeakMap,se=new WeakSet,ys=function(){const t=new Je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,N(t,me,h(this,me)),t.routes=this.routes,t},me=new WeakMap,Ne=function(t,s,n){t=t.toUpperCase(),s=Ve(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},wt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},vt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await q(this,se,vt).call(this,t,s,n,"GET")))();const r=this.getPath(t,{env:n}),i=this.router.match(a,r),l=new bn(t,{path:r,matchResult:i,env:n,executionCtx:s,notFoundHandler:h(this,me)});if(i[0].length===1){let d;try{d=i[0][0][0][0](l,async()=>{l.res=await h(this,me).call(this,l)})}catch(c){return q(this,se,wt).call(this,c,l)}return d instanceof Promise?d.then(c=>c||(l.finalized?l.res:h(this,me).call(this,l))).catch(c=>q(this,se,wt).call(this,c,l)):d??h(this,me).call(this,l)}const o=qt(i[0],this.errorHandler,h(this,me));return(async()=>{try{const d=await o(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return q(this,se,wt).call(this,d,l)}})()},Je),bs=[];function xn(e,t){const s=this.buildAllMatchers(),n=((a,r)=>{const i=s[a]||s[te],l=i[2][r];if(l)return l;const o=r.match(i[0]);if(!o)return[[],bs];const d=o.indexOf("",1);return[i[1][d],o]});return this.match=n,n(e,t)}var xt="[^/]+",ot=".*",lt="(?:|/.*)",ze=Symbol(),Ln=new Set(".\\+*[^]$()");function Rn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ot||e===lt?1:t===ot||t===lt?-1:e===xt?1:t===xt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ce,Be,ge,He,kn=(He=class{constructor(){P(this,Ce);P(this,Be);P(this,ge,Object.create(null))}insert(t,s,n,a,r){if(t.length===0){if(h(this,Ce)!==void 0)throw ze;if(r)return;N(this,Ce,s);return}const[i,...l]=t,o=i==="*"?l.length===0?["","",ot]:["","",xt]:i==="/*"?["","",lt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(o){const c=o[1];let p=o[2]||xt;if(c&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ze;if(d=h(this,ge)[p],!d){if(Object.keys(h(this,ge)).some(m=>m!==ot&&m!==lt))throw ze;if(r)return;d=h(this,ge)[p]=new He,c!==""&&N(d,Be,a.varIndex++)}!r&&c!==""&&n.push([c,h(d,Be)])}else if(d=h(this,ge)[i],!d){if(Object.keys(h(this,ge)).some(c=>c.length>1&&c!==ot&&c!==lt))throw ze;if(r)return;d=h(this,ge)[i]=new He}d.insert(l,s,n,a,r)}buildRegExpStr(){const s=Object.keys(h(this,ge)).sort(Rn).map(n=>{const a=h(this,ge)[n];return(typeof h(a,Be)=="number"?`(${n})@${h(a,Be)}`:Ln.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof h(this,Ce)=="number"&&s.unshift(`#${h(this,Ce)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ce=new WeakMap,Be=new WeakMap,ge=new WeakMap,He),kt,ft,ns,In=(ns=class{constructor(){P(this,kt,{varIndex:0});P(this,ft,new kn)}insert(e,t,s){const n=[],a=[];for(let i=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const d=`@\\${i}`;return a[i]=[d,o],i++,l=!0,d}),!l)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=a.length-1;i>=0;i--){const[l]=a[i];for(let o=r.length-1;o>=0;o--)if(r[o].indexOf(l)!==-1){r[o]=r[o].replace(l,a[i][1]);break}}return h(this,ft).insert(r,t,n,h(this,kt),s),n}buildRegExp(){let e=h(this,ft).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,r,i)=>r!==void 0?(s[++t]=Number(r),"$()"):(i!==void 0&&(n[Number(i)]=++t),"")),[new RegExp(`^${e}`),s,n]}},kt=new WeakMap,ft=new WeakMap,ns),An=[/^$/,[],Object.create(null)],St=Object.create(null);function Es(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Dn(){St=Object.create(null)}function Mn(e){var d;const t=new In,s=[];if(e.length===0)return An;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[m,u])=>c?1:m?-1:p.length-u.length),a=Object.create(null);for(let c=0,p=-1,m=n.length;c<m;c++){const[u,g,f]=n[c];u?a[g]=[f.map(([y])=>[y,Object.create(null)]),bs]:p++;let _;try{_=t.insert(g,p,u)}catch(y){throw y===ze?new hs(g):y}u||(s[p]=f.map(([y,w])=>{const S=Object.create(null);for(w-=1;w>=0;w--){const[b,E]=_[w];S[b]=E}return[y,S]}))}const[r,i,l]=t.buildRegExp();for(let c=0,p=s.length;c<p;c++)for(let m=0,u=s[c].length;m<u;m++){const g=(d=s[c][m])==null?void 0:d[1];if(!g)continue;const f=Object.keys(g);for(let _=0,y=f.length;_<y;_++)g[f[_]]=l[g[f[_]]]}const o=[];for(const c in i)o[c]=s[i[c]];return[r,o,a]}function Ge(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(Es(s).test(t))return[...e[s]]}}var ke,Ie,It,ws,as,Nn=(as=class{constructor(){P(this,It);F(this,"name","RegExpRouter");P(this,ke);P(this,Ie);F(this,"match",xn);N(this,ke,{[te]:Object.create(null)}),N(this,Ie,{[te]:Object.create(null)})}add(e,t,s){var l;const n=h(this,ke),a=h(this,Ie);if(!n||!a)throw new Error(_s);n[e]||[n,a].forEach(o=>{o[e]=Object.create(null),Object.keys(o[te]).forEach(d=>{o[e][d]=[...o[te][d]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Es(t);e===te?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ge(n[d],t)||Ge(n[te],t)||[])}):(l=n[e])[t]||(l[t]=Ge(n[e],t)||Ge(n[te],t)||[]),Object.keys(n).forEach(d=>{(e===te||e===d)&&Object.keys(n[d]).forEach(c=>{o.test(c)&&n[d][c].push([s,r])})}),Object.keys(a).forEach(d=>{(e===te||e===d)&&Object.keys(a[d]).forEach(c=>o.test(c)&&a[d][c].push([s,r]))});return}const i=cs(t)||[t];for(let o=0,d=i.length;o<d;o++){const c=i[o];Object.keys(a).forEach(p=>{var m;(e===te||e===p)&&((m=a[p])[c]||(m[c]=[...Ge(n[p],c)||Ge(n[te],c)||[]]),a[p][c].push([s,r-d+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Ie)).concat(Object.keys(h(this,ke))).forEach(t=>{e[t]||(e[t]=q(this,It,ws).call(this,t))}),N(this,ke,N(this,Ie,void 0)),Dn(),e}},ke=new WeakMap,Ie=new WeakMap,It=new WeakSet,ws=function(e){const t=[];let s=e===te;return[h(this,ke),h(this,Ie)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(r=>[r,n[e][r]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==te&&t.push(...Object.keys(n[te]).map(r=>[r,n[te][r]]))}),s?Mn(t):null},as),Ae,Ee,rs,$n=(rs=class{constructor(e){F(this,"name","SmartRouter");P(this,Ae,[]);P(this,Ee,[]);N(this,Ae,e.routers)}add(e,t,s){if(!h(this,Ee))throw new Error(_s);h(this,Ee).push([e,t,s])}match(e,t){if(!h(this,Ee))throw new Error("Fatal error");const s=h(this,Ae),n=h(this,Ee),a=s.length;let r=0,i;for(;r<a;r++){const l=s[r];try{for(let o=0,d=n.length;o<d;o++)l.add(...n[o]);i=l.match(e,t)}catch(o){if(o instanceof hs)continue;throw o}this.match=l.match.bind(l),N(this,Ae,[l]),N(this,Ee,void 0);break}if(r===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(h(this,Ee)||h(this,Ae).length!==1)throw new Error("No active router has been determined yet.");return h(this,Ae)[0]}},Ae=new WeakMap,Ee=new WeakMap,rs),it=Object.create(null),De,le,Pe,et,ie,we,$e,tt,Fn=(tt=class{constructor(t,s,n){P(this,we);P(this,De);P(this,le);P(this,Pe);P(this,et,0);P(this,ie,it);if(N(this,le,n||Object.create(null)),N(this,De,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},N(this,De,[a])}N(this,Pe,[])}insert(t,s,n){N(this,et,++Vt(this,et)._);let a=this;const r=cn(s),i=[];for(let l=0,o=r.length;l<o;l++){const d=r[l],c=r[l+1],p=pn(d,c),m=Array.isArray(p)?p[0]:d;if(m in h(a,le)){a=h(a,le)[m],p&&i.push(p[1]);continue}h(a,le)[m]=new tt,p&&(h(a,Pe).push(p),i.push(p[1])),a=h(a,le)[m]}return h(a,De).push({[t]:{handler:n,possibleKeys:i.filter((l,o,d)=>d.indexOf(l)===o),score:h(this,et)}}),a}search(t,s){var o;const n=[];N(this,ie,it);let r=[this];const i=os(s),l=[];for(let d=0,c=i.length;d<c;d++){const p=i[d],m=d===c-1,u=[];for(let g=0,f=r.length;g<f;g++){const _=r[g],y=h(_,le)[p];y&&(N(y,ie,h(_,ie)),m?(h(y,le)["*"]&&n.push(...q(this,we,$e).call(this,h(y,le)["*"],t,h(_,ie))),n.push(...q(this,we,$e).call(this,y,t,h(_,ie)))):u.push(y));for(let w=0,S=h(_,Pe).length;w<S;w++){const b=h(_,Pe)[w],E=h(_,ie)===it?{}:{...h(_,ie)};if(b==="*"){const I=h(_,le)["*"];I&&(n.push(...q(this,we,$e).call(this,I,t,h(_,ie))),N(I,ie,E),u.push(I));continue}const[L,$,H]=b;if(!p&&!(H instanceof RegExp))continue;const T=h(_,le)[L],x=i.slice(d).join("/");if(H instanceof RegExp){const I=H.exec(x);if(I){if(E[$]=I[0],n.push(...q(this,we,$e).call(this,T,t,h(_,ie),E)),Object.keys(h(T,le)).length){N(T,ie,E);const A=((o=I[0].match(/\//))==null?void 0:o.length)??0;(l[A]||(l[A]=[])).push(T)}continue}}(H===!0||H.test(p))&&(E[$]=p,m?(n.push(...q(this,we,$e).call(this,T,t,E,h(_,ie))),h(T,le)["*"]&&n.push(...q(this,we,$e).call(this,h(T,le)["*"],t,E,h(_,ie)))):(N(T,ie,E),u.push(T)))}}r=u.concat(l.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},De=new WeakMap,le=new WeakMap,Pe=new WeakMap,et=new WeakMap,ie=new WeakMap,we=new WeakSet,$e=function(t,s,n,a){const r=[];for(let i=0,l=h(t,De).length;i<l;i++){const o=h(t,De)[i],d=o[s]||o[te],c={};if(d!==void 0&&(d.params=Object.create(null),r.push(d),n!==it||a&&a!==it))for(let p=0,m=d.possibleKeys.length;p<m;p++){const u=d.possibleKeys[p],g=c[d.score];d.params[u]=a!=null&&a[u]&&!g?a[u]:n[u]??(a==null?void 0:a[u]),c[d.score]=!0}}return r},tt),Ue,is,On=(is=class{constructor(){F(this,"name","TrieRouter");P(this,Ue);N(this,Ue,new Fn)}add(e,t,s){const n=cs(t);if(n){for(let a=0,r=n.length;a<r;a++)h(this,Ue).insert(e,n[a],s);return}h(this,Ue).insert(e,t,s)}match(e,t){return h(this,Ue).search(e,t)}},Ue=new WeakMap,is),he=class extends Tn{constructor(e={}){super(e),this.router=e.router??new $n({routers:[new Nn,new On]})}},Cn=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(r=>typeof r=="string"?r==="*"?()=>r:i=>r===i?i:null:typeof r=="function"?r:i=>r.includes(i)?i:null)(s.origin),a=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(s.allowMethods);return async function(i,l){var c;function o(p,m){i.res.headers.set(p,m)}const d=await n(i.req.header("origin")||"",i);if(d&&o("Access-Control-Allow-Origin",d),s.credentials&&o("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),i.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await a(i.req.header("origin")||"",i);p.length&&o("Access-Control-Allow-Methods",p.join(","));let m=s.allowHeaders;if(!(m!=null&&m.length)){const u=i.req.header("Access-Control-Request-Headers");u&&(m=u.split(/\s*,\s*/))}return m!=null&&m.length&&(o("Access-Control-Allow-Headers",m.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function Lt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Fe(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Bn(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let n=0,a=0;for(let o=0;o<t;o++)s[o]>0?n+=s[o]:a+=Math.abs(s[o]);let r=n/t,i=a/t;for(let o=t;o<s.length;o++){const d=s[o];r=(r*(t-1)+(d>0?d:0))/t,i=(i*(t-1)+(d<0?Math.abs(d):0))/t}return i===0?100:100-100/(1+r/i)}function Pn(e){const t=Lt(e,12),s=Lt(e,26),n=t-s,a=n*.9,r=n-a;return{macd:n,signal:a,histogram:r}}function Un(e,t=20,s=2){const n=Fe(e,t),r=e.slice(-t).reduce((l,o)=>l+Math.pow(o-n,2),0)/t,i=Math.sqrt(r);return{upper:n+i*s,middle:n,lower:n-i*s}}function Hn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let r=1;r<e.length;r++){const i=e[r].high,l=e[r].low,o=e[r-1].close,d=Math.max(i-l,Math.abs(i-o),Math.abs(l-o));s.push(d)}const n=Fe(s,t);return Math.max(n,10)}function jn(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(p=>p.high),r=n.map(p=>p.low),i=e[e.length-1].close,l=Math.max(...a),o=Math.min(...r),d=(i-o)/(l-o)*100;return{k:d,d}}function Wn(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let d=1;d<Math.min(t+1,e.length);d++){const c=e[d].high,p=e[d].low,m=e[d-1].high,u=e[d-1].low,g=e[d-1].close,f=c-m,_=u-p;f>_&&f>0&&(s+=f),_>f&&_>0&&(n+=_),a+=Math.max(c-p,Math.abs(c-g),Math.abs(p-g))}const r=a>0?s/a*100:0,i=a>0?n/a*100:0;return{adx:r+i>0?Math.abs(r-i)/(r+i)*100:0,plusDI:r,minusDI:i}}function Yn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(y=>y.high)),a=Math.min(...s.map(y=>y.low)),r=(n+a)/2,i=Math.min(26,e.length),l=e.slice(-i),o=Math.max(...l.map(y=>y.high)),d=Math.min(...l.map(y=>y.low)),c=(o+d)/2,p=(r+c)/2,m=Math.min(52,e.length),u=e.slice(-m),g=Math.max(...u.map(y=>y.high)),f=Math.min(...u.map(y=>y.low)),_=(g+f)/2;return{tenkan:r,kijun:c,senkouA:p,senkouB:_}}function Gn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Vn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,r=n.volume||1;t+=a*r,s+=r}return s>0?t/s:e[e.length-1].close}function qn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(o=>o.high),a=s.map(o=>o.low),r=Math.max(...n),i=Math.min(...a),l=r-i;return{fib_0:r,fib_236:r-l*.236,fib_382:r-l*.382,fib_500:r-l*.5,fib_618:r-l*.618,fib_100:i}}function _e(e){if(e.length<50)return null;const t=e.map(c=>c.close),s=Pn(t),n=Un(t),a=jn(e,14,3),r=Wn(e,14),i=Yn(e),l=Gn(e),o=Vn(e),d=qn(e,50);return{rsi_14:Bn(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:Lt(t,12),ema_26:Lt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Hn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:r.adx,plus_di:r.plusDI,minus_di:r.minusDI,ichimoku_tenkan:i.tenkan,ichimoku_kijun:i.kijun,ichimoku_senkou_a:i.senkouA,ichimoku_senkou_b:i.senkouB,parabolic_sar:l,vwap:o,fib_382:d.fib_382,fib_500:d.fib_500,fib_618:d.fib_618}}function ne(e,t,s){const n=[];let a=0,r=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:r+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),r+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),r+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),r+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),r+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),r+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),r+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),r+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),r+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),r+=2):t.rsi_14>60&&(n.push("RSI above 60"),r+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),r+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),r+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),r+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),r+=2);const i=a+r,l=i>0?a/i*100:50;let o="HOLD",d=50;a>r+1?(o="BUY",d=Math.min(l,95)):r>a+1&&(o="SELL",d=Math.min(100-l,95)),t.adx>30&&Math.abs(a-r)>4&&(d=Math.min(d+5,95),n.push("High conviction signal"));const c=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,m=s==="day_trade"?4:5.5,u=s==="day_trade"?5:7,f=e*(1/100);let _,y,w,S;if(o==="BUY"){const b=e-t.atr_14*c;_=Math.max(b,e-f),y=e+t.atr_14*p,w=e+t.atr_14*m,S=e+t.atr_14*u}else if(o==="SELL"){const b=e+t.atr_14*c;_=Math.min(b,e+f),y=e-t.atr_14*p,w=e-t.atr_14*m,S=e-t.atr_14*u}else _=e,y=e,w=e,S=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(_.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(w.toFixed(2)),take_profit_3:parseFloat(S.toFixed(2)),confidence:parseFloat(d.toFixed(1)),reason:n.join(", ")}}async function K(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function zn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function ct(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
⏰ ${new Date().toLocaleString()}
  `.trim()}function vs(e,t){if(!e)throw console.error("[determineTrend] indicators is null/undefined!"),new Error("Indicators is undefined");if(e.rsi_14===void 0)throw console.error("[determineTrend] rsi_14 is undefined! Indicators:",Object.keys(e)),new Error("rsi_14 is undefined in indicators");let s=0,n=0,a=0;e.macd>e.macd_signal&&e.macd_histogram>0?s+=3:e.macd<e.macd_signal&&e.macd_histogram<0&&(n+=3),a+=3,t>e.sma_20?s+=2:n+=2,a+=2,t>e.sma_50?s+=2:n+=2,a+=2,t>e.sma_200?s+=3:n+=3,a+=3,e.adx&&e.adx>25&&e.plus_di&&e.minus_di&&(e.plus_di>e.minus_di?s+=2:n+=2,a+=2),e.rsi_14>50?s+=1:n+=1,a+=1;const r=s/a*100,i=n/a*100,l=Math.abs(r-i);let o,d;return r>60?(o="BULLISH",d=r):i>60?(o="BEARISH",d=i):(o="NEUTRAL",d=50),{timeframe:"1h",trend:o,strength:l,confidence:d}}function jt(e,t){console.log("[analyzeTimeframeAlignment] START"),console.log("[analyzeTimeframeAlignment] indicators keys:",Object.keys(e||{})),console.log("[analyzeTimeframeAlignment] currentPrice:",t);const s=[],n=["5m","15m","1h","4h","daily"];for(const c of n){console.log(`[analyzeTimeframeAlignment] Processing ${c}`);const p=e[c];if(p){console.log(`[analyzeTimeframeAlignment] ${c} has indicators, calling determineTrend`),console.log(`[analyzeTimeframeAlignment] ${c} rsi_14:`,p.rsi_14,typeof p.rsi_14);const m=vs(p,t);m.timeframe=c,s.push(m)}else console.log(`[analyzeTimeframeAlignment] ${c} missing indicators`)}const a=s.filter(c=>c.trend==="BULLISH").length,r=s.filter(c=>c.trend==="BEARISH").length;s.filter(c=>c.trend==="NEUTRAL").length;const i=s.length,l=Math.max(a,r);let o,d;return a===i?(o="ALL_BULLISH",d=20):r===i?(o="ALL_BEARISH",d=20):a>=i*.8?(o="ALL_BULLISH",d=15):r>=i*.8?(o="ALL_BEARISH",d=15):a>=i*.6||r>=i*.6?(o="MIXED",d=10):(o="CONFLICTING",d=0),{score:l,type:o,confidenceBoost:d,trends:s}}function Ut(e,t){if(e==="HOLD")return{isValid:!1,confidence:50,reason:"HOLD signal - no trade"};const{trends:s,type:n,confidenceBoost:a}=t,r=s.find(p=>p.timeframe==="daily"),i=s.find(p=>p.timeframe==="4h"),l=s.find(p=>p.timeframe==="1h"),o=s.find(p=>p.timeframe==="15m"),d=s.find(p=>p.timeframe==="5m"),c=e==="BUY"&&(d==null?void 0:d.trend)==="BULLISH"&&(o==null?void 0:o.trend)==="BULLISH"&&(l==null?void 0:l.trend)==="BULLISH"&&(d.strength>70||o.strength>70||l.strength>70)||e==="SELL"&&(d==null?void 0:d.trend)==="BEARISH"&&(o==null?void 0:o.trend)==="BEARISH"&&(l==null?void 0:l.trend)==="BEARISH"&&(d.strength>70||o.strength>70||l.strength>70);return e==="BUY"?r&&r.trend==="BEARISH"&&r.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BEARISH - opposing BUY signal"}:i&&i.trend==="BEARISH"&&i.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BEARISH - opposing BUY signal"}:l&&l.trend==="BEARISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BEARISH - weak BUY setup"}:n==="ALL_BULLISH"?{isValid:!0,confidence:85+a,reason:`All timeframes BULLISH - high probability BUY (${t.score}/${s.length} aligned)`}:n==="MIXED"&&a>=15?{isValid:!0,confidence:75+a,reason:`Strong multi-timeframe BULLISH alignment (${t.score}/${s.length})`}:n==="MIXED"&&c?{isValid:!0,confidence:70+a,reason:`Lower timeframes (5m/15m/1h) strongly aligned BUY - immediate opportunity (${t.score}/${s.length})`}:a>=10?{isValid:!0,confidence:65+a,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip BUY (${t.score}/${s.length})`}:e==="SELL"?r&&r.trend==="BULLISH"&&r.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BULLISH - opposing SELL signal"}:i&&i.trend==="BULLISH"&&i.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BULLISH - opposing SELL signal"}:l&&l.trend==="BULLISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BULLISH - weak SELL setup"}:n==="ALL_BEARISH"?{isValid:!0,confidence:85+a,reason:`All timeframes BEARISH - high probability SELL (${t.score}/${s.length} aligned)`}:n==="MIXED"&&a>=15?{isValid:!0,confidence:75+a,reason:`Strong multi-timeframe BEARISH alignment (${t.score}/${s.length})`}:n==="MIXED"&&c?{isValid:!0,confidence:70+a,reason:`Lower timeframes (5m/15m/1h) strongly aligned SELL - immediate opportunity (${t.score}/${s.length})`}:a>=10?{isValid:!0,confidence:65+a,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip SELL (${t.score}/${s.length})`}:{isValid:!1,confidence:50,reason:"Unknown signal type"}}function Xn(e){const t=[`Multi-Timeframe Alignment: ${e.type}`];t.push(`Score: ${e.score}/${e.trends.length}`),t.push(`Confidence Boost: +${e.confidenceBoost}%`),t.push(""),t.push("Timeframe Analysis:");for(const s of e.trends){const n=s.trend==="BULLISH"?"📈":s.trend==="BEARISH"?"📉":"➡️";t.push(`  ${n} ${s.timeframe.padEnd(6)}: ${s.trend.padEnd(8)} (${s.confidence.toFixed(0)}% confident, ${s.strength.toFixed(0)}% strength)`)}return t.join(`
`)}const Ss=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:jt,determineTrend:vs,formatAlignmentReport:Xn,validateMultiTimeframeSignal:Ut},Symbol.toStringTag,{value:"Module"}));function Kt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((r,i)=>r-i),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function Kn(e,t){const s=Kt(e,.95),n=Kt(e,.99),a=t*s,r=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(r.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Zn(e,t,s,n){const a=t-e,r=a/t*100;let i=0;for(let d=n.length-1;d>=0&&n[d].balance<t;d--)i++;const l=r<=s,o=r>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(r.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:i}}function Qn(e,t,s=5){let n=0;const a=[];for(const o of e){const c=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=c/t*100;n+=c,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const r=n/t*100,i=r<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(r.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:a}}function Jn(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[r,i,l]=a;if(i.value>r.value&&i.value>l.value&&Math.abs(r.value-l.value)/r.value<.02){const d=Math.min(r.value,l.value)*.995,c=d-(i.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function ea(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],d=n[n.length-1]-n[0],c=o+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function ta(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),n=t.map(d=>d.low),r=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(r<.01&&o>.015){const d=Math.max(...s),c=t[t.length-1].close,p=d+(d-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function sa(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[r,i]=a;if(Math.abs(r.value-i.value)/r.value<.015){const o=Math.max(...s.slice(r.index,i.index))*1.005,d=o+(o-r.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:66}}return null}function na(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),r=s[25];if(Math.abs(n-r)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),d=(r-o)/r;if(d>.01&&d<.05){const c=n-a,p=r+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function aa(e){const t=[],s=Jn(e);s&&t.push(s);const n=ea(e);n&&t.push(n);const a=ta(e);a&&t.push(a);const r=sa(e);r&&t.push(r);const i=na(e);i&&t.push(i);let l=0,o=0,d=0;for(const u of t)u.direction==="bullish"?(l++,d+=u.confidence):u.direction==="bearish"&&(o++,d+=u.confidence);let c="neutral",p=0;l>o?(c="bullish",p=Math.min(d/l/10,15)):o>l&&(c="bearish",p=Math.min(d/o/10,15));let m="";if(t.length===0)m="No significant chart patterns detected";else{const u=t.map(g=>g.pattern_type).join(", ");m=`Detected ${t.length} pattern(s): ${u}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(p.toFixed(1)),summary:m}}function ra(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function ia(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function oa(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function la(e,t,s){const n=ra(t.atr_14,s),a=ia(t,s),r=oa(t,s);let i,l,o,d,c,p;const m=e.slice(-10),u=m.map(y=>y.volume||0),g=u.reduce((y,w)=>y+w,0)/u.length,_=(m[m.length-1].volume||0)>g*1.5;return n==="EXTREME"&&_?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,o=!0,d="Trend-following (aggressive entry)",c=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,o=!1,d="Wait for stabilization",c=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,o=!1,d="Wait for direction",c=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,o=!0,d="Trend-following (buy dips, trail stops)",c=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,o=!1,d="Stay in cash or short",c=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,o=!0,d="Trend-following (selective entries)",c=1,p="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,o=!1,d="Reduce exposure or stay flat",c=.5,p="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,r>60?(o=!0,d="Mean-reversion (fade extremes)",c=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,d="Wait for trend to develop",c=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:r,should_trade:o,recommended_strategy:d,risk_adjustment:c,description:p}}function ca(e){const t=e.length;let s=0,n=0,a=0,r=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],r+=o*o;const i=(t*a-s*n)/(t*r-s*s),l=(n-i*s)/t;return{slope:i,intercept:l}}function da(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let r=n[0];for(let l=1;l<n.length;l++)r=(n[l]-r)*a+r;const i=(n[n.length-1]-n[n.length-10])/10;return r+i*s}function ua(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const i=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function pa(e,t,s){const n=e[e.length-1].close;e.map(i=>i.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const r=a/100*s;return n+t.atr_14*r}function ma(e,t){const s=e.map(m=>m.close),n=s[s.length-1],a=10,r=s.slice(-a),i=Math.min(...r),l=Math.max(...r),o=r.map(m=>(m-i)/(l-i));let d={index:0,similarity:-1/0};for(let m=a;m<s.length-a-t;m++){const u=s.slice(m-a,m),g=Math.min(...u),f=Math.max(...u),_=u.map(S=>(S-g)/(f-g));let y=0;for(let S=0;S<a;S++)y+=Math.pow(o[S]-_[S],2);const w=-y;w>d.similarity&&(d={index:m,similarity:w})}const p=(s[d.index+t]-s[d.index])*(n/s[d.index]);return n+p}function Ot(e,t,s){const n=[],a=[],r=e.map(L=>L.close),{slope:i,intercept:l}=ca(r.slice(-20)),o=i*(r.length-1+s)+l;n.push(o),a.push(1);const d=da(e,12,s);n.push(d),a.push(1.5);const c=ua(e,s);n.push(c),a.push(1.2);const p=pa(e,t,s);n.push(p),a.push(1.8);const m=ma(e,s);n.push(m),a.push(1.3);const u=a.reduce((L,$)=>L+$,0),f=n.reduce((L,$,H)=>L+$*a[H],0)/u,_=n.reduce((L,$)=>L+$,0)/n.length,y=n.reduce((L,$)=>L+Math.pow($-_,2),0)/n.length,w=Math.sqrt(y),S=e[e.length-1].close,b=1-w/S,E=Math.max(50,Math.min(95,b*100));return{prediction:f,confidence:E}}function ga(e,t){const s=e[e.length-1].close,n=[],a=Ot(e,t,1),r=a.prediction-s,i=r/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:r>.5?"UP":r<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Ot(e,t,4),o=l.prediction-s,d=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Ot(e,t,24),p=c.prediction-s,m=p/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(m.toFixed(2)),method:"Ensemble (5 models)"});const u=n.filter(w=>w.direction==="UP").length,g=n.filter(w=>w.direction==="DOWN").length;let f,_=0;u>g?(f="BULLISH",_=Math.min(u*5,15)):g>u?(f="BEARISH",_=Math.min(g*5,15)):f="NEUTRAL";const y=`ML models predict ${f} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:f,confidence_boost:parseFloat(_.toFixed(1)),summary:y}}function Ct(e,t,s,n,a){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const o=(n-50)/10;l+=o;const d=(a-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function fa(e,t,s,n,a){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function _a(e,t,s,n,a,r){const i=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,d=t-e;return r.tp1/100*i+r.tp2/100*l+r.tp3/100*o+r.sl/100*d}function ha(e,t,s){const n=e.price,a=t.atr_14;let r=50;e.signal_type==="BUY"?(n>t.sma_20&&(r+=10),n>t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(r+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(r+=10),n<t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(r+=10)),r=Math.min(100,r);const i=s.slice(-50),l=[];for(let S=14;S<i.length;S++){const b=i.slice(S-14,S);let E=0;for(let L=1;L<b.length;L++){const $=Math.max(b[L].high-b[L].low,Math.abs(b[L].high-b[L-1].close),Math.abs(b[L].low-b[L-1].close));E+=$}l.push(E/14)}const o=l.reduce((S,b)=>S+b,0)/l.length,d=a/o,c=Ct(n,e.take_profit_1,a,r,d),p=Ct(n,e.take_profit_2,a,r,d),m=Ct(n,e.take_profit_3,a,r,d),u=fa(n,e.stop_loss,a,r,e.signal_type),g=_a(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:p,tp3:m,sl:u}),_=(c+p+m)/3/u;let y;c>70&&g>5&&_>2?y="STRONG_TRADE":c>60&&g>0&&_>1.5?y="GOOD_TRADE":c>50&&g>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const w=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${_.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(m.toFixed(1)),stop_loss_probability:parseFloat(u.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(_.toFixed(2)),recommendation:y,summary:w}}function Ts(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=ya(e),s=ba(),n=Ea(e,s.session),a=wa(t,s.session),r=va(t,s),i=Sa(t,s,n,r),l=Ta(i,t,s,n),o=xa(i);return{liquidity_score:Math.round(i),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(r),optimal_for_trading:i>=70&&l.length===0,warnings:l,recommendation:o}}function ya(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((d,c)=>d+(c.volume||1),0)/e.length,a=t.reduce((d,c)=>d+(c.volume||1),0)/t.length,r=s.reduce((d,c)=>d+(c.volume||1),0)/s.length,i=a/n;let l;a>r*1.2?l="INCREASING":a<r*.8?l="DECREASING":l="STABLE";const o=Math.min(100,i*100);return{avg_volume:n,current_volume:a,volume_ratio:i,volume_spike:i>2,volume_drought:i<.5,trend:l,percentile:o}}function ba(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,r;return n>=780&&n<960?(a="OVERLAP",r="HIGH"):n>=480&&n<780?(a="LONDON",r="HIGH"):n>=960&&n<1320?(a="NEW_YORK",r="HIGH"):n>=0&&n<480?(a="ASIA",r="MEDIUM"):(a="OFF_HOURS",r="LOW"),{zone:r,session:a}}function Ea(e,t){const s=e.slice(-20);let n=0;for(const c of s){const p=c.high-c.low;n+=p}const a=n/s.length,r=s[s.length-1].close,i=a/r*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+i*2,d=l*o;return{spread_pips:Math.round(d)}}function wa(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,r=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*r}function va(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function Sa(e,t,s,n){const a=e.percentile*.3,r=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,i=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+r+i+l}function Ta(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function xa(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Wt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function La(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function At(e=30){const t=[],s=new Date;for(const a of Wt){const r=new Date(a),i=Math.floor((r.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const r=new Date(s.getTime()+a*24*60*60*1e3),i=r.getFullYear(),l=r.getMonth(),o=r.getDate(),d=r.getDay();if(o===La(i,l)&&d===5){const c=r.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&d>=1&&d<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&d>=1&&d<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,r,i)=>r===i.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,r)=>{const i=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${r.date}T${r.time}:00Z`);return i.getTime()-l.getTime()})}function _t(e=new Date,t=[]){const s=[...At(7),...t],n=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(i=>i.date===a&&i.impact==="high"),Wt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Ra(a)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const r=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>r&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Ra(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Tt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function ka(e){const t=e.toISOString().split("T")[0];return Wt.includes(t)?!0:At(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Ia(){const e=new Date().toISOString().split("T")[0];return At(7).filter(s=>s.date===e)}function xs(e=new Date){const t=_t(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const Ls=new he;Ls.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const B of["5m","15m","1h","4h","daily"]){const M=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(B).first();M&&(n[B]=M);const V=await t.prepare(`
        SELECT timestamp, open, high, low, close, volume 
        FROM market_data 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(B).all();V.results&&V.results.length>0&&(a[B]=V.results.map(v=>({timestamp:v.timestamp,open:v.open,high:v.high,low:v.low,close:v.close,volume:v.volume||0})))}if(Object.keys(n).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(n).length}. Please fetch multi-timeframe data first.`},400);const r=[];if(n["1h"]&&n["1h"].timestamp){const B=new Date(n["1h"].timestamp).getTime(),V=(Date.now()-B)/(1e3*60);V>60?r.push(`⚠️ WARNING: 1h data is ${V.toFixed(0)} minutes old (>60 min)`):V>30&&r.push(`⚠️ CAUTION: 1h data is ${V.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${V.toFixed(1)} minutes old`)}const i=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(i==null?void 0:i.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(i!=null&&i.timestamp){const B=new Date(i.timestamp).getTime(),M=(Date.now()-B)/(1e3*60);M>60&&r.push(`⚠️ WARNING: Price data is ${M.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${M.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=_t(),d=xs();let c=null,p=!1;o.riskLevel==="danger"?(p=!0,c=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(c=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const m=n["1h"];if(!m)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const u=jt(n,l),g=ne(l,m,"day_trade"),f=ne(l,m,"swing_trade"),_=Ut(g.signal_type,u),y=Ut(f.signal_type,u),w={...g,base_confidence:g.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:u.score,alignment_type:u.type},S={...f,base_confidence:f.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:u.score,alignment_type:u.type};let b=0,E="",L=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const M=aa(a["1h"]);L=(M==null?void 0:M.patterns)||[]}catch(M){console.error("[ENHANCED] Pattern detection error:",M.message)}const B=L.filter(M=>M.confidence>=70&&M.endIndex>=a["1h"].length-5);for(const M of B)M.type==="bullish"&&w.signal_type==="BUY"?(b+=M.confidence*.1,E+=`${M.name} (${M.confidence.toFixed(0)}%), `):M.type==="bearish"&&w.signal_type==="SELL"&&(b+=M.confidence*.1,E+=`${M.name} (${M.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let $=0,H="",T=null;if(a["1h"]&&a["1h"].length>=50){const B=_e(a["1h"]);B&&(T=la(a["1h"],B),T.trend==="STRONG_UPTREND"&&w.signal_type==="BUY"?($=10,H="Strong Uptrend"):T.trend==="UPTREND"&&w.signal_type==="BUY"?($=5,H="Uptrend"):T.trend==="STRONG_DOWNTREND"&&w.signal_type==="SELL"?($=10,H="Strong Downtrend"):T.trend==="DOWNTREND"&&w.signal_type==="SELL"&&($=5,H="Downtrend"))}let x=0,I="",A=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{A=ga(a["1h"],l),A.overall_direction==="BULLISH"&&w.signal_type==="BUY"?(x=A.confidence_boost,I=`ML predicts +${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):A.overall_direction==="BEARISH"&&w.signal_type==="SELL"&&(x=A.confidence_boost,I=`ML predicts ${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(B){console.error("[ENHANCED] ML prediction error:",B.message)}let Y=0,j="",X=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const B=_e(a["1h"]);B&&(X=ha(w,B,a["1h"]),X.tp1_probability>70?(Y=10,j=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`):X.tp1_probability>60&&(Y=5,j=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`))}catch(B){console.error("[ENHANCED] Probability of Profit error:",B.message)}let k=null,G=0,ce=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{k=Ts(a["1h"]),k.liquidity_score>=80?G=5:k.liquidity_score>=70?G=0:k.liquidity_score>=50?ce=-5:ce=-10,console.log(`[LIQUIDITY] Score: ${k.liquidity_score}/100, Session: ${k.session}, Adjust: ${G+ce}%`)}catch(B){console.error("[ENHANCED] Liquidity Analysis error:",B.message)}let D=0,z=0,ee=0,ae=0,re="";try{const B=await t.prepare(`
      ...
      `).all(),V=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(B&&M.results&&M.results.length>=10){const v=Kn(M.results,B.balance);D=v.var_95,z=v.var_99;const oe=Zn(B.balance,M.results);if(ee=oe.current_drawdown_pct,oe.is_within_limit||(re+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),V.results){const C=Qn(V.results,B.balance);ae=C.total_risk_pct,C.is_within_limit||(re+=`⚠️ Portfolio heat ${ae.toFixed(1)}% exceeds limit. `)}}}catch(B){console.error("[ENHANCED] Risk metrics error (optional):",B.message)}const R=b+$+x+Y+G+ce,W={...w,pattern_boost:b,regime_boost:$,ml_boost:x,pop_boost:Y,total_boost:R,enhanced_confidence:Math.min(98,w.final_confidence+R),var_95:D,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ae,risk_warning:re||null},O={...S,pattern_boost:b,regime_boost:$,ml_boost:x,pop_boost:Y,total_boost:R,enhanced_confidence:Math.min(98,S.final_confidence+R),var_95:D,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ae,risk_warning:re||null};p?(W.signal_type="HOLD",O.signal_type="HOLD",W.enhanced_confidence=50,O.enhanced_confidence=50,W.reasoning=c||"Economic event nearby - trading paused",O.reasoning=c||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):d.adjustment<0&&(W.enhanced_confidence=Math.max(50,W.enhanced_confidence+d.adjustment),O.enhanced_confidence=Math.max(50,O.enhanced_confidence+d.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",d.adjustment)),W.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:d.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(B=>Tt(B))},O.calendar_check=W.calendar_check;let Se=!1;try{const B=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),M={};for(const V of B.results||[])M[V.setting_key]=V.setting_value;if(M.telegram_bot_token&&M.telegram_chat_id){const V=new Date().toLocaleString("en-US",{timeZone:"UTC"});let v=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${V} UTC
...
`),$>0&&(v+=`Regime: +${$.toFixed(0)}%
`),x>0&&(v+=`ML: +${x.toFixed(0)}%
`),Y>0&&(v+=`PoP: +${Y.toFixed(0)}%
`),G!==0||ce!==0){const J=G+ce;v+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}v+=`*FINAL: ${W.enhanced_confidence.toFixed(0)}%*

`,T&&(v+=`🌡️ *Market Regime:* ${T.trend||"N/A"}
`,v+=`Volatility: ${T.volatility}
`,v+=`Should Trade: ${T.should_trade?"✅ YES":"❌ NO"}
...
`),v+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",v.length,"characters");const oe=await K({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},v);let C=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if(k){const J=k.liquidity_score>=80?"🟢":k.liquidity_score>=70?"🟡":k.liquidity_score>=50?"🟠":"🔴";if(C+=`🌊 *LIQUIDITY ANALYSIS*
`,C+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,C+=`${J} *Score:* ${k.liquidity_score}/100
`,C+=`🕐 *Session:* ${k.session}
`,C+=`📊 *Time Zone:* ${k.time_of_day_zone} LIQUIDITY
`,C+=`📈 *Volume:* ${k.volume_trend} (${k.volume_percentile}%)
`,C+=`💰 *Spread:* ~${k.estimated_spread_pips} pips
`,C+=`📉 *Price Impact:* ~${k.price_impact_bps} bps per $100k
`,C+=`🎯 *Market Depth:* ${k.market_depth_score}/100
`,C+=`✅ *Optimal:* ${k.optimal_for_trading?"YES":"NO"}

`,k.warnings.length>0){C+=`⚠️ *Liquidity Warnings:*
`;for(const Z of k.warnings)C+=`• ${Z}
`;C+=`
`}C+=`💡 *Recommendation:*
${k.recommendation}
...
`,C+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",C.length,"characters");const je=await K({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},C);Se=oe&&je}}catch(B){console.error("[ENHANCED] Telegram error (optional):",B.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Se,day_trade:W,swing_trade:O,alignment:{type:u.type,score:u.score,trends:u.trends},patterns:L.length>0?L.slice(0,3):null,regime:T?{trend:T.trend,volatility:T.volatility,should_trade:T.should_trade}:null,ml_prediction:A?{direction:A.overall_direction,predictions:A.predictions}:null,profit_probability:X?{tp1:X.tp1_probability,tp2:X.tp2_probability,tp3:X.tp3_probability,expected_value:X.expected_value}:null,liquidity:k?{score:k.liquidity_score,session:k.session,time_zone:k.time_of_day_zone,volume_trend:k.volume_trend,volume_percentile:k.volume_percentile,estimated_spread_pips:k.estimated_spread_pips,price_impact_bps:k.price_impact_bps,market_depth_score:k.market_depth_score,optimal_for_trading:k.optimal_for_trading,warnings:k.warnings,recommendation:k.recommendation}:null,risk_metrics:{var_95:D,var_99:z,drawdown_pct:ee,portfolio_heat_pct:ae}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Rs=new he;Rs.post("/simple",async e=>{var s,n,a,r;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const i=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,S+=`⏰ ${w}`,console.log("[SIMPLE] Sending Telegram message, length:",S.length),g=await K({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},S),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:d,telegram_sent:g,day_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(d),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"day_trade"},swing_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(d),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"swing_trade"}})}catch(i){return console.error("[SIMPLE] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function Aa(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Da(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Ma(e,t){return e>t*1.1}function Na(e){let t=0,s=0,n=0;for(const l of e){const o=l.volume||0;n+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const a=s>0?t/s:t>0?10:1;let r="NEUTRAL";a>1.5?r="BUYING":a<.67&&(r="SELLING");let i=0;return a>3?i=100:a>1.5?i=50+(a-1.5)/1.5*50:a>.67?i=(a-.67)/.83*50:a>.33?i=50+(.67-a)/.34*50:i=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:r,strength:Math.round(i)}}function ks(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function $a(e,t){const n=ks(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Fa(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Oa(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Ca(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Ba(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Pa(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Ua(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Ha(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),ja(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),Wa(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Ya(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Ga(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Oa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Ca(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Ba(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Pa(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Ua(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),i=e.close<e.open,l=s.close>s.open;return i&&a<n*.5&&l&&r>n*.6&&s.close>(e.open+e.close)/2}function Ha(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),i=e.close>e.open,l=s.close<s.open;return i&&a<n*.5&&l&&r>n*.6&&s.close<(e.open+e.close)/2}function ja(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,r=t.low>e.low&&s.low>t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&r&&i>d&&l>d&&o>d}function Wa(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,r=t.low<e.low&&s.low<t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&r&&i>d&&l>d&&o>d}function Ya(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Ga(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function Va(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function qa(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const c=e.slice(-288),p=Math.max(...c.map(u=>u.high)),m=Math.min(...c.map(u=>u.low));s.push({level:p,type:"RESISTANCE",strength:85,distance:p-t,distancePercent:(p-t)/t*100}),s.push({level:m,type:"SUPPORT",strength:85,distance:t-m,distancePercent:(t-m)/t*100})}const n=e.slice(-50),a=Zt(n,"HIGH"),r=Zt(n,"LOW");if(a.forEach(c=>{s.push({level:c,type:"RESISTANCE",strength:75,distance:c-t,distancePercent:(c-t)/t*100})}),r.forEach(c=>{s.push({level:c,type:"SUPPORT",strength:75,distance:t-c,distancePercent:(t-c)/t*100})}),za(t).forEach(c=>{const p=c>t?"RESISTANCE":"SUPPORT";s.push({level:c,type:p,strength:70,distance:Math.abs(c-t),distancePercent:Math.abs(c-t)/t*100})}),e.length>=288){const c=e.slice(-288),p=Xa(c);s.push({level:p.pp,type:"PIVOT",strength:80,distance:Math.abs(p.pp-t),distancePercent:Math.abs(p.pp-t)/t*100}),s.push({level:p.r1,type:"RESISTANCE",strength:70,distance:p.r1-t,distancePercent:(p.r1-t)/t*100}),s.push({level:p.s1,type:"SUPPORT",strength:70,distance:t-p.s1,distancePercent:(t-p.s1)/t*100})}const l=s.filter(c=>Math.abs(c.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((c,p)=>Math.abs(p.distancePercent)<Math.abs(c.distancePercent)?p:c),d=Ka(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:d,strength:o.strength,description:Za(o,d)}}function Zt(e,t){const s=[];for(let r=5;r<e.length-5;r++){const i=t==="HIGH"?e[r].high:e[r].low;let l=!0;for(let o=r-5;o<=r+5;o++){if(o===r)continue;const d=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&d>=i){l=!1;break}if(t==="LOW"&&d<=i){l=!1;break}}l&&s.push(i)}return Array.from(new Set(s)).slice(-3)}function za(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function Xa(e){const t=Math.max(...e.map(d=>d.high)),s=Math.min(...e.map(d=>d.low)),n=e[e.length-1].close,a=(t+s+n)/3,r=2*a-s,i=2*a-t,l=a+(t-s),o=a-(t-s);return{pp:a,r1:r,s1:i,r2:l,s2:o}}function Ka(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function Za(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function Qa(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function Ja(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=er(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const r=tr(s,a),i=sr(s,a);return r.type!=="NONE"&&i.type===r.type?{type:r.type,category:r.category,indicator:"BOTH",strength:95,description:`${r.type} ${r.category} (RSI+MACD)`,confidence:90}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"RSI",strength:80,description:`${r.type} ${r.category} (RSI)`,confidence:75}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"MACD",strength:70,description:`${i.type} ${i.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function er(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const r=e[a];let i=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].high>=r.high){i=!1;break}i&&t.push({index:a,price:r.high});let l=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].low<=r.low){l=!1;break}l&&s.push({index:a,price:r.low})}return{highs:t,lows:s}}function tr(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,r=e[n.index].rsi,i=e[a.index].rsi;if(a.price<n.price&&i>r)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,r=e[n.index].rsi,i=e[a.index].rsi;if(a.price>n.price&&i<r)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function sr(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,r=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price<n.price&&i>r)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,r=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price>n.price&&i<r)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function nr(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function ar(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,r=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${r}, ${e.strength}/100)`}function rr(e,t,s,n){const a=(_,y)=>{const w=parseFloat(String(_));return isNaN(w)?y:w},r=a(e.ema_12,n),i=a(t.ema_26,n),l=a(s.sma_200,n),o=Bt(n,r),d=Bt(n,i),c=Bt(n,l),p=o===d&&d===c&&o!=="NEUTRAL",m=o===d&&o!=="NEUTRAL"||o===c&&o!=="NEUTRAL"||d===c&&d!=="NEUTRAL";let u=0,g="",f="";return p?(u=100,g=`ALL ${o}`,f=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):m?(u=65,o===d?(g=`5M+15M ${o}`,f=`5m & 15m ${o.toLowerCase()} (1h ${c.toLowerCase()})`):o===c?(g=`5M+1H ${o}`,f=`5m & 1h ${o.toLowerCase()} (15m ${d.toLowerCase()})`):(g=`15M+1H ${d}`,f=`15m & 1h ${d.toLowerCase()} (5m ${o.toLowerCase()})`)):(u=30,g="MIXED",f=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${d.toLowerCase()}, 1h ${c.toLowerCase()}`),{tf5m:o,tf15m:d,tf1h:c,allAligned:p,twoAligned:m,alignment:g,strength:u,description:f}}function Bt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function ir(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function or(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function lr(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,r=(s.close-n.close)/n.close*100;let i="FLAT";r>.1?i="UP":r<-.1&&(i="DOWN");let l="NEUTRAL";i==="DOWN"?l="BULLISH":i==="UP"&&(l="BEARISH");const o=Math.abs(r);let d=-.8,c=0;o>.3?c=90:o>.2?c=75:o>.1?c=60:c=40;const p=new Date(s.timestamp),u=Math.floor((new Date().getTime()-p.getTime())/6e4),g=dr(a,r,i,l,c);return{dxyPrice:a,dxyChange:r,dxyTrend:i,goldSignalSupport:l,correlation:d,strength:c,description:g,dataAge:u}}function cr(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function dr(e,t,s,n,a){const r=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${r} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${r} → Gold BEARISH (${a}/100)`:`DXY flat ${r} → Neutral (${a}/100)`}async function ur(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function pr(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function mr(e){try{const t=await e.prepare(`
      SELECT timestamp, close
      FROM dxy_cache
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function gr(e,t,s=15){const n=await mr(e);if(n.length>0){const r=new Date(n[n.length-1].timestamp),l=(new Date().getTime()-r.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),n}console.log("[DXY] Fetching fresh DXY data from API...");const a=await ur(t);return a.length>0?(await pr(e,a),a):(console.log("[DXY] Fetch failed, using stale cache"),n)}function fr(e,t,s){const n=Qt("Silver (XAG/USD)",e),a=Qt("Crude Oil (WTI)",t);let r=0;n&&Rt(n.trend,s)&&r++,a&&Rt(a.trend,s)&&r++;let i=0;const l=r>=1;r===2?i=95:r===1?i=70:i=30;const o=_r(n,a,r,s);return{silver:n,oil:a,aligned:l,alignmentCount:r,strength:i,description:o}}function Qt(e,t){if(t.length<2)return null;const s=t[t.length-1],n=t[0],a=s.close,r=(s.close-n.close)/n.close*100;let i="FLAT";r>.2?i="UP":r<-.2&&(i="DOWN");const l=Math.abs(r);let o=0;return l>1?o=90:l>.5?o=75:l>.2?o=60:o=40,{symbol:e,price:a,change:r,trend:i,strength:o}}function Rt(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function _r(e,t,s,n){if(s===2)return`Silver & Oil both ${n==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&Rt(e.trend,n))return`Silver ${e.trend.toLowerCase()} confirms Gold ${n}`;if(t&&Rt(t.trend,n))return`Oil ${t.trend.toLowerCase()} confirms Gold ${n}`}const a=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",r=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${a}, ${r} (mixed signals)`}async function hr(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[SILVER] No data returned from API"),[]):n.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function yr(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[OIL] No data returned from API"),[]):n.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function br(e,t,s){try{const n=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const a of s)await e.prepare(`
      ...
      DELETE FROM ${n}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(n){console.error(`[${t}] Error storing data:`,n.message)}}async function Er(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",n=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!n.results||n.results.length===0?[]:n.results.map(a=>({close:a.close,timestamp:a.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function Jt(e,t,s,n=15){const a=await Er(e,s);if(a.length>0){const i=new Date(a[a.length-1].timestamp),o=(new Date().getTime()-i.getTime())/6e4;if(o<n)return console.log(`[${s}] Using cached data (${o.toFixed(1)}min old)`),a}console.log(`[${s}] Fetching fresh data from API...`);const r=s==="SILVER"?await hr(t):await yr(t);return r.length>0?(await br(e,s,r),r):(console.log(`[${s}] Fetch failed, using stale cache`),a)}function wr(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),a=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let r="NEUTRAL",i="NEUTRAL",l=50;const o=e.percentile;if(o>=90?(r="EXTREME_BULLISH",i="BULLISH",l=95):o>=70?(r="BULLISH",i="BULLISH",l=80):o<=30?(r="BEARISH",i="BEARISH",l=80):o<=10?(r="EXTREME_BEARISH",i="BEARISH",l=95):(r="NEUTRAL",i="NEUTRAL",l=50),e.largeSpecNet>0){const c=vr(e.largeSpecNet);c>=95?i==="BEARISH"?l+=10:i==="BULLISH"&&(l-=15):c<=5&&(i==="BULLISH"?l+=10:i==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const d=Tr(r,o,a);return{currentPosition:e,positioning:r,goldSignalSupport:i,strength:l,description:d,dataAge:a}}function vr(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function Sr(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Tr(e,t,s){const n=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${n}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${n}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${n}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${n}]`:`COT: Neutral positioning (${t}th percentile) [${n}]`}async function xr(){return null}async function Lr(e,t){try{await e.prepare(`
    ...
    `).bind(p,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let m=!1;if(c.grade==="A"||c.grade==="A+")try{const g=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),f={};for(const _ of g.results||[])f[_.setting_key]=_.setting_value;if(f.telegram_bot_token&&f.telegram_chat_id){const _=As(c,d);m=await K({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},_),await t.prepare(`
    ...
    `).bind(p,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let m=!1;if(c.grade==="A"||c.grade==="A+")try{const u=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),g={};for(const y of u.results||[]){const w=y;g[w.setting_key]=w.setting_value}const f=g.telegram_bot_token,_=g.telegram_chat_id;if(f&&_&&f!=="your_bot_token_here"&&_!=="your_chat_id_here"){const y=`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});st.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const d of s.results||[])n[d.setting_key]=d.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,r=15,i={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-r,tp1:a+r*2,tp2:a+r*3,tp3:a+r*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=As(i,a),o=await K({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Is(e,t,s,n,a,r){console.log("[ANALYZE] Starting analysis");let i=0,l=0;const o=[],d=(Q,Ye)=>{const bt=parseFloat(String(Q));return isNaN(bt)?Ye:bt};console.log("[ANALYZE] parseNum defined");const c={ema20:d(t.ema_12,r),rsi:d(t.rsi_14,50),macd:d(t.macd,0),macd_signal:d(t.macd_signal,0),macd_histogram:d(t.macd_histogram,0),adx:d(t.adx,25)},p={ema50:d(s.ema_26,r)},m={sma200:d(n.sma_200,r)},u=r>c.ema20&&r>p.ema50&&r>m.sma200,g=r<c.ema20&&r<p.ema50&&r<m.sma200;u||g?(i+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${u?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const f=c.rsi>=40&&c.rsi<=60,_=c.macd>c.macd_signal&&c.macd_histogram>0,y=c.macd<c.macd_signal&&c.macd_histogram<0;f&&(u?_:y)?(i+=15,l++,o.push(`✅ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${u?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${f?"no crossover":"extreme"}`);const w=a.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,S=a[a.length-1].volume;S>w*1.5?(i+=15,l++,o.push(`✅ Layer 3: Volume spike ${(S/w).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(S/w).toFixed(1)}x (need 1.5x+)`);const E=Math.max(...a.slice(-20).map(Q=>Q.high)),L=Math.min(...a.slice(-20).map(Q=>Q.low)),$=r>E*.999,H=r<L*1.001;u&&$||g&&H?(i+=15,l++,o.push(`✅ Layer 4: ${u?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let T=null;try{T=await Ts(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const x=(T==null?void 0:T.liquidity_score)||50,I=(T==null?void 0:T.session)||"UNKNOWN";x>=70?(i+=15,l++,o.push(`✅ Layer 5: Liquidity ${x}/100 (${I} session)`)):o.push(`❌ Layer 5: Liquidity ${x}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const Y=_t();console.log("[ANALYZE] Calendar check complete"),Y.riskLevel==="safe"?(i+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${Y.reason}`);const X=c.adx>25,k=c.adx>70;X&&!k?(i+=10,l++,o.push(`✅ Layer 7: ADX ${c.adx.toFixed(1)} (strong trend)`)):k?o.push(`⚠️ Layer 7: ADX ${c.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${c.adx.toFixed(1)} (weak trend)`);let G="HOLD";(u||g)&&l>=5&&(G=u?"BUY":"SELL");const ce=new Date,D=Aa(ce);D.hasBoost?(i+=8,l++,o.push(`✅ Layer 8: ${D.reason} (+${D.boost}% win)`)):o.push(`ℹ️ Layer 8: ${D.reason}`);const z=Da(ce);z.hasBoost?(i+=5,l++,o.push(`✅ Layer 9: ${z.reason} (+${z.boost}% win)`)):o.push(`ℹ️ Layer 9: ${z.reason}`);const ee=d(t.atr_14,r*.01),ae=a.slice(-20).reduce((Q,Ye)=>{const bt=Ye.high-Ye.low;return Q+bt},0)/20;if(Ma(ee,ae)){i+=7,l++;const Q=((ee/ae-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-ee/ae)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const R=Na(a.slice(-20));ks(R,G)&&R.strength>=60&&(i+=10,l++),o.push($a(R,G));const O=Fa(a.slice(-3)),{aligned:Se,strongestPattern:B}=Va(O,G);Se&&B?(i+=12,l++,o.push(`✅ Layer 12: ${B.name} (${B.strength}/100)`)):O.length>0&&O[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${O[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const M=qa(a,r);Qa(M,G)&&M.nearZone?(i+=8,l++,o.push(`✅ Layer 13: ${M.description}`)):M.nearZone?o.push(`⚠️ Layer 13: ${M.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const oe=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),C=Ja(oe,a.slice(-10)),J=nr(C,G,u?"BULLISH":g?"BEARISH":"NEUTRAL");J&&C.strength>=70&&(i+=9,l++),o.push(ar(C,J));const Z=rr(t,s,n,r),Yt=ir(Z,G);Yt&&(Z.allAligned||Z.twoAligned)&&(i+=6,l++),o.push(or(Z,Yt));const Dt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),Mt=(Dt==null?void 0:Dt.setting_value)||"70140f57bea54c5e90768de696487d8f",Vs=await gr(e,Mt,15),rt=lr(Vs);cr(rt,G)&&rt.strength>=60?(i+=5,l++,o.push(`✅ Layer 18: ${rt.description}`)):rt.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${rt.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const qs=await Jt(e,Mt,"SILVER",15),zs=await Jt(e,Mt,"OIL",15),We=fr(qs,zs,G);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;i+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const Xs=await kr(e)||Ir(),Te=wr(Xs);if(Sr(Te,G)&&Te.strength>=70){const Q=Te.positioning.includes("EXTREME")?7:4;i+=Q,l++,o.push(`✅ Layer 20: ${Te.description} (${Te.strength}/100)`)}else Te.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${Te.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${Te.description}`);let yt="C";i>=162?yt="A+":i>=144?yt="A":i>=126&&(yt="B"),(u||g)&&l>=7&&(G=u?"BUY":"SELL");const xe=Math.max(ee*1.5,r*.003),Ks=G==="BUY"?r-xe:r+xe,Zs=G==="BUY"?r+xe*2:r-xe*2,Qs=G==="BUY"?r+xe*3:r-xe*3,Js=G==="BUY"?r+xe*4:r-xe*4;return{grade:yt,score:i,signal:G,confidence:i,layersPassed:l,layers:o,stopLoss:Ks,tp1:Zs,tp2:Qs,tp3:Js,liquidityScore:x,session:I,adx:c.adx,rsi:c.rsi,volumeRatio:S/w}}function As(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,r=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let i=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,i+="Next scan in 5 minutes...",i}async function nt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,i,l,o,e).run();const c=(await nt(n)).current_balance+i;return await n.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(c).run(),await $s(n),await Dr(n),await Mr(n),{success:!0,profit_loss:i}}catch(a){return{success:!1,error:a.message}}}async function $s(e){const t=await nt(e),s=await e.prepare(`
  ...
  `).bind(s,r).run();let i=!1,l="";s>=t.max_drawdown_pct?(i=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):r>=t.max_daily_loss_pct&&(i=!0,l=`Daily loss ${r.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),i&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s).run(),e.json({success:!0,message:"Event deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});function Cs(e,t,s){const n=s.find(y=>t.confidence>=y.confidence_min&&t.confidence<=y.confidence_max);if(!n)return{units:0,value:0,risk_amount:0,risk_pct:0,position_pct:0,stop_loss_distance:0,reward_risk_ratio:0,is_valid:!1,warning:`No position sizing rule found for confidence ${t.confidence}%`};const a=Math.abs(t.entry_price-t.stop_loss),i=e.current_balance*(n.risk_pct/100)/a,l=i*t.entry_price;l/e.current_balance*100;const o=e.current_balance*(n.max_position_pct/100);let d=i,c=l,p=n.risk_pct,m;l>o&&(c=o,d=o/t.entry_price,p=d*a/e.current_balance*100,m=`Position reduced to ${n.max_position_pct}% max position size`);const g=Math.abs(t.take_profit_1-t.entry_price)/a;let f=!0;const _=[];return m&&_.push(m),g<1.5&&_.push(`Low reward:risk ratio (${g.toFixed(2)}:1). Recommended: >1.5:1`),p>e.max_daily_loss_pct&&(f=!1,_.push(`Risk ${p.toFixed(2)}% exceeds max daily loss ${e.max_daily_loss_pct}%`)),d<.01&&(f=!1,_.push("Position size too small (minimum 0.01 lots)")),{units:parseFloat(d.toFixed(2)),value:parseFloat(c.toFixed(2)),risk_amount:parseFloat((d*a).toFixed(2)),risk_pct:parseFloat(p.toFixed(2)),position_pct:parseFloat((c/e.current_balance*100).toFixed(2)),stop_loss_distance:parseFloat(a.toFixed(2)),reward_risk_ratio:parseFloat(g.toFixed(2)),is_valid:f,warning:_.length>0?_.join("; "):void 0}}function Bs(e,t,s,n,a=0){let r;n==="BUY"?r=(t-e)*s:r=(e-t)*s,r-=a;const i=(t-e)/e*100,l=Math.abs(t-e)/.01;return{profit_loss:parseFloat(r.toFixed(2)),profit_loss_pct:parseFloat(i.toFixed(2)),pips:parseFloat(l.toFixed(1))}}function Nr(e,t){const s=t.filter(l=>l.profit_loss<0).reduce((l,o)=>l+o.profit_loss,0),n=Math.abs(s/e.current_balance)*100,a=n>=e.max_daily_loss_pct,i=e.current_balance*(e.max_daily_loss_pct/100)-Math.abs(s);return{current_loss:parseFloat(s.toFixed(2)),current_loss_pct:parseFloat(n.toFixed(2)),limit_exceeded:a,remaining:parseFloat(i.toFixed(2))}}function $r(e){const t=e.filter(f=>f.status==="CLOSED"),s=t.filter(f=>f.profit_loss>0),n=t.filter(f=>f.profit_loss<0),a=s.reduce((f,_)=>f+_.profit_loss,0),r=Math.abs(n.reduce((f,_)=>f+_.profit_loss,0)),i=a-r,l=s.length>0?a/s.length:0,o=n.length>0?r/n.length:0,d=t.length>0?s.length/t.length*100:0,c=r>0?a/r:a,p=100-d,m=d/100*l-p/100*o,u=s.length>0?Math.max(...s.map(f=>f.profit_loss)):0,g=n.length>0?Math.min(...n.map(f=>f.profit_loss)):0;return{total_trades:t.length,winning_trades:s.length,losing_trades:n.length,win_rate:parseFloat(d.toFixed(2)),total_profit:parseFloat(a.toFixed(2)),total_loss:parseFloat(r.toFixed(2)),net_profit:parseFloat(i.toFixed(2)),avg_win:parseFloat(l.toFixed(2)),avg_loss:parseFloat(o.toFixed(2)),profit_factor:parseFloat(c.toFixed(2)),expectancy:parseFloat(m.toFixed(2)),largest_win:parseFloat(u.toFixed(2)),largest_loss:parseFloat(g.toFixed(2))}}function Fr(e){return e.is_valid?`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ht=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:$r,calculatePositionSize:Cs,calculateProfitLoss:Bs,checkDailyLossLimit:Nr,formatPositionSize:Fr},Symbol.toStringTag,{value:"Module"}));async function Ps(e,t,s){const n=Date.now(),a=[],r=[];let i=t.starting_balance,l=t.starting_balance;const o=e.filter(D=>{const z=new Date(D.timestamp);return z>=new Date(t.start_date)&&z<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const d={current_balance:i,max_daily_loss_pct:2};for(let D=200;D<o.length;D++){const z=o.slice(D-200,D),ee=_e(z);if(!ee)continue;const ae=o[D],re=ae.close,R=ne(re,ee,"day_trade"),W=ne(re,ee,"swing_trade");for(const O of[R,W]){if(O.signal_type==="HOLD"||O.confidence<t.min_confidence)continue;d.current_balance=i;const Se=Cs(d,{entry_price:O.price,stop_loss:O.stop_loss,take_profit_1:O.take_profit_1,take_profit_2:O.take_profit_2,take_profit_3:O.take_profit_3,confidence:O.confidence,signal_type:O.signal_type,trading_style:O.trading_style},s);if(!Se.is_valid)continue;const B=ae.timestamp,M=O.price;let V=null,v=null,oe="UNKNOWN";const C=Math.min(50,o.length-D-1);for(let J=1;J<=C;J++){const Z=o[D+J];if(O.signal_type==="BUY"){if(Z.low<=O.stop_loss){V=O.stop_loss,v=Z.timestamp,oe="STOP_LOSS";break}if(Z.high>=O.take_profit_3){V=O.take_profit_3,v=Z.timestamp,oe="TP3";break}if(Z.high>=O.take_profit_2){V=O.take_profit_2,v=Z.timestamp,oe="TP2";break}if(Z.high>=O.take_profit_1){V=O.take_profit_1,v=Z.timestamp,oe="TP1";break}}else{if(Z.high>=O.stop_loss){V=O.stop_loss,v=Z.timestamp,oe="STOP_LOSS";break}if(Z.low<=O.take_profit_3){V=O.take_profit_3,v=Z.timestamp,oe="TP3";break}if(Z.low<=O.take_profit_2){V=O.take_profit_2,v=Z.timestamp,oe="TP2";break}if(Z.low<=O.take_profit_1){V=O.take_profit_1,v=Z.timestamp,oe="TP1";break}}}if(!V||!v)continue;const je=Bs(M,V,Se.units,O.signal_type,t.commission_per_trade);i+=je.profit_loss,i>l&&(l=i),a.push({entry_time:B,entry_price:M,exit_time:v,exit_price:V,signal_type:O.signal_type,trading_style:O.trading_style,position_size:Se.units,profit_loss:je.profit_loss,profit_loss_pct:je.profit_loss_pct,exit_reason:oe,confidence:O.confidence}),r.push({date:v,balance:i})}}const c=a.filter(D=>D.profit_loss>0),p=a.filter(D=>D.profit_loss<0),m=c.reduce((D,z)=>D+z.profit_loss,0),u=Math.abs(p.reduce((D,z)=>D+z.profit_loss,0)),g=i-t.starting_balance,f=a.length>0?c.length/a.length*100:0,_=c.length>0?m/c.length:0,y=p.length>0?u/p.length:0,w=c.length>0?Math.max(...c.map(D=>D.profit_loss)):0,S=p.length>0?Math.min(...p.map(D=>D.profit_loss)):0,b=u>0?m/u:m,E=100-f,L=f/100*_-E/100*y;let $=0,H=0,T=t.starting_balance;for(const D of r){D.balance>T&&(T=D.balance);const z=T-D.balance,ee=z/T*100;z>$&&($=z,H=ee)}const x=a.map(D=>D.profit_loss_pct),I=x.reduce((D,z)=>D+z,0)/x.length,A=Math.sqrt(x.reduce((D,z)=>D+Math.pow(z-I,2),0)/x.length),Y=A>0?I/A:0;let j=0,X=0,k=0,G=0;for(const D of a)D.profit_loss>0?(k++,G=0,j=Math.max(j,k)):(G++,k=0,X=Math.max(X,G));const ce=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:c.length,losing_trades:p.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(_.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(w.toFixed(2)),largest_loss:parseFloat(S.toFixed(2)),max_drawdown:parseFloat($.toFixed(2)),max_drawdown_pct:parseFloat(H.toFixed(2)),profit_factor:parseFloat(b.toFixed(2)),sharpe_ratio:parseFloat(Y.toFixed(2)),expectancy:parseFloat(L.toFixed(2)),max_consecutive_wins:j,max_consecutive_losses:X,starting_balance:t.starting_balance,ending_balance:parseFloat(i.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:r,execution_time_ms:ce}}function Us(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Or=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Us,runBacktest:Ps},Symbol.toStringTag,{value:"Module"})),at=new he;at.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
...
📅 Backtest ID: ${o.meta.last_row_id}
        `.trim();d=await K({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},f)}}catch(c){console.error("[BACKTEST] Telegram send failed:",c)}return e.json({success:!0,backtest_id:o.meta.last_row_id,result:l,formatted:Us(l),telegram_sent:d})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});at.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
...
${d} @ $${c}
Stop: $${p}
TP1: $${m}`):await K(l,`❌ Error: ${u.error}`)}else if(r.startsWith("/close_trade")){const o=r.split(" ");if(o.length<4)return await K(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const d=parseInt(o[1]),c=parseFloat(o[2]),p=o[3],m=await Ns(d,c,p,t);if(m.success){const u=m.profit_loss||0,g=u>0?"💰":"❌";await K(l,`${g} *Trade #${d} Closed*

Exit: $${c}
P&L: ${u>0?"+":""}$${u.toFixed(2)}
Result: ${u>0?"WIN ✅":"LOSS ❌"}`)}else await K(l,`❌ Error: ${m.error}`)}else if(r==="/open"){const o=await Os(t);if(o.length===0)await K(l,"📊 No open positions");else{let d=`📊 *Open Positions (${o.length})*

`;for(const c of o)d+=`#${c.id}: ${c.trade_type} @ $${c.entry_price}
`,d+=`Stop: $${c.stop_loss}
`,d+=`TP1: $${c.take_profit_1}

`;await K(l,d)}}else if(r==="/stats"){const o=await Fs(t);let d=`📊 *Trading Statistics*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const js=new he;js.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const x of s.results||[])x.setting_key==="twelve_data_api_key"&&(n=x.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const x=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,A=await(await fetch(x)).json();A.values&&A.values.length>=50&&(a=A.values.reverse().map(Y=>({timestamp:Y.datetime,open:parseFloat(Y.open),high:parseFloat(Y.high),low:parseFloat(Y.low),close:parseFloat(Y.close),volume:parseFloat(Y.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const x=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!x.results||x.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=x.results.reverse().map(I=>({timestamp:I.timestamp,open:I.open,high:I.high,low:I.low,close:I.close,volume:I.volume||0}))}const r=_e(a);if(!r)return e.json({success:!1,error:"Failed to calculate indicators"},400);const i=a[a.length-1].close,l=ne(i,r,"day_trade");console.log("[AI-ANALYSIS] Current price:",i,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const x of["5m","15m","1h","4h","daily"]){const I=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();I&&(o[x]=I)}const d=jt(o,i),c=a.slice(-50),p=c.map(x=>x.high).sort((x,I)=>I-x),m=c.map(x=>x.low).sort((x,I)=>x-I),u=[Math.max(...p.slice(0,10))],g=[Math.min(...m.slice(0,10))];i>r.sma_20?g.push(r.sma_20):u.push(r.sma_20),i>r.sma_50?g.push(r.sma_50):u.push(r.sma_50),i>r.vwap?g.push(r.vwap):u.push(r.vwap);const f=Math.round(i/10)*10;f>i?u.push(f):g.push(f);const _=[...new Set(u)].sort((x,I)=>x-I).filter(x=>x>i).slice(0,3),y=[...new Set(g)].sort((x,I)=>I-x).filter(x=>x<i).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",_);const w=r.atr_14/i*100;let S="NORMAL";w>3?S="EXTREME":w>1.5?S="HIGH":w<.5&&(S="LOW");const b=[];let E=30,L=30,$=40;d.type==="ALL_BULLISH"?(E=60,L=20,$=20):d.type==="ALL_BEARISH"?(E=20,L=60,$=20):d.score>=4&&(d.trends.filter(x=>x.trend==="BULLISH").length>=4?(E=50,L=25,$=25):(E=25,L=50,$=25)),_.length>0&&b.push({name:"📈 BULLISH CONTINUATION",probability:E,description:`Price breaks above $${_[0].toFixed(2)} and rallies toward $${(_[_.length-1]||i*1.02).toFixed(2)}`,trigger:`Breakout above $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||i*1.02}),y.length>0&&b.push({name:"📉 BEARISH CORRECTION",probability:L,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||i*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||i*.98}),b.push({name:"↔️ CONTINUED RANGING",probability:$,description:`Price oscillates between $${(y[0]||i*.99).toFixed(2)} and $${(_[0]||i*1.01).toFixed(2)} with choppy action`,trigger:S==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),b.sort((x,I)=>I.probability-x.probability);let H={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?H={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${(i-5).toFixed(2)}-${i.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(H={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${i.toFixed(2)}-${(i+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):S==="EXTREME"?H.reason=`⚠️ EXTREME volatility (ADX ${r.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(d.type==="MIXED"||d.type==="CONFLICTING")&&(H.reason=`⏰ Timeframes conflicting (${d.score}/5 aligned). Wait for ${_[0]?`breakout above $${_[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let T=!1;try{const x=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),I={};for(const A of x.results||[])I[A.setting_key]=A.setting_value;if(I.telegram_bot_token&&I.telegram_chat_id){let A=`🤖 *AI MARKET ANALYSIS*
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
...
`,A+=`🟢 *Support:* ${y.map(Y=>`$${Y.toFixed(2)}`).join(", ")}

`,A+=`*Scenarios:*
`;for(const Y of b)A+=`${Y.name} (${Y.probability}%)
`;A+=`
💡 *Recommendation:* ${H.action==="WAIT"?"⏰":H.action==="BUY"?"📈":"📉"} ${H.action}
`,A+=`${H.reason}`,T=await K({botToken:I.telegram_bot_token,chatId:I.telegram_chat_id},A),console.log("[AI-ANALYSIS] Telegram sent:",T)}}catch(x){console.error("[AI-ANALYSIS] Telegram error:",x.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:i,signal:l.signal_type,confidence:l.confidence,volatility:S,mtf_alignment:{type:d.type,score:d.score,trends:d.trends},key_levels:{resistance:_,support:y},scenarios:b,recommendation:H,telegram_sent:T}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const U=new he;U.use("/api/*",Cn());U.route("/api/signals/enhanced",Ls);U.route("/api/signals/simple",Rs);U.route("/api/scanner",st);U.route("/api/trades",fe);U.route("/api/calendar",Me);U.route("/api/backtest",at);U.route("/api/telegram",Hs);U.route("/api/ai",js);U.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});U.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Gs),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});U.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    ...
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,o=await(await fetch(i)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=o.values.map(u=>({timestamp:u.datetime,open:parseFloat(u.open)||0,high:parseFloat(u.high)||0,low:parseFloat(u.low)||0,close:parseFloat(u.close)||0,volume:0})),p=c.map(u=>t.prepare(`
      ...
      `).bind(u.timestamp,u.open,u.high,u.low,u.close,u.volume));await t.batch(p);const m=c.length;if(c.length>=50){const u=_e(c.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const g=c[c.length-1].close,f=ne(g,u,"day_trade"),_=ne(g,u,"swing_trade"),y=70;for(const w of[f,_])if(w.confidence>=y&&w.signal_type!=="HOLD"){await t.prepare(`
              INSERT INTO signals 
              (timestamp, signal_type, trading_style, price, stop_loss, 
               take_profit_1, take_profit_2, take_profit_3, confidence, reason)
              VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `).bind(w.signal_type,w.trading_style,w.price,w.stop_loss,w.take_profit_1,w.take_profit_2,w.take_profit_3,w.confidence,w.reason).run();const S=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),b={};for(const E of S.results||[])b[E.setting_key]=E.setting_value;b.telegram_bot_token&&b.telegram_chat_id&&await K({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},ct(w))}}}return e.json({success:!0,count:m})}catch(s){return e.json({success:!1,error:s.message},500)}});U.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),n={};for(const T of s.results)n[T.setting_key]=T.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",r=n.telegram_bot_token,i=n.telegram_chat_id,d=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,p=await(await fetch(d)).json();if(p.code&&p.status==="error")return e.json({success:!1,error:p.message||"API error",telegram_sent:!1});if(!p.values||!Array.isArray(p.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const u=p.values.reverse().map(T=>({timestamp:T.datetime,open:parseFloat(T.open)||0,high:parseFloat(T.high)||0,low:parseFloat(T.low)||0,close:parseFloat(T.close)||0,volume:parseInt(T.volume||"0")||0})),g=u.map(T=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(T.timestamp,T.open,T.high,T.low,T.close,T.volume,"1h"));await t.batch(g);const f=_e(u);if(!f)return e.json({success:!0,count:u.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});const _=u[u.length-1].close,y=u[u.length-1].timestamp,S=(Date.now()-new Date(y).getTime())/(1e3*60*60);S>2&&console.warn(`[CRON] WARNING: Data is ${S.toFixed(1)} hours old! Latest: ${y}`);const b=ne(_,f,"day_trade"),E=ne(_,f,"swing_trade"),L=70;let $=!1;const H=[];if(r&&i&&r!=="your_bot_token_here"){if(b.confidence>=L&&b.signal_type!=="HOLD"){const T=b.signal_type==="BUY"?"🟢":"🔴",x=`${T} GOLD/USD ${b.signal_type} SIGNAL ${T}
...
🛡️ Stop Loss: $${b.stop_loss.toFixed(2)}

📝 Reason:
${b.reason}

⏰ ${new Date().toLocaleString()}`;await K({botToken:r,chatId:i},x)&&($=!0,H.push("Day Trade"))}if(E.confidence>=80&&E.signal_type!=="HOLD"){const T=E.signal_type==="BUY"?"🟢":"🔴",x=`${T} GOLD/USD ${E.signal_type} SIGNAL ${T}
...
⏰ ${new Date().toLocaleString()}`;await K({botToken:r,chatId:i},x)&&($=!0,H.push("Swing Trade"))}}return console.log(`[CRON] Processed ${u.length} candles, Telegram: ${$?"SENT":"NOT SENT"}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:u.length,latest_price:_,data_timestamp:u[u.length-1].timestamp},signals:{day_trade:{type:b.signal_type,confidence:b.confidence,price:_},swing_trade:{type:E.signal_type,confidence:E.confidence,price:_}},telegram:{configured:!!(r&&i),sent:$,alerts:H},message:$?`✅ Alerts sent: ${H.join(", ")}`:"⚪ No alerts (criteria not met or market in HOLD)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});U.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",r=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let i=0;const l={};for(const o of r){const d=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${o.interval}&apikey=${n}&outputsize=${o.outputsize}`,p=await(await fetch(d)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const m=p.values;let u=0;const g=[];for(const f of m.reverse()){const _={timestamp:f.datetime,open:parseFloat(f.open)||0,high:parseFloat(f.high)||0,low:parseFloat(f.low)||0,close:parseFloat(f.close)||0,volume:0};g.push(_),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(_.timestamp,_.open,_.high,_.low,_.close,_.volume,o.dbKey).run(),u++}if(g.length>=50){const f=_e(g);f&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,f.rsi_14,f.macd,f.macd_signal,f.macd_histogram,f.sma_20,f.sma_50,f.sma_200,f.ema_12,f.ema_26,f.bb_upper,f.bb_middle,f.bb_lower,f.atr_14,f.stochastic_k,f.stochastic_d,f.adx,f.plus_di,f.minus_di,f.ichimoku_tenkan,f.ichimoku_kijun,f.ichimoku_senkou_a,f.ichimoku_senkou_b,f.parabolic_sar,f.vwap,f.fib_382,f.fib_500,f.fib_618).run()}l[o.dbKey]={success:!0,count:u},i+=u,await new Promise(f=>setTimeout(f,500))}return e.json({success:!0,totalCount:i,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),a=_e(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const r=n[n.length-1].close,i=ne(r,a,"day_trade"),l=ne(r,a,"swing_trade");return e.json({success:!0,signals:{day_trade:i,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Ss),r=["5m","15m","1h","4h","daily"],i={};for(const L of r){const $=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(L).first();$&&(i[L]=$)}const l=Object.keys(i).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(i)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const d=o.close,c=s(i,d),p=i["1h"],m=ne(d,p,"day_trade"),u=ne(d,p,"swing_trade"),g=n(m.signal_type,c),f=n(u.signal_type,c),_={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:c.score,alignment_type:c.type,reason:`${m.reason}, MTF: ${g.reason}`},y={...u,base_confidence:u.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:c.score,alignment_type:c.type,reason:`${u.reason}, MTF: ${f.reason}`},w=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),S={};for(const L of w.results||[])S[L.setting_key]=L.setting_value;let b=!1,E=[];S.telegram_bot_token&&S.telegram_chat_id&&(_.isValid&&_.signal_type!=="HOLD"&&await K({botToken:S.telegram_bot_token,chatId:S.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${ct({..._,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(E.push("day_trade"),b=!0),await new Promise(L=>setTimeout(L,1e3)),y.isValid&&y.signal_type!=="HOLD"&&await K({botToken:S.telegram_bot_token,chatId:S.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${ct({...y,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(E.push("swing_trade"),b=!0));for(const L of[_,y])L.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(L.signal_type,L.trading_style,L.price,L.stop_loss,L.take_profit_1,L.take_profit_2,L.take_profit_3,L.base_confidence,L.mtf_confidence,L.final_confidence,L.alignment_score,L.alignment_type,L.reason,b?1:0).run();return e.json({success:!0,signals:{day_trade:_,swing_trade:y},alignment:c,alignment_report:a(c),telegram_sent:b,sent_to_telegram:E,available_timeframes:Object.keys(i)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});U.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('twelve_data_api_key')
    `).all();let n="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(n=g.setting_value);let a,r=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,_=await(await fetch(g)).json();_.values&&_.values.length>=50?(a=_.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open)||0,high:parseFloat(y.high)||0,low:parseFloat(y.low)||0,close:parseFloat(y.close)||0,volume:parseFloat(y.volume)||0})),r=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!a){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 200
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const g of c.results||[])p[g.setting_key]=g.setting_value;let m=!1,u=[];p.telegram_bot_token&&p.telegram_chat_id&&(await K({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},ct({...o,timestamp:new Date().toISOString()}))&&(u.push("day_trade"),m=!0),await new Promise(_=>setTimeout(_,1e3)),await K({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},ct({...d,timestamp:new Date().toISOString()}))&&(u.push("swing_trade"),m=!0));for(const g of[o,d])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(n).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const f=new Date().toISOString().split("T")[0],_=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,f).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>ht),w=y(g,_.results);if(w.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${w.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const S=c*r,b=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>ht),r=a(n.results);return e.json({success:!0,stats:r})}catch(n){return e.json({success:!1,error:n.message},500)}});U.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    ...
    `).first(),i=!n&&(r==null?void 0:r.count)>0;let l=0;if(i)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const j=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(m==null?void 0:m.close)||0,g=o(p,u),f=p["1h"],_=ne(u,f,"day_trade"),y=ne(u,f,"swing_trade"),w=d(_.signal_type,g),S=d(y.signal_type,g),b={..._,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:g.score,alignment_type:g.type},E={...y,final_confidence:Math.min(95,S.confidence),isValid:S.isValid,mtf_reason:S.reason,alignment_score:g.score,alignment_type:g.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:b,swingTrade:E,alignment:g},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const L=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),$=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:H}=await Promise.resolve().then(()=>ht),T=H(L,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},$.results),x=H(L,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},$.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:T,swingPosition:x},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const I=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),A={};for(const j of I.results||[])A[j.setting_key]=j.setting_value;let Y=!1;if(A.telegram_bot_token&&A.telegram_chat_id){const j=`
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();Y=await K({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},j)}if(a.steps[3].status=Y?"completed":"failed",a.steps[3].data={telegramSent:Y},b.isValid||E.isValid)for(const j of[b,E])j.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(j.signal_type,j.trading_style,j.price,j.stop_loss,j.take_profit_1,j.take_profit_2,j.take_profit_3,j.confidence,j.final_confidence,j.final_confidence,j.alignment_score,j.alignment_type,j.reason,Y?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:a,signals:{day_trade:b,swing_trade:E},positions:{day_trade:T,swing_trade:x},alignment:g,telegram_sent:Y})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});const es=new he,Cr=Object.assign({"/src/index.tsx":U});let Ws=!1;for(const[,e]of Object.entries(Cr))e&&(es.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),es.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Ws=!0);if(!Ws)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Br=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],Pr=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function Ys(e){const t=e.toLowerCase();let s=0,n=0;for(const l of Br)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of Pr)t.includes(l)&&(n+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(n+=1));const a=s+n;let r=0;a>0&&(r=(s-n)/a*100);let i="neutral";return r>20?i="bullish":r<-20&&(i="bearish"),{sentiment:i,score:r}}function Ur(e){let t=0,s=0,n=0,a=0;const r=e.map(o=>{const d=`${o.title} ${o.description||""}`,c=Ys(d);return c.sentiment==="bullish"?t++:c.sentiment==="bearish"?s++:n++,a+=c.score,{...o,sentiment:c.sentiment,score:c.score}}),i=e.length>0?a/e.length:0;let l="neutral";return i>20?l="bullish":i<-20&&(l="bearish"),{overall:l,score:Math.round(i),bullishCount:t,bearishCount:s,neutralCount:n,articles:r.slice(0,10)}}async function Hr(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,a=await(await fetch(s)).json();return a.status!=="ok"?(console.error("NewsAPI error:",a.message),[]):a.articles.map(r=>({title:r.title,description:r.description,url:r.url,publishedAt:r.publishedAt,source:r.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function jr(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(n=>{const a=new Date(n.date);return a>=e&&a<=t})}const Gs=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:Ur,analyzeSentiment:Ys,fetchGoldNews:Hr,getEconomicEvents:jr},Symbol.toStringTag,{value:"Module"}));export{es as default};
