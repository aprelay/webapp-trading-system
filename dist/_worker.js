...
`)}const es=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Jt,determineTrend:Vs,formatAlignmentReport:yn,validateMultiTimeframeSignal:Zt},Symbol.toStringTag,{value:"Module"}));function ls(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((o,i)=>o-i),a=Math.floor((1-t)*s.length);return Math.abs(s[a]||0)}function En(e,t){const s=ls(e,.95),a=ls(e,.99),n=t*s,o=t*a;return{var_95:parseFloat(n.toFixed(2)),var_99:parseFloat(o.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function bn(e,t,s,a){const n=t-e,o=n/t*100;let i=0;for(let d=a.length-1;d>=0&&a[d].balance<t;d--)i++;const l=o<=s,r=o>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(n.toFixed(2)),current_drawdown_pct:parseFloat(o.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:i}}function wn(e,t,s=5){let a=0;const n=[];for(const r of e){const c=Math.abs(r.entry_price-r.stop_loss)*r.position_size,u=c/t*100;a+=c,n.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(u.toFixed(2))})}const o=a/t*100,i=o<=s,l=t*(s/100)-a;return{total_open_positions:e.length,total_risk_amount:parseFloat(a.toFixed(2)),total_risk_pct:parseFloat(o.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:n}}function Tn(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),a=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&a.push({index:r,value:s[r]});if(a.length<3)return null;const n=a.slice(-3),[o,i,l]=n;if(i.value>o.value&&i.value>l.value&&Math.abs(o.value-l.value)/o.value<.02){const d=Math.min(o.value,l.value)*.995,c=d-(i.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function Sn(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),a=s.slice(0,10),n=s.slice(10);if((a[a.length-1]-a[0])/a[0]>.02&&(Math.max(...n)-Math.min(...n))/n[0]<.015){const r=s[s.length-1],d=a[a.length-1]-a[0],c=r+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function vn(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),a=t.map(d=>d.low),o=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=a.slice(0,6),l=a.slice(-6),r=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(o<.01&&r>.015){const d=Math.max(...s),c=t[t.length-1].close,u=d+(d-Math.min(...a));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function xn(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),a=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&a.push({index:r,value:s[r]});if(a.length<2)return null;const n=a.slice(-2),[o,i]=n;if(Math.abs(o.value-i.value)/o.value<.015){const r=Math.max(...s.slice(o.index,i.index))*1.005,d=r+(r-o.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:66}}return null}function kn(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),a=s[0],n=Math.min(...s.slice(10,25)),o=s[25];if(Math.abs(a-o)/a<.02&&n<a*.95){const l=s.slice(25),r=Math.min(...l),d=(o-r)/o;if(d>.01&&d<.05){const c=a-n,u=o+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function Rn(e){const t=[],s=Tn(e);s&&t.push(s);const a=Sn(e);a&&t.push(a);const n=vn(e);n&&t.push(n);const o=xn(e);o&&t.push(o);const i=kn(e);i&&t.push(i);let l=0,r=0,d=0;for(const m of t)m.direction==="bullish"?(l++,d+=m.confidence):m.direction==="bearish"&&(r++,d+=m.confidence);let c="neutral",u=0;l>r?(c="bullish",u=Math.min(d/l/10,15)):r>l&&(c="bearish",u=Math.min(d/r/10,15));let _="";if(t.length===0)_="No significant chart patterns detected";else{const m=t.map(p=>p.pattern_type).join(", ");_=`Detected ${t.length} pattern(s): ${m}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(u.toFixed(1)),summary:_}}function In(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Ln(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const n=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=n*10}const a=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(a*10,30),Math.min(Math.round(s),100)}function $n(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const a=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(a>.9||a<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function An(e,t,s){const a=In(t.atr_14,s),n=Ln(t,s),o=$n(t,s);let i,l,r,d,c,u;const _=e.slice(-10),m=_.map(h=>h.volume||0),p=m.reduce((h,y)=>h+y,0)/m.length,f=(_[_.length-1].volume||0)>p*1.5;return a==="EXTREME"&&f?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,r=!0,d="Trend-following (aggressive entry)",c=1.3,u="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,r=!1,d="Wait for stabilization",c=.5,u="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,r=!1,d="Wait for direction",c=.5,u="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&n>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,r=!0,d="Trend-following (buy dips, trail stops)",c=1.5,u="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,r=!1,d="Stay in cash or short",c=.3,u="Strong bearish trend - avoid long positions"):t.adx>20&&n>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,r=!0,d="Trend-following (selective entries)",c=1,u="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,r=!1,d="Reduce exposure or stay flat",c=.5,u="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,o>60?(r=!0,d="Mean-reversion (fade extremes)",c=.8,u="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,d="Wait for trend to develop",c=.5,u="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:a,trend_strength:n,mean_reversion_score:o,should_trade:r,recommended_strategy:d,risk_adjustment:c,description:u}}function Dn(e){const t=e.length;let s=0,a=0,n=0,o=0;for(let r=0;r<t;r++)s+=r,a+=e[r],n+=r*e[r],o+=r*r;const i=(t*n-s*a)/(t*o-s*s),l=(a-i*s)/t;return{slope:i,intercept:l}}function Mn(e,t,s){const a=e.map(l=>l.close),n=2/(t+1);let o=a[0];for(let l=1;l<a.length;l++)o=(a[l]-o)*n+o;const i=(a[a.length-1]-a[a.length-10])/10;return o+i*s}function Nn(e,t){const s=e.map(l=>l.close).slice(-20),a=[];for(let l=1;l<s.length;l++)a.push(s[l]-s[l-1]);const i=a.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function On(e,t,s){const a=e[e.length-1].close;e.map(i=>i.close).slice(-20);let n=0;t.rsi_14>50?n+=t.rsi_14-50:n-=50-t.rsi_14,t.macd>t.macd_signal?n+=20:n-=20,a>t.sma_20&&(n+=10),a>t.sma_50&&(n+=10);const o=n/100*s;return a+t.atr_14*o}function Cn(e,t){const s=e.map(_=>_.close),a=s[s.length-1],n=10,o=s.slice(-n),i=Math.min(...o),l=Math.max(...o),r=o.map(_=>(_-i)/(l-i));let d={index:0,similarity:-1/0};for(let _=n;_<s.length-n-t;_++){const m=s.slice(_-n,_),p=Math.min(...m),g=Math.max(...m),f=m.map(w=>(w-p)/(g-p));let h=0;for(let w=0;w<n;w++)h+=Math.pow(r[w]-f[w],2);const y=-h;y>d.similarity&&(d={index:_,similarity:y})}const u=(s[d.index+t]-s[d.index])*(a/s[d.index]);return a+u}function Vt(e,t,s){const a=[],n=[],o=e.map(b=>b.close),{slope:i,intercept:l}=Dn(o.slice(-20)),r=i*(o.length-1+s)+l;a.push(r),n.push(1);const d=Mn(e,12,s);a.push(d),n.push(1.5);const c=Nn(e,s);a.push(c),n.push(1.2);const u=On(e,t,s);a.push(u),n.push(1.8);const _=Cn(e,s);a.push(_),n.push(1.3);const m=n.reduce((b,k)=>b+k,0),g=a.reduce((b,k,v)=>b+k*n[v],0)/m,f=a.reduce((b,k)=>b+k,0)/a.length,h=a.reduce((b,k)=>b+Math.pow(k-f,2),0)/a.length,y=Math.sqrt(h),w=e[e.length-1].close,E=1-y/w,S=Math.max(50,Math.min(95,E*100));return{prediction:g,confidence:S}}function Fn(e,t){const s=e[e.length-1].close,a=[],n=Vt(e,t,1),o=n.prediction-s,i=o/s*100;a.push({timeframe:"1h",predicted_price:parseFloat(n.prediction.toFixed(2)),confidence_interval_upper:parseFloat((n.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((n.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(n.confidence.toFixed(1)),direction:o>.5?"UP":o<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Vt(e,t,4),r=l.prediction-s,d=r/s*100;a.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Vt(e,t,24),u=c.prediction-s,_=u/s*100;a.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:u>5?"UP":u<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(_.toFixed(2)),method:"Ensemble (5 models)"});const m=a.filter(y=>y.direction==="UP").length,p=a.filter(y=>y.direction==="DOWN").length;let g,f=0;m>p?(g="BULLISH",f=Math.min(m*5,15)):p>m?(g="BEARISH",f=Math.min(p*5,15)):g="NEUTRAL";const h=`ML models predict ${g} movement. 1h: ${a[0].direction} (${a[0].expected_move_pct.toFixed(2)}%), 4h: ${a[1].direction} (${a[1].expected_move_pct.toFixed(2)}%), 24h: ${a[2].direction} (${a[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:a,overall_direction:g,confidence_boost:parseFloat(f.toFixed(1)),summary:h}}function qt(e,t,s,a,n){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const r=(a-50)/10;l+=r;const d=(n-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function Un(e,t,s,a,n){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,n==="BUY"){const r=(a-50)/10;l-=r}else{const r=(a-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function Bn(e,t,s,a,n,o){const i=(s-e)*.5,l=(a-e)*.3,r=(n-e)*.2,d=t-e;return o.tp1/100*i+o.tp2/100*l+o.tp3/100*r+o.sl/100*d}function Hn(e,t,s){const a=e.price,n=t.atr_14;let o=50;e.signal_type==="BUY"?(a>t.sma_20&&(o+=10),a>t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(o+=10)):e.signal_type==="SELL"&&(a<t.sma_20&&(o+=10),a<t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(o+=10)),o=Math.min(100,o);const i=s.slice(-50),l=[];for(let w=14;w<i.length;w++){const E=i.slice(w-14,w);let S=0;for(let b=1;b<E.length;b++){const k=Math.max(E[b].high-E[b].low,Math.abs(E[b].high-E[b-1].close),Math.abs(E[b].low-E[b-1].close));S+=k}l.push(S/14)}const r=l.reduce((w,E)=>w+E,0)/l.length,d=n/r,c=qt(a,e.take_profit_1,n,o,d),u=qt(a,e.take_profit_2,n,o,d),_=qt(a,e.take_profit_3,n,o,d),m=Un(a,e.stop_loss,n,o,e.signal_type),p=Bn(a,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:u,tp3:_,sl:m}),f=(c+u+_)/3/m;let h;c>70&&p>5&&f>2?h="STRONG_TRADE":c>60&&p>0&&f>1.5?h="GOOD_TRADE":c>50&&p>-2?h="MARGINAL_TRADE":h="AVOID_TRADE";const y=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${p.toFixed(2)}. Risk-adjusted R:R: ${f.toFixed(2)}:1. Recommendation: ${h.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(u.toFixed(1)),tp3_probability:parseFloat(_.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(p.toFixed(2)),risk_reward_adjusted:parseFloat(f.toFixed(2)),recommendation:h,summary:y}}const ts=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Pn(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Ht(e=30){const t=[],s=new Date;for(const n of ts){const o=new Date(n),i=Math.floor((o.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:n,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:n,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let n=0;n<=e;n++){const o=new Date(s.getTime()+n*24*60*60*1e3),i=o.getFullYear(),l=o.getMonth(),r=o.getDate(),d=o.getDay();if(r===Pn(i,l)&&d===5){const c=o.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((n,o,i)=>o===i.findIndex(l=>l.date===n.date&&l.time===n.time&&l.title===n.title)).sort((n,o)=>{const i=new Date(`${n.date}T${n.time}:00Z`),l=new Date(`${o.date}T${o.time}:00Z`);return i.getTime()-l.getTime()})}function kt(e=new Date,t=[]){const s=[...Ht(7),...t],a=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),n=e.toISOString().split("T")[0];if(s.filter(i=>i.date===n&&i.impact==="high"),ts.includes(n))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:a,nextSafeTime:jn(n)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:a,nextSafeTime:void 0}}const o=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>o&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:a}}function jn(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Nt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let a="🔴";return e.impact==="medium"&&(a="🟡"),e.impact==="low"&&(a="🟢"),`${a} ${e.date} ${s} UTC - ${e.title}`}function Wn(e){const t=e.toISOString().split("T")[0];return ts.includes(t)?!0:Ht(30).filter(n=>n.date===t&&n.impact==="high").length>=2}function Yn(){const e=new Date().toISOString().split("T")[0];return Ht(7).filter(s=>s.date===e)}function qs(e=new Date){const t=kt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const zs=new _e;zs.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const a={},n={};for(const H of["5m","15m","1h","4h","daily"]){const C=await t.prepare(`
    ...
    `).first(),d=(r==null?void 0:r.setting_value)||"70140f57bea54c5e90768de696487d8f";try{console.log("[ENHANCED] Fetching real-time price...");const C=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${d}`,{signal:AbortSignal.timeout(5e3)})).json();if(C.price){const X=parseFloat(C.price),A=l,de=Math.abs(X-A)/X*100;console.log(`[ENHANCED] Real-time: $${X}, Last candle: $${A}, Diff: ${de.toFixed(2)}%`),de<2?(l=X,console.log(`[ENHANCED] ✅ Using real-time price: $${X}`)):console.log(`[ENHANCED] ⚠️ Price diff too large (${de.toFixed(2)}%), using candle close`)}}catch(H){console.log("[ENHANCED] Real-time price fetch failed, using candle close:",H.message)}if(i!=null&&i.timestamp){const H=new Date(i.timestamp).getTime(),C=(Date.now()-H)/(1e3*60);C>60&&o.push(`⚠️ WARNING: Price data is ${C.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${C.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const c=kt(),u=qs();let _=null,m=!1;c.riskLevel==="danger"?(m=!0,_=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",c.reason)):c.riskLevel==="caution"?(_=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",c.reason)):console.log("[ENHANCED] ✅ Calendar safe:",c.reason);const p=a["1h"];if(!p)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(a).join(", ")}`},400);const g=Jt(a,l),f=le(l,p,"day_trade"),h=le(l,p,"swing_trade"),y=Zt(f.signal_type,g),w=Zt(h.signal_type,g),E={...f,base_confidence:f.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:g.score,alignment_type:g.type},S={...h,base_confidence:h.confidence,mtf_confidence:w.confidence,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:g.score,alignment_type:g.type};let b=0,k="",v=[];if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20){try{const C=Rn(n["1h"]);v=(C==null?void 0:C.patterns)||[]}catch(C){console.error("[ENHANCED] Pattern detection error:",C.message)}const H=v.filter(C=>C.confidence>=70&&C.endIndex>=n["1h"].length-5);for(const C of H)C.type==="bullish"&&E.signal_type==="BUY"?(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `):C.type==="bearish"&&E.signal_type==="SELL"&&(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let $=0,R="",I=null;if(n["1h"]&&n["1h"].length>=50){const H=pe(n["1h"]);H&&(I=An(n["1h"],H),I.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?($=10,R="Strong Uptrend"):I.trend==="UPTREND"&&E.signal_type==="BUY"?($=5,R="Uptrend"):I.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?($=10,R="Strong Downtrend"):I.trend==="DOWNTREND"&&E.signal_type==="SELL"&&($=5,R="Downtrend"))}let U=0,j="",L=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{L=Fn(n["1h"],l),L.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(U=L.confidence_boost,j=`ML predicts +${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):L.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(U=L.confidence_boost,j=`ML predicts ${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(H){console.error("[ENHANCED] ML prediction error:",H.message)}let O=0,D="",B=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{const H=pe(n["1h"]);H&&(B=Hn(E,H,n["1h"]),B.tp1_probability>70?(O=10,D=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`):B.tp1_probability>60&&(O=5,D=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`))}catch(H){console.error("[ENHANCED] Probability of Profit error:",H.message)}let P=null,N=0,F=0;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20)try{P=Bt(n["1h"]),P.liquidity_score>=80?N=5:P.liquidity_score>=70?N=0:P.liquidity_score>=50?F=-5:F=-10,console.log(`[LIQUIDITY] Score: ${P.liquidity_score}/100, Session: ${P.session}, Adjust: ${N+F}%`)}catch(H){console.error("[ENHANCED] Liquidity Analysis error:",H.message)}let V=0,Q=0,ee=0,te=0,se="";try{const H=await t.prepare(`
...
`;const he=candles1h.slice(-20),de=he.map(J=>J.high).sort((J,Te)=>Te-J),ae=he.map(J=>J.low).sort((J,Te)=>J-Te),Rt=de.slice(0,3),_t=ae.slice(0,3);if(A+=`📊 *Key Levels:*
...
`,v+=`⏰ ${k}`,console.log("[SIMPLE] Sending Telegram message, length:",v.length),f=await q({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},v),console.log("[SIMPLE] Telegram sent:",f),f||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(h){console.error("[SIMPLE] Telegram error:",h.message)}try{await t.prepare(`
      ...
      `).bind(g.signal_type,"swing_trade",d,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.confidence,g.reason,f?1:0,g.liquidity_score||50,g.session||"UNKNOWN",g.time_zone||"MEDIUM",g.volume_trend||"STABLE",g.volume_percentile||50,g.estimated_spread_pips||40,g.price_impact_bps||10,g.market_depth_score||50,g.optimal_for_trading?1:0,g.liquidity_warnings||"[]",g.liquidity_recommendation||"No recommendation",g.position_size_multiplier||1).run(),console.log("[SIMPLE] Signals saved to database")}catch(h){console.error("[SIMPLE] Database save error:",h.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:d,telegram_sent:f,day_trade:{signal_type:p.signal_type,confidence:Number(p.confidence),price:Number(d),stop_loss:Number(p.stop_loss),take_profit_1:Number(p.take_profit_1),take_profit_2:Number(p.take_profit_2),take_profit_3:Number(p.take_profit_3),reason:String(p.reason),trading_style:"day_trade"},swing_trade:{signal_type:g.signal_type,confidence:Number(g.confidence),price:Number(d),stop_loss:Number(g.stop_loss),take_profit_1:Number(g.take_profit_1),take_profit_2:Number(g.take_profit_2),take_profit_3:Number(g.take_profit_3),reason:String(g.reason),trading_style:"swing_trade"}})}catch(i){return console.error("[SIMPLE] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function Gn(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Vn(e=new Date){const t=e.getUTCDay(),a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${a} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${a} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${a} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${a} (market closed)`}:{hasBoost:!1,boost:0,reason:`${a} (standard day)`}}function qn(e,t){return e>t*1.1}function zn(e){let t=0,s=0,a=0;for(const l of e){const r=l.volume||0;a+=r,l.close>l.open?t+=r:l.close<l.open&&(s+=r)}const n=s>0?t/s:t>0?10:1;let o="NEUTRAL";n>1.5?o="BUYING":n<.67&&(o="SELLING");let i=0;return n>3?i=100:n>1.5?i=50+(n-1.5)/1.5*50:n>.67?i=(n-.67)/.83*50:n>.33?i=50+(.67-n)/.34*50:i=100,{uptickVolume:t,downtickVolume:s,totalVolume:a,pressureRatio:n,signal:o,strength:Math.round(i)}}function Ks(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Xn(e,t){const a=Ks(e,t)?"✅":"❌";return e.signal==="BUYING"?`${a} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${a} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${a} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Kn(e){if(e.length<3)return[];const t=[],s=e[e.length-3],a=e[e.length-2],n=e[e.length-1];return Zn(n)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Qn(n)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Jn(a,n)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),eo(a,n)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),to(s,a,n)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),so(s,a,n)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),ao(s,a,n)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),no(s,a,n)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),oo(n)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),io(n)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Zn(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>=t*2&&a<=t*.1&&t>0}function Qn(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Jn(e,t){const s=e.close<e.open,a=t.close>t.open;return s&&a&&t.open<e.close&&t.close>e.open}function eo(e,t){const s=e.close>e.open,a=t.close<t.open;return s&&a&&t.open>e.close&&t.close<e.open}function to(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close<e.open,l=s.close>s.open;return i&&n<a*.5&&l&&o>a*.6&&s.close>(e.open+e.close)/2}function so(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close>e.open,l=s.close<s.open;return i&&n<a*.5&&l&&o>a*.6&&s.close<(e.open+e.close)/2}function ao(e,t,s){const a=e.close>e.open&&t.close>t.open&&s.close>s.open,n=t.high>e.high&&s.high>t.high,o=t.low>e.low&&s.low>t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&o&&i>d&&l>d&&r>d}function no(e,t,s){const a=e.close<e.open&&t.close<t.open&&s.close<s.open,n=t.high<e.high&&s.high<t.high,o=t.low<e.low&&s.low<t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&o&&i>d&&l>d&&r>d}function oo(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function io(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,a=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&a>t*.5&&n>t*.5}function ro(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const a of e)a.strength>s.strength&&(s=a);if(t==="BUY"){const a=e.some(n=>n.type==="BULLISH_REVERSAL"||n.type==="BULLISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}if(t==="SELL"){const a=e.some(n=>n.type==="BEARISH_REVERSAL"||n.type==="BEARISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}return{aligned:!1,strongestPattern:null}}function lo(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const c=e.slice(-288),u=Math.max(...c.map(m=>m.high)),_=Math.min(...c.map(m=>m.low));s.push({level:u,type:"RESISTANCE",strength:85,distance:u-t,distancePercent:(u-t)/t*100}),s.push({level:_,type:"SUPPORT",strength:85,distance:t-_,distancePercent:(t-_)/t*100})}const a=e.slice(-50),n=cs(a,"HIGH"),o=cs(a,"LOW");if(n.forEach(c=>{s.push({level:c,type:"RESISTANCE",strength:75,distance:c-t,distancePercent:(c-t)/t*100})}),o.forEach(c=>{s.push({level:c,type:"SUPPORT",strength:75,distance:t-c,distancePercent:(t-c)/t*100})}),co(t).forEach(c=>{const u=c>t?"RESISTANCE":"SUPPORT";s.push({level:c,type:u,strength:70,distance:Math.abs(c-t),distancePercent:Math.abs(c-t)/t*100})}),e.length>=288){const c=e.slice(-288),u=mo(c);s.push({level:u.pp,type:"PIVOT",strength:80,distance:Math.abs(u.pp-t),distancePercent:Math.abs(u.pp-t)/t*100}),s.push({level:u.r1,type:"RESISTANCE",strength:70,distance:u.r1-t,distancePercent:(u.r1-t)/t*100}),s.push({level:u.s1,type:"SUPPORT",strength:70,distance:t-u.s1,distancePercent:(t-u.s1)/t*100})}const l=s.filter(c=>Math.abs(c.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const r=l.reduce((c,u)=>Math.abs(u.distancePercent)<Math.abs(c.distancePercent)?u:c),d=po(e,t,r);return{nearZone:!0,closestZone:r,zoneType:r.type,action:d,strength:r.strength,description:uo(r,d)}}function cs(e,t){const s=[];for(let o=5;o<e.length-5;o++){const i=t==="HIGH"?e[o].high:e[o].low;let l=!0;for(let r=o-5;r<=o+5;r++){if(r===o)continue;const d=t==="HIGH"?e[r].high:e[r].low;if(t==="HIGH"&&d>=i){l=!1;break}if(t==="LOW"&&d<=i){l=!1;break}}l&&s.push(i)}return Array.from(new Set(s)).slice(-3)}function co(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const a=Math.floor(e/50)*50;return t.includes(a)||t.push(a),t.includes(a+50)||t.push(a+50),t.filter(n=>Math.abs((n-e)/e)*100<=2)}function mo(e){const t=Math.max(...e.map(d=>d.high)),s=Math.min(...e.map(d=>d.low)),a=e[e.length-1].close,n=(t+s+a)/3,o=2*n-s,i=2*n-t,l=n+(t-s),r=n-(t-s);return{pp:n,r1:o,s1:i,r2:l,s2:r}}function po(e,t,s){if(e.length<3)return"NONE";const a=e.slice(-3),n=a[1];if(a[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&n.close<=s.level)return"BREAKOUT";if(t<s.level&&n.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&n.close>=s.level)return"BREAKOUT";if(t>s.level&&n.close<=s.level)return"BOUNCE"}return"NONE"}function uo(e,t){const s=e.level.toFixed(2),a=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${a}% away)`}function _o(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function go(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),a=t.slice(-10),n=fo(a);if(n.highs.length<2&&n.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const o=ho(s,n),i=yo(s,n);return o.type!=="NONE"&&i.type===o.type?{type:o.type,category:o.category,indicator:"BOTH",strength:95,description:`${o.type} ${o.category} (RSI+MACD)`,confidence:90}:o.type!=="NONE"?{type:o.type,category:o.category,indicator:"RSI",strength:80,description:`${o.type} ${o.category} (RSI)`,confidence:75}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"MACD",strength:70,description:`${i.type} ${i.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function fo(e){const t=[],s=[];for(let n=2;n<e.length-2;n++){const o=e[n];let i=!0;for(let r=n-2;r<=n+2;r++)if(r!==n&&e[r].high>=o.high){i=!1;break}i&&t.push({index:n,price:o.high});let l=!0;for(let r=n-2;r<=n+2;r++)if(r!==n&&e[r].low<=o.low){l=!1;break}l&&s.push({index:n,price:o.low})}return{highs:t,lows:s}}function ho(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[a,n]=s,o=e[a.index].rsi,i=e[n.index].rsi;if(n.price<a.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(n.price>a.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[a,n]=s,o=e[a.index].rsi,i=e[n.index].rsi;if(n.price>a.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(n.price<a.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function yo(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[a,n]=s,o=e[a.index].macd_histogram,i=e[n.index].macd_histogram;if(n.price<a.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(n.price>a.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[a,n]=s,o=e[a.index].macd_histogram,i=e[n.index].macd_histogram;if(n.price>a.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(n.price<a.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function Eo(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function bo(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",a=e.type,n=e.category,o=e.indicator;return`${s} Layer 14: ${a} ${n} divergence (${o}, ${e.strength}/100)`}function wo(e,t,s,a){const n=(f,h)=>{const y=parseFloat(String(f));return isNaN(y)?h:y},o=n(e.ema_12,a),i=n(t.ema_26,a),l=n(s.sma_200,a),r=zt(a,o),d=zt(a,i),c=zt(a,l),u=r===d&&d===c&&r!=="NEUTRAL",_=r===d&&r!=="NEUTRAL"||r===c&&r!=="NEUTRAL"||d===c&&d!=="NEUTRAL";let m=0,p="",g="";return u?(m=100,p=`ALL ${r}`,g=`All 3 timeframes ${r.toLowerCase()} (perfect alignment)`):_?(m=65,r===d?(p=`5M+15M ${r}`,g=`5m & 15m ${r.toLowerCase()} (1h ${c.toLowerCase()})`):r===c?(p=`5M+1H ${r}`,g=`5m & 1h ${r.toLowerCase()} (15m ${d.toLowerCase()})`):(p=`15M+1H ${d}`,g=`15m & 1h ${d.toLowerCase()} (5m ${r.toLowerCase()})`)):(m=30,p="MIXED",g=`Mixed signals: 5m ${r.toLowerCase()}, 15m ${d.toLowerCase()}, 1h ${c.toLowerCase()}`),{tf5m:r,tf15m:d,tf1h:c,allAligned:u,twoAligned:_,alignment:p,strength:m,description:g}}function zt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function To(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function So(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function vo(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],a=e[0],n=s.close,o=(s.close-a.close)/a.close*100;let i="FLAT";o>.1?i="UP":o<-.1&&(i="DOWN");let l="NEUTRAL";i==="DOWN"?l="BULLISH":i==="UP"&&(l="BEARISH");const r=Math.abs(o);let d=-.8,c=0;r>.3?c=90:r>.2?c=75:r>.1?c=60:c=40;const u=new Date(s.timestamp),m=Math.floor((new Date().getTime()-u.getTime())/6e4),p=ko(n,o,i,l,c);return{dxyPrice:n,dxyChange:o,dxyTrend:i,goldSignalSupport:l,correlation:d,strength:c,description:p,dataAge:m}}function xo(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function ko(e,t,s,a,n){const o=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${o} → Gold BULLISH (${n}/100)`:s==="UP"?`DXY up ${o} → Gold BEARISH (${n}/100)`:`DXY flat ${o} → Neutral (${n}/100)`}async function Ro(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[DXY] No data returned from API"),[]):a.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function Io(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function Lo(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function $o(e,t,s=15){const a=await Lo(e);if(a.length>0){const o=new Date(a[a.length-1].timestamp),l=(new Date().getTime()-o.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),a}console.log("[DXY] Fetching fresh DXY data from API...");const n=await Ro(t);return n.length>0?(await Io(e,n),n):(console.log("[DXY] Fetch failed, using stale cache"),a)}function Ao(e,t,s){const a=ds("Silver (XAG/USD)",e),n=ds("Crude Oil (WTI)",t);let o=0;a&&Ct(a.trend,s)&&o++,n&&Ct(n.trend,s)&&o++;let i=0;const l=o>=1;o===2?i=95:o===1?i=70:i=30;const r=Do(a,n,o,s);return{silver:a,oil:n,aligned:l,alignmentCount:o,strength:i,description:r}}function ds(e,t){if(t.length<2)return null;const s=t[t.length-1],a=t[0],n=s.close,o=(s.close-a.close)/a.close*100;let i="FLAT";o>.2?i="UP":o<-.2&&(i="DOWN");const l=Math.abs(o);let r=0;return l>1?r=90:l>.5?r=75:l>.2?r=60:r=40,{symbol:e,price:n,change:o,trend:i,strength:r}}function Ct(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function Do(e,t,s,a){if(s===2)return`Silver & Oil both ${a==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&Ct(e.trend,a))return`Silver ${e.trend.toLowerCase()} confirms Gold ${a}`;if(t&&Ct(t.trend,a))return`Oil ${t.trend.toLowerCase()} confirms Gold ${a}`}const n=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",o=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${n}, ${o} (mixed signals)`}async function Mo(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[SILVER] No data returned from API"),[]):a.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function No(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,a=await(await fetch(t)).json();return!a.values||a.values.length===0?(console.error("[OIL] No data returned from API"),[]):a.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function Oo(e,t,s){try{const a=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const n of s)await e.prepare(`
      ...
      DELETE FROM ${a}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(a){console.error(`[${t}] Error storing data:`,a.message)}}async function Co(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",a=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!a.results||a.results.length===0?[]:a.results.map(n=>({close:n.close,timestamp:n.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function ms(e,t,s,a=15){const n=await Co(e,s);if(n.length>0){const i=new Date(n[n.length-1].timestamp),r=(new Date().getTime()-i.getTime())/6e4;if(r<a)return console.log(`[${s}] Using cached data (${r.toFixed(1)}min old)`),n}console.log(`[${s}] Fetching fresh data from API...`);const o=s==="SILVER"?await Mo(t):await No(t);return o.length>0?(await Oo(e,s,o),o):(console.log(`[${s}] Fetch failed, using stale cache`),n)}function Fo(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),n=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let o="NEUTRAL",i="NEUTRAL",l=50;const r=e.percentile;if(r>=90?(o="EXTREME_BULLISH",i="BULLISH",l=95):r>=70?(o="BULLISH",i="BULLISH",l=80):r<=30?(o="BEARISH",i="BEARISH",l=80):r<=10?(o="EXTREME_BEARISH",i="BEARISH",l=95):(o="NEUTRAL",i="NEUTRAL",l=50),e.largeSpecNet>0){const c=Uo(e.largeSpecNet);c>=95?i==="BEARISH"?l+=10:i==="BULLISH"&&(l-=15):c<=5&&(i==="BULLISH"?l+=10:i==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const d=Ho(o,r,n);return{currentPosition:e,positioning:o,goldSignalSupport:i,strength:l,description:d,dataAge:n}}function Uo(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function Bo(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Ho(e,t,s){const a=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${a}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${a}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${a}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${a}]`:`COT: Neutral positioning (${t}th percentile) [${a}]`}async function Po(){return null}async function jo(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function Wo(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function Yo(e){const t=await Wo(e);if(t){const a=new Date(t.timestamp),o=(new Date().getTime()-a.getTime())/(1e3*60*60*24);if(o<7)return console.log(`[COT] Using cached data (${o.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await Po();return s?(await jo(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Go(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const ct=new _e;ct.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const a=s.toISOString();console.log("[5M-SCANNER] Starting scan at",a),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});ct.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),a={};for(const d of s.results||[])a[d.setting_key]=d.setting_value;if(!a.telegram_bot_token||!a.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const n=4386.5,o=15,i={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:n-o,tp1:n+o*2,tp2:n+o*3,tp3:n+o*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Qs(i,n),r=await q({botToken:a.telegram_bot_token,chatId:a.telegram_chat_id},l);return e.json({success:r,message:r?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Zs(e,t,s,a,n,o){console.log("[ANALYZE] Starting analysis");let i=0,l=0;const r=[],d=(ne,Ke)=>{const Lt=parseFloat(String(ne));return isNaN(Lt)?Ke:Lt};console.log("[ANALYZE] parseNum defined");const c={ema20:d(t.ema_12,o),rsi:d(t.rsi_14,50),macd:d(t.macd,0),macd_signal:d(t.macd_signal,0),macd_histogram:d(t.macd_histogram,0),adx:d(t.adx,25)},u={ema50:d(s.ema_26,o)},_={sma200:d(a.sma_200,o)},m=o>c.ema20&&o>u.ema50&&o>_.sma200,p=o<c.ema20&&o<u.ema50&&o<_.sma200;m||p?(i+=20,l++,r.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):r.push("❌ Layer 1: Trend NOT aligned (conflicting)");const g=c.rsi>=40&&c.rsi<=60,f=c.macd>c.macd_signal&&c.macd_histogram>0,h=c.macd<c.macd_signal&&c.macd_histogram<0;g&&(m?f:h)?(i+=15,l++,r.push(`✅ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):r.push(`❌ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${g?"no crossover":"extreme"}`);const y=n.slice(-20).reduce((ne,Ke)=>ne+Ke.volume,0)/20,w=n[n.length-1].volume;w>y*1.5?(i+=15,l++,r.push(`✅ Layer 3: Volume spike ${(w/y).toFixed(1)}x average`)):r.push(`❌ Layer 3: Volume ${(w/y).toFixed(1)}x (need 1.5x+)`);const S=Math.max(...n.slice(-20).map(ne=>ne.high)),b=Math.min(...n.slice(-20).map(ne=>ne.low)),k=o>S*.999,v=o<b*1.001;m&&k||p&&v?(i+=15,l++,r.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):r.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let $=null;try{$=await Bt(n),console.log("[ANALYZE] Liquidity calculated successfully")}catch(ne){console.log("[5M-SCANNER] Liquidity calc failed:",ne)}const R=($==null?void 0:$.liquidity_score)||50,I=($==null?void 0:$.session)||"UNKNOWN";R>=70?(i+=15,l++,r.push(`✅ Layer 5: Liquidity ${R}/100 (${I} session)`)):r.push(`❌ Layer 5: Liquidity ${R}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const j=kt();console.log("[ANALYZE] Calendar check complete"),j.riskLevel==="safe"?(i+=10,l++,r.push("✅ Layer 6: No major news")):r.push(`❌ Layer 6: ${j.reason}`);const O=c.adx>25,D=c.adx>70;O&&!D?(i+=10,l++,r.push(`✅ Layer 7: ADX ${c.adx.toFixed(1)} (strong trend)`)):D?r.push(`⚠️ Layer 7: ADX ${c.adx.toFixed(1)} (extreme, reversal risk)`):r.push(`❌ Layer 7: ADX ${c.adx.toFixed(1)} (weak trend)`);let B="HOLD";(m||p)&&l>=5&&(B=m?"BUY":"SELL");const P=new Date,N=Gn(P);N.hasBoost?(i+=8,l++,r.push(`✅ Layer 8: ${N.reason} (+${N.boost}% win)`)):r.push(`ℹ️ Layer 8: ${N.reason}`);const F=Vn(P);F.hasBoost?(i+=5,l++,r.push(`✅ Layer 9: ${F.reason} (+${F.boost}% win)`)):r.push(`ℹ️ Layer 9: ${F.reason}`);const V=d(t.atr_14,o*.01),Q=n.slice(-20).reduce((ne,Ke)=>{const Lt=Ke.high-Ke.low;return ne+Lt},0)/20;if(qn(V,Q)){i+=7,l++;const ne=((V/Q-1)*100).toFixed(1);r.push(`✅ Layer 10: ATR expanding ${ne}% (high volatility)`)}else{const ne=((1-V/Q)*100).toFixed(1);r.push(`❌ Layer 10: ATR compressed ${ne}% (skip low volatility)`)}const te=zn(n.slice(-20));Ks(te,B)&&te.strength>=60&&(i+=10,l++),r.push(Xn(te,B));const x=Kn(n.slice(-3)),{aligned:M,strongestPattern:ue}=ro(x,B);M&&ue?(i+=12,l++,r.push(`✅ Layer 12: ${ue.name} (${ue.strength}/100)`)):x.length>0&&x[0].type==="INDECISION"?r.push(`⚠️ Layer 12: ${x[0].name} (indecision, wait)`):r.push("❌ Layer 12: No clear candlestick pattern");const fe=lo(n,o);_o(fe,B)&&fe.nearZone?(i+=8,l++,r.push(`✅ Layer 13: ${fe.description}`)):fe.nearZone?r.push(`⚠️ Layer 13: ${fe.description} (not aligned)`):r.push("ℹ️ Layer 13: No key zones nearby");const X=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(ne=>({rsi:parseFloat(String(ne.rsi))||50,macd:parseFloat(String(ne.macd))||0,macd_histogram:parseFloat(String(ne.macd_histogram))||0})).reverse(),A=go(X,n.slice(-10)),de=Eo(A,B,m?"BULLISH":p?"BEARISH":"NEUTRAL");de&&A.strength>=70&&(i+=9,l++),r.push(bo(A,de));const ae=wo(t,s,a,o),Rt=To(ae,B);Rt&&(ae.allAligned||ae.twoAligned)&&(i+=6,l++),r.push(So(ae,Rt));const _t=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),gt=(_t==null?void 0:_t.setting_value)||"70140f57bea54c5e90768de696487d8f",K=await $o(e,gt,15),Be=vo(K);xo(Be,B)&&Be.strength>=60?(i+=5,l++,r.push(`✅ Layer 18: ${Be.description}`)):Be.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 18: ${Be.description} (not aligned)`):r.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Te=await ms(e,gt,"SILVER",15),Ea=await ms(e,gt,"OIL",15),Xe=Ao(Te,Ea,B);if(Xe.aligned&&Xe.alignmentCount>=1){const ne=Xe.alignmentCount===2?5:3;i+=ne,l++,r.push(`✅ Layer 19: ${Xe.description} (${Xe.strength}/100)`)}else r.push(`❌ Layer 19: ${Xe.description}`);const ba=await Yo(e)||Go(),Ie=Fo(ba);if(Bo(Ie,B)&&Ie.strength>=70){const ne=Ie.positioning.includes("EXTREME")?7:4;i+=ne,l++,r.push(`✅ Layer 20: ${Ie.description} (${Ie.strength}/100)`)}else Ie.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 20: ${Ie.description} (not aligned)`):r.push(`ℹ️ Layer 20: ${Ie.description}`);let It="C";i>=162?It="A+":i>=144?It="A":i>=126&&(It="B"),(m||p)&&l>=7&&(B=m?"BUY":"SELL");const Le=Math.max(V*1.5,o*.003),wa=B==="BUY"?o-Le:o+Le,Ta=B==="BUY"?o+Le*2:o-Le*2,Sa=B==="BUY"?o+Le*3:o-Le*3,va=B==="BUY"?o+Le*4:o-Le*4;return{grade:It,score:i,signal:B,confidence:i,layersPassed:l,layers:r,stopLoss:wa,tp1:Ta,tp2:Sa,tp3:va,liquidityScore:R,session:I,adx:c.adx,rsi:c.rsi,volumeRatio:w/y}}function Qs(e,t){const s=e.signal==="BUY"?"🟢":"🔴",a=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",n=new Date,o=`${n.getUTCHours().toString().padStart(2,"0")}:${n.getUTCMinutes().toString().padStart(2,"0")}`;let i=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,i+="Next scan in 5 minutes...",i}async function dt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,i,l,r,e).run();const c=(await dt(a)).current_balance+i;return await a.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(c).run(),await sa(a),await qo(a),await zo(a),{success:!0,profit_loss:i}}catch(n){return{success:!1,error:n.message}}}async function sa(e){const t=await dt(e),s=await e.prepare(`
  ...
  `).all();let a=0;for(const o of s.results||[]){const i=o,r=Math.abs(i.entry_price-i.stop_loss)*i.position_size;a+=r}const n=a/t.current_balance*100;await e.prepare(`
    ...
    SET current_portfolio_risk = ?,
        updated_at = CURRENT_TIMESTAMP
    WHERE id = 1
  `).bind(n).run()}async function qo(e){const t=new Date().toISOString().split("T")[0],s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const a=s.results,n=a.length,o=a.filter(m=>m.win===1).length,i=a.filter(m=>m.win===0).length,l=o/n*100,r=a.reduce((m,p)=>m+(p.profit_loss||0),0),d=Math.max(...a.map(m=>m.profit_loss||0)),c=Math.min(...a.map(m=>m.profit_loss||0)),u=a.reduce((m,p)=>m+(p.confidence||0),0)/n,_=a.reduce((m,p)=>m+(p.mtf_score||0),0)/n;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,n,o,i,l,r,d,c,u,_).run()}async function zo(e){const t=await dt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,a=new Date().toISOString().split("T")[0],n=await e.prepare(`
...
`,D+=`🛡️ *Stop:* $${v.stop_loss}`),await q({botToken:I.telegram_bot_token,chatId:I.telegram_chat_id},D)},300*1e3))}}catch(R){console.error("[AI-ANALYSIS] Telegram error:",R.message)}else console.log("[AI-ANALYSIS] No Telegram alert - Confidence:",l.confidence,"Signal:",l.signal_type);return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:i,signal:l.signal_type,confidence:l.confidence,volatility:w,mtf_alignment:{type:d.type,score:d.score,trends:d.trends},key_levels:{resistance:f,support:h},scenarios:E,recommendation:v,telegram_sent:$}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}}const Ue=new _e;async function Jo(e){try{return await e.prepare("SELECT 1 FROM monitoring_config LIMIT 1").first(),!0}catch{return!1}}async function ma(e){try{const t=await e.prepare(`
    ...
    `).all(),s={};for(const a of t.results||[])s[a.config_key]=a.config_value;return s}catch{return{data_stale_threshold_minutes:"30",endpoint_timeout_ms:"30000",slow_response_threshold_ms:"5000",max_failure_count:"3",monitoring_interval_minutes:"5",telegram_alerts_enabled:"1",auto_recovery_enabled:"1"}}}async function ei(e,t,s,a){const n=Date.now();try{const o=a+s,i=new AbortController,l=setTimeout(()=>i.abort(),3e4),r=await fetch(o,{signal:i.signal,method:s.includes("fetch-mtf")||s.includes("analyze-and-notify")?"POST":"GET"});clearTimeout(l);const d=Date.now()-n;if(!r.ok)return{status:"degraded",responseTime:d,error:`HTTP ${r.status}`};try{const c=await r.json();if(c.success===!1)return{status:"degraded",responseTime:d,error:c.error||"API returned success: false"}}catch{}return{status:"healthy",responseTime:d}}catch(o){return{status:"down",responseTime:Date.now()-n,error:o.message||"Unknown error"}}}async function ti(e,t){const s=parseInt(t.data_stale_threshold_minutes||"30"),a=[],n=await e.prepare(`
...
⏰ ${new Date().toUTCString()}`;return await q(u,l,r),!0}}return!1}catch(i){return console.error("[MONITORING] Failed to send alert:",i),!1}}Ue.get("/health-check",async e=>{const{DB:t}=e.env;try{const s=await ma(t),a=e.req.url.replace("/api/monitoring/health-check",""),n=new Date().toISOString(),o=await Jo(t);console.log("[MONITORING] Starting comprehensive health check..."),console.log("[MONITORING] Tables exist:",o);const i=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}],l=[],r=s.telegram_alerts_enabled==="1",d=parseInt(s.slow_response_threshold_ms||"5000"),c=parseInt(s.max_failure_count||"3");console.log("[MONITORING] Fast mode: Checking 5 endpoints (MTF skipped)");for(const h of i){const y=await ei(t,h.name,h.url,a);let w=0,E="unknown",S=y.status==="down"?1:0;if(o)try{const b=await t.prepare(`
...
`,h+=`Signal #${l} | ${f}`,h}ut.get("/scan",async e=>{var a;const{DB:t}=e.env,s={success:!1,message:"",data:{}};try{console.log("[MICRO] Starting 5-minute scan...");const n=await ri(t);if(!n.allowed)return console.log("[MICRO] Daily limit check failed:",n.reason),s.message=n.reason,s.data={signals_sent_today:n.signals_sent_today,max_signals:n.max_signals},e.json(s);console.log(`[MICRO] Daily limit check passed: ${n.signals_sent_today}/${n.max_signals} signals sent`);const o=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = '5m'
      ORDER BY timestamp DESC 
    ...
    `).all();if(!o.results||o.results.length<20)return s.message="Insufficient 5m candle data",e.json(s);const i=o.results.map(b=>({timestamp:b.timestamp,open:b.open,high:b.high,low:b.low,close:b.close,volume:b.volume||1})).reverse(),l=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 60
    `).all();if(!l.results||l.results.length<50)return s.message=`Insufficient 15m candle data (have ${((a=l.results)==null?void 0:a.length)||0}, need 50)`,e.json(s);const r=l.results.map(b=>({timestamp:b.timestamp,open:b.open,high:b.high,low:b.low,close:b.close,volume:b.volume||1})).reverse(),d=pe(i),c=pe(r);if(!d)return console.error("[MICRO] Failed to calculate 5m indicators - data length:",i.length),s.message="Failed to calculate 5m indicators",s.data={candles5m_count:i.length,first_candle:i[0],last_candle:i[i.length-1]},e.json(s);if(!c)return console.error("[MICRO] Failed to calculate 15m indicators - data length:",r.length),s.message="Failed to calculate 15m indicators",s.data={candles15m_count:r.length},e.json(s);const u=i[i.length-1].close,_=pa(i,d,r,c);if(!_)return console.log("[MICRO] No valid setup detected"),s.success=!0,s.message="No signal - waiting for setup",s.data={currentPrice:u},e.json(s);if(console.log(`[MICRO] Signal detected: ${_.signal_type} ${_.setup_type} (${_.confidence}%)`),_.confidence<60)return console.log(`[MICRO] Confidence too low: ${_.confidence}%`),s.success=!0,s.message=`Signal below threshold (${_.confidence}% < 60%)`,s.data={signal:_},e.json(s);const m=Bt(i);if(m.liquidity_score<60)return console.log(`[MICRO] Liquidity too low: ${m.liquidity_score}`),s.success=!0,s.message=`Low liquidity (${m.liquidity_score} < 60)`,s.data={signal:_,liquidity:m},e.json(s);const p=li(_,m.liquidity_score,m.optimal_for_trading),g=new Date(Date.now()+900*1e3).toISOString(),f=new Date().toISOString().split("T")[0],h=await t.prepare(`
    ...
    `).bind(_.signal_type,_.price,_.stop_loss,_.take_profit_1,_.take_profit_2,_.take_profit_3,_.confidence,_.setup_type,_.trend_5m,_.trend_15m,_.indicators_5m.rsi,_.indicators_5m.macd,_.indicators_5m.macd_signal,_.indicators_5m.macd_histogram,_.indicators_5m.adx,_.indicators_5m.stochastic_k,_.indicators_5m.stochastic_d,_.indicators_5m.ema_20,_.indicators_5m.volume,m.liquidity_score,m.session,m.time_zone,m.volume_trend,m.volume_percentile,m.estimated_spread_pips,m.price_impact_bps,m.market_depth_score,m.optimal_for_trading?1:0,p.multiplier,p.lots,p.risk_amount,p.risk_percent,g,_.reason).run(),console.log("[MICRO] Signal saved to database");const w=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),E={};for(const b of w.results||[])E[b.setting_key]=b.setting_value;let S=!1;if(E.telegram_bot_token&&E.telegram_chat_id){const b=ua(_,m.liquidity_score,m.session,m.volume_trend,m.volume_percentile,m.estimated_spread_pips,p,y);S=await q({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},b),S&&(await t.prepare(`
...
📅 Real signals will start appearing when market opens Monday.`;return await q({botToken:a.telegram_bot_token,chatId:a.telegram_chat_id},r)?e.json({success:!0,message:"Test alert sent to Telegram successfully!",preview:r,telegram_config:{hasToken:!0,hasChat:!0,chatId:a.telegram_chat_id}}):e.json({success:!1,message:"Failed to send test alert to Telegram",preview:r},500)}catch(s){return console.error("[MICRO TEST] Error:",s),e.json({success:!1,error:s.message,stack:s.stack},500)}});function ci(e,t){const s=Object.keys(t);let a=0;for(const i of s){const l=t[i];if(!l)continue;(l.trend||l.ema_trend||"NEUTRAL")===(e==="BUY"?"BULLISH":"BEARISH")&&a++}const n=a>=3,o=a/s.length*100;return{passed:n,score:o,reason:n?`${a}/${s.length} timeframes aligned`:`Only ${a}/${s.length} timeframes aligned (need 3+)`}}function di(e){const t=[{hour:12,minute:30,name:"US CPI",duration:30},{hour:14,minute:0,name:"FOMC",duration:60},{hour:8,minute:30,name:"UK GDP",duration:30}],s=e.getUTCHours(),a=e.getUTCMinutes(),n=s*60+a;for(const o of t){const i=o.hour*60+o.minute-15,l=o.hour*60+o.minute+o.duration;if(n>=i&&n<=l)return{passed:!1,score:0,reason:`High-impact news: ${o.name} (avoid zone)`}}return{passed:!0,score:100,reason:"No high-impact news in danger zone"}}function mi(e){const t=e.getUTCHours(),a={0:.45,1:.42,2:.4,3:.48,4:.52,5:.55,6:.6,7:.65,8:.72,9:.68,10:.7,11:.72,12:.75,13:.78,14:.82,15:.8,16:.75,17:.72,18:.68,19:.65,20:.58,21:.52,22:.48,23:.46}[t]||.5,n=a>=.7;return{passed:n,score:a*100,reason:n?`Optimal trading hour (${(a*100).toFixed(0)}% historical win rate)`:`Low win rate hour (${(a*100).toFixed(0)}% - need 70%+)`}}function pi(e,t){if(t.length<50)return{passed:!0,score:50,reason:"Insufficient data for volatility check"};const s=[...t].sort((i,l)=>i-l),a=s.filter(i=>i<e).length/s.length*100;let n,o;return a<20?(n="LOW",o=!1):a<70?(n="NORMAL",o=!0):a<90?(n="HIGH",o=!0):(n="EXTREME",o=!1),{passed:o,score:o?100:0,reason:`Volatility: ${n} (${a.toFixed(0)}th percentile)`}}function ui(e,t){if(t.length<20)return{passed:!0,score:50,reason:"Insufficient candles for structure analysis"};const s=[],a=[];for(let c=2;c<Math.min(t.length-2,50);c++){const u=t[c],_=t[c-1],m=t[c-2],p=t[c+1],g=t[c+2];if(u.high>_.high&&u.high>m.high&&u.high>p.high&&u.high>g.high&&(s.push(u.high),s.length>=3)||u.low<_.low&&u.low<m.low&&u.low<p.low&&u.low<g.low&&(a.push(u.low),a.length>=3))break}if(s.length<3||a.length<3)return{passed:!0,score:50,reason:"Not enough swings for structure analysis"};const n=s[0]>s[1]&&s[1]>s[2],o=a[0]>a[1]&&a[1]>a[2],i=s[0]<s[1]&&s[1]<s[2],l=a[0]<a[1]&&a[1]<a[2];let r=!1,d="RANGING";return n&&o?(d="BULLISH",r=e==="BUY"):i&&l&&(d="BEARISH",r=e==="SELL"),{passed:r,score:r?100:0,reason:`Market structure: ${d} (${r?"aligned":"against signal"})`}}function _i(e,t){if(t.length<100)return{passed:!0,score:50,reason:"Insufficient data for volume profile"};const s=new Map;t.slice(-200).forEach(l=>{const r=Math.round(l.close*10)/10;s.set(r,(s.get(r)||0)+(l.volume||1))});const a=Array.from(s.entries()).sort((l,r)=>r[1]-l[1]),n=a[0][1],i=a.filter(([l,r])=>r>=n*.6).map(([l,r])=>l).some(l=>Math.abs(e-l)/e<.003);return{passed:i,score:i?100:30,reason:i?"Price near high-volume node (key level)":"Price not near any high-volume nodes"}}function gi(e,t){if(t.length<10)return{passed:!0,score:50,reason:"Insufficient candles for order flow"};const s=t.slice(-10);let a=0,n=0;s.forEach(r=>{const d=Math.abs(r.close-r.open),c=r.volume||1,u=d*c;r.close>r.open?a+=u:n+=u});const o=a+n,i=a/o;let l=!1;return(e==="BUY"&&i>.55||e==="SELL"&&i<.45)&&(l=!0),{passed:l,score:l?100:40,reason:l?`Order flow aligned (${(i*100).toFixed(0)}% bullish pressure)`:`Order flow not aligned (${(i*100).toFixed(0)}% bullish pressure)`}}function fi(e,t,s){if(s.length<20)return{passed:!0,score:50,reason:"Insufficient data for SMC analysis"};const a=[];for(let o=1;o<Math.min(s.length-1,50);o++){const i=s[o-1],l=s[o];i.close>i.open&&l.close<l.open&&(i.close-l.close)/i.close>.002&&a.push({type:"BULLISH",low:i.low,high:i.high}),i.close<i.open&&l.close>l.open&&(l.close-i.close)/i.close>.002&&a.push({type:"BEARISH",low:i.low,high:i.high})}let n=!1;return e==="BUY"?n=a.some(o=>o.type==="BULLISH"&&t>=o.low&&t<=o.high*1.005):n=a.some(o=>o.type==="BEARISH"&&t<=o.high&&t>=o.low*.995),{passed:n,score:n?100:30,reason:n?"Price testing institutional order block":"No relevant order blocks nearby"}}function hi(e,t){if(!t)return{passed:!0,score:70,reason:"No correlation data available"};let s=50,a=[];return e==="BUY"?(t.dxy_direction==="DOWN"&&(s+=25,a.push("DXY falling (bullish for gold)")),t.spx_direction==="DOWN"&&(s+=25,a.push("SPX falling (risk-off, bullish for gold)"))):(t.dxy_direction==="UP"&&(s+=25,a.push("DXY rising (bearish for gold)")),t.spx_direction==="UP"&&(s+=25,a.push("SPX rising (risk-on, bearish for gold)"))),{passed:s>=75,score:s,reason:a.length>0?a.join(", "):"No correlation support"}}function yi(e,t){let s=0;const a=[],n=t.rsi_14||t.rsi||50;e==="BUY"&&n<50?(s++,a.push("RSI oversold")):e==="SELL"&&n>50&&(s++,a.push("RSI overbought")),t.macd&&t.macd_signal&&(e==="BUY"&&t.macd>t.macd_signal?(s++,a.push("MACD bullish")):e==="SELL"&&t.macd<t.macd_signal&&(s++,a.push("MACD bearish"))),(t.adx_14||t.adx||0)>25&&(s++,a.push("Strong trend (ADX > 25)")),t.stochastic_k&&(e==="BUY"&&t.stochastic_k<30?(s++,a.push("Stochastic oversold")):e==="SELL"&&t.stochastic_k>70&&(s++,a.push("Stochastic overbought"))),t.ema_20&&t.ema_50&&(e==="BUY"&&t.ema_20>t.ema_50?(s++,a.push("EMA bullish alignment")):e==="SELL"&&t.ema_20<t.ema_50&&(s++,a.push("EMA bearish alignment")));const i=5,l=s/i*100;return{passed:s>=3,score:l,reason:`${s}/${i} indicators aligned: ${a.join(", ")}`}}async function _a(e,t,s,a,n,o){const i=new Date,l={multiTimeframe:ci(e,n),newsCalendar:di(i),timeOfDay:mi(i),volatility:pi(a.atr_14||a.atr||0,(o==null?void 0:o.atrHistory)||[]),marketStructure:ui(e,s),volumeProfile:_i(t,s),orderFlow:gi(e,s),smartMoney:fi(e,t,s),correlation:hi(e,o==null?void 0:o.correlationData),confluence:yi(e,a)},r=Object.values(l).filter(p=>p.passed).length,d=Object.keys(l).length,c=Object.values(l).reduce((p,g)=>p+g.score,0)/d;let u,_,m;return r>=9?(u="A+",_=2,m=90+(c-90)/2):r>=7?(u="A",_=1,m=80+(c-80)/2):r>=4?(u="B",_=.5,m=65+(c-65)/3):(u="REJECT",_=0,m=c),{grade:u,filtersPassed:r,totalFilters:d,positionMultiplier:_,confidence:m,filterResults:l}}const jt=new _e;function ga(e,t,s,a,n){const o=e.signal_type==="BUY"?"🟢":"🔴",i={"A+":"💎",A:"⭐",B:"📊"}[t.grade]||"📍",l={BREAKOUT:"📈",CONTINUATION:"➡️",REVERSAL:"🔄",BOUNCE:"⚡",PATTERN:"📊"}[e.setup_type]||"📍",r=Math.abs(e.price-e.stop_loss)/e.price*1e4,d=Math.abs(e.take_profit_1-e.price)/e.price*1e4,c=d/r,u=new Date,_=`${u.getUTCHours().toString().padStart(2,"0")}:${u.getUTCMinutes().toString().padStart(2,"0")} UTC`;let m="";t.grade==="A+"?m=`${i} <b>PREMIUM SIGNAL #${s}</b> ${i}
<b>GRADE: A+ (TOP 10%)</b>
...
`,p+=`Signal #${s} | ${_}`,p}jt.get("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),y={};for(const E of h.results||[])y[E.setting_key]=E.setting_value;let w=!1;if(y.telegram_bot_token&&y.telegram_chat_id){const E=ga(f,m,g,85,"NEW_YORK");w=await q({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},E),w&&await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 50
    `).all();if(!s.results||s.results.length<20)return e.json({success:!1,error:"Insufficient data for testing"});const a=s.results.map(l=>({timestamp:l.timestamp,open:l.open,high:l.high,low:l.low,close:l.close,volume:l.volume||1})).reverse(),n=await pe(a),o=a[a.length-1].close,i=await _a("BUY",o,a,n,{"5m":{trend:"BULLISH",indicators:n}});return e.json({success:!0,test_results:{grade:i.grade,filters_passed:i.filtersPassed,confidence:i.confidence,position_multiplier:i.positionMultiplier,filter_details:i.filterResults},current_price:o,indicators:{rsi:n.rsi,macd:n.macd,adx:n.adx}})}catch(s){return e.json({success:!1,error:s.message},500)}});const G=new _e;G.use("/api/*",ln());G.route("/api/signals/enhanced",zs);G.route("/api/signals/simple",Xs);G.route("/api/scanner",ct);G.route("/api/trades",we);G.route("/api/calendar",Fe);G.route("/api/backtest",pt);G.route("/api/telegram",ca);G.route("/api/ai",Pt);G.route("/api/monitoring",Ue);G.route("/api/micro",ut);G.route("/api/hybrid-micro",jt);G.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
📊 ${n(c)}`)&&(S.push("day_trade"),E=!0),await new Promise(b=>setTimeout(b,1e3)),h.isValid&&h.signal_type!=="HOLD"&&await q({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...h,timestamp:new Date().toISOString()})}

📊 ${n(c)}`)&&(S.push("swing_trade"),E=!0));for(const b of[f,h])b.isValid&&await t.prepare(`
    ...
    `).all();let a="";for(const E of s.results||[])E.setting_key==="twelve_data_api_key"&&(a=E.setting_value);let n,o=!1;if(a&&a!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const E=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,b=await(await fetch(E)).json();b.values&&b.values.length>=50?(n=b.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open)||0,high:parseFloat(k.high)||0,low:parseFloat(k.low)||0,close:parseFloat(k.close)||0,volume:parseFloat(k.volume)||0})),o=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",n[n.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(E){console.error("[GENERATE-NOW] API fetch failed:",E.message)}}if(!n||n.length===0){console.log("[GENERATE-NOW] Using database data (may be stale)");const E=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!E.results||E.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});n=E.results.reverse().map(S=>({timestamp:S.timestamp,open:S.open,high:S.high,low:S.low,close:S.close,volume:S.volume}))}const i=pe(n);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"});let l=n[n.length-1].close,r=!1;if(a&&a!=="your_api_key_here")try{console.log("[GENERATE-NOW] Fetching real-time price...");const S=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${a}`,{signal:AbortSignal.timeout(5e3)})).json();if(S.price){const b=parseFloat(S.price),k=l,$=Math.abs(b-k)/b*100;console.log(`[GENERATE-NOW] Real-time: $${b}, Last candle: $${k}, Diff: ${$.toFixed(2)}%`),l=b,r=!0}}catch(E){console.log("[GENERATE-NOW] Real-time price fetch failed, using candle close:",E.message)}const d=le(l,i,"day_trade"),c=le(l,i,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",d.signal_type,"Swing:",c.signal_type);const u=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),_={};for(const E of u.results||[])_[E.setting_key]=E.setting_value;let m=!1,p=[];const g=n.slice(-20),f=g.map(E=>E.high).sort((E,S)=>S-E),h=g.map(E=>E.low).sort((E,S)=>E-S),y=f.length>=3?[f[0],f[1],f[2]]:f.length>=1?[f[0]]:[],w=h.length>=3?[h[0],h[1],h[2]]:h.length>=1?[h[0]]:[];console.log("[GENERATE-NOW] S/R calculated - Resistance:",y,"Support:",w),_.telegram_bot_token&&_.telegram_chat_id&&(await q({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},lt({...d,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(p.push("day_trade"),m=!0),await new Promise(b=>setTimeout(b,1e3)),await q({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},lt({...c,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(p.push("swing_trade"),m=!0));for(const E of[d,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(a).first();if(!p)return e.json({success:!1,error:"Account not found"},404);const g=new Date().toISOString().split("T")[0],f=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(a,g).all(),{checkDailyLossLimit:h}=await Promise.resolve().then(()=>mt),y=h(p,f.results);if(y.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${y.current_loss_pct}% (max ${p.max_daily_loss_pct}%)`},400);const w=c*o,E=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(a.timeframe||"1h").all();if(!n.results||n.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=n.results)==null?void 0:s.length)||0}`},400);const o=await t.prepare(`
      ...
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:i,formatBacktestResults:l}=await Promise.resolve().then(()=>Qo),r=await i(n.results,{start_date:a.start_date||"2024-01-01",end_date:a.end_date||new Date().toISOString().split("T")[0],starting_balance:a.starting_balance||1e4,min_confidence:a.min_confidence||75,use_mtf_confirmation:a.use_mtf_confirmation!==!1,use_news_filter:a.use_news_filter!==!1,timeframe:a.timeframe||"1h",commission_per_trade:a.commission_per_trade||0},o.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();O=await q({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},N)}if(n.steps[3].status=O?"completed":"failed",n.steps[3].data={telegramSent:O},b.isValid||k.isValid)for(const D of[b,k])D.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim(),{sendTelegramMessage:P}=await Promise.resolve().then(()=>Gs);j=await P({botToken:U.telegram_bot_token,chatId:U.telegram_chat_id},B)}if(n.steps[3].status=j?"completed":"failed",n.steps[3].data={telegramSent:j},E.isValid||S.isValid)for(const L of[E,S])L.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(L.signal_type,L.trading_style,L.price,L.stop_loss,L.take_profit_1,L.take_profit_2,L.take_profit_3,L.confidence,L.final_confidence,L.final_confidence,L.alignment_score,L.alignment_type,L.reason,j?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:n,signals:{day_trade:E,swing_trade:S},positions:{day_trade:$,swing_trade:R},alignment:p,telegram_sent:j})}catch(s){return console.error("[ANALYZE-NOTIFY-GET] Error:",s),e.json({success:!1,error:s.message,stack:s.stack},500)}});const us=new _e,Ei=Object.assign({"/src/index.tsx":G});let fa=!1;for(const[,e]of Object.entries(Ei))e&&(us.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),us.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),fa=!0);if(!fa)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const bi=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],wi=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function ha(e){const t=e.toLowerCase();let s=0,a=0;for(const l of bi)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of wi)t.includes(l)&&(a+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(a+=1));const n=s+a;let o=0;n>0&&(o=(s-a)/n*100);let i="neutral";return o>20?i="bullish":o<-20&&(i="bearish"),{sentiment:i,score:o}}function Ti(e){let t=0,s=0,a=0,n=0;const o=e.map(r=>{const d=`${r.title} ${r.description||""}`,c=ha(d);return c.sentiment==="bullish"?t++:c.sentiment==="bearish"?s++:a++,n+=c.score,{...r,sentiment:c.sentiment,score:c.score}}),i=e.length>0?n/e.length:0;let l="neutral";return i>20?l="bullish":i<-20&&(l="bearish"),{overall:l,score:Math.round(i),bullishCount:t,bearishCount:s,neutralCount:a,articles:o.slice(0,10)}}async function Si(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,n=await(await fetch(s)).json();return n.status!=="ok"?(console.error("NewsAPI error:",n.message),[]):n.articles.map(o=>({title:o.title,description:o.description,url:o.url,publishedAt:o.publishedAt,source:o.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function vi(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(a=>{const n=new Date(a.date);return n>=e&&n<=t})}const ya=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:Ti,analyzeSentiment:ha,fetchGoldNews:Si,getEconomicEvents:vi},Symbol.toStringTag,{value:"Module"}));export{us as default};
