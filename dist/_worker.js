...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const et=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:tn,calculatePositionSize:ct,calculateProfitLoss:ts,checkDailyLossLimit:en,formatPositionSize:sn},Symbol.toStringTag,{value:"Module"}));function Rt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((r,i)=>r-i),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function nn(e,t){const s=Rt(e,.95),n=Rt(e,.99),a=t*s,r=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(r.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function an(e,t,s,n){const a=t-e,r=a/t*100;let i=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)i++;const l=r<=s,o=r>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(r.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:i}}function rn(e,t,s=5){let n=0;const a=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,u=d/t*100;n+=d,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(u.toFixed(2))})}const r=n/t*100,i=r<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(r.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:a}}function on(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[r,i,l]=a;if(i.value>r.value&&i.value>l.value&&Math.abs(r.value-l.value)/r.value<.02){const c=Math.min(r.value,l.value)*.995,d=c-(i.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function ln(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],c=n[n.length-1]-n[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function cn(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),r=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(r<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,u=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function dn(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[r,i]=a;if(Math.abs(r.value-i.value)/r.value<.015){const o=Math.max(...s.slice(r.index,i.index))*1.005,c=o+(o-r.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:66}}return null}function un(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),r=s[25];if(Math.abs(n-r)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),c=(r-o)/r;if(c>.01&&c<.05){const d=n-a,u=r+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function pn(e){const t=[],s=on(e);s&&t.push(s);const n=ln(e);n&&t.push(n);const a=cn(e);a&&t.push(a);const r=dn(e);r&&t.push(r);const i=un(e);i&&t.push(i);let l=0,o=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(o++,c+=m.confidence);let d="neutral",u=0;l>o?(d="bullish",u=Math.min(c/l/10,15)):o>l&&(d="bearish",u=Math.min(c/o/10,15));let p="";if(t.length===0)p="No significant chart patterns detected";else{const m=t.map(w=>w.pattern_type).join(", ");p=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(u.toFixed(1)),summary:p}}function fn(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function _n(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function mn(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function hn(e,t,s){const n=fn(t.atr_14,s),a=_n(t,s),r=mn(t,s);let i,l,o,c,d,u;const p=e.slice(-10),m=p.map(h=>h.volume||0),w=m.reduce((h,E)=>h+E,0)/m.length,b=(p[p.length-1].volume||0)>w*1.5;return n==="EXTREME"&&b?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,u="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,u="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,o=!1,c="Wait for direction",d=.5,u="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,u="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,u="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,u="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,u="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,r>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,u="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,u="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:r,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:u}}function gn(e){const t=e.length;let s=0,n=0,a=0,r=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],r+=o*o;const i=(t*a-s*n)/(t*r-s*s),l=(n-i*s)/t;return{slope:i,intercept:l}}function bn(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let r=n[0];for(let l=1;l<n.length;l++)r=(n[l]-r)*a+r;const i=(n[n.length-1]-n[n.length-10])/10;return r+i*s}function yn(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const i=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function wn(e,t,s){const n=e[e.length-1].close;e.map(i=>i.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const r=a/100*s;return n+t.atr_14*r}function vn(e,t){const s=e.map(p=>p.close),n=s[s.length-1],a=10,r=s.slice(-a),i=Math.min(...r),l=Math.max(...r),o=r.map(p=>(p-i)/(l-i));let c={index:0,similarity:-1/0};for(let p=a;p<s.length-a-t;p++){const m=s.slice(p-a,p),w=Math.min(...m),_=Math.max(...m),b=m.map(g=>(g-w)/(_-w));let h=0;for(let g=0;g<a;g++)h+=Math.pow(o[g]-b[g],2);const E=-h;E>c.similarity&&(c={index:p,similarity:E})}const u=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+u}function gt(e,t,s){const n=[],a=[],r=e.map(v=>v.close),{slope:i,intercept:l}=gn(r.slice(-20)),o=i*(r.length-1+s)+l;n.push(o),a.push(1);const c=bn(e,12,s);n.push(c),a.push(1.5);const d=yn(e,s);n.push(d),a.push(1.2);const u=wn(e,t,s);n.push(u),a.push(1.8);const p=vn(e,s);n.push(p),a.push(1.3);const m=a.reduce((v,M)=>v+M,0),_=n.reduce((v,M,P)=>v+M*a[P],0)/m,b=n.reduce((v,M)=>v+M,0)/n.length,h=n.reduce((v,M)=>v+Math.pow(M-b,2),0)/n.length,E=Math.sqrt(h),g=e[e.length-1].close,y=1-E/g,D=Math.max(50,Math.min(95,y*100));return{prediction:_,confidence:D}}function xn(e,t){const s=e[e.length-1].close,n=[],a=gt(e,t,1),r=a.prediction-s,i=r/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:r>.5?"UP":r<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=gt(e,t,4),o=l.prediction-s,c=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=gt(e,t,24),u=d.prediction-s,p=u/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:u>5?"UP":u<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(p.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(E=>E.direction==="UP").length,w=n.filter(E=>E.direction==="DOWN").length;let _,b=0;m>w?(_="BULLISH",b=Math.min(m*5,15)):w>m?(_="BEARISH",b=Math.min(w*5,15)):_="NEUTRAL";const h=`ML models predict ${_} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:_,confidence_boost:parseFloat(b.toFixed(1)),summary:h}}function bt(e,t,s,n,a){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const o=(n-50)/10;l+=o;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function kn(e,t,s,n,a){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function En(e,t,s,n,a,r){const i=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,c=t-e;return r.tp1/100*i+r.tp2/100*l+r.tp3/100*o+r.sl/100*c}function $t(e,t,s){const n=e.price,a=t.atr_14;let r=50;e.signal_type==="BUY"?(n>t.sma_20&&(r+=10),n>t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(r+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(r+=10),n<t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(r+=10)),r=Math.min(100,r);const i=s.slice(-50),l=[];for(let g=14;g<i.length;g++){const y=i.slice(g-14,g);let D=0;for(let v=1;v<y.length;v++){const M=Math.max(y[v].high-y[v].low,Math.abs(y[v].high-y[v-1].close),Math.abs(y[v].low-y[v-1].close));D+=M}l.push(D/14)}const o=l.reduce((g,y)=>g+y,0)/l.length,c=a/o,d=bt(n,e.take_profit_1,a,r,c),u=bt(n,e.take_profit_2,a,r,c),p=bt(n,e.take_profit_3,a,r,c),m=kn(n,e.stop_loss,a,r,e.signal_type),w=En(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:u,tp3:p,sl:m}),b=(d+u+p)/3/m;let h;d>70&&w>5&&b>2?h="STRONG_TRADE":d>60&&w>0&&b>1.5?h="GOOD_TRADE":d>50&&w>-2?h="MARGINAL_TRADE":h="AVOID_TRADE";const E=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${w.toFixed(2)}. Risk-adjusted R:R: ${b.toFixed(2)}:1. Recommendation: ${h.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(u.toFixed(1)),tp3_probability:parseFloat(p.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(w.toFixed(2)),risk_reward_adjusted:parseFloat(b.toFixed(2)),recommendation:h,summary:E}}const ss=new xt;ss.post("/enhanced",async e=>{var s,n;const{DB:t}=e.env;try{const a=["5m","15m","1h","4h","daily"],r={},i={};try{for(const x of a){try{const te=await t.prepare(`
            ...
            LIMIT 1
          `).bind(x).all();if(te.results&&te.results.length>0){const W=te.results[0];W&&typeof W.rsi_14=="number"&&typeof W.macd=="number"&&typeof W.atr_14=="number"&&(r[x]=W)}}catch(te){console.error(`Error fetching indicators for ${x}:`,te.message)}try{const te=await t.prepare(`
            SELECT timestamp, open, high, low, close, volume 
            FROM market_data 
            WHERE timeframe = ?
            ORDER BY timestamp DESC 
            LIMIT 100
          `).bind(x).all();te.results&&te.results.length>0&&(i[x]=te.results.reverse().map(W=>({timestamp:W.timestamp,open:W.open,high:W.high,low:W.low,close:W.close,volume:W.volume||0})))}catch(te){console.error(`Error fetching candles for ${x}:`,te.message)}}}catch(x){return e.json({success:!1,error:`Error fetching data: ${x.message}`,stack:x.stack},500)}if(Object.keys(r).length<3||!r["1h"])return e.json({success:!1,error:`Not enough timeframe data. Need at least 3 timeframes including 1h. Have: ${Object.keys(r).join(", ")}`,debug:{hasOneHour:!!r["1h"],totalTimeframes:Object.keys(r).length,availableTimeframes:Object.keys(r),oneHourSample:r["1h"]?{hasRsi:typeof r["1h"].rsi_14,hasMacd:typeof r["1h"].macd,hasAtr:typeof r["1h"].atr_14}:null}},400);console.log("MTF Indicators loaded:",{timeframes:Object.keys(r),oneHour:r["1h"]?"present":"missing",rsi:(s=r["1h"])==null?void 0:s.rsi_14});const l=i["1h"]&&i["1h"].length>0?i["1h"][i["1h"].length-1].close:0;if(l===0)return e.json({success:!1,error:"Current price not available"},400);const o=r["1h"];if(!o)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(r).join(", ")}`},400);let c;try{c=Zt(r,l)}catch(x){return e.json({success:!1,error:`Error analyzing MTF alignment: ${x.message}`,stack:x.stack,debug:{hasIndicators:Object.keys(r),sampleIndicator:r["1h"]?{rsi:typeof r["1h"].rsi_14,macd:typeof r["1h"].macd}:"missing"}},500)}const d=Z(l,o,"day_trade"),u=Z(l,o,"swing_trade"),p=wt(d.signal_type,c),m=wt(u.signal_type,c);let w=null;i["1h"]&&i["1h"].length>=20&&(w=pn(i["1h"]));const b=((w==null?void 0:w.patterns)||[]).filter(x=>x.confidence>=70&&x.endIndex>=i["1h"].length-5);let h=0,E="";for(const x of b)x.type==="bullish"&&d.signal_type==="BUY"?(h+=x.confidence*.1,E+=`${x.name} (${x.confidence.toFixed(0)}%), `):x.type==="bearish"&&d.signal_type==="SELL"&&(h+=x.confidence*.1,E+=`${x.name} (${x.confidence.toFixed(0)}%), `);h=Math.min(15,h);let g=null;if(i["1h"]&&i["1h"].length>=50){const x=Le(i["1h"]);x&&(g=hn(i["1h"],x))}let y=0,D="";g&&(g.trend==="STRONG_UPTREND"&&d.signal_type==="BUY"?(y=10,D="Strong Uptrend"):g.trend==="UPTREND"&&d.signal_type==="BUY"?(y=5,D="Uptrend"):g.trend==="STRONG_DOWNTREND"&&d.signal_type==="SELL"?(y=10,D="Strong Downtrend"):g.trend==="DOWNTREND"&&d.signal_type==="SELL"?(y=5,D="Downtrend"):g.trend==="RANGING"&&(y=-10,D="Ranging (avoid)"),(g.trend==="STRONG_UPTREND"||g.trend==="STRONG_DOWNTREND")&&g.volatility==="HIGH"&&(y+=5,D+=" + High Vol"));let v=null;i["1h"]&&i["1h"].length>=50&&(v=xn(i["1h"]));const M=((n=v==null?void 0:v.predictions)==null?void 0:n.find(x=>x.timeframe==="1h"))||null;let P=0,L="";if(M&&M.confidence>=60){const x=(M.predicted_price-l)/l*100;d.signal_type==="BUY"&&x>.1?(P=Math.min(20,M.confidence*.2),L=`ML: +${x.toFixed(2)}% (${M.confidence.toFixed(0)}%)`):d.signal_type==="SELL"&&x<-.1?(P=Math.min(20,M.confidence*.2),L=`ML: ${x.toFixed(2)}% (${M.confidence.toFixed(0)}%)`):Math.abs(x)<.05&&(P=-15,L="ML: Sideways (avoid)")}const K=$t({entry_price:d.price,stop_loss:d.stop_loss,take_profit_1:d.take_profit_1,take_profit_2:d.take_profit_2,take_profit_3:d.take_profit_3,signal_type:d.signal_type,confidence:d.confidence,atr:o.atr_14}),j=$t({entry_price:u.price,stop_loss:u.stop_loss,take_profit_1:u.take_profit_1,take_profit_2:u.take_profit_2,take_profit_3:u.take_profit_3,signal_type:u.signal_type,confidence:u.confidence,atr:o.atr_14});let O=0;K.tp1_probability>=75?O=10:K.tp1_probability>=65?O=5:K.tp1_probability<50&&(O=-10);const I=Math.min(98,Math.max(0,p.confidence+h+y+P+O)),se=Math.min(98,Math.max(0,m.confidence+h+y+P+O)),Y=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),ne=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),Q=ct(Y,{entry_price:d.price,stop_loss:d.stop_loss,take_profit_1:d.take_profit_1,take_profit_2:d.take_profit_2,take_profit_3:d.take_profit_3,confidence:I,signal_type:d.signal_type,trading_style:"day_trade"},ne.results),F=ct(Y,{entry_price:u.price,stop_loss:u.stop_loss,take_profit_1:u.take_profit_1,take_profit_2:u.take_profit_2,take_profit_3:u.take_profit_3,confidence:se,signal_type:u.signal_type,trading_style:"swing_trade"},ne.results),T=await t.prepare(`
      SELECT * FROM trades 
      WHERE account_id = 1 
      ORDER BY entry_time DESC 
      LIMIT 100
    `).all(),H=nn(T.results),le=H.var_95,_e=H.var_99,ee=an(Y,T.results),pt=await t.prepare(`
      SELECT * FROM trades 
      WHERE account_id = 1 AND status = 'OPEN'
    `).all(),me=rn(pt.results,Y),R=[];ee.should_pause_trading&&R.push(`⛔ TRADING PAUSED: Drawdown ${ee.current_drawdown_pct.toFixed(2)}% exceeds ${ee.max_allowed_drawdown_pct}% limit`),me.total_risk_pct>10&&R.push(`⚠️ HIGH PORTFOLIO HEAT: ${me.total_risk_pct.toFixed(1)}% (max 10%)`),Q.risk_amount>_e&&R.push(`⚠️ Position risk ($${Q.risk_amount}) exceeds VaR99 ($${_e.toFixed(2)})`);const q={...d,base_confidence:d.confidence,mtf_confidence:p.confidence,pattern_boost:h,regime_boost:y,ml_boost:P,pop_boost:O,final_confidence:I,isValid:p.isValid&&!ee.should_pause_trading,mtf_reason:p.reason,patterns:b,regime:g||void 0,ml_prediction:M||void 0,probability:K,var_95:le,var_99:_e,current_drawdown:ee,portfolio_heat:me,risk_warnings:R,reason:[d.reason,`MTF: ${p.reason}`,E?`Patterns: ${E}`:"",D?`Regime: ${D}`:"",L||"",`PoP TP1: ${K.tp1_probability.toFixed(0)}%`].filter(x=>x).join(", ")},tt={...u,base_confidence:u.confidence,mtf_confidence:m.confidence,pattern_boost:h,regime_boost:y,ml_boost:P,pop_boost:O,final_confidence:se,isValid:m.isValid&&!ee.should_pause_trading,mtf_reason:m.reason,patterns:b,regime:g||void 0,ml_prediction:M||void 0,probability:j,var_95:le,var_99:_e,current_drawdown:ee,portfolio_heat:me,risk_warnings:R,reason:[u.reason,`MTF: ${m.reason}`,E?`Patterns: ${E}`:"",D?`Regime: ${D}`:"",L||"",`PoP TP1: ${j.tp1_probability.toFixed(0)}%`].filter(x=>x).join(", ")},st=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),U={};for(const x of st.results||[])U[x.setting_key]=x.setting_value;let X=!1;if(U.telegram_bot_token&&U.telegram_chat_id){const x=Sn(q,tt,Q,F,c);X=await xe({botToken:U.telegram_bot_token,chatId:U.telegram_chat_id},x)}return await t.prepare(`
      ...
      VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(q.signal_type,q.trading_style,q.price,q.stop_loss,q.take_profit_1,q.take_profit_2,q.take_profit_3,q.base_confidence,q.final_confidence,h,y,P,O,le,_e,ee.current_drawdown_pct,me.total_risk_pct,ee.should_pause_trading?1:0,X?1:0,JSON.stringify({patterns:b,regime:g,ml_prediction:M,probability:K,alignment:c})).run(),e.json({success:!0,signals:{day_trade:q,swing_trade:tt},positions:{day_trade:Q,swing_trade:F},alignment:c,risk_metrics:{var_95,var_99,drawdown:ee,portfolio_heat:me,warnings:R},telegram_sent:X})}catch(a){return e.json({success:!1,error:a.message,stack:a.stack},500)}});function Sn(e,t,s,n,a){const r=new Date().toLocaleString("en-US",{timeZone:"UTC"});let i=`🏦 *HEDGE FUND GRADE ANALYSIS*
`;if(i+=`⏰ ${r} UTC
...
`,i}const C=new xt;C.use("/api/*",Us());C.route("/api/signals/enhanced",ss);C.get("/",e=>e.html(`
  ...
  `));C.get("/api/signals/recent",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),n={};for(const a of s.results||[])n[a.setting_key]=a.setting_value;return e.json({success:!0,settings:n})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/settings",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const r of s.results||[])n[r.setting_key]=r.setting_value;const a=await xe({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},`🔔 <b>Test Alert</b>
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,o=await(await fetch(i)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=o.values;let d=0;const u=[];for(const p of c){const m={timestamp:p.datetime,open:parseFloat(p.open),high:parseFloat(p.high),low:parseFloat(p.low),close:parseFloat(p.close),volume:0};u.push(m),await t.prepare(`
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume).run(),d++}if(u.length>=50){const p=Le(u.reverse());if(p){await t.prepare(`
        ...
        `).bind(p.rsi_14,p.macd,p.macd_signal,p.macd_histogram,p.sma_20,p.sma_50,p.sma_200,p.ema_12,p.ema_26,p.bb_upper,p.bb_middle,p.bb_lower,p.atr_14,p.stochastic_k,p.stochastic_d,p.adx,p.plus_di,p.minus_di,p.ichimoku_tenkan,p.ichimoku_kijun,p.ichimoku_senkou_a,p.ichimoku_senkou_b,p.parabolic_sar,p.vwap,p.fib_382||0,p.fib_500||0,p.fib_618||0).run();const m=u[u.length-1].close,w=Z(m,p,"day_trade"),_=Z(m,p,"swing_trade"),b=70;for(const h of[w,_])if(h.confidence>=b&&h.signal_type!=="HOLD"){await t.prepare(`
              INSERT INTO signals 
              (timestamp, signal_type, trading_style, price, stop_loss, 
            ...
            `).bind(h.signal_type,h.trading_style,h.price,h.stop_loss,h.take_profit_1,h.take_profit_2,h.take_profit_3,h.confidence,h.reason).run();const E=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),g={};for(const y of E.results||[])g[y.setting_key]=y.setting_value;g.telegram_bot_token&&g.telegram_chat_id&&await xe({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},Ke(h))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",r=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let i=0;const l={};for(const o of r){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${o.interval}&apikey=${n}&outputsize=${o.outputsize}`,u=await(await fetch(c)).json();if(u.code&&u.status==="error"){l[o.dbKey]={success:!1,error:u.message,count:0};continue}if(!u.values||!Array.isArray(u.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const p=u.values;let m=0;const w=[];for(const _ of p){const b={timestamp:_.datetime,open:parseFloat(_.open),high:parseFloat(_.high),low:parseFloat(_.low),close:parseFloat(_.close),volume:0};w.push(b),await t.prepare(`
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(b.timestamp,b.open,b.high,b.low,b.close,b.volume,o.dbKey).run(),m++}if(w.length>=50){const _=Le(w.reverse());_&&await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),a=Le(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const r=n[n.length-1].close,i=Z(r,a,"day_trade"),l=Z(r,a,"swing_trade");return e.json({success:!0,signals:{day_trade:i,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>es),r=["5m","15m","1h","4h","daily"],i={};for(const v of r){const M=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(v).first();M&&(i[v]=M)}const l=Object.keys(i).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(i)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(i,c),u=i["1h"],p=Z(c,u,"day_trade"),m=Z(c,u,"swing_trade"),w=n(p.signal_type,d),_=n(m.signal_type,d),b={...p,base_confidence:p.confidence,mtf_confidence:w.confidence,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:d.score,alignment_type:d.type,reason:`${p.reason}, MTF: ${w.reason}`},h={...m,base_confidence:m.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${_.reason}`},E=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),g={};for(const v of E.results||[])g[v.setting_key]=v.setting_value;let y=!1,D=[];g.telegram_bot_token&&g.telegram_chat_id&&(b.isValid&&b.signal_type!=="HOLD"&&await xe({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${Ke({...b,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(D.push("day_trade"),y=!0),await new Promise(v=>setTimeout(v,1e3)),h.isValid&&h.signal_type!=="HOLD"&&await xe({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED
...
📊 ${a(d)}`)&&(D.push("swing_trade"),y=!0));for(const v of[b,h])v.isValid&&await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first."});const n=s.results.reverse().map(p=>({timestamp:p.timestamp,open:p.open,high:p.high,low:p.low,close:p.close,volume:p.volume})),a=Le(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const r=n[n.length-1].close,i=Z(r,a,"day_trade"),l=Z(r,a,"swing_trade"),o=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    ...
    `).bind(n).first();if(!w)return e.json({success:!1,error:"Account not found"},404);const _=new Date().toISOString().split("T")[0],b=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,_).all(),{checkDailyLossLimit:h}=await Promise.resolve().then(()=>et),E=h(w,b.results);if(E.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${E.current_loss_pct}% (max ${w.max_daily_loss_pct}%)`},400);const g=d*r,y=await t.prepare(`
      INSERT INTO trades (
    ...
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Fetch MTF Data",status:"running"});const n=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),a=(n==null?void 0:n.setting_value)||"70140f57bea54c5e90768de696487d8f",r=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];let i=0;for(const I of r){const se=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${I.interval}&apikey=${a}&outputsize=100`,ne=await(await fetch(se)).json();if(ne.values&&Array.isArray(ne.values)){const Q=[];for(const F of ne.values){const T={timestamp:F.datetime,open:parseFloat(F.open),high:parseFloat(F.high),low:parseFloat(F.low),close:parseFloat(F.close),volume:0};Q.push(T),await t.prepare(`
            INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT DO NOTHING
          `).bind(T.timestamp,T.open,T.high,T.low,T.close,T.volume,I.dbKey).run()}if(Q.length>=50){const F=Le(Q.reverse());F&&await t.prepare(`
              INSERT INTO multi_timeframe_indicators 
              (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
               sma_20, sma_50, sma_200, ema_12, ema_26,
               bb_upper, bb_middle, bb_lower, atr_14,
               ...
               parabolic_sar, vwap, fib_382, fib_500, fib_618)
              VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `).bind(I.dbKey,F.rsi_14,F.macd,F.macd_signal,F.macd_histogram,F.sma_20,F.sma_50,F.sma_200,F.ema_12,F.ema_26,F.bb_upper,F.bb_middle,F.bb_lower,F.atr_14,F.stochastic_k,F.stochastic_d,F.adx,F.plus_di,F.minus_di,F.ichimoku_tenkan,F.ichimoku_kijun,F.ichimoku_senkou_a,F.ichimoku_senkou_b,F.parabolic_sar,F.vwap,F.fib_382,F.fib_500,F.fib_618).run()}i+=ne.values.length}await new Promise(Q=>setTimeout(Q,500))}s.steps[0].status="completed",s.steps[0].data={totalCandles:i},s.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:l,validateMultiTimeframeSignal:o,formatAlignmentReport:c}=await Promise.resolve().then(()=>es),d={};for(const I of["5m","15m","1h","4h","daily"]){const se=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(I).first();se&&(d[I]=se)}const u=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),p=(u==null?void 0:u.close)||0,m=l(d,p),w=d["1h"],_=Z(p,w,"day_trade"),b=Z(p,w,"swing_trade"),h=o(_.signal_type,m),E=o(b.signal_type,m),g={..._,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:m.score,alignment_type:m.type},y={...b,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:m.score,alignment_type:m.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:g,swingTrade:y,alignment:m},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const D=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),v=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:M}=await Promise.resolve().then(()=>et),P=M(D,{entry_price:g.price,stop_loss:g.stop_loss,take_profit_1:g.take_profit_1,take_profit_2:g.take_profit_2,take_profit_3:g.take_profit_3,confidence:g.final_confidence,signal_type:g.signal_type,trading_style:g.trading_style},v.results),L=M(D,{entry_price:y.price,stop_loss:y.stop_loss,take_profit_1:y.take_profit_1,take_profit_2:y.take_profit_2,take_profit_3:y.take_profit_3,confidence:y.final_confidence,signal_type:y.signal_type,trading_style:y.trading_style},v.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:P,swingPosition:L},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const K=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),j={};for(const I of K.results||[])j[I.setting_key]=I.setting_value;let O=!1;if(j.telegram_bot_token&&j.telegram_chat_id){const I=`
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();O=await xe({botToken:j.telegram_bot_token,chatId:j.telegram_chat_id},I)}if(s.steps[3].status=O?"completed":"failed",s.steps[3].data={telegramSent:O},g.isValid||y.isValid)for(const I of[g,y])I.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
