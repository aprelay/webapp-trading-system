var Is=Object.defineProperty;var Ft=e=>{throw TypeError(e)};var Ms=(e,t,s)=>t in e?Is(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var $=(e,t,s)=>Ms(e,typeof t!="symbol"?t+"":t,s),xt=(e,t,s)=>t.has(e)||Ft("Cannot "+s);var h=(e,t,s)=>(xt(e,t,"read from private field"),s?s.call(e):t.get(e)),H=(e,t,s)=>t.has(e)?Ft("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),M=(e,t,s,a)=>(xt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),G=(e,t,s)=>(xt(e,t,"access private method"),s);var $t=(e,t,s,a)=>({set _(n){M(e,t,n,s)},get _(){return h(e,t,a)}});var Nt=(e,t,s)=>(a,n)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,c=!1,d;if(e[l]?(d=e[l][0][0],a.req.routeIndex=l):d=l===e.length&&n||void 0,d)try{o=await d(a,()=>r(l+1))}catch(p){if(p instanceof Error&&t)a.error=p,o=await t(p,a),c=!0;else throw p}else a.finalized===!1&&s&&(o=await s(a));return o&&(a.finalized===!1||c)&&(a.res=o),a}},Ds=Symbol(),Fs=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof Zt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?$s(e,{all:s,dot:a}):{}};async function $s(e,t){const s=await e.formData();return s?Ns(s,t):{}}function Ns(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Os(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(Cs(s,a,n),delete s[a])}),s}var Os=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Cs=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((i,r)=>{r===n.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},Gt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ps=e=>{const{groups:t,path:s}=Bs(e),a=Gt(s);return Hs(a,t)},Bs=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},Hs=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},mt={},Us=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return mt[a]||(s[2]?mt[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:mt[a]=[e,s[1],!0]),mt[a]}return null},It=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},js=e=>It(e,decodeURI),qt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const i=t.indexOf("?",a),r=t.slice(s,i===-1?void 0:i);return js(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(n===63)break}return t.slice(s,a)},Ws=e=>{const t=qt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ue=(e,t,...s)=>(s.length&&(t=Ue(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),zt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const i=n.replace("?","");a+="/"+i,s.push(a)}else a+="/"+n}),s.filter((n,i,r)=>r.indexOf(n)===i)},St=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?It(e,Xt):e):e,Kt=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,c=e.indexOf("&",o);return St(e.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(a&&(o=St(o)),i=r,o==="")continue;let c;l===-1?c="":(c=e.slice(l+1,r===-1?void 0:r),a&&(c=St(c))),s?(n[o]&&Array.isArray(n[o])||(n[o]=[]),n[o].push(c)):n[o]??(n[o]=c)}return t?n[t]:n},Vs=Kt,Ys=(e,t)=>Kt(e,t,!0),Xt=decodeURIComponent,Ot=e=>It(e,Xt),Ve,le,we,Qt,Jt,Lt,xe,Ht,Zt=(Ht=class{constructor(e,t="/",s=[[]]){H(this,we);$(this,"raw");H(this,Ve);H(this,le);$(this,"routeIndex",0);$(this,"path");$(this,"bodyCache",{});H(this,xe,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,M(this,le,s),M(this,Ve,{})}param(e){return e?G(this,we,Qt).call(this,e):G(this,we,Jt).call(this)}query(e){return Vs(this.url,e)}queries(e){return Ys(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Fs(this,e))}json(){return h(this,xe).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,xe).call(this,"text")}arrayBuffer(){return h(this,xe).call(this,"arrayBuffer")}blob(){return h(this,xe).call(this,"blob")}formData(){return h(this,xe).call(this,"formData")}addValidatedData(e,t){h(this,Ve)[e]=t}valid(e){return h(this,Ve)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ds](){return h(this,le)}get matchedRoutes(){return h(this,le)[0].map(([[,e]])=>e)}get routePath(){return h(this,le)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ve=new WeakMap,le=new WeakMap,we=new WeakSet,Qt=function(e){const t=h(this,le)[0][this.routeIndex][1][e],s=G(this,we,Lt).call(this,t);return s&&/\%/.test(s)?Ot(s):s},Jt=function(){const e={},t=Object.keys(h(this,le)[0][this.routeIndex][1]);for(const s of t){const a=G(this,we,Lt).call(this,h(this,le)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?Ot(a):a)}return e},Lt=function(e){return h(this,le)[1]?h(this,le)[1][e]:e},xe=new WeakMap,Ht),Gs={Stringify:1},es=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(l=>l({phase:t,buffer:n,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(o=>es(o,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},qs="text/plain; charset=UTF-8",Tt=(e,t)=>({"Content-Type":e,...t}),at,nt,fe,Ye,he,ie,it,Ge,qe,$e,rt,ot,Se,je,Ut,zs=(Ut=class{constructor(e,t){H(this,Se);H(this,at);H(this,nt);$(this,"env",{});H(this,fe);$(this,"finalized",!1);$(this,"error");H(this,Ye);H(this,he);H(this,ie);H(this,it);H(this,Ge);H(this,qe);H(this,$e);H(this,rt);H(this,ot);$(this,"render",(...e)=>(h(this,Ge)??M(this,Ge,t=>this.html(t)),h(this,Ge).call(this,...e)));$(this,"setLayout",e=>M(this,it,e));$(this,"getLayout",()=>h(this,it));$(this,"setRenderer",e=>{M(this,Ge,e)});$(this,"header",(e,t,s)=>{this.finalized&&M(this,ie,new Response(h(this,ie).body,h(this,ie)));const a=h(this,ie)?h(this,ie).headers:h(this,$e)??M(this,$e,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});$(this,"status",e=>{M(this,Ye,e)});$(this,"set",(e,t)=>{h(this,fe)??M(this,fe,new Map),h(this,fe).set(e,t)});$(this,"get",e=>h(this,fe)?h(this,fe).get(e):void 0);$(this,"newResponse",(...e)=>G(this,Se,je).call(this,...e));$(this,"body",(e,t,s)=>G(this,Se,je).call(this,e,t,s));$(this,"text",(e,t,s)=>!h(this,$e)&&!h(this,Ye)&&!t&&!s&&!this.finalized?new Response(e):G(this,Se,je).call(this,e,t,Tt(qs,s)));$(this,"json",(e,t,s)=>G(this,Se,je).call(this,JSON.stringify(e),t,Tt("application/json",s)));$(this,"html",(e,t,s)=>{const a=n=>G(this,Se,je).call(this,n,t,Tt("text/html; charset=UTF-8",s));return typeof e=="object"?es(e,Gs.Stringify,!1,{}).then(a):a(e)});$(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});$(this,"notFound",()=>(h(this,qe)??M(this,qe,()=>new Response),h(this,qe).call(this,this)));M(this,at,e),t&&(M(this,he,t.executionCtx),this.env=t.env,M(this,qe,t.notFoundHandler),M(this,ot,t.path),M(this,rt,t.matchResult))}get req(){return h(this,nt)??M(this,nt,new Zt(h(this,at),h(this,ot),h(this,rt))),h(this,nt)}get event(){if(h(this,he)&&"respondWith"in h(this,he))return h(this,he);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,he))return h(this,he);throw Error("This context has no ExecutionContext")}get res(){return h(this,ie)||M(this,ie,new Response(null,{headers:h(this,$e)??M(this,$e,new Headers)}))}set res(e){if(h(this,ie)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,ie).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=h(this,ie).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}M(this,ie,e),this.finalized=!0}get var(){return h(this,fe)?Object.fromEntries(h(this,fe)):{}}},at=new WeakMap,nt=new WeakMap,fe=new WeakMap,Ye=new WeakMap,he=new WeakMap,ie=new WeakMap,it=new WeakMap,Ge=new WeakMap,qe=new WeakMap,$e=new WeakMap,rt=new WeakMap,ot=new WeakMap,Se=new WeakSet,je=function(e,t,s){const a=h(this,ie)?new Headers(h(this,ie).headers):h(this,$e)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?a.append(r,l):a.set(r,l)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")a.set(i,r);else{a.delete(i);for(const l of r)a.append(i,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ye);return new Response(e,{status:n,headers:a})},Ut),Q="ALL",Ks="all",Xs=["get","post","put","delete","options","patch"],ts="Can not add a route since the matcher is already built.",ss=class extends Error{},Zs="__COMPOSED_HANDLER",Qs=e=>e.text("404 Not Found",404),Ct=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},ce,J,as,de,Me,gt,_t,ze,Js=(ze=class{constructor(t={}){H(this,J);$(this,"get");$(this,"post");$(this,"put");$(this,"delete");$(this,"options");$(this,"patch");$(this,"all");$(this,"on");$(this,"use");$(this,"router");$(this,"getPath");$(this,"_basePath","/");H(this,ce,"/");$(this,"routes",[]);H(this,de,Qs);$(this,"errorHandler",Ct);$(this,"onError",t=>(this.errorHandler=t,this));$(this,"notFound",t=>(M(this,de,t),this));$(this,"fetch",(t,...s)=>G(this,J,_t).call(this,t,s[1],s[0],t.method));$(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ue("/",t)}`,s),a,n)));$(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(G(this,J,_t).call(this,t.request,t,void 0,t.request.method))})});[...Xs,Ks].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?M(this,ce,r):G(this,J,Me).call(this,i,h(this,ce),r),l.forEach(o=>{G(this,J,Me).call(this,i,h(this,ce),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){M(this,ce,o);for(const c of[i].flat())l.map(d=>{G(this,J,Me).call(this,c.toUpperCase(),h(this,ce),d)})}return this},this.use=(i,...r)=>(typeof i=="string"?M(this,ce,i):(M(this,ce,"*"),r.unshift(i)),r.forEach(l=>{G(this,J,Me).call(this,Q,h(this,ce),l)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??qt:Ws}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var r;let i;s.errorHandler===Ct?i=n.handler:(i=async(l,o)=>(await Nt([],s.errorHandler)(l,()=>n.handler(l,o))).res,i[Zs]=n.handler),G(r=a,J,Me).call(r,n.method,n.path,i)}),this}basePath(t){const s=G(this,J,as).call(this);return s._basePath=Ue(this._basePath,t),s}mount(t,s,a){let n,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?n=o=>o:n=a.replaceRequest));const r=i?o=>{const c=i(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};n||(n=(()=>{const o=Ue(this._basePath,t),c=o==="/"?0:o.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const l=async(o,c)=>{const d=await s(n(o.req.raw),...r(o));if(d)return d;await c()};return G(this,J,Me).call(this,Q,Ue(t,"*"),l),this}},ce=new WeakMap,J=new WeakSet,as=function(){const t=new ze({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,M(t,de,h(this,de)),t.routes=this.routes,t},de=new WeakMap,Me=function(t,s,a){t=t.toUpperCase(),s=Ue(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},gt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},_t=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await G(this,J,_t).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),r=this.router.match(n,i),l=new zs(t,{path:i,matchResult:r,env:a,executionCtx:s,notFoundHandler:h(this,de)});if(r[0].length===1){let c;try{c=r[0][0][0][0](l,async()=>{l.res=await h(this,de).call(this,l)})}catch(d){return G(this,J,gt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:h(this,de).call(this,l))).catch(d=>G(this,J,gt).call(this,d,l)):c??h(this,de).call(this,l)}const o=Nt(r[0],this.errorHandler,h(this,de));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return G(this,J,gt).call(this,c,l)}})()},ze),ns=[];function ea(e,t){const s=this.buildAllMatchers(),a=((n,i)=>{const r=s[n]||s[Q],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],ns];const c=o.indexOf("",1);return[r[1][c],o]});return this.match=a,a(e,t)}var yt="[^/]+",et=".*",tt="(?:|/.*)",We=Symbol(),ta=new Set(".\\+*[^]$()");function sa(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===et||e===tt?1:t===et||t===tt?-1:e===yt?1:t===yt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ne,Oe,ue,Be,aa=(Be=class{constructor(){H(this,Ne);H(this,Oe);H(this,ue,Object.create(null))}insert(t,s,a,n,i){if(t.length===0){if(h(this,Ne)!==void 0)throw We;if(i)return;M(this,Ne,s);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",et]:["","",yt]:r==="/*"?["","",tt]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const d=o[1];let p=o[2]||yt;if(d&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw We;if(c=h(this,ue)[p],!c){if(Object.keys(h(this,ue)).some(u=>u!==et&&u!==tt))throw We;if(i)return;c=h(this,ue)[p]=new Be,d!==""&&M(c,Oe,n.varIndex++)}!i&&d!==""&&a.push([d,h(c,Oe)])}else if(c=h(this,ue)[r],!c){if(Object.keys(h(this,ue)).some(d=>d.length>1&&d!==et&&d!==tt))throw We;if(i)return;c=h(this,ue)[r]=new Be}c.insert(l,s,a,n,i)}buildRegExpStr(){const s=Object.keys(h(this,ue)).sort(sa).map(a=>{const n=h(this,ue)[a];return(typeof h(n,Oe)=="number"?`(${a})@${h(n,Oe)}`:ta.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof h(this,Ne)=="number"&&s.unshift(`#${h(this,Ne)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ne=new WeakMap,Oe=new WeakMap,ue=new WeakMap,Be),vt,lt,jt,na=(jt=class{constructor(){H(this,vt,{varIndex:0});H(this,lt,new aa)}insert(e,t,s){const a=[],n=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const c=`@\\${r}`;return n[r]=[c,o],r++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=n.length-1;r>=0;r--){const[l]=n[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,n[r][1]);break}}return h(this,lt).insert(i,t,a,h(this,vt),s),a}buildRegExp(){let e=h(this,lt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(a[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,a]}},vt=new WeakMap,lt=new WeakMap,jt),ia=[/^$/,[],Object.create(null)],ft=Object.create(null);function is(e){return ft[e]??(ft[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ra(){ft=Object.create(null)}function oa(e){var c;const t=new na,s=[];if(e.length===0)return ia;const a=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[u,m])=>d?1:u?-1:p.length-m.length),n=Object.create(null);for(let d=0,p=-1,u=a.length;d<u;d++){const[m,_,g]=a[d];m?n[_]=[g.map(([y])=>[y,Object.create(null)]),ns]:p++;let f;try{f=t.insert(_,p,m)}catch(y){throw y===We?new ss(_):y}m||(s[p]=g.map(([y,x])=>{const b=Object.create(null);for(x-=1;x>=0;x--){const[v,j]=f[x];b[v]=j}return[y,b]}))}const[i,r,l]=t.buildRegExp();for(let d=0,p=s.length;d<p;d++)for(let u=0,m=s[d].length;u<m;u++){const _=(c=s[d][u])==null?void 0:c[1];if(!_)continue;const g=Object.keys(_);for(let f=0,y=g.length;f<y;f++)_[g[f]]=l[_[g[f]]]}const o=[];for(const d in r)o[d]=s[r[d]];return[i,o,n]}function He(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(is(s).test(t))return[...e[s]]}}var Te,ke,wt,rs,Wt,la=(Wt=class{constructor(){H(this,wt);$(this,"name","RegExpRouter");H(this,Te);H(this,ke);$(this,"match",ea);M(this,Te,{[Q]:Object.create(null)}),M(this,ke,{[Q]:Object.create(null)})}add(e,t,s){var l;const a=h(this,Te),n=h(this,ke);if(!a||!n)throw new Error(ts);a[e]||[a,n].forEach(o=>{o[e]=Object.create(null),Object.keys(o[Q]).forEach(c=>{o[e][c]=[...o[Q][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=is(t);e===Q?Object.keys(a).forEach(c=>{var d;(d=a[c])[t]||(d[t]=He(a[c],t)||He(a[Q],t)||[])}):(l=a[e])[t]||(l[t]=He(a[e],t)||He(a[Q],t)||[]),Object.keys(a).forEach(c=>{(e===Q||e===c)&&Object.keys(a[c]).forEach(d=>{o.test(d)&&a[c][d].push([s,i])})}),Object.keys(n).forEach(c=>{(e===Q||e===c)&&Object.keys(n[c]).forEach(d=>o.test(d)&&n[c][d].push([s,i]))});return}const r=zt(t)||[t];for(let o=0,c=r.length;o<c;o++){const d=r[o];Object.keys(n).forEach(p=>{var u;(e===Q||e===p)&&((u=n[p])[d]||(u[d]=[...He(a[p],d)||He(a[Q],d)||[]]),n[p][d].push([s,i-c+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,ke)).concat(Object.keys(h(this,Te))).forEach(t=>{e[t]||(e[t]=G(this,wt,rs).call(this,t))}),M(this,Te,M(this,ke,void 0)),ra(),e}},Te=new WeakMap,ke=new WeakMap,wt=new WeakSet,rs=function(e){const t=[];let s=e===Q;return[h(this,Te),h(this,ke)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==Q&&t.push(...Object.keys(a[Q]).map(i=>[i,a[Q][i]]))}),s?oa(t):null},Wt),Re,ye,Vt,ca=(Vt=class{constructor(e){$(this,"name","SmartRouter");H(this,Re,[]);H(this,ye,[]);M(this,Re,e.routers)}add(e,t,s){if(!h(this,ye))throw new Error(ts);h(this,ye).push([e,t,s])}match(e,t){if(!h(this,ye))throw new Error("Fatal error");const s=h(this,Re),a=h(this,ye),n=s.length;let i=0,r;for(;i<n;i++){const l=s[i];try{for(let o=0,c=a.length;o<c;o++)l.add(...a[o]);r=l.match(e,t)}catch(o){if(o instanceof ss)continue;throw o}this.match=l.match.bind(l),M(this,Re,[l]),M(this,ye,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(h(this,ye)||h(this,Re).length!==1)throw new Error("No active router has been determined yet.");return h(this,Re)[0]}},Re=new WeakMap,ye=new WeakMap,Vt),Je=Object.create(null),Le,ne,Ce,Ke,te,be,De,Xe,da=(Xe=class{constructor(t,s,a){H(this,be);H(this,Le);H(this,ne);H(this,Ce);H(this,Ke,0);H(this,te,Je);if(M(this,ne,a||Object.create(null)),M(this,Le,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},M(this,Le,[n])}M(this,Ce,[])}insert(t,s,a){M(this,Ke,++$t(this,Ke)._);let n=this;const i=Ps(s),r=[];for(let l=0,o=i.length;l<o;l++){const c=i[l],d=i[l+1],p=Us(c,d),u=Array.isArray(p)?p[0]:c;if(u in h(n,ne)){n=h(n,ne)[u],p&&r.push(p[1]);continue}h(n,ne)[u]=new Xe,p&&(h(n,Ce).push(p),r.push(p[1])),n=h(n,ne)[u]}return h(n,Le).push({[t]:{handler:a,possibleKeys:r.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,Ke)}}),n}search(t,s){var o;const a=[];M(this,te,Je);let i=[this];const r=Gt(s),l=[];for(let c=0,d=r.length;c<d;c++){const p=r[c],u=c===d-1,m=[];for(let _=0,g=i.length;_<g;_++){const f=i[_],y=h(f,ne)[p];y&&(M(y,te,h(f,te)),u?(h(y,ne)["*"]&&a.push(...G(this,be,De).call(this,h(y,ne)["*"],t,h(f,te))),a.push(...G(this,be,De).call(this,y,t,h(f,te)))):m.push(y));for(let x=0,b=h(f,Ce).length;x<b;x++){const v=h(f,Ce)[x],j=h(f,te)===Je?{}:{...h(f,te)};if(v==="*"){const L=h(f,ne)["*"];L&&(a.push(...G(this,be,De).call(this,L,t,h(f,te))),M(L,te,j),m.push(L));continue}const[E,P,U]=v;if(!p&&!(U instanceof RegExp))continue;const R=h(f,ne)[E],S=r.slice(c).join("/");if(U instanceof RegExp){const L=U.exec(S);if(L){if(j[P]=L[0],a.push(...G(this,be,De).call(this,R,t,h(f,te),j)),Object.keys(h(R,ne)).length){M(R,te,j);const A=((o=L[0].match(/\//))==null?void 0:o.length)??0;(l[A]||(l[A]=[])).push(R)}continue}}(U===!0||U.test(p))&&(j[P]=p,u?(a.push(...G(this,be,De).call(this,R,t,j,h(f,te))),h(R,ne)["*"]&&a.push(...G(this,be,De).call(this,h(R,ne)["*"],t,j,h(f,te)))):(M(R,te,j),m.push(R)))}}i=m.concat(l.shift()??[])}return a.length>1&&a.sort((c,d)=>c.score-d.score),[a.map(({handler:c,params:d})=>[c,d])]}},Le=new WeakMap,ne=new WeakMap,Ce=new WeakMap,Ke=new WeakMap,te=new WeakMap,be=new WeakSet,De=function(t,s,a,n){const i=[];for(let r=0,l=h(t,Le).length;r<l;r++){const o=h(t,Le)[r],c=o[s]||o[Q],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),a!==Je||n&&n!==Je))for(let p=0,u=c.possibleKeys.length;p<u;p++){const m=c.possibleKeys[p],_=d[c.score];c.params[m]=n!=null&&n[m]&&!_?n[m]:a[m]??(n==null?void 0:n[m]),d[c.score]=!0}}return i},Xe),Pe,Yt,ua=(Yt=class{constructor(){$(this,"name","TrieRouter");H(this,Pe);M(this,Pe,new da)}add(e,t,s){const a=zt(t);if(a){for(let n=0,i=a.length;n<i;n++)h(this,Pe).insert(e,a[n],s);return}h(this,Pe).insert(e,t,s)}match(e,t){return h(this,Pe).search(e,t)}},Pe=new WeakMap,Yt),_e=class extends Js{constructor(e={}){super(e),this.router=e.router??new ca({routers:[new la,new ua]})}},pa=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(i=>typeof i=="string"?i==="*"?()=>i:r=>i===r?r:null:typeof i=="function"?i:r=>i.includes(r)?r:null)(s.origin),n=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(r,l){var d;function o(p,u){r.res.headers.set(p,u)}const c=await a(r.req.header("origin")||"",r);if(c&&o("Access-Control-Allow-Origin",c),s.credentials&&o("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await n(r.req.header("origin")||"",r);p.length&&o("Access-Control-Allow-Methods",p.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const m=r.req.header("Access-Control-Request-Headers");m&&(u=m.split(/\s*,\s*/))}return u!=null&&u.length&&(o("Access-Control-Allow-Headers",u.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((a,n)=>a+n,0)/t}function bt(e,t){if(e.length<t)return 0;const s=2/(t+1);let a=Fe(e.slice(0,t),t);for(let n=t;n<e.length;n++)a=(e[n]-a)*s+a;return a}function ma(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let a=0,n=0;for(let o=0;o<t;o++)s[o]>0?a+=s[o]:n+=Math.abs(s[o]);let i=a/t,r=n/t;for(let o=t;o<s.length;o++){const c=s[o];i=(i*(t-1)+(c>0?c:0))/t,r=(r*(t-1)+(c<0?Math.abs(c):0))/t}return r===0?100:100-100/(1+i/r)}function ga(e){const t=bt(e,12),s=bt(e,26),a=t-s,n=a*.9,i=a-n;return{macd:a,signal:n,histogram:i}}function _a(e,t=20,s=2){const a=Fe(e,t),i=e.slice(-t).reduce((l,o)=>l+Math.pow(o-a,2),0)/t,r=Math.sqrt(i);return{upper:a+r*s,middle:a,lower:a-r*s}}function fa(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const r=e[i].high,l=e[i].low,o=e[i-1].close,c=Math.max(r-l,Math.abs(r-o),Math.abs(l-o));s.push(c)}const a=Fe(s,t);return Math.max(a,10)}function ha(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const a=e.slice(-t),n=a.map(p=>p.high),i=a.map(p=>p.low),r=e[e.length-1].close,l=Math.max(...n),o=Math.min(...i),c=(r-o)/(l-o)*100;return{k:c,d:c}}function ya(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,a=0,n=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,p=e[c].low,u=e[c-1].high,m=e[c-1].low,_=e[c-1].close,g=d-u,f=m-p;g>f&&g>0&&(s+=g),f>g&&f>0&&(a+=f),n+=Math.max(d-p,Math.abs(d-_),Math.abs(p-_))}const i=n>0?s/n*100:0,r=n>0?a/n*100:0;return{adx:i+r>0?Math.abs(i-r)/(i+r)*100:0,plusDI:i,minusDI:r}}function ba(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),a=Math.max(...s.map(y=>y.high)),n=Math.min(...s.map(y=>y.low)),i=(a+n)/2,r=Math.min(26,e.length),l=e.slice(-r),o=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(o+c)/2,p=(i+d)/2,u=Math.min(52,e.length),m=e.slice(-u),_=Math.max(...m.map(y=>y.high)),g=Math.min(...m.map(y=>y.low)),f=(_+g)/2;return{tenkan:i,kijun:d,senkouA:p,senkouB:f}}function va(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const a=e[e.length-1],n=e[e.length-2];return a.close>n.close?a.low*.98:a.high*1.02}function wa(e){if(e.length===0)return 0;let t=0,s=0;for(const a of e){const n=(a.high+a.low+a.close)/3,i=a.volume||1;t+=n*i,s+=i}return s>0?t/s:e[e.length-1].close}function Ea(e,t=50){const s=e.slice(-Math.min(t,e.length)),a=s.map(o=>o.high),n=s.map(o=>o.low),i=Math.max(...a),r=Math.min(...n),l=i-r;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:r}}function ve(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=ga(t),a=_a(t),n=ha(e,14,3),i=ya(e,14),r=ba(e),l=va(e),o=wa(e),c=Ea(e,50);return{rsi_14:ma(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:bt(t,12),ema_26:bt(t,26),bb_upper:a.upper,bb_middle:a.middle,bb_lower:a.lower,atr_14:fa(e,14),stochastic_k:n.k,stochastic_d:n.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:r.tenkan,ichimoku_kijun:r.kijun,ichimoku_senkou_a:r.senkouA,ichimoku_senkou_b:r.senkouB,parabolic_sar:l,vwap:o,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function se(e,t,s){const a=[];let n=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(a.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?n+=2:i+=2),t.stochastic_k<20?(a.push("Stochastic oversold (<20)"),n+=2):t.stochastic_k<30?(a.push("Stochastic approaching oversold"),n+=1):t.stochastic_k>80?(a.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(a.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(a.push("Stochastic bullish crossover"),n+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(a.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(a.push("Price above Ichimoku Cloud (bullish)"),n+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(a.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(a.push("Ichimoku bullish (Tenkan > Kijun)"),n+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(a.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(a.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),n+=1):e<t.vwap&&(a.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(a.push("Near 61.8% Fibonacci support"),n+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(a.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(a.push("RSI oversold (<30)"),n+=2):t.rsi_14<40?(a.push("RSI below 40"),n+=1):t.rsi_14>70?(a.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(a.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(a.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(a.push("MACD bullish crossover"),n+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(a.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(a.push("Price above SMA20 and SMA50"),n+=1):e<t.sma_20&&e<t.sma_50&&(a.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(a.push("Uptrend (above SMA200)"),n+=1):(a.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(a.push("Price at lower Bollinger Band"),n+=2):e>=t.bb_upper&&(a.push("Price at upper Bollinger Band"),i+=2);const r=n+i,l=r>0?n/r*100:50;let o="HOLD",c=50;n>i+1?(o="BUY",c=Math.min(l,95)):i>n+1&&(o="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(n-i)>4&&(c=Math.min(c+5,95),a.push("High conviction signal"));const d=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,g=e*(1/100);let f,y,x,b;if(o==="BUY"){const v=e-t.atr_14*d;f=Math.max(v,e-g),y=e+t.atr_14*p,x=e+t.atr_14*u,b=e+t.atr_14*m}else if(o==="SELL"){const v=e+t.atr_14*d;f=Math.min(v,e+g),y=e-t.atr_14*p,x=e-t.atr_14*u,b=e-t.atr_14*m}else f=e,y=e,x=e,b=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(f.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(x.toFixed(2)),take_profit_3:parseFloat(b.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:a.join(", ")}}async function Z(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const n=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return n.ok||console.error("[Telegram] Send failed:",JSON.stringify(n)),n.ok===!0}catch(a){return console.error("Failed to send Telegram message:",a),!1}}function xa(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function st(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
⏰ ${new Date().toLocaleString()}
  `.trim()}function os(e,t){if(!e)throw console.error("[determineTrend] indicators is null/undefined!"),new Error("Indicators is undefined");if(e.rsi_14===void 0)throw console.error("[determineTrend] rsi_14 is undefined! Indicators:",Object.keys(e)),new Error("rsi_14 is undefined in indicators");let s=0,a=0,n=0;e.macd>e.macd_signal&&e.macd_histogram>0?s+=3:e.macd<e.macd_signal&&e.macd_histogram<0&&(a+=3),n+=3,t>e.sma_20?s+=2:a+=2,n+=2,t>e.sma_50?s+=2:a+=2,n+=2,t>e.sma_200?s+=3:a+=3,n+=3,e.adx&&e.adx>25&&e.plus_di&&e.minus_di&&(e.plus_di>e.minus_di?s+=2:a+=2,n+=2),e.rsi_14>50?s+=1:a+=1,n+=1;const i=s/n*100,r=a/n*100,l=Math.abs(i-r);let o,c;return i>60?(o="BULLISH",c=i):r>60?(o="BEARISH",c=r):(o="NEUTRAL",c=50),{timeframe:"1h",trend:o,strength:l,confidence:c}}function Mt(e,t){console.log("[analyzeTimeframeAlignment] START"),console.log("[analyzeTimeframeAlignment] indicators keys:",Object.keys(e||{})),console.log("[analyzeTimeframeAlignment] currentPrice:",t);const s=[],a=["5m","15m","1h","4h","daily"];for(const d of a){console.log(`[analyzeTimeframeAlignment] Processing ${d}`);const p=e[d];if(p){console.log(`[analyzeTimeframeAlignment] ${d} has indicators, calling determineTrend`),console.log(`[analyzeTimeframeAlignment] ${d} rsi_14:`,p.rsi_14,typeof p.rsi_14);const u=os(p,t);u.timeframe=d,s.push(u)}else console.log(`[analyzeTimeframeAlignment] ${d} missing indicators`)}const n=s.filter(d=>d.trend==="BULLISH").length,i=s.filter(d=>d.trend==="BEARISH").length;s.filter(d=>d.trend==="NEUTRAL").length;const r=s.length,l=Math.max(n,i);let o,c;return n===r?(o="ALL_BULLISH",c=20):i===r?(o="ALL_BEARISH",c=20):n>=r*.8?(o="ALL_BULLISH",c=15):i>=r*.8?(o="ALL_BEARISH",c=15):n>=r*.6||i>=r*.6?(o="MIXED",c=10):(o="CONFLICTING",c=0),{score:l,type:o,confidenceBoost:c,trends:s}}function At(e,t){if(e==="HOLD")return{isValid:!1,confidence:50,reason:"HOLD signal - no trade"};const{trends:s,type:a,confidenceBoost:n}=t,i=s.find(p=>p.timeframe==="daily"),r=s.find(p=>p.timeframe==="4h"),l=s.find(p=>p.timeframe==="1h"),o=s.find(p=>p.timeframe==="15m"),c=s.find(p=>p.timeframe==="5m"),d=e==="BUY"&&(c==null?void 0:c.trend)==="BULLISH"&&(o==null?void 0:o.trend)==="BULLISH"&&(l==null?void 0:l.trend)==="BULLISH"&&(c.strength>70||o.strength>70||l.strength>70)||e==="SELL"&&(c==null?void 0:c.trend)==="BEARISH"&&(o==null?void 0:o.trend)==="BEARISH"&&(l==null?void 0:l.trend)==="BEARISH"&&(c.strength>70||o.strength>70||l.strength>70);return e==="BUY"?i&&i.trend==="BEARISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BEARISH - opposing BUY signal"}:r&&r.trend==="BEARISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BEARISH - opposing BUY signal"}:l&&l.trend==="BEARISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BEARISH - weak BUY setup"}:a==="ALL_BULLISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BULLISH - high probability BUY (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BULLISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned BUY - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip BUY (${t.score}/${s.length})`}:e==="SELL"?i&&i.trend==="BULLISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BULLISH - opposing SELL signal"}:r&&r.trend==="BULLISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BULLISH - opposing SELL signal"}:l&&l.trend==="BULLISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BULLISH - weak SELL setup"}:a==="ALL_BEARISH"?{isValid:!0,confidence:85+n,reason:`All timeframes BEARISH - high probability SELL (${t.score}/${s.length} aligned)`}:a==="MIXED"&&n>=15?{isValid:!0,confidence:75+n,reason:`Strong multi-timeframe BEARISH alignment (${t.score}/${s.length})`}:a==="MIXED"&&d?{isValid:!0,confidence:70+n,reason:`Lower timeframes (5m/15m/1h) strongly aligned SELL - immediate opportunity (${t.score}/${s.length})`}:n>=10?{isValid:!0,confidence:65+n,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip SELL (${t.score}/${s.length})`}:{isValid:!1,confidence:50,reason:"Unknown signal type"}}function Sa(e){const t=[`Multi-Timeframe Alignment: ${e.type}`];t.push(`Score: ${e.score}/${e.trends.length}`),t.push(`Confidence Boost: +${e.confidenceBoost}%`),t.push(""),t.push("Timeframe Analysis:");for(const s of e.trends){const a=s.trend==="BULLISH"?"📈":s.trend==="BEARISH"?"📉":"➡️";t.push(`  ${a} ${s.timeframe.padEnd(6)}: ${s.trend.padEnd(8)} (${s.confidence.toFixed(0)}% confident, ${s.strength.toFixed(0)}% strength)`)}return t.join(`
`)}const ls=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Mt,determineTrend:os,formatAlignmentReport:Sa,validateMultiTimeframeSignal:At},Symbol.toStringTag,{value:"Module"}));function Pt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),a=Math.floor((1-t)*s.length);return Math.abs(s[a]||0)}function Ta(e,t){const s=Pt(e,.95),a=Pt(e,.99),n=t*s,i=t*a;return{var_95:parseFloat(n.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function ka(e,t,s,a){const n=t-e,i=n/t*100;let r=0;for(let c=a.length-1;c>=0&&a[c].balance<t;c--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(n.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function Ra(e,t,s=5){let a=0;const n=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=d/t*100;a+=d,n.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=a/t*100,r=i<=s,l=t*(s/100)-a;return{total_open_positions:e.length,total_risk_amount:parseFloat(a.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:n}}function La(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),a=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&a.push({index:o,value:s[o]});if(a.length<3)return null;const n=a.slice(-3),[i,r,l]=n;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(r.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function Aa(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),a=s.slice(0,10),n=s.slice(10);if((a[a.length-1]-a[0])/a[0]>.02&&(Math.max(...n)-Math.min(...n))/n[0]<.015){const o=s[s.length-1],c=a[a.length-1]-a[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function Ia(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),a=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=a.slice(0,6),l=a.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,p=c+(c-Math.min(...a));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function Ma(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),a=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&a.push({index:o,value:s[o]});if(a.length<2)return null;const n=a.slice(-2),[i,r]=n;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,c=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function Da(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),a=s[0],n=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(a-i)/a<.02&&n<a*.95){const l=s.slice(25),o=Math.min(...l),c=(i-o)/i;if(c>.01&&c<.05){const d=a-n,p=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function Fa(e){const t=[],s=La(e);s&&t.push(s);const a=Aa(e);a&&t.push(a);const n=Ia(e);n&&t.push(n);const i=Ma(e);i&&t.push(i);const r=Da(e);r&&t.push(r);let l=0,o=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(o++,c+=m.confidence);let d="neutral",p=0;l>o?(d="bullish",p=Math.min(c/l/10,15)):o>l&&(d="bearish",p=Math.min(c/o/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const m=t.map(_=>_.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(p.toFixed(1)),summary:u}}function $a(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Na(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const n=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=n*10}const a=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(a*10,30),Math.min(Math.round(s),100)}function Oa(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const a=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(a>.9||a<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function Ca(e,t,s){const a=$a(t.atr_14,s),n=Na(t,s),i=Oa(t,s);let r,l,o,c,d,p;const u=e.slice(-10),m=u.map(y=>y.volume||0),_=m.reduce((y,x)=>y+x,0)/m.length,f=(u[u.length-1].volume||0)>_*1.5;return a==="EXTREME"&&f?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,c="Wait for direction",d=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&n>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&n>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,p="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,p="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:a,trend_strength:n,mean_reversion_score:i,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:p}}function Pa(e){const t=e.length;let s=0,a=0,n=0,i=0;for(let o=0;o<t;o++)s+=o,a+=e[o],n+=o*e[o],i+=o*o;const r=(t*n-s*a)/(t*i-s*s),l=(a-r*s)/t;return{slope:r,intercept:l}}function Ba(e,t,s){const a=e.map(l=>l.close),n=2/(t+1);let i=a[0];for(let l=1;l<a.length;l++)i=(a[l]-i)*n+i;const r=(a[a.length-1]-a[a.length-10])/10;return i+r*s}function Ha(e,t){const s=e.map(l=>l.close).slice(-20),a=[];for(let l=1;l<s.length;l++)a.push(s[l]-s[l-1]);const r=a.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function Ua(e,t,s){const a=e[e.length-1].close;e.map(r=>r.close).slice(-20);let n=0;t.rsi_14>50?n+=t.rsi_14-50:n-=50-t.rsi_14,t.macd>t.macd_signal?n+=20:n-=20,a>t.sma_20&&(n+=10),a>t.sma_50&&(n+=10);const i=n/100*s;return a+t.atr_14*i}function ja(e,t){const s=e.map(u=>u.close),a=s[s.length-1],n=10,i=s.slice(-n),r=Math.min(...i),l=Math.max(...i),o=i.map(u=>(u-r)/(l-r));let c={index:0,similarity:-1/0};for(let u=n;u<s.length-n-t;u++){const m=s.slice(u-n,u),_=Math.min(...m),g=Math.max(...m),f=m.map(b=>(b-_)/(g-_));let y=0;for(let b=0;b<n;b++)y+=Math.pow(o[b]-f[b],2);const x=-y;x>c.similarity&&(c={index:u,similarity:x})}const p=(s[c.index+t]-s[c.index])*(a/s[c.index]);return a+p}function kt(e,t,s){const a=[],n=[],i=e.map(E=>E.close),{slope:r,intercept:l}=Pa(i.slice(-20)),o=r*(i.length-1+s)+l;a.push(o),n.push(1);const c=Ba(e,12,s);a.push(c),n.push(1.5);const d=Ha(e,s);a.push(d),n.push(1.2);const p=Ua(e,t,s);a.push(p),n.push(1.8);const u=ja(e,s);a.push(u),n.push(1.3);const m=n.reduce((E,P)=>E+P,0),g=a.reduce((E,P,U)=>E+P*n[U],0)/m,f=a.reduce((E,P)=>E+P,0)/a.length,y=a.reduce((E,P)=>E+Math.pow(P-f,2),0)/a.length,x=Math.sqrt(y),b=e[e.length-1].close,v=1-x/b,j=Math.max(50,Math.min(95,v*100));return{prediction:g,confidence:j}}function Wa(e,t){const s=e[e.length-1].close,a=[],n=kt(e,t,1),i=n.prediction-s,r=i/s*100;a.push({timeframe:"1h",predicted_price:parseFloat(n.prediction.toFixed(2)),confidence_interval_upper:parseFloat((n.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((n.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(n.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=kt(e,t,4),o=l.prediction-s,c=o/s*100;a.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=kt(e,t,24),p=d.prediction-s,u=p/s*100;a.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const m=a.filter(x=>x.direction==="UP").length,_=a.filter(x=>x.direction==="DOWN").length;let g,f=0;m>_?(g="BULLISH",f=Math.min(m*5,15)):_>m?(g="BEARISH",f=Math.min(_*5,15)):g="NEUTRAL";const y=`ML models predict ${g} movement. 1h: ${a[0].direction} (${a[0].expected_move_pct.toFixed(2)}%), 4h: ${a[1].direction} (${a[1].expected_move_pct.toFixed(2)}%), 24h: ${a[2].direction} (${a[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:a,overall_direction:g,confidence_boost:parseFloat(f.toFixed(1)),summary:y}}function Rt(e,t,s,a,n){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(a-50)/10;l+=o;const c=(n-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function Va(e,t,s,a,n){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,n==="BUY"){const o=(a-50)/10;l-=o}else{const o=(a-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function Ya(e,t,s,a,n,i){const r=(s-e)*.5,l=(a-e)*.3,o=(n-e)*.2,c=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*c}function Ga(e,t,s){const a=e.price,n=t.atr_14;let i=50;e.signal_type==="BUY"?(a>t.sma_20&&(i+=10),a>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(a<t.sma_20&&(i+=10),a<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let b=14;b<r.length;b++){const v=r.slice(b-14,b);let j=0;for(let E=1;E<v.length;E++){const P=Math.max(v[E].high-v[E].low,Math.abs(v[E].high-v[E-1].close),Math.abs(v[E].low-v[E-1].close));j+=P}l.push(j/14)}const o=l.reduce((b,v)=>b+v,0)/l.length,c=n/o,d=Rt(a,e.take_profit_1,n,i,c),p=Rt(a,e.take_profit_2,n,i,c),u=Rt(a,e.take_profit_3,n,i,c),m=Va(a,e.stop_loss,n,i,e.signal_type),_=Ya(a,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:p,tp3:u,sl:m}),f=(d+p+u)/3/m;let y;d>70&&_>5&&f>2?y="STRONG_TRADE":d>60&&_>0&&f>1.5?y="GOOD_TRADE":d>50&&_>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const x=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${_.toFixed(2)}. Risk-adjusted R:R: ${f.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(_.toFixed(2)),risk_reward_adjusted:parseFloat(f.toFixed(2)),recommendation:y,summary:x}}function cs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=qa(e),s=za(),a=Ka(e,s.session),n=Xa(t,s.session),i=Za(t,s),r=Qa(t,s,a,i),l=Ja(r,t,s,a),o=en(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:a.spread_pips,price_impact_bps:Math.round(n),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function qa(e){const t=e.slice(-10),s=e.slice(-20,-10),a=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,n=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,r=n/a;let l;n>i*1.2?l="INCREASING":n<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:a,current_volume:n,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function za(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),a=t*60+s;let n,i;return a>=780&&a<960?(n="OVERLAP",i="HIGH"):a>=480&&a<780?(n="LONDON",i="HIGH"):a>=960&&a<1320?(n="NEW_YORK",i="HIGH"):a>=0&&a<480?(n="ASIA",i="MEDIUM"):(n="OFF_HOURS",i="LOW"),{zone:i,session:n}}function Ka(e,t){const s=e.slice(-20);let a=0;for(const d of s){const p=d.high-d.low;a+=p}const n=a/s.length,i=s[s.length-1].close,r=n/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,c=l*o;return{spread_pips:Math.round(c)}}function Xa(e,t){let s=10;const n={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*n*i}function Za(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function Qa(e,t,s,a){const n=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=a*.2;return n+i+r+l}function Ja(e,t,s,a){const n=[];return e<50&&n.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&n.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&n.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),a.spread_pips>50&&n.push(`⚠️ WIDE SPREADS: Estimated ${a.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&n.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),n}function en(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Dt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function tn(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Et(e=30){const t=[],s=new Date;for(const n of Dt){const i=new Date(n),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:n,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:n,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let n=0;n<=e;n++){const i=new Date(s.getTime()+n*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),c=i.getDay();if(o===tn(r,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((n,i,r)=>i===r.findIndex(l=>l.date===n.date&&l.time===n.time&&l.title===n.title)).sort((n,i)=>{const r=new Date(`${n.date}T${n.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function ct(e=new Date,t=[]){const s=[...Et(7),...t],a=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),n=e.toISOString().split("T")[0];if(s.filter(r=>r.date===n&&r.impact==="high"),Dt.includes(n))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:a,nextSafeTime:sn(n)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:a,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:a}}function sn(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function ht(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let a="🔴";return e.impact==="medium"&&(a="🟡"),e.impact==="low"&&(a="🟢"),`${a} ${e.date} ${s} UTC - ${e.title}`}function an(e){const t=e.toISOString().split("T")[0];return Dt.includes(t)?!0:Et(30).filter(n=>n.date===t&&n.impact==="high").length>=2}function nn(){const e=new Date().toISOString().split("T")[0];return Et(7).filter(s=>s.date===e)}function ds(e=new Date){const t=ct(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const us=new _e;us.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const a={},n={};for(const O of["5m","15m","1h","4h","daily"]){const F=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(O).first();F&&(a[O]=F);const B=await t.prepare(`
        SELECT timestamp, open, high, low, close, volume 
        FROM market_data 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(O).all();B.results&&B.results.length>0&&(n[O]=B.results.map(w=>({timestamp:w.timestamp,open:w.open,high:w.high,low:w.low,close:w.close,volume:w.volume||0})))}if(Object.keys(a).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(a).length}. Please fetch multi-timeframe data first.`},400);const i=[];if(a["1h"]&&a["1h"].timestamp){const O=new Date(a["1h"].timestamp).getTime(),B=(Date.now()-O)/(1e3*60);B>60?i.push(`⚠️ WARNING: 1h data is ${B.toFixed(0)} minutes old (>60 min)`):B>30&&i.push(`⚠️ CAUTION: 1h data is ${B.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${B.toFixed(1)} minutes old`)}const r=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const O=new Date(r.timestamp).getTime(),F=(Date.now()-O)/(1e3*60);F>60&&i.push(`⚠️ WARNING: Price data is ${F.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${F.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ct(),c=ds();let d=null,p=!1;o.riskLevel==="danger"?(p=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const u=a["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(a).join(", ")}`},400);const m=Mt(a,l),_=se(l,u,"day_trade"),g=se(l,u,"swing_trade"),f=At(_.signal_type,m),y=At(g.signal_type,m),x={..._,base_confidence:_.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:m.score,alignment_type:m.type},b={...g,base_confidence:g.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type};let v=0,j="",E=[];if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20){try{const F=Fa(n["1h"]);E=(F==null?void 0:F.patterns)||[]}catch(F){console.error("[ENHANCED] Pattern detection error:",F.message)}const O=E.filter(F=>F.confidence>=70&&F.endIndex>=n["1h"].length-5);for(const F of O)F.type==="bullish"&&x.signal_type==="BUY"?(v+=F.confidence*.1,j+=`${F.name} (${F.confidence.toFixed(0)}%), `):F.type==="bearish"&&x.signal_type==="SELL"&&(v+=F.confidence*.1,j+=`${F.name} (${F.confidence.toFixed(0)}%), `);v=Math.min(15,v)}let P=0,U="",R=null;if(n["1h"]&&n["1h"].length>=50){const O=ve(n["1h"]);O&&(R=Ca(n["1h"],O),R.trend==="STRONG_UPTREND"&&x.signal_type==="BUY"?(P=10,U="Strong Uptrend"):R.trend==="UPTREND"&&x.signal_type==="BUY"?(P=5,U="Uptrend"):R.trend==="STRONG_DOWNTREND"&&x.signal_type==="SELL"?(P=10,U="Strong Downtrend"):R.trend==="DOWNTREND"&&x.signal_type==="SELL"&&(P=5,U="Downtrend"))}let S=0,L="",A=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{A=Wa(n["1h"],l),A.overall_direction==="BULLISH"&&x.signal_type==="BUY"?(S=A.confidence_boost,L=`ML predicts +${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):A.overall_direction==="BEARISH"&&x.signal_type==="SELL"&&(S=A.confidence_boost,L=`ML predicts ${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(O){console.error("[ENHANCED] ML prediction error:",O.message)}let T=0,re="",q=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{const O=ve(n["1h"]);O&&(q=Ga(x,O,n["1h"]),q.tp1_probability>70?(T=10,re=`PoP: TP1 ${q.tp1_probability.toFixed(0)}%`):q.tp1_probability>60&&(T=5,re=`PoP: TP1 ${q.tp1_probability.toFixed(0)}%`))}catch(O){console.error("[ENHANCED] Probability of Profit error:",O.message)}let I=null,z=0,D=0;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20)try{I=cs(n["1h"]),I.liquidity_score>=80?z=5:I.liquidity_score>=70?z=0:I.liquidity_score>=50?D=-5:D=-10,console.log(`[LIQUIDITY] Score: ${I.liquidity_score}/100, Session: ${I.session}, Adjust: ${z+D}%`)}catch(O){console.error("[ENHANCED] Liquidity Analysis error:",O.message)}let k=0,K=0,ee=0,oe=0,me="";try{const O=await t.prepare(`
      ...
      `).first(),F=await t.prepare(`
        ...
        LIMIT 30
      `).all(),B=await t.prepare(`
        SELECT * FROM open_trades 
        WHERE account_id = 1
      `).all();if(O&&F.results&&F.results.length>=10){const w=Ta(F.results,O.balance);k=w.var_95,K=w.var_99;const ae=ka(O.balance,F.results);if(ee=ae.current_drawdown_pct,ae.is_within_limit||(me+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),B.results){const C=Ra(B.results,O.balance);oe=C.total_risk_pct,C.is_within_limit||(me+=`⚠️ Portfolio heat ${oe.toFixed(1)}% exceeds limit. `)}}}catch(O){console.error("[ENHANCED] Risk metrics error (optional):",O.message)}const ge=v+P+S+T+z+D,V={...x,pattern_boost:v,regime_boost:P,ml_boost:S,pop_boost:T,total_boost:ge,enhanced_confidence:Math.min(98,x.final_confidence+ge),var_95:k,var_99:K,current_drawdown_pct:ee,portfolio_heat_pct:oe,risk_warning:me||null},N={...b,pattern_boost:v,regime_boost:P,ml_boost:S,pop_boost:T,total_boost:ge,enhanced_confidence:Math.min(98,b.final_confidence+ge),var_95:k,var_99:K,current_drawdown_pct:ee,portfolio_heat_pct:oe,risk_warning:me||null};p?(V.signal_type="HOLD",N.signal_type="HOLD",V.enhanced_confidence=50,N.enhanced_confidence=50,V.reasoning=d||"Economic event nearby - trading paused",N.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(V.enhanced_confidence=Math.max(50,V.enhanced_confidence+c.adjustment),N.enhanced_confidence=Math.max(50,N.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),V.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(O=>ht(O))},N.calendar_check=V.calendar_check;let Ee=!1;try{const O=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),F={};for(const B of O.results||[])F[B.setting_key]=B.setting_value;if(F.telegram_bot_token&&F.telegram_chat_id){const B=new Date().toLocaleString("en-US",{timeZone:"UTC"});let w=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${B} UTC

`;if(i.length>0){w+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const Y of i)w+=`${Y}
...
`,w+=`Next event: ${ht(o.upcomingEvents[0])}
...
`;for(const Y of m.trends){const X=Y.trend==="BULLISH"?"📈":Y.trend==="BEARISH"?"📉":"➡️";w+=`${X} *${Y.timeframe}*: ${Y.trend} (${Y.confidence.toFixed(0)}%)
`}if(w+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,w+=`📈 *DAY TRADE SIGNAL*
`,w+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,w+=`${V.isValid?"✅":"❌"} *${V.signal_type}* (${V.enhanced_confidence.toFixed(0)}% confidence)

`,w+=`*Entry:* $${V.price.toFixed(2)}
`,w+=`*Stop Loss:* $${V.stop_loss.toFixed(2)} (${((V.stop_loss/V.price-1)*100).toFixed(2)}%)
`,w+=`*TP1:* $${V.take_profit_1.toFixed(2)} (${((V.take_profit_1/V.price-1)*100).toFixed(2)}%)
`,w+=`*TP2:* $${V.take_profit_2.toFixed(2)} (${((V.take_profit_2/V.price-1)*100).toFixed(2)}%)
`,w+=`*TP3:* $${V.take_profit_3.toFixed(2)} (${((V.take_profit_3/V.price-1)*100).toFixed(2)}%)

`,w+=`*📊 Confidence Breakdown:*
`,w+=`Base: ${V.base_confidence.toFixed(0)}%
`,w+=`MTF: ${V.mtf_confidence.toFixed(0)}%
`,v>0&&(w+=`Pattern: +${v.toFixed(0)}%
`),P>0&&(w+=`Regime: +${P.toFixed(0)}%
`),S>0&&(w+=`ML: +${S.toFixed(0)}%
`),T>0&&(w+=`PoP: +${T.toFixed(0)}%
`),z!==0||D!==0){const Y=z+D;w+=`Liquidity: ${Y>=0?"+":""}${Y.toFixed(0)}%
`}w+=`*FINAL: ${V.enhanced_confidence.toFixed(0)}%*
...
`),w+=`
`),q&&(w+=`🎯 *Probability of Profit:*
`,w+=`TP1: ${q.tp1_probability.toFixed(0)}%
`,w+=`TP2: ${q.tp2_probability.toFixed(0)}%
`,w+=`TP3: ${q.tp3_probability.toFixed(0)}%
`,w+=`Expected Value: ${q.expected_value.toFixed(2)}R

`),w+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,w+=`💡 *RECOMMENDATION*
`,w+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,V.isValid&&V.signal_type!=="HOLD"?(w+=`✅ *EXECUTE ${V.signal_type}*
`,w+=`All hedge fund features aligned!
`):(w+=`⚠️ *SKIP TRADE*
`,w+=`Reason: ${V.mtf_reason}
`),w+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",w.length,"characters");const ae=await Z({botToken:F.telegram_bot_token,chatId:F.telegram_chat_id},w);let C=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if(I){const Y=I.liquidity_score>=80?"🟢":I.liquidity_score>=70?"🟡":I.liquidity_score>=50?"🟠":"🔴";if(C+=`🌊 *LIQUIDITY ANALYSIS*
`,C+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,C+=`${Y} *Score:* ${I.liquidity_score}/100
`,C+=`🕐 *Session:* ${I.session}
...
`,C+=`• VaR(95%): $${k.toFixed(2)}
`,C+=`• VaR(99%): $${K.toFixed(2)}
`,C+=`• Max Drawdown: ${ee.toFixed(2)}%
`,C+=`• Portfolio Heat: ${oe.toFixed(1)}%

`,o.upcomingEvents.length>0){C+=`📅 *Upcoming Events:*
`;for(const Y of o.upcomingEvents.slice(0,3))C+=`• ${ht(Y)}
`;C+=`
`}C+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,C+=`✅ Signal generated at ${B} UTC
`,C+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",C.length,"characters");const Ie=await Z({botToken:F.telegram_bot_token,chatId:F.telegram_chat_id},C);Ee=ae&&Ie}}catch(O){console.error("[ENHANCED] Telegram error (optional):",O.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Ee,day_trade:V,swing_trade:N,alignment:{type:m.type,score:m.score,trends:m.trends},patterns:E.length>0?E.slice(0,3):null,regime:R?{trend:R.trend,volatility:R.volatility,should_trade:R.should_trade}:null,ml_prediction:A?{direction:A.overall_direction,predictions:A.predictions}:null,profit_probability:q?{tp1:q.tp1_probability,tp2:q.tp2_probability,tp3:q.tp3_probability,expected_value:q.expected_value}:null,liquidity:I?{score:I.liquidity_score,session:I.session,time_zone:I.time_of_day_zone,volume_trend:I.volume_trend,volume_percentile:I.volume_percentile,estimated_spread_pips:I.estimated_spread_pips,price_impact_bps:I.price_impact_bps,market_depth_score:I.market_depth_score,optimal_for_trading:I.optimal_for_trading,warnings:I.warnings,recommendation:I.recommendation}:null,risk_metrics:{var_95:k,var_99:K,drawdown_pct:ee,portfolio_heat_pct:oe}})}catch(a){return console.error("[ENHANCED] Error:",a.message,a.stack),e.json({success:!1,error:a.message,stack:a.stack},500)}});const ps=new _e;ps.post("/simple",async e=>{var s,a,n,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,b+=`⏰ ${x}`,console.log("[SIMPLE] Sending Telegram message, length:",b.length),_=await Z({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},b),console.log("[SIMPLE] Telegram sent:",_),_||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(g){console.error("[SIMPLE] Telegram error:",g.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:_,day_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"day_trade"},swing_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(c),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"swing_trade"}})}catch(r){return console.error("[SIMPLE] Error:",r.message,r.stack),e.json({success:!1,error:r.message,stack:r.stack},500)}});function rn(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function on(e=new Date){const t=e.getUTCDay(),a=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${a} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${a} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${a} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${a} (market closed)`}:{hasBoost:!1,boost:0,reason:`${a} (standard day)`}}function ln(e,t){return e>t*1.1}function cn(e){let t=0,s=0,a=0;for(const l of e){const o=l.volume||0;a+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const n=s>0?t/s:t>0?10:1;let i="NEUTRAL";n>1.5?i="BUYING":n<.67&&(i="SELLING");let r=0;return n>3?r=100:n>1.5?r=50+(n-1.5)/1.5*50:n>.67?r=(n-.67)/.83*50:n>.33?r=50+(.67-n)/.34*50:r=100,{uptickVolume:t,downtickVolume:s,totalVolume:a,pressureRatio:n,signal:i,strength:Math.round(r)}}function ms(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function dn(e,t){const a=ms(e,t)?"✅":"❌";return e.signal==="BUYING"?`${a} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${a} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${a} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function un(e){if(e.length<3)return[];const t=[],s=e[e.length-3],a=e[e.length-2],n=e[e.length-1];return pn(n)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),mn(n)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),gn(a,n)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),_n(a,n)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),fn(s,a,n)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),hn(s,a,n)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),yn(s,a,n)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),bn(s,a,n)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),vn(n)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),wn(n)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function pn(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>=t*2&&a<=t*.1&&t>0}function mn(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function gn(e,t){const s=e.close<e.open,a=t.close>t.open;return s&&a&&t.open<e.close&&t.close>e.open}function _n(e,t){const s=e.close>e.open,a=t.close<t.open;return s&&a&&t.open>e.close&&t.close<e.open}function fn(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close<e.open,l=s.close>s.open;return r&&n<a*.5&&l&&i>a*.6&&s.close>(e.open+e.close)/2}function hn(e,t,s){const a=Math.abs(e.close-e.open),n=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close>e.open,l=s.close<s.open;return r&&n<a*.5&&l&&i>a*.6&&s.close<(e.open+e.close)/2}function yn(e,t,s){const a=e.close>e.open&&t.close>t.open&&s.close>s.open,n=t.high>e.high&&s.high>t.high,i=t.low>e.low&&s.low>t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&i&&r>c&&l>c&&o>c}function bn(e,t,s){const a=e.close<e.open&&t.close<t.open&&s.close<s.open,n=t.high<e.high&&s.high<t.high,i=t.low<e.low&&s.low<t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return a&&n&&i&&r>c&&l>c&&o>c}function vn(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function wn(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,a=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&a>t*.5&&n>t*.5}function En(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const a of e)a.strength>s.strength&&(s=a);if(t==="BUY"){const a=e.some(n=>n.type==="BULLISH_REVERSAL"||n.type==="BULLISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}if(t==="SELL"){const a=e.some(n=>n.type==="BEARISH_REVERSAL"||n.type==="BEARISH_CONTINUATION");return{aligned:a,strongestPattern:a?s:null}}return{aligned:!1,strongestPattern:null}}const dt=new _e;dt.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const a=s.toISOString();console.log("[5M-SCANNER] Starting scan at",a),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).all()).results.map(_=>({timestamp:_.timestamp,open:Number(_.open),high:Number(_.high),low:Number(_.low),close:Number(_.close),volume:Number(_.volume)||0})).reverse(),c=o[o.length-1].close;console.log("[5M-SCANNER] Step 7: Starting 7-layer analysis");const d=await xn(t,n,i,r,o,c);console.log("[5M-SCANNER] Step 8: Analysis complete:",{grade:d.grade,score:d.score,signal:d.signal}),console.log("[5M-SCANNER] Step 9: Saving to database");const p=new Date().toISOString();console.log("[5M-SCANNER] Step 10: Timestamp created:",p),await t.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(p,"5m",d.signal,d.grade,d.score,c,d.stopLoss,d.tp1,d.tp2,d.tp3,d.confidence,d.layersPassed,d.liquidityScore,d.session,0).run();let u=!1;if(d.grade==="A"||d.grade==="A+")try{const _=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),g={};for(const f of _.results||[])g[f.setting_key]=f.setting_value;if(g.telegram_bot_token&&g.telegram_chat_id){const f=gs(d,c);u=await Z({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},f),await t.prepare(`
            UPDATE scanner_history 
            SET telegram_sent = ?
            WHERE timestamp = (SELECT MAX(timestamp) FROM scanner_history)
          `).bind(u?1:0).run(),console.log("[5M-SCANNER] Telegram alert sent:",u)}}catch(_){console.error("[5M-SCANNER] Telegram error:",_.message)}const m=new Date;return console.log("[5M-SCANNER] Scan complete, returning results"),e.json({success:!0,timestamp:m.toISOString(),scan_result:{grade:d.grade,score:d.score,signal:d.signal,confidence:d.confidence,entry:c,stop_loss:d.stopLoss,targets:[d.tp1,d.tp2,d.tp3],layers_passed:d.layersPassed,telegram_sent:u}})}catch(s){console.error("[5M-SCANNER] Error caught:",s);const a=(s==null?void 0:s.message)||String(s);return console.error("[5M-SCANNER] Error message:",a),e.json({success:!1,error:a},500)}});dt.get("/stats",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});dt.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),a={};for(const c of s.results||[])a[c.setting_key]=c.setting_value;if(!a.telegram_bot_token||!a.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const n=4386.5,i=15,r={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:n-i,tp1:n+i*2,tp2:n+i*3,tp3:n+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=gs(r,n),o=await Z({botToken:a.telegram_bot_token,chatId:a.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function xn(e,t,s,a,n,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],c=(Y,X)=>{const pt=parseFloat(String(Y));return isNaN(pt)?X:pt};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,i),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},p={ema50:c(s.ema_26,i)},u={sma200:c(a.sma_200,i)},m=i>d.ema20&&i>p.ema50&&i>u.sma200,_=i<d.ema20&&i<p.ema50&&i<u.sma200;m||_?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const g=d.rsi>=40&&d.rsi<=60,f=d.macd>d.macd_signal&&d.macd_histogram>0,y=d.macd<d.macd_signal&&d.macd_histogram<0;g&&(m?f:y)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${g?"no crossover":"extreme"}`);const x=n.slice(-20).reduce((Y,X)=>Y+X.volume,0)/20,b=n[n.length-1].volume;b>x*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(b/x).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(b/x).toFixed(1)}x (need 1.5x+)`);const j=Math.max(...n.slice(-20).map(Y=>Y.high)),E=Math.min(...n.slice(-20).map(Y=>Y.low)),P=i>j*.999,U=i<E*1.001;m&&P||_&&U?(r+=15,l++,o.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let R=null;try{R=await cs(n),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Y){console.log("[5M-SCANNER] Liquidity calc failed:",Y)}const S=(R==null?void 0:R.liquidity_score)||50,L=(R==null?void 0:R.session)||"UNKNOWN";S>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${S}/100 (${L} session)`)):o.push(`❌ Layer 5: Liquidity ${S}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const T=ct();console.log("[ANALYZE] Calendar check complete"),T.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${T.reason}`);const q=d.adx>25,I=d.adx>70;q&&!I?(r+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):I?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let z="HOLD";(m||_)&&l>=5&&(z=m?"BUY":"SELL");const D=new Date,k=rn(D);k.hasBoost?(r+=8,l++,o.push(`✅ Layer 8: ${k.reason} (+${k.boost}% win)`)):o.push(`ℹ️ Layer 8: ${k.reason}`);const K=on(D);K.hasBoost?(r+=5,l++,o.push(`✅ Layer 9: ${K.reason} (+${K.boost}% win)`)):o.push(`ℹ️ Layer 9: ${K.reason}`);const ee=c(t.atr_14,i*.01),oe=n.slice(-20).reduce((Y,X)=>{const pt=X.high-X.low;return Y+pt},0)/20;if(ln(ee,oe)){r+=7,l++;const Y=((ee/oe-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Y}% (high volatility)`)}else{const Y=((1-ee/oe)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Y}% (skip low volatility)`)}const ge=cn(n.slice(-20));ms(ge,z)&&ge.strength>=60&&(r+=10,l++),o.push(dn(ge,z));const N=un(n.slice(-3)),{aligned:Ee,strongestPattern:O}=En(N,z);Ee&&O?(r+=12,l++,o.push(`✅ Layer 12: ${O.name} (${O.strength}/100)`)):N.length>0&&N[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${N[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");let F="C";r>=90?F="A+":r>=80?F="A":r>=70&&(F="B"),(m||_)&&l>=7&&(z=m?"BUY":"SELL");const B=Math.max(ee*1.5,i*.003),w=z==="BUY"?i-B:i+B,ae=z==="BUY"?i+B*2:i-B*2,C=z==="BUY"?i+B*3:i-B*3,Ie=z==="BUY"?i+B*4:i-B*4;return{grade:F,score:r,signal:z,confidence:r,layersPassed:l,layers:o,stopLoss:w,tp1:ae,tp2:C,tp3:Ie,liquidityScore:S,session:L,adx:d.adx,rsi:d.rsi,volumeRatio:b/x}}function gs(e,t){const s=e.signal==="BUY"?"🟢":"🔴",a=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",n=new Date,i=`${n.getUTCHours().toString().padStart(2,"0")}:${n.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,r+="Next scan in 5 minutes...",r}async function Ze(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,r,l,o,e).run();const d=(await Ze(a)).current_balance+r;return await a.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await ys(a),await Tn(a),await kn(a),{success:!0,profit_loss:r}}catch(n){return{success:!1,error:n.message}}}async function ys(e){const t=await Ze(e),s=await e.prepare(`
  ...
  `).all();let a=0;for(const i of s.results||[]){const r=i,o=Math.abs(r.entry_price-r.stop_loss)*r.position_size;a+=o}const n=a/t.current_balance*100;await e.prepare(`
    ...
    SET current_portfolio_risk = ?,
        updated_at = CURRENT_TIMESTAMP
    WHERE id = 1
  `).bind(n).run()}async function Tn(e){const t=new Date().toISOString().split("T")[0],s=await e.prepare(`
    SELECT * FROM live_trades 
    WHERE DATE(exit_time) = ? AND status = 'CLOSED'
  `).bind(t).all();if(s.results.length===0)return;const a=s.results,n=a.length,i=a.filter(m=>m.win===1).length,r=a.filter(m=>m.win===0).length,l=i/n*100,o=a.reduce((m,_)=>m+(_.profit_loss||0),0),c=Math.max(...a.map(m=>m.profit_loss||0)),d=Math.min(...a.map(m=>m.profit_loss||0)),p=a.reduce((m,_)=>m+(_.confidence||0),0)/n,u=a.reduce((m,_)=>m+(_.mtf_score||0),0)/n;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,n,i,r,l,o,c,d,p,u).run()}async function kn(e){const t=await Ze(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,a=new Date().toISOString().split("T")[0],n=await e.prepare(`
  ...
  `).bind(s,i).run();let r=!1,l="";s>=t.max_drawdown_pct?(r=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(r=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),r&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});pe.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Ae=new _e;Ae.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Et(t);return e.json({success:!0,count:s.length,events:s.map(a=>({...a,formatted:ht(a)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Ae.get("/today",async e=>{try{const t=nn(),s=ct();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Ae.get("/check",async e=>{try{const t=ct(),s=ds();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Ae.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let a=0;a<30;a++){const n=new Date(t.getTime()+a*24*60*60*1e3);an(n)&&s.push(n.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Ae.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
    ...
    `).bind(s).run(),e.json({success:!0,message:"Event deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});function ws(e,t,s){const a=s.find(y=>t.confidence>=y.confidence_min&&t.confidence<=y.confidence_max);if(!a)return{units:0,value:0,risk_amount:0,risk_pct:0,position_pct:0,stop_loss_distance:0,reward_risk_ratio:0,is_valid:!1,warning:`No position sizing rule found for confidence ${t.confidence}%`};const n=Math.abs(t.entry_price-t.stop_loss),r=e.current_balance*(a.risk_pct/100)/n,l=r*t.entry_price;l/e.current_balance*100;const o=e.current_balance*(a.max_position_pct/100);let c=r,d=l,p=a.risk_pct,u;l>o&&(d=o,c=o/t.entry_price,p=c*n/e.current_balance*100,u=`Position reduced to ${a.max_position_pct}% max position size`);const _=Math.abs(t.take_profit_1-t.entry_price)/n;let g=!0;const f=[];return u&&f.push(u),_<1.5&&f.push(`Low reward:risk ratio (${_.toFixed(2)}:1). Recommended: >1.5:1`),p>e.max_daily_loss_pct&&(g=!1,f.push(`Risk ${p.toFixed(2)}% exceeds max daily loss ${e.max_daily_loss_pct}%`)),c<.01&&(g=!1,f.push("Position size too small (minimum 0.01 lots)")),{units:parseFloat(c.toFixed(2)),value:parseFloat(d.toFixed(2)),risk_amount:parseFloat((c*n).toFixed(2)),risk_pct:parseFloat(p.toFixed(2)),position_pct:parseFloat((d/e.current_balance*100).toFixed(2)),stop_loss_distance:parseFloat(n.toFixed(2)),reward_risk_ratio:parseFloat(_.toFixed(2)),is_valid:g,warning:f.length>0?f.join("; "):void 0}}function Es(e,t,s,a,n=0){let i;a==="BUY"?i=(t-e)*s:i=(e-t)*s,i-=n;const r=(t-e)/e*100,l=Math.abs(t-e)/.01;return{profit_loss:parseFloat(i.toFixed(2)),profit_loss_pct:parseFloat(r.toFixed(2)),pips:parseFloat(l.toFixed(1))}}function Rn(e,t){const s=t.filter(l=>l.profit_loss<0).reduce((l,o)=>l+o.profit_loss,0),a=Math.abs(s/e.current_balance)*100,n=a>=e.max_daily_loss_pct,r=e.current_balance*(e.max_daily_loss_pct/100)-Math.abs(s);return{current_loss:parseFloat(s.toFixed(2)),current_loss_pct:parseFloat(a.toFixed(2)),limit_exceeded:n,remaining:parseFloat(r.toFixed(2))}}function Ln(e){const t=e.filter(g=>g.status==="CLOSED"),s=t.filter(g=>g.profit_loss>0),a=t.filter(g=>g.profit_loss<0),n=s.reduce((g,f)=>g+f.profit_loss,0),i=Math.abs(a.reduce((g,f)=>g+f.profit_loss,0)),r=n-i,l=s.length>0?n/s.length:0,o=a.length>0?i/a.length:0,c=t.length>0?s.length/t.length*100:0,d=i>0?n/i:n,p=100-c,u=c/100*l-p/100*o,m=s.length>0?Math.max(...s.map(g=>g.profit_loss)):0,_=a.length>0?Math.min(...a.map(g=>g.profit_loss)):0;return{total_trades:t.length,winning_trades:s.length,losing_trades:a.length,win_rate:parseFloat(c.toFixed(2)),total_profit:parseFloat(n.toFixed(2)),total_loss:parseFloat(i.toFixed(2)),net_profit:parseFloat(r.toFixed(2)),avg_win:parseFloat(l.toFixed(2)),avg_loss:parseFloat(o.toFixed(2)),profit_factor:parseFloat(d.toFixed(2)),expectancy:parseFloat(u.toFixed(2)),largest_win:parseFloat(m.toFixed(2)),largest_loss:parseFloat(_.toFixed(2))}}function An(e){return e.is_valid?`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ut=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Ln,calculatePositionSize:ws,calculateProfitLoss:Es,checkDailyLossLimit:Rn,formatPositionSize:An},Symbol.toStringTag,{value:"Module"}));async function xs(e,t,s){const a=Date.now(),n=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(k=>{const K=new Date(k.timestamp);return K>=new Date(t.start_date)&&K<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:r,max_daily_loss_pct:2};for(let k=200;k<o.length;k++){const K=o.slice(k-200,k),ee=ve(K);if(!ee)continue;const oe=o[k],me=oe.close,ge=se(me,ee,"day_trade"),V=se(me,ee,"swing_trade");for(const N of[ge,V]){if(N.signal_type==="HOLD"||N.confidence<t.min_confidence)continue;c.current_balance=r;const Ee=ws(c,{entry_price:N.price,stop_loss:N.stop_loss,take_profit_1:N.take_profit_1,take_profit_2:N.take_profit_2,take_profit_3:N.take_profit_3,confidence:N.confidence,signal_type:N.signal_type,trading_style:N.trading_style},s);if(!Ee.is_valid)continue;const O=oe.timestamp,F=N.price;let B=null,w=null,ae="UNKNOWN";const C=Math.min(50,o.length-k-1);for(let Y=1;Y<=C;Y++){const X=o[k+Y];if(N.signal_type==="BUY"){if(X.low<=N.stop_loss){B=N.stop_loss,w=X.timestamp,ae="STOP_LOSS";break}if(X.high>=N.take_profit_3){B=N.take_profit_3,w=X.timestamp,ae="TP3";break}if(X.high>=N.take_profit_2){B=N.take_profit_2,w=X.timestamp,ae="TP2";break}if(X.high>=N.take_profit_1){B=N.take_profit_1,w=X.timestamp,ae="TP1";break}}else{if(X.high>=N.stop_loss){B=N.stop_loss,w=X.timestamp,ae="STOP_LOSS";break}if(X.low<=N.take_profit_3){B=N.take_profit_3,w=X.timestamp,ae="TP3";break}if(X.low<=N.take_profit_2){B=N.take_profit_2,w=X.timestamp,ae="TP2";break}if(X.low<=N.take_profit_1){B=N.take_profit_1,w=X.timestamp,ae="TP1";break}}}if(!B||!w)continue;const Ie=Es(F,B,Ee.units,N.signal_type,t.commission_per_trade);r+=Ie.profit_loss,r>l&&(l=r),n.push({entry_time:O,entry_price:F,exit_time:w,exit_price:B,signal_type:N.signal_type,trading_style:N.trading_style,position_size:Ee.units,profit_loss:Ie.profit_loss,profit_loss_pct:Ie.profit_loss_pct,exit_reason:ae,confidence:N.confidence}),i.push({date:w,balance:r})}}const d=n.filter(k=>k.profit_loss>0),p=n.filter(k=>k.profit_loss<0),u=d.reduce((k,K)=>k+K.profit_loss,0),m=Math.abs(p.reduce((k,K)=>k+K.profit_loss,0)),_=r-t.starting_balance,g=n.length>0?d.length/n.length*100:0,f=d.length>0?u/d.length:0,y=p.length>0?m/p.length:0,x=d.length>0?Math.max(...d.map(k=>k.profit_loss)):0,b=p.length>0?Math.min(...p.map(k=>k.profit_loss)):0,v=m>0?u/m:u,j=100-g,E=g/100*f-j/100*y;let P=0,U=0,R=t.starting_balance;for(const k of i){k.balance>R&&(R=k.balance);const K=R-k.balance,ee=K/R*100;K>P&&(P=K,U=ee)}const S=n.map(k=>k.profit_loss_pct),L=S.reduce((k,K)=>k+K,0)/S.length,A=Math.sqrt(S.reduce((k,K)=>k+Math.pow(K-L,2),0)/S.length),T=A>0?L/A:0;let re=0,q=0,I=0,z=0;for(const k of n)k.profit_loss>0?(I++,z=0,re=Math.max(re,I)):(z++,I=0,q=Math.max(q,z));const D=Date.now()-a;return{config:t,total_trades:n.length,winning_trades:d.length,losing_trades:p.length,win_rate:parseFloat(g.toFixed(2)),net_profit:parseFloat(_.toFixed(2)),total_return_pct:parseFloat((_/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(f.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(x.toFixed(2)),largest_loss:parseFloat(b.toFixed(2)),max_drawdown:parseFloat(P.toFixed(2)),max_drawdown_pct:parseFloat(U.toFixed(2)),profit_factor:parseFloat(v.toFixed(2)),sharpe_ratio:parseFloat(T.toFixed(2)),expectancy:parseFloat(E.toFixed(2)),max_consecutive_wins:re,max_consecutive_losses:q,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:n,equity_curve:i,execution_time_ms:D}}function Ss(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const In=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Ss,runBacktest:xs},Symbol.toStringTag,{value:"Module"})),Qe=new _e;Qe.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp ASC
    `).all();if(a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Have ${a.results.length} candles, need at least 200. System has been collecting data since Dec 26 - wait a few more days or reduce timeframe.`},400);const n=a.results.map(d=>({timestamp:d.timestamp,open:d.open,high:d.high,low:d.low,close:d.close,volume:d.volume||0})),i={start_date:s.start_date||new Date(Date.now()-365*24*60*60*1e3).toISOString(),end_date:s.end_date||new Date().toISOString(),starting_balance:s.starting_balance||1e4,min_confidence:s.min_confidence||75,use_mtf_confirmation:s.use_mtf_confirmation!==!1,use_news_filter:s.use_news_filter!==!1,timeframe:s.timeframe||"1h",commission_per_trade:s.commission_per_trade||0},l=await xs(n,i,[{confidence_min:90,confidence_max:100,risk_pct:2,max_position_pct:10},{confidence_min:80,confidence_max:89,risk_pct:1.5,max_position_pct:7.5},{confidence_min:75,confidence_max:79,risk_pct:1,max_position_pct:5},{confidence_min:70,confidence_max:74,risk_pct:.5,max_position_pct:2.5}]),o=await t.prepare(`
    ...
    `).bind(s.run_name||`Backtest ${new Date().toISOString()}`,i.start_date,i.end_date,i.starting_balance,i.min_confidence,i.use_mtf_confirmation?1:0,i.use_news_filter?1:0,i.timeframe,l.total_trades,l.winning_trades,l.win_rate,l.net_profit,l.total_return_pct,l.max_drawdown_pct,l.profit_factor,l.sharpe_ratio,JSON.stringify(l.trades),JSON.stringify(l.equity_curve)).run();let c=!1;try{const d=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings 
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),p={};if(d.results.forEach(u=>{u.setting_key==="telegram_bot_token"&&(p.telegram_bot_token=u.setting_value),u.setting_key==="telegram_chat_id"&&(p.telegram_chat_id=u.setting_value)}),p.telegram_bot_token&&p.telegram_chat_id){const u=l;let m="",_="";u.total_trades<10?(m="⏳ INSUFFICIENT DATA",_="⏳"):u.total_trades<50?(m="⚠️ SMALL SAMPLE SIZE",_="⚠️"):u.win_rate>=70&&u.profit_factor>=2?(m="✅ STRATEGY VALIDATED",_="✅"):u.win_rate>=60?(m="⚠️ GOOD PERFORMANCE",_="⚠️"):(m="❌ NEEDS IMPROVEMENT",_="❌");const g=`
🎯 *BACKTEST COMPLETE*
...
📅 Backtest ID: ${o.meta.last_row_id}
        `.trim();c=await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},g)}}catch(d){console.error("[BACKTEST] Telegram send failed:",d)}return e.json({success:!0,backtest_id:o.meta.last_row_id,result:l,formatted:Ss(l),telegram_sent:c})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});Qe.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),a=await t.prepare(`
      SELECT 
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const ks=new _e;ks.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
    ...
    `).all();let a="";for(const S of s.results||[])S.setting_key==="twelve_data_api_key"&&(a=S.setting_value);let n=[];if(a&&a!=="your_api_key_here")try{const S=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,A=await(await fetch(S)).json();A.values&&A.values.length>=50&&(n=A.values.reverse().map(T=>({timestamp:T.datetime,open:parseFloat(T.open),high:parseFloat(T.high),low:parseFloat(T.low),close:parseFloat(T.close),volume:parseFloat(T.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",n.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(n.length===0){const S=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!S.results||S.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);n=S.results.reverse().map(L=>({timestamp:L.timestamp,open:L.open,high:L.high,low:L.low,close:L.close,volume:L.volume||0}))}const i=ve(n);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=n[n.length-1].close,l=se(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const S of["5m","15m","1h","4h","daily"]){const L=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(S).first();L&&(o[S]=L)}const c=Mt(o,r),d=n.slice(-50),p=d.map(S=>S.high).sort((S,L)=>L-S),u=d.map(S=>S.low).sort((S,L)=>S-L),m=[Math.max(...p.slice(0,10))],_=[Math.min(...u.slice(0,10))];r>i.sma_20?_.push(i.sma_20):m.push(i.sma_20),r>i.sma_50?_.push(i.sma_50):m.push(i.sma_50),r>i.vwap?_.push(i.vwap):m.push(i.vwap);const g=Math.round(r/10)*10;g>r?m.push(g):_.push(g);const f=[...new Set(m)].sort((S,L)=>S-L).filter(S=>S>r).slice(0,3),y=[...new Set(_)].sort((S,L)=>L-S).filter(S=>S<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",f);const x=i.atr_14/r*100;let b="NORMAL";x>3?b="EXTREME":x>1.5?b="HIGH":x<.5&&(b="LOW");const v=[];let j=30,E=30,P=40;c.type==="ALL_BULLISH"?(j=60,E=20,P=20):c.type==="ALL_BEARISH"?(j=20,E=60,P=20):c.score>=4&&(c.trends.filter(S=>S.trend==="BULLISH").length>=4?(j=50,E=25,P=25):(j=25,E=50,P=25)),f.length>0&&v.push({name:"📈 BULLISH CONTINUATION",probability:j,description:`Price breaks above $${f[0].toFixed(2)} and rallies toward $${(f[f.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${f[0].toFixed(2)} with volume`,target:f[f.length-1]||r*1.02}),y.length>0&&v.push({name:"📉 BEARISH CORRECTION",probability:E,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||r*.98}),v.push({name:"↔️ CONTINUED RANGING",probability:P,description:`Price oscillates between $${(y[0]||r*.99).toFixed(2)} and $${(f[0]||r*1.01).toFixed(2)} with choppy action`,trigger:b==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),v.sort((S,L)=>L.probability-S.probability);let U={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?U={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(U={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):b==="EXTREME"?U.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(U.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${f[0]?`breakout above $${f[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let R=!1;try{const S=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,A+=`${U.reason}`,R=await Z({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},A),console.log("[AI-ANALYSIS] Telegram sent:",R)}}catch(S){console.error("[AI-ANALYSIS] Telegram error:",S.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:b,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:f,support:y},scenarios:v,recommendation:U,telegram_sent:R}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const W=new _e;W.use("/api/*",pa());W.route("/api/signals/enhanced",us);W.route("/api/signals/simple",ps);W.route("/api/scanner",dt);W.route("/api/trades",pe);W.route("/api/calendar",Ae);W.route("/api/backtest",Qe);W.route("/api/telegram",Ts);W.route("/api/ai",ks);W.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:n})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),a=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:a.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});W.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>As),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});W.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const r=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,o=await(await fetch(r)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=o.values;let d=0;const p=[];for(const u of c){const m={timestamp:u.datetime,open:parseFloat(u.open),high:parseFloat(u.high),low:parseFloat(u.low),close:parseFloat(u.close),volume:0};p.push(m),await t.prepare(`
      ...
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const n="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let r=0;const l={};for(const o of i){const c=`https://api.twelvedata.com/time_series?symbol=${n}&interval=${o.interval}&apikey=${a}&outputsize=${o.outputsize}`,p=await(await fetch(c)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const u=p.values;let m=0;const _=[];for(const g of u){const f={timestamp:g.datetime,open:parseFloat(g.open),high:parseFloat(g.high),low:parseFloat(g.low),close:parseFloat(g.close),volume:0};_.push(f),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(f.timestamp,f.open,f.high,f.low,f.close,f.volume,o.dbKey).run(),m++}if(_.length>=50){const g=ve(_.reverse());g&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,g.rsi_14,g.macd,g.macd_signal,g.macd_histogram,g.sma_20,g.sma_50,g.sma_200,g.ema_12,g.ema_26,g.bb_upper,g.bb_middle,g.bb_lower,g.atr_14,g.stochastic_k,g.stochastic_d,g.adx,g.plus_di,g.minus_di,g.ichimoku_tenkan,g.ichimoku_kijun,g.ichimoku_senkou_a,g.ichimoku_senkou_b,g.parabolic_sar,g.vwap,g.fib_382,g.fib_500,g.fib_618).run()}l[o.dbKey]={success:!0,count:m},r+=m,await new Promise(g=>setTimeout(g,500))}return e.json({success:!0,totalCount:r,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const a=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),n=ve(a);if(!n)return e.json({success:!1,error:"Failed to calculate indicators"});const i=a[a.length-1].close,r=se(i,n,"day_trade"),l=se(i,n,"swing_trade");return e.json({success:!0,signals:{day_trade:r,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:a,formatAlignmentReport:n}=await Promise.resolve().then(()=>ls),i=["5m","15m","1h","4h","daily"],r={};for(const E of i){const P=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(E).first();P&&(r[E]=P)}const l=Object.keys(r).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(r)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(r,c),p=r["1h"],u=se(c,p,"day_trade"),m=se(c,p,"swing_trade"),_=a(u.signal_type,d),g=a(m.signal_type,d),f={...u,base_confidence:u.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${_.reason}`},y={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${g.reason}`},x=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),b={};for(const E of x.results||[])b[E.setting_key]=E.setting_value;let v=!1,j=[];b.telegram_bot_token&&b.telegram_chat_id&&(f.isValid&&f.signal_type!=="HOLD"&&await Z({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED
...
📊 ${n(d)}`)&&(j.push("swing_trade"),v=!0));for(const E of[f,y])E.isValid&&await t.prepare(`
    ...
    `).all();let a="";for(const _ of s.results||[])_.setting_key==="twelve_data_api_key"&&(a=_.setting_value);let n,i=!1;if(a&&a!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const _=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,f=await(await fetch(_)).json();f.values&&f.values.length>=50?(n=f.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",n[n.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(_){console.error("[GENERATE-NOW] API fetch failed:",_.message)}}if(!n){console.log("[GENERATE-NOW] Using database data (may be stale)");const _=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!_.results||_.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});n=_.results.reverse().map(g=>({timestamp:g.timestamp,open:g.open,high:g.high,low:g.low,close:g.close,volume:g.volume}))}const r=ve(n);if(!r)return e.json({success:!1,error:"Failed to calculate indicators"});const l=n[n.length-1].close,o=se(l,r,"day_trade"),c=se(l,r,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",o.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const _ of d.results||[])p[_.setting_key]=_.setting_value;let u=!1,m=[];p.telegram_bot_token&&p.telegram_chat_id&&(await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},st({...o,timestamp:new Date().toISOString()}))&&(m.push("day_trade"),u=!0),await new Promise(f=>setTimeout(f,1e3)),await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},st({...c,timestamp:new Date().toISOString()}))&&(m.push("swing_trade"),u=!0));for(const _ of[o,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason, telegram_sent)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(_.signal_type,_.trading_style,_.price,_.stop_loss,_.take_profit_1,_.take_profit_2,_.take_profit_3,_.confidence,_.reason,u?1:0).run();return e.json({success:!0,signals:{day_trade:o,swing_trade:c},telegram_sent:u,sent_to_telegram:m})}catch(s){return e.json({success:!1,error:s.message},500)}});W.get("/api/trading/account/:id",async e=>{const{DB:t}=e.env,s=e.req.param("id");try{const a=await t.prepare(`
    ...
    `).bind(a.timeframe||"1h").all();if(!n.results||n.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=n.results)==null?void 0:s.length)||0}`},400);const i=await t.prepare(`
      ...
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:r,formatBacktestResults:l}=await Promise.resolve().then(()=>In),o=await r(n.results,{start_date:a.start_date||"2024-01-01",end_date:a.end_date||new Date().toISOString().split("T")[0],starting_balance:a.starting_balance||1e4,min_confidence:a.min_confidence||75,use_mtf_confirmation:a.use_mtf_confirmation!==!1,use_news_filter:a.use_news_filter!==!1,timeframe:a.timeframe||"1h",commission_per_trade:a.commission_per_trade||0},i.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
    ...
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});W.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Fetch MTF Data",status:"running"});const a=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),n=(a==null?void 0:a.setting_value)||"70140f57bea54c5e90768de696487d8f",i=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];let r=0;for(const T of i){const re=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${T.interval}&apikey=${n}&outputsize=100`,I=await(await fetch(re)).json();if(I.values&&Array.isArray(I.values)){const z=[];for(const D of I.values){const k={timestamp:D.datetime,open:parseFloat(D.open),high:parseFloat(D.high),low:parseFloat(D.low),close:parseFloat(D.close),volume:0};z.push(k),await t.prepare(`
            INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT DO NOTHING
          `).bind(k.timestamp,k.open,k.high,k.low,k.close,k.volume,T.dbKey).run()}if(z.length>=50){const D=ve(z.reverse());D&&await t.prepare(`
              INSERT INTO multi_timeframe_indicators 
              (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
               sma_20, sma_50, sma_200, ema_12, ema_26,
               bb_upper, bb_middle, bb_lower, atr_14,
               ...
               parabolic_sar, vwap, fib_382, fib_500, fib_618)
              VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
            `).bind(T.dbKey,D.rsi_14,D.macd,D.macd_signal,D.macd_histogram,D.sma_20,D.sma_50,D.sma_200,D.ema_12,D.ema_26,D.bb_upper,D.bb_middle,D.bb_lower,D.atr_14,D.stochastic_k,D.stochastic_d,D.adx,D.plus_di,D.minus_di,D.ichimoku_tenkan,D.ichimoku_kijun,D.ichimoku_senkou_a,D.ichimoku_senkou_b,D.parabolic_sar,D.vwap,D.fib_382,D.fib_500,D.fib_618).run()}r+=I.values.length}await new Promise(z=>setTimeout(z,500))}s.steps[0].status="completed",s.steps[0].data={totalCandles:r},s.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:l,validateMultiTimeframeSignal:o,formatAlignmentReport:c}=await Promise.resolve().then(()=>ls),d={};for(const T of["5m","15m","1h","4h","daily"]){const re=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(T).first();re&&(d[T]=re)}const p=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(p==null?void 0:p.close)||0,m=l(d,u),_=d["1h"],g=se(u,_,"day_trade"),f=se(u,_,"swing_trade"),y=o(g.signal_type,m),x=o(f.signal_type,m),b={...g,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type},v={...f,final_confidence:Math.min(95,x.confidence),isValid:x.isValid,mtf_reason:x.reason,alignment_score:m.score,alignment_type:m.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:b,swingTrade:v,alignment:m},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const j=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),E=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:P}=await Promise.resolve().then(()=>ut),U=P(j,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},E.results),R=P(j,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},E.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:U,swingPosition:R},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const S=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();A=await Z({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},T)}if(s.steps[3].status=A?"completed":"failed",s.steps[3].data={telegramSent:A},b.isValid||v.isValid)for(const T of[b,v])T.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(T.signal_type,T.trading_style,T.price,T.stop_loss,T.take_profit_1,T.take_profit_2,T.take_profit_3,T.confidence,T.final_confidence,T.final_confidence,T.alignment_score,T.alignment_type,T.reason,A?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:s,signals:{day_trade:b,swing_trade:v},positions:{day_trade:U,swing_trade:R},alignment:m,telegram_sent:A})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});const Bt=new _e,Mn=Object.assign({"/src/index.tsx":W});let Rs=!1;for(const[,e]of Object.entries(Mn))e&&(Bt.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Bt.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Rs=!0);if(!Rs)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Dn=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],Fn=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function Ls(e){const t=e.toLowerCase();let s=0,a=0;for(const l of Dn)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of Fn)t.includes(l)&&(a+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(a+=1));const n=s+a;let i=0;n>0&&(i=(s-a)/n*100);let r="neutral";return i>20?r="bullish":i<-20&&(r="bearish"),{sentiment:r,score:i}}function $n(e){let t=0,s=0,a=0,n=0;const i=e.map(o=>{const c=`${o.title} ${o.description||""}`,d=Ls(c);return d.sentiment==="bullish"?t++:d.sentiment==="bearish"?s++:a++,n+=d.score,{...o,sentiment:d.sentiment,score:d.score}}),r=e.length>0?n/e.length:0;let l="neutral";return r>20?l="bullish":r<-20&&(l="bearish"),{overall:l,score:Math.round(r),bullishCount:t,bearishCount:s,neutralCount:a,articles:i.slice(0,10)}}async function Nn(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,n=await(await fetch(s)).json();return n.status!=="ok"?(console.error("NewsAPI error:",n.message),[]):n.articles.map(i=>({title:i.title,description:i.description,url:i.url,publishedAt:i.publishedAt,source:i.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function On(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(a=>{const n=new Date(a.date);return n>=e&&n<=t})}const As=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:$n,analyzeSentiment:Ls,fetchGoldNews:Nn,getEconomicEvents:On},Symbol.toStringTag,{value:"Module"}));export{Bt as default};
