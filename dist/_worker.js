...
`)}const Ts=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Wt,determineTrend:ws,formatAlignmentReport:Zn,validateMultiTimeframeSignal:Ht},Symbol.toStringTag,{value:"Module"}));function Zt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function Qn(e,t){const s=Zt(e,.95),n=Zt(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Jn(e,t,s,n){const a=t-e,i=a/t*100;let r=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function ea(e,t,s=5){let n=0;const a=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,m=d/t*100;n+=d,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(m.toFixed(2))})}const i=n/t*100,r=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:a}}function ta(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[i,r,l]=a;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(r.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function sa(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],c=n[n.length-1]-n[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function na(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,m=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function aa(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[i,r]=a;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,c=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function ia(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),c=(i-o)/i;if(c>.01&&c<.05){const d=n-a,m=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function ra(e){const t=[],s=ta(e);s&&t.push(s);const n=sa(e);n&&t.push(n);const a=na(e);a&&t.push(a);const i=aa(e);i&&t.push(i);const r=ia(e);r&&t.push(r);let l=0,o=0,c=0;for(const p of t)p.direction==="bullish"?(l++,c+=p.confidence):p.direction==="bearish"&&(o++,c+=p.confidence);let d="neutral",m=0;l>o?(d="bullish",m=Math.min(c/l/10,15)):o>l&&(d="bearish",m=Math.min(c/o/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const p=t.map(g=>g.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${p}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(m.toFixed(1)),summary:u}}function oa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function la(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function ca(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function da(e,t,s){const n=oa(t.atr_14,s),a=la(t,s),i=ca(t,s);let r,l,o,c,d,m;const u=e.slice(-10),p=u.map(h=>h.volume||0),g=p.reduce((h,E)=>h+E,0)/p.length,_=(u[u.length-1].volume||0)>g*1.5;return n==="EXTREME"&&_?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,m="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,m="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,c="Wait for direction",d=.5,m="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,m="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,m="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,m="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,m="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,m="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,m="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:m}}function ma(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],i+=o*o;const r=(t*a-s*n)/(t*i-s*s),l=(n-r*s)/t;return{slope:r,intercept:l}}function pa(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const r=(n[n.length-1]-n[n.length-10])/10;return i+r*s}function ua(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const r=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function ga(e,t,s){const n=e[e.length-1].close;e.map(r=>r.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function fa(e,t){const s=e.map(u=>u.close),n=s[s.length-1],a=10,i=s.slice(-a),r=Math.min(...i),l=Math.max(...i),o=i.map(u=>(u-r)/(l-r));let c={index:0,similarity:-1/0};for(let u=a;u<s.length-a-t;u++){const p=s.slice(u-a,u),g=Math.min(...p),f=Math.max(...p),_=p.map(x=>(x-g)/(f-g));let h=0;for(let x=0;x<a;x++)h+=Math.pow(o[x]-_[x],2);const E=-h;E>c.similarity&&(c={index:u,similarity:E})}const m=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+m}function Ct(e,t,s){const n=[],a=[],i=e.map(y=>y.close),{slope:r,intercept:l}=ma(i.slice(-20)),o=r*(i.length-1+s)+l;n.push(o),a.push(1);const c=pa(e,12,s);n.push(c),a.push(1.5);const d=ua(e,s);n.push(d),a.push(1.2);const m=ga(e,t,s);n.push(m),a.push(1.8);const u=fa(e,s);n.push(u),a.push(1.3);const p=a.reduce((y,L)=>y+L,0),f=n.reduce((y,L,G)=>y+L*a[G],0)/p,_=n.reduce((y,L)=>y+L,0)/n.length,h=n.reduce((y,L)=>y+Math.pow(L-_,2),0)/n.length,E=Math.sqrt(h),x=e[e.length-1].close,v=1-E/x,w=Math.max(50,Math.min(95,v*100));return{prediction:f,confidence:w}}function _a(e,t){const s=e[e.length-1].close,n=[],a=Ct(e,t,1),i=a.prediction-s,r=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=Ct(e,t,4),o=l.prediction-s,c=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Ct(e,t,24),m=d.prediction-s,u=m/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:m>5?"UP":m<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const p=n.filter(E=>E.direction==="UP").length,g=n.filter(E=>E.direction==="DOWN").length;let f,_=0;p>g?(f="BULLISH",_=Math.min(p*5,15)):g>p?(f="BEARISH",_=Math.min(g*5,15)):f="NEUTRAL";const h=`ML models predict ${f} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:f,confidence_boost:parseFloat(_.toFixed(1)),summary:h}}function Bt(e,t,s,n,a){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(n-50)/10;l+=o;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function ha(e,t,s,n,a){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function ya(e,t,s,n,a,i){const r=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,c=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*c}function ba(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let x=14;x<r.length;x++){const v=r.slice(x-14,x);let w=0;for(let y=1;y<v.length;y++){const L=Math.max(v[y].high-v[y].low,Math.abs(v[y].high-v[y-1].close),Math.abs(v[y].low-v[y-1].close));w+=L}l.push(w/14)}const o=l.reduce((x,v)=>x+v,0)/l.length,c=a/o,d=Bt(n,e.take_profit_1,a,i,c),m=Bt(n,e.take_profit_2,a,i,c),u=Bt(n,e.take_profit_3,a,i,c),p=ha(n,e.stop_loss,a,i,e.signal_type),g=ya(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:m,tp3:u,sl:p}),_=(d+m+u)/3/p;let h;d>70&&g>5&&_>2?h="STRONG_TRADE":d>60&&g>0&&_>1.5?h="GOOD_TRADE":d>50&&g>-2?h="MARGINAL_TRADE":h="AVOID_TRADE";const E=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${_.toFixed(2)}:1. Recommendation: ${h.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(m.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(p.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(_.toFixed(2)),recommendation:h,summary:E}}function xs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=Ea(e),s=va(),n=Sa(e,s.session),a=wa(t,s.session),i=Ta(t,s),r=xa(t,s,n,i),l=La(r,t,s,n),o=ka(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function Ea(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,a=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,r=a/n;let l;a>i*1.2?l="INCREASING":a<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:n,current_volume:a,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function va(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,i;return n>=780&&n<960?(a="OVERLAP",i="HIGH"):n>=480&&n<780?(a="LONDON",i="HIGH"):n>=960&&n<1320?(a="NEW_YORK",i="HIGH"):n>=0&&n<480?(a="ASIA",i="MEDIUM"):(a="OFF_HOURS",i="LOW"),{zone:i,session:a}}function Sa(e,t){const s=e.slice(-20);let n=0;for(const d of s){const m=d.high-d.low;n+=m}const a=n/s.length,i=s[s.length-1].close,r=a/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,c=l*o;return{spread_pips:Math.round(c)}}function wa(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*i}function Ta(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function xa(e,t,s,n){const a=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+i+r+l}function La(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function ka(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Gt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ra(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Dt(e=30){const t=[],s=new Date;for(const a of Gt){const i=new Date(a),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),c=i.getDay();if(o===Ra(r,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,r)=>i===r.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const r=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function ht(e=new Date,t=[]){const s=[...Dt(7),...t],n=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(r=>r.date===a&&r.impact==="high"),Gt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Ia(a)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Ia(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function xt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Aa(e){const t=e.toISOString().split("T")[0];return Gt.includes(t)?!0:Dt(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Da(){const e=new Date().toISOString().split("T")[0];return Dt(7).filter(s=>s.date===e)}function Ls(e=new Date){const t=ht(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const ks=new _e;ks.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const C of["5m","15m","1h","4h","daily"]){const M=await t.prepare(`
      ...
      `).bind(C).first();M&&(n[C]=M);const V=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(C).all();V.results&&V.results.length>0&&(a[C]=V.results.map(S=>({timestamp:S.timestamp,open:S.open,high:S.high,low:S.low,close:S.close,volume:S.volume||0})))}if(Object.keys(n).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(n).length}. Please fetch multi-timeframe data first.`},400);const i=[];if(n["1h"]&&n["1h"].timestamp){const C=new Date(n["1h"].timestamp).getTime(),V=(Date.now()-C)/(1e3*60);V>60?i.push(`⚠️ WARNING: 1h data is ${V.toFixed(0)} minutes old (>60 min)`):V>30&&i.push(`⚠️ CAUTION: 1h data is ${V.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${V.toFixed(1)} minutes old`)}const r=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const C=new Date(r.timestamp).getTime(),M=(Date.now()-C)/(1e3*60);M>60&&i.push(`⚠️ WARNING: Price data is ${M.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${M.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ht(),c=Ls();let d=null,m=!1;o.riskLevel==="danger"?(m=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const u=n["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const p=Wt(n,l),g=ne(l,u,"day_trade"),f=ne(l,u,"swing_trade"),_=Ht(g.signal_type,p),h=Ht(f.signal_type,p),E={...g,base_confidence:g.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:p.score,alignment_type:p.type},x={...f,base_confidence:f.confidence,mtf_confidence:h.confidence,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:p.score,alignment_type:p.type};let v=0,w="",y=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const M=ra(a["1h"]);y=(M==null?void 0:M.patterns)||[]}catch(M){console.error("[ENHANCED] Pattern detection error:",M.message)}const C=y.filter(M=>M.confidence>=70&&M.endIndex>=a["1h"].length-5);for(const M of C)M.type==="bullish"&&E.signal_type==="BUY"?(v+=M.confidence*.1,w+=`${M.name} (${M.confidence.toFixed(0)}%), `):M.type==="bearish"&&E.signal_type==="SELL"&&(v+=M.confidence*.1,w+=`${M.name} (${M.confidence.toFixed(0)}%), `);v=Math.min(15,v)}let L=0,G="",k=null;if(a["1h"]&&a["1h"].length>=50){const C=fe(a["1h"]);C&&(k=da(a["1h"],C),k.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(L=10,G="Strong Uptrend"):k.trend==="UPTREND"&&E.signal_type==="BUY"?(L=5,G="Uptrend"):k.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(L=10,G="Strong Downtrend"):k.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(L=5,G="Downtrend"))}let T=0,N="",A=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{A=_a(a["1h"],l),A.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(T=A.confidence_boost,N=`ML predicts +${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):A.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(T=A.confidence_boost,N=`ML predicts ${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(C){console.error("[ENHANCED] ML prediction error:",C.message)}let Y=0,H="",X=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const C=fe(a["1h"]);C&&(X=ba(E,C,a["1h"]),X.tp1_probability>70?(Y=10,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`):X.tp1_probability>60&&(Y=5,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`))}catch(C){console.error("[ENHANCED] Probability of Profit error:",C.message)}let I=null,j=0,le=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{I=xs(a["1h"]),I.liquidity_score>=80?j=5:I.liquidity_score>=70?j=0:I.liquidity_score>=50?le=-5:le=-10,console.log(`[LIQUIDITY] Score: ${I.liquidity_score}/100, Session: ${I.session}, Adjust: ${j+le}%`)}catch(C){console.error("[ENHANCED] Liquidity Analysis error:",C.message)}let D=0,q=0,J=0,ae=0,ie="";try{const C=await t.prepare(`
      ...
      `).all(),V=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(C&&M.results&&M.results.length>=10){const S=Qn(M.results,C.balance);D=S.var_95,q=S.var_99;const ce=Jn(C.balance,M.results);if(J=ce.current_drawdown_pct,ce.is_within_limit||(ie+=`⚠️ Drawdown ${J.toFixed(1)}% exceeds limit. `),V.results){const B=ea(V.results,C.balance);ae=B.total_risk_pct,B.is_within_limit||(ie+=`⚠️ Portfolio heat ${ae.toFixed(1)}% exceeds limit. `)}}}catch(C){console.error("[ENHANCED] Risk metrics error (optional):",C.message)}const R=v+L+T+Y+j+le,W={...E,pattern_boost:v,regime_boost:L,ml_boost:T,pop_boost:Y,total_boost:R,enhanced_confidence:Math.min(98,E.final_confidence+R),var_95:D,var_99:q,current_drawdown_pct:J,portfolio_heat_pct:ae,risk_warning:ie||null},O={...x,pattern_boost:v,regime_boost:L,ml_boost:T,pop_boost:Y,total_boost:R,enhanced_confidence:Math.min(98,x.final_confidence+R),var_95:D,var_99:q,current_drawdown_pct:J,portfolio_heat_pct:ae,risk_warning:ie||null};m?(W.signal_type="HOLD",O.signal_type="HOLD",W.enhanced_confidence=50,O.enhanced_confidence=50,W.reasoning=d||"Economic event nearby - trading paused",O.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(W.enhanced_confidence=Math.max(50,W.enhanced_confidence+c.adjustment),O.enhanced_confidence=Math.max(50,O.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),W.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(C=>xt(C))},O.calendar_check=W.calendar_check;let Te=!1;try{const C=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),M={};for(const V of C.results||[])M[V.setting_key]=V.setting_value;if(M.telegram_bot_token&&M.telegram_chat_id){const V=new Date().toLocaleString("en-US",{timeZone:"UTC"});let S=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${V} UTC

`;if(i.length>0){S+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const ee of i)S+=`${ee}
...
`,S+=`${p.type} (${p.score}/5 timeframes)
`,S+=`Confidence Boost: +${p.confidenceBoost}%

`;for(const ee of p.trends){const Z=ee.trend==="BULLISH"?"📈":ee.trend==="BEARISH"?"📉":"➡️";S+=`${Z} *${ee.timeframe}*: ${ee.trend} (${ee.confidence.toFixed(0)}%)
`}if(S+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,S+=`📈 *DAY TRADE SIGNAL*
`,S+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,S+=`${W.isValid?"✅":"❌"} *${W.signal_type}* (${W.enhanced_confidence.toFixed(0)}% confidence)

`,S+=`*Entry:* $${W.price.toFixed(2)}
`,S+=`*Stop Loss:* $${W.stop_loss.toFixed(2)} (${((W.stop_loss/W.price-1)*100).toFixed(2)}%)
`,S+=`*TP1:* $${W.take_profit_1.toFixed(2)} (${((W.take_profit_1/W.price-1)*100).toFixed(2)}%)
`,S+=`*TP2:* $${W.take_profit_2.toFixed(2)} (${((W.take_profit_2/W.price-1)*100).toFixed(2)}%)
`,S+=`*TP3:* $${W.take_profit_3.toFixed(2)} (${((W.take_profit_3/W.price-1)*100).toFixed(2)}%)

`,S+=`*📊 Confidence Breakdown:*
`,S+=`Base: ${W.base_confidence.toFixed(0)}%
`,S+=`MTF: ${W.mtf_confidence.toFixed(0)}%
`,v>0&&(S+=`Pattern: +${v.toFixed(0)}%
`),L>0&&(S+=`Regime: +${L.toFixed(0)}%
`),T>0&&(S+=`ML: +${T.toFixed(0)}%
`),Y>0&&(S+=`PoP: +${Y.toFixed(0)}%
`),j!==0||le!==0){const ee=j+le;S+=`Liquidity: ${ee>=0?"+":""}${ee.toFixed(0)}%
`}S+=`*FINAL: ${W.enhanced_confidence.toFixed(0)}%*

`,k&&(S+=`🌡️ *Market Regime:* ${k.trend||"N/A"}
`,S+=`Volatility: ${k.volatility}
`,S+=`Should Trade: ${k.should_trade?"✅ YES":"❌ NO"}

`),A&&A.overall_direction!=="NEUTRAL"&&(S+=`🤖 *ML Prediction:* ${A.overall_direction}
`,(s=A.predictions[0])!=null&&s.predicted_price&&(S+=`1h Target: $${A.predictions[0].predicted_price.toFixed(2)}
`),S+=`
`),X&&(S+=`🎯 *Probability of Profit:*
`,S+=`TP1: ${X.tp1_probability.toFixed(0)}%
`,S+=`TP2: ${X.tp2_probability.toFixed(0)}%
`,S+=`TP3: ${X.tp3_probability.toFixed(0)}%
`,S+=`Expected Value: ${X.expected_value.toFixed(2)}R

`),S+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,S+=`💡 *RECOMMENDATION*
`,S+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,W.isValid&&W.signal_type!=="HOLD"?(S+=`✅ *EXECUTE ${W.signal_type}*
`,S+=`All hedge fund features aligned!
`):(S+=`⚠️ *SKIP TRADE*
`,S+=`Reason: ${W.mtf_reason}
`),S+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",S.length,"characters");const ce=await K({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},S);let B=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━
...
`,B+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",B.length,"characters");const ye=await K({botToken:M.telegram_bot_token,chatId:M.telegram_chat_id},B);Te=ce&&ye}}catch(C){console.error("[ENHANCED] Telegram error (optional):",C.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Te,day_trade:W,swing_trade:O,alignment:{type:p.type,score:p.score,trends:p.trends},patterns:y.length>0?y.slice(0,3):null,regime:k?{trend:k.trend,volatility:k.volatility,should_trade:k.should_trade}:null,ml_prediction:A?{direction:A.overall_direction,predictions:A.predictions}:null,profit_probability:X?{tp1:X.tp1_probability,tp2:X.tp2_probability,tp3:X.tp3_probability,expected_value:X.expected_value}:null,liquidity:I?{score:I.liquidity_score,session:I.session,time_zone:I.time_of_day_zone,volume_trend:I.volume_trend,volume_percentile:I.volume_percentile,estimated_spread_pips:I.estimated_spread_pips,price_impact_bps:I.price_impact_bps,market_depth_score:I.market_depth_score,optimal_for_trading:I.optimal_for_trading,warnings:I.warnings,recommendation:I.recommendation}:null,risk_metrics:{var_95:D,var_99:q,drawdown_pct:J,portfolio_heat_pct:ae}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Rs=new _e;Rs.post("/simple",async e=>{var s,n,a,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    ...
    `).all();if(!l.results||l.results.length<50)return e.json({success:!1,error:'Not enough candle data. Please click "Fetch Market Data" to fetch fresh data.'},400);const o=l.results.map(f=>({timestamp:f.timestamp,open:Number(f.open),high:Number(f.high),low:Number(f.low),close:Number(f.close),volume:Number(f.volume)||0})).reverse(),c=o[o.length-1].close;console.log("[SIMPLE] Got",o.length,"candles, current price:",c);const d=(f,_)=>{const h=parseFloat(String(f));return isNaN(h)?_:h},m={rsi_14:d(r.rsi_14,50),macd:d(r.macd,0),macd_signal:d(r.macd_signal,0),macd_histogram:d(r.macd_histogram,0),sma_20:d(r.sma_20,c),sma_50:d(r.sma_50,c),sma_200:d(r.sma_200,c),ema_12:d(r.ema_12,c),ema_26:d(r.ema_26,c),bb_upper:d(r.bb_upper,c*1.02),bb_middle:d(r.bb_middle,c),bb_lower:d(r.bb_lower,c*.98),atr_14:d(r.atr_14,c*.01),stochastic_k:d(r.stochastic_k,50),stochastic_d:d(r.stochastic_d,50),adx:d(r.adx,25),plus_di:d(r.plus_di,25),minus_di:d(r.minus_di,25),ichimoku_tenkan:d(r.ichimoku_tenkan,c),ichimoku_kijun:d(r.ichimoku_kijun,c),ichimoku_senkou_a:d(r.ichimoku_senkou_a,c),ichimoku_senkou_b:d(r.ichimoku_senkou_b,c),parabolic_sar:d(r.parabolic_sar,c),vwap:d(r.vwap,c),fib_382:d(r.fib_382,0)||void 0,fib_500:d(r.fib_500,0)||void 0,fib_618:d(r.fib_618,0)||void 0};console.log("[SIMPLE] Using pre-calculated indicators:",{rsi:(s=m.rsi_14)==null?void 0:s.toFixed(1),macd:(n=m.macd)==null?void 0:n.toFixed(2),adx:(a=m.adx)==null?void 0:a.toFixed(1)});const u=ne(c,m,"day_trade",o),p=ne(c,m,"swing_trade",o);console.log("[SIMPLE] Generated signals:",{day:u.signal_type,swing:p.signal_type});let g=!1;try{const f=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),_={};for(const h of f.results||[])_[h.setting_key]=h.setting_value;if(console.log("[SIMPLE] Telegram config:",{hasToken:!!_.telegram_bot_token,hasChat:!!_.telegram_chat_id,tokenLength:((i=_.telegram_bot_token)==null?void 0:i.length)||0,chatId:_.telegram_chat_id}),_.telegram_bot_token&&_.telegram_chat_id){const h=Number(u.confidence);let E=u.signal_type,x=!1;(h<60||u.signal_type==="HOLD")&&(E="HOLD",x=!0);const v=E==="BUY"?"🟢":E==="SELL"?"🔴":"⚪",w=new Date().toLocaleString("en-US",{timeZone:"UTC"});let y=`${v} <b>GOLD/USD ${E} SIGNAL</b> ${v}
...
`;const L=String(u.reason).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");y+=L+`
...
`),_+=`⏰ ${f}`,d=await K({botToken:u.telegram_bot_token,chatId:u.telegram_chat_id},_),console.log("[FLIP] Telegram sent:",d)}}catch(m){console.error("[FLIP] Telegram error:",m.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:d,flip_signal:{is_flip:c.is_flip,flip_type:c.flip_type,flip_confidence:c.flip_confidence,flip_strength:c.flip_strength,flip_reasons:c.flip_reasons,entry_zone:c.entry_zone,timeframe_alignment:c.timeframe_alignment,momentum_shift:c.momentum_shift,structure_break:c.structure_break,smart_money:c.smart_money,description:Ba(c)}})}catch(i){return console.error("[FLIP] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function Pa(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Ua(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Ha(e,t){return e>t*1.1}function ja(e){let t=0,s=0,n=0;for(const l of e){const o=l.volume||0;n+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const a=s>0?t/s:t>0?10:1;let i="NEUTRAL";a>1.5?i="BUYING":a<.67&&(i="SELLING");let r=0;return a>3?r=100:a>1.5?r=50+(a-1.5)/1.5*50:a>.67?r=(a-.67)/.83*50:a>.33?r=50+(.67-a)/.34*50:r=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:i,strength:Math.round(r)}}function As(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Wa(e,t){const n=As(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Ga(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Ya(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Va(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),za(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),qa(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Ka(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Xa(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Za(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),Qa(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Ja(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),ei(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Ya(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Va(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function za(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function qa(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Ka(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close<e.open,l=s.close>s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close>(e.open+e.close)/2}function Xa(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close>e.open,l=s.close<s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close<(e.open+e.close)/2}function Za(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,i=t.low>e.low&&s.low>t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function Qa(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,i=t.low<e.low&&s.low<t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function Ja(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function ei(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function ti(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function si(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),m=Math.max(...d.map(p=>p.high)),u=Math.min(...d.map(p=>p.low));s.push({level:m,type:"RESISTANCE",strength:85,distance:m-t,distancePercent:(m-t)/t*100}),s.push({level:u,type:"SUPPORT",strength:85,distance:t-u,distancePercent:(t-u)/t*100})}const n=e.slice(-50),a=Qt(n,"HIGH"),i=Qt(n,"LOW");if(a.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),i.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),ni(t).forEach(d=>{const m=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:m,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),m=ai(d);s.push({level:m.pp,type:"PIVOT",strength:80,distance:Math.abs(m.pp-t),distancePercent:Math.abs(m.pp-t)/t*100}),s.push({level:m.r1,type:"RESISTANCE",strength:70,distance:m.r1-t,distancePercent:(m.r1-t)/t*100}),s.push({level:m.s1,type:"SUPPORT",strength:70,distance:t-m.s1,distancePercent:(t-m.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((d,m)=>Math.abs(m.distancePercent)<Math.abs(d.distancePercent)?m:d),c=ii(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:c,strength:o.strength,description:ri(o,c)}}function Qt(e,t){const s=[];for(let i=5;i<e.length-5;i++){const r=t==="HIGH"?e[i].high:e[i].low;let l=!0;for(let o=i-5;o<=i+5;o++){if(o===i)continue;const c=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&c>=r){l=!1;break}if(t==="LOW"&&c<=r){l=!1;break}}l&&s.push(r)}return Array.from(new Set(s)).slice(-3)}function ni(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function ai(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),n=e[e.length-1].close,a=(t+s+n)/3,i=2*a-s,r=2*a-t,l=a+(t-s),o=a-(t-s);return{pp:a,r1:i,s1:r,r2:l,s2:o}}function ii(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function ri(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function oi(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function li(e){const t=[];if(e.length<3)return t;let s=0,n=0;for(let i=1;i<Math.min(14,e.length);i++){const r=e[i].high-e[i].low;s+=r,n++}const a=n>0?s/n:1;for(let i=2;i<e.length;i++){const r=e[i-2];e[i-1];const l=e[i];if(r.high<l.low){const o=l.low-r.high,c=Math.min(100,Math.round(o/a*100));t.push({type:"BULLISH",gapStart:r.high,gapEnd:l.low,gapMidpoint:(r.high+l.low)/2,timestamp:l.timestamp,filled:!1,distancePercent:0,strength:c})}if(r.low>l.high){const o=r.low-l.high,c=Math.min(100,Math.round(o/a*100));t.push({type:"BEARISH",gapStart:l.high,gapEnd:r.low,gapMidpoint:(l.high+r.low)/2,timestamp:l.timestamp,filled:!1,distancePercent:0,strength:c})}}return t}function ci(e,t,s){if(e.length===0)return[];for(const a of e){const i=t.findIndex(l=>l.timestamp===a.timestamp);if(i===-1)continue;const r=t.slice(i+1);for(const l of r)if(a.type==="BULLISH"){if(l.low<=a.gapEnd){a.filled=!0;break}}else if(l.high>=a.gapStart){a.filled=!0;break}a.distancePercent=Math.abs(s-a.gapMidpoint)/s*100}const n=e.filter(a=>!a.filled&&a.distancePercent<1);return n.sort((a,i)=>a.distancePercent-i.distancePercent),n}function di(e,t,s){return t==="BUY"?e.type==="BULLISH"&&s>=e.gapEnd:t==="SELL"?e.type==="BEARISH"&&s<=e.gapStart:!1}function mi(e,t){if(!e.hasFVG)return"No unfilled FVG within 1% of price";const s=e.closestGap,n=s.distancePercent.toFixed(2),a=s.gapMidpoint.toFixed(2);return e.aligned?`${s.type} FVG at $${a} (${n}% away, strength ${s.strength}/100) - ALIGNED`:`${s.type} FVG at $${a} (${n}% away, strength ${s.strength}/100) - not aligned`}function pi(e,t,s){if(!e||e.length<20)return{hasFVG:!1,aligned:!1,nearbyGaps:[],closestGap:null,description:"Insufficient data for FVG analysis (need 20+ candles)",score:0};const n=li(e),a=ci(n,e,t);if(a.length===0)return{hasFVG:!1,aligned:!1,nearbyGaps:[],closestGap:null,description:"No unfilled FVG within 1% of price",score:0};const i=a[0],r=di(i,s,t);let l=0;r&&(l=10,i.distancePercent<.3&&(l+=2),i.strength>70&&(l+=2),l=Math.min(10,l));const o={hasFVG:!0,aligned:r,nearbyGaps:a,closestGap:i,description:"",score:l};return o.description=mi(o),o}function ui(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=gi(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const i=fi(s,a),r=_i(s,a);return i.type!=="NONE"&&r.type===i.type?{type:i.type,category:i.category,indicator:"BOTH",strength:95,description:`${i.type} ${i.category} (RSI+MACD)`,confidence:90}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"RSI",strength:80,description:`${i.type} ${i.category} (RSI)`,confidence:75}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"MACD",strength:70,description:`${r.type} ${r.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function gi(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const i=e[a];let r=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].high>=i.high){r=!1;break}r&&t.push({index:a,price:i.high});let l=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].low<=i.low){l=!1;break}l&&s.push({index:a,price:i.low})}return{highs:t,lows:s}}function fi(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function _i(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function hi(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function yi(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,i=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${i}, ${e.strength}/100)`}function bi(e,t,s,n){const a=(_,h)=>{const E=parseFloat(String(_));return isNaN(E)?h:E},i=a(e.ema_12,n),r=a(t.ema_26,n),l=a(s.sma_200,n),o=Pt(n,i),c=Pt(n,r),d=Pt(n,l),m=o===c&&c===d&&o!=="NEUTRAL",u=o===c&&o!=="NEUTRAL"||o===d&&o!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let p=0,g="",f="";return m?(p=100,g=`ALL ${o}`,f=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):u?(p=65,o===c?(g=`5M+15M ${o}`,f=`5m & 15m ${o.toLowerCase()} (1h ${d.toLowerCase()})`):o===d?(g=`5M+1H ${o}`,f=`5m & 1h ${o.toLowerCase()} (15m ${c.toLowerCase()})`):(g=`15M+1H ${c}`,f=`15m & 1h ${c.toLowerCase()} (5m ${o.toLowerCase()})`)):(p=30,g="MIXED",f=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:o,tf15m:c,tf1h:d,allAligned:m,twoAligned:u,alignment:g,strength:p,description:f}}function Pt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function Ei(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function vi(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function Si(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.1?r="UP":i<-.1&&(r="DOWN");let l="NEUTRAL";r==="DOWN"?l="BULLISH":r==="UP"&&(l="BEARISH");const o=Math.abs(i);let c=-.8,d=0;o>.3?d=90:o>.2?d=75:o>.1?d=60:d=40;const m=new Date(s.timestamp),p=Math.floor((new Date().getTime()-m.getTime())/6e4),g=Ti(a,i,r,l,d);return{dxyPrice:a,dxyChange:i,dxyTrend:r,goldSignalSupport:l,correlation:c,strength:d,description:g,dataAge:p}}function wi(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Ti(e,t,s,n,a){const i=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${i} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${i} → Gold BEARISH (${a}/100)`:`DXY flat ${i} → Neutral (${a}/100)`}async function xi(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function Li(e,t){try{await e.prepare(`
    ...
    `).bind(m,"5m",d.signal,d.grade,d.score,c,d.stopLoss,d.tp1,d.tp2,d.tp3,d.confidence,d.layersPassed,d.liquidityScore,d.session,0).run();let u=!1;if(d.grade==="A"||d.grade==="A+")try{const g=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),f={};for(const _ of g.results||[])f[_.setting_key]=_.setting_value;if(f.telegram_bot_token&&f.telegram_chat_id){const _=Ms(d,c);u=await K({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},_),await t.prepare(`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});nt.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const c of s.results||[])n[c.setting_key]=c.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,i=15,r={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-i,tp1:a+i*2,tp2:a+i*3,tp3:a+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Ms(r,a),o=await K({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Ds(e,t,s,n,a,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],c=(Q,Ye)=>{const Et=parseFloat(String(Q));return isNaN(Et)?Ye:Et};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,i),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},m={ema50:c(s.ema_26,i)},u={sma200:c(n.sma_200,i)},p=i>d.ema20&&i>m.ema50&&i>u.sma200,g=i<d.ema20&&i<m.ema50&&i<u.sma200;p||g?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${p?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const f=d.rsi>=40&&d.rsi<=60,_=d.macd>d.macd_signal&&d.macd_histogram>0,h=d.macd<d.macd_signal&&d.macd_histogram<0;f&&(p?_:h)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${p?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${f?"no crossover":"extreme"}`);const E=a.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,x=a[a.length-1].volume;x>E*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(x/E).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(x/E).toFixed(1)}x (need 1.5x+)`);const w=Math.max(...a.slice(-20).map(Q=>Q.high)),y=Math.min(...a.slice(-20).map(Q=>Q.low)),L=i>w*.999,G=i<y*1.001;p&&L||g&&G?(r+=15,l++,o.push(`✅ Layer 4: ${p?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let k=null;try{k=await xs(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const T=(k==null?void 0:k.liquidity_score)||50,N=(k==null?void 0:k.session)||"UNKNOWN";T>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${T}/100 (${N} session)`)):o.push(`❌ Layer 5: Liquidity ${T}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const Y=ht();console.log("[ANALYZE] Calendar check complete"),Y.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${Y.reason}`);const X=d.adx>25,I=d.adx>70;X&&!I?(r+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):I?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let j="HOLD";(p||g)&&l>=5&&(j=p?"BUY":"SELL");const le=new Date,D=Pa(le);D.hasBoost?(r+=8,l++,o.push(`✅ Layer 8: ${D.reason} (+${D.boost}% win)`)):o.push(`ℹ️ Layer 8: ${D.reason}`);const q=Ua(le);q.hasBoost?(r+=5,l++,o.push(`✅ Layer 9: ${q.reason} (+${q.boost}% win)`)):o.push(`ℹ️ Layer 9: ${q.reason}`);const J=c(t.atr_14,i*.01),ae=a.slice(-20).reduce((Q,Ye)=>{const Et=Ye.high-Ye.low;return Q+Et},0)/20;if(Ha(J,ae)){r+=7,l++;const Q=((J/ae-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-J/ae)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const R=ja(a.slice(-20));As(R,j)&&R.strength>=60&&(r+=10,l++),o.push(Wa(R,j));const O=Ga(a.slice(-3)),{aligned:Te,strongestPattern:C}=ti(O,j);Te&&C?(r+=12,l++,o.push(`✅ Layer 12: ${C.name} (${C.strength}/100)`)):O.length>0&&O[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${O[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const M=si(a,i);oi(M,j)&&M.nearZone?(r+=8,l++,o.push(`✅ Layer 13: ${M.description}`)):M.nearZone?o.push(`⚠️ Layer 13: ${M.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const S=pi(a,i,j.signal_type);S.aligned&&S.hasFVG?(r+=10,l++,o.push(`✅ Layer 21: ${S.description}`)):S.hasFVG?o.push(`⚠️ Layer 21: ${S.description}`):o.push(`ℹ️ Layer 21: ${S.description}`);const B=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),ye=ui(B,a.slice(-10)),Z=hi(ye,j,p?"BULLISH":g?"BEARISH":"NEUTRAL");Z&&ye.strength>=70&&(r+=9,l++),o.push(yi(ye,Z));const bt=bi(t,s,n,i),Yt=Ei(bt,j);Yt&&(bt.allAligned||bt.twoAligned)&&(r+=6,l++),o.push(vi(bt,Yt));const Mt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),$t=(Mt==null?void 0:Mt.setting_value)||"70140f57bea54c5e90768de696487d8f",qs=await Ri(e,$t,15),rt=Si(qs);wi(rt,j)&&rt.strength>=60?(r+=5,l++,o.push(`✅ Layer 18: ${rt.description}`)):rt.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${rt.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Ks=await es(e,$t,"SILVER",15),Xs=await es(e,$t,"OIL",15),We=Ii(Ks,Xs,j);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;r+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const Zs=await ji(e)||Wi(),xe=Fi(Zs);if(Ci(xe,j)&&xe.strength>=70){const Q=xe.positioning.includes("EXTREME")?7:4;r+=Q,l++,o.push(`✅ Layer 20: ${xe.description} (${xe.strength}/100)`)}else xe.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${xe.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${xe.description}`);let Ge="C";r>=171?Ge="A+":r>=152?Ge="A":r>=142?Ge="B+":r>=133?Ge="B":r>=124&&(Ge="B-"),(p||g)&&l>=8&&(j=p?"BUY":"SELL");const Le=Math.max(J*1.5,i*.003),Qs=j==="BUY"?i-Le:i+Le,Js=j==="BUY"?i+Le*2:i-Le*2,en=j==="BUY"?i+Le*3:i-Le*3,tn=j==="BUY"?i+Le*4:i-Le*4;return{grade:Ge,score:r,signal:j,confidence:r,layersPassed:l,layers:o,stopLoss:Qs,tp1:Js,tp2:en,tp3:tn,liquidityScore:T,session:N,adx:d.adx,rsi:d.rsi,volumeRatio:x/E}}function Ms(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,i=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,r,l,o,e).run();const d=(await at(n)).current_balance+r;return await n.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await Os(n),await Yi(n),await Vi(n),{success:!0,profit_loss:r}}catch(a){return{success:!1,error:a.message}}}async function Os(e){const t=await at(e),s=await e.prepare(`
  ...
  `).bind(s,i).run();let r=!1,l="";s>=t.max_drawdown_pct?(r=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(r=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),r&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});he.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const $e=new _e;$e.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Dt(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:xt(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});$e.get("/today",async e=>{try{const t=Da(),s=ht();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});$e.get("/check",async e=>{try{const t=ht(),s=Ls();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});$e.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);Aa(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});$e.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const yt=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:qi,calculatePositionSize:Ps,calculateProfitLoss:Us,checkDailyLossLimit:zi,formatPositionSize:Ki},Symbol.toStringTag,{value:"Module"}));async function Hs(e,t,s){const n=Date.now(),a=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(D=>{const q=new Date(D.timestamp);return q>=new Date(t.start_date)&&q<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:r,max_daily_loss_pct:2};for(let D=200;D<o.length;D++){const q=o.slice(D-200,D),J=fe(q);if(!J)continue;const ae=o[D],ie=ae.close,R=ne(ie,J,"day_trade"),W=ne(ie,J,"swing_trade");for(const O of[R,W]){if(O.signal_type==="HOLD"||O.confidence<t.min_confidence)continue;c.current_balance=r;const Te=Ps(c,{entry_price:O.price,stop_loss:O.stop_loss,take_profit_1:O.take_profit_1,take_profit_2:O.take_profit_2,take_profit_3:O.take_profit_3,confidence:O.confidence,signal_type:O.signal_type,trading_style:O.trading_style},s);if(!Te.is_valid)continue;const C=ae.timestamp,M=O.price;let V=null,S=null,ce="UNKNOWN";const B=Math.min(50,o.length-D-1);for(let ee=1;ee<=B;ee++){const Z=o[D+ee];if(O.signal_type==="BUY"){if(Z.low<=O.stop_loss){V=O.stop_loss,S=Z.timestamp,ce="STOP_LOSS";break}if(Z.high>=O.take_profit_3){V=O.take_profit_3,S=Z.timestamp,ce="TP3";break}if(Z.high>=O.take_profit_2){V=O.take_profit_2,S=Z.timestamp,ce="TP2";break}if(Z.high>=O.take_profit_1){V=O.take_profit_1,S=Z.timestamp,ce="TP1";break}}else{if(Z.high>=O.stop_loss){V=O.stop_loss,S=Z.timestamp,ce="STOP_LOSS";break}if(Z.low<=O.take_profit_3){V=O.take_profit_3,S=Z.timestamp,ce="TP3";break}if(Z.low<=O.take_profit_2){V=O.take_profit_2,S=Z.timestamp,ce="TP2";break}if(Z.low<=O.take_profit_1){V=O.take_profit_1,S=Z.timestamp,ce="TP1";break}}}if(!V||!S)continue;const ye=Us(M,V,Te.units,O.signal_type,t.commission_per_trade);r+=ye.profit_loss,r>l&&(l=r),a.push({entry_time:C,entry_price:M,exit_time:S,exit_price:V,signal_type:O.signal_type,trading_style:O.trading_style,position_size:Te.units,profit_loss:ye.profit_loss,profit_loss_pct:ye.profit_loss_pct,exit_reason:ce,confidence:O.confidence}),i.push({date:S,balance:r})}}const d=a.filter(D=>D.profit_loss>0),m=a.filter(D=>D.profit_loss<0),u=d.reduce((D,q)=>D+q.profit_loss,0),p=Math.abs(m.reduce((D,q)=>D+q.profit_loss,0)),g=r-t.starting_balance,f=a.length>0?d.length/a.length*100:0,_=d.length>0?u/d.length:0,h=m.length>0?p/m.length:0,E=d.length>0?Math.max(...d.map(D=>D.profit_loss)):0,x=m.length>0?Math.min(...m.map(D=>D.profit_loss)):0,v=p>0?u/p:u,w=100-f,y=f/100*_-w/100*h;let L=0,G=0,k=t.starting_balance;for(const D of i){D.balance>k&&(k=D.balance);const q=k-D.balance,J=q/k*100;q>L&&(L=q,G=J)}const T=a.map(D=>D.profit_loss_pct),N=T.reduce((D,q)=>D+q,0)/T.length,A=Math.sqrt(T.reduce((D,q)=>D+Math.pow(q-N,2),0)/T.length),Y=A>0?N/A:0;let H=0,X=0,I=0,j=0;for(const D of a)D.profit_loss>0?(I++,j=0,H=Math.max(H,I)):(j++,I=0,X=Math.max(X,j));const le=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:d.length,losing_trades:m.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(_.toFixed(2)),avg_loss:parseFloat(h.toFixed(2)),largest_win:parseFloat(E.toFixed(2)),largest_loss:parseFloat(x.toFixed(2)),max_drawdown:parseFloat(L.toFixed(2)),max_drawdown_pct:parseFloat(G.toFixed(2)),profit_factor:parseFloat(v.toFixed(2)),sharpe_ratio:parseFloat(Y.toFixed(2)),expectancy:parseFloat(y.toFixed(2)),max_consecutive_wins:H,max_consecutive_losses:X,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:i,execution_time_ms:le}}function js(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Xi=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:js,runBacktest:Hs},Symbol.toStringTag,{value:"Module"})),it=new _e;it.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
...
📅 Backtest ID: ${o.meta.last_row_id}
        `.trim();c=await K({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},f)}}catch(d){console.error("[BACKTEST] Telegram send failed:",d)}return e.json({success:!0,backtest_id:o.meta.last_row_id,result:l,formatted:js(l),telegram_sent:c})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});it.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Gs=new _e;Gs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const T of s.results||[])T.setting_key==="twelve_data_api_key"&&(n=T.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const T=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,A=await(await fetch(T)).json();A.values&&A.values.length>=50&&(a=A.values.reverse().map(Y=>({timestamp:Y.datetime,open:parseFloat(Y.open),high:parseFloat(Y.high),low:parseFloat(Y.low),close:parseFloat(Y.close),volume:parseFloat(Y.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const T=await t.prepare(`
      ...
      `).all();if(!T.results||T.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=T.results.reverse().map(N=>({timestamp:N.timestamp,open:N.open,high:N.high,low:N.low,close:N.close,volume:N.volume||0}))}const i=fe(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=a[a.length-1].close,l=ne(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const T of["5m","15m","1h","4h","daily"]){const N=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(T).first();N&&(o[T]=N)}const c=Wt(o,r),d=a.slice(-50),m=d.map(T=>T.high).sort((T,N)=>N-T),u=d.map(T=>T.low).sort((T,N)=>T-N),p=[Math.max(...m.slice(0,10))],g=[Math.min(...u.slice(0,10))];r>i.sma_20?g.push(i.sma_20):p.push(i.sma_20),r>i.sma_50?g.push(i.sma_50):p.push(i.sma_50),r>i.vwap?g.push(i.vwap):p.push(i.vwap);const f=Math.round(r/10)*10;f>r?p.push(f):g.push(f);const _=[...new Set(p)].sort((T,N)=>T-N).filter(T=>T>r).slice(0,3),h=[...new Set(g)].sort((T,N)=>N-T).filter(T=>T<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",h,"Resistance:",_);const E=i.atr_14/r*100;let x="NORMAL";E>3?x="EXTREME":E>1.5?x="HIGH":E<.5&&(x="LOW");const v=[];let w=30,y=30,L=40;c.type==="ALL_BULLISH"?(w=60,y=20,L=20):c.type==="ALL_BEARISH"?(w=20,y=60,L=20):c.score>=4&&(c.trends.filter(T=>T.trend==="BULLISH").length>=4?(w=50,y=25,L=25):(w=25,y=50,L=25)),_.length>0&&v.push({name:"📈 BULLISH CONTINUATION",probability:w,description:`Price breaks above $${_[0].toFixed(2)} and rallies toward $${(_[_.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||r*1.02}),h.length>0&&v.push({name:"📉 BEARISH CORRECTION",probability:y,description:`Price breaks below $${h[0].toFixed(2)} and drops toward $${(h[h.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||r*.98}),v.push({name:"↔️ CONTINUED RANGING",probability:L,description:`Price oscillates between $${(h[0]||r*.99).toFixed(2)} and $${(_[0]||r*1.01).toFixed(2)} with choppy action`,trigger:x==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),v.sort((T,N)=>N.probability-T.probability);let G={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?G={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(G={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):x==="EXTREME"?G.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(G.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${_[0]?`breakout above $${_[0].toFixed(2)}`:h[0]?`breakdown below $${h[0].toFixed(2)}`:"clearer direction"}.`);let k=!1;try{const T=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,A+=`${G.reason}`,k=await K({botToken:N.telegram_bot_token,chatId:N.telegram_chat_id},A),console.log("[AI-ANALYSIS] Telegram sent:",k)}}catch(T){console.error("[AI-ANALYSIS] Telegram error:",T.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:x,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:_,support:h},scenarios:v,recommendation:G,telegram_sent:k}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const P=new _e;P.use("/api/*",Pn());P.route("/api/signals/enhanced",ks);P.route("/api/signals/simple",Rs);P.route("/api/signals/flip",Is);P.route("/api/scanner",nt);P.route("/api/trades",he);P.route("/api/calendar",$e);P.route("/api/backtest",it);P.route("/api/telegram",Ws);P.route("/api/ai",Gs);P.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>zs),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});P.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(p.timestamp,p.open,p.high,p.low,p.close,p.volume));await t.batch(m);const u=d.length;if(d.length>=50){const p=fe(d.reverse());if(p){await t.prepare(`
        ...
        `).bind(p.rsi_14,p.macd,p.macd_signal,p.macd_histogram,p.sma_20,p.sma_50,p.sma_200,p.ema_12,p.ema_26,p.bb_upper,p.bb_middle,p.bb_lower,p.atr_14,p.stochastic_k,p.stochastic_d,p.adx,p.plus_di,p.minus_di,p.ichimoku_tenkan,p.ichimoku_kijun,p.ichimoku_senkou_a,p.ichimoku_senkou_b,p.parabolic_sar,p.vwap,p.fib_382||0,p.fib_500||0,p.fib_618||0).run();const g=d[d.length-1].close,f=ne(g,p,"day_trade"),_=ne(g,p,"swing_trade"),h=70;for(const E of[f,_])if(E.confidence>=h&&E.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(E.signal_type,E.trading_style,E.price,E.stop_loss,E.take_profit_1,E.take_profit_2,E.take_profit_3,E.confidence,E.reason).run();const x=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),v={};for(const w of x.results||[])v[w.setting_key]=w.setting_value;v.telegram_bot_token&&v.telegram_chat_id&&await K({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},dt(E))}}}return e.json({success:!0,count:u})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),n={};for(const y of s.results)n[y.setting_key]=y.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",i=n.telegram_bot_token,r=n.telegram_chat_id,c=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,m=await(await fetch(c)).json();if(m.code&&m.status==="error")return e.json({success:!1,error:m.message||"API error",telegram_sent:!1});if(!m.values||!Array.isArray(m.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const p=m.values.map(y=>({timestamp:y.datetime,open:parseFloat(y.open)||0,high:parseFloat(y.high)||0,low:parseFloat(y.low)||0,close:parseFloat(y.close)||0,volume:parseInt(y.volume||"0")||0})),g=p.map(y=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(y.timestamp,y.open,y.high,y.low,y.close,y.volume,"1h"));await t.batch(g);const f=fe(p);if(!f)return e.json({success:!0,count:p.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});const _=p[p.length-1].close,h=ne(_,f,"day_trade",p),E=ne(_,f,"swing_trade",p),x=70;let v=!1;const w=[];if(i&&r&&i!=="your_bot_token_here"){if(h.confidence>=x&&h.signal_type!=="HOLD"){const y=h.signal_type==="BUY"?"🟢":"🔴",L=`${y} GOLD/USD ${h.signal_type} SIGNAL ${y}
...
⏰ ${new Date().toLocaleString()}`;await K({botToken:i,chatId:r},L)&&(v=!0,w.push("Day Trade"))}if(E.confidence>=80&&E.signal_type!=="HOLD"){const y=E.signal_type==="BUY"?"🟢":"🔴",L=`${y} GOLD/USD ${E.signal_type} SIGNAL ${y}
...
⏰ ${new Date().toLocaleString()}`;await K({botToken:i,chatId:r},L)&&(v=!0,w.push("Swing Trade"))}}return console.log(`[CRON] Processed ${p.length} candles, Telegram: ${v?"SENT":"NOT SENT"}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:p.length,latest_price:_},signals:{day_trade:{type:h.signal_type,confidence:h.confidence,price:_},swing_trade:{type:E.signal_type,confidence:E.confidence,price:_}},telegram:{configured:!!(i&&r),sent:v,alerts:w},message:v?`✅ Alerts sent: ${w.join(", ")}`:"⚪ No alerts (criteria not met or market in HOLD)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});P.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    ...
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(r,c),m=r["1h"],u=ne(c,m,"day_trade"),p=ne(c,m,"swing_trade"),g=n(u.signal_type,d),f=n(p.signal_type,d),_={...u,base_confidence:u.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${g.reason}`},h={...p,base_confidence:p.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${p.reason}, MTF: ${f.reason}`},E=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),x={};for(const y of E.results||[])x[y.setting_key]=y.setting_value;let v=!1,w=[];x.telegram_bot_token&&x.telegram_chat_id&&(_.isValid&&_.signal_type!=="HOLD"&&await K({botToken:x.telegram_bot_token,chatId:x.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${dt({..._,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(w.push("day_trade"),v=!0),await new Promise(y=>setTimeout(y,1e3)),h.isValid&&h.signal_type!=="HOLD"&&await K({botToken:x.telegram_bot_token,chatId:x.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${dt({...h,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(w.push("swing_trade"),v=!0));for(const y of[_,h])y.isValid&&await t.prepare(`
    ...
    `).first(),r=!n&&(i==null?void 0:i.count)>0;let l=0;if(r)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const H=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),X=(H==null?void 0:H.setting_value)||"70140f57bea54c5e90768de696487d8f",I=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const j of I)try{const le=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${j.interval}&apikey=${X}&outputsize=100`,D=new AbortController,q=setTimeout(()=>D.abort(),6e4),J=await fetch(le,{signal:D.signal});clearTimeout(q);const ae=await J.json();if(ae.values&&Array.isArray(ae.values)){const ie=[];for(const R of ae.values)ie.push({timestamp:R.datetime,open:parseFloat(R.open)||0,high:parseFloat(R.high)||0,low:parseFloat(R.low)||0,close:parseFloat(R.close)||0,volume:0});for(const R of ie)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind(R.timestamp,R.open,R.high,R.low,R.close,R.volume,j.dbKey).run();if(ie.length>=50){const R=fe(ie.reverse());R&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(j.dbKey,R.rsi_14,R.macd,R.macd_signal,R.macd_histogram,R.sma_20,R.sma_50,R.sma_200,R.ema_12,R.ema_26,R.bb_upper,R.bb_middle,R.bb_lower,R.atr_14,R.stochastic_k,R.stochastic_d,R.adx,R.plus_di,R.minus_di,R.ichimoku_tenkan,R.ichimoku_kijun,R.ichimoku_senkou_a,R.ichimoku_senkou_b,R.parabolic_sar,R.vwap,R.fib_382,R.fib_500,R.fib_618).run()}l+=ae.values.length}await new Promise(ie=>setTimeout(ie,100))}catch(le){console.error(`[MTF] Error fetching ${j.dbKey}:`,le)}}a.steps[0].status="completed",a.steps[0].data={totalCandles:l},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:o,validateMultiTimeframeSignal:c,formatAlignmentReport:d}=await Promise.resolve().then(()=>Ts),m={};for(const H of["5m","15m","1h","4h","daily"]){const X=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(H).first();X&&(m[H]=X)}const u=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),p=(u==null?void 0:u.close)||0,g=o(m,p),f=m["1h"],_=ne(p,f,"day_trade"),h=ne(p,f,"swing_trade"),E=c(_.signal_type,g),x=c(h.signal_type,g),v={..._,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:g.score,alignment_type:g.type},w={...h,final_confidence:Math.min(95,x.confidence),isValid:x.isValid,mtf_reason:x.reason,alignment_score:g.score,alignment_type:g.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:v,swingTrade:w,alignment:g},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const y=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),L=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:G}=await Promise.resolve().then(()=>yt),k=G(y,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},L.results),T=G(y,{entry_price:w.price,stop_loss:w.stop_loss,take_profit_1:w.take_profit_1,take_profit_2:w.take_profit_2,take_profit_3:w.take_profit_3,confidence:w.final_confidence,signal_type:w.signal_type,trading_style:w.trading_style},L.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:k,swingPosition:T},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const N=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),A={};for(const H of N.results||[])A[H.setting_key]=H.setting_value;let Y=!1;if(A.telegram_bot_token&&A.telegram_chat_id){const H=`
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();Y=await K({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},H)}if(a.steps[3].status=Y?"completed":"failed",a.steps[3].data={telegramSent:Y},v.isValid||w.isValid)for(const H of[v,w])H.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(H.signal_type,H.trading_style,H.price,H.stop_loss,H.take_profit_1,H.take_profit_2,H.take_profit_3,H.confidence,H.final_confidence,H.final_confidence,H.alignment_score,H.alignment_type,H.reason,Y?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:a,signals:{day_trade:v,swing_trade:w},positions:{day_trade:k,swing_trade:T},alignment:g,telegram_sent:Y})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});const ts=new _e,Zi=Object.assign({"/src/index.tsx":P});let Ys=!1;for(const[,e]of Object.entries(Zi))e&&(ts.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),ts.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),Ys=!0);if(!Ys)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const Qi=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],Ji=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function Vs(e){const t=e.toLowerCase();let s=0,n=0;for(const l of Qi)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of Ji)t.includes(l)&&(n+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(n+=1));const a=s+n;let i=0;a>0&&(i=(s-n)/a*100);let r="neutral";return i>20?r="bullish":i<-20&&(r="bearish"),{sentiment:r,score:i}}function er(e){let t=0,s=0,n=0,a=0;const i=e.map(o=>{const c=`${o.title} ${o.description||""}`,d=Vs(c);return d.sentiment==="bullish"?t++:d.sentiment==="bearish"?s++:n++,a+=d.score,{...o,sentiment:d.sentiment,score:d.score}}),r=e.length>0?a/e.length:0;let l="neutral";return r>20?l="bullish":r<-20&&(l="bearish"),{overall:l,score:Math.round(r),bullishCount:t,bearishCount:s,neutralCount:n,articles:i.slice(0,10)}}async function tr(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,a=await(await fetch(s)).json();return a.status!=="ok"?(console.error("NewsAPI error:",a.message),[]):a.articles.map(i=>({title:i.title,description:i.description,url:i.url,publishedAt:i.publishedAt,source:i.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function sr(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(n=>{const a=new Date(n.date);return a>=e&&a<=t})}const zs=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:er,analyzeSentiment:Vs,fetchGoldNews:tr,getEconomicEvents:sr},Symbol.toStringTag,{value:"Module"}));export{ts as default};
