var xn=Object.defineProperty;var ss=e=>{throw TypeError(e)};var kn=(e,t,s)=>t in e?xn(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Y=(e,t,s)=>kn(e,typeof t!="symbol"?t+"":t,s),jt=(e,t,s)=>t.has(e)||ss("Cannot "+s);var T=(e,t,s)=>(jt(e,t,"read from private field"),s?s.call(e):t.get(e)),q=(e,t,s)=>t.has(e)?ss("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),W=(e,t,s,n)=>(jt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),Z=(e,t,s)=>(jt(e,t,"access private method"),s);var ns=(e,t,s,n)=>({set _(a){W(e,t,a,s)},get _(){return T(e,t,n)}});var as=(e,t,s)=>(n,a)=>{let o=-1;return i(0);async function i(l){if(l<=o)throw new Error("next() called multiple times");o=l;let r,d=!1,c;if(e[l]?(c=e[l][0][0],n.req.routeIndex=l):c=l===e.length&&a||void 0,c)try{r=await c(n,()=>i(l+1))}catch(p){if(p instanceof Error&&t)n.error=p,r=await t(p,n),d=!0;else throw p}else n.finalized===!1&&s&&(r=await s(n));return r&&(n.finalized===!1||d)&&(n.res=r),n}},Rn=Symbol(),Ln=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,o=(e instanceof xs?e.raw.headers:e.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?In(e,{all:s,dot:n}):{}};async function In(e,t){const s=await e.formData();return s?$n(s,t):{}}function $n(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?An(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(Dn(s,n,a),delete s[n])}),s}var An=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Dn=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((o,i)=>{i===a.length-1?n[o]=s:((!n[o]||typeof n[o]!="object"||Array.isArray(n[o])||n[o]instanceof File)&&(n[o]=Object.create(null)),n=n[o])})},bs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Mn=e=>{const{groups:t,path:s}=Nn(e),n=bs(s);return On(n,t)},Nn=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},On=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},$t={},Cn=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return $t[n]||(s[2]?$t[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:$t[n]=[e,s[1],!0]),$t[n]}return null},Zt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Fn=e=>Zt(e,decodeURI),ws=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const o=t.indexOf("?",n),i=t.slice(s,o===-1?void 0:o);return Fn(i.includes("%25")?i.replace(/%25/g,"%2525"):i)}else if(a===63)break}return t.slice(s,n)},Un=e=>{const t=ws(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Qe=(e,t,...s)=>(s.length&&(t=Qe(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Ts=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const o=a.replace("?","");n+="/"+o,s.push(n)}else n+="/"+a}),s.filter((a,o,i)=>i.indexOf(a)===o)},Wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Zt(e,vs):e):e,Ss=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let i=e.indexOf("?",8);if(i===-1)return;for(e.startsWith(t,i+1)||(i=e.indexOf(`&${t}`,i+1));i!==-1;){const l=e.charCodeAt(i+t.length+1);if(l===61){const r=i+t.length+2,d=e.indexOf("&",r);return Wt(e.slice(r,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";i=e.indexOf(`&${t}`,i+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let o=e.indexOf("?",8);for(;o!==-1;){const i=e.indexOf("&",o+1);let l=e.indexOf("=",o);l>i&&i!==-1&&(l=-1);let r=e.slice(o+1,l===-1?i===-1?void 0:i:l);if(n&&(r=Wt(r)),o=i,r==="")continue;let d;l===-1?d="":(d=e.slice(l+1,i===-1?void 0:i),n&&(d=Wt(d))),s?(a[r]&&Array.isArray(a[r])||(a[r]=[]),a[r].push(d)):a[r]??(a[r]=d)}return t?a[t]:a},Bn=Ss,Hn=(e,t)=>Ss(e,t,!0),vs=decodeURIComponent,os=e=>Zt(e,vs),tt,ge,Re,ks,Rs,Xt,$e,_s,xs=(_s=class{constructor(e,t="/",s=[[]]){q(this,Re);Y(this,"raw");q(this,tt);q(this,ge);Y(this,"routeIndex",0);Y(this,"path");Y(this,"bodyCache",{});q(this,$e,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(o=>(a==="json"&&(o=JSON.stringify(o)),new Response(o)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,W(this,ge,s),W(this,tt,{})}param(e){return e?Z(this,Re,ks).call(this,e):Z(this,Re,Rs).call(this)}query(e){return Bn(this.url,e)}queries(e){return Hn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ln(this,e))}json(){return T(this,$e).call(this,"text").then(e=>JSON.parse(e))}text(){return T(this,$e).call(this,"text")}arrayBuffer(){return T(this,$e).call(this,"arrayBuffer")}blob(){return T(this,$e).call(this,"blob")}formData(){return T(this,$e).call(this,"formData")}addValidatedData(e,t){T(this,tt)[e]=t}valid(e){return T(this,tt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Rn](){return T(this,ge)}get matchedRoutes(){return T(this,ge)[0].map(([[,e]])=>e)}get routePath(){return T(this,ge)[0].map(([[,e]])=>e)[this.routeIndex].path}},tt=new WeakMap,ge=new WeakMap,Re=new WeakSet,ks=function(e){const t=T(this,ge)[0][this.routeIndex][1][e],s=Z(this,Re,Xt).call(this,t);return s&&/\%/.test(s)?os(s):s},Rs=function(){const e={},t=Object.keys(T(this,ge)[0][this.routeIndex][1]);for(const s of t){const n=Z(this,Re,Xt).call(this,T(this,ge)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?os(n):n)}return e},Xt=function(e){return T(this,ge)[1]?T(this,ge)[1][e]:e},$e=new WeakMap,_s),Pn={Stringify:1},Ls=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const o=e.callbacks;return o!=null&&o.length?(a?a[0]+=e:a=[e],Promise.all(o.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(r=>Ls(r,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},jn="text/plain; charset=UTF-8",Yt=(e,t)=>({"Content-Type":e,...t}),bt,wt,Se,st,ve,me,Tt,nt,at,je,St,vt,Ae,Je,gs,Wn=(gs=class{constructor(e,t){q(this,Ae);q(this,bt);q(this,wt);Y(this,"env",{});q(this,Se);Y(this,"finalized",!1);Y(this,"error");q(this,st);q(this,ve);q(this,me);q(this,Tt);q(this,nt);q(this,at);q(this,je);q(this,St);q(this,vt);Y(this,"render",(...e)=>(T(this,nt)??W(this,nt,t=>this.html(t)),T(this,nt).call(this,...e)));Y(this,"setLayout",e=>W(this,Tt,e));Y(this,"getLayout",()=>T(this,Tt));Y(this,"setRenderer",e=>{W(this,nt,e)});Y(this,"header",(e,t,s)=>{this.finalized&&W(this,me,new Response(T(this,me).body,T(this,me)));const n=T(this,me)?T(this,me).headers:T(this,je)??W(this,je,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});Y(this,"status",e=>{W(this,st,e)});Y(this,"set",(e,t)=>{T(this,Se)??W(this,Se,new Map),T(this,Se).set(e,t)});Y(this,"get",e=>T(this,Se)?T(this,Se).get(e):void 0);Y(this,"newResponse",(...e)=>Z(this,Ae,Je).call(this,...e));Y(this,"body",(e,t,s)=>Z(this,Ae,Je).call(this,e,t,s));Y(this,"text",(e,t,s)=>!T(this,je)&&!T(this,st)&&!t&&!s&&!this.finalized?new Response(e):Z(this,Ae,Je).call(this,e,t,Yt(jn,s)));Y(this,"json",(e,t,s)=>Z(this,Ae,Je).call(this,JSON.stringify(e),t,Yt("application/json",s)));Y(this,"html",(e,t,s)=>{const n=a=>Z(this,Ae,Je).call(this,a,t,Yt("text/html; charset=UTF-8",s));return typeof e=="object"?Ls(e,Pn.Stringify,!1,{}).then(n):n(e)});Y(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});Y(this,"notFound",()=>(T(this,at)??W(this,at,()=>new Response),T(this,at).call(this,this)));W(this,bt,e),t&&(W(this,ve,t.executionCtx),this.env=t.env,W(this,at,t.notFoundHandler),W(this,vt,t.path),W(this,St,t.matchResult))}get req(){return T(this,wt)??W(this,wt,new xs(T(this,bt),T(this,vt),T(this,St))),T(this,wt)}get event(){if(T(this,ve)&&"respondWith"in T(this,ve))return T(this,ve);throw Error("This context has no FetchEvent")}get executionCtx(){if(T(this,ve))return T(this,ve);throw Error("This context has no ExecutionContext")}get res(){return T(this,me)||W(this,me,new Response(null,{headers:T(this,je)??W(this,je,new Headers)}))}set res(e){if(T(this,me)&&e){e=new Response(e.body,e);for(const[t,s]of T(this,me).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=T(this,me).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}W(this,me,e),this.finalized=!0}get var(){return T(this,Se)?Object.fromEntries(T(this,Se)):{}}},bt=new WeakMap,wt=new WeakMap,Se=new WeakMap,st=new WeakMap,ve=new WeakMap,me=new WeakMap,Tt=new WeakMap,nt=new WeakMap,at=new WeakMap,je=new WeakMap,St=new WeakMap,vt=new WeakMap,Ae=new WeakSet,Je=function(e,t,s){const n=T(this,me)?new Headers(T(this,me).headers):T(this,je)??new Headers;if(typeof t=="object"&&"headers"in t){const o=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[i,l]of o)i.toLowerCase()==="set-cookie"?n.append(i,l):n.set(i,l)}if(s)for(const[o,i]of Object.entries(s))if(typeof i=="string")n.set(o,i);else{n.delete(o);for(const l of i)n.append(o,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??T(this,st);return new Response(e,{status:a,headers:n})},gs),oe="ALL",Yn="all",Gn=["get","post","put","delete","options","patch"],Is="Can not add a route since the matcher is already built.",$s=class extends Error{},Vn="__COMPOSED_HANDLER",qn=e=>e.text("404 Not Found",404),is=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},ye,ie,As,Ee,He,At,Dt,ot,zn=(ot=class{constructor(t={}){q(this,ie);Y(this,"get");Y(this,"post");Y(this,"put");Y(this,"delete");Y(this,"options");Y(this,"patch");Y(this,"all");Y(this,"on");Y(this,"use");Y(this,"router");Y(this,"getPath");Y(this,"_basePath","/");q(this,ye,"/");Y(this,"routes",[]);q(this,Ee,qn);Y(this,"errorHandler",is);Y(this,"onError",t=>(this.errorHandler=t,this));Y(this,"notFound",t=>(W(this,Ee,t),this));Y(this,"fetch",(t,...s)=>Z(this,ie,Dt).call(this,t,s[1],s[0],t.method));Y(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Qe("/",t)}`,s),n,a)));Y(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(Z(this,ie,Dt).call(this,t.request,t,void 0,t.request.method))})});[...Gn,Yn].forEach(o=>{this[o]=(i,...l)=>(typeof i=="string"?W(this,ye,i):Z(this,ie,He).call(this,o,T(this,ye),i),l.forEach(r=>{Z(this,ie,He).call(this,o,T(this,ye),r)}),this)}),this.on=(o,i,...l)=>{for(const r of[i].flat()){W(this,ye,r);for(const d of[o].flat())l.map(c=>{Z(this,ie,He).call(this,d.toUpperCase(),T(this,ye),c)})}return this},this.use=(o,...i)=>(typeof o=="string"?W(this,ye,o):(W(this,ye,"*"),i.unshift(o)),i.forEach(l=>{Z(this,ie,He).call(this,oe,T(this,ye),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ws:Un}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var i;let o;s.errorHandler===is?o=a.handler:(o=async(l,r)=>(await as([],s.errorHandler)(l,()=>a.handler(l,r))).res,o[Vn]=a.handler),Z(i=n,ie,He).call(i,a.method,a.path,o)}),this}basePath(t){const s=Z(this,ie,As).call(this);return s._basePath=Qe(this._basePath,t),s}mount(t,s,n){let a,o;n&&(typeof n=="function"?o=n:(o=n.optionHandler,n.replaceRequest===!1?a=r=>r:a=n.replaceRequest));const i=o?r=>{const d=o(r);return Array.isArray(d)?d:[d]}:r=>{let d;try{d=r.executionCtx}catch{}return[r.env,d]};a||(a=(()=>{const r=Qe(this._basePath,t),d=r==="/"?0:r.length;return c=>{const p=new URL(c.url);return p.pathname=p.pathname.slice(d)||"/",new Request(p,c)}})());const l=async(r,d)=>{const c=await s(a(r.req.raw),...i(r));if(c)return c;await d()};return Z(this,ie,He).call(this,oe,Qe(t,"*"),l),this}},ye=new WeakMap,ie=new WeakSet,As=function(){const t=new ot({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,W(t,Ee,T(this,Ee)),t.routes=this.routes,t},Ee=new WeakMap,He=function(t,s,n){t=t.toUpperCase(),s=Qe(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},At=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Dt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await Z(this,ie,Dt).call(this,t,s,n,"GET")))();const o=this.getPath(t,{env:n}),i=this.router.match(a,o),l=new Wn(t,{path:o,matchResult:i,env:n,executionCtx:s,notFoundHandler:T(this,Ee)});if(i[0].length===1){let d;try{d=i[0][0][0][0](l,async()=>{l.res=await T(this,Ee).call(this,l)})}catch(c){return Z(this,ie,At).call(this,c,l)}return d instanceof Promise?d.then(c=>c||(l.finalized?l.res:T(this,Ee).call(this,l))).catch(c=>Z(this,ie,At).call(this,c,l)):d??T(this,Ee).call(this,l)}const r=as(i[0],this.errorHandler,T(this,Ee));return(async()=>{try{const d=await r(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return Z(this,ie,At).call(this,d,l)}})()},ot),Ds=[];function Xn(e,t){const s=this.buildAllMatchers(),n=((a,o)=>{const i=s[a]||s[oe],l=i[2][o];if(l)return l;const r=o.match(i[0]);if(!r)return[[],Ds];const d=r.indexOf("",1);return[i[1][d],r]});return this.match=n,n(e,t)}var Ot="[^/]+",ht=".*",yt="(?:|/.*)",et=Symbol(),Kn=new Set(".\\+*[^]$()");function Zn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ht||e===yt?1:t===ht||t===yt?-1:e===Ot?1:t===Ot?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var We,Ye,be,qe,Qn=(qe=class{constructor(){q(this,We);q(this,Ye);q(this,be,Object.create(null))}insert(t,s,n,a,o){if(t.length===0){if(T(this,We)!==void 0)throw et;if(o)return;W(this,We,s);return}const[i,...l]=t,r=i==="*"?l.length===0?["","",ht]:["","",Ot]:i==="/*"?["","",yt]:i.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(r){const c=r[1];let p=r[2]||Ot;if(c&&r[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw et;if(d=T(this,be)[p],!d){if(Object.keys(T(this,be)).some(_=>_!==ht&&_!==yt))throw et;if(o)return;d=T(this,be)[p]=new qe,c!==""&&W(d,Ye,a.varIndex++)}!o&&c!==""&&n.push([c,T(d,Ye)])}else if(d=T(this,be)[i],!d){if(Object.keys(T(this,be)).some(c=>c.length>1&&c!==ht&&c!==yt))throw et;if(o)return;d=T(this,be)[i]=new qe}d.insert(l,s,n,a,o)}buildRegExpStr(){const s=Object.keys(T(this,be)).sort(Zn).map(n=>{const a=T(this,be)[n];return(typeof T(a,Ye)=="number"?`(${n})@${T(a,Ye)}`:Kn.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof T(this,We)=="number"&&s.unshift(`#${T(this,We)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},We=new WeakMap,Ye=new WeakMap,be=new WeakMap,qe),Ft,xt,fs,Jn=(fs=class{constructor(){q(this,Ft,{varIndex:0});q(this,xt,new Qn)}insert(e,t,s){const n=[],a=[];for(let i=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,r=>{const d=`@\\${i}`;return a[i]=[d,r],i++,l=!0,d}),!l)break}const o=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let i=a.length-1;i>=0;i--){const[l]=a[i];for(let r=o.length-1;r>=0;r--)if(o[r].indexOf(l)!==-1){o[r]=o[r].replace(l,a[i][1]);break}}return T(this,xt).insert(o,t,n,T(this,Ft),s),n}buildRegExp(){let e=T(this,xt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,o,i)=>o!==void 0?(s[++t]=Number(o),"$()"):(i!==void 0&&(n[Number(i)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Ft=new WeakMap,xt=new WeakMap,fs),ea=[/^$/,[],Object.create(null)],Mt=Object.create(null);function Ms(e){return Mt[e]??(Mt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ta(){Mt=Object.create(null)}function sa(e){var d;const t=new Jn,s=[];if(e.length===0)return ea;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,p],[_,m])=>c?1:_?-1:p.length-m.length),a=Object.create(null);for(let c=0,p=-1,_=n.length;c<_;c++){const[m,u,g]=n[c];m?a[u]=[g.map(([f])=>[f,Object.create(null)]),Ds]:p++;let h;try{h=t.insert(u,p,m)}catch(f){throw f===et?new $s(u):f}m||(s[p]=g.map(([f,y])=>{const w=Object.create(null);for(y-=1;y>=0;y--){const[E,S]=h[y];w[E]=S}return[f,w]}))}const[o,i,l]=t.buildRegExp();for(let c=0,p=s.length;c<p;c++)for(let _=0,m=s[c].length;_<m;_++){const u=(d=s[c][_])==null?void 0:d[1];if(!u)continue;const g=Object.keys(u);for(let h=0,f=g.length;h<f;h++)u[g[h]]=l[u[g[h]]]}const r=[];for(const c in i)r[c]=s[i[c]];return[o,r,a]}function Ze(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(Ms(s).test(t))return[...e[s]]}}var De,Me,Ut,Ns,hs,na=(hs=class{constructor(){q(this,Ut);Y(this,"name","RegExpRouter");q(this,De);q(this,Me);Y(this,"match",Xn);W(this,De,{[oe]:Object.create(null)}),W(this,Me,{[oe]:Object.create(null)})}add(e,t,s){var l;const n=T(this,De),a=T(this,Me);if(!n||!a)throw new Error(Is);n[e]||[n,a].forEach(r=>{r[e]=Object.create(null),Object.keys(r[oe]).forEach(d=>{r[e][d]=[...r[oe][d]]})}),t==="/*"&&(t="*");const o=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const r=Ms(t);e===oe?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ze(n[d],t)||Ze(n[oe],t)||[])}):(l=n[e])[t]||(l[t]=Ze(n[e],t)||Ze(n[oe],t)||[]),Object.keys(n).forEach(d=>{(e===oe||e===d)&&Object.keys(n[d]).forEach(c=>{r.test(c)&&n[d][c].push([s,o])})}),Object.keys(a).forEach(d=>{(e===oe||e===d)&&Object.keys(a[d]).forEach(c=>r.test(c)&&a[d][c].push([s,o]))});return}const i=Ts(t)||[t];for(let r=0,d=i.length;r<d;r++){const c=i[r];Object.keys(a).forEach(p=>{var _;(e===oe||e===p)&&((_=a[p])[c]||(_[c]=[...Ze(n[p],c)||Ze(n[oe],c)||[]]),a[p][c].push([s,o-d+r+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(T(this,Me)).concat(Object.keys(T(this,De))).forEach(t=>{e[t]||(e[t]=Z(this,Ut,Ns).call(this,t))}),W(this,De,W(this,Me,void 0)),ta(),e}},De=new WeakMap,Me=new WeakMap,Ut=new WeakSet,Ns=function(e){const t=[];let s=e===oe;return[T(this,De),T(this,Me)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(o=>[o,n[e][o]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==oe&&t.push(...Object.keys(n[oe]).map(o=>[o,n[oe][o]]))}),s?sa(t):null},hs),Ne,xe,ys,aa=(ys=class{constructor(e){Y(this,"name","SmartRouter");q(this,Ne,[]);q(this,xe,[]);W(this,Ne,e.routers)}add(e,t,s){if(!T(this,xe))throw new Error(Is);T(this,xe).push([e,t,s])}match(e,t){if(!T(this,xe))throw new Error("Fatal error");const s=T(this,Ne),n=T(this,xe),a=s.length;let o=0,i;for(;o<a;o++){const l=s[o];try{for(let r=0,d=n.length;r<d;r++)l.add(...n[r]);i=l.match(e,t)}catch(r){if(r instanceof $s)continue;throw r}this.match=l.match.bind(l),W(this,Ne,[l]),W(this,xe,void 0);break}if(o===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,i}get activeRouter(){if(T(this,xe)||T(this,Ne).length!==1)throw new Error("No active router has been determined yet.");return T(this,Ne)[0]}},Ne=new WeakMap,xe=new WeakMap,ys),ft=Object.create(null),Oe,ce,Ge,it,re,ke,Pe,rt,oa=(rt=class{constructor(t,s,n){q(this,ke);q(this,Oe);q(this,ce);q(this,Ge);q(this,it,0);q(this,re,ft);if(W(this,ce,n||Object.create(null)),W(this,Oe,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},W(this,Oe,[a])}W(this,Ge,[])}insert(t,s,n){W(this,it,++ns(this,it)._);let a=this;const o=Mn(s),i=[];for(let l=0,r=o.length;l<r;l++){const d=o[l],c=o[l+1],p=Cn(d,c),_=Array.isArray(p)?p[0]:d;if(_ in T(a,ce)){a=T(a,ce)[_],p&&i.push(p[1]);continue}T(a,ce)[_]=new rt,p&&(T(a,Ge).push(p),i.push(p[1])),a=T(a,ce)[_]}return T(a,Oe).push({[t]:{handler:n,possibleKeys:i.filter((l,r,d)=>d.indexOf(l)===r),score:T(this,it)}}),a}search(t,s){var r;const n=[];W(this,re,ft);let o=[this];const i=bs(s),l=[];for(let d=0,c=i.length;d<c;d++){const p=i[d],_=d===c-1,m=[];for(let u=0,g=o.length;u<g;u++){const h=o[u],f=T(h,ce)[p];f&&(W(f,re,T(h,re)),_?(T(f,ce)["*"]&&n.push(...Z(this,ke,Pe).call(this,T(f,ce)["*"],t,T(h,re))),n.push(...Z(this,ke,Pe).call(this,f,t,T(h,re)))):m.push(f));for(let y=0,w=T(h,Ge).length;y<w;y++){const E=T(h,Ge)[y],S=T(h,re)===ft?{}:{...T(h,re)};if(E==="*"){const I=T(h,ce)["*"];I&&(n.push(...Z(this,ke,Pe).call(this,I,t,T(h,re))),W(I,re,S),m.push(I));continue}const[b,k,v]=E;if(!p&&!(v instanceof RegExp))continue;const D=T(h,ce)[b],R=i.slice(d).join("/");if(v instanceof RegExp){const I=v.exec(R);if(I){if(S[k]=I[0],n.push(...Z(this,ke,Pe).call(this,D,t,T(h,re),S)),Object.keys(T(D,ce)).length){W(D,re,S);const U=((r=I[0].match(/\//))==null?void 0:r.length)??0;(l[U]||(l[U]=[])).push(D)}continue}}(v===!0||v.test(p))&&(S[k]=p,_?(n.push(...Z(this,ke,Pe).call(this,D,t,S,T(h,re))),T(D,ce)["*"]&&n.push(...Z(this,ke,Pe).call(this,T(D,ce)["*"],t,S,T(h,re)))):(W(D,re,S),m.push(D)))}}o=m.concat(l.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},Oe=new WeakMap,ce=new WeakMap,Ge=new WeakMap,it=new WeakMap,re=new WeakMap,ke=new WeakSet,Pe=function(t,s,n,a){const o=[];for(let i=0,l=T(t,Oe).length;i<l;i++){const r=T(t,Oe)[i],d=r[s]||r[oe],c={};if(d!==void 0&&(d.params=Object.create(null),o.push(d),n!==ft||a&&a!==ft))for(let p=0,_=d.possibleKeys.length;p<_;p++){const m=d.possibleKeys[p],u=c[d.score];d.params[m]=a!=null&&a[m]&&!u?a[m]:n[m]??(a==null?void 0:a[m]),c[d.score]=!0}}return o},rt),Ve,Es,ia=(Es=class{constructor(){Y(this,"name","TrieRouter");q(this,Ve);W(this,Ve,new oa)}add(e,t,s){const n=Ts(t);if(n){for(let a=0,o=n.length;a<o;a++)T(this,Ve).insert(e,n[a],s);return}T(this,Ve).insert(e,t,s)}match(e,t){return T(this,Ve).search(e,t)}},Ve=new WeakMap,Es),_e=class extends zn{constructor(e={}){super(e),this.router=e.router??new aa({routers:[new na,new ia]})}},ra=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(o=>typeof o=="string"?o==="*"?()=>o:i=>o===i?i:null:typeof o=="function"?o:i=>o.includes(i)?i:null)(s.origin),a=(o=>typeof o=="function"?o:Array.isArray(o)?()=>o:()=>[])(s.allowMethods);return async function(i,l){var c;function r(p,_){i.res.headers.set(p,_)}const d=await n(i.req.header("origin")||"",i);if(d&&r("Access-Control-Allow-Origin",d),s.credentials&&r("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&r("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),i.req.method==="OPTIONS"){s.origin!=="*"&&r("Vary","Origin"),s.maxAge!=null&&r("Access-Control-Max-Age",s.maxAge.toString());const p=await a(i.req.header("origin")||"",i);p.length&&r("Access-Control-Allow-Methods",p.join(","));let _=s.allowHeaders;if(!(_!=null&&_.length)){const m=i.req.header("Access-Control-Request-Headers");m&&(_=m.split(/\s*,\s*/))}return _!=null&&_.length&&(r("Access-Control-Allow-Headers",_.join(",")),i.res.headers.append("Vary","Access-Control-Request-Headers")),i.res.headers.delete("Content-Length"),i.res.headers.delete("Content-Type"),new Response(null,{headers:i.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&i.header("Vary","Origin",{append:!0})}};function Bt(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=la(e),s=ca(),n=da(e,s.session),a=ma(t,s.session),o=pa(t,s),i=ua(t,s,n,o),l=_a(i,t,s,n),r=ga(i);return{liquidity_score:Math.round(i),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(o),optimal_for_trading:i>=70&&l.length===0,warnings:l,recommendation:r}}function la(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((d,c)=>d+(c.volume||1),0)/e.length,a=t.reduce((d,c)=>d+(c.volume||1),0)/t.length,o=s.reduce((d,c)=>d+(c.volume||1),0)/s.length,i=a/n;let l;a>o*1.2?l="INCREASING":a<o*.8?l="DECREASING":l="STABLE";const r=Math.min(100,i*100);return{avg_volume:n,current_volume:a,volume_ratio:i,volume_spike:i>2,volume_drought:i<.5,trend:l,percentile:r}}function ca(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,o;return n>=780&&n<960?(a="OVERLAP",o="HIGH"):n>=480&&n<780?(a="LONDON",o="HIGH"):n>=960&&n<1320?(a="NEW_YORK",o="HIGH"):n>=0&&n<480?(a="ASIA",o="MEDIUM"):(a="OFF_HOURS",o="LOW"),{zone:o,session:a}}function da(e,t){const s=e.slice(-20);let n=0;for(const c of s){const p=c.high-c.low;n+=p}const a=n/s.length,o=s[s.length-1].close,i=a/o*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const r=1+i*2,d=l*r;return{spread_pips:Math.round(d)}}function ma(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,o=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*o}function pa(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function ua(e,t,s,n){const a=e.percentile*.3,o=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,i=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+o+i+l}function _a(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function ga(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}function Ce(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function Et(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Ce(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Os(e,t=14){if(e.length<t+1)return 50;const s=[];for(let r=1;r<e.length;r++)s.push(e[r]-e[r-1]);let n=0,a=0;for(let r=0;r<t;r++)s[r]>0?n+=s[r]:a+=Math.abs(s[r]);let o=n/t,i=a/t;for(let r=t;r<s.length;r++){const d=s[r];o=(o*(t-1)+(d>0?d:0))/t,i=(i*(t-1)+(d<0?Math.abs(d):0))/t}return i===0?100:100-100/(1+o/i)}function Cs(e){const t=Et(e,12),s=Et(e,26),n=t-s,a=n*.9,o=n-a;return{macd:n,signal:a,histogram:o}}function Fs(e,t=20,s=2){const n=Ce(e,t),o=e.slice(-t).reduce((l,r)=>l+Math.pow(r-n,2),0)/t,i=Math.sqrt(o);return{upper:n+i*s,middle:n,lower:n-i*s}}function Us(e,t=14){if(e.length<t+1)return 10;const s=[];for(let o=1;o<e.length;o++){const i=e[o].high,l=e[o].low,r=e[o-1].close,d=Math.max(i-l,Math.abs(i-r),Math.abs(l-r));s.push(d)}const n=Ce(s,t);return Math.max(n,10)}function Bs(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(p=>p.high),o=n.map(p=>p.low),i=e[e.length-1].close,l=Math.max(...a),r=Math.min(...o),d=(i-r)/(l-r)*100;return{k:d,d}}function Hs(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let d=1;d<Math.min(t+1,e.length);d++){const c=e[d].high,p=e[d].low,_=e[d-1].high,m=e[d-1].low,u=e[d-1].close,g=c-_,h=m-p;g>h&&g>0&&(s+=g),h>g&&h>0&&(n+=h),a+=Math.max(c-p,Math.abs(c-u),Math.abs(p-u))}const o=a>0?s/a*100:0,i=a>0?n/a*100:0;return{adx:o+i>0?Math.abs(o-i)/(o+i)*100:0,plusDI:o,minusDI:i}}function Ps(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(f=>f.high)),a=Math.min(...s.map(f=>f.low)),o=(n+a)/2,i=Math.min(26,e.length),l=e.slice(-i),r=Math.max(...l.map(f=>f.high)),d=Math.min(...l.map(f=>f.low)),c=(r+d)/2,p=(o+c)/2,_=Math.min(52,e.length),m=e.slice(-_),u=Math.max(...m.map(f=>f.high)),g=Math.min(...m.map(f=>f.low)),h=(u+g)/2;return{tenkan:o,kijun:c,senkouA:p,senkouB:h}}function js(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Ws(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,o=n.volume||1;t+=a*o,s+=o}return s>0?t/s:e[e.length-1].close}function Ys(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(r=>r.high),a=s.map(r=>r.low),o=Math.max(...n),i=Math.min(...a),l=o-i;return{fib_0:o,fib_236:o-l*.236,fib_382:o-l*.382,fib_500:o-l*.5,fib_618:o-l*.618,fib_100:i}}function pe(e){if(e.length<50)return null;const t=e.map(c=>c.close),s=Cs(t),n=Fs(t),a=Bs(e,14,3),o=Hs(e,14),i=Ps(e),l=js(e),r=Ws(e),d=Ys(e,50);return{rsi_14:Os(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Ce(t,20),sma_50:Ce(t,50),sma_200:e.length>=200?Ce(t,200):Ce(t,Math.min(100,e.length)),ema_12:Et(t,12),ema_26:Et(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Us(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:o.adx,plus_di:o.plusDI,minus_di:o.minusDI,ichimoku_tenkan:i.tenkan,ichimoku_kijun:i.kijun,ichimoku_senkou_a:i.senkouA,ichimoku_senkou_b:i.senkouB,parabolic_sar:l,vwap:r,fib_382:d.fib_382,fib_500:d.fib_500,fib_618:d.fib_618}}function le(e,t,s){const n=[];let a=0,o=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:o+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),o+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),o+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),o+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),o+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),o+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),o+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),o+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),o+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),o+=2):t.rsi_14>60&&(n.push("RSI above 60"),o+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),o+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),o+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),o+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),o+=2);const i=a+o,l=i>0?a/i*100:50;let r="HOLD",d=50;a>o+1?(r="BUY",d=Math.min(l,95)):o>a+1&&(r="SELL",d=Math.min(100-l,95)),t.adx>30&&Math.abs(a-o)>4&&(d=Math.min(d+5,95),n.push("High conviction signal"));const c=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,_=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,g=e*(1/100);let h,f,y,w;if(r==="BUY"){const E=e-t.atr_14*c;h=Math.max(E,e-g),f=e+t.atr_14*p,y=e+t.atr_14*_,w=e+t.atr_14*m}else if(r==="SELL"){const E=e+t.atr_14*c;h=Math.min(E,e+g),f=e-t.atr_14*p,y=e-t.atr_14*_,w=e-t.atr_14*m}else h=e,f=e,y=e,w=e;return{signal_type:r,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(f.toFixed(2)),take_profit_2:parseFloat(y.toFixed(2)),take_profit_3:parseFloat(w.toFixed(2)),confidence:parseFloat(d.toFixed(1)),reason:n.join(", ")}}function ze(e,t,s,n){const a=le(e,t,n),o=Bt(s);let i=a.confidence;o.liquidity_score<50?i*=.85:o.liquidity_score<60?i*=.9:o.liquidity_score<70&&(i*=.95),o.optimal_for_trading&&o.liquidity_score>=80&&(i=Math.min(i*1.05,95));let l=1;o.liquidity_score<40?l=.25:o.liquidity_score<50?l=.5:o.liquidity_score<60?l=.75:o.liquidity_score>=80&&o.optimal_for_trading&&(l=1);let r=a.reason;return o.session&&(r+=` | Session: ${o.session}`),o.warnings.length>0&&(r+=` | ⚠️ ${o.warnings[0]}`),{...a,confidence:parseFloat(i.toFixed(1)),reason:r,liquidity_score:o.liquidity_score,session:o.session,time_zone:o.time_of_day_zone,volume_trend:o.volume_trend,volume_percentile:o.volume_percentile,estimated_spread_pips:o.estimated_spread_pips,price_impact_bps:o.price_impact_bps,market_depth_score:o.market_depth_score,optimal_for_trading:o.optimal_for_trading,liquidity_warnings:JSON.stringify(o.warnings),liquidity_recommendation:o.recommendation,position_size_multiplier:l}}const rs=Object.freeze(Object.defineProperty({__proto__:null,calculateADX:Hs,calculateATR:Us,calculateBollingerBands:Fs,calculateEMA:Et,calculateFibonacci:Ys,calculateIchimoku:Ps,calculateIndicators:pe,calculateMACD:Cs,calculateParabolicSAR:js,calculateRSI:Os,calculateSMA:Ce,calculateStochastic:Bs,calculateVWAP:Ws,generateSignal:le,generateSignalWithLiquidity:ze},Symbol.toStringTag,{value:"Module"}));async function z(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function fa(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function lt(e,t){const s=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",n=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";let a=`
...
`)}const Jt=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Qt,determineTrend:Vs,formatAlignmentReport:ha,validateMultiTimeframeSignal:Kt},Symbol.toStringTag,{value:"Module"}));function ls(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((o,i)=>o-i),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function ya(e,t){const s=ls(e,.95),n=ls(e,.99),a=t*s,o=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(o.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Ea(e,t,s,n){const a=t-e,o=a/t*100;let i=0;for(let d=n.length-1;d>=0&&n[d].balance<t;d--)i++;const l=o<=s,r=o>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(o.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:i}}function ba(e,t,s=5){let n=0;const a=[];for(const r of e){const c=Math.abs(r.entry_price-r.stop_loss)*r.position_size,p=c/t*100;n+=c,a.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const o=n/t*100,i=o<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(o.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:a}}function wa(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),n=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&n.push({index:r,value:s[r]});if(n.length<3)return null;const a=n.slice(-3),[o,i,l]=a;if(i.value>o.value&&i.value>l.value&&Math.abs(o.value-l.value)/o.value<.02){const d=Math.min(o.value,l.value)*.995,c=d-(i.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function Ta(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const r=s[s.length-1],d=n[n.length-1]-n[0],c=r+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function Sa(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),n=t.map(d=>d.low),o=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=n.slice(0,6),l=n.slice(-6),r=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(o<.01&&r>.015){const d=Math.max(...s),c=t[t.length-1].close,p=d+(d-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function va(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),n=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&n.push({index:r,value:s[r]});if(n.length<2)return null;const a=n.slice(-2),[o,i]=a;if(Math.abs(o.value-i.value)/o.value<.015){const r=Math.max(...s.slice(o.index,i.index))*1.005,d=r+(r-o.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:66}}return null}function xa(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),o=s[25];if(Math.abs(n-o)/n<.02&&a<n*.95){const l=s.slice(25),r=Math.min(...l),d=(o-r)/o;if(d>.01&&d<.05){const c=n-a,p=o+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function ka(e){const t=[],s=wa(e);s&&t.push(s);const n=Ta(e);n&&t.push(n);const a=Sa(e);a&&t.push(a);const o=va(e);o&&t.push(o);const i=xa(e);i&&t.push(i);let l=0,r=0,d=0;for(const m of t)m.direction==="bullish"?(l++,d+=m.confidence):m.direction==="bearish"&&(r++,d+=m.confidence);let c="neutral",p=0;l>r?(c="bullish",p=Math.min(d/l/10,15)):r>l&&(c="bearish",p=Math.min(d/r/10,15));let _="";if(t.length===0)_="No significant chart patterns detected";else{const m=t.map(u=>u.pattern_type).join(", ");_=`Detected ${t.length} pattern(s): ${m}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(p.toFixed(1)),summary:_}}function Ra(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function La(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function Ia(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function $a(e,t,s){const n=Ra(t.atr_14,s),a=La(t,s),o=Ia(t,s);let i,l,r,d,c,p;const _=e.slice(-10),m=_.map(f=>f.volume||0),u=m.reduce((f,y)=>f+y,0)/m.length,h=(_[_.length-1].volume||0)>u*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,r=!0,d="Trend-following (aggressive entry)",c=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,r=!1,d="Wait for stabilization",c=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,r=!1,d="Wait for direction",c=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,r=!0,d="Trend-following (buy dips, trail stops)",c=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,r=!1,d="Stay in cash or short",c=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,r=!0,d="Trend-following (selective entries)",c=1,p="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,r=!1,d="Reduce exposure or stay flat",c=.5,p="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,o>60?(r=!0,d="Mean-reversion (fade extremes)",c=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,d="Wait for trend to develop",c=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:o,should_trade:r,recommended_strategy:d,risk_adjustment:c,description:p}}function Aa(e){const t=e.length;let s=0,n=0,a=0,o=0;for(let r=0;r<t;r++)s+=r,n+=e[r],a+=r*e[r],o+=r*r;const i=(t*a-s*n)/(t*o-s*s),l=(n-i*s)/t;return{slope:i,intercept:l}}function Da(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let o=n[0];for(let l=1;l<n.length;l++)o=(n[l]-o)*a+o;const i=(n[n.length-1]-n[n.length-10])/10;return o+i*s}function Ma(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const i=n.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function Na(e,t,s){const n=e[e.length-1].close;e.map(i=>i.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const o=a/100*s;return n+t.atr_14*o}function Oa(e,t){const s=e.map(_=>_.close),n=s[s.length-1],a=10,o=s.slice(-a),i=Math.min(...o),l=Math.max(...o),r=o.map(_=>(_-i)/(l-i));let d={index:0,similarity:-1/0};for(let _=a;_<s.length-a-t;_++){const m=s.slice(_-a,_),u=Math.min(...m),g=Math.max(...m),h=m.map(w=>(w-u)/(g-u));let f=0;for(let w=0;w<a;w++)f+=Math.pow(r[w]-h[w],2);const y=-f;y>d.similarity&&(d={index:_,similarity:y})}const p=(s[d.index+t]-s[d.index])*(n/s[d.index]);return n+p}function Gt(e,t,s){const n=[],a=[],o=e.map(b=>b.close),{slope:i,intercept:l}=Aa(o.slice(-20)),r=i*(o.length-1+s)+l;n.push(r),a.push(1);const d=Da(e,12,s);n.push(d),a.push(1.5);const c=Ma(e,s);n.push(c),a.push(1.2);const p=Na(e,t,s);n.push(p),a.push(1.8);const _=Oa(e,s);n.push(_),a.push(1.3);const m=a.reduce((b,k)=>b+k,0),g=n.reduce((b,k,v)=>b+k*a[v],0)/m,h=n.reduce((b,k)=>b+k,0)/n.length,f=n.reduce((b,k)=>b+Math.pow(k-h,2),0)/n.length,y=Math.sqrt(f),w=e[e.length-1].close,E=1-y/w,S=Math.max(50,Math.min(95,E*100));return{prediction:g,confidence:S}}function Ca(e,t){const s=e[e.length-1].close,n=[],a=Gt(e,t,1),o=a.prediction-s,i=o/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:o>.5?"UP":o<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Gt(e,t,4),r=l.prediction-s,d=r/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Gt(e,t,24),p=c.prediction-s,_=p/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(_.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(y=>y.direction==="UP").length,u=n.filter(y=>y.direction==="DOWN").length;let g,h=0;m>u?(g="BULLISH",h=Math.min(m*5,15)):u>m?(g="BEARISH",h=Math.min(u*5,15)):g="NEUTRAL";const f=`ML models predict ${g} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:g,confidence_boost:parseFloat(h.toFixed(1)),summary:f}}function Vt(e,t,s,n,a){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const r=(n-50)/10;l+=r;const d=(a-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function Fa(e,t,s,n,a){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,a==="BUY"){const r=(n-50)/10;l-=r}else{const r=(n-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function Ua(e,t,s,n,a,o){const i=(s-e)*.5,l=(n-e)*.3,r=(a-e)*.2,d=t-e;return o.tp1/100*i+o.tp2/100*l+o.tp3/100*r+o.sl/100*d}function Ba(e,t,s){const n=e.price,a=t.atr_14;let o=50;e.signal_type==="BUY"?(n>t.sma_20&&(o+=10),n>t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(o+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(o+=10),n<t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(o+=10)),o=Math.min(100,o);const i=s.slice(-50),l=[];for(let w=14;w<i.length;w++){const E=i.slice(w-14,w);let S=0;for(let b=1;b<E.length;b++){const k=Math.max(E[b].high-E[b].low,Math.abs(E[b].high-E[b-1].close),Math.abs(E[b].low-E[b-1].close));S+=k}l.push(S/14)}const r=l.reduce((w,E)=>w+E,0)/l.length,d=a/r,c=Vt(n,e.take_profit_1,a,o,d),p=Vt(n,e.take_profit_2,a,o,d),_=Vt(n,e.take_profit_3,a,o,d),m=Fa(n,e.stop_loss,a,o,e.signal_type),u=Ua(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:p,tp3:_,sl:m}),h=(c+p+_)/3/m;let f;c>70&&u>5&&h>2?f="STRONG_TRADE":c>60&&u>0&&h>1.5?f="GOOD_TRADE":c>50&&u>-2?f="MARGINAL_TRADE":f="AVOID_TRADE";const y=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${u.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${f.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(_.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(u.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:f,summary:y}}const es=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ha(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Ht(e=30){const t=[],s=new Date;for(const a of es){const o=new Date(a),i=Math.floor((o.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const o=new Date(s.getTime()+a*24*60*60*1e3),i=o.getFullYear(),l=o.getMonth(),r=o.getDate(),d=o.getDay();if(r===Ha(i,l)&&d===5){const c=o.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&d>=1&&d<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,o,i)=>o===i.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,o)=>{const i=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${o.date}T${o.time}:00Z`);return i.getTime()-l.getTime()})}function kt(e=new Date,t=[]){const s=[...Ht(7),...t],n=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(i=>i.date===a&&i.impact==="high"),es.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Pa(a)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const o=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>o&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Pa(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Nt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function ja(e){const t=e.toISOString().split("T")[0];return es.includes(t)?!0:Ht(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Wa(){const e=new Date().toISOString().split("T")[0];return Ht(7).filter(s=>s.date===e)}function qs(e=new Date){const t=kt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const zs=new _e;zs.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const H of["5m","15m","1h","4h","daily"]){const C=await t.prepare(`
    ...
    `).first(),d=(r==null?void 0:r.setting_value)||"70140f57bea54c5e90768de696487d8f";try{console.log("[ENHANCED] Fetching real-time price...");const C=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${d}`,{signal:AbortSignal.timeout(5e3)})).json();if(C.price){const X=parseFloat(C.price),$=l,de=Math.abs(X-$)/X*100;console.log(`[ENHANCED] Real-time: $${X}, Last candle: $${$}, Diff: ${de.toFixed(2)}%`),de<2?(l=X,console.log(`[ENHANCED] ✅ Using real-time price: $${X}`)):console.log(`[ENHANCED] ⚠️ Price diff too large (${de.toFixed(2)}%), using candle close`)}}catch(H){console.log("[ENHANCED] Real-time price fetch failed, using candle close:",H.message)}if(i!=null&&i.timestamp){const H=new Date(i.timestamp).getTime(),C=(Date.now()-H)/(1e3*60);C>60&&o.push(`⚠️ WARNING: Price data is ${C.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${C.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const c=kt(),p=qs();let _=null,m=!1;c.riskLevel==="danger"?(m=!0,_=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",c.reason)):c.riskLevel==="caution"?(_=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",c.reason)):console.log("[ENHANCED] ✅ Calendar safe:",c.reason);const u=n["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const g=Qt(n,l),h=le(l,u,"day_trade"),f=le(l,u,"swing_trade"),y=Kt(h.signal_type,g),w=Kt(f.signal_type,g),E={...h,base_confidence:h.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:g.score,alignment_type:g.type},S={...f,base_confidence:f.confidence,mtf_confidence:w.confidence,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:g.score,alignment_type:g.type};let b=0,k="",v=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const C=ka(a["1h"]);v=(C==null?void 0:C.patterns)||[]}catch(C){console.error("[ENHANCED] Pattern detection error:",C.message)}const H=v.filter(C=>C.confidence>=70&&C.endIndex>=a["1h"].length-5);for(const C of H)C.type==="bullish"&&E.signal_type==="BUY"?(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `):C.type==="bearish"&&E.signal_type==="SELL"&&(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let D=0,R="",I=null;if(a["1h"]&&a["1h"].length>=50){const H=pe(a["1h"]);H&&(I=$a(a["1h"],H),I.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(D=10,R="Strong Uptrend"):I.trend==="UPTREND"&&E.signal_type==="BUY"?(D=5,R="Uptrend"):I.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(D=10,R="Strong Downtrend"):I.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(D=5,R="Downtrend"))}let U=0,j="",L=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{L=Ca(a["1h"],l),L.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(U=L.confidence_boost,j=`ML predicts +${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):L.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(U=L.confidence_boost,j=`ML predicts ${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(H){console.error("[ENHANCED] ML prediction error:",H.message)}let O=0,A="",B=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const H=pe(a["1h"]);H&&(B=Ba(E,H,a["1h"]),B.tp1_probability>70?(O=10,A=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`):B.tp1_probability>60&&(O=5,A=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`))}catch(H){console.error("[ENHANCED] Probability of Profit error:",H.message)}let P=null,N=0,F=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{P=Bt(a["1h"]),P.liquidity_score>=80?N=5:P.liquidity_score>=70?N=0:P.liquidity_score>=50?F=-5:F=-10,console.log(`[LIQUIDITY] Score: ${P.liquidity_score}/100, Session: ${P.session}, Adjust: ${N+F}%`)}catch(H){console.error("[ENHANCED] Liquidity Analysis error:",H.message)}let V=0,Q=0,ee=0,te=0,se="";try{const H=await t.prepare(`
      ...
      `).all(),X=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(H&&C.results&&C.results.length>=10){const $=ya(C.results,H.balance);V=$.var_95,Q=$.var_99;const he=Ea(H.balance,C.results);if(ee=he.current_drawdown_pct,he.is_within_limit||(se+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),X.results){const de=ba(X.results,H.balance);te=de.total_risk_pct,de.is_within_limit||(se+=`⚠️ Portfolio heat ${te.toFixed(1)}% exceeds limit. `)}}}catch(H){console.error("[ENHANCED] Risk metrics error (optional):",H.message)}const x=b+D+U+O+N+F,M={...E,pattern_boost:b,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,E.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null},ue={...S,pattern_boost:b,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,S.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null};m?(M.signal_type="HOLD",ue.signal_type="HOLD",M.enhanced_confidence=50,ue.enhanced_confidence=50,M.reasoning=_||"Economic event nearby - trading paused",ue.reasoning=_||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):p.adjustment<0&&(M.enhanced_confidence=Math.max(50,M.enhanced_confidence+p.adjustment),ue.enhanced_confidence=Math.max(50,ue.enhanced_confidence+p.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",p.adjustment)),M.calendar_check={risk_level:c.riskLevel,should_trade:c.shouldTrade,reason:c.reason,confidence_adjustment:p.adjustment,upcoming_events:c.upcomingEvents.slice(0,3).map(H=>Nt(H))},ue.calendar_check=M.calendar_check;let fe=!1;try{const H=await t.prepare(`
...
`,$+=`${M.isValid?"✅":"❌"} *${M.signal_type}* (${M.enhanced_confidence.toFixed(0)}% confidence)

`,$+=`*Entry:* $${M.price.toFixed(2)}
`,$+=`*Stop Loss:* $${M.stop_loss.toFixed(2)} (${((M.stop_loss/M.price-1)*100).toFixed(2)}%)
`,$+=`*TP1:* $${M.take_profit_1.toFixed(2)} (${((M.take_profit_1/M.price-1)*100).toFixed(2)}%)
`,$+=`*TP2:* $${M.take_profit_2.toFixed(2)} (${((M.take_profit_2/M.price-1)*100).toFixed(2)}%)
`,$+=`*TP3:* $${M.take_profit_3.toFixed(2)} (${((M.take_profit_3/M.price-1)*100).toFixed(2)}%)
...
`,$+=`Base: ${M.base_confidence.toFixed(0)}%
`,$+=`MTF: ${M.mtf_confidence.toFixed(0)}%
`,b>0&&($+=`Pattern: +${b.toFixed(0)}%
`),D>0&&($+=`Regime: +${D.toFixed(0)}%
`),U>0&&($+=`ML: +${U.toFixed(0)}%
`),O>0&&($+=`PoP: +${O.toFixed(0)}%
`),N!==0||F!==0){const J=N+F;$+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}$+=`*FINAL: ${M.enhanced_confidence.toFixed(0)}%*
...
`,M.isValid&&M.signal_type!=="HOLD"?($+=`✅ *EXECUTE ${M.signal_type}*
...
`;for(const J of c.upcomingEvents.slice(0,3))K+=`• ${Nt(J)}
`;K+=`
`}K+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,K+=`✅ Signal generated at ${X} UTC
`,K+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",K.length,"characters");const Be=await z({botToken:C.telegram_bot_token,chatId:C.telegram_chat_id},K);fe=gt&&Be}}catch(H){console.error("[ENHANCED] Telegram error (optional):",H.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:fe,day_trade:M,swing_trade:ue,alignment:{type:g.type,score:g.score,trends:g.trends},patterns:v.length>0?v.slice(0,3):null,regime:I?{trend:I.trend,volatility:I.volatility,should_trade:I.should_trade}:null,ml_prediction:L?{direction:L.overall_direction,predictions:L.predictions}:null,profit_probability:B?{tp1:B.tp1_probability,tp2:B.tp2_probability,tp3:B.tp3_probability,expected_value:B.expected_value}:null,liquidity:P?{score:P.liquidity_score,session:P.session,time_zone:P.time_of_day_zone,volume_trend:P.volume_trend,volume_percentile:P.volume_percentile,estimated_spread_pips:P.estimated_spread_pips,price_impact_bps:P.price_impact_bps,market_depth_score:P.market_depth_score,optimal_for_trading:P.optimal_for_trading,warnings:P.warnings,recommendation:P.recommendation}:null,risk_metrics:{var_95:V,var_99:Q,drawdown_pct:ee,portfolio_heat_pct:te}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Xs=new _e;Xs.post("/simple",async e=>{var s,n,a,o;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const i=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    ...
    `).all()).results||[]).map(f=>({timestamp:f.timestamp,open:f.open,high:f.high,low:f.low,close:f.close,volume:f.volume||1})).reverse(),u=ze(d,p,m,"day_trade"),g=ze(d,p,m,"swing_trade");console.log("[SIMPLE] Generated signals with liquidity:",{day:{type:u.signal_type,confidence:u.confidence,liquidity_score:u.liquidity_score,session:u.session},swing:{type:g.signal_type,confidence:g.confidence,liquidity_score:g.liquidity_score,session:g.session}});let h=!1;try{const f=await t.prepare(`
      ...
      `).all(),y={};for(const w of f.results||[])y[w.setting_key]=w.setting_value;if(console.log("[SIMPLE] Telegram config:",{hasToken:!!y.telegram_bot_token,hasChat:!!y.telegram_chat_id,tokenLength:((o=y.telegram_bot_token)==null?void 0:o.length)||0,chatId:y.telegram_chat_id}),y.telegram_bot_token&&y.telegram_chat_id){const w=await t.prepare(`
          ...
          ORDER BY timestamp DESC 
          LIMIT 20
        `).all();let E=[],S=[];if(w.results&&w.results.length>=20){const j=w.results.map(O=>O.high).sort((O,A)=>A-O),L=w.results.map(O=>O.low).sort((O,A)=>O-A);E=j.slice(0,3),S=L.slice(0,3)}const b=u.signal_type==="BUY"?"🟢":u.signal_type==="SELL"?"🔴":"⚪",k=new Date().toLocaleString("en-US",{timeZone:"UTC"});let v=`${b} <b>GOLD/USD ${u.signal_type} SIGNAL</b> ${b}

`;v+=`📊 Day Trade
`,v+=`💰 <b>Price:</b> $${Number(d).toFixed(2)}
`,v+=`📊 <b>Confidence:</b> ${Number(u.confidence).toFixed(1)}%

`,v+=`🎯 <b>Take Profits:</b>
`,v+=`   TP1: $${Number(u.take_profit_1).toFixed(2)}
`,v+=`   TP2: $${Number(u.take_profit_2).toFixed(2)}
`,v+=`   TP3: $${Number(u.take_profit_3).toFixed(2)}

`,v+=`🛡️ <b>Stop Loss:</b> $${Number(u.stop_loss).toFixed(2)}

`,E.length>0&&(v+=`📊 <b>Key Levels:</b>
`,v+=`🔴 <b>Resistance:</b> ${E.map(j=>`$${j.toFixed(2)}`).join(", ")}
`,v+=`🟢 <b>Support:</b> ${S.map(j=>`$${j.toFixed(2)}`).join(", ")}

`),v+=`💧 <b>LIQUIDITY ANALYSIS:</b>
`;const D=u.liquidity_score&&u.liquidity_score>=70?"🟢":u.liquidity_score&&u.liquidity_score>=50?"🟡":"🔴";v+=`${D} <b>Score:</b> ${u.liquidity_score||50}/100
`,v+=`🌐 <b>Session:</b> ${u.session||"UNKNOWN"} (${u.time_zone||"MEDIUM"} LIQUIDITY)
`,v+=`📊 <b>Volume:</b> ${u.volume_trend||"STABLE"} (${u.volume_percentile||50}%ile)
`,v+=`💰 <b>Spread:</b> ~${u.estimated_spread_pips||40} pips
`,v+=`📉 <b>Impact:</b> ~${u.price_impact_bps||10} bps ($100K)
`;const R=u.position_size_multiplier||1,I=R>=1?"🟢":R>=.75?"🟡":"🔴";if(v+=`
💼 <b>POSITION SIZING:</b>
`,v+=`${I} <b>Recommended:</b> ${(R*100).toFixed(0)}% of normal size
`,R<.75?v+=`⚠️ <b>Warning:</b> Reduced position due to liquidity
`:u.optimal_for_trading&&(v+=`✅ <b>Status:</b> Optimal for trading
`),u.liquidity_warnings&&u.liquidity_warnings!=="[]")try{const j=JSON.parse(u.liquidity_warnings);j.length>0&&(v+=`
⚠️ <b>WARNINGS:</b>
`,j.slice(0,2).forEach(L=>{const O=L.replace(/[⚠️🔴]/g,"").trim();v+=`• ${O}
`}))}catch{}v+=`
`,v+=`📝 <b>Reason:</b>
`;const U=String(u.reason).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");v+=U+`

`,v+=`⏰ ${k}`,console.log("[SIMPLE] Sending Telegram message, length:",v.length),h=await z({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},v),console.log("[SIMPLE] Telegram sent:",h),h||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}try{await t.prepare(`
        INSERT INTO signals (
      ...
      `).bind(g.signal_type,"swing_trade",d,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.confidence,g.reason,h?1:0,g.liquidity_score||50,g.session||"UNKNOWN",g.time_zone||"MEDIUM",g.volume_trend||"STABLE",g.volume_percentile||50,g.estimated_spread_pips||40,g.price_impact_bps||10,g.market_depth_score||50,g.optimal_for_trading?1:0,g.liquidity_warnings||"[]",g.liquidity_recommendation||"No recommendation",g.position_size_multiplier||1).run(),console.log("[SIMPLE] Signals saved to database")}catch(f){console.error("[SIMPLE] Database save error:",f.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:d,telegram_sent:h,day_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(d),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"day_trade"},swing_trade:{signal_type:g.signal_type,confidence:Number(g.confidence),price:Number(d),stop_loss:Number(g.stop_loss),take_profit_1:Number(g.take_profit_1),take_profit_2:Number(g.take_profit_2),take_profit_3:Number(g.take_profit_3),reason:String(g.reason),trading_style:"swing_trade"}})}catch(i){return console.error("[SIMPLE] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function Ya(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Ga(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Va(e,t){return e>t*1.1}function qa(e){let t=0,s=0,n=0;for(const l of e){const r=l.volume||0;n+=r,l.close>l.open?t+=r:l.close<l.open&&(s+=r)}const a=s>0?t/s:t>0?10:1;let o="NEUTRAL";a>1.5?o="BUYING":a<.67&&(o="SELLING");let i=0;return a>3?i=100:a>1.5?i=50+(a-1.5)/1.5*50:a>.67?i=(a-.67)/.83*50:a>.33?i=50+(.67-a)/.34*50:i=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:o,strength:Math.round(i)}}function Ks(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function za(e,t){const n=Ks(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Xa(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Ka(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Za(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Qa(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Ja(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),eo(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),to(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),so(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),no(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),ao(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),oo(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Ka(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Za(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Qa(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Ja(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function eo(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close<e.open,l=s.close>s.open;return i&&a<n*.5&&l&&o>n*.6&&s.close>(e.open+e.close)/2}function to(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close>e.open,l=s.close<s.open;return i&&a<n*.5&&l&&o>n*.6&&s.close<(e.open+e.close)/2}function so(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,o=t.low>e.low&&s.low>t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&o&&i>d&&l>d&&r>d}function no(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,o=t.low<e.low&&s.low<t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),d=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&o&&i>d&&l>d&&r>d}function ao(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function oo(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function io(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function ro(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const c=e.slice(-288),p=Math.max(...c.map(m=>m.high)),_=Math.min(...c.map(m=>m.low));s.push({level:p,type:"RESISTANCE",strength:85,distance:p-t,distancePercent:(p-t)/t*100}),s.push({level:_,type:"SUPPORT",strength:85,distance:t-_,distancePercent:(t-_)/t*100})}const n=e.slice(-50),a=cs(n,"HIGH"),o=cs(n,"LOW");if(a.forEach(c=>{s.push({level:c,type:"RESISTANCE",strength:75,distance:c-t,distancePercent:(c-t)/t*100})}),o.forEach(c=>{s.push({level:c,type:"SUPPORT",strength:75,distance:t-c,distancePercent:(t-c)/t*100})}),lo(t).forEach(c=>{const p=c>t?"RESISTANCE":"SUPPORT";s.push({level:c,type:p,strength:70,distance:Math.abs(c-t),distancePercent:Math.abs(c-t)/t*100})}),e.length>=288){const c=e.slice(-288),p=co(c);s.push({level:p.pp,type:"PIVOT",strength:80,distance:Math.abs(p.pp-t),distancePercent:Math.abs(p.pp-t)/t*100}),s.push({level:p.r1,type:"RESISTANCE",strength:70,distance:p.r1-t,distancePercent:(p.r1-t)/t*100}),s.push({level:p.s1,type:"SUPPORT",strength:70,distance:t-p.s1,distancePercent:(t-p.s1)/t*100})}const l=s.filter(c=>Math.abs(c.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const r=l.reduce((c,p)=>Math.abs(p.distancePercent)<Math.abs(c.distancePercent)?p:c),d=mo(e,t,r);return{nearZone:!0,closestZone:r,zoneType:r.type,action:d,strength:r.strength,description:po(r,d)}}function cs(e,t){const s=[];for(let o=5;o<e.length-5;o++){const i=t==="HIGH"?e[o].high:e[o].low;let l=!0;for(let r=o-5;r<=o+5;r++){if(r===o)continue;const d=t==="HIGH"?e[r].high:e[r].low;if(t==="HIGH"&&d>=i){l=!1;break}if(t==="LOW"&&d<=i){l=!1;break}}l&&s.push(i)}return Array.from(new Set(s)).slice(-3)}function lo(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function co(e){const t=Math.max(...e.map(d=>d.high)),s=Math.min(...e.map(d=>d.low)),n=e[e.length-1].close,a=(t+s+n)/3,o=2*a-s,i=2*a-t,l=a+(t-s),r=a-(t-s);return{pp:a,r1:o,s1:i,r2:l,s2:r}}function mo(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function po(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function uo(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function _o(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=go(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const o=fo(s,a),i=ho(s,a);return o.type!=="NONE"&&i.type===o.type?{type:o.type,category:o.category,indicator:"BOTH",strength:95,description:`${o.type} ${o.category} (RSI+MACD)`,confidence:90}:o.type!=="NONE"?{type:o.type,category:o.category,indicator:"RSI",strength:80,description:`${o.type} ${o.category} (RSI)`,confidence:75}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"MACD",strength:70,description:`${i.type} ${i.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function go(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const o=e[a];let i=!0;for(let r=a-2;r<=a+2;r++)if(r!==a&&e[r].high>=o.high){i=!1;break}i&&t.push({index:a,price:o.high});let l=!0;for(let r=a-2;r<=a+2;r++)if(r!==a&&e[r].low<=o.low){l=!1;break}l&&s.push({index:a,price:o.low})}return{highs:t,lows:s}}function fo(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,o=e[n.index].rsi,i=e[a.index].rsi;if(a.price<n.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,o=e[n.index].rsi,i=e[a.index].rsi;if(a.price>n.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ho(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,o=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price<n.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,o=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price>n.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function yo(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function Eo(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,o=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${o}, ${e.strength}/100)`}function bo(e,t,s,n){const a=(h,f)=>{const y=parseFloat(String(h));return isNaN(y)?f:y},o=a(e.ema_12,n),i=a(t.ema_26,n),l=a(s.sma_200,n),r=qt(n,o),d=qt(n,i),c=qt(n,l),p=r===d&&d===c&&r!=="NEUTRAL",_=r===d&&r!=="NEUTRAL"||r===c&&r!=="NEUTRAL"||d===c&&d!=="NEUTRAL";let m=0,u="",g="";return p?(m=100,u=`ALL ${r}`,g=`All 3 timeframes ${r.toLowerCase()} (perfect alignment)`):_?(m=65,r===d?(u=`5M+15M ${r}`,g=`5m & 15m ${r.toLowerCase()} (1h ${c.toLowerCase()})`):r===c?(u=`5M+1H ${r}`,g=`5m & 1h ${r.toLowerCase()} (15m ${d.toLowerCase()})`):(u=`15M+1H ${d}`,g=`15m & 1h ${d.toLowerCase()} (5m ${r.toLowerCase()})`)):(m=30,u="MIXED",g=`Mixed signals: 5m ${r.toLowerCase()}, 15m ${d.toLowerCase()}, 1h ${c.toLowerCase()}`),{tf5m:r,tf15m:d,tf1h:c,allAligned:p,twoAligned:_,alignment:u,strength:m,description:g}}function qt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function wo(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function To(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function So(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,o=(s.close-n.close)/n.close*100;let i="FLAT";o>.1?i="UP":o<-.1&&(i="DOWN");let l="NEUTRAL";i==="DOWN"?l="BULLISH":i==="UP"&&(l="BEARISH");const r=Math.abs(o);let d=-.8,c=0;r>.3?c=90:r>.2?c=75:r>.1?c=60:c=40;const p=new Date(s.timestamp),m=Math.floor((new Date().getTime()-p.getTime())/6e4),u=xo(a,o,i,l,c);return{dxyPrice:a,dxyChange:o,dxyTrend:i,goldSignalSupport:l,correlation:d,strength:c,description:u,dataAge:m}}function vo(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function xo(e,t,s,n,a){const o=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${o} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${o} → Gold BEARISH (${a}/100)`:`DXY flat ${o} → Neutral (${a}/100)`}async function ko(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function Ro(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function Lo(e){try{const t=await e.prepare(`
      SELECT timestamp, close
      FROM dxy_cache
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function Io(e,t,s=15){const n=await Lo(e);if(n.length>0){const o=new Date(n[n.length-1].timestamp),l=(new Date().getTime()-o.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),n}console.log("[DXY] Fetching fresh DXY data from API...");const a=await ko(t);return a.length>0?(await Ro(e,a),a):(console.log("[DXY] Fetch failed, using stale cache"),n)}function $o(e,t,s){const n=ds("Silver (XAG/USD)",e),a=ds("Crude Oil (WTI)",t);let o=0;n&&Ct(n.trend,s)&&o++,a&&Ct(a.trend,s)&&o++;let i=0;const l=o>=1;o===2?i=95:o===1?i=70:i=30;const r=Ao(n,a,o,s);return{silver:n,oil:a,aligned:l,alignmentCount:o,strength:i,description:r}}function ds(e,t){if(t.length<2)return null;const s=t[t.length-1],n=t[0],a=s.close,o=(s.close-n.close)/n.close*100;let i="FLAT";o>.2?i="UP":o<-.2&&(i="DOWN");const l=Math.abs(o);let r=0;return l>1?r=90:l>.5?r=75:l>.2?r=60:r=40,{symbol:e,price:a,change:o,trend:i,strength:r}}function Ct(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function Ao(e,t,s,n){if(s===2)return`Silver & Oil both ${n==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&Ct(e.trend,n))return`Silver ${e.trend.toLowerCase()} confirms Gold ${n}`;if(t&&Ct(t.trend,n))return`Oil ${t.trend.toLowerCase()} confirms Gold ${n}`}const a=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",o=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${a}, ${o} (mixed signals)`}async function Do(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[SILVER] No data returned from API"),[]):n.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function Mo(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[OIL] No data returned from API"),[]):n.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function No(e,t,s){try{const n=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const a of s)await e.prepare(`
      ...
      DELETE FROM ${n}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(n){console.error(`[${t}] Error storing data:`,n.message)}}async function Oo(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",n=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!n.results||n.results.length===0?[]:n.results.map(a=>({close:a.close,timestamp:a.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function ms(e,t,s,n=15){const a=await Oo(e,s);if(a.length>0){const i=new Date(a[a.length-1].timestamp),r=(new Date().getTime()-i.getTime())/6e4;if(r<n)return console.log(`[${s}] Using cached data (${r.toFixed(1)}min old)`),a}console.log(`[${s}] Fetching fresh data from API...`);const o=s==="SILVER"?await Do(t):await Mo(t);return o.length>0?(await No(e,s,o),o):(console.log(`[${s}] Fetch failed, using stale cache`),a)}function Co(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),a=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let o="NEUTRAL",i="NEUTRAL",l=50;const r=e.percentile;if(r>=90?(o="EXTREME_BULLISH",i="BULLISH",l=95):r>=70?(o="BULLISH",i="BULLISH",l=80):r<=30?(o="BEARISH",i="BEARISH",l=80):r<=10?(o="EXTREME_BEARISH",i="BEARISH",l=95):(o="NEUTRAL",i="NEUTRAL",l=50),e.largeSpecNet>0){const c=Fo(e.largeSpecNet);c>=95?i==="BEARISH"?l+=10:i==="BULLISH"&&(l-=15):c<=5&&(i==="BULLISH"?l+=10:i==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const d=Bo(o,r,a);return{currentPosition:e,positioning:o,goldSignalSupport:i,strength:l,description:d,dataAge:a}}function Fo(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function Uo(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Bo(e,t,s){const n=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${n}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${n}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${n}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${n}]`:`COT: Neutral positioning (${t}th percentile) [${n}]`}async function Ho(){return null}async function Po(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function jo(e){try{const t=await e.prepare(`
      SELECT 
        timestamp,
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function Wo(e){const t=await jo(e);if(t){const n=new Date(t.timestamp),o=(new Date().getTime()-n.getTime())/(1e3*60*60*24);if(o<7)return console.log(`[COT] Using cached data (${o.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await Ho();return s?(await Po(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Yo(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const ct=new _e;ct.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER] Starting scan at",n),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).first();if(!a||!o||!i)return console.log("[5M-SCANNER-GET] Missing indicators:",{has5m:!!a,has15m:!!o,has1h:!!i}),e.json({success:!1,error:"Insufficient data for scan. Please run /api/market/fetch-mtf first."});const r=(await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 100
    `).all()).results.map(m=>({timestamp:m.timestamp,open:Number(m.open),high:Number(m.high),low:Number(m.low),close:Number(m.close),volume:Number(m.volume)||0})).reverse();if(!r||r.length===0)return e.json({success:!1,error:"No 5m market data available"});const d=r[r.length-1].close,c=await Zs(t,a,o,i,r,d),p=new Date().toISOString();await t.prepare(`
      INSERT INTO scanner_history 
      (timestamp, timeframe, signal_type, grade, score, 
       entry_price, stop_loss, take_profit_1, take_profit_2, take_profit_3,
       confidence, layers_passed, liquidity_score, session, telegram_sent)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(p,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let _=!1;if(c.grade==="A"||c.grade==="A+")try{const m=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});ct.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const d of s.results||[])n[d.setting_key]=d.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,o=15,i={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-o,tp1:a+o*2,tp2:a+o*3,tp3:a+o*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Qs(i,a),r=await z({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:r,message:r?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Zs(e,t,s,n,a,o){console.log("[ANALYZE] Starting analysis");let i=0,l=0;const r=[],d=(ae,Ke)=>{const It=parseFloat(String(ae));return isNaN(It)?Ke:It};console.log("[ANALYZE] parseNum defined");const c={ema20:d(t.ema_12,o),rsi:d(t.rsi_14,50),macd:d(t.macd,0),macd_signal:d(t.macd_signal,0),macd_histogram:d(t.macd_histogram,0),adx:d(t.adx,25)},p={ema50:d(s.ema_26,o)},_={sma200:d(n.sma_200,o)},m=o>c.ema20&&o>p.ema50&&o>_.sma200,u=o<c.ema20&&o<p.ema50&&o<_.sma200;m||u?(i+=20,l++,r.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):r.push("❌ Layer 1: Trend NOT aligned (conflicting)");const g=c.rsi>=40&&c.rsi<=60,h=c.macd>c.macd_signal&&c.macd_histogram>0,f=c.macd<c.macd_signal&&c.macd_histogram<0;g&&(m?h:f)?(i+=15,l++,r.push(`✅ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):r.push(`❌ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${g?"no crossover":"extreme"}`);const y=a.slice(-20).reduce((ae,Ke)=>ae+Ke.volume,0)/20,w=a[a.length-1].volume;w>y*1.5?(i+=15,l++,r.push(`✅ Layer 3: Volume spike ${(w/y).toFixed(1)}x average`)):r.push(`❌ Layer 3: Volume ${(w/y).toFixed(1)}x (need 1.5x+)`);const S=Math.max(...a.slice(-20).map(ae=>ae.high)),b=Math.min(...a.slice(-20).map(ae=>ae.low)),k=o>S*.999,v=o<b*1.001;m&&k||u&&v?(i+=15,l++,r.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):r.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let D=null;try{D=await Bt(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(ae){console.log("[5M-SCANNER] Liquidity calc failed:",ae)}const R=(D==null?void 0:D.liquidity_score)||50,I=(D==null?void 0:D.session)||"UNKNOWN";R>=70?(i+=15,l++,r.push(`✅ Layer 5: Liquidity ${R}/100 (${I} session)`)):r.push(`❌ Layer 5: Liquidity ${R}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const j=kt();console.log("[ANALYZE] Calendar check complete"),j.riskLevel==="safe"?(i+=10,l++,r.push("✅ Layer 6: No major news")):r.push(`❌ Layer 6: ${j.reason}`);const O=c.adx>25,A=c.adx>70;O&&!A?(i+=10,l++,r.push(`✅ Layer 7: ADX ${c.adx.toFixed(1)} (strong trend)`)):A?r.push(`⚠️ Layer 7: ADX ${c.adx.toFixed(1)} (extreme, reversal risk)`):r.push(`❌ Layer 7: ADX ${c.adx.toFixed(1)} (weak trend)`);let B="HOLD";(m||u)&&l>=5&&(B=m?"BUY":"SELL");const P=new Date,N=Ya(P);N.hasBoost?(i+=8,l++,r.push(`✅ Layer 8: ${N.reason} (+${N.boost}% win)`)):r.push(`ℹ️ Layer 8: ${N.reason}`);const F=Ga(P);F.hasBoost?(i+=5,l++,r.push(`✅ Layer 9: ${F.reason} (+${F.boost}% win)`)):r.push(`ℹ️ Layer 9: ${F.reason}`);const V=d(t.atr_14,o*.01),Q=a.slice(-20).reduce((ae,Ke)=>{const It=Ke.high-Ke.low;return ae+It},0)/20;if(Va(V,Q)){i+=7,l++;const ae=((V/Q-1)*100).toFixed(1);r.push(`✅ Layer 10: ATR expanding ${ae}% (high volatility)`)}else{const ae=((1-V/Q)*100).toFixed(1);r.push(`❌ Layer 10: ATR compressed ${ae}% (skip low volatility)`)}const te=qa(a.slice(-20));Ks(te,B)&&te.strength>=60&&(i+=10,l++),r.push(za(te,B));const x=Xa(a.slice(-3)),{aligned:M,strongestPattern:ue}=io(x,B);M&&ue?(i+=12,l++,r.push(`✅ Layer 12: ${ue.name} (${ue.strength}/100)`)):x.length>0&&x[0].type==="INDECISION"?r.push(`⚠️ Layer 12: ${x[0].name} (indecision, wait)`):r.push("❌ Layer 12: No clear candlestick pattern");const fe=ro(a,o);uo(fe,B)&&fe.nearZone?(i+=8,l++,r.push(`✅ Layer 13: ${fe.description}`)):fe.nearZone?r.push(`⚠️ Layer 13: ${fe.description} (not aligned)`):r.push("ℹ️ Layer 13: No key zones nearby");const X=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(ae=>({rsi:parseFloat(String(ae.rsi))||50,macd:parseFloat(String(ae.macd))||0,macd_histogram:parseFloat(String(ae.macd_histogram))||0})).reverse(),$=_o(X,a.slice(-10)),de=yo($,B,m?"BULLISH":u?"BEARISH":"NEUTRAL");de&&$.strength>=70&&(i+=9,l++),r.push(Eo($,de));const ne=bo(t,s,n,o),Rt=wo(ne,B);Rt&&(ne.allAligned||ne.twoAligned)&&(i+=6,l++),r.push(To(ne,Rt));const _t=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),gt=(_t==null?void 0:_t.setting_value)||"70140f57bea54c5e90768de696487d8f",K=await Io(e,gt,15),Be=So(K);vo(Be,B)&&Be.strength>=60?(i+=5,l++,r.push(`✅ Layer 18: ${Be.description}`)):Be.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 18: ${Be.description} (not aligned)`):r.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Te=await ms(e,gt,"SILVER",15),En=await ms(e,gt,"OIL",15),Xe=$o(Te,En,B);if(Xe.aligned&&Xe.alignmentCount>=1){const ae=Xe.alignmentCount===2?5:3;i+=ae,l++,r.push(`✅ Layer 19: ${Xe.description} (${Xe.strength}/100)`)}else r.push(`❌ Layer 19: ${Xe.description}`);const bn=await Wo(e)||Yo(),Le=Co(bn);if(Uo(Le,B)&&Le.strength>=70){const ae=Le.positioning.includes("EXTREME")?7:4;i+=ae,l++,r.push(`✅ Layer 20: ${Le.description} (${Le.strength}/100)`)}else Le.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 20: ${Le.description} (not aligned)`):r.push(`ℹ️ Layer 20: ${Le.description}`);let Lt="C";i>=162?Lt="A+":i>=144?Lt="A":i>=126&&(Lt="B"),(m||u)&&l>=7&&(B=m?"BUY":"SELL");const Ie=Math.max(V*1.5,o*.003),wn=B==="BUY"?o-Ie:o+Ie,Tn=B==="BUY"?o+Ie*2:o-Ie*2,Sn=B==="BUY"?o+Ie*3:o-Ie*3,vn=B==="BUY"?o+Ie*4:o-Ie*4;return{grade:Lt,score:i,signal:B,confidence:i,layersPassed:l,layers:r,stopLoss:wn,tp1:Tn,tp2:Sn,tp3:vn,liquidityScore:R,session:I,adx:c.adx,rsi:c.rsi,volumeRatio:w/y}}function Qs(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,o=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let i=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,i+="Next scan in 5 minutes...",i}async function dt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,i,l,r,e).run();const c=(await dt(n)).current_balance+i;return await n.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(c).run(),await sn(n),await Vo(n),await qo(n),{success:!0,profit_loss:i}}catch(a){return{success:!1,error:a.message}}}async function sn(e){const t=await dt(e),s=await e.prepare(`
  ...
  `).all();let n=0;for(const o of s.results||[]){const i=o,r=Math.abs(i.entry_price-i.stop_loss)*i.position_size;n+=r}const a=n/t.current_balance*100;await e.prepare(`
    ...
    SET current_portfolio_risk = ?,
        updated_at = CURRENT_TIMESTAMP
    WHERE id = 1
  `).bind(a).run()}async function Vo(e){const t=new Date().toISOString().split("T")[0],s=await e.prepare(`
    SELECT * FROM live_trades 
    WHERE DATE(exit_time) = ? AND status = 'CLOSED'
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,o=n.filter(m=>m.win===1).length,i=n.filter(m=>m.win===0).length,l=o/a*100,r=n.reduce((m,u)=>m+(u.profit_loss||0),0),d=Math.max(...n.map(m=>m.profit_loss||0)),c=Math.min(...n.map(m=>m.profit_loss||0)),p=n.reduce((m,u)=>m+(u.confidence||0),0)/a,_=n.reduce((m,u)=>m+(u.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,o,i,l,r,d,c,p,_).run()}async function qo(e){const t=await dt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,o).run();let i=!1,l="";s>=t.max_drawdown_pct?(i=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):o>=t.max_daily_loss_pct&&(i=!0,l=`Daily loss ${o.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),i&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});we.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Fe=new _e;Fe.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Ht(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:Nt(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/today",async e=>{try{const t=Wa(),s=kt();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/check",async e=>{try{const t=kt(),s=qs();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);ja(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
    ...
    `).bind(s).run(),e.json({success:!0,message:"Event deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});function on(e,t,s){const n=s.find(f=>t.confidence>=f.confidence_min&&t.confidence<=f.confidence_max);if(!n)return{units:0,value:0,risk_amount:0,risk_pct:0,position_pct:0,stop_loss_distance:0,reward_risk_ratio:0,is_valid:!1,warning:`No position sizing rule found for confidence ${t.confidence}%`};const a=Math.abs(t.entry_price-t.stop_loss),i=e.current_balance*(n.risk_pct/100)/a,l=i*t.entry_price;l/e.current_balance*100;const r=e.current_balance*(n.max_position_pct/100);let d=i,c=l,p=n.risk_pct,_;l>r&&(c=r,d=r/t.entry_price,p=d*a/e.current_balance*100,_=`Position reduced to ${n.max_position_pct}% max position size`);const u=Math.abs(t.take_profit_1-t.entry_price)/a;let g=!0;const h=[];return _&&h.push(_),u<1.5&&h.push(`Low reward:risk ratio (${u.toFixed(2)}:1). Recommended: >1.5:1`),p>e.max_daily_loss_pct&&(g=!1,h.push(`Risk ${p.toFixed(2)}% exceeds max daily loss ${e.max_daily_loss_pct}%`)),d<.01&&(g=!1,h.push("Position size too small (minimum 0.01 lots)")),{units:parseFloat(d.toFixed(2)),value:parseFloat(c.toFixed(2)),risk_amount:parseFloat((d*a).toFixed(2)),risk_pct:parseFloat(p.toFixed(2)),position_pct:parseFloat((c/e.current_balance*100).toFixed(2)),stop_loss_distance:parseFloat(a.toFixed(2)),reward_risk_ratio:parseFloat(u.toFixed(2)),is_valid:g,warning:h.length>0?h.join("; "):void 0}}function rn(e,t,s,n,a=0){let o;n==="BUY"?o=(t-e)*s:o=(e-t)*s,o-=a;const i=(t-e)/e*100,l=Math.abs(t-e)/.01;return{profit_loss:parseFloat(o.toFixed(2)),profit_loss_pct:parseFloat(i.toFixed(2)),pips:parseFloat(l.toFixed(1))}}function zo(e,t){const s=t.filter(l=>l.profit_loss<0).reduce((l,r)=>l+r.profit_loss,0),n=Math.abs(s/e.current_balance)*100,a=n>=e.max_daily_loss_pct,i=e.current_balance*(e.max_daily_loss_pct/100)-Math.abs(s);return{current_loss:parseFloat(s.toFixed(2)),current_loss_pct:parseFloat(n.toFixed(2)),limit_exceeded:a,remaining:parseFloat(i.toFixed(2))}}function Xo(e){const t=e.filter(g=>g.status==="CLOSED"),s=t.filter(g=>g.profit_loss>0),n=t.filter(g=>g.profit_loss<0),a=s.reduce((g,h)=>g+h.profit_loss,0),o=Math.abs(n.reduce((g,h)=>g+h.profit_loss,0)),i=a-o,l=s.length>0?a/s.length:0,r=n.length>0?o/n.length:0,d=t.length>0?s.length/t.length*100:0,c=o>0?a/o:a,p=100-d,_=d/100*l-p/100*r,m=s.length>0?Math.max(...s.map(g=>g.profit_loss)):0,u=n.length>0?Math.min(...n.map(g=>g.profit_loss)):0;return{total_trades:t.length,winning_trades:s.length,losing_trades:n.length,win_rate:parseFloat(d.toFixed(2)),total_profit:parseFloat(a.toFixed(2)),total_loss:parseFloat(o.toFixed(2)),net_profit:parseFloat(i.toFixed(2)),avg_win:parseFloat(l.toFixed(2)),avg_loss:parseFloat(r.toFixed(2)),profit_factor:parseFloat(c.toFixed(2)),expectancy:parseFloat(_.toFixed(2)),largest_win:parseFloat(m.toFixed(2)),largest_loss:parseFloat(u.toFixed(2))}}function Ko(e){return e.is_valid?`
...
`)}const Zo=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:cn,runBacktest:ln},Symbol.toStringTag,{value:"Module"})),pt=new _e;pt.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
    ...
    `).bind(s.run_name||`Backtest ${new Date().toISOString()}`,o.start_date,o.end_date,o.starting_balance,o.min_confidence,o.use_mtf_confirmation?1:0,o.use_news_filter?1:0,o.timeframe,l.total_trades,l.winning_trades,l.win_rate,l.net_profit,l.total_return_pct,l.max_drawdown_pct,l.profit_factor,l.sharpe_ratio,JSON.stringify(l.trades),JSON.stringify(l.equity_curve)).run();let d=!1;try{const c=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings 
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),p={};if(c.results.forEach(_=>{_.setting_key==="telegram_bot_token"&&(p.telegram_bot_token=_.setting_value),_.setting_key==="telegram_chat_id"&&(p.telegram_chat_id=_.setting_value)}),p.telegram_bot_token&&p.telegram_chat_id){const _=l;let m="",u="";_.total_trades<10?(m="⏳ INSUFFICIENT DATA",u="⏳"):_.total_trades<50?(m="⚠️ SMALL SAMPLE SIZE",u="⚠️"):_.win_rate>=70&&_.profit_factor>=2?(m="✅ STRATEGY VALIDATED",u="✅"):_.win_rate>=60?(m="⚠️ GOOD PERFORMANCE",u="⚠️"):(m="❌ NEEDS IMPROVEMENT",u="❌");const g=`
🎯 *BACKTEST COMPLETE*
...
📅 Backtest ID: ${r.meta.last_row_id}
        `.trim();d=await z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},g)}}catch(c){console.error("[BACKTEST] Telegram send failed:",c)}return e.json({success:!0,backtest_id:r.meta.last_row_id,result:l,formatted:cn(l),telegram_sent:d})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});pt.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
    ...
    `).bind(s).run(),e.json({success:!0,message:"Backtest deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});pt.get("/data-availability",async e=>{try{const{DB:t}=e.env,s=await t.prepare(`
      ...
      FROM market_data
      WHERE timeframe = '1h'
    `).first();if(!s||s.total_candles===0)return e.json({success:!0,available:!1,message:"No historical data available. Fetch market data first.",total_candles:0});const n=new Date(s.earliest_date),a=new Date(s.latest_date),o=Math.floor((a.getTime()-n.getTime())/(1e3*60*60*24));return e.json({success:!0,available:s.total_candles>=200,total_candles:s.total_candles,earliest_date:s.earliest_date,latest_date:s.latest_date,days_covered:o,min_required:200,ready_for_backtest:s.total_candles>=200})}catch(t){return e.json({success:!1,error:t.message},500)}});const dn=new _e;dn.post("/webhook",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=s.message||s.edited_message;if(!n||!n.text)return e.json({ok:!0});const a=n.chat.id,o=n.text.trim(),i=await t.prepare(`
      SELECT setting_value FROM user_settings WHERE setting_key = 'telegram_bot_token'
    `).first();if(!i)return e.json({ok:!0});const l={botToken:i.setting_value,chatId:a.toString()};if(o.startsWith("/log_trade")){const r=o.split(" ");if(r.length<5)return await z(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const d=r[1].toUpperCase(),c=parseFloat(r[2]),p=parseFloat(r[3]),_=parseFloat(r[4]),m=await en({trade_type:d,trading_style:"day_trade",entry_price:c,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:p,take_profit_1:_,take_profit_2:_*1.002,take_profit_3:_*1.003,status:"OPEN",confidence:85},t);m.success?await z(l,`✅ *Trade #${m.trade_id} Logged*

${d} @ $${c}
Stop: $${p}
TP1: $${_}`):await z(l,`❌ Error: ${m.error}`)}else if(o.startsWith("/close_trade")){const r=o.split(" ");if(r.length<4)return await z(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const d=parseInt(r[1]),c=parseFloat(r[2]),p=r[3],_=await tn(d,c,p,t);if(_.success){const m=_.profit_loss||0,u=m>0?"💰":"❌";await z(l,`${u} *Trade #${d} Closed*

Exit: $${c}
P&L: ${m>0?"+":""}$${m.toFixed(2)}
Result: ${m>0?"WIN ✅":"LOSS ❌"}`)}else await z(l,`❌ Error: ${_.error}`)}else if(o==="/open"){const r=await an(t);if(r.length===0)await z(l,"📊 No open positions");else{let d=`📊 *Open Positions (${r.length})*

`;for(const c of r)d+=`#${c.id}: ${c.trade_type} @ $${c.entry_price}
`,d+=`Stop: $${c.stop_loss}
`,d+=`TP1: $${c.take_profit_1}

`;await z(l,d)}}else if(o==="/stats"){const r=await nn(t);let d=`📊 *Trading Statistics*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Pt=new _e;Pt.post("/market-analysis",async e=>await mn(e));Pt.get("/health",async e=>e.json({success:!0,status:"healthy",service:"ai-analysis",timestamp:new Date().toISOString()}));Pt.get("/auto-ai-scan",async e=>await mn(e));async function mn(e){const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const R of s.results||[])R.setting_key==="twelve_data_api_key"&&(n=R.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const R=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,U=await(await fetch(R)).json();U.values&&U.values.length>=50&&(a=U.values.reverse().map(j=>({timestamp:j.datetime,open:parseFloat(j.open),high:parseFloat(j.high),low:parseFloat(j.low),close:parseFloat(j.close),volume:parseFloat(j.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const R=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!R.results||R.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=R.results.reverse().map(I=>({timestamp:I.timestamp,open:I.open,high:I.high,low:I.low,close:I.close,volume:I.volume||0}))}const o=pe(a);if(!o)return e.json({success:!1,error:"Failed to calculate indicators"},400);const i=a[a.length-1].close,l=le(i,o,"day_trade");console.log("[AI-ANALYSIS] Current price:",i,"Signal:",l.signal_type,"Confidence:",l.confidence);const r={};for(const R of["5m","15m","1h","4h","daily"]){const I=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(R).first();I&&(r[R]=I)}const d=Qt(r,i),c=a.slice(-50),p=c.map(R=>R.high).sort((R,I)=>I-R),_=c.map(R=>R.low).sort((R,I)=>R-I),m=[Math.max(...p.slice(0,10))],u=[Math.min(..._.slice(0,10))];i>o.sma_20?u.push(o.sma_20):m.push(o.sma_20),i>o.sma_50?u.push(o.sma_50):m.push(o.sma_50),i>o.vwap?u.push(o.vwap):m.push(o.vwap);const g=Math.round(i/10)*10;g>i?m.push(g):u.push(g);const h=[...new Set(m)].sort((R,I)=>R-I).filter(R=>R>i).slice(0,3),f=[...new Set(u)].sort((R,I)=>I-R).filter(R=>R<i).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",f,"Resistance:",h);const y=o.atr_14/i*100;let w="NORMAL";y>3?w="EXTREME":y>1.5?w="HIGH":y<.5&&(w="LOW");const E=[];let S=30,b=30,k=40;d.type==="ALL_BULLISH"?(S=60,b=20,k=20):d.type==="ALL_BEARISH"?(S=20,b=60,k=20):d.score>=4&&(d.trends.filter(R=>R.trend==="BULLISH").length>=4?(S=50,b=25,k=25):(S=25,b=50,k=25)),h.length>0&&E.push({name:"📈 BULLISH CONTINUATION",probability:S,description:`Price breaks above $${h[0].toFixed(2)} and rallies toward $${(h[h.length-1]||i*1.02).toFixed(2)}`,trigger:`Breakout above $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||i*1.02}),f.length>0&&E.push({name:"📉 BEARISH CORRECTION",probability:b,description:`Price breaks below $${f[0].toFixed(2)} and drops toward $${(f[f.length-1]||i*.98).toFixed(2)}`,trigger:`Breakdown below $${f[0].toFixed(2)} with volume`,target:f[f.length-1]||i*.98}),E.push({name:"↔️ CONTINUED RANGING",probability:k,description:`Price oscillates between $${(f[0]||i*.99).toFixed(2)} and $${(h[0]||i*1.01).toFixed(2)} with choppy action`,trigger:w==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),E.sort((R,I)=>I.probability-R.probability);let v={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=65?l.signal_type==="BUY"?v={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${(i-5).toFixed(2)}-${i.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(v={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${i.toFixed(2)}-${(i+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):w==="EXTREME"?v.reason=`⚠️ EXTREME volatility (ADX ${o.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(d.type==="MIXED"||d.type==="CONFLICTING")&&(v.reason=`⏰ Timeframes conflicting (${d.score}/5 aligned). Wait for ${h[0]?`breakout above $${h[0].toFixed(2)}`:f[0]?`breakdown below $${f[0].toFixed(2)}`:"clearer direction"}.`);let D=!1;if(l.confidence>=65)try{const R=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,A+=`💡 *Action:* ${v.action}
`,v.entry_range&&(A+=`🎯 *Entry:* $${v.entry_range}
`,A+=`🛡️ *Stop:* $${v.stop_loss}
...
⏰ ${new Date().toUTCString()}`;return await z(p,l,r),!0}}return!1}catch(i){return console.error("[MONITORING] Failed to send alert:",i),!1}}Ue.get("/health-check",async e=>{const{DB:t}=e.env;try{const s=await pn(t),n=e.req.url.replace("/api/monitoring/health-check",""),a=new Date().toISOString(),o=await Qo(t);console.log("[MONITORING] Starting comprehensive health check..."),console.log("[MONITORING] Tables exist:",o);const i=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}],l=[],r=s.telegram_alerts_enabled==="1",d=parseInt(s.slow_response_threshold_ms||"5000"),c=parseInt(s.max_failure_count||"3");console.log("[MONITORING] Fast mode: Checking 5 endpoints (MTF skipped)");for(const f of i){const y=await Jo(t,f.name,f.url,n);let w=0,E="unknown",S=y.status==="down"?1:0;if(o)try{const b=await t.prepare(`
            SELECT failure_count, status FROM system_health
            WHERE endpoint_name = ?
            ORDER BY last_check_at DESC
            LIMIT 1
          `).bind(f.name).first();w=(b==null?void 0:b.failure_count)||0,E=(b==null?void 0:b.status)||"unknown",S=y.status==="down"?w+1:0}catch(b){console.log("[MONITORING] Could not read previous health check:",b)}if(o)try{await t.prepare(`
        ...
        `).bind(_,m,u,g,l.reduce((f,y)=>f+y.response_time_ms,0)/l.length).run()}catch(f){console.log("[MONITORING] Could not save metrics:",f)}return console.log(`[MONITORING] Health check complete: ${h}`),console.log(`[MONITORING] Tables exist: ${o}, Alerts enabled: ${r}`),e.json({success:!0,timestamp:a,overall_status:h,summary:{endpoints:{healthy:_,degraded:m,down:u,total:l.length},data:{fresh:p.length-g,stale:g,total:p.length}},endpoints:l,data_freshness:p,config:{stale_threshold_minutes:s.data_stale_threshold_minutes,slow_response_threshold_ms:s.slow_response_threshold_ms,max_failure_count:s.max_failure_count,telegram_alerts_enabled:r}})}catch(s){return console.error("[MONITORING] Health check failed:",s),e.json({success:!1,error:s.message,timestamp:new Date().toISOString()},500)}});Ue.get("/status",async e=>{const{DB:t}=e.env;try{let s,n,a;try{s=await t.prepare(`
        SELECT 
          endpoint_name,
          status,
          response_time_ms,
      ...
      `).all(),a=await t.prepare(`
        ...
        ORDER BY created_at DESC
        LIMIT 10
      `).all()}catch{const r=new URL(e.req.url),d=`${r.protocol}//${r.host}`,c=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}];s={results:await Promise.all(c.map(async({name:_,url:m})=>{try{const u=Date.now(),g=await fetch(`${d}${m}`,{method:"GET",signal:AbortSignal.timeout(1e4)}),h=Date.now()-u;return{endpoint_name:_,status:g.ok?"healthy":"degraded",response_time_ms:h,last_check_at:new Date().toISOString()}}catch{return{endpoint_name:_,status:"down",response_time_ms:0,last_check_at:new Date().toISOString()}}}))};try{const _=await t.prepare(`
          SELECT 
            '1h' as data_source,
            '1h' as timeframe,
        ...
        `).all(),u=await t.prepare(`
          SELECT 
            ...
            datetime('now') as last_fetch_at
          FROM signals
        `).first();n={results:[..._?[_]:[],...m.results||[],...u?[u]:[]]}}catch(_){console.log("[MONITORING] Data freshness check error:",_.message),n={results:[]}}a={results:[]}}const o=(s.results||[]).every(l=>l.status==="healthy"),i=(n.results||[]).every(l=>l.is_stale===0);return e.json({success:!0,overall_status:o&&i?"healthy":"degraded",endpoints:s.results,data_sources:n.results,unresolved_alerts:a.results,alert_count:(a.results||[]).length})}catch(s){return e.json({success:!1,error:s.message},500)}});Ue.get("/alerts",async e=>{const{DB:t}=e.env,s=e.req.query("resolved")==="true";try{const n=await t.prepare(`
    ...
    `).all();return e.json({success:!0,period_hours:s,metrics:n.results})}catch(n){return e.json({success:!1,error:n.message},500)}});Ue.get("/config",async e=>{const{DB:t}=e.env;try{const s=await pn(t);return e.json({success:!0,config:s})}catch(s){return e.json({success:!1,error:s.message},500)}});Ue.post("/config",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
        UPDATE monitoring_config
        SET config_value = ?, updated_at = datetime('now')
        WHERE config_key = ?
      `).bind(a,n).run();return e.json({success:!0,message:"Configuration updated"})}catch(n){return e.json({success:!1,error:n.message},500)}});function ps(e){let t=0,s=0;return e.rsi_14>55&&t++,e.rsi_14<45&&s++,e.macd>e.macd_signal&&t++,e.macd<e.macd_signal&&s++,e.ema_12>e.ema_26&&t++,e.ema_12<e.ema_26&&s++,e.sma_20>e.sma_50&&t++,e.sma_20<e.sma_50&&s++,t>s+1?"BULLISH":s>t+1?"BEARISH":"NEUTRAL"}function ti(e,t,s,n){if(t.length<20)return null;const a=t.slice(-20),o=a.map(_=>_.high),i=a.map(_=>_.low),l=Math.max(...o),r=Math.min(...i),d=a.reduce((_,m)=>_+(m.volume||1),0)/a.length,c=t[t.length-1].volume||1,p=c>d*1.3;if(e>l&&p&&s.rsi_14>50&&s.macd>0&&s.adx>25&&n==="BULLISH"){const _=Math.max(r,e-e*.0027),m=e+e*.0022,u=e+e*.004,g=e+e*.0055;let h=65;return s.adx>35&&(h+=5),s.rsi_14>60&&s.rsi_14<75&&(h+=5),c>d*1.5&&(h+=5),{signal_type:"BUY",setup_type:"BREAKOUT",price:e,stop_loss:_,take_profit_1:m,take_profit_2:u,take_profit_3:g,confidence:Math.min(h,85),trend_5m:n,trend_15m:n,reason:`Bullish breakout above $${l.toFixed(2)} with ${p?"strong":"moderate"} volume`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:c}}}if(e<r&&p&&s.rsi_14<50&&s.macd<0&&s.adx>25&&n==="BEARISH"){const _=Math.min(l,e+e*.0027),m=e-e*.0022,u=e-e*.004,g=e-e*.0055;let h=65;return s.adx>35&&(h+=5),s.rsi_14<40&&s.rsi_14>25&&(h+=5),c>d*1.5&&(h+=5),{signal_type:"SELL",setup_type:"BREAKOUT",price:e,stop_loss:_,take_profit_1:m,take_profit_2:u,take_profit_3:g,confidence:Math.min(h,85),trend_5m:n,trend_15m:n,reason:`Bearish breakdown below $${r.toFixed(2)} with ${p?"strong":"moderate"} volume`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:c}}}return null}function si(e,t,s,n){if(s!==n)return null;if(s==="BULLISH"&&t.adx>28&&e>t.ema_12&&t.rsi_14>=45&&t.rsi_14<=70&&t.macd>t.macd_signal){const a=e-e*.002,o=e+e*.0027,i=e+e*.004,l=e+e*.0055;let r=62;return t.adx>35&&(r+=6),t.rsi_14>50&&t.rsi_14<65&&(r+=5),t.plus_di>t.minus_di&&(r+=4),{signal_type:"BUY",setup_type:"CONTINUATION",price:e,stop_loss:a,take_profit_1:o,take_profit_2:i,take_profit_3:l,confidence:Math.min(r,80),trend_5m:s,trend_15m:n,reason:`Bullish continuation - pullback in strong uptrend (ADX ${t.adx.toFixed(0)})`,indicators_5m:{rsi:t.rsi_14,macd:t.macd,macd_signal:t.macd_signal,macd_histogram:t.macd_histogram,adx:t.adx,stochastic_k:t.stochastic_k,stochastic_d:t.stochastic_d,ema_20:t.sma_20,volume:0}}}if(s==="BEARISH"&&t.adx>28&&e<t.ema_12&&t.rsi_14>=30&&t.rsi_14<=55&&t.macd<t.macd_signal){const a=e+e*.002,o=e-e*.0027,i=e-e*.004,l=e-e*.0055;let r=62;return t.adx>35&&(r+=6),t.rsi_14<50&&t.rsi_14>35&&(r+=5),t.minus_di>t.plus_di&&(r+=4),{signal_type:"SELL",setup_type:"CONTINUATION",price:e,stop_loss:a,take_profit_1:o,take_profit_2:i,take_profit_3:l,confidence:Math.min(r,80),trend_5m:s,trend_15m:n,reason:`Bearish continuation - pullback in strong downtrend (ADX ${t.adx.toFixed(0)})`,indicators_5m:{rsi:t.rsi_14,macd:t.macd,macd_signal:t.macd_signal,macd_histogram:t.macd_histogram,adx:t.adx,stochastic_k:t.stochastic_k,stochastic_d:t.stochastic_d,ema_20:t.sma_20,volume:0}}}return null}function ni(e,t,s){if(t.length<10)return null;const n=t.slice(-10),a=Math.min(...n.map(i=>i.low)),o=Math.max(...n.map(i=>i.high));if(s.rsi_14<30&&s.stochastic_k<25&&e<a*1.001&&s.macd_histogram>-.5){const i=e-e*.002,l=e+e*.0022,r=e+e*.004,d=e+e*.0055;let c=60;return s.rsi_14<25&&(c+=5),s.stochastic_k<20&&(c+=5),{signal_type:"BUY",setup_type:"REVERSAL",price:e,stop_loss:i,take_profit_1:l,take_profit_2:r,take_profit_3:d,confidence:Math.min(c,75),trend_5m:"NEUTRAL",trend_15m:"NEUTRAL",reason:`Bullish reversal - oversold bounce (RSI ${s.rsi_14.toFixed(0)}, Stoch ${s.stochastic_k.toFixed(0)})`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}if(s.rsi_14>70&&s.stochastic_k>75&&e>o*.999&&s.macd_histogram<.5){const i=e+e*.002,l=e-e*.0022,r=e-e*.004,d=e-e*.0055;let c=60;return s.rsi_14>75&&(c+=5),s.stochastic_k>80&&(c+=5),{signal_type:"SELL",setup_type:"REVERSAL",price:e,stop_loss:i,take_profit_1:l,take_profit_2:r,take_profit_3:d,confidence:Math.min(c,75),trend_5m:"NEUTRAL",trend_15m:"NEUTRAL",reason:`Bearish reversal - overbought rejection (RSI ${s.rsi_14.toFixed(0)}, Stoch ${s.stochastic_k.toFixed(0)})`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}return null}function ai(e,t,s){if(t.length<20||s.adx>25)return null;const n=t.slice(-20),a=n.map(c=>c.high),o=n.map(c=>c.low),i=Math.max(...a),l=Math.min(...o),r=i-l,d=l+r/2;if(r<e*.002)return null;if(e<l*1.002&&s.rsi_14<40&&s.stochastic_k<35){const c=l-e*.0018,p=d,_=d+r*.3,m=i*.998;let u=60;return s.rsi_14<30&&(u+=5),s.stochastic_k<25&&s.stochastic_d<25&&(u+=3),{signal_type:"BUY",setup_type:"BOUNCE",price:e,stop_loss:c,take_profit_1:p,take_profit_2:_,take_profit_3:m,confidence:Math.min(u,72),trend_5m:"NEUTRAL",trend_15m:"NEUTRAL",reason:`Support bounce in range $${l.toFixed(2)}-$${i.toFixed(2)}`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}if(e>i*.998&&s.rsi_14>60&&s.stochastic_k>65){const c=i+e*.0018,p=d,_=d-r*.3,m=l*1.002;let u=60;return s.rsi_14>70&&(u+=5),s.stochastic_k>75&&s.stochastic_d>75&&(u+=3),{signal_type:"SELL",setup_type:"BOUNCE",price:e,stop_loss:c,take_profit_1:p,take_profit_2:_,take_profit_3:m,confidence:Math.min(u,72),trend_5m:"NEUTRAL",trend_15m:"NEUTRAL",reason:`Resistance rejection in range $${l.toFixed(2)}-$${i.toFixed(2)}`,indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}return null}function oi(e,t,s,n){if(t.length<15)return null;const a=t.slice(-10),o=a.map(l=>l.high),i=a.map(l=>l.low);if(n==="BULLISH"&&s.adx>30&&Math.max(...o)-Math.min(...i)<e*.002&&e>s.ema_12&&s.rsi_14>45&&s.rsi_14<65){const l=Math.min(...i)-e*.0018,r=e+e*.0027,d=e+e*.004,c=e+e*.0055;return{signal_type:"BUY",setup_type:"PATTERN",price:e,stop_loss:l,take_profit_1:r,take_profit_2:d,take_profit_3:c,confidence:68,trend_5m:n,trend_15m:n,reason:"Bull flag pattern - tight consolidation in uptrend",indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}if(n==="BEARISH"&&s.adx>30&&Math.max(...o)-Math.min(...i)<e*.002&&e<s.ema_12&&s.rsi_14>35&&s.rsi_14<55){const l=Math.max(...o)+e*.0018,r=e-e*.0027,d=e-e*.004,c=e-e*.0055;return{signal_type:"SELL",setup_type:"PATTERN",price:e,stop_loss:l,take_profit_1:r,take_profit_2:d,take_profit_3:c,confidence:68,trend_5m:n,trend_15m:n,reason:"Bear flag pattern - tight consolidation in downtrend",indicators_5m:{rsi:s.rsi_14,macd:s.macd,macd_signal:s.macd_signal,macd_histogram:s.macd_histogram,adx:s.adx,stochastic_k:s.stochastic_k,stochastic_d:s.stochastic_d,ema_20:s.sma_20,volume:0}}}return null}function un(e,t,s,n){if(e.length<20)return null;const a=e[e.length-1].close,o=ps(t),i=ps(n),l=[ti(a,e,t,o),si(a,t,o,i),oi(a,e,t,o),ni(a,e,t),ai(a,e,t)];for(const r of l)if(r&&r.confidence>=60)return r;return null}const ut=new _e;async function ii(e){const t=new Date().toISOString().split("T")[0];let s=await e.prepare(`
  ...
  `).bind(t).first();s||(await e.prepare(`
    ...
    `).bind(a.toISOString(),"5 consecutive losses",t).run(),{allowed:!1,reason:"5 consecutive losses - paused for 1 hour",signals_sent_today:s.signals_sent_today,max_signals:n}}if(s.daily_pnl_pips<=-80){const a=new Date;return a.setUTCHours(23,59,59,999),await e.prepare(`
      ...
      SET paused_until = ?, pause_reason = ?, updated_at = datetime('now')
      WHERE date = ?
    `).bind(a.toISOString(),"Daily loss limit (-80 pips)",t).run(),{allowed:!1,reason:"Daily loss limit reached (-80 pips)",signals_sent_today:s.signals_sent_today,max_signals:n}}return{allowed:!0,signals_sent_today:s.signals_sent_today,max_signals:n}}function ri(e,t,s){const a=t>=80?1:t>=70?.9:t>=60?.7:.5,o=e.confidence>=75?1:e.confidence>=70?.9:e.confidence>=65?.8:.7,l={BREAKOUT:1,CONTINUATION:.95,PATTERN:.9,REVERSAL:.8,BOUNCE:.75}[e.setup_type]||.7,r=a*o*l,d=1e3*r,c=d/1e3*.1,m=Math.abs(e.price-e.stop_loss)/e.price*1e4*.01*c*100,u=m/1e4*100;return{multiplier:r,lots:Number(c.toFixed(2)),value:Number(d.toFixed(0)),risk_amount:Number(m.toFixed(2)),risk_percent:Number(u.toFixed(2))}}function _n(e,t,s,n,a,o,i,l){const r=e.signal_type==="BUY"?"🟢":"🔴",d={BREAKOUT:"📈",CONTINUATION:"➡️",REVERSAL:"🔄",BOUNCE:"⚡",PATTERN:"📊"}[e.setup_type]||"📍",c=t>=75?"🟢":t>=60?"🟡":"🔴",p=e.confidence>=75?"⭐⭐⭐":e.confidence>=70?"⭐⭐":e.confidence>=65?"⭐":"",_=Math.abs(e.price-e.stop_loss)/e.price*1e4,m=Math.abs(e.take_profit_1-e.price)/e.price*1e4,u=m/_,g=new Date,h=`${g.getUTCHours().toString().padStart(2,"0")}:${g.getUTCMinutes().toString().padStart(2,"0")} UTC`;let f=`${r} <b>MICRO TRADE #${l}</b> ${d}

`;f+=`<b>${e.signal_type}</b> XAU/USD | ${e.confidence.toFixed(0)}% ${p}
`,f+=`Setup: ${e.setup_type} ${e.trend_5m==="BULLISH"?"📈":e.trend_5m==="BEARISH"?"📉":"➡️"}

`,f+=`💰 <b>Entry:</b> $${e.price.toFixed(2)} (NOW!)
`,f+=`🛡️ <b>Stop:</b> $${e.stop_loss.toFixed(2)} (-${_.toFixed(0)} pips)
...
`,f+=`Signal #${l} | ${h}`,f}ut.get("/scan",async e=>{var n;const{DB:t}=e.env,s={success:!1,message:"",data:{}};try{console.log("[MICRO] Starting 5-minute scan...");const a=await ii(t);if(!a.allowed)return console.log("[MICRO] Daily limit check failed:",a.reason),s.message=a.reason,s.data={signals_sent_today:a.signals_sent_today,max_signals:a.max_signals},e.json(s);console.log(`[MICRO] Daily limit check passed: ${a.signals_sent_today}/${a.max_signals} signals sent`);const o=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = '5m'
      ORDER BY timestamp DESC 
    ...
    `).all();if(!o.results||o.results.length<20)return s.message="Insufficient 5m candle data",e.json(s);const i=o.results.map(b=>({timestamp:b.timestamp,open:b.open,high:b.high,low:b.low,close:b.close,volume:b.volume||1})).reverse(),l=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 60
    `).all();if(!l.results||l.results.length<50)return s.message=`Insufficient 15m candle data (have ${((n=l.results)==null?void 0:n.length)||0}, need 50)`,e.json(s);const r=l.results.map(b=>({timestamp:b.timestamp,open:b.open,high:b.high,low:b.low,close:b.close,volume:b.volume||1})).reverse(),d=pe(i),c=pe(r);if(!d)return console.error("[MICRO] Failed to calculate 5m indicators - data length:",i.length),s.message="Failed to calculate 5m indicators",s.data={candles5m_count:i.length,first_candle:i[0],last_candle:i[i.length-1]},e.json(s);if(!c)return console.error("[MICRO] Failed to calculate 15m indicators - data length:",r.length),s.message="Failed to calculate 15m indicators",s.data={candles15m_count:r.length},e.json(s);const p=i[i.length-1].close,_=un(i,d,r,c);if(!_)return console.log("[MICRO] No valid setup detected"),s.success=!0,s.message="No signal - waiting for setup",s.data={currentPrice:p},e.json(s);if(console.log(`[MICRO] Signal detected: ${_.signal_type} ${_.setup_type} (${_.confidence}%)`),_.confidence<60)return console.log(`[MICRO] Confidence too low: ${_.confidence}%`),s.success=!0,s.message=`Signal below threshold (${_.confidence}% < 60%)`,s.data={signal:_},e.json(s);const m=Bt(i);if(m.liquidity_score<60)return console.log(`[MICRO] Liquidity too low: ${m.liquidity_score}`),s.success=!0,s.message=`Low liquidity (${m.liquidity_score} < 60)`,s.data={signal:_,liquidity:m},e.json(s);const u=ri(_,m.liquidity_score,m.optimal_for_trading),g=new Date(Date.now()+900*1e3).toISOString(),h=new Date().toISOString().split("T")[0],f=await t.prepare(`
    ...
    `).all(),E={};for(const b of w.results||[])E[b.setting_key]=b.setting_value;let S=!1;if(E.telegram_bot_token&&E.telegram_chat_id){const b=_n(_,m.liquidity_score,m.session,m.volume_trend,m.volume_percentile,m.estimated_spread_pips,u,y);S=await z({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},b),S&&(await t.prepare(`
        ...
        `).bind(h).run(),await t.prepare(`
          ...
          ON CONFLICT(date) DO UPDATE SET
            ...
            updated_at = datetime('now')
        `).bind(h,_.signal_type==="BUY"?1:0,_.signal_type==="SELL"?1:0,_.confidence,m.liquidity_score,m.session==="ASIA"?1:0,m.session==="LONDON"?1:0,m.session==="NEW_YORK"?1:0,m.session==="OVERLAP"?1:0,_.setup_type==="BREAKOUT"?1:0,_.setup_type==="CONTINUATION"?1:0,_.setup_type==="REVERSAL"?1:0,_.setup_type==="BOUNCE"?1:0,_.setup_type==="PATTERN"?1:0).run(),console.log("[MICRO] Telegram alert sent successfully"))}return s.success=!0,s.message=S?"Signal generated and sent to Telegram":"Signal generated (Telegram not configured)",s.data={signal:_,liquidity:m,position:u,signalNumber:y,limitsCheck:a,telegramSent:S},e.json(s)}catch(a){return console.error("[MICRO] Error:",a),s.message=a.message||"Unknown error",e.json(s,500)}});ut.get("/signals/recent",async e=>{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"20");try{const n=await t.prepare(`
...
${_n(a,o.liquidity_score,o.session,o.volume_trend,o.volume_percentile,o.estimated_spread_pips,i,999)}

✅ This is a test alert to show you what micro-trade signals will look like.

📅 Real signals will start appearing when market opens Monday.`;return await z({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},r)?e.json({success:!0,message:"Test alert sent to Telegram successfully!",preview:r,telegram_config:{hasToken:!0,hasChat:!0,chatId:n.telegram_chat_id}}):e.json({success:!1,message:"Failed to send test alert to Telegram",preview:r},500)}catch(s){return console.error("[MICRO TEST] Error:",s),e.json({success:!1,error:s.message,stack:s.stack},500)}});function li(e,t){const s=Object.keys(t);let n=0;for(const i of s){const l=t[i];if(!l)continue;(l.trend||l.ema_trend||"NEUTRAL")===(e==="BUY"?"BULLISH":"BEARISH")&&n++}const a=n>=3,o=n/s.length*100;return{passed:a,score:o,reason:a?`${n}/${s.length} timeframes aligned`:`Only ${n}/${s.length} timeframes aligned (need 3+)`}}function ci(e){const t=[{hour:12,minute:30,name:"US CPI",duration:30},{hour:14,minute:0,name:"FOMC",duration:60},{hour:8,minute:30,name:"UK GDP",duration:30}],s=e.getUTCHours(),n=e.getUTCMinutes(),a=s*60+n;for(const o of t){const i=o.hour*60+o.minute-15,l=o.hour*60+o.minute+o.duration;if(a>=i&&a<=l)return{passed:!1,score:0,reason:`High-impact news: ${o.name} (avoid zone)`}}return{passed:!0,score:100,reason:"No high-impact news in danger zone"}}function di(e){const t=e.getUTCHours(),n={0:.45,1:.42,2:.4,3:.48,4:.52,5:.55,6:.6,7:.65,8:.72,9:.68,10:.7,11:.72,12:.75,13:.78,14:.82,15:.8,16:.75,17:.72,18:.68,19:.65,20:.58,21:.52,22:.48,23:.46}[t]||.5,a=n>=.7;return{passed:a,score:n*100,reason:a?`Optimal trading hour (${(n*100).toFixed(0)}% historical win rate)`:`Low win rate hour (${(n*100).toFixed(0)}% - need 70%+)`}}function mi(e,t){if(t.length<50)return{passed:!0,score:50,reason:"Insufficient data for volatility check"};const s=[...t].sort((i,l)=>i-l),n=s.filter(i=>i<e).length/s.length*100;let a,o;return n<20?(a="LOW",o=!1):n<70?(a="NORMAL",o=!0):n<90?(a="HIGH",o=!0):(a="EXTREME",o=!1),{passed:o,score:o?100:0,reason:`Volatility: ${a} (${n.toFixed(0)}th percentile)`}}function pi(e,t){if(t.length<20)return{passed:!0,score:50,reason:"Insufficient candles for structure analysis"};const s=[],n=[];for(let c=2;c<Math.min(t.length-2,50);c++){const p=t[c],_=t[c-1],m=t[c-2],u=t[c+1],g=t[c+2];if(p.high>_.high&&p.high>m.high&&p.high>u.high&&p.high>g.high&&(s.push(p.high),s.length>=3)||p.low<_.low&&p.low<m.low&&p.low<u.low&&p.low<g.low&&(n.push(p.low),n.length>=3))break}if(s.length<3||n.length<3)return{passed:!0,score:50,reason:"Not enough swings for structure analysis"};const a=s[0]>s[1]&&s[1]>s[2],o=n[0]>n[1]&&n[1]>n[2],i=s[0]<s[1]&&s[1]<s[2],l=n[0]<n[1]&&n[1]<n[2];let r=!1,d="RANGING";return a&&o?(d="BULLISH",r=e==="BUY"):i&&l&&(d="BEARISH",r=e==="SELL"),{passed:r,score:r?100:0,reason:`Market structure: ${d} (${r?"aligned":"against signal"})`}}function ui(e,t){if(t.length<100)return{passed:!0,score:50,reason:"Insufficient data for volume profile"};const s=new Map;t.slice(-200).forEach(l=>{const r=Math.round(l.close*10)/10;s.set(r,(s.get(r)||0)+(l.volume||1))});const n=Array.from(s.entries()).sort((l,r)=>r[1]-l[1]),a=n[0][1],i=n.filter(([l,r])=>r>=a*.6).map(([l,r])=>l).some(l=>Math.abs(e-l)/e<.003);return{passed:i,score:i?100:30,reason:i?"Price near high-volume node (key level)":"Price not near any high-volume nodes"}}function _i(e,t){if(t.length<10)return{passed:!0,score:50,reason:"Insufficient candles for order flow"};const s=t.slice(-10);let n=0,a=0;s.forEach(r=>{const d=Math.abs(r.close-r.open),c=r.volume||1,p=d*c;r.close>r.open?n+=p:a+=p});const o=n+a,i=n/o;let l=!1;return(e==="BUY"&&i>.55||e==="SELL"&&i<.45)&&(l=!0),{passed:l,score:l?100:40,reason:l?`Order flow aligned (${(i*100).toFixed(0)}% bullish pressure)`:`Order flow not aligned (${(i*100).toFixed(0)}% bullish pressure)`}}function gi(e,t,s){if(s.length<20)return{passed:!0,score:50,reason:"Insufficient data for SMC analysis"};const n=[];for(let o=1;o<Math.min(s.length-1,50);o++){const i=s[o-1],l=s[o];i.close>i.open&&l.close<l.open&&(i.close-l.close)/i.close>.002&&n.push({type:"BULLISH",low:i.low,high:i.high}),i.close<i.open&&l.close>l.open&&(l.close-i.close)/i.close>.002&&n.push({type:"BEARISH",low:i.low,high:i.high})}let a=!1;return e==="BUY"?a=n.some(o=>o.type==="BULLISH"&&t>=o.low&&t<=o.high*1.005):a=n.some(o=>o.type==="BEARISH"&&t<=o.high&&t>=o.low*.995),{passed:a,score:a?100:30,reason:a?"Price testing institutional order block":"No relevant order blocks nearby"}}function fi(e,t){if(!t)return{passed:!0,score:70,reason:"No correlation data available"};let s=50,n=[];return e==="BUY"?(t.dxy_direction==="DOWN"&&(s+=25,n.push("DXY falling (bullish for gold)")),t.spx_direction==="DOWN"&&(s+=25,n.push("SPX falling (risk-off, bullish for gold)"))):(t.dxy_direction==="UP"&&(s+=25,n.push("DXY rising (bearish for gold)")),t.spx_direction==="UP"&&(s+=25,n.push("SPX rising (risk-on, bearish for gold)"))),{passed:s>=75,score:s,reason:n.length>0?n.join(", "):"No correlation support"}}function hi(e,t){let s=0;const n=[],a=t.rsi_14||t.rsi||50;e==="BUY"&&a<50?(s++,n.push("RSI oversold")):e==="SELL"&&a>50&&(s++,n.push("RSI overbought")),t.macd&&t.macd_signal&&(e==="BUY"&&t.macd>t.macd_signal?(s++,n.push("MACD bullish")):e==="SELL"&&t.macd<t.macd_signal&&(s++,n.push("MACD bearish"))),(t.adx_14||t.adx||0)>25&&(s++,n.push("Strong trend (ADX > 25)")),t.stochastic_k&&(e==="BUY"&&t.stochastic_k<30?(s++,n.push("Stochastic oversold")):e==="SELL"&&t.stochastic_k>70&&(s++,n.push("Stochastic overbought"))),t.ema_20&&t.ema_50&&(e==="BUY"&&t.ema_20>t.ema_50?(s++,n.push("EMA bullish alignment")):e==="SELL"&&t.ema_20<t.ema_50&&(s++,n.push("EMA bearish alignment")));const i=5,l=s/i*100;return{passed:s>=3,score:l,reason:`${s}/${i} indicators aligned: ${n.join(", ")}`}}async function gn(e,t,s,n,a,o){const i=new Date,l={multiTimeframe:li(e,a),newsCalendar:ci(i),timeOfDay:di(i),volatility:mi(n.atr_14||n.atr||0,(o==null?void 0:o.atrHistory)||[]),marketStructure:pi(e,s),volumeProfile:ui(t,s),orderFlow:_i(e,s),smartMoney:gi(e,t,s),correlation:fi(e,o==null?void 0:o.correlationData),confluence:hi(e,n)},r=Object.values(l).filter(u=>u.passed).length,d=Object.keys(l).length,c=Object.values(l).reduce((u,g)=>u+g.score,0)/d;let p,_,m;return r>=9?(p="A+",_=2,m=90+(c-90)/2):r>=7?(p="A",_=1,m=80+(c-80)/2):r>=4?(p="B",_=.5,m=65+(c-65)/3):(p="REJECT",_=0,m=c),{grade:p,filtersPassed:r,totalFilters:d,positionMultiplier:_,confidence:m,filterResults:l}}const ts=new _e;function yi(e,t,s,n,a){const o=e.signal_type==="BUY"?"🟢":"🔴",i={"A+":"💎",A:"⭐",B:"📊"}[t.grade]||"📍",l={BREAKOUT:"📈",CONTINUATION:"➡️",REVERSAL:"🔄",BOUNCE:"⚡",PATTERN:"📊"}[e.setup_type]||"📍",r=Math.abs(e.price-e.stop_loss)/e.price*1e4,d=Math.abs(e.take_profit_1-e.price)/e.price*1e4,c=d/r,p=new Date,_=`${p.getUTCHours().toString().padStart(2,"0")}:${p.getUTCMinutes().toString().padStart(2,"0")} UTC`;let m="";t.grade==="A+"?m=`${i} <b>PREMIUM SIGNAL #${s}</b> ${i}
<b>GRADE: A+ (TOP 10%)</b>
...
`;let u=m;u+=`${o} <b>${e.signal_type}</b> XAU/USD | ${t.confidence.toFixed(0)}%
`,u+=`Setup: ${e.setup_type} ${e.trend_5m==="BULLISH"?"📈":e.trend_5m==="BEARISH"?"📉":"➡️"}

`,u+=`💰 <b>Entry:</b> $${e.price.toFixed(2)} (NOW!)
`,u+=`🛡️ <b>Stop:</b> $${e.stop_loss.toFixed(2)} (-${r.toFixed(0)} pips)
`,u+=`🎯 <b>TP1:</b> $${e.take_profit_1.toFixed(2)} (+${d.toFixed(0)} pips) - Take 50%
`,u+=`🎯 <b>TP2:</b> $${e.take_profit_2.toFixed(2)} - Take 30%
`,u+=`🎯 <b>TP3:</b> $${e.take_profit_3.toFixed(2)} - Trail rest

`;const h=1e3*t.positionMultiplier,f=h/1e3*.1,y=r*.01*f*100,w=y/1e4*100,E=t.positionMultiplier>=1.5?"🟢🟢":t.positionMultiplier>=.9?"🟢":"🟡";return u+=`${E} <b>Position:</b> ${f.toFixed(2)} lots ($${h}) [${t.positionMultiplier}x]
`,u+=`⚠️ <b>Risk:</b> $${y.toFixed(2)} (${w.toFixed(2)}%)

`,u+=`📊 <b>Quality Metrics:</b>
`,u+=`   Filters Passed: ${t.filtersPassed}/10
`,u+=`   Liquidity: ${n}/100 | ${a}
`,u+=`   R:R Ratio: 1:${c.toFixed(1)}

`,u+=`⏱️ <b>Valid:</b> 15 minutes
`,u+=`⚡ <b>Execute immediately!</b>

`,u+=`━━━━━━━━━━━━━━━━━━━━
`,u+=`${e.reason}

`,u+=`Signal #${s} | ${_}`,u}ts.get("/scan",async e=>{const{DB:t}=e.env,s=Date.now();try{console.log("[HYBRID-MICRO] Starting hybrid scan...");const n={};for(const g of["5m","15m","1h","4h"]){const h=await t.prepare(`
        SELECT timestamp, open, high, low, close, volume 
        FROM market_data 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(g).all();if(h.results&&h.results.length>=20){const f=h.results.map(w=>({timestamp:w.timestamp,open:w.open,high:w.high,low:w.low,close:w.close,volume:w.volume||1})).reverse(),y=await pe(f);if(!y){console.log(`[HYBRID-MICRO] Skipping ${g} - insufficient data for indicators`);continue}n[g]={candles:f,indicators:y,trend:y.ema_20>y.ema_50?"BULLISH":"BEARISH"}}}if(!n["5m"]||!n["15m"])return e.json({success:!1,error:"Insufficient data for hybrid analysis"});const a=await un(n["5m"].candles,n["5m"].indicators,n["15m"].candles,n["15m"].indicators);if(!a)return e.json({success:!1,message:"No micro trade setup detected"});const o=n["5m"].candles[n["5m"].candles.length-1].close,i=n["5m"].indicators;if(!i||!i.rsi_14)return e.json({success:!1,error:"Technical indicators not available",debug:{hasIndicators:!!i,indicatorKeys:i?Object.keys(i).slice(0,5):[]}});const l=n["5m"].candles.slice(-100).map((g,h,f)=>{if(h<14)return 0;const y=f.slice(Math.max(0,h-14),h),w=y.map((E,S)=>{if(S===0)return E.high-E.low;const b=y[S-1].close;return Math.max(E.high-E.low,Math.abs(E.high-b),Math.abs(E.low-b))});return w.reduce((E,S)=>E+S,0)/w.length}).filter(g=>g>0),r=await gn(a.signal_type,o,n["5m"].candles,i,n,{atrHistory:l});if(console.log(`[HYBRID-MICRO] Signal graded: ${r.grade} (${r.filtersPassed}/10 filters)`),r.grade==="REJECT")return e.json({success:!1,message:`Signal rejected (only ${r.filtersPassed}/10 filters passed)`,grade:r.grade,filters_passed:r.filtersPassed});const d=await t.prepare(`
      SELECT COUNT(*) as count FROM micro_trade_signals 
      WHERE DATE(created_at) = DATE('now')
    `).first(),c=((d==null?void 0:d.count)||0)+1,p={...a,confidence:r.confidence};await t.prepare(`
      INSERT INTO micro_trade_signals (
    ...
    `).bind(p.signal_type,p.price,p.stop_loss,p.take_profit_1,p.take_profit_2,p.take_profit_3,r.confidence,p.setup_type,p.trend_5m,p.trend_15m,JSON.stringify(p.indicators_5m),p.reason,r.grade,r.filtersPassed,r.positionMultiplier).run();const _=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),m={};for(const g of _.results||[])m[g.setting_key]=g.setting_value;let u=!1;if(m.telegram_bot_token&&m.telegram_chat_id){const g=yi(p,r,c,85,"NEW_YORK");u=await z({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},g),u&&await t.prepare(`
          UPDATE micro_trade_signals 
          SET telegram_sent = 1
          WHERE id = (SELECT MAX(id) FROM micro_trade_signals)
        `).run()}return e.json({success:!0,message:`${r.grade}-grade signal generated and ${u?"sent":"saved"}`,signal:{...p,grade:r.grade,filters_passed:r.filtersPassed,position_multiplier:r.positionMultiplier},telegram_sent:u,execution_time_ms:Date.now()-s})}catch(n){return console.error("[HYBRID-MICRO] Error:",n),e.json({success:!1,error:n.message},500)}});ts.get("/test",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = '5m'
      ORDER BY timestamp DESC 
      LIMIT 50
    `).all();if(!s.results||s.results.length<20)return e.json({success:!1,error:"Insufficient data for testing"});const n=s.results.map(l=>({timestamp:l.timestamp,open:l.open,high:l.high,low:l.low,close:l.close,volume:l.volume||1})).reverse(),a=await pe(n),o=n[n.length-1].close,i=await gn("BUY",o,n,a,{"5m":{trend:"BULLISH",indicators:a}});return e.json({success:!0,test_results:{grade:i.grade,filters_passed:i.filtersPassed,confidence:i.confidence,position_multiplier:i.positionMultiplier,filter_details:i.filterResults},current_price:o,indicators:{rsi:a.rsi,macd:a.macd,adx:a.adx}})}catch(s){return e.json({success:!1,error:s.message},500)}});const G=new _e;G.use("/api/*",ra());G.route("/api/signals/enhanced",zs);G.route("/api/signals/simple",Xs);G.route("/api/scanner",ct);G.route("/api/trades",we);G.route("/api/calendar",Fe);G.route("/api/backtest",pt);G.route("/api/telegram",dn);G.route("/api/ai",Pt);G.route("/api/monitoring",Ue);G.route("/api/micro",ut);G.route("/api/hybrid-micro",ts);G.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>yn),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});G.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,r=await(await fetch(i)).json();if(r.code&&r.status==="error")return e.json({success:!1,error:r.message||"Twelve Data API error",count:0});if(!r.values||!Array.isArray(r.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const d=r.values,c=d.map(u=>t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(u.datetime,parseFloat(u.open)||0,parseFloat(u.high)||0,parseFloat(u.low)||0,parseFloat(u.close)||0,parseInt(u.volume||"0")||0,"1h"));await t.batch(c);const p=d.length,_=d[0],m=parseFloat(_.close)||0;return e.json({success:!0,count:p,price:m,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});G.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const i=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,r=await(await fetch(i)).json();if(r.code&&r.status==="error")return e.json({success:!1,error:r.message||"Twelve Data API error",count:0});if(!r.values||!Array.isArray(r.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=r.values.map(m=>({timestamp:m.datetime,open:parseFloat(m.open)||0,high:parseFloat(m.high)||0,low:parseFloat(m.low)||0,close:parseFloat(m.close)||0,volume:0})),p=c.map(m=>t.prepare(`
        INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, '1h')
        ON CONFLICT DO NOTHING
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume));await t.batch(p);const _=c.length;if(c.length>=50){const m=pe(c.reverse());if(m){await t.prepare(`
        ...
        `).bind(m.rsi_14,m.macd,m.macd_signal,m.macd_histogram,m.sma_20,m.sma_50,m.sma_200,m.ema_12,m.ema_26,m.bb_upper,m.bb_middle,m.bb_lower,m.atr_14,m.stochastic_k,m.stochastic_d,m.adx,m.plus_di,m.minus_di,m.ichimoku_tenkan,m.ichimoku_kijun,m.ichimoku_senkou_a,m.ichimoku_senkou_b,m.parabolic_sar,m.vwap,m.fib_382||0,m.fib_500||0,m.fib_618||0).run();const u=c[c.length-1].close,g=le(u,m,"day_trade"),h=le(u,m,"swing_trade"),f=70;for(const y of[g,h])if(y.confidence>=f&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const w=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),E={};for(const S of w.results||[])E[S.setting_key]=S.setting_value;E.telegram_bot_token&&E.telegram_chat_id&&await z({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},lt(y))}}}return e.json({success:!0,count:_})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),n={};for(const v of s.results)n[v.setting_key]=v.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",o=n.telegram_bot_token,i=n.telegram_chat_id;console.log("[AUTO-FETCH] Settings loaded:",{hasApiKey:!!a,hasBotToken:!!o,botTokenLength:o?o.length:0,hasChatId:!!i,chatId:i});const d=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,p=await(await fetch(d)).json();if(p.code&&p.status==="error")return e.json({success:!1,error:p.message||"API error",telegram_sent:!1});if(!p.values||!Array.isArray(p.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const m=p.values.map(v=>({timestamp:v.datetime,open:parseFloat(v.open)||0,high:parseFloat(v.high)||0,low:parseFloat(v.low)||0,close:parseFloat(v.close)||0,volume:parseInt(v.volume||"0")||0})),u=m.map(v=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(v.timestamp,v.open,v.high,v.low,v.close,v.volume,"1h"));await t.batch(u);const g=pe(m);if(!g)return e.json({success:!0,count:m.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});let h=m[0].close,f=!1;try{console.log("[AUTO-FETCH] Fetching real-time price...");const D=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${a}`,{signal:AbortSignal.timeout(5e3)})).json();if(D.price){const R=parseFloat(D.price),I=h,j=Math.abs(R-I)/R*100;console.log(`[AUTO-FETCH] Real-time: $${R}, Last candle: $${I}, Diff: ${j.toFixed(2)}%`),j<2?(h=R,f=!0,console.log(`[AUTO-FETCH] ✅ Using real-time price: $${R}`)):console.log(`[AUTO-FETCH] ⚠️ Price diff too large (${j.toFixed(2)}%), using candle close`)}}catch(v){console.log("[AUTO-FETCH] Real-time price fetch failed, using candle close:",v.message)}const y=le(h,g,"day_trade"),w=le(h,g,"swing_trade");try{await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
⏰ ${new Date().toLocaleString()}`,j=await z({botToken:o,chatId:i},U);k.day_trade_send_result=j,console.log("[AUTO-FETCH] Day trade alert result:",j),j?(S=!0,b.push("Day Trade"),R&&y.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${D}
...
⏰ ${new Date().toLocaleString()}`,j=await z({botToken:o,chatId:i},U);k.swing_trade_send_result=j,j&&(S=!0,b.push("Swing Trade"),R&&w.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${D}
...
🎯 TP1: $${w.take_profit_1.toFixed(2)}
🛡️ Stop: $${w.stop_loss.toFixed(2)}`;await z({botToken:o,chatId:i},L),console.log("[AUTO-FETCH] Swing final reminder sent")},420*1e3),b.push("High Conviction Swing Reminders (3+7min)")))}}else console.log("[AUTO-FETCH] Telegram NOT configured or invalid token");return console.log(`[CRON] Processed ${m.length} candles, Telegram: ${S?"SENT":"NOT SENT"}, Alerts: ${b.join(", ")}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:m.length,latest_price:h,data_timestamp:m[0].timestamp},signals:{day_trade:{type:y.signal_type,confidence:y.confidence,price:h},swing_trade:{type:w.signal_type,confidence:w.confidence,price:h}},telegram:{configured:!!(o&&i),bot_token_set:!!o,chat_id_set:!!i,bot_token_valid:o!=="your_bot_token_here",sent:S,alerts:b},debug:{...k,day_trade_check:{confidence:y.confidence,min_confidence:E,meets_threshold:y.confidence>=E,signal_type:y.signal_type,sends_all_signals:!0,should_alert:y.confidence>=E},swing_trade_check:{confidence:w.confidence,min_confidence:80,meets_threshold:w.confidence>=80,signal_type:w.signal_type,sends_all_signals:!0,should_alert:w.confidence>=80}},message:S?`✅ Alerts sent: ${b.join(", ")}`:"⚪ No alerts sent (signals below confidence threshold)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});G.get("/api/test/auto-fetch-settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings 
      WHERE setting_key IN ('twelve_data_api_key', 'telegram_bot_token', 'telegram_chat_id')
    ...
    `).first();if(!((o==null?void 0:o.setting_value)==="1"||(o==null?void 0:o.setting_value)==="true"))return console.log("[AI-AUTO-SCAN] Disabled in settings"),e.json({success:!0,message:"AI auto-scan is disabled",ai_scan_enabled:!1});const l=await((n=(s=e.env.app)==null?void 0:s.fetch)==null?void 0:n.call(s,new Request(new URL("/api/ai/market-analysis",e.req.url).toString(),{method:"POST"})));if(l){const r=await l.json();return console.log("[AI-AUTO-SCAN] Analysis complete:",r.success?"Success":"Failed"),e.json({success:!0,ai_scan_enabled:!0,analysis:r,message:(a=r.analysis)!=null&&a.telegram_sent?"🤖 AI analysis complete - Telegram alert sent":"🤖 AI analysis complete - No alert (confidence < 65% or HOLD)"})}return e.json({success:!1,error:"Failed to run AI analysis"},500)}catch(o){return console.error("[AI-AUTO-SCAN] Error:",o),e.json({success:!1,error:o.message},500)}});G.get("/api/cron/hedge-fund",async e=>{var s,n,a,o,i,l,r,d,c,p;const t=Date.now();try{console.log("[HEDGE-FUND-CRON] Starting hedge fund analysis");const _=await fetch(`${e.req.url.replace("/api/cron/hedge-fund","/api/signals/enhanced/enhanced")}`,{method:"POST",headers:{"Content-Type":"application/json"}});if(!_.ok)throw new Error(`Enhanced endpoint returned ${_.status}`);const m=await _.json();if(!m.success)return e.json({success:!1,error:m.error||"Enhanced signal generation failed",execution_time_ms:Date.now()-t});const u=m.day_trade,g=m.swing_trade,h=(u==null?void 0:u.enhanced_confidence)>=80||(g==null?void 0:g.enhanced_confidence)>=80;console.log("[HEDGE-FUND-CRON] Signal confidence:",{day:u==null?void 0:u.enhanced_confidence,swing:g==null?void 0:g.enhanced_confidence,shouldAlert:h});let f=!1;if(h){const{DB:w}=e.env,E=await w.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),S={};for(const b of E.results||[])S[b.setting_key]=b.setting_value;if(S.telegram_bot_token&&S.telegram_chat_id){const b=`
...
🌐 Dashboard: ${e.req.url.replace("/api/cron/hedge-fund","")}
    ...
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",o=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let i=0;const l={};for(const r of o){const d=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${r.interval}&apikey=${n}&outputsize=${r.outputsize}`,p=await(await fetch(d)).json();if(p.code&&p.status==="error"){l[r.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[r.dbKey]={success:!1,error:"No data",count:0};continue}const _=p.values;let m=0;const u=[];for(const g of _){const h={timestamp:g.datetime,open:parseFloat(g.open)||0,high:parseFloat(g.high)||0,low:parseFloat(g.low)||0,close:parseFloat(g.close)||0,volume:0};u.push(h),await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(r=>({timestamp:r.timestamp,open:r.open,high:r.high,low:r.low,close:r.close,volume:r.volume})),a=pe(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const o=n[n.length-1].close,i=le(o,a,"day_trade"),l=le(o,a,"swing_trade");return e.json({success:!0,signals:{day_trade:i,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Jt),o=["5m","15m","1h","4h","daily"],i={};for(const b of o){const k=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const d=r.close,c=s(i,d),p=i["1h"],_=le(d,p,"day_trade"),m=le(d,p,"swing_trade"),u=n(_.signal_type,c),g=n(m.signal_type,c),h={..._,base_confidence:_.confidence,mtf_confidence:u.confidence,final_confidence:Math.min(95,u.confidence),isValid:u.isValid,mtf_reason:u.reason,alignment_score:c.score,alignment_type:c.type,reason:`${_.reason}, MTF: ${u.reason}`},f={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:c.score,alignment_type:c.type,reason:`${m.reason}, MTF: ${g.reason}`},y=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),w={};for(const b of y.results||[])w[b.setting_key]=b.setting_value;let E=!1,S=[];w.telegram_bot_token&&w.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await z({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...h,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(S.push("day_trade"),E=!0),await new Promise(b=>setTimeout(b,1e3)),f.isValid&&f.signal_type!=="HOLD"&&await z({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...f,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(S.push("swing_trade"),E=!0));for(const b of[h,f])b.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(b.signal_type,b.trading_style,b.price,b.stop_loss,b.take_profit_1,b.take_profit_2,b.take_profit_3,b.base_confidence,b.mtf_confidence,b.final_confidence,b.alignment_score,b.alignment_type,b.reason,E?1:0).run();return e.json({success:!0,signals:{day_trade:h,swing_trade:f},alignment:c,alignment_report:a(c),telegram_sent:E,sent_to_telegram:S,available_timeframes:Object.keys(i)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});G.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('twelve_data_api_key')
    `).all();let n="";for(const E of s.results||[])E.setting_key==="twelve_data_api_key"&&(n=E.setting_value);let a,o=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const E=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,b=await(await fetch(E)).json();b.values&&b.values.length>=50?(a=b.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open)||0,high:parseFloat(k.high)||0,low:parseFloat(k.low)||0,close:parseFloat(k.close)||0,volume:parseFloat(k.volume)||0})),o=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(E){console.error("[GENERATE-NOW] API fetch failed:",E.message)}}if(!a||a.length===0){console.log("[GENERATE-NOW] Using database data (may be stale)");const E=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!E.results||E.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});a=E.results.reverse().map(S=>({timestamp:S.timestamp,open:S.open,high:S.high,low:S.low,close:S.close,volume:S.volume}))}const i=pe(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"});let l=a[a.length-1].close,r=!1;if(n&&n!=="your_api_key_here")try{console.log("[GENERATE-NOW] Fetching real-time price...");const S=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${n}`,{signal:AbortSignal.timeout(5e3)})).json();if(S.price){const b=parseFloat(S.price),k=l,D=Math.abs(b-k)/b*100;console.log(`[GENERATE-NOW] Real-time: $${b}, Last candle: $${k}, Diff: ${D.toFixed(2)}%`),l=b,r=!0}}catch(E){console.log("[GENERATE-NOW] Real-time price fetch failed, using candle close:",E.message)}const d=le(l,i,"day_trade"),c=le(l,i,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",d.signal_type,"Swing:",c.signal_type);const p=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),_={};for(const E of p.results||[])_[E.setting_key]=E.setting_value;let m=!1,u=[];const g=a.slice(-20),h=g.map(E=>E.high).sort((E,S)=>S-E),f=g.map(E=>E.low).sort((E,S)=>E-S),y=h.length>=3?[h[0],h[1],h[2]]:h.length>=1?[h[0]]:[],w=f.length>=3?[f[0],f[1],f[2]]:f.length>=1?[f[0]]:[];console.log("[GENERATE-NOW] S/R calculated - Resistance:",y,"Support:",w),_.telegram_bot_token&&_.telegram_chat_id&&(await z({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},lt({...d,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(u.push("day_trade"),m=!0),await new Promise(b=>setTimeout(b,1e3)),await z({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},lt({...c,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(u.push("swing_trade"),m=!0));for(const E of[d,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(n).first();if(!u)return e.json({success:!1,error:"Account not found"},404);const g=new Date().toISOString().split("T")[0],h=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,g).all(),{checkDailyLossLimit:f}=await Promise.resolve().then(()=>mt),y=f(u,h.results);if(y.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${y.current_loss_pct}% (max ${u.max_daily_loss_pct}%)`},400);const w=c*o,E=await t.prepare(`
      INSERT INTO trades (
    ...
    `).first(),m=(_==null?void 0:_.close)||0,g=((await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 20
    `).all()).results||[]).map(A=>({timestamp:A.timestamp,open:A.open,high:A.high,low:A.low,close:A.close,volume:A.volume||1})).reverse(),h=r(p,m),f=p["1h"],y=ze(m,f,g,"day_trade"),w=ze(m,f,g,"swing_trade"),E=d(y.signal_type,h),S=d(w.signal_type,h),b={...y,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:h.score,alignment_type:h.type},k={...w,final_confidence:Math.min(95,S.confidence),isValid:S.isValid,mtf_reason:S.reason,alignment_score:h.score,alignment_type:h.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:b,swingTrade:k,alignment:h},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const v=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),D=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:R}=await Promise.resolve().then(()=>mt),I=R(v,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},D.results),U=R(v,{entry_price:k.price,stop_loss:k.stop_loss,take_profit_1:k.take_profit_1,take_profit_2:k.take_profit_2,take_profit_3:k.take_profit_3,confidence:k.final_confidence,signal_type:k.signal_type,trading_style:k.trading_style},D.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:I,swingPosition:U},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const j=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),L={};for(const A of j.results||[])L[A.setting_key]=A.setting_value;let O=!1;if(L.telegram_bot_token&&L.telegram_chat_id){const A=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 20
      `).all();let B=[],P=[];if(A.results&&A.results.length>=20){const V=A.results.map(ee=>ee.high).sort((ee,te)=>te-ee),Q=A.results.map(ee=>ee.low).sort((ee,te)=>ee-te);B=V.slice(0,3),P=Q.slice(0,3)}const N=`
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();O=await z({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},N)}if(a.steps[3].status=O?"completed":"failed",a.steps[3].data={telegramSent:O},b.isValid||k.isValid)for(const A of[b,k])A.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),p=(c==null?void 0:c.close)||0,m=((await t.prepare(`
      SELECT timestamp, open, high, low, close, volume FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 20
    `).all()).results||[]).map(L=>({timestamp:L.timestamp,open:L.open,high:L.high,low:L.low,close:L.close,volume:L.volume||1})).reverse(),u=i(d,p),g=d["1h"],h=ze(p,g,m,"day_trade"),f=ze(p,g,m,"swing_trade"),y=l(h.signal_type,u),w=l(f.signal_type,u),E={...h,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:u.score,alignment_type:u.type},S={...f,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:u.score,alignment_type:u.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:E,swingTrade:S,alignment:u},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const b=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),k=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:v}=await Promise.resolve().then(()=>mt),D=v(b,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},k.results),R=v(b,{entry_price:S.price,stop_loss:S.stop_loss,take_profit_1:S.take_profit_1,take_profit_2:S.take_profit_2,take_profit_3:S.take_profit_3,confidence:S.final_confidence,signal_type:S.signal_type,trading_style:S.trading_style},k.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:D,swingPosition:R},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const I=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),U={};for(const L of I.results||[])U[L.setting_key]=L.setting_value;let j=!1;if(U.telegram_bot_token&&U.telegram_chat_id){const L=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 20
      `).all();let O=[],A=[];if(L.results&&L.results.length>=20){const F=L.results.map(Q=>Q.high).sort((Q,ee)=>ee-Q),V=L.results.map(Q=>Q.low).sort((Q,ee)=>Q-ee);O=F.slice(0,3),A=V.slice(0,3)}const B=`
🤖 *AUTOMATED DAILY ANALYSIS*
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim(),{sendTelegramMessage:P}=await Promise.resolve().then(()=>Gs);j=await P({botToken:U.telegram_bot_token,chatId:U.telegram_chat_id},B)}if(a.steps[3].status=j?"completed":"failed",a.steps[3].data={telegramSent:j},E.isValid||S.isValid)for(const L of[E,S])L.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
             alignment_score, alignment_type, reason, telegram_sent)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(L.signal_type,L.trading_style,L.price,L.stop_loss,L.take_profit_1,L.take_profit_2,L.take_profit_3,L.confidence,L.final_confidence,L.final_confidence,L.alignment_score,L.alignment_type,L.reason,j?1:0).run();return e.json({success:!0,message:"Daily analysis completed",results:a,signals:{day_trade:E,swing_trade:S},positions:{day_trade:D,swing_trade:R},alignment:u,telegram_sent:j})}catch(s){return console.error("[ANALYZE-NOTIFY-GET] Error:",s),e.json({success:!1,error:s.message,stack:s.stack},500)}});const us=new _e,Ei=Object.assign({"/src/index.tsx":G});let fn=!1;for(const[,e]of Object.entries(Ei))e&&(us.all("*",t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),us.notFound(t=>{let s;try{s=t.executionCtx}catch{}return e.fetch(t.req.raw,t.env,s)}),fn=!0);if(!fn)throw new Error("Can't import modules from ['/src/index.ts','/src/index.tsx','/app/server.ts']");const bi=["inflation","rate cut","dovish","stimulus","quantitative easing","qe","recession","crisis","uncertainty","safe haven","hedge","geopolitical","war","tension","dollar weakness","dollar decline","fed pivot","lower rates","monetary easing","gold rally","gold surge","gold demand","central bank buying","reserve accumulation","currency devaluation"],wi=["rate hike","hawkish","strong dollar","dollar strength","tightening","rate increase","yield rise","bond surge","economic growth","recovery","gold decline","gold drop","sell gold","gold weakness","profit taking","risk on","stock rally","equity surge","fed hawkish","inflation cooling"];function hn(e){const t=e.toLowerCase();let s=0,n=0;for(const l of bi)t.includes(l)&&(s+=1,["inflation","rate cut","crisis","war"].includes(l)&&(s+=1));for(const l of wi)t.includes(l)&&(n+=1,["rate hike","hawkish","strong dollar"].includes(l)&&(n+=1));const a=s+n;let o=0;a>0&&(o=(s-n)/a*100);let i="neutral";return o>20?i="bullish":o<-20&&(i="bearish"),{sentiment:i,score:o}}function Ti(e){let t=0,s=0,n=0,a=0;const o=e.map(r=>{const d=`${r.title} ${r.description||""}`,c=hn(d);return c.sentiment==="bullish"?t++:c.sentiment==="bearish"?s++:n++,a+=c.score,{...r,sentiment:c.sentiment,score:c.score}}),i=e.length>0?a/e.length:0;let l="neutral";return i>20?l="bullish":i<-20&&(l="bearish"),{overall:l,score:Math.round(i),bullishCount:t,bearishCount:s,neutralCount:n,articles:o.slice(0,10)}}async function Si(e){if(!e||e==="your_key_here")return console.log("No NewsAPI key configured, skipping news fetch"),[];try{const s=`https://newsapi.org/v2/everything?q=${encodeURIComponent("gold AND (federal reserve OR inflation OR dollar OR interest rate)")}&language=en&sortBy=publishedAt&pageSize=20&apiKey=${e}`,a=await(await fetch(s)).json();return a.status!=="ok"?(console.error("NewsAPI error:",a.message),[]):a.articles.map(o=>({title:o.title,description:o.description,url:o.url,publishedAt:o.publishedAt,source:o.source.name}))}catch(t){return console.error("Error fetching news:",t),[]}}async function vi(){const e=new Date,t=new Date(e.getTime()+10080*60*1e3);return[{title:"Federal Reserve Interest Rate Decision",date:"2025-01-29",impact:"high",currency:"USD"},{title:"US CPI (Consumer Price Index)",date:"2025-01-15",impact:"high",currency:"USD"},{title:"US Non-Farm Payrolls (NFP)",date:"2025-01-10",impact:"high",currency:"USD"},{title:"US PPI (Producer Price Index)",date:"2025-01-16",impact:"medium",currency:"USD"},{title:"Fed Chair Powell Speech",date:"2025-01-12",impact:"high",currency:"USD"}].filter(n=>{const a=new Date(n.date);return a>=e&&a<=t})}const yn=Object.freeze(Object.defineProperty({__proto__:null,analyzeNewsSentiment:Ti,analyzeSentiment:hn,fetchGoldNews:Si,getEconomicEvents:vi},Symbol.toStringTag,{value:"Module"}));export{us as default};
