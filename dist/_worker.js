var En=Object.defineProperty;var es=e=>{throw TypeError(e)};var bn=(e,t,s)=>t in e?En(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var Y=(e,t,s)=>bn(e,typeof t!="symbol"?t+"":t,s),Bt=(e,t,s)=>t.has(e)||es("Cannot "+s);var v=(e,t,s)=>(Bt(e,t,"read from private field"),s?s.call(e):t.get(e)),q=(e,t,s)=>t.has(e)?es("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),W=(e,t,s,n)=>(Bt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),Z=(e,t,s)=>(Bt(e,t,"access private method"),s);var ts=(e,t,s,n)=>({set _(a){W(e,t,a,s)},get _(){return v(e,t,n)}});var ss=(e,t,s)=>(n,a)=>{let i=-1;return o(0);async function o(l){if(l<=i)throw new Error("next() called multiple times");i=l;let r,d=!1,c;if(e[l]?(c=e[l][0][0],n.req.routeIndex=l):c=l===e.length&&a||void 0,c)try{r=await c(n,()=>o(l+1))}catch(u){if(u instanceof Error&&t)n.error=u,r=await t(u,n),d=!0;else throw u}else n.finalized===!1&&s&&(r=await s(n));return r&&(n.finalized===!1||d)&&(n.res=r),n}},wn=Symbol(),vn=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,i=(e instanceof vs?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Tn(e,{all:s,dot:n}):{}};async function Tn(e,t){const s=await e.formData();return s?Sn(s,t):{}}function Sn(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?xn(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(kn(s,n,a),delete s[n])}),s}var xn=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},kn=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((i,o)=>{o===a.length-1?n[i]=s:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},hs=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},In=e=>{const{groups:t,path:s}=Ln(e),n=hs(s);return Rn(n,t)},Ln=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},Rn=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},Rt={},$n=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return Rt[n]||(s[2]?Rt[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Rt[n]=[e,s[1],!0]),Rt[n]}return null},Xt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},An=e=>Xt(e,decodeURI),ys=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),o=t.slice(s,i===-1?void 0:i);return An(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return t.slice(s,n)},Dn=e=>{const t=ys(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Qe=(e,t,...s)=>(s.length&&(t=Qe(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Es=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const i=a.replace("?","");n+="/"+i,s.push(n)}else n+="/"+a}),s.filter((a,i,o)=>o.indexOf(a)===i)},Pt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Xt(e,ws):e):e,bs=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const r=o+t.length+2,d=e.indexOf("&",r);return Pt(e.slice(r,d===-1?void 0:d))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const o=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>o&&o!==-1&&(l=-1);let r=e.slice(i+1,l===-1?o===-1?void 0:o:l);if(n&&(r=Pt(r)),i=o,r==="")continue;let d;l===-1?d="":(d=e.slice(l+1,o===-1?void 0:o),n&&(d=Pt(d))),s?(a[r]&&Array.isArray(a[r])||(a[r]=[]),a[r].push(d)):a[r]??(a[r]=d)}return t?a[t]:a},Nn=bs,Mn=(e,t)=>bs(e,t,!0),ws=decodeURIComponent,ns=e=>Xt(e,ws),tt,pe,Ie,Ts,Ss,qt,$e,us,vs=(us=class{constructor(e,t="/",s=[[]]){q(this,Ie);Y(this,"raw");q(this,tt);q(this,pe);Y(this,"routeIndex",0);Y(this,"path");Y(this,"bodyCache",{});q(this,$e,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,W(this,pe,s),W(this,tt,{})}param(e){return e?Z(this,Ie,Ts).call(this,e):Z(this,Ie,Ss).call(this)}query(e){return Nn(this.url,e)}queries(e){return Mn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await vn(this,e))}json(){return v(this,$e).call(this,"text").then(e=>JSON.parse(e))}text(){return v(this,$e).call(this,"text")}arrayBuffer(){return v(this,$e).call(this,"arrayBuffer")}blob(){return v(this,$e).call(this,"blob")}formData(){return v(this,$e).call(this,"formData")}addValidatedData(e,t){v(this,tt)[e]=t}valid(e){return v(this,tt)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[wn](){return v(this,pe)}get matchedRoutes(){return v(this,pe)[0].map(([[,e]])=>e)}get routePath(){return v(this,pe)[0].map(([[,e]])=>e)[this.routeIndex].path}},tt=new WeakMap,pe=new WeakMap,Ie=new WeakSet,Ts=function(e){const t=v(this,pe)[0][this.routeIndex][1][e],s=Z(this,Ie,qt).call(this,t);return s&&/\%/.test(s)?ns(s):s},Ss=function(){const e={},t=Object.keys(v(this,pe)[0][this.routeIndex][1]);for(const s of t){const n=Z(this,Ie,qt).call(this,v(this,pe)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?ns(n):n)}return e},qt=function(e){return v(this,pe)[1]?v(this,pe)[1][e]:e},$e=new WeakMap,us),On={Stringify:1},xs=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(r=>xs(r,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},Cn="text/plain; charset=UTF-8",jt=(e,t)=>({"Content-Type":e,...t}),Et,bt,Te,st,Se,ue,wt,nt,at,je,vt,Tt,Ae,Je,ms,Fn=(ms=class{constructor(e,t){q(this,Ae);q(this,Et);q(this,bt);Y(this,"env",{});q(this,Te);Y(this,"finalized",!1);Y(this,"error");q(this,st);q(this,Se);q(this,ue);q(this,wt);q(this,nt);q(this,at);q(this,je);q(this,vt);q(this,Tt);Y(this,"render",(...e)=>(v(this,nt)??W(this,nt,t=>this.html(t)),v(this,nt).call(this,...e)));Y(this,"setLayout",e=>W(this,wt,e));Y(this,"getLayout",()=>v(this,wt));Y(this,"setRenderer",e=>{W(this,nt,e)});Y(this,"header",(e,t,s)=>{this.finalized&&W(this,ue,new Response(v(this,ue).body,v(this,ue)));const n=v(this,ue)?v(this,ue).headers:v(this,je)??W(this,je,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});Y(this,"status",e=>{W(this,st,e)});Y(this,"set",(e,t)=>{v(this,Te)??W(this,Te,new Map),v(this,Te).set(e,t)});Y(this,"get",e=>v(this,Te)?v(this,Te).get(e):void 0);Y(this,"newResponse",(...e)=>Z(this,Ae,Je).call(this,...e));Y(this,"body",(e,t,s)=>Z(this,Ae,Je).call(this,e,t,s));Y(this,"text",(e,t,s)=>!v(this,je)&&!v(this,st)&&!t&&!s&&!this.finalized?new Response(e):Z(this,Ae,Je).call(this,e,t,jt(Cn,s)));Y(this,"json",(e,t,s)=>Z(this,Ae,Je).call(this,JSON.stringify(e),t,jt("application/json",s)));Y(this,"html",(e,t,s)=>{const n=a=>Z(this,Ae,Je).call(this,a,t,jt("text/html; charset=UTF-8",s));return typeof e=="object"?xs(e,On.Stringify,!1,{}).then(n):n(e)});Y(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});Y(this,"notFound",()=>(v(this,at)??W(this,at,()=>new Response),v(this,at).call(this,this)));W(this,Et,e),t&&(W(this,Se,t.executionCtx),this.env=t.env,W(this,at,t.notFoundHandler),W(this,Tt,t.path),W(this,vt,t.matchResult))}get req(){return v(this,bt)??W(this,bt,new vs(v(this,Et),v(this,Tt),v(this,vt))),v(this,bt)}get event(){if(v(this,Se)&&"respondWith"in v(this,Se))return v(this,Se);throw Error("This context has no FetchEvent")}get executionCtx(){if(v(this,Se))return v(this,Se);throw Error("This context has no ExecutionContext")}get res(){return v(this,ue)||W(this,ue,new Response(null,{headers:v(this,je)??W(this,je,new Headers)}))}set res(e){if(v(this,ue)&&e){e=new Response(e.body,e);for(const[t,s]of v(this,ue).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=v(this,ue).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}W(this,ue,e),this.finalized=!0}get var(){return v(this,Te)?Object.fromEntries(v(this,Te)):{}}},Et=new WeakMap,bt=new WeakMap,Te=new WeakMap,st=new WeakMap,Se=new WeakMap,ue=new WeakMap,wt=new WeakMap,nt=new WeakMap,at=new WeakMap,je=new WeakMap,vt=new WeakMap,Tt=new WeakMap,Ae=new WeakSet,Je=function(e,t,s){const n=v(this,ue)?new Headers(v(this,ue).headers):v(this,je)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of i)o.toLowerCase()==="set-cookie"?n.append(o,l):n.set(o,l)}if(s)for(const[i,o]of Object.entries(s))if(typeof o=="string")n.set(i,o);else{n.delete(i);for(const l of o)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??v(this,st);return new Response(e,{status:a,headers:n})},ms),ie="ALL",Un="all",Hn=["get","post","put","delete","options","patch"],ks="Can not add a route since the matcher is already built.",Is=class extends Error{},Bn="__COMPOSED_HANDLER",Pn=e=>e.text("404 Not Found",404),as=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},_e,oe,Ls,he,Be,$t,At,it,jn=(it=class{constructor(t={}){q(this,oe);Y(this,"get");Y(this,"post");Y(this,"put");Y(this,"delete");Y(this,"options");Y(this,"patch");Y(this,"all");Y(this,"on");Y(this,"use");Y(this,"router");Y(this,"getPath");Y(this,"_basePath","/");q(this,_e,"/");Y(this,"routes",[]);q(this,he,Pn);Y(this,"errorHandler",as);Y(this,"onError",t=>(this.errorHandler=t,this));Y(this,"notFound",t=>(W(this,he,t),this));Y(this,"fetch",(t,...s)=>Z(this,oe,At).call(this,t,s[1],s[0],t.method));Y(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Qe("/",t)}`,s),n,a)));Y(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(Z(this,oe,At).call(this,t.request,t,void 0,t.request.method))})});[...Hn,Un].forEach(i=>{this[i]=(o,...l)=>(typeof o=="string"?W(this,_e,o):Z(this,oe,Be).call(this,i,v(this,_e),o),l.forEach(r=>{Z(this,oe,Be).call(this,i,v(this,_e),r)}),this)}),this.on=(i,o,...l)=>{for(const r of[o].flat()){W(this,_e,r);for(const d of[i].flat())l.map(c=>{Z(this,oe,Be).call(this,d.toUpperCase(),v(this,_e),c)})}return this},this.use=(i,...o)=>(typeof i=="string"?W(this,_e,i):(W(this,_e,"*"),o.unshift(i)),o.forEach(l=>{Z(this,oe,Be).call(this,ie,v(this,_e),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ys:Dn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var o;let i;s.errorHandler===as?i=a.handler:(i=async(l,r)=>(await ss([],s.errorHandler)(l,()=>a.handler(l,r))).res,i[Bn]=a.handler),Z(o=n,oe,Be).call(o,a.method,a.path,i)}),this}basePath(t){const s=Z(this,oe,Ls).call(this);return s._basePath=Qe(this._basePath,t),s}mount(t,s,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=r=>r:a=n.replaceRequest));const o=i?r=>{const d=i(r);return Array.isArray(d)?d:[d]}:r=>{let d;try{d=r.executionCtx}catch{}return[r.env,d]};a||(a=(()=>{const r=Qe(this._basePath,t),d=r==="/"?0:r.length;return c=>{const u=new URL(c.url);return u.pathname=u.pathname.slice(d)||"/",new Request(u,c)}})());const l=async(r,d)=>{const c=await s(a(r.req.raw),...o(r));if(c)return c;await d()};return Z(this,oe,Be).call(this,ie,Qe(t,"*"),l),this}},_e=new WeakMap,oe=new WeakSet,Ls=function(){const t=new it({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,W(t,he,v(this,he)),t.routes=this.routes,t},he=new WeakMap,Be=function(t,s,n){t=t.toUpperCase(),s=Qe(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},$t=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},At=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await Z(this,oe,At).call(this,t,s,n,"GET")))();const i=this.getPath(t,{env:n}),o=this.router.match(a,i),l=new Fn(t,{path:i,matchResult:o,env:n,executionCtx:s,notFoundHandler:v(this,he)});if(o[0].length===1){let d;try{d=o[0][0][0][0](l,async()=>{l.res=await v(this,he).call(this,l)})}catch(c){return Z(this,oe,$t).call(this,c,l)}return d instanceof Promise?d.then(c=>c||(l.finalized?l.res:v(this,he).call(this,l))).catch(c=>Z(this,oe,$t).call(this,c,l)):d??v(this,he).call(this,l)}const r=ss(o[0],this.errorHandler,v(this,he));return(async()=>{try{const d=await r(l);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return Z(this,oe,$t).call(this,d,l)}})()},it),Rs=[];function Wn(e,t){const s=this.buildAllMatchers(),n=((a,i)=>{const o=s[a]||s[ie],l=o[2][i];if(l)return l;const r=i.match(o[0]);if(!r)return[[],Rs];const d=r.indexOf("",1);return[o[1][d],r]});return this.match=n,n(e,t)}var Mt="[^/]+",_t=".*",ht="(?:|/.*)",et=Symbol(),Yn=new Set(".\\+*[^]$()");function Gn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===_t||e===ht?1:t===_t||t===ht?-1:e===Mt?1:t===Mt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var We,Ye,ye,qe,Vn=(qe=class{constructor(){q(this,We);q(this,Ye);q(this,ye,Object.create(null))}insert(t,s,n,a,i){if(t.length===0){if(v(this,We)!==void 0)throw et;if(i)return;W(this,We,s);return}const[o,...l]=t,r=o==="*"?l.length===0?["","",_t]:["","",Mt]:o==="/*"?["","",ht]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(r){const c=r[1];let u=r[2]||Mt;if(c&&r[2]&&(u===".*"||(u=u.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(u))))throw et;if(d=v(this,ye)[u],!d){if(Object.keys(v(this,ye)).some(f=>f!==_t&&f!==ht))throw et;if(i)return;d=v(this,ye)[u]=new qe,c!==""&&W(d,Ye,a.varIndex++)}!i&&c!==""&&n.push([c,v(d,Ye)])}else if(d=v(this,ye)[o],!d){if(Object.keys(v(this,ye)).some(c=>c.length>1&&c!==_t&&c!==ht))throw et;if(i)return;d=v(this,ye)[o]=new qe}d.insert(l,s,n,a,i)}buildRegExpStr(){const s=Object.keys(v(this,ye)).sort(Gn).map(n=>{const a=v(this,ye)[n];return(typeof v(a,Ye)=="number"?`(${n})@${v(a,Ye)}`:Yn.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof v(this,We)=="number"&&s.unshift(`#${v(this,We)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},We=new WeakMap,Ye=new WeakMap,ye=new WeakMap,qe),Ct,St,ps,qn=(ps=class{constructor(){q(this,Ct,{varIndex:0});q(this,St,new Vn)}insert(e,t,s){const n=[],a=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,r=>{const d=`@\\${o}`;return a[o]=[d,r],o++,l=!0,d}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[l]=a[o];for(let r=i.length-1;r>=0;r--)if(i[r].indexOf(l)!==-1){i[r]=i[r].replace(l,a[o][1]);break}}return v(this,St).insert(i,t,n,v(this,Ct),s),n}buildRegExp(){let e=v(this,St).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,o)=>i!==void 0?(s[++t]=Number(i),"$()"):(o!==void 0&&(n[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Ct=new WeakMap,St=new WeakMap,ps),zn=[/^$/,[],Object.create(null)],Dt=Object.create(null);function $s(e){return Dt[e]??(Dt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Xn(){Dt=Object.create(null)}function Kn(e){var d;const t=new qn,s=[];if(e.length===0)return zn;const n=e.map(c=>[!/\*|\/:/.test(c[0]),...c]).sort(([c,u],[f,m])=>c?1:f?-1:u.length-m.length),a=Object.create(null);for(let c=0,u=-1,f=n.length;c<f;c++){const[m,p,g]=n[c];m?a[p]=[g.map(([_])=>[_,Object.create(null)]),Rs]:u++;let h;try{h=t.insert(p,u,m)}catch(_){throw _===et?new Is(p):_}m||(s[u]=g.map(([_,y])=>{const w=Object.create(null);for(y-=1;y>=0;y--){const[E,T]=h[y];w[E]=T}return[_,w]}))}const[i,o,l]=t.buildRegExp();for(let c=0,u=s.length;c<u;c++)for(let f=0,m=s[c].length;f<m;f++){const p=(d=s[c][f])==null?void 0:d[1];if(!p)continue;const g=Object.keys(p);for(let h=0,_=g.length;h<_;h++)p[g[h]]=l[p[g[h]]]}const r=[];for(const c in o)r[c]=s[o[c]];return[i,r,a]}function Ze(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if($s(s).test(t))return[...e[s]]}}var De,Ne,Ft,As,gs,Zn=(gs=class{constructor(){q(this,Ft);Y(this,"name","RegExpRouter");q(this,De);q(this,Ne);Y(this,"match",Wn);W(this,De,{[ie]:Object.create(null)}),W(this,Ne,{[ie]:Object.create(null)})}add(e,t,s){var l;const n=v(this,De),a=v(this,Ne);if(!n||!a)throw new Error(ks);n[e]||[n,a].forEach(r=>{r[e]=Object.create(null),Object.keys(r[ie]).forEach(d=>{r[e][d]=[...r[ie][d]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const r=$s(t);e===ie?Object.keys(n).forEach(d=>{var c;(c=n[d])[t]||(c[t]=Ze(n[d],t)||Ze(n[ie],t)||[])}):(l=n[e])[t]||(l[t]=Ze(n[e],t)||Ze(n[ie],t)||[]),Object.keys(n).forEach(d=>{(e===ie||e===d)&&Object.keys(n[d]).forEach(c=>{r.test(c)&&n[d][c].push([s,i])})}),Object.keys(a).forEach(d=>{(e===ie||e===d)&&Object.keys(a[d]).forEach(c=>r.test(c)&&a[d][c].push([s,i]))});return}const o=Es(t)||[t];for(let r=0,d=o.length;r<d;r++){const c=o[r];Object.keys(a).forEach(u=>{var f;(e===ie||e===u)&&((f=a[u])[c]||(f[c]=[...Ze(n[u],c)||Ze(n[ie],c)||[]]),a[u][c].push([s,i-d+r+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(v(this,Ne)).concat(Object.keys(v(this,De))).forEach(t=>{e[t]||(e[t]=Z(this,Ft,As).call(this,t))}),W(this,De,W(this,Ne,void 0)),Xn(),e}},De=new WeakMap,Ne=new WeakMap,Ft=new WeakSet,As=function(e){const t=[];let s=e===ie;return[v(this,De),v(this,Ne)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==ie&&t.push(...Object.keys(n[ie]).map(i=>[i,n[ie][i]]))}),s?Kn(t):null},gs),Me,xe,fs,Qn=(fs=class{constructor(e){Y(this,"name","SmartRouter");q(this,Me,[]);q(this,xe,[]);W(this,Me,e.routers)}add(e,t,s){if(!v(this,xe))throw new Error(ks);v(this,xe).push([e,t,s])}match(e,t){if(!v(this,xe))throw new Error("Fatal error");const s=v(this,Me),n=v(this,xe),a=s.length;let i=0,o;for(;i<a;i++){const l=s[i];try{for(let r=0,d=n.length;r<d;r++)l.add(...n[r]);o=l.match(e,t)}catch(r){if(r instanceof Is)continue;throw r}this.match=l.match.bind(l),W(this,Me,[l]),W(this,xe,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(v(this,xe)||v(this,Me).length!==1)throw new Error("No active router has been determined yet.");return v(this,Me)[0]}},Me=new WeakMap,xe=new WeakMap,fs),ft=Object.create(null),Oe,ce,Ge,ot,re,ke,Pe,rt,Jn=(rt=class{constructor(t,s,n){q(this,ke);q(this,Oe);q(this,ce);q(this,Ge);q(this,ot,0);q(this,re,ft);if(W(this,ce,n||Object.create(null)),W(this,Oe,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},W(this,Oe,[a])}W(this,Ge,[])}insert(t,s,n){W(this,ot,++ts(this,ot)._);let a=this;const i=In(s),o=[];for(let l=0,r=i.length;l<r;l++){const d=i[l],c=i[l+1],u=$n(d,c),f=Array.isArray(u)?u[0]:d;if(f in v(a,ce)){a=v(a,ce)[f],u&&o.push(u[1]);continue}v(a,ce)[f]=new rt,u&&(v(a,Ge).push(u),o.push(u[1])),a=v(a,ce)[f]}return v(a,Oe).push({[t]:{handler:n,possibleKeys:o.filter((l,r,d)=>d.indexOf(l)===r),score:v(this,ot)}}),a}search(t,s){var r;const n=[];W(this,re,ft);let i=[this];const o=hs(s),l=[];for(let d=0,c=o.length;d<c;d++){const u=o[d],f=d===c-1,m=[];for(let p=0,g=i.length;p<g;p++){const h=i[p],_=v(h,ce)[u];_&&(W(_,re,v(h,re)),f?(v(_,ce)["*"]&&n.push(...Z(this,ke,Pe).call(this,v(_,ce)["*"],t,v(h,re))),n.push(...Z(this,ke,Pe).call(this,_,t,v(h,re)))):m.push(_));for(let y=0,w=v(h,Ge).length;y<w;y++){const E=v(h,Ge)[y],T=v(h,re)===ft?{}:{...v(h,re)};if(E==="*"){const R=v(h,ce)["*"];R&&(n.push(...Z(this,ke,Pe).call(this,R,t,v(h,re))),W(R,re,T),m.push(R));continue}const[b,k,S]=E;if(!u&&!(S instanceof RegExp))continue;const D=v(h,ce)[b],I=o.slice(d).join("/");if(S instanceof RegExp){const R=S.exec(I);if(R){if(T[k]=R[0],n.push(...Z(this,ke,Pe).call(this,D,t,v(h,re),T)),Object.keys(v(D,ce)).length){W(D,re,T);const U=((r=R[0].match(/\//))==null?void 0:r.length)??0;(l[U]||(l[U]=[])).push(D)}continue}}(S===!0||S.test(u))&&(T[k]=u,f?(n.push(...Z(this,ke,Pe).call(this,D,t,T,v(h,re))),v(D,ce)["*"]&&n.push(...Z(this,ke,Pe).call(this,v(D,ce)["*"],t,T,v(h,re)))):(W(D,re,T),m.push(D)))}}i=m.concat(l.shift()??[])}return n.length>1&&n.sort((d,c)=>d.score-c.score),[n.map(({handler:d,params:c})=>[d,c])]}},Oe=new WeakMap,ce=new WeakMap,Ge=new WeakMap,ot=new WeakMap,re=new WeakMap,ke=new WeakSet,Pe=function(t,s,n,a){const i=[];for(let o=0,l=v(t,Oe).length;o<l;o++){const r=v(t,Oe)[o],d=r[s]||r[ie],c={};if(d!==void 0&&(d.params=Object.create(null),i.push(d),n!==ft||a&&a!==ft))for(let u=0,f=d.possibleKeys.length;u<f;u++){const m=d.possibleKeys[u],p=c[d.score];d.params[m]=a!=null&&a[m]&&!p?a[m]:n[m]??(a==null?void 0:a[m]),c[d.score]=!0}}return i},rt),Ve,_s,ea=(_s=class{constructor(){Y(this,"name","TrieRouter");q(this,Ve);W(this,Ve,new Jn)}add(e,t,s){const n=Es(t);if(n){for(let a=0,i=n.length;a<i;a++)v(this,Ve).insert(e,n[a],s);return}v(this,Ve).insert(e,t,s)}match(e,t){return v(this,Ve).search(e,t)}},Ve=new WeakMap,_s),be=class extends jn{constructor(e={}){super(e),this.router=e.router??new Qn({routers:[new Zn,new ea]})}},ta=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:o=>i===o?o:null:typeof i=="function"?i:o=>i.includes(o)?o:null)(s.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(o,l){var c;function r(u,f){o.res.headers.set(u,f)}const d=await n(o.req.header("origin")||"",o);if(d&&r("Access-Control-Allow-Origin",d),s.credentials&&r("Access-Control-Allow-Credentials","true"),(c=s.exposeHeaders)!=null&&c.length&&r("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&r("Vary","Origin"),s.maxAge!=null&&r("Access-Control-Max-Age",s.maxAge.toString());const u=await a(o.req.header("origin")||"",o);u.length&&r("Access-Control-Allow-Methods",u.join(","));let f=s.allowHeaders;if(!(f!=null&&f.length)){const m=o.req.header("Access-Control-Request-Headers");m&&(f=m.split(/\s*,\s*/))}return f!=null&&f.length&&(r("Access-Control-Allow-Headers",f.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Kt(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=sa(e),s=na(),n=aa(e,s.session),a=ia(t,s.session),i=oa(t,s),o=ra(t,s,n,i),l=la(o,t,s,n),r=ca(o);return{liquidity_score:Math.round(o),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(i),optimal_for_trading:o>=70&&l.length===0,warnings:l,recommendation:r}}function sa(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((d,c)=>d+(c.volume||1),0)/e.length,a=t.reduce((d,c)=>d+(c.volume||1),0)/t.length,i=s.reduce((d,c)=>d+(c.volume||1),0)/s.length,o=a/n;let l;a>i*1.2?l="INCREASING":a<i*.8?l="DECREASING":l="STABLE";const r=Math.min(100,o*100);return{avg_volume:n,current_volume:a,volume_ratio:o,volume_spike:o>2,volume_drought:o<.5,trend:l,percentile:r}}function na(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,i;return n>=780&&n<960?(a="OVERLAP",i="HIGH"):n>=480&&n<780?(a="LONDON",i="HIGH"):n>=960&&n<1320?(a="NEW_YORK",i="HIGH"):n>=0&&n<480?(a="ASIA",i="MEDIUM"):(a="OFF_HOURS",i="LOW"),{zone:i,session:a}}function aa(e,t){const s=e.slice(-20);let n=0;for(const c of s){const u=c.high-c.low;n+=u}const a=n/s.length,i=s[s.length-1].close,o=a/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const r=1+o*2,d=l*r;return{spread_pips:Math.round(d)}}function ia(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*i}function oa(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function ra(e,t,s,n){const a=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,o=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+i+o+l}function la(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function ca(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}function Ce(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function yt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Ce(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Ds(e,t=14){if(e.length<t+1)return 50;const s=[];for(let r=1;r<e.length;r++)s.push(e[r]-e[r-1]);let n=0,a=0;for(let r=0;r<t;r++)s[r]>0?n+=s[r]:a+=Math.abs(s[r]);let i=n/t,o=a/t;for(let r=t;r<s.length;r++){const d=s[r];i=(i*(t-1)+(d>0?d:0))/t,o=(o*(t-1)+(d<0?Math.abs(d):0))/t}return o===0?100:100-100/(1+i/o)}function Ns(e){const t=yt(e,12),s=yt(e,26),n=t-s,a=n*.9,i=n-a;return{macd:n,signal:a,histogram:i}}function Ms(e,t=20,s=2){const n=Ce(e,t),i=e.slice(-t).reduce((l,r)=>l+Math.pow(r-n,2),0)/t,o=Math.sqrt(i);return{upper:n+o*s,middle:n,lower:n-o*s}}function Os(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const o=e[i].high,l=e[i].low,r=e[i-1].close,d=Math.max(o-l,Math.abs(o-r),Math.abs(l-r));s.push(d)}const n=Ce(s,t);return Math.max(n,10)}function Cs(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(u=>u.high),i=n.map(u=>u.low),o=e[e.length-1].close,l=Math.max(...a),r=Math.min(...i),d=(o-r)/(l-r)*100;return{k:d,d}}function Fs(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let d=1;d<Math.min(t+1,e.length);d++){const c=e[d].high,u=e[d].low,f=e[d-1].high,m=e[d-1].low,p=e[d-1].close,g=c-f,h=m-u;g>h&&g>0&&(s+=g),h>g&&h>0&&(n+=h),a+=Math.max(c-u,Math.abs(c-p),Math.abs(u-p))}const i=a>0?s/a*100:0,o=a>0?n/a*100:0;return{adx:i+o>0?Math.abs(i-o)/(i+o)*100:0,plusDI:i,minusDI:o}}function Us(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(_=>_.high)),a=Math.min(...s.map(_=>_.low)),i=(n+a)/2,o=Math.min(26,e.length),l=e.slice(-o),r=Math.max(...l.map(_=>_.high)),d=Math.min(...l.map(_=>_.low)),c=(r+d)/2,u=(i+c)/2,f=Math.min(52,e.length),m=e.slice(-f),p=Math.max(...m.map(_=>_.high)),g=Math.min(...m.map(_=>_.low)),h=(p+g)/2;return{tenkan:i,kijun:c,senkouA:u,senkouB:h}}function Hs(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Bs(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,i=n.volume||1;t+=a*i,s+=i}return s>0?t/s:e[e.length-1].close}function Ps(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(r=>r.high),a=s.map(r=>r.low),i=Math.max(...n),o=Math.min(...a),l=i-o;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:o}}function Ee(e){if(e.length<50)return null;const t=e.map(c=>c.close),s=Ns(t),n=Ms(t),a=Cs(e,14,3),i=Fs(e,14),o=Us(e),l=Hs(e),r=Bs(e),d=Ps(e,50);return{rsi_14:Ds(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Ce(t,20),sma_50:Ce(t,50),sma_200:e.length>=200?Ce(t,200):Ce(t,Math.min(100,e.length)),ema_12:yt(t,12),ema_26:yt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Os(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:o.tenkan,ichimoku_kijun:o.kijun,ichimoku_senkou_a:o.senkouA,ichimoku_senkou_b:o.senkouB,parabolic_sar:l,vwap:r,fib_382:d.fib_382,fib_500:d.fib_500,fib_618:d.fib_618}}function le(e,t,s){const n=[];let a=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:i+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(n.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),i+=2);const o=a+i,l=o>0?a/o*100:50;let r="HOLD",d=50;a>i+1?(r="BUY",d=Math.min(l,95)):i>a+1&&(r="SELL",d=Math.min(100-l,95)),t.adx>30&&Math.abs(a-i)>4&&(d=Math.min(d+5,95),n.push("High conviction signal"));const c=s==="day_trade"?1.5:2,u=s==="day_trade"?3:4,f=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,g=e*(1/100);let h,_,y,w;if(r==="BUY"){const E=e-t.atr_14*c;h=Math.max(E,e-g),_=e+t.atr_14*u,y=e+t.atr_14*f,w=e+t.atr_14*m}else if(r==="SELL"){const E=e+t.atr_14*c;h=Math.min(E,e+g),_=e-t.atr_14*u,y=e-t.atr_14*f,w=e-t.atr_14*m}else h=e,_=e,y=e,w=e;return{signal_type:r,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(_.toFixed(2)),take_profit_2:parseFloat(y.toFixed(2)),take_profit_3:parseFloat(w.toFixed(2)),confidence:parseFloat(d.toFixed(1)),reason:n.join(", ")}}function ze(e,t,s,n){const a=le(e,t,n),i=Kt(s);let o=a.confidence;i.liquidity_score<50?o*=.85:i.liquidity_score<60?o*=.9:i.liquidity_score<70&&(o*=.95),i.optimal_for_trading&&i.liquidity_score>=80&&(o=Math.min(o*1.05,95));let l=1;i.liquidity_score<40?l=.25:i.liquidity_score<50?l=.5:i.liquidity_score<60?l=.75:i.liquidity_score>=80&&i.optimal_for_trading&&(l=1);let r=a.reason;return i.session&&(r+=` | Session: ${i.session}`),i.warnings.length>0&&(r+=` | ⚠️ ${i.warnings[0]}`),{...a,confidence:parseFloat(o.toFixed(1)),reason:r,liquidity_score:i.liquidity_score,session:i.session,time_zone:i.time_of_day_zone,volume_trend:i.volume_trend,volume_percentile:i.volume_percentile,estimated_spread_pips:i.estimated_spread_pips,price_impact_bps:i.price_impact_bps,market_depth_score:i.market_depth_score,optimal_for_trading:i.optimal_for_trading,liquidity_warnings:JSON.stringify(i.warnings),liquidity_recommendation:i.recommendation,position_size_multiplier:l}}const is=Object.freeze(Object.defineProperty({__proto__:null,calculateADX:Fs,calculateATR:Os,calculateBollingerBands:Ms,calculateEMA:yt,calculateFibonacci:Ps,calculateIchimoku:Us,calculateIndicators:Ee,calculateMACD:Ns,calculateParabolicSAR:Hs,calculateRSI:Ds,calculateSMA:Ce,calculateStochastic:Cs,calculateVWAP:Bs,generateSignal:le,generateSignalWithLiquidity:ze},Symbol.toStringTag,{value:"Module"}));async function K(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function da(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function lt(e,t){const s=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",n=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";let a=`
...
`)}const Qt=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Zt,determineTrend:Ws,formatAlignmentReport:ua,validateMultiTimeframeSignal:zt},Symbol.toStringTag,{value:"Module"}));function os(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,o)=>i-o),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function ma(e,t){const s=os(e,.95),n=os(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function pa(e,t,s,n){const a=t-e,i=a/t*100;let o=0;for(let d=n.length-1;d>=0&&n[d].balance<t;d--)o++;const l=i<=s,r=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:o}}function ga(e,t,s=5){let n=0;const a=[];for(const r of e){const c=Math.abs(r.entry_price-r.stop_loss)*r.position_size,u=c/t*100;n+=c,a.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(c.toFixed(2)),risk_pct:parseFloat(u.toFixed(2))})}const i=n/t*100,o=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:o,available_risk:parseFloat(l.toFixed(2)),positions:a}}function fa(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),n=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&n.push({index:r,value:s[r]});if(n.length<3)return null;const a=n.slice(-3),[i,o,l]=a;if(o.value>i.value&&o.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const d=Math.min(i.value,l.value)*.995,c=d-(o.value-d);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:65}}return null}function _a(e){if(e.length<20)return null;const s=e.slice(-20).map(o=>o.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const r=s[s.length-1],d=n[n.length-1]-n[0],c=r+d;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function ha(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(d=>d.high),n=t.map(d=>d.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),o=n.slice(0,6),l=n.slice(-6),r=(Math.min(...l)-Math.min(...o))/Math.min(...o);if(i<.01&&r>.015){const d=Math.max(...s),c=t[t.length-1].close,u=d+(d-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat((c*.975).toFixed(2)),historical_win_rate:72}}return null}function ya(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),n=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&n.push({index:r,value:s[r]});if(n.length<2)return null;const a=n.slice(-2),[i,o]=a;if(Math.abs(i.value-o.value)/i.value<.015){const r=Math.max(...s.slice(i.index,o.index))*1.005,d=r+(r-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+o.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function Ea(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),r=Math.min(...l),d=(i-r)/i;if(d>.01&&d<.05){const c=n-a,u=i+c;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(u.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function ba(e){const t=[],s=fa(e);s&&t.push(s);const n=_a(e);n&&t.push(n);const a=ha(e);a&&t.push(a);const i=ya(e);i&&t.push(i);const o=Ea(e);o&&t.push(o);let l=0,r=0,d=0;for(const m of t)m.direction==="bullish"?(l++,d+=m.confidence):m.direction==="bearish"&&(r++,d+=m.confidence);let c="neutral",u=0;l>r?(c="bullish",u=Math.min(d/l/10,15)):r>l&&(c="bearish",u=Math.min(d/r/10,15));let f="";if(t.length===0)f="No significant chart patterns detected";else{const m=t.map(p=>p.pattern_type).join(", ");f=`Detected ${t.length} pattern(s): ${m}. Overall ${c} bias.`}return{patterns:t,overall_sentiment:c,confidence_boost:parseFloat(u.toFixed(1)),summary:f}}function wa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function va(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function Ta(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function Sa(e,t,s){const n=wa(t.atr_14,s),a=va(t,s),i=Ta(t,s);let o,l,r,d,c,u;const f=e.slice(-10),m=f.map(_=>_.volume||0),p=m.reduce((_,y)=>_+y,0)/m.length,h=(f[f.length-1].volume||0)>p*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(o="BREAKOUT",l=75,r=!0,d="Trend-following (aggressive entry)",c=1.3,u="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(o="BREAKDOWN",l=75,r=!1,d="Wait for stabilization",c=.5,u="Sharp breakdown in progress - avoid trading until dust settles"):(o="RANGING",l=50,r=!1,d="Wait for direction",c=.5,u="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(o="STRONG_UPTREND",l=90,r=!0,d="Trend-following (buy dips, trail stops)",c=1.5,u="Strong bullish trend confirmed - ideal for aggressive long positions"):(o="STRONG_DOWNTREND",l=90,r=!1,d="Stay in cash or short",c=.3,u="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(o="WEAK_UPTREND",l=70,r=!0,d="Trend-following (selective entries)",c=1,u="Moderate bullish trend - trade with normal position sizing"):(o="WEAK_DOWNTREND",l=70,r=!1,d="Reduce exposure or stay flat",c=.5,u="Moderate bearish trend - reduce risk or wait"):(o="RANGING",l=80,i>60?(r=!0,d="Mean-reversion (fade extremes)",c=.8,u="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,d="Wait for trend to develop",c=.5,u="Choppy market without clear opportunity - stay on sidelines")),{regime:o,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:r,recommended_strategy:d,risk_adjustment:c,description:u}}function xa(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let r=0;r<t;r++)s+=r,n+=e[r],a+=r*e[r],i+=r*r;const o=(t*a-s*n)/(t*i-s*s),l=(n-o*s)/t;return{slope:o,intercept:l}}function ka(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const o=(n[n.length-1]-n[n.length-10])/10;return i+o*s}function Ia(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const o=n.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+o}function La(e,t,s){const n=e[e.length-1].close;e.map(o=>o.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function Ra(e,t){const s=e.map(f=>f.close),n=s[s.length-1],a=10,i=s.slice(-a),o=Math.min(...i),l=Math.max(...i),r=i.map(f=>(f-o)/(l-o));let d={index:0,similarity:-1/0};for(let f=a;f<s.length-a-t;f++){const m=s.slice(f-a,f),p=Math.min(...m),g=Math.max(...m),h=m.map(w=>(w-p)/(g-p));let _=0;for(let w=0;w<a;w++)_+=Math.pow(r[w]-h[w],2);const y=-_;y>d.similarity&&(d={index:f,similarity:y})}const u=(s[d.index+t]-s[d.index])*(n/s[d.index]);return n+u}function Wt(e,t,s){const n=[],a=[],i=e.map(b=>b.close),{slope:o,intercept:l}=xa(i.slice(-20)),r=o*(i.length-1+s)+l;n.push(r),a.push(1);const d=ka(e,12,s);n.push(d),a.push(1.5);const c=Ia(e,s);n.push(c),a.push(1.2);const u=La(e,t,s);n.push(u),a.push(1.8);const f=Ra(e,s);n.push(f),a.push(1.3);const m=a.reduce((b,k)=>b+k,0),g=n.reduce((b,k,S)=>b+k*a[S],0)/m,h=n.reduce((b,k)=>b+k,0)/n.length,_=n.reduce((b,k)=>b+Math.pow(k-h,2),0)/n.length,y=Math.sqrt(_),w=e[e.length-1].close,E=1-y/w,T=Math.max(50,Math.min(95,E*100));return{prediction:g,confidence:T}}function $a(e,t){const s=e[e.length-1].close,n=[],a=Wt(e,t,1),i=a.prediction-s,o=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(o.toFixed(2)),method:"Ensemble (5 models)"});const l=Wt(e,t,4),r=l.prediction-s,d=r/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(d.toFixed(2)),method:"Ensemble (5 models)"});const c=Wt(e,t,24),u=c.prediction-s,f=u/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(c.prediction.toFixed(2)),confidence_interval_upper:parseFloat((c.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((c.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(c.confidence.toFixed(1)),direction:u>5?"UP":u<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(f.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(y=>y.direction==="UP").length,p=n.filter(y=>y.direction==="DOWN").length;let g,h=0;m>p?(g="BULLISH",h=Math.min(m*5,15)):p>m?(g="BEARISH",h=Math.min(p*5,15)):g="NEUTRAL";const _=`ML models predict ${g} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:g,confidence_boost:parseFloat(h.toFixed(1)),summary:_}}function Yt(e,t,s,n,a){const o=Math.abs(t-e)/s;let l;o<1?l=80:o<2?l=65:o<3?l=50:o<4?l=35:l=20;const r=(n-50)/10;l+=r;const d=(a-1)*5;return l+=d,Math.max(5,Math.min(95,l))}function Aa(e,t,s,n,a){const o=Math.abs(e-t)/s;let l;if(o<1?l=60:o<1.5?l=40:o<2?l=25:l=15,a==="BUY"){const r=(n-50)/10;l-=r}else{const r=(n-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function Da(e,t,s,n,a,i){const o=(s-e)*.5,l=(n-e)*.3,r=(a-e)*.2,d=t-e;return i.tp1/100*o+i.tp2/100*l+i.tp3/100*r+i.sl/100*d}function Na(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const o=s.slice(-50),l=[];for(let w=14;w<o.length;w++){const E=o.slice(w-14,w);let T=0;for(let b=1;b<E.length;b++){const k=Math.max(E[b].high-E[b].low,Math.abs(E[b].high-E[b-1].close),Math.abs(E[b].low-E[b-1].close));T+=k}l.push(T/14)}const r=l.reduce((w,E)=>w+E,0)/l.length,d=a/r,c=Yt(n,e.take_profit_1,a,i,d),u=Yt(n,e.take_profit_2,a,i,d),f=Yt(n,e.take_profit_3,a,i,d),m=Aa(n,e.stop_loss,a,i,e.signal_type),p=Da(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:c,tp2:u,tp3:f,sl:m}),h=(c+u+f)/3/m;let _;c>70&&p>5&&h>2?_="STRONG_TRADE":c>60&&p>0&&h>1.5?_="GOOD_TRADE":c>50&&p>-2?_="MARGINAL_TRADE":_="AVOID_TRADE";const y=`TP1 has ${c.toFixed(0)}% chance of hitting. Expected value: $${p.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${_.replace(/_/g," ")}`;return{tp1_probability:parseFloat(c.toFixed(1)),tp2_probability:parseFloat(u.toFixed(1)),tp3_probability:parseFloat(f.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(p.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:_,summary:y}}const Jt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ma(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Ut(e=30){const t=[],s=new Date;for(const a of Jt){const i=new Date(a),o=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));o>=0&&o<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),o=i.getFullYear(),l=i.getMonth(),r=i.getDate(),d=i.getDay();if(r===Ma(o,l)&&d===5){const c=i.toISOString().split("T")[0];t.push({date:c,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:c,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&d>=1&&d<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&d>=1&&d<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,o)=>i===o.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const o=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return o.getTime()-l.getTime()})}function xt(e=new Date,t=[]){const s=[...Ut(7),...t],n=s.filter(o=>new Date(`${o.date}T${o.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(o=>o.date===a&&o.impact==="high"),Jt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Oa(a)};new Date(e.getTime()+7200*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(o.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(o.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`);if(o.impact==="high"&&l>i&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${o.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Oa(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Nt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Ca(e){const t=e.toISOString().split("T")[0];return Jt.includes(t)?!0:Ut(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Fa(){const e=new Date().toISOString().split("T")[0];return Ut(7).filter(s=>s.date===e)}function Ys(e=new Date){const t=xt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const Gs=new be;Gs.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const B of["5m","15m","1h","4h","daily"]){const C=await t.prepare(`
    ...
    `).first(),d=(r==null?void 0:r.setting_value)||"70140f57bea54c5e90768de696487d8f";try{console.log("[ENHANCED] Fetching real-time price...");const C=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${d}`,{signal:AbortSignal.timeout(5e3)})).json();if(C.price){const z=parseFloat(C.price),$=l,de=Math.abs(z-$)/z*100;console.log(`[ENHANCED] Real-time: $${z}, Last candle: $${$}, Diff: ${de.toFixed(2)}%`),de<2?(l=z,console.log(`[ENHANCED] ✅ Using real-time price: $${z}`)):console.log(`[ENHANCED] ⚠️ Price diff too large (${de.toFixed(2)}%), using candle close`)}}catch(B){console.log("[ENHANCED] Real-time price fetch failed, using candle close:",B.message)}if(o!=null&&o.timestamp){const B=new Date(o.timestamp).getTime(),C=(Date.now()-B)/(1e3*60);C>60&&i.push(`⚠️ WARNING: Price data is ${C.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${C.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const c=xt(),u=Ys();let f=null,m=!1;c.riskLevel==="danger"?(m=!0,f=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",c.reason)):c.riskLevel==="caution"?(f=c.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",c.reason)):console.log("[ENHANCED] ✅ Calendar safe:",c.reason);const p=n["1h"];if(!p)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const g=Zt(n,l),h=le(l,p,"day_trade"),_=le(l,p,"swing_trade"),y=zt(h.signal_type,g),w=zt(_.signal_type,g),E={...h,base_confidence:h.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:g.score,alignment_type:g.type},T={..._,base_confidence:_.confidence,mtf_confidence:w.confidence,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:g.score,alignment_type:g.type};let b=0,k="",S=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const C=ba(a["1h"]);S=(C==null?void 0:C.patterns)||[]}catch(C){console.error("[ENHANCED] Pattern detection error:",C.message)}const B=S.filter(C=>C.confidence>=70&&C.endIndex>=a["1h"].length-5);for(const C of B)C.type==="bullish"&&E.signal_type==="BUY"?(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `):C.type==="bearish"&&E.signal_type==="SELL"&&(b+=C.confidence*.1,k+=`${C.name} (${C.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let D=0,I="",R=null;if(a["1h"]&&a["1h"].length>=50){const B=Ee(a["1h"]);B&&(R=Sa(a["1h"],B),R.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(D=10,I="Strong Uptrend"):R.trend==="UPTREND"&&E.signal_type==="BUY"?(D=5,I="Uptrend"):R.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(D=10,I="Strong Downtrend"):R.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(D=5,I="Downtrend"))}let U=0,j="",L=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{L=$a(a["1h"],l),L.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(U=L.confidence_boost,j=`ML predicts +${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):L.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(U=L.confidence_boost,j=`ML predicts ${((L.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(B){console.error("[ENHANCED] ML prediction error:",B.message)}let O=0,A="",H=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const B=Ee(a["1h"]);B&&(H=Na(E,B,a["1h"]),H.tp1_probability>70?(O=10,A=`PoP: TP1 ${H.tp1_probability.toFixed(0)}%`):H.tp1_probability>60&&(O=5,A=`PoP: TP1 ${H.tp1_probability.toFixed(0)}%`))}catch(B){console.error("[ENHANCED] Probability of Profit error:",B.message)}let P=null,M=0,F=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{P=Kt(a["1h"]),P.liquidity_score>=80?M=5:P.liquidity_score>=70?M=0:P.liquidity_score>=50?F=-5:F=-10,console.log(`[LIQUIDITY] Score: ${P.liquidity_score}/100, Session: ${P.session}, Adjust: ${M+F}%`)}catch(B){console.error("[ENHANCED] Liquidity Analysis error:",B.message)}let V=0,Q=0,ee=0,te=0,se="";try{const B=await t.prepare(`
      ...
      `).all(),z=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(B&&C.results&&C.results.length>=10){const $=ma(C.results,B.balance);V=$.var_95,Q=$.var_99;const fe=pa(B.balance,C.results);if(ee=fe.current_drawdown_pct,fe.is_within_limit||(se+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),z.results){const de=ga(z.results,B.balance);te=de.total_risk_pct,de.is_within_limit||(se+=`⚠️ Portfolio heat ${te.toFixed(1)}% exceeds limit. `)}}}catch(B){console.error("[ENHANCED] Risk metrics error (optional):",B.message)}const x=b+D+U+O+M+F,N={...E,pattern_boost:b,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,E.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null},me={...T,pattern_boost:b,regime_boost:D,ml_boost:U,pop_boost:O,total_boost:x,enhanced_confidence:Math.min(98,T.final_confidence+x),var_95:V,var_99:Q,current_drawdown_pct:ee,portfolio_heat_pct:te,risk_warning:se||null};m?(N.signal_type="HOLD",me.signal_type="HOLD",N.enhanced_confidence=50,me.enhanced_confidence=50,N.reasoning=f||"Economic event nearby - trading paused",me.reasoning=f||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):u.adjustment<0&&(N.enhanced_confidence=Math.max(50,N.enhanced_confidence+u.adjustment),me.enhanced_confidence=Math.max(50,me.enhanced_confidence+u.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",u.adjustment)),N.calendar_check={risk_level:c.riskLevel,should_trade:c.shouldTrade,reason:c.reason,confidence_adjustment:u.adjustment,upcoming_events:c.upcomingEvents.slice(0,3).map(B=>Nt(B))},me.calendar_check=N.calendar_check;let ge=!1;try{const B=await t.prepare(`
...
`;for(const J of g.trends){const ve=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";$+=`${ve} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}$+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,$+=`📈 *DAY TRADE SIGNAL*
`,$+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`;const fe=candles1h.slice(-20),de=fe.map(J=>J.high).sort((J,ve)=>ve-J),ne=fe.map(J=>J.low).sort((J,ve)=>J-ve),kt=de.slice(0,3),pt=ne.slice(0,3);if($+=`📊 *Key Levels:*
`,$+=`🔴 *Resistance:* ${kt.map(J=>`$${J.toFixed(2)}`).join(", ")}
`,$+=`🟢 *Support:* ${pt.map(J=>`$${J.toFixed(2)}`).join(", ")}
...
`,$+=`Reason: ${N.mtf_reason}
`),$+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",$.length,"characters");const gt=await K({botToken:C.telegram_bot_token,chatId:C.telegram_chat_id},$);let X=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━
...
`;for(const ve of P.warnings)X+=`• ${ve}
`;X+=`
`}X+=`💡 *Recommendation:*
${P.recommendation}
...
`,X+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",X.length,"characters");const He=await K({botToken:C.telegram_bot_token,chatId:C.telegram_chat_id},X);ge=gt&&He}}catch(B){console.error("[ENHANCED] Telegram error (optional):",B.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:ge,day_trade:N,swing_trade:me,alignment:{type:g.type,score:g.score,trends:g.trends},patterns:S.length>0?S.slice(0,3):null,regime:R?{trend:R.trend,volatility:R.volatility,should_trade:R.should_trade}:null,ml_prediction:L?{direction:L.overall_direction,predictions:L.predictions}:null,profit_probability:H?{tp1:H.tp1_probability,tp2:H.tp2_probability,tp3:H.tp3_probability,expected_value:H.expected_value}:null,liquidity:P?{score:P.liquidity_score,session:P.session,time_zone:P.time_of_day_zone,volume_trend:P.volume_trend,volume_percentile:P.volume_percentile,estimated_spread_pips:P.estimated_spread_pips,price_impact_bps:P.price_impact_bps,market_depth_score:P.market_depth_score,optimal_for_trading:P.optimal_for_trading,warnings:P.warnings,recommendation:P.recommendation}:null,risk_metrics:{var_95:V,var_99:Q,drawdown_pct:ee,portfolio_heat_pct:te}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Vs=new be;Vs.post("/simple",async e=>{var s,n,a,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const o=await t.prepare(`
    ...
    `).first();if(!o)return e.json({success:!1,error:'No data available. Please click "Fetch Market Data" first to fetch all timeframes.'},400);const l=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 100
    `).all();if(!l.results||l.results.length<50)return e.json({success:!1,error:'Not enough candle data. Please click "Fetch Market Data" to fetch fresh data.'},400);const r=l.results.map(_=>({timestamp:_.timestamp,open:Number(_.open),high:Number(_.high),low:Number(_.low),close:Number(_.close),volume:Number(_.volume)||0})).reverse(),d=r[r.length-1].close;console.log("[SIMPLE] Got",r.length,"candles, current price:",d);const c=(_,y)=>{const w=parseFloat(String(_));return isNaN(w)?y:w},u={rsi_14:c(o.rsi_14,50),macd:c(o.macd,0),macd_signal:c(o.macd_signal,0),macd_histogram:c(o.macd_histogram,0),sma_20:c(o.sma_20,d),sma_50:c(o.sma_50,d),sma_200:c(o.sma_200,d),ema_12:c(o.ema_12,d),ema_26:c(o.ema_26,d),bb_upper:c(o.bb_upper,d*1.02),bb_middle:c(o.bb_middle,d),bb_lower:c(o.bb_lower,d*.98),atr_14:c(o.atr_14,d*.01),stochastic_k:c(o.stochastic_k,50),stochastic_d:c(o.stochastic_d,50),adx:c(o.adx,25),plus_di:c(o.plus_di,25),minus_di:c(o.minus_di,25),ichimoku_tenkan:c(o.ichimoku_tenkan,d),ichimoku_kijun:c(o.ichimoku_kijun,d),ichimoku_senkou_a:c(o.ichimoku_senkou_a,d),ichimoku_senkou_b:c(o.ichimoku_senkou_b,d),parabolic_sar:c(o.parabolic_sar,d),vwap:c(o.vwap,d),fib_382:c(o.fib_382,0)||void 0,fib_500:c(o.fib_500,0)||void 0,fib_618:c(o.fib_618,0)||void 0};console.log("[SIMPLE] Using pre-calculated indicators:",{rsi:(s=u.rsi_14)==null?void 0:s.toFixed(1),macd:(n=u.macd)==null?void 0:n.toFixed(2),adx:(a=u.adx)==null?void 0:a.toFixed(1)});const m=((await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC
      LIMIT 25
    `).all()).results||[]).map(_=>({timestamp:_.timestamp,open:_.open,high:_.high,low:_.low,close:_.close,volume:_.volume||1})).reverse(),p=ze(d,u,m,"day_trade"),g=ze(d,u,m,"swing_trade");console.log("[SIMPLE] Generated signals with liquidity:",{day:{type:p.signal_type,confidence:p.confidence,liquidity_score:p.liquidity_score,session:p.session},swing:{type:g.signal_type,confidence:g.confidence,liquidity_score:g.liquidity_score,session:g.session}});let h=!1;try{const _=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),y={};for(const w of _.results||[])y[w.setting_key]=w.setting_value;if(console.log("[SIMPLE] Telegram config:",{hasToken:!!y.telegram_bot_token,hasChat:!!y.telegram_chat_id,tokenLength:((i=y.telegram_bot_token)==null?void 0:i.length)||0,chatId:y.telegram_chat_id}),y.telegram_bot_token&&y.telegram_chat_id){const w=await t.prepare(`
          SELECT high, low FROM market_data 
          WHERE timeframe = '1h'
          ORDER BY timestamp DESC 
          LIMIT 20
        `).all();let E=[],T=[];if(w.results&&w.results.length>=20){const j=w.results.map(O=>O.high).sort((O,A)=>A-O),L=w.results.map(O=>O.low).sort((O,A)=>O-A);E=j.slice(0,3),T=L.slice(0,3)}const b=p.signal_type==="BUY"?"🟢":p.signal_type==="SELL"?"🔴":"⚪",k=new Date().toLocaleString("en-US",{timeZone:"UTC"});let S=`${b} <b>GOLD/USD ${p.signal_type} SIGNAL</b> ${b}

`;S+=`📊 Day Trade
`,S+=`💰 <b>Price:</b> $${Number(d).toFixed(2)}
`,S+=`📊 <b>Confidence:</b> ${Number(p.confidence).toFixed(1)}%

`,S+=`🎯 <b>Take Profits:</b>
`,S+=`   TP1: $${Number(p.take_profit_1).toFixed(2)}
`,S+=`   TP2: $${Number(p.take_profit_2).toFixed(2)}
`,S+=`   TP3: $${Number(p.take_profit_3).toFixed(2)}

`,S+=`🛡️ <b>Stop Loss:</b> $${Number(p.stop_loss).toFixed(2)}
...
`;const D=p.liquidity_score&&p.liquidity_score>=70?"🟢":p.liquidity_score&&p.liquidity_score>=50?"🟡":"🔴";S+=`${D} <b>Score:</b> ${p.liquidity_score||50}/100
`,S+=`🌐 <b>Session:</b> ${p.session||"UNKNOWN"} (${p.time_zone||"MEDIUM"} LIQUIDITY)
`,S+=`📊 <b>Volume:</b> ${p.volume_trend||"STABLE"} (${p.volume_percentile||50}%ile)
`,S+=`💰 <b>Spread:</b> ~${p.estimated_spread_pips||40} pips
`,S+=`📉 <b>Impact:</b> ~${p.price_impact_bps||10} bps ($100K)
`;const I=p.position_size_multiplier||1,R=I>=1?"🟢":I>=.75?"🟡":"🔴";if(S+=`
💼 <b>POSITION SIZING:</b>
`,S+=`${R} <b>Recommended:</b> ${(I*100).toFixed(0)}% of normal size
`,I<.75?S+=`⚠️ <b>Warning:</b> Reduced position due to liquidity
`:p.optimal_for_trading&&(S+=`✅ <b>Status:</b> Optimal for trading
`),p.liquidity_warnings&&p.liquidity_warnings!=="[]")try{const j=JSON.parse(p.liquidity_warnings);j.length>0&&(S+=`
⚠️ <b>WARNINGS:</b>
`,j.slice(0,2).forEach(L=>{const O=L.replace(/[⚠️🔴]/g,"").trim();S+=`• ${O}
`}))}catch{}S+=`
`,S+=`📝 <b>Reason:</b>
`;const U=String(p.reason).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");S+=U+`

`,S+=`⏰ ${k}`,console.log("[SIMPLE] Sending Telegram message, length:",S.length),h=await K({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},S),console.log("[SIMPLE] Telegram sent:",h),h||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(_){console.error("[SIMPLE] Telegram error:",_.message)}try{await t.prepare(`
        INSERT INTO signals (
    ...
    `).all()).results.map(p=>({timestamp:p.timestamp,open:Number(p.open),high:Number(p.high),low:Number(p.low),close:Number(p.close),volume:Number(p.volume)||0})).reverse(),d=r[r.length-1].close;console.log("[5M-SCANNER] Step 7: Starting 7-layer analysis");const c=await zs(t,a,i,o,r,d);console.log("[5M-SCANNER] Step 8: Analysis complete:",{grade:c.grade,score:c.score,signal:c.signal}),console.log("[5M-SCANNER] Step 9: Saving to database");const u=new Date().toISOString();console.log("[5M-SCANNER] Step 10: Timestamp created:",u),await t.prepare(`
      ...
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(u,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let f=!1;if(c.grade==="A"||c.grade==="A+")try{const p=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),g={};for(const h of p.results||[])g[h.setting_key]=h.setting_value;if(g.telegram_bot_token&&g.telegram_chat_id){const h=Xs(c,d);f=await K({botToken:g.telegram_bot_token,chatId:g.telegram_chat_id},h),await t.prepare(`
            UPDATE scanner_history 
            SET telegram_sent = ?
            WHERE timestamp = (SELECT MAX(timestamp) FROM scanner_history)
          `).bind(f?1:0).run(),console.log("[5M-SCANNER] Telegram alert sent:",f)}}catch(p){console.error("[5M-SCANNER] Telegram error:",p.message)}const m=new Date;return console.log("[5M-SCANNER] Scan complete, returning results"),e.json({success:!0,timestamp:m.toISOString(),scan_result:{grade:c.grade,score:c.score,signal:c.signal,confidence:c.confidence,entry:d,stop_loss:c.stopLoss,targets:[c.tp1,c.tp2,c.tp3],layers_passed:c.layersPassed,telegram_sent:f}})}catch(s){console.error("[5M-SCANNER] Error caught:",s);const n=(s==null?void 0:s.message)||String(s);return console.error("[5M-SCANNER] Error message:",n),e.json({success:!1,error:n},500)}});ct.get("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER-GET] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER-GET] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER-GET] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER-GET] Starting scan at",n),console.log("[5M-SCANNER-GET] Step 4: Creating table"),await t.prepare(`
      CREATE TABLE IF NOT EXISTS scanner_history (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        timestamp DATETIME NOT NULL,
        timeframe TEXT NOT NULL,
    ...
    `).all()).results.map(m=>({timestamp:m.timestamp,open:Number(m.open),high:Number(m.high),low:Number(m.low),close:Number(m.close),volume:Number(m.volume)||0})).reverse();if(!r||r.length===0)return e.json({success:!1,error:"No 5m market data available"});const d=r[r.length-1].close,c=await zs(t,a,i,o,r,d),u=new Date().toISOString();await t.prepare(`
      ...
      (timestamp, timeframe, signal_type, grade, score, 
       ...
       confidence, layers_passed, liquidity_score, session, telegram_sent)
      VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
    `).bind(u,"5m",c.signal,c.grade,c.score,d,c.stopLoss,c.tp1,c.tp2,c.tp3,c.confidence,c.layersPassed,c.liquidityScore,c.session,0).run();let f=!1;if(c.grade==="A"||c.grade==="A+")try{const m=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),p={};for(const _ of m.results||[]){const y=_;p[y.setting_key]=y.setting_value}const g=p.telegram_bot_token,h=p.telegram_chat_id;if(g&&h&&g!=="your_bot_token_here"&&h!=="your_chat_id_here"){const _=`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
          `.trim();await K(g,h,_),f=!0,console.log("[5M-SCANNER-GET] Telegram alert sent for",c.grade,"grade")}}catch(m){console.error("[5M-SCANNER-GET] Telegram error:",m)}return e.json({success:!0,timestamp:u,scan_result:{grade:c.grade,score:c.score,signal:c.signal,confidence:c.confidence,entry:d,stop_loss:c.stopLoss,targets:[c.tp1,c.tp2,c.tp3],layers_passed:c.layersPassed,telegram_sent:f}})}catch(s){console.error("[5M-SCANNER-GET] Fatal error:",s);const n=(s==null?void 0:s.message)||String(s);return console.error("[5M-SCANNER-GET] Error message:",n),e.json({success:!1,error:n},500)}});ct.get("/stats",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),o=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:n.results,session_stats:a.results,best_hours:i.results,recent_a_grade:o.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});ct.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});ct.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const d of s.results||[])n[d.setting_key]=d.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,i=15,o={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-i,tp1:a+i*2,tp2:a+i*3,tp3:a+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Xs(o,a),r=await K({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:r,message:r?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function zs(e,t,s,n,a,i){console.log("[ANALYZE] Starting analysis");let o=0,l=0;const r=[],d=(ae,Ke)=>{const Lt=parseFloat(String(ae));return isNaN(Lt)?Ke:Lt};console.log("[ANALYZE] parseNum defined");const c={ema20:d(t.ema_12,i),rsi:d(t.rsi_14,50),macd:d(t.macd,0),macd_signal:d(t.macd_signal,0),macd_histogram:d(t.macd_histogram,0),adx:d(t.adx,25)},u={ema50:d(s.ema_26,i)},f={sma200:d(n.sma_200,i)},m=i>c.ema20&&i>u.ema50&&i>f.sma200,p=i<c.ema20&&i<u.ema50&&i<f.sma200;m||p?(o+=20,l++,r.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):r.push("❌ Layer 1: Trend NOT aligned (conflicting)");const g=c.rsi>=40&&c.rsi<=60,h=c.macd>c.macd_signal&&c.macd_histogram>0,_=c.macd<c.macd_signal&&c.macd_histogram<0;g&&(m?h:_)?(o+=15,l++,r.push(`✅ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):r.push(`❌ Layer 2: RSI ${c.rsi.toFixed(0)}, MACD ${g?"no crossover":"extreme"}`);const y=a.slice(-20).reduce((ae,Ke)=>ae+Ke.volume,0)/20,w=a[a.length-1].volume;w>y*1.5?(o+=15,l++,r.push(`✅ Layer 3: Volume spike ${(w/y).toFixed(1)}x average`)):r.push(`❌ Layer 3: Volume ${(w/y).toFixed(1)}x (need 1.5x+)`);const T=Math.max(...a.slice(-20).map(ae=>ae.high)),b=Math.min(...a.slice(-20).map(ae=>ae.low)),k=i>T*.999,S=i<b*1.001;m&&k||p&&S?(o+=15,l++,r.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):r.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let D=null;try{D=await Kt(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(ae){console.log("[5M-SCANNER] Liquidity calc failed:",ae)}const I=(D==null?void 0:D.liquidity_score)||50,R=(D==null?void 0:D.session)||"UNKNOWN";I>=70?(o+=15,l++,r.push(`✅ Layer 5: Liquidity ${I}/100 (${R} session)`)):r.push(`❌ Layer 5: Liquidity ${I}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const j=xt();console.log("[ANALYZE] Calendar check complete"),j.riskLevel==="safe"?(o+=10,l++,r.push("✅ Layer 6: No major news")):r.push(`❌ Layer 6: ${j.reason}`);const O=c.adx>25,A=c.adx>70;O&&!A?(o+=10,l++,r.push(`✅ Layer 7: ADX ${c.adx.toFixed(1)} (strong trend)`)):A?r.push(`⚠️ Layer 7: ADX ${c.adx.toFixed(1)} (extreme, reversal risk)`):r.push(`❌ Layer 7: ADX ${c.adx.toFixed(1)} (weak trend)`);let H="HOLD";(m||p)&&l>=5&&(H=m?"BUY":"SELL");const P=new Date,M=Ua(P);M.hasBoost?(o+=8,l++,r.push(`✅ Layer 8: ${M.reason} (+${M.boost}% win)`)):r.push(`ℹ️ Layer 8: ${M.reason}`);const F=Ha(P);F.hasBoost?(o+=5,l++,r.push(`✅ Layer 9: ${F.reason} (+${F.boost}% win)`)):r.push(`ℹ️ Layer 9: ${F.reason}`);const V=d(t.atr_14,i*.01),Q=a.slice(-20).reduce((ae,Ke)=>{const Lt=Ke.high-Ke.low;return ae+Lt},0)/20;if(Ba(V,Q)){o+=7,l++;const ae=((V/Q-1)*100).toFixed(1);r.push(`✅ Layer 10: ATR expanding ${ae}% (high volatility)`)}else{const ae=((1-V/Q)*100).toFixed(1);r.push(`❌ Layer 10: ATR compressed ${ae}% (skip low volatility)`)}const te=Pa(a.slice(-20));qs(te,H)&&te.strength>=60&&(o+=10,l++),r.push(ja(te,H));const x=Wa(a.slice(-3)),{aligned:N,strongestPattern:me}=ei(x,H);N&&me?(o+=12,l++,r.push(`✅ Layer 12: ${me.name} (${me.strength}/100)`)):x.length>0&&x[0].type==="INDECISION"?r.push(`⚠️ Layer 12: ${x[0].name} (indecision, wait)`):r.push("❌ Layer 12: No clear candlestick pattern");const ge=ti(a,i);oi(ge,H)&&ge.nearZone?(o+=8,l++,r.push(`✅ Layer 13: ${ge.description}`)):ge.nearZone?r.push(`⚠️ Layer 13: ${ge.description} (not aligned)`):r.push("ℹ️ Layer 13: No key zones nearby");const z=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(ae=>({rsi:parseFloat(String(ae.rsi))||50,macd:parseFloat(String(ae.macd))||0,macd_histogram:parseFloat(String(ae.macd_histogram))||0})).reverse(),$=ri(z,a.slice(-10)),de=ui($,H,m?"BULLISH":p?"BEARISH":"NEUTRAL");de&&$.strength>=70&&(o+=9,l++),r.push(mi($,de));const ne=pi(t,s,n,i),kt=gi(ne,H);kt&&(ne.allAligned||ne.twoAligned)&&(o+=6,l++),r.push(fi(ne,kt));const pt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),gt=(pt==null?void 0:pt.setting_value)||"70140f57bea54c5e90768de696487d8f",X=await vi(e,gt,15),He=_i(X);hi(He,H)&&He.strength>=60?(o+=5,l++,r.push(`✅ Layer 18: ${He.description}`)):He.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 18: ${He.description} (not aligned)`):r.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const ve=await cs(e,gt,"SILVER",15),pn=await cs(e,gt,"OIL",15),Xe=Ti(ve,pn,H);if(Xe.aligned&&Xe.alignmentCount>=1){const ae=Xe.alignmentCount===2?5:3;o+=ae,l++,r.push(`✅ Layer 19: ${Xe.description} (${Xe.strength}/100)`)}else r.push(`❌ Layer 19: ${Xe.description}`);const gn=await Ci(e)||Fi(),Le=Ri(gn);if(Ai(Le,H)&&Le.strength>=70){const ae=Le.positioning.includes("EXTREME")?7:4;o+=ae,l++,r.push(`✅ Layer 20: ${Le.description} (${Le.strength}/100)`)}else Le.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 20: ${Le.description} (not aligned)`):r.push(`ℹ️ Layer 20: ${Le.description}`);let It="C";o>=162?It="A+":o>=144?It="A":o>=126&&(It="B"),(m||p)&&l>=7&&(H=m?"BUY":"SELL");const Re=Math.max(V*1.5,i*.003),fn=H==="BUY"?i-Re:i+Re,_n=H==="BUY"?i+Re*2:i-Re*2,hn=H==="BUY"?i+Re*3:i-Re*3,yn=H==="BUY"?i+Re*4:i-Re*4;return{grade:It,score:o,signal:H,confidence:o,layersPassed:l,layers:r,stopLoss:fn,tp1:_n,tp2:hn,tp3:yn,liquidityScore:I,session:R,adx:c.adx,rsi:c.rsi,volumeRatio:w/y}}function Xs(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,i=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let o=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,o+="Next scan in 5 minutes...",o}async function dt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(e).first();if(!a)return{success:!1,error:"Trade not found or already closed"};const i=a.trade_type==="BUY"?t-a.entry_price:a.entry_price-t,o=i*a.position_size,l=i/a.entry_price*100,r=o>0?1:0;await n.prepare(`
      ...
      WHERE id = ?
    `).bind(t,new Date().toISOString(),s,o,l,r,e).run();const c=(await dt(n)).current_balance+o;return await n.prepare(`
      UPDATE risk_limits
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(c).run(),await Js(n),await Hi(n),await Bi(n),{success:!0,profit_loss:o}}catch(a){return{success:!1,error:a.message}}}async function Js(e){const t=await dt(e),s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,i=n.filter(m=>m.win===1).length,o=n.filter(m=>m.win===0).length,l=i/a*100,r=n.reduce((m,p)=>m+(p.profit_loss||0),0),d=Math.max(...n.map(m=>m.profit_loss||0)),c=Math.min(...n.map(m=>m.profit_loss||0)),u=n.reduce((m,p)=>m+(p.confidence||0),0)/a,f=n.reduce((m,p)=>m+(p.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,i,o,l,r,d,c,u,f).run()}async function Bi(e){const t=await dt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,i).run();let o=!1,l="";s>=t.max_drawdown_pct?(o=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(o=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),o&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});we.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Fe=new be;Fe.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Ut(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:Nt(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/today",async e=>{try{const t=Fa(),s=xt();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/check",async e=>{try{const t=xt(),s=Ys();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);Ca(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
    ...
    `).bind(s).run(),e.json({success:!0,message:"Event deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});function sn(e,t,s){const n=s.find(_=>t.confidence>=_.confidence_min&&t.confidence<=_.confidence_max);if(!n)return{units:0,value:0,risk_amount:0,risk_pct:0,position_pct:0,stop_loss_distance:0,reward_risk_ratio:0,is_valid:!1,warning:`No position sizing rule found for confidence ${t.confidence}%`};const a=Math.abs(t.entry_price-t.stop_loss),o=e.current_balance*(n.risk_pct/100)/a,l=o*t.entry_price;l/e.current_balance*100;const r=e.current_balance*(n.max_position_pct/100);let d=o,c=l,u=n.risk_pct,f;l>r&&(c=r,d=r/t.entry_price,u=d*a/e.current_balance*100,f=`Position reduced to ${n.max_position_pct}% max position size`);const p=Math.abs(t.take_profit_1-t.entry_price)/a;let g=!0;const h=[];return f&&h.push(f),p<1.5&&h.push(`Low reward:risk ratio (${p.toFixed(2)}:1). Recommended: >1.5:1`),u>e.max_daily_loss_pct&&(g=!1,h.push(`Risk ${u.toFixed(2)}% exceeds max daily loss ${e.max_daily_loss_pct}%`)),d<.01&&(g=!1,h.push("Position size too small (minimum 0.01 lots)")),{units:parseFloat(d.toFixed(2)),value:parseFloat(c.toFixed(2)),risk_amount:parseFloat((d*a).toFixed(2)),risk_pct:parseFloat(u.toFixed(2)),position_pct:parseFloat((c/e.current_balance*100).toFixed(2)),stop_loss_distance:parseFloat(a.toFixed(2)),reward_risk_ratio:parseFloat(p.toFixed(2)),is_valid:g,warning:h.length>0?h.join("; "):void 0}}function nn(e,t,s,n,a=0){let i;n==="BUY"?i=(t-e)*s:i=(e-t)*s,i-=a;const o=(t-e)/e*100,l=Math.abs(t-e)/.01;return{profit_loss:parseFloat(i.toFixed(2)),profit_loss_pct:parseFloat(o.toFixed(2)),pips:parseFloat(l.toFixed(1))}}function Pi(e,t){const s=t.filter(l=>l.profit_loss<0).reduce((l,r)=>l+r.profit_loss,0),n=Math.abs(s/e.current_balance)*100,a=n>=e.max_daily_loss_pct,o=e.current_balance*(e.max_daily_loss_pct/100)-Math.abs(s);return{current_loss:parseFloat(s.toFixed(2)),current_loss_pct:parseFloat(n.toFixed(2)),limit_exceeded:a,remaining:parseFloat(o.toFixed(2))}}function ji(e){const t=e.filter(g=>g.status==="CLOSED"),s=t.filter(g=>g.profit_loss>0),n=t.filter(g=>g.profit_loss<0),a=s.reduce((g,h)=>g+h.profit_loss,0),i=Math.abs(n.reduce((g,h)=>g+h.profit_loss,0)),o=a-i,l=s.length>0?a/s.length:0,r=n.length>0?i/n.length:0,d=t.length>0?s.length/t.length*100:0,c=i>0?a/i:a,u=100-d,f=d/100*l-u/100*r,m=s.length>0?Math.max(...s.map(g=>g.profit_loss)):0,p=n.length>0?Math.min(...n.map(g=>g.profit_loss)):0;return{total_trades:t.length,winning_trades:s.length,losing_trades:n.length,win_rate:parseFloat(d.toFixed(2)),total_profit:parseFloat(a.toFixed(2)),total_loss:parseFloat(i.toFixed(2)),net_profit:parseFloat(o.toFixed(2)),avg_win:parseFloat(l.toFixed(2)),avg_loss:parseFloat(r.toFixed(2)),profit_factor:parseFloat(c.toFixed(2)),expectancy:parseFloat(f.toFixed(2)),largest_win:parseFloat(m.toFixed(2)),largest_loss:parseFloat(p.toFixed(2))}}function Wi(e){return e.is_valid?`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ut=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:ji,calculatePositionSize:sn,calculateProfitLoss:nn,checkDailyLossLimit:Pi,formatPositionSize:Wi},Symbol.toStringTag,{value:"Module"}));async function an(e,t,s){const n=Date.now(),a=[],i=[];let o=t.starting_balance,l=t.starting_balance;const r=e.filter(M=>{const F=new Date(M.timestamp);return F>=new Date(t.start_date)&&F<=new Date(t.end_date)});if(r.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${r.length}`);const d={current_balance:o,max_daily_loss_pct:2};for(let M=200;M<r.length;M++){const F=r.slice(M-200,M),V=Ee(F);if(!V)continue;const Q=r[M],ee=Q.close,te=le(ee,V,"day_trade"),se=le(ee,V,"swing_trade");for(const x of[te,se]){if(x.signal_type==="HOLD"||x.confidence<t.min_confidence)continue;d.current_balance=o;const N=sn(d,{entry_price:x.price,stop_loss:x.stop_loss,take_profit_1:x.take_profit_1,take_profit_2:x.take_profit_2,take_profit_3:x.take_profit_3,confidence:x.confidence,signal_type:x.signal_type,trading_style:x.trading_style},s);if(!N.is_valid)continue;const me=Q.timestamp,ge=x.price;let B=null,C=null,z="UNKNOWN";const $=Math.min(50,r.length-M-1);for(let de=1;de<=$;de++){const ne=r[M+de];if(x.signal_type==="BUY"){if(ne.low<=x.stop_loss){B=x.stop_loss,C=ne.timestamp,z="STOP_LOSS";break}if(ne.high>=x.take_profit_3){B=x.take_profit_3,C=ne.timestamp,z="TP3";break}if(ne.high>=x.take_profit_2){B=x.take_profit_2,C=ne.timestamp,z="TP2";break}if(ne.high>=x.take_profit_1){B=x.take_profit_1,C=ne.timestamp,z="TP1";break}}else{if(ne.high>=x.stop_loss){B=x.stop_loss,C=ne.timestamp,z="STOP_LOSS";break}if(ne.low<=x.take_profit_3){B=x.take_profit_3,C=ne.timestamp,z="TP3";break}if(ne.low<=x.take_profit_2){B=x.take_profit_2,C=ne.timestamp,z="TP2";break}if(ne.low<=x.take_profit_1){B=x.take_profit_1,C=ne.timestamp,z="TP1";break}}}if(!B||!C)continue;const fe=nn(ge,B,N.units,x.signal_type,t.commission_per_trade);o+=fe.profit_loss,o>l&&(l=o),a.push({entry_time:me,entry_price:ge,exit_time:C,exit_price:B,signal_type:x.signal_type,trading_style:x.trading_style,position_size:N.units,profit_loss:fe.profit_loss,profit_loss_pct:fe.profit_loss_pct,exit_reason:z,confidence:x.confidence}),i.push({date:C,balance:o})}}const c=a.filter(M=>M.profit_loss>0),u=a.filter(M=>M.profit_loss<0),f=c.reduce((M,F)=>M+F.profit_loss,0),m=Math.abs(u.reduce((M,F)=>M+F.profit_loss,0)),p=o-t.starting_balance,g=a.length>0?c.length/a.length*100:0,h=c.length>0?f/c.length:0,_=u.length>0?m/u.length:0,y=c.length>0?Math.max(...c.map(M=>M.profit_loss)):0,w=u.length>0?Math.min(...u.map(M=>M.profit_loss)):0,E=m>0?f/m:f,T=100-g,b=g/100*h-T/100*_;let k=0,S=0,D=t.starting_balance;for(const M of i){M.balance>D&&(D=M.balance);const F=D-M.balance,V=F/D*100;F>k&&(k=F,S=V)}const I=a.map(M=>M.profit_loss_pct),R=I.reduce((M,F)=>M+F,0)/I.length,U=Math.sqrt(I.reduce((M,F)=>M+Math.pow(F-R,2),0)/I.length),j=U>0?R/U:0;let L=0,O=0,A=0,H=0;for(const M of a)M.profit_loss>0?(A++,H=0,L=Math.max(L,A)):(H++,A=0,O=Math.max(O,H));const P=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:c.length,losing_trades:u.length,win_rate:parseFloat(g.toFixed(2)),net_profit:parseFloat(p.toFixed(2)),total_return_pct:parseFloat((p/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(h.toFixed(2)),avg_loss:parseFloat(_.toFixed(2)),largest_win:parseFloat(y.toFixed(2)),largest_loss:parseFloat(w.toFixed(2)),max_drawdown:parseFloat(k.toFixed(2)),max_drawdown_pct:parseFloat(S.toFixed(2)),profit_factor:parseFloat(E.toFixed(2)),sharpe_ratio:parseFloat(j.toFixed(2)),expectancy:parseFloat(b.toFixed(2)),max_consecutive_wins:L,max_consecutive_losses:O,starting_balance:t.starting_balance,ending_balance:parseFloat(o.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:i,execution_time_ms:P}}function on(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Yi=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:on,runBacktest:an},Symbol.toStringTag,{value:"Module"})),mt=new be;mt.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
    ...
    `).bind(s.run_name||`Backtest ${new Date().toISOString()}`,i.start_date,i.end_date,i.starting_balance,i.min_confidence,i.use_mtf_confirmation?1:0,i.use_news_filter?1:0,i.timeframe,l.total_trades,l.winning_trades,l.win_rate,l.net_profit,l.total_return_pct,l.max_drawdown_pct,l.profit_factor,l.sharpe_ratio,JSON.stringify(l.trades),JSON.stringify(l.equity_curve)).run();let d=!1;try{const c=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings 
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),u={};if(c.results.forEach(f=>{f.setting_key==="telegram_bot_token"&&(u.telegram_bot_token=f.setting_value),f.setting_key==="telegram_chat_id"&&(u.telegram_chat_id=f.setting_value)}),u.telegram_bot_token&&u.telegram_chat_id){const f=l;let m="",p="";f.total_trades<10?(m="⏳ INSUFFICIENT DATA",p="⏳"):f.total_trades<50?(m="⚠️ SMALL SAMPLE SIZE",p="⚠️"):f.win_rate>=70&&f.profit_factor>=2?(m="✅ STRATEGY VALIDATED",p="✅"):f.win_rate>=60?(m="⚠️ GOOD PERFORMANCE",p="⚠️"):(m="❌ NEEDS IMPROVEMENT",p="❌");const g=`
🎯 *BACKTEST COMPLETE*
...
*Win Rate:* ${f.win_rate.toFixed(1)}% (${f.winning_trades}W / ${f.losing_trades}L)
*Net Profit:* ${f.net_profit>0?"+":""}$${f.net_profit.toFixed(2)}
*Total Return:* ${f.total_return_pct>0?"+":""}${f.total_return_pct.toFixed(2)}%

━━━━━━━━━━━━━━━━━━━━━━━━━
💰 *PROFIT METRICS*
━━━━━━━━━━━━━━━━━━━━━━━━━

*Average Win:* +$${f.avg_win.toFixed(2)}
*Average Loss:* -$${Math.abs(f.avg_loss).toFixed(2)}
*Largest Win:* +$${f.largest_win.toFixed(2)}
*Largest Loss:* -$${Math.abs(f.largest_loss).toFixed(2)}
*Profit Factor:* ${f.profit_factor.toFixed(2)}
*Expectancy:* $${f.expectancy.toFixed(2)} per trade

━━━━━━━━━━━━━━━━━━━━━━━━━
⚠️ *RISK METRICS*
━━━━━━━━━━━━━━━━━━━━━━━━━

*Max Drawdown:* ${f.max_drawdown_pct.toFixed(2)}%
*Sharpe Ratio:* ${f.sharpe_ratio.toFixed(2)}
...
*Starting:* $${f.starting_balance.toFixed(2)}
*Peak:* $${f.peak_balance.toFixed(2)}
*Ending:* $${f.ending_balance.toFixed(2)}
...
${f.total_trades<10?"⚠️ Only "+f.total_trades+" trades executed. Need 50+ for validation.":f.total_trades<50?"⚠️ Need 50+ trades for reliable results. Keep collecting data.":f.win_rate>=70&&f.profit_factor>=2?"✅ Ready for paper trading!":f.win_rate>=60?"⚠️ Consider increasing confidence threshold or adding filters.":"❌ Adjust strategy parameters before live trading."}

⏱️ Execution Time: ${f.execution_time_ms}ms
📅 Backtest ID: ${r.meta.last_row_id}
        `.trim();d=await K({botToken:u.telegram_bot_token,chatId:u.telegram_chat_id},g)}}catch(c){console.error("[BACKTEST] Telegram send failed:",c)}return e.json({success:!0,backtest_id:r.meta.last_row_id,result:l,formatted:on(l),telegram_sent:d})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});mt.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
      ...
      LIMIT ?
    `).bind(s).all();return e.json({success:!0,count:n.results.length,backtests:n.results})}catch(t){return e.json({success:!1,error:t.message},500)}});mt.get("/results/:id",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.param("id")),n=await t.prepare(`
      SELECT * FROM backtest_runs WHERE id = ?
    `).bind(s).first();return n?(n.trades=n.trades_json?JSON.parse(n.trades_json):[],n.equity_curve=n.equity_curve_json?JSON.parse(n.equity_curve_json):[],e.json({success:!0,backtest:n})):e.json({success:!1,error:"Backtest not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});mt.delete("/results/:id",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.param("id"));return await t.prepare(`
      DELETE FROM backtest_runs WHERE id = ?
    `).bind(s).run(),e.json({success:!0,message:"Backtest deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});mt.get("/data-availability",async e=>{try{const{DB:t}=e.env,s=await t.prepare(`
      SELECT 
    ...
    `).first();if(!o)return e.json({ok:!0});const l={botToken:o.setting_value,chatId:a.toString()};if(i.startsWith("/log_trade")){const r=i.split(" ");if(r.length<5)return await K(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const d=r[1].toUpperCase(),c=parseFloat(r[2]),u=parseFloat(r[3]),f=parseFloat(r[4]),m=await Zs({trade_type:d,trading_style:"day_trade",entry_price:c,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:u,take_profit_1:f,take_profit_2:f*1.002,take_profit_3:f*1.003,status:"OPEN",confidence:85},t);m.success?await K(l,`✅ *Trade #${m.trade_id} Logged*

${d} @ $${c}
Stop: $${u}
TP1: $${f}`):await K(l,`❌ Error: ${m.error}`)}else if(i.startsWith("/close_trade")){const r=i.split(" ");if(r.length<4)return await K(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const d=parseInt(r[1]),c=parseFloat(r[2]),u=r[3],f=await Qs(d,c,u,t);if(f.success){const m=f.profit_loss||0,p=m>0?"💰":"❌";await K(l,`${p} *Trade #${d} Closed*

Exit: $${c}
P&L: ${m>0?"+":""}$${m.toFixed(2)}
Result: ${m>0?"WIN ✅":"LOSS ❌"}`)}else await K(l,`❌ Error: ${f.error}`)}else if(i==="/open"){const r=await tn(t);if(r.length===0)await K(l,"📊 No open positions");else{let d=`📊 *Open Positions (${r.length})*

`;for(const c of r)d+=`#${c.id}: ${c.trade_type} @ $${c.entry_price}
`,d+=`Stop: $${c.stop_loss}
`,d+=`TP1: $${c.take_profit_1}

`;await K(l,d)}}else if(i==="/stats"){const r=await en(t);let d=`📊 *Trading Statistics*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Ht=new be;Ht.post("/market-analysis",async e=>await ln(e));Ht.get("/health",async e=>e.json({success:!0,status:"healthy",service:"ai-analysis",timestamp:new Date().toISOString()}));Ht.get("/auto-ai-scan",async e=>await ln(e));async function ln(e){const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const I of s.results||[])I.setting_key==="twelve_data_api_key"&&(n=I.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const I=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,U=await(await fetch(I)).json();U.values&&U.values.length>=50&&(a=U.values.reverse().map(j=>({timestamp:j.datetime,open:parseFloat(j.open),high:parseFloat(j.high),low:parseFloat(j.low),close:parseFloat(j.close),volume:parseFloat(j.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const I=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!I.results||I.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=I.results.reverse().map(R=>({timestamp:R.timestamp,open:R.open,high:R.high,low:R.low,close:R.close,volume:R.volume||0}))}const i=Ee(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const o=a[a.length-1].close,l=le(o,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",o,"Signal:",l.signal_type,"Confidence:",l.confidence);const r={};for(const I of["5m","15m","1h","4h","daily"]){const R=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(I).first();R&&(r[I]=R)}const d=Zt(r,o),c=a.slice(-50),u=c.map(I=>I.high).sort((I,R)=>R-I),f=c.map(I=>I.low).sort((I,R)=>I-R),m=[Math.max(...u.slice(0,10))],p=[Math.min(...f.slice(0,10))];o>i.sma_20?p.push(i.sma_20):m.push(i.sma_20),o>i.sma_50?p.push(i.sma_50):m.push(i.sma_50),o>i.vwap?p.push(i.vwap):m.push(i.vwap);const g=Math.round(o/10)*10;g>o?m.push(g):p.push(g);const h=[...new Set(m)].sort((I,R)=>I-R).filter(I=>I>o).slice(0,3),_=[...new Set(p)].sort((I,R)=>R-I).filter(I=>I<o).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",_,"Resistance:",h);const y=i.atr_14/o*100;let w="NORMAL";y>3?w="EXTREME":y>1.5?w="HIGH":y<.5&&(w="LOW");const E=[];let T=30,b=30,k=40;d.type==="ALL_BULLISH"?(T=60,b=20,k=20):d.type==="ALL_BEARISH"?(T=20,b=60,k=20):d.score>=4&&(d.trends.filter(I=>I.trend==="BULLISH").length>=4?(T=50,b=25,k=25):(T=25,b=50,k=25)),h.length>0&&E.push({name:"📈 BULLISH CONTINUATION",probability:T,description:`Price breaks above $${h[0].toFixed(2)} and rallies toward $${(h[h.length-1]||o*1.02).toFixed(2)}`,trigger:`Breakout above $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||o*1.02}),_.length>0&&E.push({name:"📉 BEARISH CORRECTION",probability:b,description:`Price breaks below $${_[0].toFixed(2)} and drops toward $${(_[_.length-1]||o*.98).toFixed(2)}`,trigger:`Breakdown below $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||o*.98}),E.push({name:"↔️ CONTINUED RANGING",probability:k,description:`Price oscillates between $${(_[0]||o*.99).toFixed(2)} and $${(h[0]||o*1.01).toFixed(2)} with choppy action`,trigger:w==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),E.sort((I,R)=>R.probability-I.probability);let S={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=65?l.signal_type==="BUY"?S={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${(o-5).toFixed(2)}-${o.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(S={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${d.type} MTF alignment.`,entry_range:`${o.toFixed(2)}-${(o+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):w==="EXTREME"?S.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(d.type==="MIXED"||d.type==="CONFLICTING")&&(S.reason=`⏰ Timeframes conflicting (${d.score}/5 aligned). Wait for ${h[0]?`breakout above $${h[0].toFixed(2)}`:_[0]?`breakdown below $${_[0].toFixed(2)}`:"clearer direction"}.`);let D=!1;if(l.confidence>=65)try{const I=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,O+=`🟢 *Support:* ${_.length>0?_.map(A=>`$${A.toFixed(2)}`).join(", "):"N/A"}
...
`,O+=`🛡️ *Stop Loss:* $${S.stop_loss}`),D=await K({botToken:R.telegram_bot_token,chatId:R.telegram_chat_id},O),console.log("[AI-ANALYSIS] Telegram alert sent:",D,"for",l.signal_type,l.confidence+"%"),D&&j&&(l.signal_type==="BUY"||l.signal_type==="SELL")&&(console.log("[AI-ANALYSIS] 🔥 HIGH CONVICTION AI signal! Scheduling reminders..."),setTimeout(async()=>{let A=`${U} *⚠️ REMINDER: AI HIGH CONVICTION* ${U}
...
`),A+="⏰ Don't miss this AI signal!",await K({botToken:R.telegram_bot_token,chatId:R.telegram_chat_id},A)},120*1e3),setTimeout(async()=>{let A=`${U} *⚠️ FINAL: AI SIGNAL STILL VALID* ${U}

`;A+=`📊 *${l.signal_type}* (${l.confidence.toFixed(1)}%)
`,A+=`💰 *Current Price:* $${o.toFixed(2)}

`,A+=`🔥 Last chance - ${S.action}!
`,S.entry_range&&(A+=`🎯 *Entry:* $${S.entry_range}
`,A+=`🛡️ *Stop:* $${S.stop_loss}`),await K({botToken:R.telegram_bot_token,chatId:R.telegram_chat_id},A)},300*1e3))}}catch(I){console.error("[AI-ANALYSIS] Telegram error:",I.message)}else console.log("[AI-ANALYSIS] No Telegram alert - Confidence:",l.confidence,"Signal:",l.signal_type);return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:o,signal:l.signal_type,confidence:l.confidence,volatility:w,mtf_alignment:{type:d.type,score:d.score,trends:d.trends},key_levels:{resistance:h,support:_},scenarios:E,recommendation:S,telegram_sent:D}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}}const Ue=new be;async function Gi(e){try{return await e.prepare("SELECT 1 FROM monitoring_config LIMIT 1").first(),!0}catch{return!1}}async function cn(e){try{const t=await e.prepare(`
  ...
  `).first();if(a){const l=a.last_timestamp,r=a.count,d=l?Math.floor((Date.now()-new Date(l).getTime())/6e4):9999;n.push({source:"market_data",timeframe:"1h",ageMinutes:d,isStale:d>s,lastTimestamp:l,count:r})}const i=["5m","15m","1h","4h","daily"];for(const l of i){const r=await e.prepare(`
    ...
    SELECT MAX(timestamp) as last_timestamp, COUNT(*) as count
    FROM signals
  `).first();if(o){const l=o.last_timestamp,r=o.count,d=l?Math.floor((Date.now()-new Date(l).getTime())/6e4):9999;n.push({source:"signals",ageMinutes:d,isStale:d>s,lastTimestamp:l,count:r})}return n}async function Vt(e,t,s,n,a,i){try{try{await e.prepare(`
...
⏰ ${new Date().toUTCString()}`;return await K(u,l,r),!0}}return!1}catch(o){return console.error("[MONITORING] Failed to send alert:",o),!1}}Ue.get("/health-check",async e=>{const{DB:t}=e.env;try{const s=await cn(t),n=e.req.url.replace("/api/monitoring/health-check",""),a=new Date().toISOString(),i=await Gi(t);console.log("[MONITORING] Starting comprehensive health check..."),console.log("[MONITORING] Tables exist:",i);const o=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}],l=[],r=s.telegram_alerts_enabled==="1",d=parseInt(s.slow_response_threshold_ms||"5000"),c=parseInt(s.max_failure_count||"3");console.log("[MONITORING] Fast mode: Checking 5 endpoints (MTF skipped)");for(const _ of o){const y=await Vi(t,_.name,_.url,n);let w=0,E="unknown",T=y.status==="down"?1:0;if(i)try{const b=await t.prepare(`
          ...
          `).bind(_.name).first();w=(b==null?void 0:b.failure_count)||0,E=(b==null?void 0:b.status)||"unknown",T=y.status==="down"?w+1:0}catch(b){console.log("[MONITORING] Could not read previous health check:",b)}if(i)try{await t.prepare(`
            ...
            VALUES (?, ?, ?, ?, datetime('now'), ?, ?, ?, ?)
          `).bind(_.name,_.url,y.status,y.responseTime,y.status==="healthy"?new Date().toISOString():null,y.status==="down"?new Date().toISOString():null,T,y.error||null).run()}catch(b){console.log("[MONITORING] Could not save health check:",b)}l.push({name:_.name,url:_.url,status:y.status,response_time_ms:y.responseTime,failure_count:T,error:y.error}),y.status==="down"&&T>=c&&E!=="down"&&i&&await Vt(t,"endpoint_down","critical",_.name,`Endpoint ${_.name} is DOWN after ${T} consecutive failures. Error: ${y.error}`,r),y.status==="healthy"&&y.responseTime>d&&i&&await Vt(t,"slow_response","medium",_.name,`Endpoint ${_.name} is responding slowly: ${y.responseTime}ms (threshold: ${d}ms)`,r)}console.log("[MONITORING] Checking data freshness...");const u=await qi(t,s);for(const _ of u){if(i)try{await t.prepare(`
            INSERT INTO data_freshness 
            (data_source, timeframe, last_data_timestamp, last_fetch_at, data_age_minutes, is_stale, record_count)
            VALUES (?, ?, ?, datetime('now'), ?, ?, ?)
          `).bind(_.source,_.timeframe||null,_.lastTimestamp||null,_.ageMinutes,_.isStale?1:0,_.count||null).run()}catch(y){console.log("[MONITORING] Could not save freshness check:",y)}if(_.isStale&&i){const y=_.timeframe?`${_.source} (${_.timeframe})`:_.source;await Vt(t,"data_stale","high",y,`Data source ${y} is STALE. Last update: ${_.lastTimestamp||"unknown"}, Age: ${_.ageMinutes} minutes (threshold: ${s.data_stale_threshold_minutes} minutes)`,r)}}const f=l.filter(_=>_.status==="healthy").length,m=l.filter(_=>_.status==="degraded").length,p=l.filter(_=>_.status==="down").length,g=u.filter(_=>_.isStale).length,h=p>0?"critical":m>0||g>0?"degraded":"healthy";if(i)try{await t.prepare(`
        ...
        `).bind(f,m,p,g,l.reduce((_,y)=>_+y.response_time_ms,0)/l.length).run()}catch(_){console.log("[MONITORING] Could not save metrics:",_)}return console.log(`[MONITORING] Health check complete: ${h}`),console.log(`[MONITORING] Tables exist: ${i}, Alerts enabled: ${r}`),e.json({success:!0,timestamp:a,overall_status:h,summary:{endpoints:{healthy:f,degraded:m,down:p,total:l.length},data:{fresh:u.length-g,stale:g,total:u.length}},endpoints:l,data_freshness:u,config:{stale_threshold_minutes:s.data_stale_threshold_minutes,slow_response_threshold_ms:s.slow_response_threshold_ms,max_failure_count:s.max_failure_count,telegram_alerts_enabled:r}})}catch(s){return console.error("[MONITORING] Health check failed:",s),e.json({success:!1,error:s.message,timestamp:new Date().toISOString()},500)}});Ue.get("/status",async e=>{const{DB:t}=e.env;try{let s,n,a;try{s=await t.prepare(`
        SELECT 
          endpoint_name,
          status,
          response_time_ms,
      ...
      `).all(),a=await t.prepare(`
        ...
        ORDER BY created_at DESC
        LIMIT 10
      `).all()}catch{const r=new URL(e.req.url),d=`${r.protocol}//${r.host}`,c=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}];s={results:await Promise.all(c.map(async({name:f,url:m})=>{try{const p=Date.now(),g=await fetch(`${d}${m}`,{method:"GET",signal:AbortSignal.timeout(1e4)}),h=Date.now()-p;return{endpoint_name:f,status:g.ok?"healthy":"degraded",response_time_ms:h,last_check_at:new Date().toISOString()}}catch{return{endpoint_name:f,status:"down",response_time_ms:0,last_check_at:new Date().toISOString()}}}))};try{const f=await t.prepare(`
          SELECT 
            '1h' as data_source,
            '1h' as timeframe,
        ...
        `).all(),p=await t.prepare(`
          SELECT 
            ...
            datetime('now') as last_fetch_at
          FROM signals
        `).first();n={results:[...f?[f]:[],...m.results||[],...p?[p]:[]]}}catch(f){console.log("[MONITORING] Data freshness check error:",f.message),n={results:[]}}a={results:[]}}const i=(s.results||[]).every(l=>l.status==="healthy"),o=(n.results||[]).every(l=>l.is_stale===0);return e.json({success:!0,overall_status:i&&o?"healthy":"degraded",endpoints:s.results,data_sources:n.results,unresolved_alerts:a.results,alert_count:(a.results||[]).length})}catch(s){return e.json({success:!1,error:s.message},500)}});Ue.get("/alerts",async e=>{const{DB:t}=e.env,s=e.req.query("resolved")==="true";try{const n=await t.prepare(`
    ...
    `).all();return e.json({success:!0,period_hours:s,metrics:n.results})}catch(n){return e.json({success:!1,error:n.message},500)}});Ue.get("/config",async e=>{const{DB:t}=e.env;try{const s=await cn(t);return e.json({success:!0,config:s})}catch(s){return e.json({success:!1,error:s.message},500)}});Ue.post("/config",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
        ...
        WHERE config_key = ?
      `).bind(a,n).run();return e.json({success:!0,message:"Configuration updated"})}catch(n){return e.json({success:!1,error:n.message},500)}});const G=new be;G.use("/api/*",ta());G.route("/api/signals/enhanced",Gs);G.route("/api/signals/simple",Vs);G.route("/api/scanner",ct);G.route("/api/trades",we);G.route("/api/calendar",Fe);G.route("/api/backtest",mt);G.route("/api/telegram",rn);G.route("/api/ai",Ht);G.route("/api/monitoring",Ue);G.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>mn),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});G.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),o=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,r=await(await fetch(o)).json();if(r.code&&r.status==="error")return e.json({success:!1,error:r.message||"Twelve Data API error",count:0});if(!r.values||!Array.isArray(r.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const d=r.values,c=d.map(p=>t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(p.datetime,parseFloat(p.open)||0,parseFloat(p.high)||0,parseFloat(p.low)||0,parseFloat(p.close)||0,parseInt(p.volume||"0")||0,"1h"));await t.batch(c);const u=d.length,f=d[0],m=parseFloat(f.close)||0;return e.json({success:!0,count:u,price:m,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});G.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const o=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,r=await(await fetch(o)).json();if(r.code&&r.status==="error")return e.json({success:!1,error:r.message||"Twelve Data API error",count:0});if(!r.values||!Array.isArray(r.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=r.values.map(m=>({timestamp:m.datetime,open:parseFloat(m.open)||0,high:parseFloat(m.high)||0,low:parseFloat(m.low)||0,close:parseFloat(m.close)||0,volume:0})),u=c.map(m=>t.prepare(`
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume));await t.batch(u);const f=c.length;if(c.length>=50){const m=Ee(c.reverse());if(m){await t.prepare(`
        ...
        `).bind(m.rsi_14,m.macd,m.macd_signal,m.macd_histogram,m.sma_20,m.sma_50,m.sma_200,m.ema_12,m.ema_26,m.bb_upper,m.bb_middle,m.bb_lower,m.atr_14,m.stochastic_k,m.stochastic_d,m.adx,m.plus_di,m.minus_di,m.ichimoku_tenkan,m.ichimoku_kijun,m.ichimoku_senkou_a,m.ichimoku_senkou_b,m.parabolic_sar,m.vwap,m.fib_382||0,m.fib_500||0,m.fib_618||0).run();const p=c[c.length-1].close,g=le(p,m,"day_trade"),h=le(p,m,"swing_trade"),_=70;for(const y of[g,h])if(y.confidence>=_&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const w=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),E={};for(const T of w.results||[])E[T.setting_key]=T.setting_value;E.telegram_bot_token&&E.telegram_chat_id&&await K({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},lt(y))}}}return e.json({success:!0,count:f})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
    ...
    `).all(),n={};for(const S of s.results)n[S.setting_key]=S.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",i=n.telegram_bot_token,o=n.telegram_chat_id;console.log("[AUTO-FETCH] Settings loaded:",{hasApiKey:!!a,hasBotToken:!!i,botTokenLength:i?i.length:0,hasChatId:!!o,chatId:o});const d=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${a}&outputsize=100`,u=await(await fetch(d)).json();if(u.code&&u.status==="error")return e.json({success:!1,error:u.message||"API error",telegram_sent:!1});if(!u.values||!Array.isArray(u.values))return e.json({success:!1,error:"No data available",telegram_sent:!1});const m=u.values.map(S=>({timestamp:S.datetime,open:parseFloat(S.open)||0,high:parseFloat(S.high)||0,low:parseFloat(S.low)||0,close:parseFloat(S.close)||0,volume:parseInt(S.volume||"0")||0})),p=m.map(S=>t.prepare(`
        INSERT OR REPLACE INTO market_data (timestamp, open, high, low, close, volume, timeframe)
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(S.timestamp,S.open,S.high,S.low,S.close,S.volume,"1h"));await t.batch(p);const g=Ee(m);if(!g)return e.json({success:!0,count:m.length,message:"Data stored, but insufficient for indicators",telegram_sent:!1});let h=m[0].close,_=!1;try{console.log("[AUTO-FETCH] Fetching real-time price...");const D=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${a}`,{signal:AbortSignal.timeout(5e3)})).json();if(D.price){const I=parseFloat(D.price),R=h,j=Math.abs(I-R)/I*100;console.log(`[AUTO-FETCH] Real-time: $${I}, Last candle: $${R}, Diff: ${j.toFixed(2)}%`),j<2?(h=I,_=!0,console.log(`[AUTO-FETCH] ✅ Using real-time price: $${I}`)):console.log(`[AUTO-FETCH] ⚠️ Price diff too large (${j.toFixed(2)}%), using candle close`)}}catch(S){console.log("[AUTO-FETCH] Real-time price fetch failed, using candle close:",S.message)}const y=le(h,g,"day_trade"),w=le(h,g,"swing_trade");try{await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?)
...
⏰ ${new Date().toLocaleString()}`,j=await K({botToken:i,chatId:o},U);k.day_trade_send_result=j,console.log("[AUTO-FETCH] Day trade alert result:",j),j?(T=!0,b.push("Day Trade"),I&&y.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${D}
...
⏰ Don't miss this trade!`;await K({botToken:i,chatId:o},L),console.log("[AUTO-FETCH] First reminder sent")},120*1e3),setTimeout(async()=>{const L=`${D} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${D}
...
⏰ ${new Date().toLocaleString()}`,j=await K({botToken:i,chatId:o},U);k.swing_trade_send_result=j,j&&(T=!0,b.push("Swing Trade"),I&&w.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const L=`${D} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${D}
...
⏰ Don't miss this swing trade!`;await K({botToken:i,chatId:o},L),console.log("[AUTO-FETCH] Swing first reminder sent")},180*1e3),setTimeout(async()=>{const L=`${D} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${D}
...
🎯 TP1: $${w.take_profit_1.toFixed(2)}
🛡️ Stop: $${w.stop_loss.toFixed(2)}`;await K({botToken:i,chatId:o},L),console.log("[AUTO-FETCH] Swing final reminder sent")},420*1e3),b.push("High Conviction Swing Reminders (3+7min)")))}}else console.log("[AUTO-FETCH] Telegram NOT configured or invalid token");return console.log(`[CRON] Processed ${m.length} candles, Telegram: ${T?"SENT":"NOT SENT"}, Alerts: ${b.join(", ")}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:m.length,latest_price:h,data_timestamp:m[0].timestamp},signals:{day_trade:{type:y.signal_type,confidence:y.confidence,price:h},swing_trade:{type:w.signal_type,confidence:w.confidence,price:h}},telegram:{configured:!!(i&&o),bot_token_set:!!i,chat_id_set:!!o,bot_token_valid:i!=="your_bot_token_here",sent:T,alerts:b},debug:{...k,day_trade_check:{confidence:y.confidence,min_confidence:E,meets_threshold:y.confidence>=E,signal_type:y.signal_type,sends_all_signals:!0,should_alert:y.confidence>=E},swing_trade_check:{confidence:w.confidence,min_confidence:80,meets_threshold:w.confidence>=80,signal_type:w.signal_type,sends_all_signals:!0,should_alert:w.confidence>=80}},message:T?`✅ Alerts sent: ${b.join(", ")}`:"⚪ No alerts sent (signals below confidence threshold)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});G.get("/api/test/auto-fetch-settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings 
      WHERE setting_key IN ('twelve_data_api_key', 'telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const l of s.results)n[l.setting_key]=l.setting_value;const a=n.twelve_data_api_key||"70140f57bea54c5e90768de696487d8f",i=n.telegram_bot_token,o=n.telegram_chat_id;return e.json({success:!0,raw_results:s.results,config_object:n,extracted:{apiKey:a?`${a.substring(0,10)}...`:null,telegramBotToken:i?`${i.substring(0,10)}...`:null,telegramChatId:o,is_configured:!!(i&&o&&i!=="your_bot_token_here")}})}catch(s){return e.json({success:!1,error:s.message},500)}});G.get("/api/cron/auto-ai-scan",async e=>{var s,n,a;const{DB:t}=e.env;try{console.log("[AI-AUTO-SCAN] Starting automatic AI market analysis");const i=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'ai_auto_scan_enabled'
    `).first();if(!((i==null?void 0:i.setting_value)==="1"||(i==null?void 0:i.setting_value)==="true"))return console.log("[AI-AUTO-SCAN] Disabled in settings"),e.json({success:!0,message:"AI auto-scan is disabled",ai_scan_enabled:!1});const l=await((n=(s=e.env.app)==null?void 0:s.fetch)==null?void 0:n.call(s,new Request(new URL("/api/ai/market-analysis",e.req.url).toString(),{method:"POST"})));if(l){const r=await l.json();return console.log("[AI-AUTO-SCAN] Analysis complete:",r.success?"Success":"Failed"),e.json({success:!0,ai_scan_enabled:!0,analysis:r,message:(a=r.analysis)!=null&&a.telegram_sent?"🤖 AI analysis complete - Telegram alert sent":"🤖 AI analysis complete - No alert (confidence < 65% or HOLD)"})}return e.json({success:!1,error:"Failed to run AI analysis"},500)}catch(i){return console.error("[AI-AUTO-SCAN] Error:",i),e.json({success:!1,error:i.message},500)}});G.get("/api/cron/hedge-fund",async e=>{var s,n,a,i,o,l,r,d,c,u;const t=Date.now();try{console.log("[HEDGE-FUND-CRON] Starting hedge fund analysis");const f=await fetch(`${e.req.url.replace("/api/cron/hedge-fund","/api/signals/enhanced/enhanced")}`,{method:"POST",headers:{"Content-Type":"application/json"}});if(!f.ok)throw new Error(`Enhanced endpoint returned ${f.status}`);const m=await f.json();if(!m.success)return e.json({success:!1,error:m.error||"Enhanced signal generation failed",execution_time_ms:Date.now()-t});const p=m.day_trade,g=m.swing_trade,h=(p==null?void 0:p.enhanced_confidence)>=80||(g==null?void 0:g.enhanced_confidence)>=80;console.log("[HEDGE-FUND-CRON] Signal confidence:",{day:p==null?void 0:p.enhanced_confidence,swing:g==null?void 0:g.enhanced_confidence,shouldAlert:h});let _=!1;if(h){const{DB:w}=e.env,E=await w.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
*Entry:* $${p.price.toFixed(2)}
*Stop Loss:* $${p.stop_loss.toFixed(2)}
*TP1:* $${p.take_profit_1.toFixed(2)}
*TP2:* $${p.take_profit_2.toFixed(2)}
*TP3:* $${p.take_profit_3.toFixed(2)}
...
🌊 *Market Regime:* ${((o=m.regime)==null?void 0:o.volatility)||"UNKNOWN"}
...
${((u=m.regime)==null?void 0:u.should_trade)===!1?"⚠️ *WARNING: Extreme volatility detected*":""}

🌐 Dashboard: ${e.req.url.replace("/api/cron/hedge-fund","")}
        `.trim(),{sendTelegramMessage:k}=await Promise.resolve().then(()=>js);_=await k({botToken:T.telegram_bot_token,chatId:T.telegram_chat_id},b),console.log("[HEDGE-FUND-CRON] Telegram alert sent:",_)}}const y=Date.now()-t;return e.json({success:!0,message:h?`Hedge fund signal generated and ${_?"sent":"failed to send"} to Telegram`:"Signal confidence below 80% threshold - no alert sent",confidence:{day_trade:(p==null?void 0:p.enhanced_confidence)||0,swing_trade:(g==null?void 0:g.enhanced_confidence)||0},telegram_sent:_,threshold:80,execution_time_ms:y,timestamp:new Date().toISOString()})}catch(f){return console.error("[HEDGE-FUND-CRON] Error:",f),e.json({success:!1,error:f.message,execution_time_ms:Date.now()-t},500)}});G.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let o=0;const l={};for(const r of i){const d=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${r.interval}&apikey=${n}&outputsize=${r.outputsize}`,u=await(await fetch(d)).json();if(u.code&&u.status==="error"){l[r.dbKey]={success:!1,error:u.message,count:0};continue}if(!u.values||!Array.isArray(u.values)){l[r.dbKey]={success:!1,error:"No data",count:0};continue}const f=u.values;let m=0;const p=[];for(const g of f){const h={timestamp:g.datetime,open:parseFloat(g.open)||0,high:parseFloat(g.high)||0,low:parseFloat(g.low)||0,close:parseFloat(g.close)||0,volume:0};p.push(h),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(h.timestamp,h.open,h.high,h.low,h.close,h.volume,r.dbKey).run(),m++}if(p.length>=50){const g=Ee(p.reverse());g&&await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(r=>({timestamp:r.timestamp,open:r.open,high:r.high,low:r.low,close:r.close,volume:r.volume})),a=Ee(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,o=le(i,a,"day_trade"),l=le(i,a,"swing_trade");return e.json({success:!0,signals:{day_trade:o,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Qt),i=["5m","15m","1h","4h","daily"],o={};for(const b of i){const k=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const d=r.close,c=s(o,d),u=o["1h"],f=le(d,u,"day_trade"),m=le(d,u,"swing_trade"),p=n(f.signal_type,c),g=n(m.signal_type,c),h={...f,base_confidence:f.confidence,mtf_confidence:p.confidence,final_confidence:Math.min(95,p.confidence),isValid:p.isValid,mtf_reason:p.reason,alignment_score:c.score,alignment_type:c.type,reason:`${f.reason}, MTF: ${p.reason}`},_={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:c.score,alignment_type:c.type,reason:`${m.reason}, MTF: ${g.reason}`},y=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),w={};for(const b of y.results||[])w[b.setting_key]=b.setting_value;let E=!1,T=[];w.telegram_bot_token&&w.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await K({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...h,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(T.push("day_trade"),E=!0),await new Promise(b=>setTimeout(b,1e3)),_.isValid&&_.signal_type!=="HOLD"&&await K({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({..._,timestamp:new Date().toISOString()})}

📊 ${a(c)}`)&&(T.push("swing_trade"),E=!0));for(const b of[h,_])b.isValid&&await t.prepare(`
    ...
    `).all();let n="";for(const E of s.results||[])E.setting_key==="twelve_data_api_key"&&(n=E.setting_value);let a,i=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const E=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,b=await(await fetch(E)).json();b.values&&b.values.length>=50?(a=b.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open)||0,high:parseFloat(k.high)||0,low:parseFloat(k.low)||0,close:parseFloat(k.close)||0,volume:parseFloat(k.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(E){console.error("[GENERATE-NOW] API fetch failed:",E.message)}}if(!a||a.length===0){console.log("[GENERATE-NOW] Using database data (may be stale)");const E=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!E.results||E.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});a=E.results.reverse().map(T=>({timestamp:T.timestamp,open:T.open,high:T.high,low:T.low,close:T.close,volume:T.volume}))}const o=Ee(a);if(!o)return e.json({success:!1,error:"Failed to calculate indicators"});let l=a[a.length-1].close,r=!1;if(n&&n!=="your_api_key_here")try{console.log("[GENERATE-NOW] Fetching real-time price...");const T=await(await fetch(`https://api.twelvedata.com/price?symbol=XAU/USD&apikey=${n}`,{signal:AbortSignal.timeout(5e3)})).json();if(T.price){const b=parseFloat(T.price),k=l,D=Math.abs(b-k)/b*100;console.log(`[GENERATE-NOW] Real-time: $${b}, Last candle: $${k}, Diff: ${D.toFixed(2)}%`),l=b,r=!0}}catch(E){console.log("[GENERATE-NOW] Real-time price fetch failed, using candle close:",E.message)}const d=le(l,o,"day_trade"),c=le(l,o,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",d.signal_type,"Swing:",c.signal_type);const u=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),f={};for(const E of u.results||[])f[E.setting_key]=E.setting_value;let m=!1,p=[];const g=a.slice(-20),h=g.map(E=>E.high).sort((E,T)=>T-E),_=g.map(E=>E.low).sort((E,T)=>E-T),y=h.length>=3?[h[0],h[1],h[2]]:h.length>=1?[h[0]]:[],w=_.length>=3?[_[0],_[1],_[2]]:_.length>=1?[_[0]]:[];console.log("[GENERATE-NOW] S/R calculated - Resistance:",y,"Support:",w),f.telegram_bot_token&&f.telegram_chat_id&&(await K({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},lt({...d,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(p.push("day_trade"),m=!0),await new Promise(b=>setTimeout(b,1e3)),await K({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},lt({...c,timestamp:new Date().toISOString(),resistance:y,support:w}))&&(p.push("swing_trade"),m=!0));for(const E of[d,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(s).first();return n?e.json({success:!0,account:n}):e.json({success:!1,error:"Account not found"},404)}catch(n){return e.json({success:!1,error:n.message},500)}});G.post("/api/trading/calculate-position",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal:a}=s,i=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!i)return e.json({success:!1,error:"Account not found"},404);const o=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = ? AND is_active = 1
      ORDER BY confidence_min DESC
    `).bind(n).all(),{calculatePositionSize:l,formatPositionSize:r}=await Promise.resolve().then(()=>ut),d=l(i,a,o.results);return e.json({success:!0,position:d,formatted:r(d)})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/trading/execute",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal_id:a,entry_price:i,stop_loss:o,take_profit_1:l,take_profit_2:r,take_profit_3:d,position_size:c,signal_type:u,trading_style:f,confidence:m}=s,p=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!p)return e.json({success:!1,error:"Account not found"},404);const g=new Date().toISOString().split("T")[0],h=await t.prepare(`
      SELECT profit_loss FROM trades 
      WHERE account_id = ? 
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,g).all(),{checkDailyLossLimit:_}=await Promise.resolve().then(()=>ut),y=_(p,h.results);if(y.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${y.current_loss_pct}% (max ${p.max_daily_loss_pct}%)`},400);const w=c*i,E=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(n,a||null,u,f,i,c,w,o,l,r,d,m).run();return e.json({success:!0,trade_id:E.meta.last_row_id,message:"Trade executed successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});G.post("/api/trading/close/:trade_id",async e=>{const{DB:t}=e.env,s=e.req.param("trade_id");try{const n=await e.req.json(),{exit_price:a,exit_reason:i}=n,o=await t.prepare(`
      SELECT * FROM trades WHERE id = ?
    `).bind(s).first();if(!o)return e.json({success:!1,error:"Trade not found"},404);if(o.status==="CLOSED")return e.json({success:!1,error:"Trade already closed"},400);const{calculateProfitLoss:l}=await Promise.resolve().then(()=>ut),r=l(o.entry_price,a,o.position_size,o.trade_type,o.commission||0);return await t.prepare(`
      UPDATE trades 
      SET exit_price = ?,
    ...
    `).bind(a,i,r.profit_loss,r.profit_loss_pct,r.pips,s).run(),await t.prepare(`
      ...
      SET current_balance = current_balance + ?,
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(r.profit_loss,o.account_id).run(),e.json({success:!0,profit_loss:r.profit_loss,profit_loss_pct:r.profit_loss_pct,pips:r.pips})}catch(n){return e.json({success:!1,error:n.message},500)}});G.get("/api/trading/trades/open",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1";try{const n=await t.prepare(`
      SELECT * FROM trades 
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>ut),i=a(n.results);return e.json({success:!0,stats:i})}catch(n){return e.json({success:!1,error:n.message},500)}});G.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    ...
    `).first(),o=!n&&(i==null?void 0:i.count)>0;let l=0;if(o)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const A=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),H=(A==null?void 0:A.setting_value)||"70140f57bea54c5e90768de696487d8f",P=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const M of P)try{const F=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${M.interval}&apikey=${H}&outputsize=100`,V=new AbortController,Q=setTimeout(()=>V.abort(),1e4),ee=await fetch(F,{signal:V.signal});clearTimeout(Q);const te=await ee.json();if(te.values&&Array.isArray(te.values)){const se=[];for(const x of te.values)se.push({timestamp:x.datetime,open:parseFloat(x.open)||0,high:parseFloat(x.high)||0,low:parseFloat(x.low)||0,close:parseFloat(x.close)||0,volume:0});for(const x of se)await t.prepare(`
                ...
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind(x.timestamp,x.open,x.high,x.low,x.close,x.volume,M.dbKey).run();if(se.length>=50){const x=Ee(se.reverse());x&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(M.dbKey,x.rsi_14,x.macd,x.macd_signal,x.macd_histogram,x.sma_20,x.sma_50,x.sma_200,x.ema_12,x.ema_26,x.bb_upper,x.bb_middle,x.bb_lower,x.atr_14,x.stochastic_k,x.stochastic_d,x.adx,x.plus_di,x.minus_di,x.ichimoku_tenkan,x.ichimoku_kijun,x.ichimoku_senkou_a,x.ichimoku_senkou_b,x.parabolic_sar,x.vwap,x.fib_382,x.fib_500,x.fib_618).run()}l+=te.values.length}await new Promise(se=>setTimeout(se,100))}catch(F){console.error(`[MTF] Error fetching ${M.dbKey}:`,F)}}a.steps[0].status="completed",a.steps[0].data={totalCandles:l},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:r,validateMultiTimeframeSignal:d,formatAlignmentReport:c}=await Promise.resolve().then(()=>Qt),u={};for(const A of["5m","15m","1h","4h","daily"]){const H=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(A).first();H&&(u[A]=H)}const f=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),m=(f==null?void 0:f.close)||0,g=((await t.prepare(`
      SELECT timestamp, open, high, low, close, volume FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 20
    `).all()).results||[]).map(A=>({timestamp:A.timestamp,open:A.open,high:A.high,low:A.low,close:A.close,volume:A.volume||1})).reverse(),h=r(u,m),_=u["1h"],y=ze(m,_,g,"day_trade"),w=ze(m,_,g,"swing_trade"),E=d(y.signal_type,h),T=d(w.signal_type,h),b={...y,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:h.score,alignment_type:h.type},k={...w,final_confidence:Math.min(95,T.confidence),isValid:T.isValid,mtf_reason:T.reason,alignment_score:h.score,alignment_type:h.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:b,swingTrade:k,alignment:h},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const S=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),D=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:I}=await Promise.resolve().then(()=>ut),R=I(S,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},D.results),U=I(S,{entry_price:k.price,stop_loss:k.stop_loss,take_profit_1:k.take_profit_1,take_profit_2:k.take_profit_2,take_profit_3:k.take_profit_3,confidence:k.final_confidence,signal_type:k.signal_type,trading_style:k.trading_style},D.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:R,swingPosition:U},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const j=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();O=await K({botToken:L.telegram_bot_token,chatId:L.telegram_chat_id},M)}if(a.steps[3].status=O?"completed":"failed",a.steps[3].data={telegramSent:O},b.isValid||k.isValid)for(const A of[b,k])A.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
        ...
        `).first(),H=(A==null?void 0:A.setting_value)||"70140f57bea54c5e90768de696487d8f",P=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const M of P)try{const F=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${M.interval}&apikey=${H}&outputsize=100`,V=new AbortController,Q=setTimeout(()=>V.abort(),1e4),ee=await fetch(F,{signal:V.signal});clearTimeout(Q);const te=await ee.json();if(te.values&&Array.isArray(te.values)){const se=[];for(const x of te.values)se.push({timestamp:x.datetime,open:parseFloat(x.open)||0,high:parseFloat(x.high)||0,low:parseFloat(x.low)||0,close:parseFloat(x.close)||0,volume:0});for(const x of se)await t.prepare(`
                ...
                `).bind(x.timestamp,x.open,x.high,x.low,x.close,x.volume,M.dbKey).run();if(se.length>=50){const{calculateIndicators:x}=await Promise.resolve().then(()=>is),N=x(se.reverse());N&&await t.prepare(`
                    ...
                    (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                     ...
                     parabolic_sar, vwap, fib_382, fib_500, fib_618)
                    VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                  `).bind(M.dbKey,N.rsi_14,N.macd,N.macd_signal,N.macd_histogram,N.sma_20,N.sma_50,N.sma_200,N.ema_12,N.ema_26,N.bb_upper,N.bb_middle,N.bb_lower,N.atr_14,N.stochastic_k,N.stochastic_d,N.adx,N.plus_di,N.minus_di,N.ichimoku_tenkan,N.ichimoku_kijun,N.ichimoku_senkou_a,N.ichimoku_senkou_b,N.parabolic_sar,N.vwap,N.fib_382,N.fib_500,N.fib_618).run()}i+=te.values.length}await new Promise(se=>setTimeout(se,100))}catch(F){console.error(`[MTF] Error fetching ${M.dbKey}:`,F)}}else i=0,a.steps[0].cached=!0}a.steps[0].status="completed",a.steps[0].data={totalCandles:i},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:o,validateMultiTimeframeSignal:l}=await Promise.resolve().then(()=>Qt),{generateSignal:r}=await Promise.resolve().then(()=>is),d={};for(const L of["5m","15m","1h","4h","daily"]){const O=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
    ...
    `).first(),u=(c==null?void 0:c.close)||0,m=((await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 20
    `).all()).results||[]).map(L=>({timestamp:L.timestamp,open:L.open,high:L.high,low:L.low,close:L.close,volume:L.volume||1})).reverse(),p=o(d,u),g=d["1h"],h=ze(u,g,m,"day_trade"),_=ze(u,g,m,"swing_trade"),y=l(h.signal_type,p),w=l(_.signal_type,p),E={...h,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:p.score,alignment_type:p.type},T={..._,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:p.score,alignment_type:p.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:E,swingTrade:T,alignment:p},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const b=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),k=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:S}=await Promise.resolve().then(()=>ut),D=S(b,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},k.results),I=S(b,{entry_price:T.price,stop_loss:T.stop_loss,take_profit_1:T.take_profit_1,take_profit_2:T.take_profit_2,take_profit_3:T.take_profit_3,confidence:T.final_confidence,signal_type:T.signal_type,trading_style:T.trading_style},k.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:D,swingPosition:I},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const R=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
💧 *LIQUIDITY ANALYSIS:*
${_.liquidity_score>=70?"🟢":_.liquidity_score>=50?"🟡":"🔴"} *Score:* ${_.liquidity_score}/100
🌐 *Session:* ${_.session} (${_.time_zone} LIQUIDITY)
📊 *Volume:* ${_.volume_trend} (${_.volume_percentile}%ile)
💰 *Spread:* ~${_.estimated_spread_pips} pips
📉 *Impact:* ~${_.price_impact_bps} bps ($100K)

💼 *POSITION SIZING:*
${_.position_size_multiplier>=1?"🟢":_.position_size_multiplier>=.75?"🟡":"🔴"} *Recommended:* ${(_.position_size_multiplier*100).toFixed(0)}% of normal size
${_.optimal_for_trading?"✅ *Status:* Optimal for trading":"⚠️ *Status:* Sub-optimal liquidity"}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim(),{sendTelegramMessage:P}=await Promise.resolve().then(()=>js);j=await P({botToken:U.telegram_bot_token,chatId:U.telegram_chat_id},H)}if(a.steps[3].status=j?"completed":"failed",a.steps[3].data={telegramSent:j},E.isValid||T.isValid)for(const L of[E,T])L.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
