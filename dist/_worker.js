...
`)}const zt=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:qt,determineTrend:Us,formatAlignmentReport:ta,validateMultiTimeframeSignal:Gt},Symbol.toStringTag,{value:"Module"}));function ss(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((o,i)=>o-i),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function sa(e,t){const s=ss(e,.95),n=ss(e,.99),a=t*s,o=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(o.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function na(e,t,s,n){const a=t-e,o=a/t*100;let i=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)i++;const l=o<=s,r=o>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(o.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:i}}function aa(e,t,s=5){let n=0;const a=[];for(const r of e){const d=Math.abs(r.entry_price-r.stop_loss)*r.position_size,m=d/t*100;n+=d,a.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(m.toFixed(2))})}const o=n/t*100,i=o<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(o.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:i,available_risk:parseFloat(l.toFixed(2)),positions:a}}function oa(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),n=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&n.push({index:r,value:s[r]});if(n.length<3)return null;const a=n.slice(-3),[o,i,l]=a;if(i.value>o.value&&i.value>l.value&&Math.abs(o.value-l.value)/o.value<.02){const c=Math.min(o.value,l.value)*.995,d=c-(i.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:65}}return null}function ia(e){if(e.length<20)return null;const s=e.slice(-20).map(i=>i.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const r=s[s.length-1],c=n[n.length-1]-n[0],d=r+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function ra(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),o=(Math.max(...s)-Math.min(...s))/Math.max(...s),i=n.slice(0,6),l=n.slice(-6),r=(Math.min(...l)-Math.min(...i))/Math.min(...i);if(o<.01&&r>.015){const c=Math.max(...s),d=t[t.length-1].close,m=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function la(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),n=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&n.push({index:r,value:s[r]});if(n.length<2)return null;const a=n.slice(-2),[o,i]=a;if(Math.abs(o.value-i.value)/o.value<.015){const r=Math.max(...s.slice(o.index,i.index))*1.005,c=r+(r-o.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+o.index,end_index:e.length-30+i.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:66}}return null}function ca(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),o=s[25];if(Math.abs(n-o)/n<.02&&a<n*.95){const l=s.slice(25),r=Math.min(...l),c=(o-r)/o;if(c>.01&&c<.05){const d=n-a,m=o+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function da(e){const t=[],s=oa(e);s&&t.push(s);const n=ia(e);n&&t.push(n);const a=ra(e);a&&t.push(a);const o=la(e);o&&t.push(o);const i=ca(e);i&&t.push(i);let l=0,r=0,c=0;for(const u of t)u.direction==="bullish"?(l++,c+=u.confidence):u.direction==="bearish"&&(r++,c+=u.confidence);let d="neutral",m=0;l>r?(d="bullish",m=Math.min(c/l/10,15)):r>l&&(d="bearish",m=Math.min(c/r/10,15));let p="";if(t.length===0)p="No significant chart patterns detected";else{const u=t.map(g=>g.pattern_type).join(", ");p=`Detected ${t.length} pattern(s): ${u}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(m.toFixed(1)),summary:p}}function ua(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function ma(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function pa(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function ga(e,t,s){const n=ua(t.atr_14,s),a=ma(t,s),o=pa(t,s);let i,l,r,c,d,m;const p=e.slice(-10),u=p.map(f=>f.volume||0),g=u.reduce((f,h)=>f+h,0)/u.length,y=(p[p.length-1].volume||0)>g*1.5;return n==="EXTREME"&&y?s>t.bb_upper&&t.rsi_14>60?(i="BREAKOUT",l=75,r=!0,c="Trend-following (aggressive entry)",d=1.3,m="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(i="BREAKDOWN",l=75,r=!1,c="Wait for stabilization",d=.5,m="Sharp breakdown in progress - avoid trading until dust settles"):(i="RANGING",l=50,r=!1,c="Wait for direction",d=.5,m="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(i="STRONG_UPTREND",l=90,r=!0,c="Trend-following (buy dips, trail stops)",d=1.5,m="Strong bullish trend confirmed - ideal for aggressive long positions"):(i="STRONG_DOWNTREND",l=90,r=!1,c="Stay in cash or short",d=.3,m="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(i="WEAK_UPTREND",l=70,r=!0,c="Trend-following (selective entries)",d=1,m="Moderate bullish trend - trade with normal position sizing"):(i="WEAK_DOWNTREND",l=70,r=!1,c="Reduce exposure or stay flat",d=.5,m="Moderate bearish trend - reduce risk or wait"):(i="RANGING",l=80,o>60?(r=!0,c="Mean-reversion (fade extremes)",d=.8,m="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,c="Wait for trend to develop",d=.5,m="Choppy market without clear opportunity - stay on sidelines")),{regime:i,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:o,should_trade:r,recommended_strategy:c,risk_adjustment:d,description:m}}function fa(e){const t=e.length;let s=0,n=0,a=0,o=0;for(let r=0;r<t;r++)s+=r,n+=e[r],a+=r*e[r],o+=r*r;const i=(t*a-s*n)/(t*o-s*s),l=(n-i*s)/t;return{slope:i,intercept:l}}function _a(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let o=n[0];for(let l=1;l<n.length;l++)o=(n[l]-o)*a+o;const i=(n[n.length-1]-n[n.length-10])/10;return o+i*s}function ha(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const i=n.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+i}function ya(e,t,s){const n=e[e.length-1].close;e.map(i=>i.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const o=a/100*s;return n+t.atr_14*o}function Ea(e,t){const s=e.map(p=>p.close),n=s[s.length-1],a=10,o=s.slice(-a),i=Math.min(...o),l=Math.max(...o),r=o.map(p=>(p-i)/(l-i));let c={index:0,similarity:-1/0};for(let p=a;p<s.length-a-t;p++){const u=s.slice(p-a,p),g=Math.min(...u),_=Math.max(...u),y=u.map(b=>(b-g)/(_-g));let f=0;for(let b=0;b<a;b++)f+=Math.pow(r[b]-y[b],2);const h=-f;h>c.similarity&&(c={index:p,similarity:h})}const m=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+m}function Bt(e,t,s){const n=[],a=[],o=e.map(T=>T.close),{slope:i,intercept:l}=fa(o.slice(-20)),r=i*(o.length-1+s)+l;n.push(r),a.push(1);const c=_a(e,12,s);n.push(c),a.push(1.5);const d=ha(e,s);n.push(d),a.push(1.2);const m=ya(e,t,s);n.push(m),a.push(1.8);const p=Ea(e,s);n.push(p),a.push(1.3);const u=a.reduce((T,L)=>T+L,0),_=n.reduce((T,L,A)=>T+L*a[A],0)/u,y=n.reduce((T,L)=>T+L,0)/n.length,f=n.reduce((T,L)=>T+Math.pow(L-y,2),0)/n.length,h=Math.sqrt(f),b=e[e.length-1].close,w=1-h/b,v=Math.max(50,Math.min(95,w*100));return{prediction:_,confidence:v}}function ba(e,t){const s=e[e.length-1].close,n=[],a=Bt(e,t,1),o=a.prediction-s,i=o/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:o>.5?"UP":o<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(i.toFixed(2)),method:"Ensemble (5 models)"});const l=Bt(e,t,4),r=l.prediction-s,c=r/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Bt(e,t,24),m=d.prediction-s,p=m/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:m>5?"UP":m<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(p.toFixed(2)),method:"Ensemble (5 models)"});const u=n.filter(h=>h.direction==="UP").length,g=n.filter(h=>h.direction==="DOWN").length;let _,y=0;u>g?(_="BULLISH",y=Math.min(u*5,15)):g>u?(_="BEARISH",y=Math.min(g*5,15)):_="NEUTRAL";const f=`ML models predict ${_} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:_,confidence_boost:parseFloat(y.toFixed(1)),summary:f}}function Pt(e,t,s,n,a){const i=Math.abs(t-e)/s;let l;i<1?l=80:i<2?l=65:i<3?l=50:i<4?l=35:l=20;const r=(n-50)/10;l+=r;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function wa(e,t,s,n,a){const i=Math.abs(e-t)/s;let l;if(i<1?l=60:i<1.5?l=40:i<2?l=25:l=15,a==="BUY"){const r=(n-50)/10;l-=r}else{const r=(n-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function va(e,t,s,n,a,o){const i=(s-e)*.5,l=(n-e)*.3,r=(a-e)*.2,c=t-e;return o.tp1/100*i+o.tp2/100*l+o.tp3/100*r+o.sl/100*c}function Ta(e,t,s){const n=e.price,a=t.atr_14;let o=50;e.signal_type==="BUY"?(n>t.sma_20&&(o+=10),n>t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(o+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(o+=10),n<t.sma_50&&(o+=10),t.adx>25&&(o+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(o+=10)),o=Math.min(100,o);const i=s.slice(-50),l=[];for(let b=14;b<i.length;b++){const w=i.slice(b-14,b);let v=0;for(let T=1;T<w.length;T++){const L=Math.max(w[T].high-w[T].low,Math.abs(w[T].high-w[T-1].close),Math.abs(w[T].low-w[T-1].close));v+=L}l.push(v/14)}const r=l.reduce((b,w)=>b+w,0)/l.length,c=a/r,d=Pt(n,e.take_profit_1,a,o,c),m=Pt(n,e.take_profit_2,a,o,c),p=Pt(n,e.take_profit_3,a,o,c),u=wa(n,e.stop_loss,a,o,e.signal_type),g=va(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:m,tp3:p,sl:u}),y=(d+m+p)/3/u;let f;d>70&&g>5&&y>2?f="STRONG_TRADE":d>60&&g>0&&y>1.5?f="GOOD_TRADE":d>50&&g>-2?f="MARGINAL_TRADE":f="AVOID_TRADE";const h=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${y.toFixed(2)}:1. Recommendation: ${f.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(m.toFixed(1)),tp3_probability:parseFloat(p.toFixed(1)),stop_loss_probability:parseFloat(u.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(y.toFixed(2)),recommendation:f,summary:h}}function Bs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=Sa(e),s=xa(),n=ka(e,s.session),a=La(t,s.session),o=Ra(t,s),i=Ia(t,s,n,o),l=$a(i,t,s,n),r=Aa(i);return{liquidity_score:Math.round(i),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(o),optimal_for_trading:i>=70&&l.length===0,warnings:l,recommendation:r}}function Sa(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,a=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,o=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,i=a/n;let l;a>o*1.2?l="INCREASING":a<o*.8?l="DECREASING":l="STABLE";const r=Math.min(100,i*100);return{avg_volume:n,current_volume:a,volume_ratio:i,volume_spike:i>2,volume_drought:i<.5,trend:l,percentile:r}}function xa(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,o;return n>=780&&n<960?(a="OVERLAP",o="HIGH"):n>=480&&n<780?(a="LONDON",o="HIGH"):n>=960&&n<1320?(a="NEW_YORK",o="HIGH"):n>=0&&n<480?(a="ASIA",o="MEDIUM"):(a="OFF_HOURS",o="LOW"),{zone:o,session:a}}function ka(e,t){const s=e.slice(-20);let n=0;for(const d of s){const m=d.high-d.low;n+=m}const a=n/s.length,o=s[s.length-1].close,i=a/o*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const r=1+i*2,c=l*r;return{spread_pips:Math.round(c)}}function La(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,o=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*o}function Ra(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function Ia(e,t,s,n){const a=e.percentile*.3,o=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,i=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+o+i+l}function $a(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function Aa(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Xt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Da(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Ot(e=30){const t=[],s=new Date;for(const a of Xt){const o=new Date(a),i=Math.floor((o.getTime()-s.getTime())/(1e3*60*60*24));i>=0&&i<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const o=new Date(s.getTime()+a*24*60*60*1e3),i=o.getFullYear(),l=o.getMonth(),r=o.getDate(),c=o.getDay();if(r===Da(i,l)&&c===5){const d=o.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:o.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&c>=1&&c<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&c>=1&&c<=5)&&t.push({date:o.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,o,i)=>o===i.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,o)=>{const i=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${o.date}T${o.time}:00Z`);return i.getTime()-l.getTime()})}function vt(e=new Date,t=[]){const s=[...Ot(7),...t],n=s.filter(i=>new Date(`${i.date}T${i.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(i=>i.date===a&&i.impact==="high"),Xt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Na(a)};new Date(e.getTime()+7200*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(i.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(i.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${i.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const o=new Date(e.getTime()-1800*1e3);for(const i of s){const l=new Date(`${i.date}T${i.time}:00Z`);if(i.impact==="high"&&l>o&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${i.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Na(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function $t(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Ma(e){const t=e.toISOString().split("T")[0];return Xt.includes(t)?!0:Ot(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Oa(){const e=new Date().toISOString().split("T")[0];return Ot(7).filter(s=>s.date===e)}function Ps(e=new Date){const t=vt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const js=new he;js.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const Y of["5m","15m","1h","4h","daily"]){const H=await t.prepare(`
      ...
      `).bind(Y).first();H&&(n[Y]=H);const Z=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).bind(Y).all();Z.results&&Z.results.length>0&&(a[Y]=Z.results.map(S=>({timestamp:S.timestamp,open:S.open,high:S.high,low:S.low,close:S.close,volume:S.volume||0})))}if(Object.keys(n).length<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${Object.keys(n).length}. Please fetch multi-timeframe data first.`},400);const o=[];if(n["1h"]&&n["1h"].timestamp){const Y=new Date(n["1h"].timestamp).getTime(),Z=(Date.now()-Y)/(1e3*60);Z>60?o.push(`⚠️ WARNING: 1h data is ${Z.toFixed(0)} minutes old (>60 min)`):Z>30&&o.push(`⚠️ CAUTION: 1h data is ${Z.toFixed(0)} minutes old (>30 min)`),console.log(`[ENHANCED] Data freshness: 1h indicators are ${Z.toFixed(1)} minutes old`)}const i=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(i==null?void 0:i.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(i!=null&&i.timestamp){const Y=new Date(i.timestamp).getTime(),H=(Date.now()-Y)/(1e3*60);H>60&&o.push(`⚠️ WARNING: Price data is ${H.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${H.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const r=vt(),c=Ps();let d=null,m=!1;r.riskLevel==="danger"?(m=!0,d=r.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",r.reason)):r.riskLevel==="caution"?(d=r.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",r.reason)):console.log("[ENHANCED] ✅ Calendar safe:",r.reason);const p=n["1h"];if(!p)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const u=qt(n,l),g=ae(l,p,"day_trade"),_=ae(l,p,"swing_trade"),y=Gt(g.signal_type,u),f=Gt(_.signal_type,u),h={...g,base_confidence:g.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:u.score,alignment_type:u.type},b={..._,base_confidence:_.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:u.score,alignment_type:u.type};let w=0,v="",T=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const H=da(a["1h"]);T=(H==null?void 0:H.patterns)||[]}catch(H){console.error("[ENHANCED] Pattern detection error:",H.message)}const Y=T.filter(H=>H.confidence>=70&&H.endIndex>=a["1h"].length-5);for(const H of Y)H.type==="bullish"&&h.signal_type==="BUY"?(w+=H.confidence*.1,v+=`${H.name} (${H.confidence.toFixed(0)}%), `):H.type==="bearish"&&h.signal_type==="SELL"&&(w+=H.confidence*.1,v+=`${H.name} (${H.confidence.toFixed(0)}%), `);w=Math.min(15,w)}let L=0,A="",M=null;if(a["1h"]&&a["1h"].length>=50){const Y=_e(a["1h"]);Y&&(M=ga(a["1h"],Y),M.trend==="STRONG_UPTREND"&&h.signal_type==="BUY"?(L=10,A="Strong Uptrend"):M.trend==="UPTREND"&&h.signal_type==="BUY"?(L=5,A="Uptrend"):M.trend==="STRONG_DOWNTREND"&&h.signal_type==="SELL"?(L=10,A="Strong Downtrend"):M.trend==="DOWNTREND"&&h.signal_type==="SELL"&&(L=5,A="Downtrend"))}let k=0,N="",x=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{x=ba(a["1h"],l),x.overall_direction==="BULLISH"&&h.signal_type==="BUY"?(k=x.confidence_boost,N=`ML predicts +${((x.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):x.overall_direction==="BEARISH"&&h.signal_type==="SELL"&&(k=x.confidence_boost,N=`ML predicts ${((x.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(Y){console.error("[ENHANCED] ML prediction error:",Y.message)}let F=0,C="",O=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const Y=_e(a["1h"]);Y&&(O=Ta(h,Y,a["1h"]),O.tp1_probability>70?(F=10,C=`PoP: TP1 ${O.tp1_probability.toFixed(0)}%`):O.tp1_probability>60&&(F=5,C=`PoP: TP1 ${O.tp1_probability.toFixed(0)}%`))}catch(Y){console.error("[ENHANCED] Probability of Profit error:",Y.message)}let R=null,G=0,z=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{R=Bs(a["1h"]),R.liquidity_score>=80?G=5:R.liquidity_score>=70?G=0:R.liquidity_score>=50?z=-5:z=-10,console.log(`[LIQUIDITY] Score: ${R.liquidity_score}/100, Session: ${R.session}, Adjust: ${G+z}%`)}catch(Y){console.error("[ENHANCED] Liquidity Analysis error:",Y.message)}let I=0,W=0,K=0,ee=0,te="";try{const Y=await t.prepare(`
      ...
      `).all(),Z=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(Y&&H.results&&H.results.length>=10){const S=sa(H.results,Y.balance);I=S.var_95,W=S.var_99;const re=na(Y.balance,H.results);if(K=re.current_drawdown_pct,re.is_within_limit||(te+=`⚠️ Drawdown ${K.toFixed(1)}% exceeds limit. `),Z.results){const Ee=aa(Z.results,Y.balance);ee=Ee.total_risk_pct,Ee.is_within_limit||(te+=`⚠️ Portfolio heat ${ee.toFixed(1)}% exceeds limit. `)}}}catch(Y){console.error("[ENHANCED] Risk metrics error (optional):",Y.message)}const $=w+L+k+F+G+z,D={...h,pattern_boost:w,regime_boost:L,ml_boost:k,pop_boost:F,total_boost:$,enhanced_confidence:Math.min(98,h.final_confidence+$),var_95:I,var_99:W,current_drawdown_pct:K,portfolio_heat_pct:ee,risk_warning:te||null},P={...b,pattern_boost:w,regime_boost:L,ml_boost:k,pop_boost:F,total_boost:$,enhanced_confidence:Math.min(98,b.final_confidence+$),var_95:I,var_99:W,current_drawdown_pct:K,portfolio_heat_pct:ee,risk_warning:te||null};m?(D.signal_type="HOLD",P.signal_type="HOLD",D.enhanced_confidence=50,P.enhanced_confidence=50,D.reasoning=d||"Economic event nearby - trading paused",P.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(D.enhanced_confidence=Math.max(50,D.enhanced_confidence+c.adjustment),P.enhanced_confidence=Math.max(50,P.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),D.calendar_check={risk_level:r.riskLevel,should_trade:r.shouldTrade,reason:r.reason,confidence_adjustment:c.adjustment,upcoming_events:r.upcomingEvents.slice(0,3).map(Y=>$t(Y))},P.calendar_check=D.calendar_check;let xe=!1;try{const Y=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),H={};for(const Z of Y.results||[])H[Z.setting_key]=Z.setting_value;if(H.telegram_bot_token&&H.telegram_chat_id){const Z=new Date().toLocaleString("en-US",{timeZone:"UTC"});let S=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${Z} UTC

`;if(o.length>0){S+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const Q of o)S+=`${Q}
...
`;for(const Q of u.trends){const ue=Q.trend==="BULLISH"?"📈":Q.trend==="BEARISH"?"📉":"➡️";S+=`${ue} *${Q.timeframe}*: ${Q.trend} (${Q.confidence.toFixed(0)}%)
`}S+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,S+=`📈 *DAY TRADE SIGNAL*
`,S+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`;const re=candles1h.slice(-20),Ee=re.map(Q=>Q.high).sort((Q,ue)=>ue-Q),Ve=re.map(Q=>Q.low).sort((Q,ue)=>Q-ue),ke=Ee.slice(0,3),se=Ve.slice(0,3);if(S+=`📊 *Key Levels:*
`,S+=`🔴 *Resistance:* ${ke.map(Q=>`$${Q.toFixed(2)}`).join(", ")}
`,S+=`🟢 *Support:* ${se.map(Q=>`$${Q.toFixed(2)}`).join(", ")}
...
`),F>0&&(S+=`PoP: +${F.toFixed(0)}%
`),G!==0||z!==0){const Q=G+z;S+=`Liquidity: ${Q>=0?"+":""}${Q.toFixed(0)}%
...
`),S+=`
`),O&&(S+=`🎯 *Probability of Profit:*
`,S+=`TP1: ${O.tp1_probability.toFixed(0)}%
`,S+=`TP2: ${O.tp2_probability.toFixed(0)}%
`,S+=`TP3: ${O.tp3_probability.toFixed(0)}%
`,S+=`Expected Value: ${O.expected_value.toFixed(2)}R
...
`),S+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",S.length,"characters");const Tt=await X({botToken:H.telegram_bot_token,chatId:H.telegram_chat_id},S);let V=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if(R){const Q=R.liquidity_score>=80?"🟢":R.liquidity_score>=70?"🟡":R.liquidity_score>=50?"🟠":"🔴";if(V+=`🌊 *LIQUIDITY ANALYSIS*
`,V+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,V+=`${Q} *Score:* ${R.liquidity_score}/100
`,V+=`🕐 *Session:* ${R.session}
`,V+=`📊 *Time Zone:* ${R.time_of_day_zone} LIQUIDITY
`,V+=`📈 *Volume:* ${R.volume_trend} (${R.volume_percentile}%)
`,V+=`💰 *Spread:* ~${R.estimated_spread_pips} pips
`,V+=`📉 *Price Impact:* ~${R.price_impact_bps} bps per $100k
`,V+=`🎯 *Market Depth:* ${R.market_depth_score}/100
`,V+=`✅ *Optimal:* ${R.optimal_for_trading?"YES":"NO"}

`,R.warnings.length>0){V+=`⚠️ *Liquidity Warnings:*
`;for(const ue of R.warnings)V+=`• ${ue}
`;V+=`
`}V+=`💡 *Recommendation:*
${R.recommendation}
...
`,V+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",V.length,"characters");const ut=await X({botToken:H.telegram_bot_token,chatId:H.telegram_chat_id},V);xe=Tt&&ut}}catch(Y){console.error("[ENHANCED] Telegram error (optional):",Y.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:xe,day_trade:D,swing_trade:P,alignment:{type:u.type,score:u.score,trends:u.trends},patterns:T.length>0?T.slice(0,3):null,regime:M?{trend:M.trend,volatility:M.volatility,should_trade:M.should_trade}:null,ml_prediction:x?{direction:x.overall_direction,predictions:x.predictions}:null,profit_probability:O?{tp1:O.tp1_probability,tp2:O.tp2_probability,tp3:O.tp3_probability,expected_value:O.expected_value}:null,liquidity:R?{score:R.liquidity_score,session:R.session,time_zone:R.time_of_day_zone,volume_trend:R.volume_trend,volume_percentile:R.volume_percentile,estimated_spread_pips:R.estimated_spread_pips,price_impact_bps:R.price_impact_bps,market_depth_score:R.market_depth_score,optimal_for_trading:R.optimal_for_trading,warnings:R.warnings,recommendation:R.recommendation}:null,risk_metrics:{var_95:I,var_99:W,drawdown_pct:K,portfolio_heat_pct:ee}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Ws=new he;Ws.post("/simple",async e=>{var s,n,a,o;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const i=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,b+=`⏰ ${h}`,console.log("[SIMPLE] Sending Telegram message, length:",b.length),g=await X({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},b),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(_){console.error("[SIMPLE] Telegram error:",_.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:g,day_trade:{signal_type:p.signal_type,confidence:Number(p.confidence),price:Number(c),stop_loss:Number(p.stop_loss),take_profit_1:Number(p.take_profit_1),take_profit_2:Number(p.take_profit_2),take_profit_3:Number(p.take_profit_3),reason:String(p.reason),trading_style:"day_trade"},swing_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"swing_trade"}})}catch(i){return console.error("[SIMPLE] Error:",i.message,i.stack),e.json({success:!1,error:i.message,stack:i.stack},500)}});function Fa(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Ca(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Ha(e,t){return e>t*1.1}function Ua(e){let t=0,s=0,n=0;for(const l of e){const r=l.volume||0;n+=r,l.close>l.open?t+=r:l.close<l.open&&(s+=r)}const a=s>0?t/s:t>0?10:1;let o="NEUTRAL";a>1.5?o="BUYING":a<.67&&(o="SELLING");let i=0;return a>3?i=100:a>1.5?i=50+(a-1.5)/1.5*50:a>.67?i=(a-.67)/.83*50:a>.33?i=50+(.67-a)/.34*50:i=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:o,strength:Math.round(i)}}function Ys(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Ba(e,t){const n=Ys(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Pa(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return ja(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Wa(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Ya(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Ga(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Va(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),qa(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),za(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),Xa(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Ka(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Za(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function ja(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Wa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Ya(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Ga(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Va(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close<e.open,l=s.close>s.open;return i&&a<n*.5&&l&&o>n*.6&&s.close>(e.open+e.close)/2}function qa(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),i=e.close>e.open,l=s.close<s.open;return i&&a<n*.5&&l&&o>n*.6&&s.close<(e.open+e.close)/2}function za(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,o=t.low>e.low&&s.low>t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&o&&i>c&&l>c&&r>c}function Xa(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,o=t.low<e.low&&s.low<t.low,i=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&o&&i>c&&l>c&&r>c}function Ka(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Za(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function Ja(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function Qa(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),m=Math.max(...d.map(u=>u.high)),p=Math.min(...d.map(u=>u.low));s.push({level:m,type:"RESISTANCE",strength:85,distance:m-t,distancePercent:(m-t)/t*100}),s.push({level:p,type:"SUPPORT",strength:85,distance:t-p,distancePercent:(t-p)/t*100})}const n=e.slice(-50),a=ns(n,"HIGH"),o=ns(n,"LOW");if(a.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),o.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),eo(t).forEach(d=>{const m=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:m,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),m=to(d);s.push({level:m.pp,type:"PIVOT",strength:80,distance:Math.abs(m.pp-t),distancePercent:Math.abs(m.pp-t)/t*100}),s.push({level:m.r1,type:"RESISTANCE",strength:70,distance:m.r1-t,distancePercent:(m.r1-t)/t*100}),s.push({level:m.s1,type:"SUPPORT",strength:70,distance:t-m.s1,distancePercent:(t-m.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const r=l.reduce((d,m)=>Math.abs(m.distancePercent)<Math.abs(d.distancePercent)?m:d),c=so(e,t,r);return{nearZone:!0,closestZone:r,zoneType:r.type,action:c,strength:r.strength,description:no(r,c)}}function ns(e,t){const s=[];for(let o=5;o<e.length-5;o++){const i=t==="HIGH"?e[o].high:e[o].low;let l=!0;for(let r=o-5;r<=o+5;r++){if(r===o)continue;const c=t==="HIGH"?e[r].high:e[r].low;if(t==="HIGH"&&c>=i){l=!1;break}if(t==="LOW"&&c<=i){l=!1;break}}l&&s.push(i)}return Array.from(new Set(s)).slice(-3)}function eo(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function to(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),n=e[e.length-1].close,a=(t+s+n)/3,o=2*a-s,i=2*a-t,l=a+(t-s),r=a-(t-s);return{pp:a,r1:o,s1:i,r2:l,s2:r}}function so(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function no(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function ao(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function oo(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=io(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const o=ro(s,a),i=lo(s,a);return o.type!=="NONE"&&i.type===o.type?{type:o.type,category:o.category,indicator:"BOTH",strength:95,description:`${o.type} ${o.category} (RSI+MACD)`,confidence:90}:o.type!=="NONE"?{type:o.type,category:o.category,indicator:"RSI",strength:80,description:`${o.type} ${o.category} (RSI)`,confidence:75}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"MACD",strength:70,description:`${i.type} ${i.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function io(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const o=e[a];let i=!0;for(let r=a-2;r<=a+2;r++)if(r!==a&&e[r].high>=o.high){i=!1;break}i&&t.push({index:a,price:o.high});let l=!0;for(let r=a-2;r<=a+2;r++)if(r!==a&&e[r].low<=o.low){l=!1;break}l&&s.push({index:a,price:o.low})}return{highs:t,lows:s}}function ro(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,o=e[n.index].rsi,i=e[a.index].rsi;if(a.price<n.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,o=e[n.index].rsi,i=e[a.index].rsi;if(a.price>n.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function lo(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,o=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price<n.price&&i>o)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&i<o)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,o=e[n.index].macd_histogram,i=e[a.index].macd_histogram;if(a.price>n.price&&i<o)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&i>o)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function co(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function uo(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,o=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${o}, ${e.strength}/100)`}function mo(e,t,s,n){const a=(y,f)=>{const h=parseFloat(String(y));return isNaN(h)?f:h},o=a(e.ema_12,n),i=a(t.ema_26,n),l=a(s.sma_200,n),r=jt(n,o),c=jt(n,i),d=jt(n,l),m=r===c&&c===d&&r!=="NEUTRAL",p=r===c&&r!=="NEUTRAL"||r===d&&r!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let u=0,g="",_="";return m?(u=100,g=`ALL ${r}`,_=`All 3 timeframes ${r.toLowerCase()} (perfect alignment)`):p?(u=65,r===c?(g=`5M+15M ${r}`,_=`5m & 15m ${r.toLowerCase()} (1h ${d.toLowerCase()})`):r===d?(g=`5M+1H ${r}`,_=`5m & 1h ${r.toLowerCase()} (15m ${c.toLowerCase()})`):(g=`15M+1H ${c}`,_=`15m & 1h ${c.toLowerCase()} (5m ${r.toLowerCase()})`)):(u=30,g="MIXED",_=`Mixed signals: 5m ${r.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:r,tf15m:c,tf1h:d,allAligned:m,twoAligned:p,alignment:g,strength:u,description:_}}function jt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function po(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function go(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function fo(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,o=(s.close-n.close)/n.close*100;let i="FLAT";o>.1?i="UP":o<-.1&&(i="DOWN");let l="NEUTRAL";i==="DOWN"?l="BULLISH":i==="UP"&&(l="BEARISH");const r=Math.abs(o);let c=-.8,d=0;r>.3?d=90:r>.2?d=75:r>.1?d=60:d=40;const m=new Date(s.timestamp),u=Math.floor((new Date().getTime()-m.getTime())/6e4),g=ho(a,o,i,l,d);return{dxyPrice:a,dxyChange:o,dxyTrend:i,goldSignalSupport:l,correlation:c,strength:d,description:g,dataAge:u}}function _o(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function ho(e,t,s,n,a){const o=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${o} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${o} → Gold BEARISH (${a}/100)`:`DXY flat ${o} → Neutral (${a}/100)`}async function yo(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(o=>({close:parseFloat(o.close),timestamp:o.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function Eo(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function Mo(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function Oo(e){const t=await Mo(e);if(t){const n=new Date(t.timestamp),o=(new Date().getTime()-n.getTime())/(1e3*60*60*24);if(o<7)return console.log(`[COT] Using cached data (${o.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await Do();return s?(await No(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Fo(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const rt=new he;rt.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER] Starting scan at",n),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});rt.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const c of s.results||[])n[c.setting_key]=c.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,o=15,i={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-o,tp1:a+o*2,tp2:a+o*3,tp3:a+o*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Vs(i,a),r=await X({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:r,message:r?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Gs(e,t,s,n,a,o){console.log("[ANALYZE] Starting analysis");let i=0,l=0;const r=[],c=(ne,ze)=>{const xt=parseFloat(String(ne));return isNaN(xt)?ze:xt};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,o),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},m={ema50:c(s.ema_26,o)},p={sma200:c(n.sma_200,o)},u=o>d.ema20&&o>m.ema50&&o>p.sma200,g=o<d.ema20&&o<m.ema50&&o<p.sma200;u||g?(i+=20,l++,r.push(`✅ Layer 1: Trend Aligned (${u?"BULLISH":"BEARISH"})`)):r.push("❌ Layer 1: Trend NOT aligned (conflicting)");const _=d.rsi>=40&&d.rsi<=60,y=d.macd>d.macd_signal&&d.macd_histogram>0,f=d.macd<d.macd_signal&&d.macd_histogram<0;_&&(u?y:f)?(i+=15,l++,r.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${u?"bullish":"bearish"} crossover`)):r.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${_?"no crossover":"extreme"}`);const h=a.slice(-20).reduce((ne,ze)=>ne+ze.volume,0)/20,b=a[a.length-1].volume;b>h*1.5?(i+=15,l++,r.push(`✅ Layer 3: Volume spike ${(b/h).toFixed(1)}x average`)):r.push(`❌ Layer 3: Volume ${(b/h).toFixed(1)}x (need 1.5x+)`);const v=Math.max(...a.slice(-20).map(ne=>ne.high)),T=Math.min(...a.slice(-20).map(ne=>ne.low)),L=o>v*.999,A=o<T*1.001;u&&L||g&&A?(i+=15,l++,r.push(`✅ Layer 4: ${u?"Broke above resistance":"Broke below support"}`)):r.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let M=null;try{M=await Bs(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(ne){console.log("[5M-SCANNER] Liquidity calc failed:",ne)}const k=(M==null?void 0:M.liquidity_score)||50,N=(M==null?void 0:M.session)||"UNKNOWN";k>=70?(i+=15,l++,r.push(`✅ Layer 5: Liquidity ${k}/100 (${N} session)`)):r.push(`❌ Layer 5: Liquidity ${k}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const F=vt();console.log("[ANALYZE] Calendar check complete"),F.riskLevel==="safe"?(i+=10,l++,r.push("✅ Layer 6: No major news")):r.push(`❌ Layer 6: ${F.reason}`);const O=d.adx>25,R=d.adx>70;O&&!R?(i+=10,l++,r.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):R?r.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):r.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let G="HOLD";(u||g)&&l>=5&&(G=u?"BUY":"SELL");const z=new Date,I=Fa(z);I.hasBoost?(i+=8,l++,r.push(`✅ Layer 8: ${I.reason} (+${I.boost}% win)`)):r.push(`ℹ️ Layer 8: ${I.reason}`);const W=Ca(z);W.hasBoost?(i+=5,l++,r.push(`✅ Layer 9: ${W.reason} (+${W.boost}% win)`)):r.push(`ℹ️ Layer 9: ${W.reason}`);const K=c(t.atr_14,o*.01),ee=a.slice(-20).reduce((ne,ze)=>{const xt=ze.high-ze.low;return ne+xt},0)/20;if(Ha(K,ee)){i+=7,l++;const ne=((K/ee-1)*100).toFixed(1);r.push(`✅ Layer 10: ATR expanding ${ne}% (high volatility)`)}else{const ne=((1-K/ee)*100).toFixed(1);r.push(`❌ Layer 10: ATR compressed ${ne}% (skip low volatility)`)}const $=Ua(a.slice(-20));Ys($,G)&&$.strength>=60&&(i+=10,l++),r.push(Ba($,G));const P=Pa(a.slice(-3)),{aligned:xe,strongestPattern:Y}=Ja(P,G);xe&&Y?(i+=12,l++,r.push(`✅ Layer 12: ${Y.name} (${Y.strength}/100)`)):P.length>0&&P[0].type==="INDECISION"?r.push(`⚠️ Layer 12: ${P[0].name} (indecision, wait)`):r.push("❌ Layer 12: No clear candlestick pattern");const H=Qa(a,o);ao(H,G)&&H.nearZone?(i+=8,l++,r.push(`✅ Layer 13: ${H.description}`)):H.nearZone?r.push(`⚠️ Layer 13: ${H.description} (not aligned)`):r.push("ℹ️ Layer 13: No key zones nearby");const re=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(ne=>({rsi:parseFloat(String(ne.rsi))||50,macd:parseFloat(String(ne.macd))||0,macd_histogram:parseFloat(String(ne.macd_histogram))||0})).reverse(),Ee=oo(re,a.slice(-10)),ke=co(Ee,G,u?"BULLISH":g?"BEARISH":"NEUTRAL");ke&&Ee.strength>=70&&(i+=9,l++),r.push(uo(Ee,ke));const se=mo(t,s,n,o),Tt=po(se,G);Tt&&(se.allAligned||se.twoAligned)&&(i+=6,l++),r.push(go(se,Tt));const V=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),ut=(V==null?void 0:V.setting_value)||"70140f57bea54c5e90768de696487d8f",Q=await wo(e,ut,15),ue=fo(Q);_o(ue,G)&&ue.strength>=60?(i+=5,l++,r.push(`✅ Layer 18: ${ue.description}`)):ue.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 18: ${ue.description} (not aligned)`):r.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const dn=await os(e,ut,"SILVER",15),un=await os(e,ut,"OIL",15),qe=vo(dn,un,G);if(qe.aligned&&qe.alignmentCount>=1){const ne=qe.alignmentCount===2?5:3;i+=ne,l++,r.push(`✅ Layer 19: ${qe.description} (${qe.strength}/100)`)}else r.push(`❌ Layer 19: ${qe.description}`);const mn=await Oo(e)||Fo(),Le=Ro(mn);if($o(Le,G)&&Le.strength>=70){const ne=Le.positioning.includes("EXTREME")?7:4;i+=ne,l++,r.push(`✅ Layer 20: ${Le.description} (${Le.strength}/100)`)}else Le.goldSignalSupport!=="NEUTRAL"?r.push(`⚠️ Layer 20: ${Le.description} (not aligned)`):r.push(`ℹ️ Layer 20: ${Le.description}`);let St="C";i>=162?St="A+":i>=144?St="A":i>=126&&(St="B"),(u||g)&&l>=7&&(G=u?"BUY":"SELL");const Re=Math.max(K*1.5,o*.003),pn=G==="BUY"?o-Re:o+Re,gn=G==="BUY"?o+Re*2:o-Re*2,fn=G==="BUY"?o+Re*3:o-Re*3,_n=G==="BUY"?o+Re*4:o-Re*4;return{grade:St,score:i,signal:G,confidence:i,layersPassed:l,layers:r,stopLoss:pn,tp1:gn,tp2:fn,tp3:_n,liquidityScore:k,session:N,adx:d.adx,rsi:d.rsi,volumeRatio:b/h}}function Vs(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,o=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let i=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,i+="Next scan in 5 minutes...",i}async function lt(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(t,new Date().toISOString(),s,i,l,r,e).run();const d=(await lt(n)).current_balance+i;return await n.prepare(`
      ...
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await Ks(n),await Ho(n),await Uo(n),{success:!0,profit_loss:i}}catch(a){return{success:!1,error:a.message}}}async function Ks(e){const t=await lt(e),s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,o=n.filter(u=>u.win===1).length,i=n.filter(u=>u.win===0).length,l=o/a*100,r=n.reduce((u,g)=>u+(g.profit_loss||0),0),c=Math.max(...n.map(u=>u.profit_loss||0)),d=Math.min(...n.map(u=>u.profit_loss||0)),m=n.reduce((u,g)=>u+(g.confidence||0),0)/a,p=n.reduce((u,g)=>u+(g.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,o,i,l,r,c,d,m,p).run()}async function Uo(e){const t=await lt(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,o).run();let i=!1,l="";s>=t.max_drawdown_pct?(i=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):o>=t.max_daily_loss_pct&&(i=!0,l=`Daily loss ${o.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),i&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});ye.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Fe=new he;Fe.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Ot(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:$t(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/today",async e=>{try{const t=Oa(),s=vt();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/check",async e=>{try{const t=vt(),s=Ps();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);Ma(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Fe.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
...
${c} @ $${d}
Stop: $${m}
TP1: $${p}`):await X(l,`❌ Error: ${u.error}`)}else if(o.startsWith("/close_trade")){const r=o.split(" ");if(r.length<4)return await X(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const c=parseInt(r[1]),d=parseFloat(r[2]),m=r[3],p=await Xs(c,d,m,t);if(p.success){const u=p.profit_loss||0,g=u>0?"💰":"❌";await X(l,`${g} *Trade #${c} Closed*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Ft=new he;Ft.post("/market-analysis",async e=>await an(e));Ft.get("/health",async e=>e.json({success:!0,status:"healthy",service:"ai-analysis",timestamp:new Date().toISOString()}));Ft.get("/auto-ai-scan",async e=>await an(e));async function an(e){const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const k of s.results||[])k.setting_key==="twelve_data_api_key"&&(n=k.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const k=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,x=await(await fetch(k)).json();x.values&&x.values.length>=50&&(a=x.values.reverse().map(F=>({timestamp:F.datetime,open:parseFloat(F.open),high:parseFloat(F.high),low:parseFloat(F.low),close:parseFloat(F.close),volume:parseFloat(F.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const k=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!k.results||k.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=k.results.reverse().map(N=>({timestamp:N.timestamp,open:N.open,high:N.high,low:N.low,close:N.close,volume:N.volume||0}))}const o=_e(a);if(!o)return e.json({success:!1,error:"Failed to calculate indicators"},400);const i=a[a.length-1].close,l=ae(i,o,"day_trade");console.log("[AI-ANALYSIS] Current price:",i,"Signal:",l.signal_type,"Confidence:",l.confidence);const r={};for(const k of["5m","15m","1h","4h","daily"]){const N=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(k).first();N&&(r[k]=N)}const c=qt(r,i),d=a.slice(-50),m=d.map(k=>k.high).sort((k,N)=>N-k),p=d.map(k=>k.low).sort((k,N)=>k-N),u=[Math.max(...m.slice(0,10))],g=[Math.min(...p.slice(0,10))];i>o.sma_20?g.push(o.sma_20):u.push(o.sma_20),i>o.sma_50?g.push(o.sma_50):u.push(o.sma_50),i>o.vwap?g.push(o.vwap):u.push(o.vwap);const _=Math.round(i/10)*10;_>i?u.push(_):g.push(_);const y=[...new Set(u)].sort((k,N)=>k-N).filter(k=>k>i).slice(0,3),f=[...new Set(g)].sort((k,N)=>N-k).filter(k=>k<i).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",f,"Resistance:",y);const h=o.atr_14/i*100;let b="NORMAL";h>3?b="EXTREME":h>1.5?b="HIGH":h<.5&&(b="LOW");const w=[];let v=30,T=30,L=40;c.type==="ALL_BULLISH"?(v=60,T=20,L=20):c.type==="ALL_BEARISH"?(v=20,T=60,L=20):c.score>=4&&(c.trends.filter(k=>k.trend==="BULLISH").length>=4?(v=50,T=25,L=25):(v=25,T=50,L=25)),y.length>0&&w.push({name:"📈 BULLISH CONTINUATION",probability:v,description:`Price breaks above $${y[0].toFixed(2)} and rallies toward $${(y[y.length-1]||i*1.02).toFixed(2)}`,trigger:`Breakout above $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||i*1.02}),f.length>0&&w.push({name:"📉 BEARISH CORRECTION",probability:T,description:`Price breaks below $${f[0].toFixed(2)} and drops toward $${(f[f.length-1]||i*.98).toFixed(2)}`,trigger:`Breakdown below $${f[0].toFixed(2)} with volume`,target:f[f.length-1]||i*.98}),w.push({name:"↔️ CONTINUED RANGING",probability:L,description:`Price oscillates between $${(f[0]||i*.99).toFixed(2)} and $${(y[0]||i*1.01).toFixed(2)} with choppy action`,trigger:b==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),w.sort((k,N)=>N.probability-k.probability);let A={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=65?l.signal_type==="BUY"?A={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(i-5).toFixed(2)}-${i.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(A={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${i.toFixed(2)}-${(i+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):b==="EXTREME"?A.reason=`⚠️ EXTREME volatility (ADX ${o.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(A.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${y[0]?`breakout above $${y[0].toFixed(2)}`:f[0]?`breakdown below $${f[0].toFixed(2)}`:"clearer direction"}.`);let M=!1;if(l.confidence>=65)try{const k=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),N={};for(const x of k.results||[])N[x.setting_key]=x.setting_value;if(N.telegram_bot_token&&N.telegram_chat_id&&N.telegram_bot_token!=="your_bot_token_here"){const x=l.signal_type==="BUY"?"🟢":l.signal_type==="SELL"?"🔴":"⚪",F=l.confidence>=85,C=F?`🔥 *HIGH CONVICTION AI* 🔥
`:"";let O=`${x} *AI MARKET ANALYSIS* ${x}
`;O+=C,O+=`⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
...
`,O+=`🔴 *Resistance:* ${y.length>0?y.map(R=>`$${R.toFixed(2)}`).join(", "):"N/A"}
`,O+=`🟢 *Support:* ${f.length>0?f.map(R=>`$${R.toFixed(2)}`).join(", "):"N/A"}

`,O+=`*Top Scenario:* ${w[0].name} (${w[0].probability}%)
`,O+=`${w[0].description}

`,O+=`💡 *Recommendation:* ${A.action==="WAIT"?"⏰":A.action==="BUY"?"📈":"📉"} ${A.action}
`,O+=`${A.reason}

`,A.entry_range&&(O+=`🎯 *Entry Range:* $${A.entry_range}
`,O+=`🛡️ *Stop Loss:* $${A.stop_loss}`),M=await X({botToken:N.telegram_bot_token,chatId:N.telegram_chat_id},O),console.log("[AI-ANALYSIS] Telegram alert sent:",M,"for",l.signal_type,l.confidence+"%"),M&&F&&(l.signal_type==="BUY"||l.signal_type==="SELL")&&(console.log("[AI-ANALYSIS] 🔥 HIGH CONVICTION AI signal! Scheduling reminders..."),setTimeout(async()=>{let R=`${x} *⚠️ REMINDER: AI HIGH CONVICTION* ${x}
...
`),R+="⏰ Don't miss this AI signal!",await X({botToken:N.telegram_bot_token,chatId:N.telegram_chat_id},R)},120*1e3),setTimeout(async()=>{let R=`${x} *⚠️ FINAL: AI SIGNAL STILL VALID* ${x}

`;R+=`📊 *${l.signal_type}* (${l.confidence.toFixed(1)}%)
`,R+=`💰 *Current Price:* $${i.toFixed(2)}

`,R+=`🔥 Last chance - ${A.action}!
`,A.entry_range&&(R+=`🎯 *Entry:* $${A.entry_range}
`,R+=`🛡️ *Stop:* $${A.stop_loss}`),await X({botToken:N.telegram_bot_token,chatId:N.telegram_chat_id},R)},300*1e3))}}catch(k){console.error("[AI-ANALYSIS] Telegram error:",k.message)}else console.log("[AI-ANALYSIS] No Telegram alert - Confidence:",l.confidence,"Signal:",l.signal_type);return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:i,signal:l.signal_type,confidence:l.confidence,volatility:b,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:y,support:f},scenarios:w,recommendation:A,telegram_sent:M}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}}const Ce=new he;async function Yo(e){try{return await e.prepare("SELECT 1 FROM monitoring_config LIMIT 1").first(),!0}catch{return!1}}async function on(e){try{const t=await e.prepare(`
...
⏰ ${new Date().toUTCString()}`;return await X(m,l,r),!0}}return!1}catch(i){return console.error("[MONITORING] Failed to send alert:",i),!1}}Ce.get("/health-check",async e=>{const{DB:t}=e.env;try{const s=await on(t),n=e.req.url.replace("/api/monitoring/health-check",""),a=new Date().toISOString(),o=await Yo(t);console.log("[MONITORING] Starting comprehensive health check..."),console.log("[MONITORING] Tables exist:",o);const i=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}],l=[],r=s.telegram_alerts_enabled==="1",c=parseInt(s.slow_response_threshold_ms||"5000"),d=parseInt(s.max_failure_count||"3");console.log("[MONITORING] Fast mode: Checking 5 endpoints (MTF skipped)");for(const f of i){const h=await Go(t,f.name,f.url,n);let b=0,w="unknown",v=h.status==="down"?1:0;if(o)try{const T=await t.prepare(`
          ...
          `).bind(f.name).first();b=(T==null?void 0:T.failure_count)||0,w=(T==null?void 0:T.status)||"unknown",v=h.status==="down"?b+1:0}catch(T){console.log("[MONITORING] Could not read previous health check:",T)}if(o)try{await t.prepare(`
            ...
            VALUES (?, ?, ?, ?, datetime('now'), ?, ?, ?, ?)
          `).bind(f.name,f.url,h.status,h.responseTime,h.status==="healthy"?new Date().toISOString():null,h.status==="down"?new Date().toISOString():null,v,h.error||null).run()}catch(T){console.log("[MONITORING] Could not save health check:",T)}l.push({name:f.name,url:f.url,status:h.status,response_time_ms:h.responseTime,failure_count:v,error:h.error}),h.status==="down"&&v>=d&&w!=="down"&&o&&await Wt(t,"endpoint_down","critical",f.name,`Endpoint ${f.name} is DOWN after ${v} consecutive failures. Error: ${h.error}`,r),h.status==="healthy"&&h.responseTime>c&&o&&await Wt(t,"slow_response","medium",f.name,`Endpoint ${f.name} is responding slowly: ${h.responseTime}ms (threshold: ${c}ms)`,r)}console.log("[MONITORING] Checking data freshness...");const m=await Vo(t,s);for(const f of m){if(o)try{await t.prepare(`
            INSERT INTO data_freshness 
            (data_source, timeframe, last_data_timestamp, last_fetch_at, data_age_minutes, is_stale, record_count)
            VALUES (?, ?, ?, datetime('now'), ?, ?, ?)
          `).bind(f.source,f.timeframe||null,f.lastTimestamp||null,f.ageMinutes,f.isStale?1:0,f.count||null).run()}catch(h){console.log("[MONITORING] Could not save freshness check:",h)}if(f.isStale&&o){const h=f.timeframe?`${f.source} (${f.timeframe})`:f.source;await Wt(t,"data_stale","high",h,`Data source ${h} is STALE. Last update: ${f.lastTimestamp||"unknown"}, Age: ${f.ageMinutes} minutes (threshold: ${s.data_stale_threshold_minutes} minutes)`,r)}}const p=l.filter(f=>f.status==="healthy").length,u=l.filter(f=>f.status==="degraded").length,g=l.filter(f=>f.status==="down").length,_=m.filter(f=>f.isStale).length,y=g>0?"critical":u>0||_>0?"degraded":"healthy";if(o)try{await t.prepare(`
        ...
        `).bind(p,u,g,_,l.reduce((f,h)=>f+h.response_time_ms,0)/l.length).run()}catch(f){console.log("[MONITORING] Could not save metrics:",f)}return console.log(`[MONITORING] Health check complete: ${y}`),console.log(`[MONITORING] Tables exist: ${o}, Alerts enabled: ${r}`),e.json({success:!0,timestamp:a,overall_status:y,summary:{endpoints:{healthy:p,degraded:u,down:g,total:l.length},data:{fresh:m.length-_,stale:_,total:m.length}},endpoints:l,data_freshness:m,config:{stale_threshold_minutes:s.data_stale_threshold_minutes,slow_response_threshold_ms:s.slow_response_threshold_ms,max_failure_count:s.max_failure_count,telegram_alerts_enabled:r}})}catch(s){return console.error("[MONITORING] Health check failed:",s),e.json({success:!1,error:s.message,timestamp:new Date().toISOString()},500)}});Ce.get("/status",async e=>{const{DB:t}=e.env;try{let s,n,a;try{s=await t.prepare(`
        SELECT 
          endpoint_name,
          status,
          response_time_ms,
      ...
      `).all()}catch{const r=new URL(e.req.url),c=`${r.protocol}//${r.host}`,d=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}];s={results:await Promise.all(d.map(async({name:p,url:u})=>{try{const g=Date.now(),_=await fetch(`${c}${u}`,{method:"GET",signal:AbortSignal.timeout(1e4)}),y=Date.now()-g;return{endpoint_name:p,status:_.ok?"healthy":"degraded",response_time_ms:y,last_check_at:new Date().toISOString()}}catch{return{endpoint_name:p,status:"down",response_time_ms:0,last_check_at:new Date().toISOString()}}}))};try{const p=await t.prepare(`
        ...
        `).all(),g=await t.prepare(`
          SELECT 
            ...
            datetime('now') as last_fetch_at
          FROM signals
        `).first();n={results:[...p?[p]:[],...u.results||[],...g?[g]:[]]}}catch(p){console.log("[MONITORING] Data freshness check error:",p.message),n={results:[]}}a={results:[]}}const o=(s.results||[]).every(l=>l.status==="healthy"),i=(n.results||[]).every(l=>l.is_stale===0);return e.json({success:!0,overall_status:o&&i?"healthy":"degraded",endpoints:s.results,data_sources:n.results,unresolved_alerts:a.results,alert_count:(a.results||[]).length})}catch(s){return e.json({success:!1,error:s.message},500)}});Ce.get("/alerts",async e=>{const{DB:t}=e.env,s=e.req.query("resolved")==="true";try{const n=await t.prepare(`
    ...
    `).all();return e.json({success:!0,period_hours:s,metrics:n.results})}catch(n){return e.json({success:!1,error:n.message},500)}});Ce.get("/config",async e=>{const{DB:t}=e.env;try{const s=await on(t);return e.json({success:!0,config:s})}catch(s){return e.json({success:!1,error:s.message},500)}});Ce.post("/config",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
        ...
        WHERE config_key = ?
      `).bind(a,n).run();return e.json({success:!0,message:"Configuration updated"})}catch(n){return e.json({success:!1,error:n.message},500)}});const j=new he;j.use("/api/*",Qn());j.route("/api/signals/enhanced",js);j.route("/api/signals/simple",Ws);j.route("/api/scanner",rt);j.route("/api/trades",ye);j.route("/api/calendar",Fe);j.route("/api/backtest",dt);j.route("/api/telegram",nn);j.route("/api/ai",Ft);j.route("/api/monitoring",Ce);j.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
⏰ ${new Date().toLocaleString()}`,x=await X({botToken:o,chatId:i},N);T.day_trade_send_result=x,console.log("[AUTO-FETCH] Day trade alert result:",x),x?(w=!0,v.push("Day Trade"),M&&f.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const F=`${A} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${A}
...
⏰ Don't miss this trade!`;await X({botToken:o,chatId:i},F),console.log("[AUTO-FETCH] First reminder sent")},120*1e3),setTimeout(async()=>{const F=`${A} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${A}
...
🎯 TP1: $${f.take_profit_1.toFixed(2)}
🛡️ Stop: $${f.stop_loss.toFixed(2)}`;await X({botToken:o,chatId:i},F),console.log("[AUTO-FETCH] Final reminder sent")},300*1e3),v.push("High Conviction Reminders (2+5min)"))):console.error("[AUTO-FETCH] Failed to send day trade alert!")}if(T.swing_trade_checked=!0,console.log("[AUTO-FETCH] Checking swing trade...",{confidence:h.confidence,type:h.signal_type,threshold:80}),h.confidence>=80){T.swing_trade_send_attempted=!0,console.log("[AUTO-FETCH] Swing trade meets criteria! Sending alert...");const L=F=>F.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),A=h.signal_type==="BUY"?"🟢":h.signal_type==="SELL"?"🔴":"⚪",M=h.confidence>=85,k=M?"🔥 <b>HIGH CONVICTION</b> 🔥":"",N=`${A} <b>GOLD/USD ${h.signal_type} SIGNAL</b> ${A}
${k}
...
⏰ ${new Date().toLocaleString()}`,x=await X({botToken:o,chatId:i},N);T.swing_trade_send_result=x,x&&(w=!0,v.push("Swing Trade"),M&&h.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const F=`${A} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${A}
...
⏰ Don't miss this swing trade!`;await X({botToken:o,chatId:i},F),console.log("[AUTO-FETCH] Swing first reminder sent")},180*1e3),setTimeout(async()=>{const F=`${A} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${A}
...
🎯 TP1: $${h.take_profit_1.toFixed(2)}
🛡️ Stop: $${h.stop_loss.toFixed(2)}`;await X({botToken:o,chatId:i},F),console.log("[AUTO-FETCH] Swing final reminder sent")},420*1e3),v.push("High Conviction Swing Reminders (3+7min)")))}}else console.log("[AUTO-FETCH] Telegram NOT configured or invalid token");return console.log(`[CRON] Processed ${u.length} candles, Telegram: ${w?"SENT":"NOT SENT"}, Alerts: ${v.join(", ")}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:u.length,latest_price:y,data_timestamp:u[0].timestamp},signals:{day_trade:{type:f.signal_type,confidence:f.confidence,price:y},swing_trade:{type:h.signal_type,confidence:h.confidence,price:y}},telegram:{configured:!!(o&&i),bot_token_set:!!o,chat_id_set:!!i,bot_token_valid:o!=="your_bot_token_here",sent:w,alerts:v},debug:{...T,day_trade_check:{confidence:f.confidence,min_confidence:b,meets_threshold:f.confidence>=b,signal_type:f.signal_type,sends_all_signals:!0,should_alert:f.confidence>=b},swing_trade_check:{confidence:h.confidence,min_confidence:80,meets_threshold:h.confidence>=80,signal_type:h.signal_type,sends_all_signals:!0,should_alert:h.confidence>=80}},message:w?`✅ Alerts sent: ${v.join(", ")}`:"⚪ No alerts sent (signals below confidence threshold)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});j.get("/api/test/auto-fetch-settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings 
      WHERE setting_key IN ('twelve_data_api_key', 'telegram_bot_token', 'telegram_chat_id')
    ...
    `).first();if(!((o==null?void 0:o.setting_value)==="1"||(o==null?void 0:o.setting_value)==="true"))return console.log("[AI-AUTO-SCAN] Disabled in settings"),e.json({success:!0,message:"AI auto-scan is disabled",ai_scan_enabled:!1});const l=await((n=(s=e.env.app)==null?void 0:s.fetch)==null?void 0:n.call(s,new Request(new URL("/api/ai/market-analysis",e.req.url).toString(),{method:"POST"})));if(l){const r=await l.json();return console.log("[AI-AUTO-SCAN] Analysis complete:",r.success?"Success":"Failed"),e.json({success:!0,ai_scan_enabled:!0,analysis:r,message:(a=r.analysis)!=null&&a.telegram_sent?"🤖 AI analysis complete - Telegram alert sent":"🤖 AI analysis complete - No alert (confidence < 65% or HOLD)"})}return e.json({success:!1,error:"Failed to run AI analysis"},500)}catch(o){return console.error("[AI-AUTO-SCAN] Error:",o),e.json({success:!1,error:o.message},500)}});j.get("/api/cron/hedge-fund",async e=>{var s,n,a,o,i,l,r,c,d,m;const t=Date.now();try{console.log("[HEDGE-FUND-CRON] Starting hedge fund analysis");const p=await fetch(`${e.req.url.replace("/api/cron/hedge-fund","/api/signals/enhanced/enhanced")}`,{method:"POST",headers:{"Content-Type":"application/json"}});if(!p.ok)throw new Error(`Enhanced endpoint returned ${p.status}`);const u=await p.json();if(!u.success)return e.json({success:!1,error:u.error||"Enhanced signal generation failed",execution_time_ms:Date.now()-t});const g=u.day_trade,_=u.swing_trade,y=(g==null?void 0:g.enhanced_confidence)>=80||(_==null?void 0:_.enhanced_confidence)>=80;console.log("[HEDGE-FUND-CRON] Signal confidence:",{day:g==null?void 0:g.enhanced_confidence,swing:_==null?void 0:_.enhanced_confidence,shouldAlert:y});let f=!1;if(y){const{DB:b}=e.env,w=await b.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),v={};for(const T of w.results||[])v[T.setting_key]=T.setting_value;if(v.telegram_bot_token&&v.telegram_chat_id){const T=`
    ...
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",o=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let i=0;const l={};for(const r of o){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${r.interval}&apikey=${n}&outputsize=${r.outputsize}`,m=await(await fetch(c)).json();if(m.code&&m.status==="error"){l[r.dbKey]={success:!1,error:m.message,count:0};continue}if(!m.values||!Array.isArray(m.values)){l[r.dbKey]={success:!1,error:"No data",count:0};continue}const p=m.values;let u=0;const g=[];for(const _ of p){const y={timestamp:_.datetime,open:parseFloat(_.open)||0,high:parseFloat(_.high)||0,low:parseFloat(_.low)||0,close:parseFloat(_.close)||0,volume:0};g.push(y),await t.prepare(`
        ...
        `).bind(y.timestamp,y.open,y.high,y.low,y.close,y.volume,r.dbKey).run(),u++}if(g.length>=50){const _=_e(g.reverse());_&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(r.dbKey,_.rsi_14,_.macd,_.macd_signal,_.macd_histogram,_.sma_20,_.sma_50,_.sma_200,_.ema_12,_.ema_26,_.bb_upper,_.bb_middle,_.bb_lower,_.atr_14,_.stochastic_k,_.stochastic_d,_.adx,_.plus_di,_.minus_di,_.ichimoku_tenkan,_.ichimoku_kijun,_.ichimoku_senkou_a,_.ichimoku_senkou_b,_.parabolic_sar,_.vwap,_.fib_382,_.fib_500,_.fib_618).run()}l[r.dbKey]={success:!0,count:u},i+=u,await new Promise(_=>setTimeout(_,500))}return e.json({success:!0,totalCount:i,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(r=>({timestamp:r.timestamp,open:r.open,high:r.high,low:r.low,close:r.close,volume:r.volume})),a=_e(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const o=n[n.length-1].close,i=ae(o,a,"day_trade"),l=ae(o,a,"swing_trade");return e.json({success:!0,signals:{day_trade:i,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});j.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>zt),o=["5m","15m","1h","4h","daily"],i={};for(const T of o){const L=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(T).first();L&&(i[T]=L)}const l=Object.keys(i).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(i)});const r=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const c=r.close,d=s(i,c),m=i["1h"],p=ae(c,m,"day_trade"),u=ae(c,m,"swing_trade"),g=n(p.signal_type,d),_=n(u.signal_type,d),y={...p,base_confidence:p.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${p.reason}, MTF: ${g.reason}`},f={...u,base_confidence:u.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${_.reason}`},h=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),b={};for(const T of h.results||[])b[T.setting_key]=T.setting_value;let w=!1,v=[];b.telegram_bot_token&&b.telegram_chat_id&&(y.isValid&&y.signal_type!=="HOLD"&&await X({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${it({...y,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(v.push("day_trade"),w=!0),await new Promise(T=>setTimeout(T,1e3)),f.isValid&&f.signal_type!=="HOLD"&&await X({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${it({...f,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(v.push("swing_trade"),w=!0));for(const T of[y,f])T.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(T.signal_type,T.trading_style,T.price,T.stop_loss,T.take_profit_1,T.take_profit_2,T.take_profit_3,T.base_confidence,T.mtf_confidence,T.final_confidence,T.alignment_score,T.alignment_type,T.reason,w?1:0).run();return e.json({success:!0,signals:{day_trade:y,swing_trade:f},alignment:d,alignment_report:a(d),telegram_sent:w,sent_to_telegram:v,available_timeframes:Object.keys(i)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});j.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
    ...
    `).all();let n="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(n=g.setting_value);let a,o=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,y=await(await fetch(g)).json();y.values&&y.values.length>=50?(a=y.values.reverse().map(f=>({timestamp:f.datetime,open:parseFloat(f.open)||0,high:parseFloat(f.high)||0,low:parseFloat(f.low)||0,close:parseFloat(f.close)||0,volume:parseFloat(f.volume)||0})),o=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!a){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!g.results||g.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});a=g.results.reverse().map(_=>({timestamp:_.timestamp,open:_.open,high:_.high,low:_.low,close:_.close,volume:_.volume}))}const i=_e(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"});const l=a[a.length-1].close,r=ae(l,i,"day_trade"),c=ae(l,i,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",r.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),m={};for(const g of d.results||[])m[g.setting_key]=g.setting_value;let p=!1,u=[];m.telegram_bot_token&&m.telegram_chat_id&&(await X({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},it({...r,timestamp:new Date().toISOString()}))&&(u.push("day_trade"),p=!0),await new Promise(y=>setTimeout(y,1e3)),await X({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},it({...c,timestamp:new Date().toISOString()}))&&(u.push("swing_trade"),p=!0));for(const g of[r,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(n).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const _=new Date().toISOString().split("T")[0],y=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,_).all(),{checkDailyLossLimit:f}=await Promise.resolve().then(()=>ct),h=f(g,y.results);if(h.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${h.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const b=d*o,w=await t.prepare(`
      INSERT INTO trades (
    ...
    `).first(),i=!n&&(o==null?void 0:o.count)>0;let l=0;if(i)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const C=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),O=(C==null?void 0:C.setting_value)||"70140f57bea54c5e90768de696487d8f",R=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const G of R)try{const z=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${G.interval}&apikey=${O}&outputsize=100`,I=new AbortController,W=setTimeout(()=>I.abort(),1e4),K=await fetch(z,{signal:I.signal});clearTimeout(W);const ee=await K.json();if(ee.values&&Array.isArray(ee.values)){const te=[];for(const $ of ee.values)te.push({timestamp:$.datetime,open:parseFloat($.open)||0,high:parseFloat($.high)||0,low:parseFloat($.low)||0,close:parseFloat($.close)||0,volume:0});for(const $ of te)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind($.timestamp,$.open,$.high,$.low,$.close,$.volume,G.dbKey).run();if(te.length>=50){const $=_e(te.reverse());$&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(G.dbKey,$.rsi_14,$.macd,$.macd_signal,$.macd_histogram,$.sma_20,$.sma_50,$.sma_200,$.ema_12,$.ema_26,$.bb_upper,$.bb_middle,$.bb_lower,$.atr_14,$.stochastic_k,$.stochastic_d,$.adx,$.plus_di,$.minus_di,$.ichimoku_tenkan,$.ichimoku_kijun,$.ichimoku_senkou_a,$.ichimoku_senkou_b,$.parabolic_sar,$.vwap,$.fib_382,$.fib_500,$.fib_618).run()}l+=ee.values.length}await new Promise(te=>setTimeout(te,100))}catch(z){console.error(`[MTF] Error fetching ${G.dbKey}:`,z)}}a.steps[0].status="completed",a.steps[0].data={totalCandles:l},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:r,validateMultiTimeframeSignal:c,formatAlignmentReport:d}=await Promise.resolve().then(()=>zt),m={};for(const C of["5m","15m","1h","4h","daily"]){const O=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(C).first();O&&(m[C]=O)}const p=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(p==null?void 0:p.close)||0,g=r(m,u),_=m["1h"],y=ae(u,_,"day_trade"),f=ae(u,_,"swing_trade"),h=c(y.signal_type,g),b=c(f.signal_type,g),w={...y,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:g.score,alignment_type:g.type},v={...f,final_confidence:Math.min(95,b.confidence),isValid:b.isValid,mtf_reason:b.reason,alignment_score:g.score,alignment_type:g.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:w,swingTrade:v,alignment:g},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const T=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),L=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:A}=await Promise.resolve().then(()=>ct),M=A(T,{entry_price:w.price,stop_loss:w.stop_loss,take_profit_1:w.take_profit_1,take_profit_2:w.take_profit_2,take_profit_3:w.take_profit_3,confidence:w.final_confidence,signal_type:w.signal_type,trading_style:w.trading_style},L.results),k=A(T,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},L.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:M,swingPosition:k},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const N=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),x={};for(const C of N.results||[])x[C.setting_key]=C.setting_value;let F=!1;if(x.telegram_bot_token&&x.telegram_chat_id){const C=await t.prepare(`
        SELECT high, low FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 20
      `).all();let O=[],R=[];if(C.results&&C.results.length>=20){const I=C.results.map(K=>K.high).sort((K,ee)=>ee-K),W=C.results.map(K=>K.low).sort((K,ee)=>K-ee);O=I.slice(0,3),R=W.slice(0,3)}const G=`
...
🔴 *Resistance:* ${O.map(I=>`$${I.toFixed(2)}`).join(", ")}
🟢 *Support:* ${R.map(I=>`$${I.toFixed(2)}`).join(", ")}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();F=await X({botToken:x.telegram_bot_token,chatId:x.telegram_chat_id},G)}if(a.steps[3].status=F?"completed":"failed",a.steps[3].data={telegramSent:F},w.isValid||v.isValid)for(const C of[w,v])C.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
      ...
      `).first();if((x!=null&&x.latest_timestamp?Date.now()-new Date(x.latest_timestamp).getTime():1/0)>1800*1e3){const C=await t.prepare(`
        ...
        `).first(),O=(C==null?void 0:C.setting_value)||"70140f57bea54c5e90768de696487d8f",R=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const G of R)try{const z=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${G.interval}&apikey=${O}&outputsize=100`,I=new AbortController,W=setTimeout(()=>I.abort(),1e4),K=await fetch(z,{signal:I.signal});clearTimeout(W);const ee=await K.json();if(ee.values&&Array.isArray(ee.values)){const te=[];for(const $ of ee.values)te.push({timestamp:$.datetime,open:parseFloat($.open)||0,high:parseFloat($.high)||0,low:parseFloat($.low)||0,close:parseFloat($.close)||0,volume:0});for(const $ of te)await t.prepare(`
                  ...
                  VALUES (?, ?, ?, ?, ?, ?, ?)
                  ON CONFLICT DO NOTHING
                `).bind($.timestamp,$.open,$.high,$.low,$.close,$.volume,G.dbKey).run();if(te.length>=50){const{calculateIndicators:$}=await Promise.resolve().then(()=>ts),D=$(te.reverse());D&&await t.prepare(`
                    INSERT INTO multi_timeframe_indicators 
                    (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                     sma_20, sma_50, sma_200, ema_12, ema_26,
                     bb_upper, bb_middle, bb_lower, atr_14,
                     ...
                     parabolic_sar, vwap, fib_382, fib_500, fib_618)
                    VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                  `).bind(G.dbKey,D.rsi_14,D.macd,D.macd_signal,D.macd_histogram,D.sma_20,D.sma_50,D.sma_200,D.ema_12,D.ema_26,D.bb_upper,D.bb_middle,D.bb_lower,D.atr_14,D.stochastic_k,D.stochastic_d,D.adx,D.plus_di,D.minus_di,D.ichimoku_tenkan,D.ichimoku_kijun,D.ichimoku_senkou_a,D.ichimoku_senkou_b,D.parabolic_sar,D.vwap,D.fib_382,D.fib_500,D.fib_618).run()}o+=ee.values.length}await new Promise(te=>setTimeout(te,100))}catch(z){console.error(`[MTF] Error fetching ${G.dbKey}:`,z)}}else o=0,a.steps[0].cached=!0}a.steps[0].status="completed",a.steps[0].data={totalCandles:o},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:i,validateMultiTimeframeSignal:l}=await Promise.resolve().then(()=>zt),{generateSignal:r}=await Promise.resolve().then(()=>ts),c={};for(const x of["5m","15m","1h","4h","daily"]){const F=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();F&&(c[x]=F)}const d=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),m=(d==null?void 0:d.close)||0,p=i(c,m),u=c["1h"],g=r(m,u,"day_trade"),_=r(m,u,"swing_trade"),y=l(g.signal_type,p),f=l(_.signal_type,p),h={...g,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:p.score,alignment_type:p.type},b={..._,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:p.score,alignment_type:p.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:h,swingTrade:b,alignment:p},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const w=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),v=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:T}=await Promise.resolve().then(()=>ct),L=T(w,{entry_price:h.price,stop_loss:h.stop_loss,take_profit_1:h.take_profit_1,take_profit_2:h.take_profit_2,take_profit_3:h.take_profit_3,confidence:h.final_confidence,signal_type:h.signal_type,trading_style:h.trading_style},v.results),A=T(w,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},v.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:L,swingPosition:A},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const M=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),k={};for(const x of M.results||[])k[x.setting_key]=x.setting_value;let N=!1;if(k.telegram_bot_token&&k.telegram_chat_id){const x=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 20
      `).all();let F=[],C=[];if(x.results&&x.results.length>=20){const z=x.results.map(W=>W.high).sort((W,K)=>K-W),I=x.results.map(W=>W.low).sort((W,K)=>W-K);F=z.slice(0,3),C=I.slice(0,3)}const O=`
🤖 *AUTOMATED DAILY ANALYSIS*
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
...
🔴 *Resistance:* ${F.map(z=>`$${z.toFixed(2)}`).join(", ")}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim(),{sendTelegramMessage:R}=await Promise.resolve().then(()=>Hs);N=await R({botToken:k.telegram_bot_token,chatId:k.telegram_chat_id},O)}if(a.steps[3].status=N?"completed":"failed",a.steps[3].data={telegramSent:N},h.isValid||b.isValid)for(const x of[h,b])x.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
