var xs=Object.defineProperty;var Ft=e=>{throw TypeError(e)};var ks=(e,t,s)=>t in e?xs(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var S=(e,t,s)=>ks(e,typeof t!="symbol"?t+"":t,s),bt=(e,t,s)=>t.has(e)||Ft("Cannot "+s);var p=(e,t,s)=>(bt(e,t,"read from private field"),s?s.call(e):t.get(e)),F=(e,t,s)=>t.has(e)?Ft("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),k=(e,t,s,n)=>(bt(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),j=(e,t,s)=>(bt(e,t,"access private method"),s);var Mt=(e,t,s,n)=>({set _(a){k(e,t,a,s)},get _(){return p(e,t,n)}});var Lt=(e,t,s)=>(n,a)=>{let i=-1;return o(0);async function o(l){if(l<=i)throw new Error("next() called multiple times");i=l;let r,c=!1,d;if(e[l]?(d=e[l][0][0],n.req.routeIndex=l):d=l===e.length&&a||void 0,d)try{r=await d(n,()=>o(l+1))}catch(_){if(_ instanceof Error&&t)n.error=_,r=await t(_,n),c=!0;else throw _}else n.finalized===!1&&s&&(r=await s(n));return r&&(n.finalized===!1||c)&&(n.res=r),n}},Ss=Symbol(),Ts=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,i=(e instanceof Yt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Rs(e,{all:s,dot:n}):{}};async function Rs(e,t){const s=await e.formData();return s?Ds(s,t):{}}function Ds(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?Fs(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(Ms(s,n,a),delete s[n])}),s}var Fs=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Ms=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((i,o)=>{o===a.length-1?n[i]=s:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},Ut=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},Ls=e=>{const{groups:t,path:s}=$s(e),n=Ut(s);return Is(n,t)},$s=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},Is=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},ot={},As=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return ot[n]||(s[2]?ot[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:ot[n]=[e,s[1],!0]),ot[n]}return null},Rt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Os=e=>Rt(e,decodeURI),Wt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),o=t.slice(s,i===-1?void 0:i);return Os(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return t.slice(s,n)},Cs=e=>{const t=Wt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Pe=(e,t,...s)=>(s.length&&(t=Pe(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Vt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const i=a.replace("?","");n+="/"+i,s.push(n)}else n+="/"+a}),s.filter((a,i,o)=>o.indexOf(a)===i)},wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Rt(e,qt):e):e,zt=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const r=o+t.length+2,c=e.indexOf("&",r);return wt(e.slice(r,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const o=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>o&&o!==-1&&(l=-1);let r=e.slice(i+1,l===-1?o===-1?void 0:o:l);if(n&&(r=wt(r)),i=o,r==="")continue;let c;l===-1?c="":(c=e.slice(l+1,o===-1?void 0:o),n&&(c=wt(c))),s?(a[r]&&Array.isArray(a[r])||(a[r]=[]),a[r].push(c)):a[r]??(a[r]=c)}return t?a[t]:a},Ps=zt,js=(e,t)=>zt(e,t,!0),qt=decodeURIComponent,$t=e=>Rt(e,qt),He,te,ge,Gt,Kt,kt,he,Ct,Yt=(Ct=class{constructor(e,t="/",s=[[]]){F(this,ge);S(this,"raw");F(this,He);F(this,te);S(this,"routeIndex",0);S(this,"path");S(this,"bodyCache",{});F(this,he,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,k(this,te,s),k(this,He,{})}param(e){return e?j(this,ge,Gt).call(this,e):j(this,ge,Kt).call(this)}query(e){return Ps(this.url,e)}queries(e){return js(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Ts(this,e))}json(){return p(this,he).call(this,"text").then(e=>JSON.parse(e))}text(){return p(this,he).call(this,"text")}arrayBuffer(){return p(this,he).call(this,"arrayBuffer")}blob(){return p(this,he).call(this,"blob")}formData(){return p(this,he).call(this,"formData")}addValidatedData(e,t){p(this,He)[e]=t}valid(e){return p(this,He)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ss](){return p(this,te)}get matchedRoutes(){return p(this,te)[0].map(([[,e]])=>e)}get routePath(){return p(this,te)[0].map(([[,e]])=>e)[this.routeIndex].path}},He=new WeakMap,te=new WeakMap,ge=new WeakSet,Gt=function(e){const t=p(this,te)[0][this.routeIndex][1][e],s=j(this,ge,kt).call(this,t);return s&&/\%/.test(s)?$t(s):s},Kt=function(){const e={},t=Object.keys(p(this,te)[0][this.routeIndex][1]);for(const s of t){const n=j(this,ge,kt).call(this,p(this,te)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?$t(n):n)}return e},kt=function(e){return p(this,te)[1]?p(this,te)[1][e]:e},he=new WeakMap,Ct),Ns={Stringify:1},Xt=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(r=>Xt(r,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},Hs="text/plain; charset=UTF-8",vt=(e,t)=>({"Content-Type":e,...t}),et,tt,_e,Be,pe,Q,st,Ue,We,Fe,nt,at,ye,je,Pt,Bs=(Pt=class{constructor(e,t){F(this,ye);F(this,et);F(this,tt);S(this,"env",{});F(this,_e);S(this,"finalized",!1);S(this,"error");F(this,Be);F(this,pe);F(this,Q);F(this,st);F(this,Ue);F(this,We);F(this,Fe);F(this,nt);F(this,at);S(this,"render",(...e)=>(p(this,Ue)??k(this,Ue,t=>this.html(t)),p(this,Ue).call(this,...e)));S(this,"setLayout",e=>k(this,st,e));S(this,"getLayout",()=>p(this,st));S(this,"setRenderer",e=>{k(this,Ue,e)});S(this,"header",(e,t,s)=>{this.finalized&&k(this,Q,new Response(p(this,Q).body,p(this,Q)));const n=p(this,Q)?p(this,Q).headers:p(this,Fe)??k(this,Fe,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});S(this,"status",e=>{k(this,Be,e)});S(this,"set",(e,t)=>{p(this,_e)??k(this,_e,new Map),p(this,_e).set(e,t)});S(this,"get",e=>p(this,_e)?p(this,_e).get(e):void 0);S(this,"newResponse",(...e)=>j(this,ye,je).call(this,...e));S(this,"body",(e,t,s)=>j(this,ye,je).call(this,e,t,s));S(this,"text",(e,t,s)=>!p(this,Fe)&&!p(this,Be)&&!t&&!s&&!this.finalized?new Response(e):j(this,ye,je).call(this,e,t,vt(Hs,s)));S(this,"json",(e,t,s)=>j(this,ye,je).call(this,JSON.stringify(e),t,vt("application/json",s)));S(this,"html",(e,t,s)=>{const n=a=>j(this,ye,je).call(this,a,t,vt("text/html; charset=UTF-8",s));return typeof e=="object"?Xt(e,Ns.Stringify,!1,{}).then(n):n(e)});S(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});S(this,"notFound",()=>(p(this,We)??k(this,We,()=>new Response),p(this,We).call(this,this)));k(this,et,e),t&&(k(this,pe,t.executionCtx),this.env=t.env,k(this,We,t.notFoundHandler),k(this,at,t.path),k(this,nt,t.matchResult))}get req(){return p(this,tt)??k(this,tt,new Yt(p(this,et),p(this,at),p(this,nt))),p(this,tt)}get event(){if(p(this,pe)&&"respondWith"in p(this,pe))return p(this,pe);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,pe))return p(this,pe);throw Error("This context has no ExecutionContext")}get res(){return p(this,Q)||k(this,Q,new Response(null,{headers:p(this,Fe)??k(this,Fe,new Headers)}))}set res(e){if(p(this,Q)&&e){e=new Response(e.body,e);for(const[t,s]of p(this,Q).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=p(this,Q).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}k(this,Q,e),this.finalized=!0}get var(){return p(this,_e)?Object.fromEntries(p(this,_e)):{}}},et=new WeakMap,tt=new WeakMap,_e=new WeakMap,Be=new WeakMap,pe=new WeakMap,Q=new WeakMap,st=new WeakMap,Ue=new WeakMap,We=new WeakMap,Fe=new WeakMap,nt=new WeakMap,at=new WeakMap,ye=new WeakSet,je=function(e,t,s){const n=p(this,Q)?new Headers(p(this,Q).headers):p(this,Fe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of i)o.toLowerCase()==="set-cookie"?n.append(o,l):n.set(o,l)}if(s)for(const[i,o]of Object.entries(s))if(typeof o=="string")n.set(i,o);else{n.delete(i);for(const l of o)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??p(this,Be);return new Response(e,{status:a,headers:n})},Pt),V="ALL",Us="all",Ws=["get","post","put","delete","options","patch"],Jt="Can not add a route since the matcher is already built.",Zt=class extends Error{},Vs="__COMPOSED_HANDLER",zs=e=>e.text("404 Not Found",404),It=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},ie,z,Qt,re,Te,lt,ct,Ve,qs=(Ve=class{constructor(t={}){F(this,z);S(this,"get");S(this,"post");S(this,"put");S(this,"delete");S(this,"options");S(this,"patch");S(this,"all");S(this,"on");S(this,"use");S(this,"router");S(this,"getPath");S(this,"_basePath","/");F(this,ie,"/");S(this,"routes",[]);F(this,re,zs);S(this,"errorHandler",It);S(this,"onError",t=>(this.errorHandler=t,this));S(this,"notFound",t=>(k(this,re,t),this));S(this,"fetch",(t,...s)=>j(this,z,ct).call(this,t,s[1],s[0],t.method));S(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Pe("/",t)}`,s),n,a)));S(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(j(this,z,ct).call(this,t.request,t,void 0,t.request.method))})});[...Ws,Us].forEach(i=>{this[i]=(o,...l)=>(typeof o=="string"?k(this,ie,o):j(this,z,Te).call(this,i,p(this,ie),o),l.forEach(r=>{j(this,z,Te).call(this,i,p(this,ie),r)}),this)}),this.on=(i,o,...l)=>{for(const r of[o].flat()){k(this,ie,r);for(const c of[i].flat())l.map(d=>{j(this,z,Te).call(this,c.toUpperCase(),p(this,ie),d)})}return this},this.use=(i,...o)=>(typeof i=="string"?k(this,ie,i):(k(this,ie,"*"),o.unshift(i)),o.forEach(l=>{j(this,z,Te).call(this,V,p(this,ie),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??Wt:Cs}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var o;let i;s.errorHandler===It?i=a.handler:(i=async(l,r)=>(await Lt([],s.errorHandler)(l,()=>a.handler(l,r))).res,i[Vs]=a.handler),j(o=n,z,Te).call(o,a.method,a.path,i)}),this}basePath(t){const s=j(this,z,Qt).call(this);return s._basePath=Pe(this._basePath,t),s}mount(t,s,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=r=>r:a=n.replaceRequest));const o=i?r=>{const c=i(r);return Array.isArray(c)?c:[c]}:r=>{let c;try{c=r.executionCtx}catch{}return[r.env,c]};a||(a=(()=>{const r=Pe(this._basePath,t),c=r==="/"?0:r.length;return d=>{const _=new URL(d.url);return _.pathname=_.pathname.slice(c)||"/",new Request(_,d)}})());const l=async(r,c)=>{const d=await s(a(r.req.raw),...o(r));if(d)return d;await c()};return j(this,z,Te).call(this,V,Pe(t,"*"),l),this}},ie=new WeakMap,z=new WeakSet,Qt=function(){const t=new Ve({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,k(t,re,p(this,re)),t.routes=this.routes,t},re=new WeakMap,Te=function(t,s,n){t=t.toUpperCase(),s=Pe(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},lt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},ct=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await j(this,z,ct).call(this,t,s,n,"GET")))();const i=this.getPath(t,{env:n}),o=this.router.match(a,i),l=new Bs(t,{path:i,matchResult:o,env:n,executionCtx:s,notFoundHandler:p(this,re)});if(o[0].length===1){let c;try{c=o[0][0][0][0](l,async()=>{l.res=await p(this,re).call(this,l)})}catch(d){return j(this,z,lt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:p(this,re).call(this,l))).catch(d=>j(this,z,lt).call(this,d,l)):c??p(this,re).call(this,l)}const r=Lt(o[0],this.errorHandler,p(this,re));return(async()=>{try{const c=await r(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return j(this,z,lt).call(this,c,l)}})()},Ve),es=[];function Ys(e,t){const s=this.buildAllMatchers(),n=((a,i)=>{const o=s[a]||s[V],l=o[2][i];if(l)return l;const r=i.match(o[0]);if(!r)return[[],es];const c=r.indexOf("",1);return[o[1][c],r]});return this.match=n,n(e,t)}var ut="[^/]+",Je=".*",Ze="(?:|/.*)",Ne=Symbol(),Gs=new Set(".\\+*[^]$()");function Ks(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Je||e===Ze?1:t===Je||t===Ze?-1:e===ut?1:t===ut?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Me,Le,oe,Ae,Xs=(Ae=class{constructor(){F(this,Me);F(this,Le);F(this,oe,Object.create(null))}insert(t,s,n,a,i){if(t.length===0){if(p(this,Me)!==void 0)throw Ne;if(i)return;k(this,Me,s);return}const[o,...l]=t,r=o==="*"?l.length===0?["","",Je]:["","",ut]:o==="/*"?["","",Ze]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(r){const d=r[1];let _=r[2]||ut;if(d&&r[2]&&(_===".*"||(_=_.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(_))))throw Ne;if(c=p(this,oe)[_],!c){if(Object.keys(p(this,oe)).some(u=>u!==Je&&u!==Ze))throw Ne;if(i)return;c=p(this,oe)[_]=new Ae,d!==""&&k(c,Le,a.varIndex++)}!i&&d!==""&&n.push([d,p(c,Le)])}else if(c=p(this,oe)[o],!c){if(Object.keys(p(this,oe)).some(d=>d.length>1&&d!==Je&&d!==Ze))throw Ne;if(i)return;c=p(this,oe)[o]=new Ae}c.insert(l,s,n,a,i)}buildRegExpStr(){const s=Object.keys(p(this,oe)).sort(Ks).map(n=>{const a=p(this,oe)[n];return(typeof p(a,Le)=="number"?`(${n})@${p(a,Le)}`:Gs.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof p(this,Me)=="number"&&s.unshift(`#${p(this,Me)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Me=new WeakMap,Le=new WeakMap,oe=new WeakMap,Ae),pt,it,jt,Js=(jt=class{constructor(){F(this,pt,{varIndex:0});F(this,it,new Xs)}insert(e,t,s){const n=[],a=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,r=>{const c=`@\\${o}`;return a[o]=[c,r],o++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[l]=a[o];for(let r=i.length-1;r>=0;r--)if(i[r].indexOf(l)!==-1){i[r]=i[r].replace(l,a[o][1]);break}}return p(this,it).insert(i,t,n,p(this,pt),s),n}buildRegExp(){let e=p(this,it).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,o)=>i!==void 0?(s[++t]=Number(i),"$()"):(o!==void 0&&(n[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,n]}},pt=new WeakMap,it=new WeakMap,jt),Zs=[/^$/,[],Object.create(null)],dt=Object.create(null);function ts(e){return dt[e]??(dt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function Qs(){dt=Object.create(null)}function en(e){var c;const t=new Js,s=[];if(e.length===0)return Zs;const n=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,_],[u,f])=>d?1:u?-1:_.length-f.length),a=Object.create(null);for(let d=0,_=-1,u=n.length;d<u;d++){const[f,b,m]=n[d];f?a[b]=[m.map(([g])=>[g,Object.create(null)]),es]:_++;let h;try{h=t.insert(b,_,f)}catch(g){throw g===Ne?new Zt(b):g}f||(s[_]=m.map(([g,D])=>{const y=Object.create(null);for(D-=1;D>=0;D--){const[v,N]=h[D];y[v]=N}return[g,y]}))}const[i,o,l]=t.buildRegExp();for(let d=0,_=s.length;d<_;d++)for(let u=0,f=s[d].length;u<f;u++){const b=(c=s[d][u])==null?void 0:c[1];if(!b)continue;const m=Object.keys(b);for(let h=0,g=m.length;h<g;h++)b[m[h]]=l[b[m[h]]]}const r=[];for(const d in o)r[d]=s[o[d]];return[i,r,a]}function Ce(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(ts(s).test(t))return[...e[s]]}}var be,we,ft,ss,Nt,tn=(Nt=class{constructor(){F(this,ft);S(this,"name","RegExpRouter");F(this,be);F(this,we);S(this,"match",Ys);k(this,be,{[V]:Object.create(null)}),k(this,we,{[V]:Object.create(null)})}add(e,t,s){var l;const n=p(this,be),a=p(this,we);if(!n||!a)throw new Error(Jt);n[e]||[n,a].forEach(r=>{r[e]=Object.create(null),Object.keys(r[V]).forEach(c=>{r[e][c]=[...r[V][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const r=ts(t);e===V?Object.keys(n).forEach(c=>{var d;(d=n[c])[t]||(d[t]=Ce(n[c],t)||Ce(n[V],t)||[])}):(l=n[e])[t]||(l[t]=Ce(n[e],t)||Ce(n[V],t)||[]),Object.keys(n).forEach(c=>{(e===V||e===c)&&Object.keys(n[c]).forEach(d=>{r.test(d)&&n[c][d].push([s,i])})}),Object.keys(a).forEach(c=>{(e===V||e===c)&&Object.keys(a[c]).forEach(d=>r.test(d)&&a[c][d].push([s,i]))});return}const o=Vt(t)||[t];for(let r=0,c=o.length;r<c;r++){const d=o[r];Object.keys(a).forEach(_=>{var u;(e===V||e===_)&&((u=a[_])[d]||(u[d]=[...Ce(n[_],d)||Ce(n[V],d)||[]]),a[_][d].push([s,i-c+r+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(p(this,we)).concat(Object.keys(p(this,be))).forEach(t=>{e[t]||(e[t]=j(this,ft,ss).call(this,t))}),k(this,be,k(this,we,void 0)),Qs(),e}},be=new WeakMap,we=new WeakMap,ft=new WeakSet,ss=function(e){const t=[];let s=e===V;return[p(this,be),p(this,we)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==V&&t.push(...Object.keys(n[V]).map(i=>[i,n[V][i]]))}),s?en(t):null},Nt),ve,fe,Ht,sn=(Ht=class{constructor(e){S(this,"name","SmartRouter");F(this,ve,[]);F(this,fe,[]);k(this,ve,e.routers)}add(e,t,s){if(!p(this,fe))throw new Error(Jt);p(this,fe).push([e,t,s])}match(e,t){if(!p(this,fe))throw new Error("Fatal error");const s=p(this,ve),n=p(this,fe),a=s.length;let i=0,o;for(;i<a;i++){const l=s[i];try{for(let r=0,c=n.length;r<c;r++)l.add(...n[r]);o=l.match(e,t)}catch(r){if(r instanceof Zt)continue;throw r}this.match=l.match.bind(l),k(this,ve,[l]),k(this,fe,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(p(this,fe)||p(this,ve).length!==1)throw new Error("No active router has been determined yet.");return p(this,ve)[0]}},ve=new WeakMap,fe=new WeakMap,Ht),Xe=Object.create(null),Ee,J,$e,ze,Y,me,Re,qe,nn=(qe=class{constructor(t,s,n){F(this,me);F(this,Ee);F(this,J);F(this,$e);F(this,ze,0);F(this,Y,Xe);if(k(this,J,n||Object.create(null)),k(this,Ee,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},k(this,Ee,[a])}k(this,$e,[])}insert(t,s,n){k(this,ze,++Mt(this,ze)._);let a=this;const i=Ls(s),o=[];for(let l=0,r=i.length;l<r;l++){const c=i[l],d=i[l+1],_=As(c,d),u=Array.isArray(_)?_[0]:c;if(u in p(a,J)){a=p(a,J)[u],_&&o.push(_[1]);continue}p(a,J)[u]=new qe,_&&(p(a,$e).push(_),o.push(_[1])),a=p(a,J)[u]}return p(a,Ee).push({[t]:{handler:n,possibleKeys:o.filter((l,r,c)=>c.indexOf(l)===r),score:p(this,ze)}}),a}search(t,s){var r;const n=[];k(this,Y,Xe);let i=[this];const o=Ut(s),l=[];for(let c=0,d=o.length;c<d;c++){const _=o[c],u=c===d-1,f=[];for(let b=0,m=i.length;b<m;b++){const h=i[b],g=p(h,J)[_];g&&(k(g,Y,p(h,Y)),u?(p(g,J)["*"]&&n.push(...j(this,me,Re).call(this,p(g,J)["*"],t,p(h,Y))),n.push(...j(this,me,Re).call(this,g,t,p(h,Y)))):f.push(g));for(let D=0,y=p(h,$e).length;D<y;D++){const v=p(h,$e)[D],N=p(h,Y)===Xe?{}:{...p(h,Y)};if(v==="*"){const $=p(h,J)["*"];$&&(n.push(...j(this,me,Re).call(this,$,t,p(h,Y))),k($,Y,N),f.push($));continue}const[E,H,L]=v;if(!_&&!(L instanceof RegExp))continue;const A=p(h,J)[E],se=o.slice(c).join("/");if(L instanceof RegExp){const $=L.exec(se);if($){if(N[H]=$[0],n.push(...j(this,me,Re).call(this,A,t,p(h,Y),N)),Object.keys(p(A,J)).length){k(A,Y,N);const W=((r=$[0].match(/\//))==null?void 0:r.length)??0;(l[W]||(l[W]=[])).push(A)}continue}}(L===!0||L.test(_))&&(N[H]=_,u?(n.push(...j(this,me,Re).call(this,A,t,N,p(h,Y))),p(A,J)["*"]&&n.push(...j(this,me,Re).call(this,p(A,J)["*"],t,N,p(h,Y)))):(k(A,Y,N),f.push(A)))}}i=f.concat(l.shift()??[])}return n.length>1&&n.sort((c,d)=>c.score-d.score),[n.map(({handler:c,params:d})=>[c,d])]}},Ee=new WeakMap,J=new WeakMap,$e=new WeakMap,ze=new WeakMap,Y=new WeakMap,me=new WeakSet,Re=function(t,s,n,a){const i=[];for(let o=0,l=p(t,Ee).length;o<l;o++){const r=p(t,Ee)[o],c=r[s]||r[V],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),n!==Xe||a&&a!==Xe))for(let _=0,u=c.possibleKeys.length;_<u;_++){const f=c.possibleKeys[_],b=d[c.score];c.params[f]=a!=null&&a[f]&&!b?a[f]:n[f]??(a==null?void 0:a[f]),d[c.score]=!0}}return i},qe),Ie,Bt,an=(Bt=class{constructor(){S(this,"name","TrieRouter");F(this,Ie);k(this,Ie,new nn)}add(e,t,s){const n=Vt(t);if(n){for(let a=0,i=n.length;a<i;a++)p(this,Ie).insert(e,n[a],s);return}p(this,Ie).insert(e,t,s)}match(e,t){return p(this,Ie).search(e,t)}},Ie=new WeakMap,Bt),Oe=class extends qs{constructor(e={}){super(e),this.router=e.router??new sn({routers:[new tn,new an]})}},rn=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:o=>i===o?o:null:typeof i=="function"?i:o=>i.includes(o)?o:null)(s.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(o,l){var d;function r(_,u){o.res.headers.set(_,u)}const c=await n(o.req.header("origin")||"",o);if(c&&r("Access-Control-Allow-Origin",c),s.credentials&&r("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&r("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&r("Vary","Origin"),s.maxAge!=null&&r("Access-Control-Max-Age",s.maxAge.toString());const _=await a(o.req.header("origin")||"",o);_.length&&r("Access-Control-Allow-Methods",_.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const f=o.req.header("Access-Control-Request-Headers");f&&(u=f.split(/\s*,\s*/))}return u!=null&&u.length&&(r("Access-Control-Allow-Headers",u.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function De(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function _t(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=De(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function on(e,t=14){if(e.length<t+1)return 50;const s=[];for(let r=1;r<e.length;r++)s.push(e[r]-e[r-1]);let n=0,a=0;for(let r=0;r<t;r++)s[r]>0?n+=s[r]:a+=Math.abs(s[r]);let i=n/t,o=a/t;for(let r=t;r<s.length;r++){const c=s[r];i=(i*(t-1)+(c>0?c:0))/t,o=(o*(t-1)+(c<0?Math.abs(c):0))/t}return o===0?100:100-100/(1+i/o)}function ln(e){const t=_t(e,12),s=_t(e,26),n=t-s,a=n*.9,i=n-a;return{macd:n,signal:a,histogram:i}}function cn(e,t=20,s=2){const n=De(e,t),i=e.slice(-t).reduce((l,r)=>l+Math.pow(r-n,2),0)/t,o=Math.sqrt(i);return{upper:n+o*s,middle:n,lower:n-o*s}}function dn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const o=e[i].high,l=e[i].low,r=e[i-1].close,c=Math.max(o-l,Math.abs(o-r),Math.abs(l-r));s.push(c)}const n=De(s,t);return Math.max(n,10)}function un(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(_=>_.high),i=n.map(_=>_.low),o=e[e.length-1].close,l=Math.max(...a),r=Math.min(...i),c=(o-r)/(l-r)*100;return{k:c,d:c}}function _n(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,_=e[c].low,u=e[c-1].high,f=e[c-1].low,b=e[c-1].close,m=d-u,h=f-_;m>h&&m>0&&(s+=m),h>m&&h>0&&(n+=h),a+=Math.max(d-_,Math.abs(d-b),Math.abs(_-b))}const i=a>0?s/a*100:0,o=a>0?n/a*100:0;return{adx:i+o>0?Math.abs(i-o)/(i+o)*100:0,plusDI:i,minusDI:o}}function pn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(g=>g.high)),a=Math.min(...s.map(g=>g.low)),i=(n+a)/2,o=Math.min(26,e.length),l=e.slice(-o),r=Math.max(...l.map(g=>g.high)),c=Math.min(...l.map(g=>g.low)),d=(r+c)/2,_=(i+d)/2,u=Math.min(52,e.length),f=e.slice(-u),b=Math.max(...f.map(g=>g.high)),m=Math.min(...f.map(g=>g.low)),h=(b+m)/2;return{tenkan:i,kijun:d,senkouA:_,senkouB:h}}function fn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function mn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,i=n.volume||1;t+=a*i,s+=i}return s>0?t/s:e[e.length-1].close}function gn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(r=>r.high),a=s.map(r=>r.low),i=Math.max(...n),o=Math.min(...a),l=i-o;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:o}}function xe(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=ln(t),n=cn(t),a=un(e,14,3),i=_n(e,14),o=pn(e),l=fn(e),r=mn(e),c=gn(e,50);return{rsi_14:on(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:De(t,20),sma_50:De(t,50),sma_200:e.length>=200?De(t,200):De(t,Math.min(100,e.length)),ema_12:_t(t,12),ema_26:_t(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:dn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:o.tenkan,ichimoku_kijun:o.kijun,ichimoku_senkou_a:o.senkouA,ichimoku_senkou_b:o.senkouB,parabolic_sar:l,vwap:r,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function ee(e,t,s){const n=[];let a=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:i+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(n.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),i+=2);const o=a+i,l=o>0?a/o*100:50;let r="HOLD",c=50;a>i+1?(r="BUY",c=Math.min(l,95)):i>a+1&&(r="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(a-i)>4&&(c=Math.min(c+5,95),n.push("High conviction signal"));const d=s==="day_trade"?1.5:2,_=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,f=s==="day_trade"?5:7,m=e*(1/100);let h,g,D,y;if(r==="BUY"){const v=e-t.atr_14*d;h=Math.max(v,e-m),g=e+t.atr_14*_,D=e+t.atr_14*u,y=e+t.atr_14*f}else if(r==="SELL"){const v=e+t.atr_14*d;h=Math.min(v,e+m),g=e-t.atr_14*_,D=e-t.atr_14*u,y=e-t.atr_14*f}else h=e,g=e,D=e,y=e;return{signal_type:r,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(g.toFixed(2)),take_profit_2:parseFloat(D.toFixed(2)),take_profit_3:parseFloat(y.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:n.join(", ")}}async function q(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{return(await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json()).ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function Qe(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
`)}const is=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:as,determineTrend:ns,formatAlignmentReport:hn,validateMultiTimeframeSignal:St},Symbol.toStringTag,{value:"Module"}));function At(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,o)=>i-o),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function yn(e,t){const s=At(e,.95),n=At(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function bn(e,t,s,n){const a=t-e,i=a/t*100;let o=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)o++;const l=i<=s,r=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:o}}function wn(e,t,s=5){let n=0;const a=[];for(const r of e){const d=Math.abs(r.entry_price-r.stop_loss)*r.position_size,_=d/t*100;n+=d,a.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(_.toFixed(2))})}const i=n/t*100,o=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:o,available_risk:parseFloat(l.toFixed(2)),positions:a}}function vn(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),n=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&n.push({index:r,value:s[r]});if(n.length<3)return null;const a=n.slice(-3),[i,o,l]=a;if(o.value>i.value&&o.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(o.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:65}}return null}function En(e){if(e.length<20)return null;const s=e.slice(-20).map(o=>o.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const r=s[s.length-1],c=n[n.length-1]-n[0],d=r+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function xn(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),o=n.slice(0,6),l=n.slice(-6),r=(Math.min(...l)-Math.min(...o))/Math.min(...o);if(i<.01&&r>.015){const c=Math.max(...s),d=t[t.length-1].close,_=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(_.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function kn(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),n=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&n.push({index:r,value:s[r]});if(n.length<2)return null;const a=n.slice(-2),[i,o]=a;if(Math.abs(i.value-o.value)/i.value<.015){const r=Math.max(...s.slice(i.index,o.index))*1.005,c=r+(r-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+o.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function Sn(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),r=Math.min(...l),c=(i-r)/i;if(c>.01&&c<.05){const d=n-a,_=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(_.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function Tn(e){const t=[],s=vn(e);s&&t.push(s);const n=En(e);n&&t.push(n);const a=xn(e);a&&t.push(a);const i=kn(e);i&&t.push(i);const o=Sn(e);o&&t.push(o);let l=0,r=0,c=0;for(const f of t)f.direction==="bullish"?(l++,c+=f.confidence):f.direction==="bearish"&&(r++,c+=f.confidence);let d="neutral",_=0;l>r?(d="bullish",_=Math.min(c/l/10,15)):r>l&&(d="bearish",_=Math.min(c/r/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const f=t.map(b=>b.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${f}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(_.toFixed(1)),summary:u}}function Rn(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Dn(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function Fn(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function Mn(e,t,s){const n=Rn(t.atr_14,s),a=Dn(t,s),i=Fn(t,s);let o,l,r,c,d,_;const u=e.slice(-10),f=u.map(g=>g.volume||0),b=f.reduce((g,D)=>g+D,0)/f.length,h=(u[u.length-1].volume||0)>b*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(o="BREAKOUT",l=75,r=!0,c="Trend-following (aggressive entry)",d=1.3,_="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(o="BREAKDOWN",l=75,r=!1,c="Wait for stabilization",d=.5,_="Sharp breakdown in progress - avoid trading until dust settles"):(o="RANGING",l=50,r=!1,c="Wait for direction",d=.5,_="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(o="STRONG_UPTREND",l=90,r=!0,c="Trend-following (buy dips, trail stops)",d=1.5,_="Strong bullish trend confirmed - ideal for aggressive long positions"):(o="STRONG_DOWNTREND",l=90,r=!1,c="Stay in cash or short",d=.3,_="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(o="WEAK_UPTREND",l=70,r=!0,c="Trend-following (selective entries)",d=1,_="Moderate bullish trend - trade with normal position sizing"):(o="WEAK_DOWNTREND",l=70,r=!1,c="Reduce exposure or stay flat",d=.5,_="Moderate bearish trend - reduce risk or wait"):(o="RANGING",l=80,i>60?(r=!0,c="Mean-reversion (fade extremes)",d=.8,_="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,c="Wait for trend to develop",d=.5,_="Choppy market without clear opportunity - stay on sidelines")),{regime:o,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:r,recommended_strategy:c,risk_adjustment:d,description:_}}function Ln(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let r=0;r<t;r++)s+=r,n+=e[r],a+=r*e[r],i+=r*r;const o=(t*a-s*n)/(t*i-s*s),l=(n-o*s)/t;return{slope:o,intercept:l}}function $n(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const o=(n[n.length-1]-n[n.length-10])/10;return i+o*s}function In(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const o=n.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+o}function An(e,t,s){const n=e[e.length-1].close;e.map(o=>o.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function On(e,t){const s=e.map(u=>u.close),n=s[s.length-1],a=10,i=s.slice(-a),o=Math.min(...i),l=Math.max(...i),r=i.map(u=>(u-o)/(l-o));let c={index:0,similarity:-1/0};for(let u=a;u<s.length-a-t;u++){const f=s.slice(u-a,u),b=Math.min(...f),m=Math.max(...f),h=f.map(y=>(y-b)/(m-b));let g=0;for(let y=0;y<a;y++)g+=Math.pow(r[y]-h[y],2);const D=-g;D>c.similarity&&(c={index:u,similarity:D})}const _=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+_}function Et(e,t,s){const n=[],a=[],i=e.map(E=>E.close),{slope:o,intercept:l}=Ln(i.slice(-20)),r=o*(i.length-1+s)+l;n.push(r),a.push(1);const c=$n(e,12,s);n.push(c),a.push(1.5);const d=In(e,s);n.push(d),a.push(1.2);const _=An(e,t,s);n.push(_),a.push(1.8);const u=On(e,s);n.push(u),a.push(1.3);const f=a.reduce((E,H)=>E+H,0),m=n.reduce((E,H,L)=>E+H*a[L],0)/f,h=n.reduce((E,H)=>E+H,0)/n.length,g=n.reduce((E,H)=>E+Math.pow(H-h,2),0)/n.length,D=Math.sqrt(g),y=e[e.length-1].close,v=1-D/y,N=Math.max(50,Math.min(95,v*100));return{prediction:m,confidence:N}}function Cn(e,t){const s=e[e.length-1].close,n=[],a=Et(e,t,1),i=a.prediction-s,o=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(o.toFixed(2)),method:"Ensemble (5 models)"});const l=Et(e,t,4),r=l.prediction-s,c=r/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Et(e,t,24),_=d.prediction-s,u=_/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:_>5?"UP":_<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const f=n.filter(D=>D.direction==="UP").length,b=n.filter(D=>D.direction==="DOWN").length;let m,h=0;f>b?(m="BULLISH",h=Math.min(f*5,15)):b>f?(m="BEARISH",h=Math.min(b*5,15)):m="NEUTRAL";const g=`ML models predict ${m} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:m,confidence_boost:parseFloat(h.toFixed(1)),summary:g}}function xt(e,t,s,n,a){const o=Math.abs(t-e)/s;let l;o<1?l=80:o<2?l=65:o<3?l=50:o<4?l=35:l=20;const r=(n-50)/10;l+=r;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function Pn(e,t,s,n,a){const o=Math.abs(e-t)/s;let l;if(o<1?l=60:o<1.5?l=40:o<2?l=25:l=15,a==="BUY"){const r=(n-50)/10;l-=r}else{const r=(n-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function jn(e,t,s,n,a,i){const o=(s-e)*.5,l=(n-e)*.3,r=(a-e)*.2,c=t-e;return i.tp1/100*o+i.tp2/100*l+i.tp3/100*r+i.sl/100*c}function Nn(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const o=s.slice(-50),l=[];for(let y=14;y<o.length;y++){const v=o.slice(y-14,y);let N=0;for(let E=1;E<v.length;E++){const H=Math.max(v[E].high-v[E].low,Math.abs(v[E].high-v[E-1].close),Math.abs(v[E].low-v[E-1].close));N+=H}l.push(N/14)}const r=l.reduce((y,v)=>y+v,0)/l.length,c=a/r,d=xt(n,e.take_profit_1,a,i,c),_=xt(n,e.take_profit_2,a,i,c),u=xt(n,e.take_profit_3,a,i,c),f=Pn(n,e.stop_loss,a,i,e.signal_type),b=jn(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:_,tp3:u,sl:f}),h=(d+_+u)/3/f;let g;d>70&&b>5&&h>2?g="STRONG_TRADE":d>60&&b>0&&h>1.5?g="GOOD_TRADE":d>50&&b>-2?g="MARGINAL_TRADE":g="AVOID_TRADE";const D=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${b.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${g.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(_.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(f.toFixed(1)),expected_value:parseFloat(b.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:g,summary:D}}const Dt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Hn(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function mt(e=30){const t=[],s=new Date;for(const a of Dt){const i=new Date(a),o=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));o>=0&&o<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),o=i.getFullYear(),l=i.getMonth(),r=i.getDate(),c=i.getDay();if(r===Hn(o,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,o)=>i===o.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const o=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return o.getTime()-l.getTime()})}function gt(e=new Date,t=[]){const s=[...mt(7),...t],n=s.filter(o=>new Date(`${o.date}T${o.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(o=>o.date===a&&o.impact==="high"),Dt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Bn(a)};new Date(e.getTime()+7200*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(o.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(o.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`);if(o.impact==="high"&&l>i&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${o.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Bn(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Tt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function Un(e){const t=e.toISOString().split("T")[0];return Dt.includes(t)?!0:mt(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Wn(){const e=new Date().toISOString().split("T")[0];return mt(7).filter(s=>s.date===e)}function rs(e=new Date){const t=gt(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const os=new Oe;os.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const P of["5m","15m","1h","4h","daily"]){const I=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),o=(i==null?void 0:i.close)||0;if(!o)return e.json({success:!1,error:"Current price not available"},400);console.log("[ENHANCED] Step 1.5: Checking economic calendar");const l=gt(),r=rs();let c=null,d=!1;l.riskLevel==="danger"?(d=!0,c=l.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",l.reason)):l.riskLevel==="caution"?(c=l.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",l.reason)):console.log("[ENHANCED] ✅ Calendar safe:",l.reason);const _=n["1h"];if(!_)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const u=as(n,o),f=ee(o,_,"day_trade"),b=ee(o,_,"swing_trade"),m=St(f.signal_type,u),h=St(b.signal_type,u),g={...f,base_confidence:f.confidence,mtf_confidence:m.confidence,final_confidence:Math.min(95,m.confidence),isValid:m.isValid,mtf_reason:m.reason,alignment_score:u.score,alignment_type:u.type},D={...b,base_confidence:b.confidence,mtf_confidence:h.confidence,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:u.score,alignment_type:u.type};let y=0,v="",N=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const I=Tn(a["1h"]);N=(I==null?void 0:I.patterns)||[]}catch(I){console.error("[ENHANCED] Pattern detection error:",I.message)}const P=N.filter(I=>I.confidence>=70&&I.endIndex>=a["1h"].length-5);for(const I of P)I.type==="bullish"&&g.signal_type==="BUY"?(y+=I.confidence*.1,v+=`${I.name} (${I.confidence.toFixed(0)}%), `):I.type==="bearish"&&g.signal_type==="SELL"&&(y+=I.confidence*.1,v+=`${I.name} (${I.confidence.toFixed(0)}%), `);y=Math.min(15,y)}let E=0,H="",L=null;if(a["1h"]&&a["1h"].length>=50){const P=xe(a["1h"]);P&&(L=Mn(a["1h"],P),L.trend==="STRONG_UPTREND"&&g.signal_type==="BUY"?(E=10,H="Strong Uptrend"):L.trend==="UPTREND"&&g.signal_type==="BUY"?(E=5,H="Uptrend"):L.trend==="STRONG_DOWNTREND"&&g.signal_type==="SELL"?(E=10,H="Strong Downtrend"):L.trend==="DOWNTREND"&&g.signal_type==="SELL"&&(E=5,H="Downtrend"))}let A=0,se="",$=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{$=Cn(a["1h"],o),$.overall_direction==="BULLISH"&&g.signal_type==="BUY"?(A=$.confidence_boost,se=`ML predicts +${(($.predictions[0].predicted_price/o-1)*100).toFixed(2)}% in 1h`):$.overall_direction==="BEARISH"&&g.signal_type==="SELL"&&(A=$.confidence_boost,se=`ML predicts ${(($.predictions[0].predicted_price/o-1)*100).toFixed(2)}% in 1h`)}catch(P){console.error("[ENHANCED] ML prediction error:",P.message)}let W=0,O="",B=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const P=xe(a["1h"]);P&&(B=Nn(a["1h"],P,g.price,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.signal_type==="BUY"),B.tp1_probability>70?(W=10,O=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`):B.tp1_probability>60&&(W=5,O=`PoP: TP1 ${B.tp1_probability.toFixed(0)}%`))}catch(P){console.error("[ENHANCED] Probability of Profit error:",P.message)}let G=0,Z=0,K=0,T=0,x="";try{const P=await t.prepare(`
      ...
      `).all(),R=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(P&&I.results&&I.results.length>=10){const w=yn(I.results,P.balance);G=w.var_95,Z=w.var_99;const de=bn(P.balance,I.results);if(K=de.current_drawdown_pct,de.is_within_limit||(x+=`⚠️ Drawdown ${K.toFixed(1)}% exceeds limit. `),R.results){const Se=wn(R.results,P.balance);T=Se.total_risk_pct,Se.is_within_limit||(x+=`⚠️ Portfolio heat ${T.toFixed(1)}% exceeds limit. `)}}}catch(P){console.error("[ENHANCED] Risk metrics error (optional):",P.message)}const U=y+E+A+W,M={...g,pattern_boost:y,regime_boost:E,ml_boost:A,pop_boost:W,total_boost:U,enhanced_confidence:Math.min(98,g.final_confidence+U),var_95:G,var_99:Z,current_drawdown_pct:K,portfolio_heat_pct:T,risk_warning:x||null},ce={...D,pattern_boost:y,regime_boost:E,ml_boost:A,pop_boost:W,total_boost:U,enhanced_confidence:Math.min(98,D.final_confidence+U),var_95:G,var_99:Z,current_drawdown_pct:K,portfolio_heat_pct:T,risk_warning:x||null};d?(M.signal_type="HOLD",ce.signal_type="HOLD",M.enhanced_confidence=50,ce.enhanced_confidence=50,M.reasoning=c||"Economic event nearby - trading paused",ce.reasoning=c||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):r.adjustment<0&&(M.enhanced_confidence=Math.max(50,M.enhanced_confidence+r.adjustment),ce.enhanced_confidence=Math.max(50,ce.enhanced_confidence+r.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",r.adjustment)),M.calendar_check={risk_level:l.riskLevel,should_trade:l.shouldTrade,reason:l.reason,confidence_adjustment:r.adjustment,upcoming_events:l.upcomingEvents.slice(0,3).map(P=>Tt(P))},ce.calendar_check=M.calendar_check;let Ke=!1;try{const P=await t.prepare(`
...
`,w+=`${M.isValid?"✅":"❌"} *${M.signal_type}* (${M.enhanced_confidence.toFixed(0)}% confidence)

`,w+=`*Entry:* $${M.price.toFixed(2)}
`,w+=`*Stop Loss:* $${M.stop_loss.toFixed(2)} (${((M.stop_loss/M.price-1)*100).toFixed(2)}%)
`,w+=`*TP1:* $${M.take_profit_1.toFixed(2)} (${((M.take_profit_1/M.price-1)*100).toFixed(2)}%)
`,w+=`*TP2:* $${M.take_profit_2.toFixed(2)} (${((M.take_profit_2/M.price-1)*100).toFixed(2)}%)
`,w+=`*TP3:* $${M.take_profit_3.toFixed(2)} (${((M.take_profit_3/M.price-1)*100).toFixed(2)}%)

`,w+=`*📊 Confidence Breakdown:*
`,w+=`Base: ${M.base_confidence.toFixed(0)}%
`,w+=`MTF: ${M.mtf_confidence.toFixed(0)}%
`,y>0&&(w+=`Pattern: +${y.toFixed(0)}%
`),E>0&&(w+=`Regime: +${E.toFixed(0)}%
`),A>0&&(w+=`ML: +${A.toFixed(0)}%
`),W>0&&(w+=`PoP: +${W.toFixed(0)}%
`),w+=`*FINAL: ${M.enhanced_confidence.toFixed(0)}%*

`,L&&(w+=`🌡️ *Market Regime:* ${L.trend||"N/A"}
`,w+=`Volatility: ${L.volatility}
`,w+=`Should Trade: ${L.should_trade?"✅ YES":"❌ NO"}

`),$&&$.overall_direction!=="NEUTRAL"&&(w+=`🤖 *ML Prediction:* ${$.overall_direction}
`,(s=$.predictions[0])!=null&&s.predicted_price&&(w+=`1h Target: $${$.predictions[0].predicted_price.toFixed(2)}
`),w+=`
...
`,M.isValid&&M.signal_type!=="HOLD"?(w+=`✅ *EXECUTE ${M.signal_type}*
`,w+=`All hedge fund features aligned!
`):(w+=`⚠️ *SKIP TRADE*
`,w+=`Reason: ${M.mtf_reason}
`),w+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,Ke=await q({botToken:I.telegram_bot_token,chatId:I.telegram_chat_id},w)}}catch(P){console.error("[ENHANCED] Telegram error (optional):",P.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:o,telegram_sent:Ke,day_trade:M,swing_trade:ce,alignment:{type:u.type,score:u.score,trends:u.trends},patterns:N.length>0?N.slice(0,3):null,regime:L?{trend:L.trend,volatility:L.volatility,should_trade:L.should_trade}:null,ml_prediction:$?{direction:$.overall_direction,predictions:$.predictions}:null,profit_probability:B?{tp1:B.tp1_probability,tp2:B.tp2_probability,tp3:B.tp3_probability,expected_value:B.expected_value}:null,risk_metrics:{var_95:G,var_99:Z,drawdown_pct:K,portfolio_heat_pct:T}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});async function Ye(e){const t=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,i=n.filter(f=>f.win===1).length,o=n.filter(f=>f.win===0).length,l=i/a*100,r=n.reduce((f,b)=>f+(b.profit_loss||0),0),c=Math.max(...n.map(f=>f.profit_loss||0)),d=Math.min(...n.map(f=>f.profit_loss||0)),_=n.reduce((f,b)=>f+(b.confidence||0),0)/a,u=n.reduce((f,b)=>f+(b.mtf_score||0),0)/a;await e.prepare(`
...
`)}const Xn=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:hs,runBacktest:gs},Symbol.toStringTag,{value:"Module"})),Ge=new Oe;Ge.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
    ...
    `).first();if(!o)return e.json({ok:!0});const l={botToken:o.setting_value,chatId:a.toString()};if(i.startsWith("/log_trade")){const r=i.split(" ");if(r.length<5)return await q(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const c=r[1].toUpperCase(),d=parseFloat(r[2]),_=parseFloat(r[3]),u=parseFloat(r[4]),f=await cs({trade_type:c,trading_style:"day_trade",entry_price:d,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:_,take_profit_1:u,take_profit_2:u*1.002,take_profit_3:u*1.003,status:"OPEN",confidence:85},t);f.success?await q(l,`✅ *Trade #${f.trade_id} Logged*

${c} @ $${d}
Stop: $${_}
TP1: $${u}`):await q(l,`❌ Error: ${f.error}`)}else if(i.startsWith("/close_trade")){const r=i.split(" ");if(r.length<4)return await q(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const c=parseInt(r[1]),d=parseFloat(r[2]),_=r[3],u=await ds(c,d,_,t);if(u.success){const f=u.profit_loss||0,b=f>0?"💰":"❌";await q(l,`${b} *Trade #${c} Closed*

Exit: $${d}
P&L: ${f>0?"+":""}$${f.toFixed(2)}
Result: ${f>0?"WIN ✅":"LOSS ❌"}`)}else await q(l,`❌ Error: ${u.error}`)}else if(i==="/open"){const r=await ps(t);if(r.length===0)await q(l,"📊 No open positions");else{let c=`📊 *Open Positions (${r.length})*

`;for(const d of r)c+=`#${d.id}: ${d.trade_type} @ $${d.entry_price}
`,c+=`Stop: $${d.stop_loss}
`,c+=`TP1: $${d.take_profit_1}

`;await q(l,c)}}else if(i==="/stats"){const r=await _s(t);let c=`📊 *Trading Statistics*
...
`,await q(l,c)}else i==="/help"&&await q(l,`📚 *Available Commands*
      ...
      `).bind(f.timestamp,f.open,f.high,f.low,f.close,f.volume).run(),d++}if(_.length>=50){const u=xe(_.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const f=_[_.length-1].close,b=ee(f,u,"day_trade"),m=ee(f,u,"swing_trade"),h=70;for(const g of[b,m])if(g.confidence>=h&&g.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(g.signal_type,g.trading_style,g.price,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.confidence,g.reason).run();const D=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),y={};for(const v of D.results||[])y[v.setting_key]=v.setting_value;y.telegram_bot_token&&y.telegram_chat_id&&await q({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},Qe(g))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let o=0;const l={};for(const r of i){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${r.interval}&apikey=${n}&outputsize=${r.outputsize}`,_=await(await fetch(c)).json();if(_.code&&_.status==="error"){l[r.dbKey]={success:!1,error:_.message,count:0};continue}if(!_.values||!Array.isArray(_.values)){l[r.dbKey]={success:!1,error:"No data",count:0};continue}const u=_.values;let f=0;const b=[];for(const m of u){const h={timestamp:m.datetime,open:parseFloat(m.open),high:parseFloat(m.high),low:parseFloat(m.low),close:parseFloat(m.close),volume:0};b.push(h),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(h.timestamp,h.open,h.high,h.low,h.close,h.volume,r.dbKey).run(),f++}if(b.length>=50){const m=xe(b.reverse());m&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(r.dbKey,m.rsi_14,m.macd,m.macd_signal,m.macd_histogram,m.sma_20,m.sma_50,m.sma_200,m.ema_12,m.ema_26,m.bb_upper,m.bb_middle,m.bb_lower,m.atr_14,m.stochastic_k,m.stochastic_d,m.adx,m.plus_di,m.minus_di,m.ichimoku_tenkan,m.ichimoku_kijun,m.ichimoku_senkou_a,m.ichimoku_senkou_b,m.parabolic_sar,m.vwap,m.fib_382,m.fib_500,m.fib_618).run()}l[r.dbKey]={success:!0,count:f},o+=f,await new Promise(m=>setTimeout(m,500))}return e.json({success:!0,totalCount:o,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(r=>({timestamp:r.timestamp,open:r.open,high:r.high,low:r.low,close:r.close,volume:r.volume})),a=xe(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,o=ee(i,a,"day_trade"),l=ee(i,a,"swing_trade");return e.json({success:!0,signals:{day_trade:o,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>is),i=["5m","15m","1h","4h","daily"],o={};for(const E of i){const H=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(E).first();H&&(o[E]=H)}const l=Object.keys(o).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(o)});const r=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const c=r.close,d=s(o,c),_=o["1h"],u=ee(c,_,"day_trade"),f=ee(c,_,"swing_trade"),b=n(u.signal_type,d),m=n(f.signal_type,d),h={...u,base_confidence:u.confidence,mtf_confidence:b.confidence,final_confidence:Math.min(95,b.confidence),isValid:b.isValid,mtf_reason:b.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${b.reason}`},g={...f,base_confidence:f.confidence,mtf_confidence:m.confidence,final_confidence:Math.min(95,m.confidence),isValid:m.isValid,mtf_reason:m.reason,alignment_score:d.score,alignment_type:d.type,reason:`${f.reason}, MTF: ${m.reason}`},D=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),y={};for(const E of D.results||[])y[E.setting_key]=E.setting_value;let v=!1,N=[];y.telegram_bot_token&&y.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await q({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${Qe({...h,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(N.push("day_trade"),v=!0),await new Promise(E=>setTimeout(E,1e3)),g.isValid&&g.signal_type!=="HOLD"&&await q({botToken:y.telegram_bot_token,chatId:y.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${Qe({...g,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(N.push("swing_trade"),v=!0));for(const E of[h,g])E.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(E.signal_type,E.trading_style,E.price,E.stop_loss,E.take_profit_1,E.take_profit_2,E.take_profit_3,E.base_confidence,E.mtf_confidence,E.final_confidence,E.alignment_score,E.alignment_type,E.reason,v?1:0).run();return e.json({success:!0,signals:{day_trade:h,swing_trade:g},alignment:d,alignment_report:a(d),telegram_sent:v,sent_to_telegram:N,available_timeframes:Object.keys(o)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});C.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first."});const n=s.results.reverse().map(u=>({timestamp:u.timestamp,open:u.open,high:u.high,low:u.low,close:u.close,volume:u.volume})),a=xe(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,o=ee(i,a,"day_trade"),l=ee(i,a,"swing_trade"),r=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),c={};for(const u of r.results||[])c[u.setting_key]=u.setting_value;let d=!1,_=[];c.telegram_bot_token&&c.telegram_chat_id&&(await q({botToken:c.telegram_bot_token,chatId:c.telegram_chat_id},Qe({...o,timestamp:new Date().toISOString()}))&&(_.push("day_trade"),d=!0),await new Promise(b=>setTimeout(b,1e3)),await q({botToken:c.telegram_bot_token,chatId:c.telegram_chat_id},Qe({...l,timestamp:new Date().toISOString()}))&&(_.push("swing_trade"),d=!0));for(const u of[o,l])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
    ...
    `).bind(n).all(),{calculatePositionSize:l,formatPositionSize:r}=await Promise.resolve().then(()=>rt),c=l(i,a,o.results);return e.json({success:!0,position:c,formatted:r(c)})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/trading/execute",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal_id:a,entry_price:i,stop_loss:o,take_profit_1:l,take_profit_2:r,take_profit_3:c,position_size:d,signal_type:_,trading_style:u,confidence:f}=s,b=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!b)return e.json({success:!1,error:"Account not found"},404);const m=new Date().toISOString().split("T")[0],h=await t.prepare(`
      SELECT profit_loss FROM trades 
      WHERE account_id = ? 
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,m).all(),{checkDailyLossLimit:g}=await Promise.resolve().then(()=>rt),D=g(b,h.results);if(D.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${D.current_loss_pct}% (max ${b.max_daily_loss_pct}%)`},400);const y=d*i,v=await t.prepare(`
      INSERT INTO trades (
    ...
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});C.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Fetch MTF Data",status:"running"});const n=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),a=(n==null?void 0:n.setting_value)||"70140f57bea54c5e90768de696487d8f",i=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];let o=0;for(const O of i){const B=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${O.interval}&apikey=${a}&outputsize=100`,Z=await(await fetch(B)).json();if(Z.values&&Array.isArray(Z.values)){const K=[];for(const T of Z.values){const x={timestamp:T.datetime,open:parseFloat(T.open),high:parseFloat(T.high),low:parseFloat(T.low),close:parseFloat(T.close),volume:0};K.push(x),await t.prepare(`
            INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT DO NOTHING
          `).bind(x.timestamp,x.open,x.high,x.low,x.close,x.volume,O.dbKey).run()}if(K.length>=50){const T=xe(K.reverse());T&&await t.prepare(`
              INSERT INTO multi_timeframe_indicators 
              (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
               sma_20, sma_50, sma_200, ema_12, ema_26,
               bb_upper, bb_middle, bb_lower, atr_14,
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(_==null?void 0:_.close)||0,f=l(d,u),b=d["1h"],m=ee(u,b,"day_trade"),h=ee(u,b,"swing_trade"),g=r(m.signal_type,f),D=r(h.signal_type,f),y={...m,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:f.score,alignment_type:f.type},v={...h,final_confidence:Math.min(95,D.confidence),isValid:D.isValid,mtf_reason:D.reason,alignment_score:f.score,alignment_type:f.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:y,swingTrade:v,alignment:f},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const N=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),E=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:H}=await Promise.resolve().then(()=>rt),L=H(N,{entry_price:y.price,stop_loss:y.stop_loss,take_profit_1:y.take_profit_1,take_profit_2:y.take_profit_2,take_profit_3:y.take_profit_3,confidence:y.final_confidence,signal_type:y.signal_type,trading_style:y.trading_style},E.results),A=H(N,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},E.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:L,swingPosition:A},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const se=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),$={};for(const O of se.results||[])$[O.setting_key]=O.setting_value;let W=!1;if($.telegram_bot_token&&$.telegram_chat_id){const O=`
...
${f.trends.map(G=>`${G.trend==="BULLISH"?"📈":G.trend==="BEARISH"?"📉":"➡️"} *${G.timeframe}*: ${G.trend} (${G.confidence.toFixed(0)}%)`).join(`
`)}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();W=await q({botToken:$.telegram_bot_token,chatId:$.telegram_chat_id},O)}if(s.steps[3].status=W?"completed":"failed",s.steps[3].data={telegramSent:W},y.isValid||v.isValid)for(const O of[y,v])O.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
