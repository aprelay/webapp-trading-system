var Js=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var en=(e,t,s)=>t in e?Js(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var N=(e,t,s)=>en(e,typeof t!="symbol"?t+"":t,s),$t=(e,t,s)=>t.has(e)||Vt("Cannot "+s);var h=(e,t,s)=>($t(e,t,"read from private field"),s?s.call(e):t.get(e)),U=(e,t,s)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),M=(e,t,s,n)=>($t(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),q=(e,t,s)=>($t(e,t,"access private method"),s);var Gt=(e,t,s,n)=>({set _(a){M(e,t,a,s)},get _(){return h(e,t,n)}});var qt=(e,t,s)=>(n,a)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,c=!1,d;if(e[l]?(d=e[l][0][0],n.req.routeIndex=l):d=l===e.length&&a||void 0,d)try{o=await d(n,()=>r(l+1))}catch(p){if(p instanceof Error&&t)n.error=p,o=await t(p,n),c=!0;else throw p}else n.finalized===!1&&s&&(o=await s(n));return o&&(n.finalized===!1||c)&&(n.res=o),n}},tn=Symbol(),sn=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,i=(e instanceof ps?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?nn(e,{all:s,dot:n}):{}};async function nn(e,t){const s=await e.formData();return s?an(s,t):{}}function an(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?rn(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(on(s,n,a),delete s[n])}),s}var rn=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},on=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((i,r)=>{r===a.length-1?n[i]=s:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},os=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ln=e=>{const{groups:t,path:s}=cn(e),n=os(s);return dn(n,t)},cn=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},dn=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},Et={},un=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return Et[n]||(s[2]?Et[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Et[n]=[e,s[1],!0]),Et[n]}return null},Ht=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},pn=e=>Ht(e,decodeURI),ls=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),r=t.slice(s,i===-1?void 0:i);return pn(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(a===63)break}return t.slice(s,n)},mn=e=>{const t=ls(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ge=(e,t,...s)=>(s.length&&(t=Ge(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),cs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const i=a.replace("?","");n+="/"+i,s.push(n)}else n+="/"+a}),s.filter((a,i,r)=>r.indexOf(a)===i)},Nt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ht(e,us):e):e,ds=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,c=e.indexOf("&",o);return Nt(e.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(n&&(o=Nt(o)),i=r,o==="")continue;let c;l===-1?c="":(c=e.slice(l+1,r===-1?void 0:r),n&&(c=Nt(c))),s?(a[o]&&Array.isArray(a[o])||(a[o]=[]),a[o].push(c)):a[o]??(a[o]=c)}return t?a[t]:a},gn=ds,fn=(e,t)=>ds(e,t,!0),us=decodeURIComponent,zt=e=>Ht(e,us),Xe,ue,we,ms,gs,Ut,Le,ts,ps=(ts=class{constructor(e,t="/",s=[[]]){U(this,we);N(this,"raw");U(this,Xe);U(this,ue);N(this,"routeIndex",0);N(this,"path");N(this,"bodyCache",{});U(this,Le,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,M(this,ue,s),M(this,Xe,{})}param(e){return e?q(this,we,ms).call(this,e):q(this,we,gs).call(this)}query(e){return gn(this.url,e)}queries(e){return fn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await sn(this,e))}json(){return h(this,Le).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,Le).call(this,"text")}arrayBuffer(){return h(this,Le).call(this,"arrayBuffer")}blob(){return h(this,Le).call(this,"blob")}formData(){return h(this,Le).call(this,"formData")}addValidatedData(e,t){h(this,Xe)[e]=t}valid(e){return h(this,Xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[tn](){return h(this,ue)}get matchedRoutes(){return h(this,ue)[0].map(([[,e]])=>e)}get routePath(){return h(this,ue)[0].map(([[,e]])=>e)[this.routeIndex].path}},Xe=new WeakMap,ue=new WeakMap,we=new WeakSet,ms=function(e){const t=h(this,ue)[0][this.routeIndex][1][e],s=q(this,we,Ut).call(this,t);return s&&/\%/.test(s)?zt(s):s},gs=function(){const e={},t=Object.keys(h(this,ue)[0][this.routeIndex][1]);for(const s of t){const n=q(this,we,Ut).call(this,h(this,ue)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?zt(n):n)}return e},Ut=function(e){return h(this,ue)[1]?h(this,ue)[1][e]:e},Le=new WeakMap,ts),_n={Stringify:1},fs=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>fs(o,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},hn="text/plain; charset=UTF-8",Ft=(e,t)=>({"Content-Type":e,...t}),ct,dt,he,Ke,ye,de,ut,Ze,Qe,Oe,pt,mt,ke,qe,ss,yn=(ss=class{constructor(e,t){U(this,ke);U(this,ct);U(this,dt);N(this,"env",{});U(this,he);N(this,"finalized",!1);N(this,"error");U(this,Ke);U(this,ye);U(this,de);U(this,ut);U(this,Ze);U(this,Qe);U(this,Oe);U(this,pt);U(this,mt);N(this,"render",(...e)=>(h(this,Ze)??M(this,Ze,t=>this.html(t)),h(this,Ze).call(this,...e)));N(this,"setLayout",e=>M(this,ut,e));N(this,"getLayout",()=>h(this,ut));N(this,"setRenderer",e=>{M(this,Ze,e)});N(this,"header",(e,t,s)=>{this.finalized&&M(this,de,new Response(h(this,de).body,h(this,de)));const n=h(this,de)?h(this,de).headers:h(this,Oe)??M(this,Oe,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});N(this,"status",e=>{M(this,Ke,e)});N(this,"set",(e,t)=>{h(this,he)??M(this,he,new Map),h(this,he).set(e,t)});N(this,"get",e=>h(this,he)?h(this,he).get(e):void 0);N(this,"newResponse",(...e)=>q(this,ke,qe).call(this,...e));N(this,"body",(e,t,s)=>q(this,ke,qe).call(this,e,t,s));N(this,"text",(e,t,s)=>!h(this,Oe)&&!h(this,Ke)&&!t&&!s&&!this.finalized?new Response(e):q(this,ke,qe).call(this,e,t,Ft(hn,s)));N(this,"json",(e,t,s)=>q(this,ke,qe).call(this,JSON.stringify(e),t,Ft("application/json",s)));N(this,"html",(e,t,s)=>{const n=a=>q(this,ke,qe).call(this,a,t,Ft("text/html; charset=UTF-8",s));return typeof e=="object"?fs(e,_n.Stringify,!1,{}).then(n):n(e)});N(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});N(this,"notFound",()=>(h(this,Qe)??M(this,Qe,()=>new Response),h(this,Qe).call(this,this)));M(this,ct,e),t&&(M(this,ye,t.executionCtx),this.env=t.env,M(this,Qe,t.notFoundHandler),M(this,mt,t.path),M(this,pt,t.matchResult))}get req(){return h(this,dt)??M(this,dt,new ps(h(this,ct),h(this,mt),h(this,pt))),h(this,dt)}get event(){if(h(this,ye)&&"respondWith"in h(this,ye))return h(this,ye);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,ye))return h(this,ye);throw Error("This context has no ExecutionContext")}get res(){return h(this,de)||M(this,de,new Response(null,{headers:h(this,Oe)??M(this,Oe,new Headers)}))}set res(e){if(h(this,de)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,de).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=h(this,de).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}M(this,de,e),this.finalized=!0}get var(){return h(this,he)?Object.fromEntries(h(this,he)):{}}},ct=new WeakMap,dt=new WeakMap,he=new WeakMap,Ke=new WeakMap,ye=new WeakMap,de=new WeakMap,ut=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,Oe=new WeakMap,pt=new WeakMap,mt=new WeakMap,ke=new WeakSet,qe=function(e,t,s){const n=h(this,de)?new Headers(h(this,de).headers):h(this,Oe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?n.append(r,l):n.set(r,l)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")n.set(i,r);else{n.delete(i);for(const l of r)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ke);return new Response(e,{status:a,headers:n})},ss),te="ALL",bn="all",En=["get","post","put","delete","options","patch"],_s="Can not add a route since the matcher is already built.",hs=class extends Error{},vn="__COMPOSED_HANDLER",wn=e=>e.text("404 Not Found",404),Xt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,se,ys,me,$e,vt,wt,Je,Sn=(Je=class{constructor(t={}){U(this,se);N(this,"get");N(this,"post");N(this,"put");N(this,"delete");N(this,"options");N(this,"patch");N(this,"all");N(this,"on");N(this,"use");N(this,"router");N(this,"getPath");N(this,"_basePath","/");U(this,pe,"/");N(this,"routes",[]);U(this,me,wn);N(this,"errorHandler",Xt);N(this,"onError",t=>(this.errorHandler=t,this));N(this,"notFound",t=>(M(this,me,t),this));N(this,"fetch",(t,...s)=>q(this,se,wt).call(this,t,s[1],s[0],t.method));N(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ge("/",t)}`,s),n,a)));N(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(q(this,se,wt).call(this,t.request,t,void 0,t.request.method))})});[...En,bn].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?M(this,pe,r):q(this,se,$e).call(this,i,h(this,pe),r),l.forEach(o=>{q(this,se,$e).call(this,i,h(this,pe),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){M(this,pe,o);for(const c of[i].flat())l.map(d=>{q(this,se,$e).call(this,c.toUpperCase(),h(this,pe),d)})}return this},this.use=(i,...r)=>(typeof i=="string"?M(this,pe,i):(M(this,pe,"*"),r.unshift(i)),r.forEach(l=>{q(this,se,$e).call(this,te,h(this,pe),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ls:mn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var r;let i;s.errorHandler===Xt?i=a.handler:(i=async(l,o)=>(await qt([],s.errorHandler)(l,()=>a.handler(l,o))).res,i[vn]=a.handler),q(r=n,se,$e).call(r,a.method,a.path,i)}),this}basePath(t){const s=q(this,se,ys).call(this);return s._basePath=Ge(this._basePath,t),s}mount(t,s,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=o=>o:a=n.replaceRequest));const r=i?o=>{const c=i(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};a||(a=(()=>{const o=Ge(this._basePath,t),c=o==="/"?0:o.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const l=async(o,c)=>{const d=await s(a(o.req.raw),...r(o));if(d)return d;await c()};return q(this,se,$e).call(this,te,Ge(t,"*"),l),this}},pe=new WeakMap,se=new WeakSet,ys=function(){const t=new Je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,M(t,me,h(this,me)),t.routes=this.routes,t},me=new WeakMap,$e=function(t,s,n){t=t.toUpperCase(),s=Ge(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},vt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},wt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await q(this,se,wt).call(this,t,s,n,"GET")))();const i=this.getPath(t,{env:n}),r=this.router.match(a,i),l=new yn(t,{path:i,matchResult:r,env:n,executionCtx:s,notFoundHandler:h(this,me)});if(r[0].length===1){let c;try{c=r[0][0][0][0](l,async()=>{l.res=await h(this,me).call(this,l)})}catch(d){return q(this,se,vt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:h(this,me).call(this,l))).catch(d=>q(this,se,vt).call(this,d,l)):c??h(this,me).call(this,l)}const o=qt(r[0],this.errorHandler,h(this,me));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return q(this,se,vt).call(this,c,l)}})()},Je),bs=[];function xn(e,t){const s=this.buildAllMatchers(),n=((a,i)=>{const r=s[a]||s[te],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],bs];const c=o.indexOf("",1);return[r[1][c],o]});return this.match=n,n(e,t)}var Tt="[^/]+",rt=".*",ot="(?:|/.*)",ze=Symbol(),Tn=new Set(".\\+*[^]$()");function Ln(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===rt||e===ot?1:t===rt||t===ot?-1:e===Tt?1:t===Tt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ce,Be,ge,He,kn=(He=class{constructor(){U(this,Ce);U(this,Be);U(this,ge,Object.create(null))}insert(t,s,n,a,i){if(t.length===0){if(h(this,Ce)!==void 0)throw ze;if(i)return;M(this,Ce,s);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",rt]:["","",Tt]:r==="/*"?["","",ot]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const d=o[1];let p=o[2]||Tt;if(d&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ze;if(c=h(this,ge)[p],!c){if(Object.keys(h(this,ge)).some(u=>u!==rt&&u!==ot))throw ze;if(i)return;c=h(this,ge)[p]=new He,d!==""&&M(c,Be,a.varIndex++)}!i&&d!==""&&n.push([d,h(c,Be)])}else if(c=h(this,ge)[r],!c){if(Object.keys(h(this,ge)).some(d=>d.length>1&&d!==rt&&d!==ot))throw ze;if(i)return;c=h(this,ge)[r]=new He}c.insert(l,s,n,a,i)}buildRegExpStr(){const s=Object.keys(h(this,ge)).sort(Ln).map(n=>{const a=h(this,ge)[n];return(typeof h(a,Be)=="number"?`(${n})@${h(a,Be)}`:Tn.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof h(this,Ce)=="number"&&s.unshift(`#${h(this,Ce)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ce=new WeakMap,Be=new WeakMap,ge=new WeakMap,He),Rt,gt,ns,Rn=(ns=class{constructor(){U(this,Rt,{varIndex:0});U(this,gt,new kn)}insert(e,t,s){const n=[],a=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const c=`@\\${r}`;return a[r]=[c,o],r++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=a.length-1;r>=0;r--){const[l]=a[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,a[r][1]);break}}return h(this,gt).insert(i,t,n,h(this,Rt),s),n}buildRegExp(){let e=h(this,gt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(n[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Rt=new WeakMap,gt=new WeakMap,ns),An=[/^$/,[],Object.create(null)],St=Object.create(null);function Es(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function In(){St=Object.create(null)}function Dn(e){var c;const t=new Rn,s=[];if(e.length===0)return An;const n=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[u,m])=>d?1:u?-1:p.length-m.length),a=Object.create(null);for(let d=0,p=-1,u=n.length;d<u;d++){const[m,g,f]=n[d];m?a[g]=[f.map(([y])=>[y,Object.create(null)]),bs]:p++;let _;try{_=t.insert(g,p,m)}catch(y){throw y===ze?new hs(g):y}m||(s[p]=f.map(([y,S])=>{const v=Object.create(null);for(S-=1;S>=0;S--){const[b,x]=_[S];v[b]=x}return[y,v]}))}const[i,r,l]=t.buildRegExp();for(let d=0,p=s.length;d<p;d++)for(let u=0,m=s[d].length;u<m;u++){const g=(c=s[d][u])==null?void 0:c[1];if(!g)continue;const f=Object.keys(g);for(let _=0,y=f.length;_<y;_++)g[f[_]]=l[g[f[_]]]}const o=[];for(const d in r)o[d]=s[r[d]];return[i,o,a]}function Ve(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(Es(s).test(t))return[...e[s]]}}var Re,Ae,At,vs,as,Mn=(as=class{constructor(){U(this,At);N(this,"name","RegExpRouter");U(this,Re);U(this,Ae);N(this,"match",xn);M(this,Re,{[te]:Object.create(null)}),M(this,Ae,{[te]:Object.create(null)})}add(e,t,s){var l;const n=h(this,Re),a=h(this,Ae);if(!n||!a)throw new Error(_s);n[e]||[n,a].forEach(o=>{o[e]=Object.create(null),Object.keys(o[te]).forEach(c=>{o[e][c]=[...o[te][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Es(t);e===te?Object.keys(n).forEach(c=>{var d;(d=n[c])[t]||(d[t]=Ve(n[c],t)||Ve(n[te],t)||[])}):(l=n[e])[t]||(l[t]=Ve(n[e],t)||Ve(n[te],t)||[]),Object.keys(n).forEach(c=>{(e===te||e===c)&&Object.keys(n[c]).forEach(d=>{o.test(d)&&n[c][d].push([s,i])})}),Object.keys(a).forEach(c=>{(e===te||e===c)&&Object.keys(a[c]).forEach(d=>o.test(d)&&a[c][d].push([s,i]))});return}const r=cs(t)||[t];for(let o=0,c=r.length;o<c;o++){const d=r[o];Object.keys(a).forEach(p=>{var u;(e===te||e===p)&&((u=a[p])[d]||(u[d]=[...Ve(n[p],d)||Ve(n[te],d)||[]]),a[p][d].push([s,i-c+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Ae)).concat(Object.keys(h(this,Re))).forEach(t=>{e[t]||(e[t]=q(this,At,vs).call(this,t))}),M(this,Re,M(this,Ae,void 0)),In(),e}},Re=new WeakMap,Ae=new WeakMap,At=new WeakSet,vs=function(e){const t=[];let s=e===te;return[h(this,Re),h(this,Ae)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==te&&t.push(...Object.keys(n[te]).map(i=>[i,n[te][i]]))}),s?Dn(t):null},as),Ie,be,is,$n=(is=class{constructor(e){N(this,"name","SmartRouter");U(this,Ie,[]);U(this,be,[]);M(this,Ie,e.routers)}add(e,t,s){if(!h(this,be))throw new Error(_s);h(this,be).push([e,t,s])}match(e,t){if(!h(this,be))throw new Error("Fatal error");const s=h(this,Ie),n=h(this,be),a=s.length;let i=0,r;for(;i<a;i++){const l=s[i];try{for(let o=0,c=n.length;o<c;o++)l.add(...n[o]);r=l.match(e,t)}catch(o){if(o instanceof hs)continue;throw o}this.match=l.match.bind(l),M(this,Ie,[l]),M(this,be,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(h(this,be)||h(this,Ie).length!==1)throw new Error("No active router has been determined yet.");return h(this,Ie)[0]}},Ie=new WeakMap,be=new WeakMap,is),it=Object.create(null),De,le,Ue,et,ie,Ee,Ne,tt,Nn=(tt=class{constructor(t,s,n){U(this,Ee);U(this,De);U(this,le);U(this,Ue);U(this,et,0);U(this,ie,it);if(M(this,le,n||Object.create(null)),M(this,De,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},M(this,De,[a])}M(this,Ue,[])}insert(t,s,n){M(this,et,++Gt(this,et)._);let a=this;const i=ln(s),r=[];for(let l=0,o=i.length;l<o;l++){const c=i[l],d=i[l+1],p=un(c,d),u=Array.isArray(p)?p[0]:c;if(u in h(a,le)){a=h(a,le)[u],p&&r.push(p[1]);continue}h(a,le)[u]=new tt,p&&(h(a,Ue).push(p),r.push(p[1])),a=h(a,le)[u]}return h(a,De).push({[t]:{handler:n,possibleKeys:r.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,et)}}),a}search(t,s){var o;const n=[];M(this,ie,it);let i=[this];const r=os(s),l=[];for(let c=0,d=r.length;c<d;c++){const p=r[c],u=c===d-1,m=[];for(let g=0,f=i.length;g<f;g++){const _=i[g],y=h(_,le)[p];y&&(M(y,ie,h(_,ie)),u?(h(y,le)["*"]&&n.push(...q(this,Ee,Ne).call(this,h(y,le)["*"],t,h(_,ie))),n.push(...q(this,Ee,Ne).call(this,y,t,h(_,ie)))):m.push(y));for(let S=0,v=h(_,Ue).length;S<v;S++){const b=h(_,Ue)[S],x=h(_,ie)===it?{}:{...h(_,ie)};if(b==="*"){const $=h(_,le)["*"];$&&(n.push(...q(this,Ee,Ne).call(this,$,t,h(_,ie))),M($,ie,x),m.push($));continue}const[T,B,G]=b;if(!p&&!(G instanceof RegExp))continue;const k=h(_,le)[T],w=r.slice(c).join("/");if(G instanceof RegExp){const $=G.exec(w);if($){if(x[B]=$[0],n.push(...q(this,Ee,Ne).call(this,k,t,h(_,ie),x)),Object.keys(h(k,le)).length){M(k,ie,x);const A=((o=$[0].match(/\//))==null?void 0:o.length)??0;(l[A]||(l[A]=[])).push(k)}continue}}(G===!0||G.test(p))&&(x[B]=p,u?(n.push(...q(this,Ee,Ne).call(this,k,t,x,h(_,ie))),h(k,le)["*"]&&n.push(...q(this,Ee,Ne).call(this,h(k,le)["*"],t,x,h(_,ie)))):(M(k,ie,x),m.push(k)))}}i=m.concat(l.shift()??[])}return n.length>1&&n.sort((c,d)=>c.score-d.score),[n.map(({handler:c,params:d})=>[c,d])]}},De=new WeakMap,le=new WeakMap,Ue=new WeakMap,et=new WeakMap,ie=new WeakMap,Ee=new WeakSet,Ne=function(t,s,n,a){const i=[];for(let r=0,l=h(t,De).length;r<l;r++){const o=h(t,De)[r],c=o[s]||o[te],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),n!==it||a&&a!==it))for(let p=0,u=c.possibleKeys.length;p<u;p++){const m=c.possibleKeys[p],g=d[c.score];c.params[m]=a!=null&&a[m]&&!g?a[m]:n[m]??(a==null?void 0:a[m]),d[c.score]=!0}}return i},tt),Pe,rs,Fn=(rs=class{constructor(){N(this,"name","TrieRouter");U(this,Pe);M(this,Pe,new Nn)}add(e,t,s){const n=cs(t);if(n){for(let a=0,i=n.length;a<i;a++)h(this,Pe).insert(e,n[a],s);return}h(this,Pe).insert(e,t,s)}match(e,t){return h(this,Pe).search(e,t)}},Pe=new WeakMap,rs),_e=class extends Sn{constructor(e={}){super(e),this.router=e.router??new $n({routers:[new Mn,new Fn]})}},On=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:r=>i===r?r:null:typeof i=="function"?i:r=>i.includes(r)?r:null)(s.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(r,l){var d;function o(p,u){r.res.headers.set(p,u)}const c=await n(r.req.header("origin")||"",r);if(c&&o("Access-Control-Allow-Origin",c),s.credentials&&o("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await a(r.req.header("origin")||"",r);p.length&&o("Access-Control-Allow-Methods",p.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const m=r.req.header("Access-Control-Request-Headers");m&&(u=m.split(/\s*,\s*/))}return u!=null&&u.length&&(o("Access-Control-Allow-Headers",u.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function Lt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Fe(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Cn(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let n=0,a=0;for(let o=0;o<t;o++)s[o]>0?n+=s[o]:a+=Math.abs(s[o]);let i=n/t,r=a/t;for(let o=t;o<s.length;o++){const c=s[o];i=(i*(t-1)+(c>0?c:0))/t,r=(r*(t-1)+(c<0?Math.abs(c):0))/t}return r===0?100:100-100/(1+i/r)}function Bn(e){const t=Lt(e,12),s=Lt(e,26),n=t-s,a=n*.9,i=n-a;return{macd:n,signal:a,histogram:i}}function Un(e,t=20,s=2){const n=Fe(e,t),i=e.slice(-t).reduce((l,o)=>l+Math.pow(o-n,2),0)/t,r=Math.sqrt(i);return{upper:n+r*s,middle:n,lower:n-r*s}}function Pn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const r=e[i].high,l=e[i].low,o=e[i-1].close,c=Math.max(r-l,Math.abs(r-o),Math.abs(l-o));s.push(c)}const n=Fe(s,t);return Math.max(n,10)}function Hn(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(p=>p.high),i=n.map(p=>p.low),r=e[e.length-1].close,l=Math.max(...a),o=Math.min(...i),c=(r-o)/(l-o)*100;return{k:c,d:c}}function jn(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,p=e[c].low,u=e[c-1].high,m=e[c-1].low,g=e[c-1].close,f=d-u,_=m-p;f>_&&f>0&&(s+=f),_>f&&_>0&&(n+=_),a+=Math.max(d-p,Math.abs(d-g),Math.abs(p-g))}const i=a>0?s/a*100:0,r=a>0?n/a*100:0;return{adx:i+r>0?Math.abs(i-r)/(i+r)*100:0,plusDI:i,minusDI:r}}function Wn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(y=>y.high)),a=Math.min(...s.map(y=>y.low)),i=(n+a)/2,r=Math.min(26,e.length),l=e.slice(-r),o=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(o+c)/2,p=(i+d)/2,u=Math.min(52,e.length),m=e.slice(-u),g=Math.max(...m.map(y=>y.high)),f=Math.min(...m.map(y=>y.low)),_=(g+f)/2;return{tenkan:i,kijun:d,senkouA:p,senkouB:_}}function Yn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Vn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,i=n.volume||1;t+=a*i,s+=i}return s>0?t/s:e[e.length-1].close}function Gn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(o=>o.high),a=s.map(o=>o.low),i=Math.max(...n),r=Math.min(...a),l=i-r;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:r}}function ve(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=Bn(t),n=Un(t),a=Hn(e,14,3),i=jn(e,14),r=Wn(e),l=Yn(e),o=Vn(e),c=Gn(e,50);return{rsi_14:Cn(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:Lt(t,12),ema_26:Lt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Pn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:r.tenkan,ichimoku_kijun:r.kijun,ichimoku_senkou_a:r.senkouA,ichimoku_senkou_b:r.senkouB,parabolic_sar:l,vwap:o,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function re(e,t,s){const n=[];let a=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:i+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(n.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),i+=2);const r=a+i,l=r>0?a/r*100:50;let o="HOLD",c=50;a>i+1?(o="BUY",c=Math.min(l,95)):i>a+1&&(o="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(a-i)>4&&(c=Math.min(c+5,95),n.push("High conviction signal"));const d=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,f=e*(1/100);let _,y,S,v;if(o==="BUY"){const b=e-t.atr_14*d;_=Math.max(b,e-f),y=e+t.atr_14*p,S=e+t.atr_14*u,v=e+t.atr_14*m}else if(o==="SELL"){const b=e+t.atr_14*d;_=Math.min(b,e+f),y=e-t.atr_14*p,S=e-t.atr_14*u,v=e-t.atr_14*m}else _=e,y=e,S=e,v=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(_.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(S.toFixed(2)),take_profit_3:parseFloat(v.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:n.join(", ")}}async function Z(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function qn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function lt(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
`)}const Ss=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:jt,determineTrend:ws,formatAlignmentReport:zn,validateMultiTimeframeSignal:Pt},Symbol.toStringTag,{value:"Module"}));function Kt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function Xn(e,t){const s=Kt(e,.95),n=Kt(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Kn(e,t,s,n){const a=t-e,i=a/t*100;let r=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function Zn(e,t,s=5){let n=0;const a=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=d/t*100;n+=d,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=n/t*100,r=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:a}}function Qn(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[i,r,l]=a;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(r.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function Jn(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],c=n[n.length-1]-n[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function ea(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,p=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function ta(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[i,r]=a;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,c=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function sa(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),c=(i-o)/i;if(c>.01&&c<.05){const d=n-a,p=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function na(e){const t=[],s=Qn(e);s&&t.push(s);const n=Jn(e);n&&t.push(n);const a=ea(e);a&&t.push(a);const i=ta(e);i&&t.push(i);const r=sa(e);r&&t.push(r);let l=0,o=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(o++,c+=m.confidence);let d="neutral",p=0;l>o?(d="bullish",p=Math.min(c/l/10,15)):o>l&&(d="bearish",p=Math.min(c/o/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const m=t.map(g=>g.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(p.toFixed(1)),summary:u}}function aa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function ia(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function ra(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function oa(e,t,s){const n=aa(t.atr_14,s),a=ia(t,s),i=ra(t,s);let r,l,o,c,d,p;const u=e.slice(-10),m=u.map(y=>y.volume||0),g=m.reduce((y,S)=>y+S,0)/m.length,_=(u[u.length-1].volume||0)>g*1.5;return n==="EXTREME"&&_?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,c="Wait for direction",d=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,p="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,p="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:p}}function la(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],i+=o*o;const r=(t*a-s*n)/(t*i-s*s),l=(n-r*s)/t;return{slope:r,intercept:l}}function ca(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const r=(n[n.length-1]-n[n.length-10])/10;return i+r*s}function da(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const r=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function ua(e,t,s){const n=e[e.length-1].close;e.map(r=>r.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function pa(e,t){const s=e.map(u=>u.close),n=s[s.length-1],a=10,i=s.slice(-a),r=Math.min(...i),l=Math.max(...i),o=i.map(u=>(u-r)/(l-r));let c={index:0,similarity:-1/0};for(let u=a;u<s.length-a-t;u++){const m=s.slice(u-a,u),g=Math.min(...m),f=Math.max(...m),_=m.map(v=>(v-g)/(f-g));let y=0;for(let v=0;v<a;v++)y+=Math.pow(o[v]-_[v],2);const S=-y;S>c.similarity&&(c={index:u,similarity:S})}const p=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+p}function Ot(e,t,s){const n=[],a=[],i=e.map(T=>T.close),{slope:r,intercept:l}=la(i.slice(-20)),o=r*(i.length-1+s)+l;n.push(o),a.push(1);const c=ca(e,12,s);n.push(c),a.push(1.5);const d=da(e,s);n.push(d),a.push(1.2);const p=ua(e,t,s);n.push(p),a.push(1.8);const u=pa(e,s);n.push(u),a.push(1.3);const m=a.reduce((T,B)=>T+B,0),f=n.reduce((T,B,G)=>T+B*a[G],0)/m,_=n.reduce((T,B)=>T+B,0)/n.length,y=n.reduce((T,B)=>T+Math.pow(B-_,2),0)/n.length,S=Math.sqrt(y),v=e[e.length-1].close,b=1-S/v,x=Math.max(50,Math.min(95,b*100));return{prediction:f,confidence:x}}function ma(e,t){const s=e[e.length-1].close,n=[],a=Ot(e,t,1),i=a.prediction-s,r=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=Ot(e,t,4),o=l.prediction-s,c=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Ot(e,t,24),p=d.prediction-s,u=p/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(S=>S.direction==="UP").length,g=n.filter(S=>S.direction==="DOWN").length;let f,_=0;m>g?(f="BULLISH",_=Math.min(m*5,15)):g>m?(f="BEARISH",_=Math.min(g*5,15)):f="NEUTRAL";const y=`ML models predict ${f} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:f,confidence_boost:parseFloat(_.toFixed(1)),summary:y}}function Ct(e,t,s,n,a){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(n-50)/10;l+=o;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function ga(e,t,s,n,a){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function fa(e,t,s,n,a,i){const r=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,c=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*c}function _a(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let v=14;v<r.length;v++){const b=r.slice(v-14,v);let x=0;for(let T=1;T<b.length;T++){const B=Math.max(b[T].high-b[T].low,Math.abs(b[T].high-b[T-1].close),Math.abs(b[T].low-b[T-1].close));x+=B}l.push(x/14)}const o=l.reduce((v,b)=>v+b,0)/l.length,c=a/o,d=Ct(n,e.take_profit_1,a,i,c),p=Ct(n,e.take_profit_2,a,i,c),u=Ct(n,e.take_profit_3,a,i,c),m=ga(n,e.stop_loss,a,i,e.signal_type),g=fa(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:p,tp3:u,sl:m}),_=(d+p+u)/3/m;let y;d>70&&g>5&&_>2?y="STRONG_TRADE":d>60&&g>0&&_>1.5?y="GOOD_TRADE":d>50&&g>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const S=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${_.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(_.toFixed(2)),recommendation:y,summary:S}}function xs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=ha(e),s=ya(),n=ba(e,s.session),a=Ea(t,s.session),i=va(t,s),r=wa(t,s,n,i),l=Sa(r,t,s,n),o=xa(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function ha(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,a=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,r=a/n;let l;a>i*1.2?l="INCREASING":a<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:n,current_volume:a,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function ya(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,i;return n>=780&&n<960?(a="OVERLAP",i="HIGH"):n>=480&&n<780?(a="LONDON",i="HIGH"):n>=960&&n<1320?(a="NEW_YORK",i="HIGH"):n>=0&&n<480?(a="ASIA",i="MEDIUM"):(a="OFF_HOURS",i="LOW"),{zone:i,session:a}}function ba(e,t){const s=e.slice(-20);let n=0;for(const d of s){const p=d.high-d.low;n+=p}const a=n/s.length,i=s[s.length-1].close,r=a/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,c=l*o;return{spread_pips:Math.round(c)}}function Ea(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*i}function va(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function wa(e,t,s,n){const a=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+i+r+l}function Sa(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function xa(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Wt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ta(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function It(e=30){const t=[],s=new Date;for(const a of Wt){const i=new Date(a),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),c=i.getDay();if(o===Ta(r,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,r)=>i===r.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const r=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function ft(e=new Date,t=[]){const s=[...It(7),...t],n=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(r=>r.date===a&&r.impact==="high"),Wt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:La(a)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function La(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function xt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function ka(e){const t=e.toISOString().split("T")[0];return Wt.includes(t)?!0:It(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Ra(){const e=new Date().toISOString().split("T")[0];return It(7).filter(s=>s.date===e)}function Ts(e=new Date){const t=ft(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const Ls=new _e;Ls.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const C of["5m","15m","1h","4h","daily"]){const D=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const C=new Date(r.timestamp).getTime(),D=(Date.now()-C)/(1e3*60);D>60&&i.push(`⚠️ WARNING: Price data is ${D.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${D.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ft(),c=Ts();let d=null,p=!1;o.riskLevel==="danger"?(p=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const u=n["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const m=jt(n,l),g=re(l,u,"day_trade"),f=re(l,u,"swing_trade"),_=Pt(g.signal_type,m),y=Pt(f.signal_type,m),S={...g,base_confidence:g.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:m.score,alignment_type:m.type},v={...f,base_confidence:f.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type};let b=0,x="",T=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const D=na(a["1h"]);T=(D==null?void 0:D.patterns)||[]}catch(D){console.error("[ENHANCED] Pattern detection error:",D.message)}const C=T.filter(D=>D.confidence>=70&&D.endIndex>=a["1h"].length-5);for(const D of C)D.type==="bullish"&&S.signal_type==="BUY"?(b+=D.confidence*.1,x+=`${D.name} (${D.confidence.toFixed(0)}%), `):D.type==="bearish"&&S.signal_type==="SELL"&&(b+=D.confidence*.1,x+=`${D.name} (${D.confidence.toFixed(0)}%), `);b=Math.min(15,b)}let B=0,G="",k=null;if(a["1h"]&&a["1h"].length>=50){const C=ve(a["1h"]);C&&(k=oa(a["1h"],C),k.trend==="STRONG_UPTREND"&&S.signal_type==="BUY"?(B=10,G="Strong Uptrend"):k.trend==="UPTREND"&&S.signal_type==="BUY"?(B=5,G="Uptrend"):k.trend==="STRONG_DOWNTREND"&&S.signal_type==="SELL"?(B=10,G="Strong Downtrend"):k.trend==="DOWNTREND"&&S.signal_type==="SELL"&&(B=5,G="Downtrend"))}let w=0,$="",A=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{A=ma(a["1h"],l),A.overall_direction==="BULLISH"&&S.signal_type==="BUY"?(w=A.confidence_boost,$=`ML predicts +${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):A.overall_direction==="BEARISH"&&S.signal_type==="SELL"&&(w=A.confidence_boost,$=`ML predicts ${((A.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(C){console.error("[ENHANCED] ML prediction error:",C.message)}let W=0,H="",X=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const C=ve(a["1h"]);C&&(X=_a(S,C,a["1h"]),X.tp1_probability>70?(W=10,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`):X.tp1_probability>60&&(W=5,H=`PoP: TP1 ${X.tp1_probability.toFixed(0)}%`))}catch(C){console.error("[ENHANCED] Probability of Profit error:",C.message)}let R=null,Y=0,ce=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{R=xs(a["1h"]),R.liquidity_score>=80?Y=5:R.liquidity_score>=70?Y=0:R.liquidity_score>=50?ce=-5:ce=-10,console.log(`[LIQUIDITY] Score: ${R.liquidity_score}/100, Session: ${R.session}, Adjust: ${Y+ce}%`)}catch(C){console.error("[ENHANCED] Liquidity Analysis error:",C.message)}let I=0,z=0,ee=0,ne=0,ae="";try{const C=await t.prepare(`
      ...
      `).all(),V=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(C&&D.results&&D.results.length>=10){const E=Xn(D.results,C.balance);I=E.var_95,z=E.var_99;const oe=Kn(C.balance,D.results);if(ee=oe.current_drawdown_pct,oe.is_within_limit||(ae+=`⚠️ Drawdown ${ee.toFixed(1)}% exceeds limit. `),V.results){const O=Zn(V.results,C.balance);ne=O.total_risk_pct,O.is_within_limit||(ae+=`⚠️ Portfolio heat ${ne.toFixed(1)}% exceeds limit. `)}}}catch(C){console.error("[ENHANCED] Risk metrics error (optional):",C.message)}const L=b+B+w+W+Y+ce,j={...S,pattern_boost:b,regime_boost:B,ml_boost:w,pop_boost:W,total_boost:L,enhanced_confidence:Math.min(98,S.final_confidence+L),var_95:I,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ne,risk_warning:ae||null},F={...v,pattern_boost:b,regime_boost:B,ml_boost:w,pop_boost:W,total_boost:L,enhanced_confidence:Math.min(98,v.final_confidence+L),var_95:I,var_99:z,current_drawdown_pct:ee,portfolio_heat_pct:ne,risk_warning:ae||null};p?(j.signal_type="HOLD",F.signal_type="HOLD",j.enhanced_confidence=50,F.enhanced_confidence=50,j.reasoning=d||"Economic event nearby - trading paused",F.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(j.enhanced_confidence=Math.max(50,j.enhanced_confidence+c.adjustment),F.enhanced_confidence=Math.max(50,F.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),j.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(C=>xt(C))},F.calendar_check=j.calendar_check;let Se=!1;try{const C=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),D={};for(const V of C.results||[])D[V.setting_key]=V.setting_value;if(D.telegram_bot_token&&D.telegram_chat_id){const V=new Date().toLocaleString("en-US",{timeZone:"UTC"});let E=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${V} UTC
...
`,E+=`Next event: ${xt(o.upcomingEvents[0])}
...
`;for(const J of m.trends){const K=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";E+=`${K} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}if(E+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,E+=`📈 *DAY TRADE SIGNAL*
`,E+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,E+=`${j.isValid?"✅":"❌"} *${j.signal_type}* (${j.enhanced_confidence.toFixed(0)}% confidence)

`,E+=`*Entry:* $${j.price.toFixed(2)}
`,E+=`*Stop Loss:* $${j.stop_loss.toFixed(2)} (${((j.stop_loss/j.price-1)*100).toFixed(2)}%)
`,E+=`*TP1:* $${j.take_profit_1.toFixed(2)} (${((j.take_profit_1/j.price-1)*100).toFixed(2)}%)
`,E+=`*TP2:* $${j.take_profit_2.toFixed(2)} (${((j.take_profit_2/j.price-1)*100).toFixed(2)}%)
`,E+=`*TP3:* $${j.take_profit_3.toFixed(2)} (${((j.take_profit_3/j.price-1)*100).toFixed(2)}%)

`,E+=`*📊 Confidence Breakdown:*
`,E+=`Base: ${j.base_confidence.toFixed(0)}%
`,E+=`MTF: ${j.mtf_confidence.toFixed(0)}%
`,b>0&&(E+=`Pattern: +${b.toFixed(0)}%
`),B>0&&(E+=`Regime: +${B.toFixed(0)}%
`),w>0&&(E+=`ML: +${w.toFixed(0)}%
`),W>0&&(E+=`PoP: +${W.toFixed(0)}%
`),Y!==0||ce!==0){const J=Y+ce;E+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}E+=`*FINAL: ${j.enhanced_confidence.toFixed(0)}%*
...
`),E+=`
`),X&&(E+=`🎯 *Probability of Profit:*
`,E+=`TP1: ${X.tp1_probability.toFixed(0)}%
`,E+=`TP2: ${X.tp2_probability.toFixed(0)}%
`,E+=`TP3: ${X.tp3_probability.toFixed(0)}%
`,E+=`Expected Value: ${X.expected_value.toFixed(2)}R

`),E+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,E+=`💡 *RECOMMENDATION*
`,E+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,j.isValid&&j.signal_type!=="HOLD"?(E+=`✅ *EXECUTE ${j.signal_type}*
`,E+=`All hedge fund features aligned!
`):(E+=`⚠️ *SKIP TRADE*
`,E+=`Reason: ${j.mtf_reason}
`),E+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",E.length,"characters");const oe=await Z({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},E);let O=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━
...
`,O+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",O.length,"characters");const je=await Z({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},O);Se=oe&&je}}catch(C){console.error("[ENHANCED] Telegram error (optional):",C.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Se,day_trade:j,swing_trade:F,alignment:{type:m.type,score:m.score,trends:m.trends},patterns:T.length>0?T.slice(0,3):null,regime:k?{trend:k.trend,volatility:k.volatility,should_trade:k.should_trade}:null,ml_prediction:A?{direction:A.overall_direction,predictions:A.predictions}:null,profit_probability:X?{tp1:X.tp1_probability,tp2:X.tp2_probability,tp3:X.tp3_probability,expected_value:X.expected_value}:null,liquidity:R?{score:R.liquidity_score,session:R.session,time_zone:R.time_of_day_zone,volume_trend:R.volume_trend,volume_percentile:R.volume_percentile,estimated_spread_pips:R.estimated_spread_pips,price_impact_bps:R.price_impact_bps,market_depth_score:R.market_depth_score,optimal_for_trading:R.optimal_for_trading,warnings:R.warnings,recommendation:R.recommendation}:null,risk_metrics:{var_95:I,var_99:z,drawdown_pct:ee,portfolio_heat_pct:ne}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const ks=new _e;ks.post("/simple",async e=>{var s,n,a,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,v+=`⏰ ${S}`,console.log("[SIMPLE] Sending Telegram message, length:",v.length),g=await Z({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},v),console.log("[SIMPLE] Telegram sent:",g),g||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(f){console.error("[SIMPLE] Telegram error:",f.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:g,day_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"day_trade"},swing_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(c),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"swing_trade"}})}catch(r){return console.error("[SIMPLE] Error:",r.message,r.stack),e.json({success:!1,error:r.message,stack:r.stack},500)}});function Aa(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Ia(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Da(e,t){return e>t*1.1}function Ma(e){let t=0,s=0,n=0;for(const l of e){const o=l.volume||0;n+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const a=s>0?t/s:t>0?10:1;let i="NEUTRAL";a>1.5?i="BUYING":a<.67&&(i="SELLING");let r=0;return a>3?r=100:a>1.5?r=50+(a-1.5)/1.5*50:a>.67?r=(a-.67)/.83*50:a>.33?r=50+(.67-a)/.34*50:r=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:i,strength:Math.round(r)}}function Rs(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function $a(e,t){const n=Rs(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Na(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Fa(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Oa(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Ca(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Ba(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Ua(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Pa(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Ha(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),ja(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Wa(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Ya(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Fa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Oa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Ca(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Ba(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Ua(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close<e.open,l=s.close>s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close>(e.open+e.close)/2}function Pa(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close>e.open,l=s.close<s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close<(e.open+e.close)/2}function Ha(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,i=t.low>e.low&&s.low>t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function ja(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,i=t.low<e.low&&s.low<t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function Wa(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Ya(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function Va(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function Ga(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),p=Math.max(...d.map(m=>m.high)),u=Math.min(...d.map(m=>m.low));s.push({level:p,type:"RESISTANCE",strength:85,distance:p-t,distancePercent:(p-t)/t*100}),s.push({level:u,type:"SUPPORT",strength:85,distance:t-u,distancePercent:(t-u)/t*100})}const n=e.slice(-50),a=Zt(n,"HIGH"),i=Zt(n,"LOW");if(a.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),i.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),qa(t).forEach(d=>{const p=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:p,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),p=za(d);s.push({level:p.pp,type:"PIVOT",strength:80,distance:Math.abs(p.pp-t),distancePercent:Math.abs(p.pp-t)/t*100}),s.push({level:p.r1,type:"RESISTANCE",strength:70,distance:p.r1-t,distancePercent:(p.r1-t)/t*100}),s.push({level:p.s1,type:"SUPPORT",strength:70,distance:t-p.s1,distancePercent:(t-p.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((d,p)=>Math.abs(p.distancePercent)<Math.abs(d.distancePercent)?p:d),c=Xa(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:c,strength:o.strength,description:Ka(o,c)}}function Zt(e,t){const s=[];for(let i=5;i<e.length-5;i++){const r=t==="HIGH"?e[i].high:e[i].low;let l=!0;for(let o=i-5;o<=i+5;o++){if(o===i)continue;const c=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&c>=r){l=!1;break}if(t==="LOW"&&c<=r){l=!1;break}}l&&s.push(r)}return Array.from(new Set(s)).slice(-3)}function qa(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function za(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),n=e[e.length-1].close,a=(t+s+n)/3,i=2*a-s,r=2*a-t,l=a+(t-s),o=a-(t-s);return{pp:a,r1:i,s1:r,r2:l,s2:o}}function Xa(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function Ka(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function Za(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function Qa(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=Ja(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const i=ei(s,a),r=ti(s,a);return i.type!=="NONE"&&r.type===i.type?{type:i.type,category:i.category,indicator:"BOTH",strength:95,description:`${i.type} ${i.category} (RSI+MACD)`,confidence:90}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"RSI",strength:80,description:`${i.type} ${i.category} (RSI)`,confidence:75}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"MACD",strength:70,description:`${r.type} ${r.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function Ja(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const i=e[a];let r=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].high>=i.high){r=!1;break}r&&t.push({index:a,price:i.high});let l=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].low<=i.low){l=!1;break}l&&s.push({index:a,price:i.low})}return{highs:t,lows:s}}function ei(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ti(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function si(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function ni(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,i=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${i}, ${e.strength}/100)`}function ai(e,t,s,n){const a=(_,y)=>{const S=parseFloat(String(_));return isNaN(S)?y:S},i=a(e.ema_12,n),r=a(t.ema_26,n),l=a(s.sma_200,n),o=Bt(n,i),c=Bt(n,r),d=Bt(n,l),p=o===c&&c===d&&o!=="NEUTRAL",u=o===c&&o!=="NEUTRAL"||o===d&&o!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let m=0,g="",f="";return p?(m=100,g=`ALL ${o}`,f=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):u?(m=65,o===c?(g=`5M+15M ${o}`,f=`5m & 15m ${o.toLowerCase()} (1h ${d.toLowerCase()})`):o===d?(g=`5M+1H ${o}`,f=`5m & 1h ${o.toLowerCase()} (15m ${c.toLowerCase()})`):(g=`15M+1H ${c}`,f=`15m & 1h ${c.toLowerCase()} (5m ${o.toLowerCase()})`)):(m=30,g="MIXED",f=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:o,tf15m:c,tf1h:d,allAligned:p,twoAligned:u,alignment:g,strength:m,description:f}}function Bt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function ii(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function ri(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function oi(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.1?r="UP":i<-.1&&(r="DOWN");let l="NEUTRAL";r==="DOWN"?l="BULLISH":r==="UP"&&(l="BEARISH");const o=Math.abs(i);let c=-.8,d=0;o>.3?d=90:o>.2?d=75:o>.1?d=60:d=40;const p=new Date(s.timestamp),m=Math.floor((new Date().getTime()-p.getTime())/6e4),g=ci(a,i,r,l,d);return{dxyPrice:a,dxyChange:i,dxyTrend:r,goldSignalSupport:l,correlation:c,strength:d,description:g,dataAge:m}}function li(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function ci(e,t,s,n,a){const i=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${i} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${i} → Gold BEARISH (${a}/100)`:`DXY flat ${i} → Neutral (${a}/100)`}async function di(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function ui(e,t){try{await e.prepare(`
    ...
    `).bind(p,"5m",d.signal,d.grade,d.score,c,d.stopLoss,d.tp1,d.tp2,d.tp3,d.confidence,d.layersPassed,d.liquidityScore,d.session,0).run();let u=!1;if(d.grade==="A"||d.grade==="A+")try{const g=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),f={};for(const _ of g.results||[])f[_.setting_key]=_.setting_value;if(f.telegram_bot_token&&f.telegram_chat_id){const _=As(d,c);u=await Z({botToken:f.telegram_bot_token,chatId:f.telegram_chat_id},_),await t.prepare(`
    ...
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});_t.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const c of s.results||[])n[c.setting_key]=c.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,i=15,r={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-i,tp1:a+i*2,tp2:a+i*3,tp3:a+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=As(r,a),o=await Z({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Ai(e,t,s,n,a,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],c=(Q,Ye)=>{const bt=parseFloat(String(Q));return isNaN(bt)?Ye:bt};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,i),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},p={ema50:c(s.ema_26,i)},u={sma200:c(n.sma_200,i)},m=i>d.ema20&&i>p.ema50&&i>u.sma200,g=i<d.ema20&&i<p.ema50&&i<u.sma200;m||g?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const f=d.rsi>=40&&d.rsi<=60,_=d.macd>d.macd_signal&&d.macd_histogram>0,y=d.macd<d.macd_signal&&d.macd_histogram<0;f&&(m?_:y)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${f?"no crossover":"extreme"}`);const S=a.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,v=a[a.length-1].volume;v>S*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(v/S).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(v/S).toFixed(1)}x (need 1.5x+)`);const x=Math.max(...a.slice(-20).map(Q=>Q.high)),T=Math.min(...a.slice(-20).map(Q=>Q.low)),B=i>x*.999,G=i<T*1.001;m&&B||g&&G?(r+=15,l++,o.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let k=null;try{k=await xs(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const w=(k==null?void 0:k.liquidity_score)||50,$=(k==null?void 0:k.session)||"UNKNOWN";w>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${w}/100 (${$} session)`)):o.push(`❌ Layer 5: Liquidity ${w}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const W=ft();console.log("[ANALYZE] Calendar check complete"),W.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${W.reason}`);const X=d.adx>25,R=d.adx>70;X&&!R?(r+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):R?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let Y="HOLD";(m||g)&&l>=5&&(Y=m?"BUY":"SELL");const ce=new Date,I=Aa(ce);I.hasBoost?(r+=8,l++,o.push(`✅ Layer 8: ${I.reason} (+${I.boost}% win)`)):o.push(`ℹ️ Layer 8: ${I.reason}`);const z=Ia(ce);z.hasBoost?(r+=5,l++,o.push(`✅ Layer 9: ${z.reason} (+${z.boost}% win)`)):o.push(`ℹ️ Layer 9: ${z.reason}`);const ee=c(t.atr_14,i*.01),ne=a.slice(-20).reduce((Q,Ye)=>{const bt=Ye.high-Ye.low;return Q+bt},0)/20;if(Da(ee,ne)){r+=7,l++;const Q=((ee/ne-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-ee/ne)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const L=Ma(a.slice(-20));Rs(L,Y)&&L.strength>=60&&(r+=10,l++),o.push($a(L,Y));const F=Na(a.slice(-3)),{aligned:Se,strongestPattern:C}=Va(F,Y);Se&&C?(r+=12,l++,o.push(`✅ Layer 12: ${C.name} (${C.strength}/100)`)):F.length>0&&F[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${F[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const D=Ga(a,i);Za(D,Y)&&D.nearZone?(r+=8,l++,o.push(`✅ Layer 13: ${D.description}`)):D.nearZone?o.push(`⚠️ Layer 13: ${D.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const oe=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),O=Qa(oe,a.slice(-10)),J=si(O,Y,m?"BULLISH":g?"BEARISH":"NEUTRAL");J&&O.strength>=70&&(r+=9,l++),o.push(ni(O,J));const K=ai(t,s,n,i),Yt=ii(K,Y);Yt&&(K.allAligned||K.twoAligned)&&(r+=6,l++),o.push(ri(K,Yt));const Dt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),Mt=(Dt==null?void 0:Dt.setting_value)||"70140f57bea54c5e90768de696487d8f",Vs=await mi(e,Mt,15),at=oi(Vs);li(at,Y)&&at.strength>=60?(r+=5,l++,o.push(`✅ Layer 18: ${at.description}`)):at.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${at.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Gs=await Jt(e,Mt,"SILVER",15),qs=await Jt(e,Mt,"OIL",15),We=gi(Gs,qs,Y);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;r+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const zs=await ki(e)||Ri(),xe=Ei(zs);if(wi(xe,Y)&&xe.strength>=70){const Q=xe.positioning.includes("EXTREME")?7:4;r+=Q,l++,o.push(`✅ Layer 20: ${xe.description} (${xe.strength}/100)`)}else xe.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${xe.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${xe.description}`);let yt="C";r>=162?yt="A+":r>=144?yt="A":r>=126&&(yt="B"),(m||g)&&l>=7&&(Y=m?"BUY":"SELL");const Te=Math.max(ee*1.5,i*.003),Xs=Y==="BUY"?i-Te:i+Te,Ks=Y==="BUY"?i+Te*2:i-Te*2,Zs=Y==="BUY"?i+Te*3:i-Te*3,Qs=Y==="BUY"?i+Te*4:i-Te*4;return{grade:yt,score:r,signal:Y,confidence:r,layersPassed:l,layers:o,stopLoss:Xs,tp1:Ks,tp2:Zs,tp3:Qs,liquidityScore:w,session:$,adx:d.adx,rsi:d.rsi,volumeRatio:v/S}}function As(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,i=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,r+="Next scan in 5 minutes...",r}async function st(e){const t=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,i=n.filter(m=>m.win===1).length,r=n.filter(m=>m.win===0).length,l=i/a*100,o=n.reduce((m,g)=>m+(g.profit_loss||0),0),c=Math.max(...n.map(m=>m.profit_loss||0)),d=Math.min(...n.map(m=>m.profit_loss||0)),p=n.reduce((m,g)=>m+(g.confidence||0),0)/a,u=n.reduce((m,g)=>m+(g.mtf_score||0),0)/a;await e.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ht=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Ni,calculatePositionSize:Os,calculateProfitLoss:Cs,checkDailyLossLimit:$i,formatPositionSize:Fi},Symbol.toStringTag,{value:"Module"}));async function Bs(e,t,s){const n=Date.now(),a=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(I=>{const z=new Date(I.timestamp);return z>=new Date(t.start_date)&&z<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:r,max_daily_loss_pct:2};for(let I=200;I<o.length;I++){const z=o.slice(I-200,I),ee=ve(z);if(!ee)continue;const ne=o[I],ae=ne.close,L=re(ae,ee,"day_trade"),j=re(ae,ee,"swing_trade");for(const F of[L,j]){if(F.signal_type==="HOLD"||F.confidence<t.min_confidence)continue;c.current_balance=r;const Se=Os(c,{entry_price:F.price,stop_loss:F.stop_loss,take_profit_1:F.take_profit_1,take_profit_2:F.take_profit_2,take_profit_3:F.take_profit_3,confidence:F.confidence,signal_type:F.signal_type,trading_style:F.trading_style},s);if(!Se.is_valid)continue;const C=ne.timestamp,D=F.price;let V=null,E=null,oe="UNKNOWN";const O=Math.min(50,o.length-I-1);for(let J=1;J<=O;J++){const K=o[I+J];if(F.signal_type==="BUY"){if(K.low<=F.stop_loss){V=F.stop_loss,E=K.timestamp,oe="STOP_LOSS";break}if(K.high>=F.take_profit_3){V=F.take_profit_3,E=K.timestamp,oe="TP3";break}if(K.high>=F.take_profit_2){V=F.take_profit_2,E=K.timestamp,oe="TP2";break}if(K.high>=F.take_profit_1){V=F.take_profit_1,E=K.timestamp,oe="TP1";break}}else{if(K.high>=F.stop_loss){V=F.stop_loss,E=K.timestamp,oe="STOP_LOSS";break}if(K.low<=F.take_profit_3){V=F.take_profit_3,E=K.timestamp,oe="TP3";break}if(K.low<=F.take_profit_2){V=F.take_profit_2,E=K.timestamp,oe="TP2";break}if(K.low<=F.take_profit_1){V=F.take_profit_1,E=K.timestamp,oe="TP1";break}}}if(!V||!E)continue;const je=Cs(D,V,Se.units,F.signal_type,t.commission_per_trade);r+=je.profit_loss,r>l&&(l=r),a.push({entry_time:C,entry_price:D,exit_time:E,exit_price:V,signal_type:F.signal_type,trading_style:F.trading_style,position_size:Se.units,profit_loss:je.profit_loss,profit_loss_pct:je.profit_loss_pct,exit_reason:oe,confidence:F.confidence}),i.push({date:E,balance:r})}}const d=a.filter(I=>I.profit_loss>0),p=a.filter(I=>I.profit_loss<0),u=d.reduce((I,z)=>I+z.profit_loss,0),m=Math.abs(p.reduce((I,z)=>I+z.profit_loss,0)),g=r-t.starting_balance,f=a.length>0?d.length/a.length*100:0,_=d.length>0?u/d.length:0,y=p.length>0?m/p.length:0,S=d.length>0?Math.max(...d.map(I=>I.profit_loss)):0,v=p.length>0?Math.min(...p.map(I=>I.profit_loss)):0,b=m>0?u/m:u,x=100-f,T=f/100*_-x/100*y;let B=0,G=0,k=t.starting_balance;for(const I of i){I.balance>k&&(k=I.balance);const z=k-I.balance,ee=z/k*100;z>B&&(B=z,G=ee)}const w=a.map(I=>I.profit_loss_pct),$=w.reduce((I,z)=>I+z,0)/w.length,A=Math.sqrt(w.reduce((I,z)=>I+Math.pow(z-$,2),0)/w.length),W=A>0?$/A:0;let H=0,X=0,R=0,Y=0;for(const I of a)I.profit_loss>0?(R++,Y=0,H=Math.max(H,R)):(Y++,R=0,X=Math.max(X,Y));const ce=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:d.length,losing_trades:p.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(_.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(S.toFixed(2)),largest_loss:parseFloat(v.toFixed(2)),max_drawdown:parseFloat(B.toFixed(2)),max_drawdown_pct:parseFloat(G.toFixed(2)),profit_factor:parseFloat(b.toFixed(2)),sharpe_ratio:parseFloat(W.toFixed(2)),expectancy:parseFloat(T.toFixed(2)),max_consecutive_wins:H,max_consecutive_losses:X,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:i,execution_time_ms:ce}}function Us(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
...
${c} @ $${d}
Stop: $${p}
TP1: $${u}`):await Z(l,`❌ Error: ${m.error}`)}else if(i.startsWith("/close_trade")){const o=i.split(" ");if(o.length<4)return await Z(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const c=parseInt(o[1]),d=parseFloat(o[2]),p=o[3],u=await Ms(c,d,p,t);if(u.success){const m=u.profit_loss||0,g=m>0?"💰":"❌";await Z(l,`${g} *Trade #${c} Closed*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Hs=new _e;Hs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const w of s.results||[])w.setting_key==="twelve_data_api_key"&&(n=w.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const w=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,A=await(await fetch(w)).json();A.values&&A.values.length>=50&&(a=A.values.reverse().map(W=>({timestamp:W.datetime,open:parseFloat(W.open),high:parseFloat(W.high),low:parseFloat(W.low),close:parseFloat(W.close),volume:parseFloat(W.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const w=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!w.results||w.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=w.results.reverse().map($=>({timestamp:$.timestamp,open:$.open,high:$.high,low:$.low,close:$.close,volume:$.volume||0}))}const i=ve(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=a[a.length-1].close,l=re(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const w of["5m","15m","1h","4h","daily"]){const $=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(w).first();$&&(o[w]=$)}const c=jt(o,r),d=a.slice(-50),p=d.map(w=>w.high).sort((w,$)=>$-w),u=d.map(w=>w.low).sort((w,$)=>w-$),m=[Math.max(...p.slice(0,10))],g=[Math.min(...u.slice(0,10))];r>i.sma_20?g.push(i.sma_20):m.push(i.sma_20),r>i.sma_50?g.push(i.sma_50):m.push(i.sma_50),r>i.vwap?g.push(i.vwap):m.push(i.vwap);const f=Math.round(r/10)*10;f>r?m.push(f):g.push(f);const _=[...new Set(m)].sort((w,$)=>w-$).filter(w=>w>r).slice(0,3),y=[...new Set(g)].sort((w,$)=>$-w).filter(w=>w<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",_);const S=i.atr_14/r*100;let v="NORMAL";S>3?v="EXTREME":S>1.5?v="HIGH":S<.5&&(v="LOW");const b=[];let x=30,T=30,B=40;c.type==="ALL_BULLISH"?(x=60,T=20,B=20):c.type==="ALL_BEARISH"?(x=20,T=60,B=20):c.score>=4&&(c.trends.filter(w=>w.trend==="BULLISH").length>=4?(x=50,T=25,B=25):(x=25,T=50,B=25)),_.length>0&&b.push({name:"📈 BULLISH CONTINUATION",probability:x,description:`Price breaks above $${_[0].toFixed(2)} and rallies toward $${(_[_.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||r*1.02}),y.length>0&&b.push({name:"📉 BEARISH CORRECTION",probability:T,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||r*.98}),b.push({name:"↔️ CONTINUED RANGING",probability:B,description:`Price oscillates between $${(y[0]||r*.99).toFixed(2)} and $${(_[0]||r*1.01).toFixed(2)} with choppy action`,trigger:v==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),b.sort((w,$)=>$.probability-w.probability);let G={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?G={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(G={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):v==="EXTREME"?G.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(G.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${_[0]?`breakout above $${_[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let k=!1;try{const w=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),$={};for(const A of w.results||[])$[A.setting_key]=A.setting_value;if($.telegram_bot_token&&$.telegram_chat_id){let A=`🤖 *AI MARKET ANALYSIS*
...
`,A+=`🔴 *Resistance:* ${_.map(W=>`$${W.toFixed(2)}`).join(", ")}
`,A+=`🟢 *Support:* ${y.map(W=>`$${W.toFixed(2)}`).join(", ")}

`,A+=`*Scenarios:*
`;for(const W of b)A+=`${W.name} (${W.probability}%)
`;A+=`
💡 *Recommendation:* ${G.action==="WAIT"?"⏰":G.action==="BUY"?"📈":"📉"} ${G.action}
`,A+=`${G.reason}`,k=await Z({botToken:$.telegram_bot_token,chatId:$.telegram_chat_id},A),console.log("[AI-ANALYSIS] Telegram sent:",k)}}catch(w){console.error("[AI-ANALYSIS] Telegram error:",w.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:v,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:_,support:y},scenarios:b,recommendation:G,telegram_sent:k}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const P=new _e;P.use("/api/*",On());P.route("/api/signals/enhanced",Ls);P.route("/api/signals/simple",ks);P.route("/api/scanner",_t);P.route("/api/trades",fe);P.route("/api/calendar",Me);P.route("/api/backtest",nt);P.route("/api/telegram",Ps);P.route("/api/ai",Hs);P.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Ys),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});P.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),r=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,o=await(await fetch(r)).json();if(o.code&&o.status==="error")return e.json({success:!1,error:o.message||"Twelve Data API error",count:0});if(!o.values||!Array.isArray(o.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=o.values;let d=0;for(const m of c){const g={timestamp:m.datetime,open:parseFloat(m.open),high:parseFloat(m.high),low:parseFloat(m.low),close:parseFloat(m.close),volume:parseInt(m.volume||"0")};await t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(g.timestamp,g.open,g.high,g.low,g.close,g.volume,"1h").run(),d++}const p=c[0],u=parseFloat(p.close);return e.json({success:!0,count:d,price:u,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});P.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume).run(),d++}if(p.length>=50){const u=ve(p.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const m=p[p.length-1].close,g=re(m,u,"day_trade"),f=re(m,u,"swing_trade"),_=70;for(const y of[g,f])if(y.confidence>=_&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const S=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),v={};for(const b of S.results||[])v[b.setting_key]=b.setting_value;v.telegram_bot_token&&v.telegram_chat_id&&await Z({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},lt(y))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let r=0;const l={};for(const o of i){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${o.interval}&apikey=${n}&outputsize=${o.outputsize}`,p=await(await fetch(c)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const u=p.values;let m=0;const g=[];for(const f of u){const _={timestamp:f.datetime,open:parseFloat(f.open),high:parseFloat(f.high),low:parseFloat(f.low),close:parseFloat(f.close),volume:0};g.push(_),await t.prepare(`
          INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(_.timestamp,_.open,_.high,_.low,_.close,_.volume,o.dbKey).run(),m++}if(g.length>=50){const f=ve(g.reverse());f&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,f.rsi_14,f.macd,f.macd_signal,f.macd_histogram,f.sma_20,f.sma_50,f.sma_200,f.ema_12,f.ema_26,f.bb_upper,f.bb_middle,f.bb_lower,f.atr_14,f.stochastic_k,f.stochastic_d,f.adx,f.plus_di,f.minus_di,f.ichimoku_tenkan,f.ichimoku_kijun,f.ichimoku_senkou_a,f.ichimoku_senkou_b,f.parabolic_sar,f.vwap,f.fib_382,f.fib_500,f.fib_618).run()}l[o.dbKey]={success:!0,count:m},r+=m,await new Promise(f=>setTimeout(f,500))}return e.json({success:!0,totalCount:r,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),a=ve(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,r=re(i,a,"day_trade"),l=re(i,a,"swing_trade");return e.json({success:!0,signals:{day_trade:r,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Ss),i=["5m","15m","1h","4h","daily"],r={};for(const T of i){const B=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(T).first();B&&(r[T]=B)}const l=Object.keys(r).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(r)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(r,c),p=r["1h"],u=re(c,p,"day_trade"),m=re(c,p,"swing_trade"),g=n(u.signal_type,d),f=n(m.signal_type,d),_={...u,base_confidence:u.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${g.reason}`},y={...m,base_confidence:m.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${f.reason}`},S=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),v={};for(const T of S.results||[])v[T.setting_key]=T.setting_value;let b=!1,x=[];v.telegram_bot_token&&v.telegram_chat_id&&(_.isValid&&_.signal_type!=="HOLD"&&await Z({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({..._,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(x.push("day_trade"),b=!0),await new Promise(T=>setTimeout(T,1e3)),y.isValid&&y.signal_type!=="HOLD"&&await Z({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...y,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(x.push("swing_trade"),b=!0));for(const T of[_,y])T.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(T.signal_type,T.trading_style,T.price,T.stop_loss,T.take_profit_1,T.take_profit_2,T.take_profit_3,T.base_confidence,T.mtf_confidence,T.final_confidence,T.alignment_score,T.alignment_type,T.reason,b?1:0).run();return e.json({success:!0,signals:{day_trade:_,swing_trade:y},alignment:d,alignment_report:a(d),telegram_sent:b,sent_to_telegram:x,available_timeframes:Object.keys(r)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});P.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('twelve_data_api_key')
    `).all();let n="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(n=g.setting_value);let a,i=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,_=await(await fetch(g)).json();_.values&&_.values.length>=50?(a=_.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!a){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!g.results||g.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});a=g.results.reverse().map(f=>({timestamp:f.timestamp,open:f.open,high:f.high,low:f.low,close:f.close,volume:f.volume}))}const r=ve(a);if(!r)return e.json({success:!1,error:"Failed to calculate indicators"});const l=a[a.length-1].close,o=re(l,r,"day_trade"),c=re(l,r,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",o.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const g of d.results||[])p[g.setting_key]=g.setting_value;let u=!1,m=[];p.telegram_bot_token&&p.telegram_chat_id&&(await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...o,timestamp:new Date().toISOString()}))&&(m.push("day_trade"),u=!0),await new Promise(_=>setTimeout(_,1e3)),await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...c,timestamp:new Date().toISOString()}))&&(m.push("swing_trade"),u=!0));for(const g of[o,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason, telegram_sent)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(g.signal_type,g.trading_style,g.price,g.stop_loss,g.take_profit_1,g.take_profit_2,g.take_profit_3,g.confidence,g.reason,u?1:0).run();return e.json({success:!0,signals:{day_trade:o,swing_trade:c},telegram_sent:u,sent_to_telegram:m})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/trading/account/:id",async e=>{const{DB:t}=e.env,s=e.req.param("id");try{const n=await t.prepare(`
    ...
    `).bind(n).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const f=new Date().toISOString().split("T")[0],_=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,f).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>ht),S=y(g,_.results);if(S.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${S.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const v=d*i,b=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>ht),i=a(n.results);return e.json({success:!0,stats:i})}catch(n){return e.json({success:!1,error:n.message},500)}});P.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    ...
    `).first(),r=!n&&(i==null?void 0:i.count)>0;let l=0;if(r)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const H=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),X=(H==null?void 0:H.setting_value)||"70140f57bea54c5e90768de696487d8f",R=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const Y of R)try{const ce=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${Y.interval}&apikey=${X}&outputsize=100`,I=new AbortController,z=setTimeout(()=>I.abort(),1e4),ee=await fetch(ce,{signal:I.signal});clearTimeout(z);const ne=await ee.json();if(ne.values&&Array.isArray(ne.values)){const ae=[];for(const L of ne.values)ae.push({timestamp:L.datetime,open:parseFloat(L.open),high:parseFloat(L.high),low:parseFloat(L.low),close:parseFloat(L.close),volume:0});for(const L of ae)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind(L.timestamp,L.open,L.high,L.low,L.close,L.volume,Y.dbKey).run();if(ae.length>=50){const L=ve(ae.reverse());L&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(Y.dbKey,L.rsi_14,L.macd,L.macd_signal,L.macd_histogram,L.sma_20,L.sma_50,L.sma_200,L.ema_12,L.ema_26,L.bb_upper,L.bb_middle,L.bb_lower,L.atr_14,L.stochastic_k,L.stochastic_d,L.adx,L.plus_di,L.minus_di,L.ichimoku_tenkan,L.ichimoku_kijun,L.ichimoku_senkou_a,L.ichimoku_senkou_b,L.parabolic_sar,L.vwap,L.fib_382,L.fib_500,L.fib_618).run()}l+=ne.values.length}await new Promise(ae=>setTimeout(ae,100))}catch(ce){console.error(`[MTF] Error fetching ${Y.dbKey}:`,ce)}}a.steps[0].status="completed",a.steps[0].data={totalCandles:l},a.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:o,validateMultiTimeframeSignal:c,formatAlignmentReport:d}=await Promise.resolve().then(()=>Ss),p={};for(const H of["5m","15m","1h","4h","daily"]){const X=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),m=(u==null?void 0:u.close)||0,g=o(p,m),f=p["1h"],_=re(m,f,"day_trade"),y=re(m,f,"swing_trade"),S=c(_.signal_type,g),v=c(y.signal_type,g),b={..._,final_confidence:Math.min(95,S.confidence),isValid:S.isValid,mtf_reason:S.reason,alignment_score:g.score,alignment_type:g.type},x={...y,final_confidence:Math.min(95,v.confidence),isValid:v.isValid,mtf_reason:v.reason,alignment_score:g.score,alignment_type:g.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:b,swingTrade:x,alignment:g},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const T=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),B=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:G}=await Promise.resolve().then(()=>ht),k=G(T,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},B.results),w=G(T,{entry_price:x.price,stop_loss:x.stop_loss,take_profit_1:x.take_profit_1,take_profit_2:x.take_profit_2,take_profit_3:x.take_profit_3,confidence:x.final_confidence,signal_type:x.signal_type,trading_style:x.trading_style},B.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:k,swingPosition:w},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const $=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),A={};for(const H of $.results||[])A[H.setting_key]=H.setting_value;let W=!1;if(A.telegram_bot_token&&A.telegram_chat_id){const H=`
...
💼 *Position:* ${w.units} lots ($${w.value.toLocaleString()})
💰 *Risk:* $${w.risk_amount} (${w.risk_pct}%)
📊 *R:R:* ${w.reward_risk_ratio}:1

${w.warning?`⚠️ ${w.warning}`:""}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();W=await Z({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},H)}if(a.steps[3].status=W?"completed":"failed",a.steps[3].data={telegramSent:W},b.isValid||x.isValid)for(const H of[b,x])H.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
