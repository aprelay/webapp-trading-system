var an=Object.defineProperty;var Xt=e=>{throw TypeError(e)};var rn=(e,t,s)=>t in e?an(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var C=(e,t,s)=>rn(e,typeof t!="symbol"?t+"":t,s),Ct=(e,t,s)=>t.has(e)||Xt("Cannot "+s);var b=(e,t,s)=>(Ct(e,t,"read from private field"),s?s.call(e):t.get(e)),Y=(e,t,s)=>t.has(e)?Xt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),F=(e,t,s,n)=>(Ct(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),K=(e,t,s)=>(Ct(e,t,"access private method"),s);var Kt=(e,t,s,n)=>({set _(a){F(e,t,a,s)},get _(){return b(e,t,n)}});var Zt=(e,t,s)=>(n,a)=>{let r=-1;return o(0);async function o(l){if(l<=r)throw new Error("next() called multiple times");r=l;let i,c=!1,d;if(e[l]?(d=e[l][0][0],n.req.routeIndex=l):d=l===e.length&&a||void 0,d)try{i=await d(n,()=>o(l+1))}catch(m){if(m instanceof Error&&t)n.error=m,i=await t(m,n),c=!0;else throw m}else n.finalized===!1&&s&&(i=await s(n));return i&&(n.finalized===!1||c)&&(n.res=i),n}},on=Symbol(),ln=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,r=(e instanceof _s?e.raw.headers:e.headers).get("Content-Type");return r!=null&&r.startsWith("multipart/form-data")||r!=null&&r.startsWith("application/x-www-form-urlencoded")?cn(e,{all:s,dot:n}):{}};async function cn(e,t){const s=await e.formData();return s?dn(s,t):{}}function dn(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?un(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(mn(s,n,a),delete s[n])}),s}var un=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},mn=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((r,o)=>{o===a.length-1?n[r]=s:((!n[r]||typeof n[r]!="object"||Array.isArray(n[r])||n[r]instanceof File)&&(n[r]=Object.create(null)),n=n[r])})},us=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},pn=e=>{const{groups:t,path:s}=gn(e),n=us(s);return fn(n,t)},gn=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},fn=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},xt={},_n=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return xt[n]||(s[2]?xt[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:xt[n]=[e,s[1],!0]),xt[n]}return null},Vt=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},hn=e=>Vt(e,decodeURI),ms=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const r=t.indexOf("?",n),o=t.slice(s,r===-1?void 0:r);return hn(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(a===63)break}return t.slice(s,n)},yn=e=>{const t=ms(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ke=(e,t,...s)=>(s.length&&(t=Ke(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),ps=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const r=a.replace("?","");n+="/"+r,s.push(n)}else n+="/"+a}),s.filter((a,r,o)=>o.indexOf(a)===r)},Ht=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Vt(e,fs):e):e,gs=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const i=o+t.length+2,c=e.indexOf("&",i);return Ht(e.slice(i,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let r=e.indexOf("?",8);for(;r!==-1;){const o=e.indexOf("&",r+1);let l=e.indexOf("=",r);l>o&&o!==-1&&(l=-1);let i=e.slice(r+1,l===-1?o===-1?void 0:o:l);if(n&&(i=Ht(i)),r=o,i==="")continue;let c;l===-1?c="":(c=e.slice(l+1,o===-1?void 0:o),n&&(c=Ht(c))),s?(a[i]&&Array.isArray(a[i])||(a[i]=[]),a[i].push(c)):a[i]??(a[i]=c)}return t?a[t]:a},bn=gs,En=(e,t)=>gs(e,t,!0),fs=decodeURIComponent,Qt=e=>Vt(e,fs),Je,me,Se,hs,ys,Yt,Ie,rs,_s=(rs=class{constructor(e,t="/",s=[[]]){Y(this,Se);C(this,"raw");Y(this,Je);Y(this,me);C(this,"routeIndex",0);C(this,"path");C(this,"bodyCache",{});Y(this,Ie,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(r=>(a==="json"&&(r=JSON.stringify(r)),new Response(r)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,F(this,me,s),F(this,Je,{})}param(e){return e?K(this,Se,hs).call(this,e):K(this,Se,ys).call(this)}query(e){return bn(this.url,e)}queries(e){return En(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await ln(this,e))}json(){return b(this,Ie).call(this,"text").then(e=>JSON.parse(e))}text(){return b(this,Ie).call(this,"text")}arrayBuffer(){return b(this,Ie).call(this,"arrayBuffer")}blob(){return b(this,Ie).call(this,"blob")}formData(){return b(this,Ie).call(this,"formData")}addValidatedData(e,t){b(this,Je)[e]=t}valid(e){return b(this,Je)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[on](){return b(this,me)}get matchedRoutes(){return b(this,me)[0].map(([[,e]])=>e)}get routePath(){return b(this,me)[0].map(([[,e]])=>e)[this.routeIndex].path}},Je=new WeakMap,me=new WeakMap,Se=new WeakSet,hs=function(e){const t=b(this,me)[0][this.routeIndex][1][e],s=K(this,Se,Yt).call(this,t);return s&&/\%/.test(s)?Qt(s):s},ys=function(){const e={},t=Object.keys(b(this,me)[0][this.routeIndex][1]);for(const s of t){const n=K(this,Se,Yt).call(this,b(this,me)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?Qt(n):n)}return e},Yt=function(e){return b(this,me)[1]?b(this,me)[1][e]:e},Ie=new WeakMap,rs),wn={Stringify:1},bs=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const r=e.callbacks;return r!=null&&r.length?(a?a[0]+=e:a=[e],Promise.all(r.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(i=>bs(i,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},vn="text/plain; charset=UTF-8",Bt=(e,t)=>({"Content-Type":e,...t}),gt,ft,Ee,et,we,de,_t,tt,st,Ue,ht,yt,Ae,Ze,os,Tn=(os=class{constructor(e,t){Y(this,Ae);Y(this,gt);Y(this,ft);C(this,"env",{});Y(this,Ee);C(this,"finalized",!1);C(this,"error");Y(this,et);Y(this,we);Y(this,de);Y(this,_t);Y(this,tt);Y(this,st);Y(this,Ue);Y(this,ht);Y(this,yt);C(this,"render",(...e)=>(b(this,tt)??F(this,tt,t=>this.html(t)),b(this,tt).call(this,...e)));C(this,"setLayout",e=>F(this,_t,e));C(this,"getLayout",()=>b(this,_t));C(this,"setRenderer",e=>{F(this,tt,e)});C(this,"header",(e,t,s)=>{this.finalized&&F(this,de,new Response(b(this,de).body,b(this,de)));const n=b(this,de)?b(this,de).headers:b(this,Ue)??F(this,Ue,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});C(this,"status",e=>{F(this,et,e)});C(this,"set",(e,t)=>{b(this,Ee)??F(this,Ee,new Map),b(this,Ee).set(e,t)});C(this,"get",e=>b(this,Ee)?b(this,Ee).get(e):void 0);C(this,"newResponse",(...e)=>K(this,Ae,Ze).call(this,...e));C(this,"body",(e,t,s)=>K(this,Ae,Ze).call(this,e,t,s));C(this,"text",(e,t,s)=>!b(this,Ue)&&!b(this,et)&&!t&&!s&&!this.finalized?new Response(e):K(this,Ae,Ze).call(this,e,t,Bt(vn,s)));C(this,"json",(e,t,s)=>K(this,Ae,Ze).call(this,JSON.stringify(e),t,Bt("application/json",s)));C(this,"html",(e,t,s)=>{const n=a=>K(this,Ae,Ze).call(this,a,t,Bt("text/html; charset=UTF-8",s));return typeof e=="object"?bs(e,wn.Stringify,!1,{}).then(n):n(e)});C(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});C(this,"notFound",()=>(b(this,st)??F(this,st,()=>new Response),b(this,st).call(this,this)));F(this,gt,e),t&&(F(this,we,t.executionCtx),this.env=t.env,F(this,st,t.notFoundHandler),F(this,yt,t.path),F(this,ht,t.matchResult))}get req(){return b(this,ft)??F(this,ft,new _s(b(this,gt),b(this,yt),b(this,ht))),b(this,ft)}get event(){if(b(this,we)&&"respondWith"in b(this,we))return b(this,we);throw Error("This context has no FetchEvent")}get executionCtx(){if(b(this,we))return b(this,we);throw Error("This context has no ExecutionContext")}get res(){return b(this,de)||F(this,de,new Response(null,{headers:b(this,Ue)??F(this,Ue,new Headers)}))}set res(e){if(b(this,de)&&e){e=new Response(e.body,e);for(const[t,s]of b(this,de).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=b(this,de).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}F(this,de,e),this.finalized=!0}get var(){return b(this,Ee)?Object.fromEntries(b(this,Ee)):{}}},gt=new WeakMap,ft=new WeakMap,Ee=new WeakMap,et=new WeakMap,we=new WeakMap,de=new WeakMap,_t=new WeakMap,tt=new WeakMap,st=new WeakMap,Ue=new WeakMap,ht=new WeakMap,yt=new WeakMap,Ae=new WeakSet,Ze=function(e,t,s){const n=b(this,de)?new Headers(b(this,de).headers):b(this,Ue)??new Headers;if(typeof t=="object"&&"headers"in t){const r=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of r)o.toLowerCase()==="set-cookie"?n.append(o,l):n.set(o,l)}if(s)for(const[r,o]of Object.entries(s))if(typeof o=="string")n.set(r,o);else{n.delete(r);for(const l of o)n.append(r,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??b(this,et);return new Response(e,{status:a,headers:n})},os),se="ALL",Sn="all",xn=["get","post","put","delete","options","patch"],Es="Can not add a route since the matcher is already built.",ws=class extends Error{},Ln="__COMPOSED_HANDLER",Rn=e=>e.text("404 Not Found",404),Jt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},pe,ne,vs,ge,Ce,Lt,Rt,nt,kn=(nt=class{constructor(t={}){Y(this,ne);C(this,"get");C(this,"post");C(this,"put");C(this,"delete");C(this,"options");C(this,"patch");C(this,"all");C(this,"on");C(this,"use");C(this,"router");C(this,"getPath");C(this,"_basePath","/");Y(this,pe,"/");C(this,"routes",[]);Y(this,ge,Rn);C(this,"errorHandler",Jt);C(this,"onError",t=>(this.errorHandler=t,this));C(this,"notFound",t=>(F(this,ge,t),this));C(this,"fetch",(t,...s)=>K(this,ne,Rt).call(this,t,s[1],s[0],t.method));C(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ke("/",t)}`,s),n,a)));C(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(K(this,ne,Rt).call(this,t.request,t,void 0,t.request.method))})});[...xn,Sn].forEach(r=>{this[r]=(o,...l)=>(typeof o=="string"?F(this,pe,o):K(this,ne,Ce).call(this,r,b(this,pe),o),l.forEach(i=>{K(this,ne,Ce).call(this,r,b(this,pe),i)}),this)}),this.on=(r,o,...l)=>{for(const i of[o].flat()){F(this,pe,i);for(const c of[r].flat())l.map(d=>{K(this,ne,Ce).call(this,c.toUpperCase(),b(this,pe),d)})}return this},this.use=(r,...o)=>(typeof r=="string"?F(this,pe,r):(F(this,pe,"*"),o.unshift(r)),o.forEach(l=>{K(this,ne,Ce).call(this,se,b(this,pe),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ms:yn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var o;let r;s.errorHandler===Jt?r=a.handler:(r=async(l,i)=>(await Zt([],s.errorHandler)(l,()=>a.handler(l,i))).res,r[Ln]=a.handler),K(o=n,ne,Ce).call(o,a.method,a.path,r)}),this}basePath(t){const s=K(this,ne,vs).call(this);return s._basePath=Ke(this._basePath,t),s}mount(t,s,n){let a,r;n&&(typeof n=="function"?r=n:(r=n.optionHandler,n.replaceRequest===!1?a=i=>i:a=n.replaceRequest));const o=r?i=>{const c=r(i);return Array.isArray(c)?c:[c]}:i=>{let c;try{c=i.executionCtx}catch{}return[i.env,c]};a||(a=(()=>{const i=Ke(this._basePath,t),c=i==="/"?0:i.length;return d=>{const m=new URL(d.url);return m.pathname=m.pathname.slice(c)||"/",new Request(m,d)}})());const l=async(i,c)=>{const d=await s(a(i.req.raw),...o(i));if(d)return d;await c()};return K(this,ne,Ce).call(this,se,Ke(t,"*"),l),this}},pe=new WeakMap,ne=new WeakSet,vs=function(){const t=new nt({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,F(t,ge,b(this,ge)),t.routes=this.routes,t},ge=new WeakMap,Ce=function(t,s,n){t=t.toUpperCase(),s=Ke(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},Lt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},Rt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await K(this,ne,Rt).call(this,t,s,n,"GET")))();const r=this.getPath(t,{env:n}),o=this.router.match(a,r),l=new Tn(t,{path:r,matchResult:o,env:n,executionCtx:s,notFoundHandler:b(this,ge)});if(o[0].length===1){let c;try{c=o[0][0][0][0](l,async()=>{l.res=await b(this,ge).call(this,l)})}catch(d){return K(this,ne,Lt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:b(this,ge).call(this,l))).catch(d=>K(this,ne,Lt).call(this,d,l)):c??b(this,ge).call(this,l)}const i=Zt(o[0],this.errorHandler,b(this,ge));return(async()=>{try{const c=await i(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return K(this,ne,Lt).call(this,c,l)}})()},nt),Ts=[];function In(e,t){const s=this.buildAllMatchers(),n=((a,r)=>{const o=s[a]||s[se],l=o[2][r];if(l)return l;const i=r.match(o[0]);if(!i)return[[],Ts];const c=i.indexOf("",1);return[o[1][c],i]});return this.match=n,n(e,t)}var At="[^/]+",ut=".*",mt="(?:|/.*)",Qe=Symbol(),An=new Set(".\\+*[^]$()");function Dn(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===ut||e===mt?1:t===ut||t===mt?-1:e===At?1:t===At?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Pe,je,fe,Ge,$n=(Ge=class{constructor(){Y(this,Pe);Y(this,je);Y(this,fe,Object.create(null))}insert(t,s,n,a,r){if(t.length===0){if(b(this,Pe)!==void 0)throw Qe;if(r)return;F(this,Pe,s);return}const[o,...l]=t,i=o==="*"?l.length===0?["","",ut]:["","",At]:o==="/*"?["","",mt]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(i){const d=i[1];let m=i[2]||At;if(d&&i[2]&&(m===".*"||(m=m.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(m))))throw Qe;if(c=b(this,fe)[m],!c){if(Object.keys(b(this,fe)).some(p=>p!==ut&&p!==mt))throw Qe;if(r)return;c=b(this,fe)[m]=new Ge,d!==""&&F(c,je,a.varIndex++)}!r&&d!==""&&n.push([d,b(c,je)])}else if(c=b(this,fe)[o],!c){if(Object.keys(b(this,fe)).some(d=>d.length>1&&d!==ut&&d!==mt))throw Qe;if(r)return;c=b(this,fe)[o]=new Ge}c.insert(l,s,n,a,r)}buildRegExpStr(){const s=Object.keys(b(this,fe)).sort(Dn).map(n=>{const a=b(this,fe)[n];return(typeof b(a,je)=="number"?`(${n})@${b(a,je)}`:An.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof b(this,Pe)=="number"&&s.unshift(`#${b(this,Pe)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Pe=new WeakMap,je=new WeakMap,fe=new WeakMap,Ge),Nt,bt,is,Nn=(is=class{constructor(){Y(this,Nt,{varIndex:0});Y(this,bt,new $n)}insert(e,t,s){const n=[],a=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,i=>{const c=`@\\${o}`;return a[o]=[c,i],o++,l=!0,c}),!l)break}const r=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=a.length-1;o>=0;o--){const[l]=a[o];for(let i=r.length-1;i>=0;i--)if(r[i].indexOf(l)!==-1){r[i]=r[i].replace(l,a[o][1]);break}}return b(this,bt).insert(r,t,n,b(this,Nt),s),n}buildRegExp(){let e=b(this,bt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,r,o)=>r!==void 0?(s[++t]=Number(r),"$()"):(o!==void 0&&(n[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Nt=new WeakMap,bt=new WeakMap,is),Mn=[/^$/,[],Object.create(null)],kt=Object.create(null);function Ss(e){return kt[e]??(kt[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function On(){kt=Object.create(null)}function Fn(e){var c;const t=new Nn,s=[];if(e.length===0)return Mn;const n=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,m],[p,u])=>d?1:p?-1:m.length-u.length),a=Object.create(null);for(let d=0,m=-1,p=n.length;d<p;d++){const[u,f,_]=n[d];u?a[f]=[_.map(([g])=>[g,Object.create(null)]),Ts]:m++;let h;try{h=t.insert(f,m,u)}catch(g){throw g===Qe?new ws(f):g}u||(s[m]=_.map(([g,y])=>{const w=Object.create(null);for(y-=1;y>=0;y--){const[E,S]=h[y];w[E]=S}return[g,w]}))}const[r,o,l]=t.buildRegExp();for(let d=0,m=s.length;d<m;d++)for(let p=0,u=s[d].length;p<u;p++){const f=(c=s[d][p])==null?void 0:c[1];if(!f)continue;const _=Object.keys(f);for(let h=0,g=_.length;h<g;h++)f[_[h]]=l[f[_[h]]]}const i=[];for(const d in o)i[d]=s[o[d]];return[r,i,a]}function Xe(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(Ss(s).test(t))return[...e[s]]}}var De,$e,Mt,xs,ls,Cn=(ls=class{constructor(){Y(this,Mt);C(this,"name","RegExpRouter");Y(this,De);Y(this,$e);C(this,"match",In);F(this,De,{[se]:Object.create(null)}),F(this,$e,{[se]:Object.create(null)})}add(e,t,s){var l;const n=b(this,De),a=b(this,$e);if(!n||!a)throw new Error(Es);n[e]||[n,a].forEach(i=>{i[e]=Object.create(null),Object.keys(i[se]).forEach(c=>{i[e][c]=[...i[se][c]]})}),t==="/*"&&(t="*");const r=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const i=Ss(t);e===se?Object.keys(n).forEach(c=>{var d;(d=n[c])[t]||(d[t]=Xe(n[c],t)||Xe(n[se],t)||[])}):(l=n[e])[t]||(l[t]=Xe(n[e],t)||Xe(n[se],t)||[]),Object.keys(n).forEach(c=>{(e===se||e===c)&&Object.keys(n[c]).forEach(d=>{i.test(d)&&n[c][d].push([s,r])})}),Object.keys(a).forEach(c=>{(e===se||e===c)&&Object.keys(a[c]).forEach(d=>i.test(d)&&a[c][d].push([s,r]))});return}const o=ps(t)||[t];for(let i=0,c=o.length;i<c;i++){const d=o[i];Object.keys(a).forEach(m=>{var p;(e===se||e===m)&&((p=a[m])[d]||(p[d]=[...Xe(n[m],d)||Xe(n[se],d)||[]]),a[m][d].push([s,r-c+i+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(b(this,$e)).concat(Object.keys(b(this,De))).forEach(t=>{e[t]||(e[t]=K(this,Mt,xs).call(this,t))}),F(this,De,F(this,$e,void 0)),On(),e}},De=new WeakMap,$e=new WeakMap,Mt=new WeakSet,xs=function(e){const t=[];let s=e===se;return[b(this,De),b(this,$e)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(r=>[r,n[e][r]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==se&&t.push(...Object.keys(n[se]).map(r=>[r,n[se][r]]))}),s?Fn(t):null},ls),Ne,ve,cs,Hn=(cs=class{constructor(e){C(this,"name","SmartRouter");Y(this,Ne,[]);Y(this,ve,[]);F(this,Ne,e.routers)}add(e,t,s){if(!b(this,ve))throw new Error(Es);b(this,ve).push([e,t,s])}match(e,t){if(!b(this,ve))throw new Error("Fatal error");const s=b(this,Ne),n=b(this,ve),a=s.length;let r=0,o;for(;r<a;r++){const l=s[r];try{for(let i=0,c=n.length;i<c;i++)l.add(...n[i]);o=l.match(e,t)}catch(i){if(i instanceof ws)continue;throw i}this.match=l.match.bind(l),F(this,Ne,[l]),F(this,ve,void 0);break}if(r===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(b(this,ve)||b(this,Ne).length!==1)throw new Error("No active router has been determined yet.");return b(this,Ne)[0]}},Ne=new WeakMap,ve=new WeakMap,cs),dt=Object.create(null),Me,ce,We,at,ie,Te,He,rt,Bn=(rt=class{constructor(t,s,n){Y(this,Te);Y(this,Me);Y(this,ce);Y(this,We);Y(this,at,0);Y(this,ie,dt);if(F(this,ce,n||Object.create(null)),F(this,Me,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},F(this,Me,[a])}F(this,We,[])}insert(t,s,n){F(this,at,++Kt(this,at)._);let a=this;const r=pn(s),o=[];for(let l=0,i=r.length;l<i;l++){const c=r[l],d=r[l+1],m=_n(c,d),p=Array.isArray(m)?m[0]:c;if(p in b(a,ce)){a=b(a,ce)[p],m&&o.push(m[1]);continue}b(a,ce)[p]=new rt,m&&(b(a,We).push(m),o.push(m[1])),a=b(a,ce)[p]}return b(a,Me).push({[t]:{handler:n,possibleKeys:o.filter((l,i,c)=>c.indexOf(l)===i),score:b(this,at)}}),a}search(t,s){var i;const n=[];F(this,ie,dt);let r=[this];const o=us(s),l=[];for(let c=0,d=o.length;c<d;c++){const m=o[c],p=c===d-1,u=[];for(let f=0,_=r.length;f<_;f++){const h=r[f],g=b(h,ce)[m];g&&(F(g,ie,b(h,ie)),p?(b(g,ce)["*"]&&n.push(...K(this,Te,He).call(this,b(g,ce)["*"],t,b(h,ie))),n.push(...K(this,Te,He).call(this,g,t,b(h,ie)))):u.push(g));for(let y=0,w=b(h,We).length;y<w;y++){const E=b(h,We)[y],S=b(h,ie)===dt?{}:{...b(h,ie)};if(E==="*"){const D=b(h,ce)["*"];D&&(n.push(...K(this,Te,He).call(this,D,t,b(h,ie))),F(D,ie,S),u.push(D));continue}const[v,R,A]=E;if(!m&&!(A instanceof RegExp))continue;const I=b(h,ce)[v],x=o.slice(c).join("/");if(A instanceof RegExp){const D=A.exec(x);if(D){if(S[R]=D[0],n.push(...K(this,Te,He).call(this,I,t,b(h,ie),S)),Object.keys(b(I,ce)).length){F(I,ie,S);const N=((i=D[0].match(/\//))==null?void 0:i.length)??0;(l[N]||(l[N]=[])).push(I)}continue}}(A===!0||A.test(m))&&(S[R]=m,p?(n.push(...K(this,Te,He).call(this,I,t,S,b(h,ie))),b(I,ce)["*"]&&n.push(...K(this,Te,He).call(this,b(I,ce)["*"],t,S,b(h,ie)))):(F(I,ie,S),u.push(I)))}}r=u.concat(l.shift()??[])}return n.length>1&&n.sort((c,d)=>c.score-d.score),[n.map(({handler:c,params:d})=>[c,d])]}},Me=new WeakMap,ce=new WeakMap,We=new WeakMap,at=new WeakMap,ie=new WeakMap,Te=new WeakSet,He=function(t,s,n,a){const r=[];for(let o=0,l=b(t,Me).length;o<l;o++){const i=b(t,Me)[o],c=i[s]||i[se],d={};if(c!==void 0&&(c.params=Object.create(null),r.push(c),n!==dt||a&&a!==dt))for(let m=0,p=c.possibleKeys.length;m<p;m++){const u=c.possibleKeys[m],f=d[c.score];c.params[u]=a!=null&&a[u]&&!f?a[u]:n[u]??(a==null?void 0:a[u]),d[c.score]=!0}}return r},rt),Ye,ds,Un=(ds=class{constructor(){C(this,"name","TrieRouter");Y(this,Ye);F(this,Ye,new Bn)}add(e,t,s){const n=ps(t);if(n){for(let a=0,r=n.length;a<r;a++)b(this,Ye).insert(e,n[a],s);return}b(this,Ye).insert(e,t,s)}match(e,t){return b(this,Ye).search(e,t)}},Ye=new WeakMap,ds),_e=class extends kn{constructor(e={}){super(e),this.router=e.router??new Hn({routers:[new Cn,new Un]})}},Pn=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(r=>typeof r=="string"?r==="*"?()=>r:o=>r===o?o:null:typeof r=="function"?r:o=>r.includes(o)?o:null)(s.origin),a=(r=>typeof r=="function"?r:Array.isArray(r)?()=>r:()=>[])(s.allowMethods);return async function(o,l){var d;function i(m,p){o.res.headers.set(m,p)}const c=await n(o.req.header("origin")||"",o);if(c&&i("Access-Control-Allow-Origin",c),s.credentials&&i("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&i("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&i("Vary","Origin"),s.maxAge!=null&&i("Access-Control-Max-Age",s.maxAge.toString());const m=await a(o.req.header("origin")||"",o);m.length&&i("Access-Control-Allow-Methods",m.join(","));let p=s.allowHeaders;if(!(p!=null&&p.length)){const u=o.req.header("Access-Control-Request-Headers");u&&(p=u.split(/\s*,\s*/))}return p!=null&&p.length&&(i("Access-Control-Allow-Headers",p.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function Be(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function Dt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Be(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function jn(e,t=14){if(e.length<t+1)return 50;const s=[];for(let i=1;i<e.length;i++)s.push(e[i]-e[i-1]);let n=0,a=0;for(let i=0;i<t;i++)s[i]>0?n+=s[i]:a+=Math.abs(s[i]);let r=n/t,o=a/t;for(let i=t;i<s.length;i++){const c=s[i];r=(r*(t-1)+(c>0?c:0))/t,o=(o*(t-1)+(c<0?Math.abs(c):0))/t}return o===0?100:100-100/(1+r/o)}function Wn(e){const t=Dt(e,12),s=Dt(e,26),n=t-s,a=n*.9,r=n-a;return{macd:n,signal:a,histogram:r}}function Yn(e,t=20,s=2){const n=Be(e,t),r=e.slice(-t).reduce((l,i)=>l+Math.pow(i-n,2),0)/t,o=Math.sqrt(r);return{upper:n+o*s,middle:n,lower:n-o*s}}function Gn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let r=1;r<e.length;r++){const o=e[r].high,l=e[r].low,i=e[r-1].close,c=Math.max(o-l,Math.abs(o-i),Math.abs(l-i));s.push(c)}const n=Be(s,t);return Math.max(n,10)}function Vn(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(m=>m.high),r=n.map(m=>m.low),o=e[e.length-1].close,l=Math.max(...a),i=Math.min(...r),c=(o-i)/(l-i)*100;return{k:c,d:c}}function qn(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,m=e[c].low,p=e[c-1].high,u=e[c-1].low,f=e[c-1].close,_=d-p,h=u-m;_>h&&_>0&&(s+=_),h>_&&h>0&&(n+=h),a+=Math.max(d-m,Math.abs(d-f),Math.abs(m-f))}const r=a>0?s/a*100:0,o=a>0?n/a*100:0;return{adx:r+o>0?Math.abs(r-o)/(r+o)*100:0,plusDI:r,minusDI:o}}function zn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(g=>g.high)),a=Math.min(...s.map(g=>g.low)),r=(n+a)/2,o=Math.min(26,e.length),l=e.slice(-o),i=Math.max(...l.map(g=>g.high)),c=Math.min(...l.map(g=>g.low)),d=(i+c)/2,m=(r+d)/2,p=Math.min(52,e.length),u=e.slice(-p),f=Math.max(...u.map(g=>g.high)),_=Math.min(...u.map(g=>g.low)),h=(f+_)/2;return{tenkan:r,kijun:d,senkouA:m,senkouB:h}}function Xn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Kn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,r=n.volume||1;t+=a*r,s+=r}return s>0?t/s:e[e.length-1].close}function Zn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(i=>i.high),a=s.map(i=>i.low),r=Math.max(...n),o=Math.min(...a),l=r-o;return{fib_0:r,fib_236:r-l*.236,fib_382:r-l*.382,fib_500:r-l*.5,fib_618:r-l*.618,fib_100:o}}function be(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=Wn(t),n=Yn(t),a=Vn(e,14,3),r=qn(e,14),o=zn(e),l=Xn(e),i=Kn(e),c=Zn(e,50);return{rsi_14:jn(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Be(t,20),sma_50:Be(t,50),sma_200:e.length>=200?Be(t,200):Be(t,Math.min(100,e.length)),ema_12:Dt(t,12),ema_26:Dt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Gn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:r.adx,plus_di:r.plusDI,minus_di:r.minusDI,ichimoku_tenkan:o.tenkan,ichimoku_kijun:o.kijun,ichimoku_senkou_a:o.senkouA,ichimoku_senkou_b:o.senkouB,parabolic_sar:l,vwap:i,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function ae(e,t,s){const n=[];let a=0,r=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:r+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),r+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),r+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),r+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),r+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),r+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),r+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),r+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),r+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),r+=2):t.rsi_14>60&&(n.push("RSI above 60"),r+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),r+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),r+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),r+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),r+=2);const o=a+r,l=o>0?a/o*100:50;let i="HOLD",c=50;a>r+1?(i="BUY",c=Math.min(l,95)):r>a+1&&(i="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(a-r)>4&&(c=Math.min(c+5,95),n.push("High conviction signal"));const d=s==="day_trade"?1.5:2,m=s==="day_trade"?3:4,p=s==="day_trade"?4:5.5,u=s==="day_trade"?5:7,_=e*(1/100);let h,g,y,w;if(i==="BUY"){const E=e-t.atr_14*d;h=Math.max(E,e-_),g=e+t.atr_14*m,y=e+t.atr_14*p,w=e+t.atr_14*u}else if(i==="SELL"){const E=e+t.atr_14*d;h=Math.min(E,e+_),g=e-t.atr_14*m,y=e-t.atr_14*p,w=e-t.atr_14*u}else h=e,g=e,y=e,w=e;return{signal_type:i,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(g.toFixed(2)),take_profit_2:parseFloat(y.toFixed(2)),take_profit_3:parseFloat(w.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:n.join(", ")}}async function q(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function Qn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function pt(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
`)}const Rs=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:qt,determineTrend:Ls,formatAlignmentReport:Jn,validateMultiTimeframeSignal:Gt},Symbol.toStringTag,{value:"Module"}));function es(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((r,o)=>r-o),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function ea(e,t){const s=es(e,.95),n=es(e,.99),a=t*s,r=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(r.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function ta(e,t,s,n){const a=t-e,r=a/t*100;let o=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)o++;const l=r<=s,i=r>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(r.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:i,days_in_drawdown:o}}function sa(e,t,s=5){let n=0;const a=[];for(const i of e){const d=Math.abs(i.entry_price-i.stop_loss)*i.position_size,m=d/t*100;n+=d,a.push({position_id:i.id,entry_price:i.entry_price,stop_loss:i.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(m.toFixed(2))})}const r=n/t*100,o=r<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(r.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:o,available_risk:parseFloat(l.toFixed(2)),positions:a}}function na(e){if(e.length<30)return null;const s=e.slice(-30).map(i=>i.high),n=[];for(let i=2;i<s.length-2;i++)s[i]>s[i-1]&&s[i]>s[i-2]&&s[i]>s[i+1]&&s[i]>s[i+2]&&n.push({index:i,value:s[i]});if(n.length<3)return null;const a=n.slice(-3),[r,o,l]=a;if(o.value>r.value&&o.value>l.value&&Math.abs(r.value-l.value)/r.value<.02){const c=Math.min(r.value,l.value)*.995,d=c-(o.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:65}}return null}function aa(e){if(e.length<20)return null;const s=e.slice(-20).map(o=>o.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const i=s[s.length-1],c=n[n.length-1]-n[0],d=i+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((i*.98).toFixed(2)),historical_win_rate:68}}return null}function ra(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),r=(Math.max(...s)-Math.min(...s))/Math.max(...s),o=n.slice(0,6),l=n.slice(-6),i=(Math.min(...l)-Math.min(...o))/Math.min(...o);if(r<.01&&i>.015){const c=Math.max(...s),d=t[t.length-1].close,m=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function oa(e){if(e.length<30)return null;const s=e.slice(-30).map(i=>i.low),n=[];for(let i=2;i<s.length-2;i++)s[i]<s[i-1]&&s[i]<s[i-2]&&s[i]<s[i+1]&&s[i]<s[i+2]&&n.push({index:i,value:s[i]});if(n.length<2)return null;const a=n.slice(-2),[r,o]=a;if(Math.abs(r.value-o.value)/r.value<.015){const i=Math.max(...s.slice(r.index,o.index))*1.005,c=i+(i-r.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+r.index,end_index:e.length-30+o.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:66}}return null}function ia(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),r=s[25];if(Math.abs(n-r)/n<.02&&a<n*.95){const l=s.slice(25),i=Math.min(...l),c=(r-i)/r;if(c>.01&&c<.05){const d=n-a,m=r+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(m.toFixed(2)),invalidation_price:parseFloat(i.toFixed(2)),historical_win_rate:61}}}return null}function la(e){const t=[],s=na(e);s&&t.push(s);const n=aa(e);n&&t.push(n);const a=ra(e);a&&t.push(a);const r=oa(e);r&&t.push(r);const o=ia(e);o&&t.push(o);let l=0,i=0,c=0;for(const u of t)u.direction==="bullish"?(l++,c+=u.confidence):u.direction==="bearish"&&(i++,c+=u.confidence);let d="neutral",m=0;l>i?(d="bullish",m=Math.min(c/l/10,15)):i>l&&(d="bearish",m=Math.min(c/i/10,15));let p="";if(t.length===0)p="No significant chart patterns detected";else{const u=t.map(f=>f.pattern_type).join(", ");p=`Detected ${t.length} pattern(s): ${u}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(m.toFixed(1)),summary:p}}function ca(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function da(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function ua(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function ma(e,t,s){const n=ca(t.atr_14,s),a=da(t,s),r=ua(t,s);let o,l,i,c,d,m;const p=e.slice(-10),u=p.map(g=>g.volume||0),f=u.reduce((g,y)=>g+y,0)/u.length,h=(p[p.length-1].volume||0)>f*1.5;return n==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(o="BREAKOUT",l=75,i=!0,c="Trend-following (aggressive entry)",d=1.3,m="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(o="BREAKDOWN",l=75,i=!1,c="Wait for stabilization",d=.5,m="Sharp breakdown in progress - avoid trading until dust settles"):(o="RANGING",l=50,i=!1,c="Wait for direction",d=.5,m="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(o="STRONG_UPTREND",l=90,i=!0,c="Trend-following (buy dips, trail stops)",d=1.5,m="Strong bullish trend confirmed - ideal for aggressive long positions"):(o="STRONG_DOWNTREND",l=90,i=!1,c="Stay in cash or short",d=.3,m="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(o="WEAK_UPTREND",l=70,i=!0,c="Trend-following (selective entries)",d=1,m="Moderate bullish trend - trade with normal position sizing"):(o="WEAK_DOWNTREND",l=70,i=!1,c="Reduce exposure or stay flat",d=.5,m="Moderate bearish trend - reduce risk or wait"):(o="RANGING",l=80,r>60?(i=!0,c="Mean-reversion (fade extremes)",d=.8,m="Choppy market with mean-reversion opportunities - trade extremes only"):(i=!1,c="Wait for trend to develop",d=.5,m="Choppy market without clear opportunity - stay on sidelines")),{regime:o,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:r,should_trade:i,recommended_strategy:c,risk_adjustment:d,description:m}}function pa(e){const t=e.length;let s=0,n=0,a=0,r=0;for(let i=0;i<t;i++)s+=i,n+=e[i],a+=i*e[i],r+=i*i;const o=(t*a-s*n)/(t*r-s*s),l=(n-o*s)/t;return{slope:o,intercept:l}}function ga(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let r=n[0];for(let l=1;l<n.length;l++)r=(n[l]-r)*a+r;const o=(n[n.length-1]-n[n.length-10])/10;return r+o*s}function fa(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const o=n.slice(-5).reduce((l,i)=>l+i,0)/5*t*Math.pow(.8,t);return s[s.length-1]+o}function _a(e,t,s){const n=e[e.length-1].close;e.map(o=>o.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const r=a/100*s;return n+t.atr_14*r}function ha(e,t){const s=e.map(p=>p.close),n=s[s.length-1],a=10,r=s.slice(-a),o=Math.min(...r),l=Math.max(...r),i=r.map(p=>(p-o)/(l-o));let c={index:0,similarity:-1/0};for(let p=a;p<s.length-a-t;p++){const u=s.slice(p-a,p),f=Math.min(...u),_=Math.max(...u),h=u.map(w=>(w-f)/(_-f));let g=0;for(let w=0;w<a;w++)g+=Math.pow(i[w]-h[w],2);const y=-g;y>c.similarity&&(c={index:p,similarity:y})}const m=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+m}function Ut(e,t,s){const n=[],a=[],r=e.map(v=>v.close),{slope:o,intercept:l}=pa(r.slice(-20)),i=o*(r.length-1+s)+l;n.push(i),a.push(1);const c=ga(e,12,s);n.push(c),a.push(1.5);const d=fa(e,s);n.push(d),a.push(1.2);const m=_a(e,t,s);n.push(m),a.push(1.8);const p=ha(e,s);n.push(p),a.push(1.3);const u=a.reduce((v,R)=>v+R,0),_=n.reduce((v,R,A)=>v+R*a[A],0)/u,h=n.reduce((v,R)=>v+R,0)/n.length,g=n.reduce((v,R)=>v+Math.pow(R-h,2),0)/n.length,y=Math.sqrt(g),w=e[e.length-1].close,E=1-y/w,S=Math.max(50,Math.min(95,E*100));return{prediction:_,confidence:S}}function ya(e,t){const s=e[e.length-1].close,n=[],a=Ut(e,t,1),r=a.prediction-s,o=r/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:r>.5?"UP":r<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(o.toFixed(2)),method:"Ensemble (5 models)"});const l=Ut(e,t,4),i=l.prediction-s,c=i/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:i>2?"UP":i<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Ut(e,t,24),m=d.prediction-s,p=m/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:m>5?"UP":m<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(p.toFixed(2)),method:"Ensemble (5 models)"});const u=n.filter(y=>y.direction==="UP").length,f=n.filter(y=>y.direction==="DOWN").length;let _,h=0;u>f?(_="BULLISH",h=Math.min(u*5,15)):f>u?(_="BEARISH",h=Math.min(f*5,15)):_="NEUTRAL";const g=`ML models predict ${_} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:_,confidence_boost:parseFloat(h.toFixed(1)),summary:g}}function Pt(e,t,s,n,a){const o=Math.abs(t-e)/s;let l;o<1?l=80:o<2?l=65:o<3?l=50:o<4?l=35:l=20;const i=(n-50)/10;l+=i;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function ba(e,t,s,n,a){const o=Math.abs(e-t)/s;let l;if(o<1?l=60:o<1.5?l=40:o<2?l=25:l=15,a==="BUY"){const i=(n-50)/10;l-=i}else{const i=(n-50)/10;l-=i}return Math.max(5,Math.min(80,l))}function Ea(e,t,s,n,a,r){const o=(s-e)*.5,l=(n-e)*.3,i=(a-e)*.2,c=t-e;return r.tp1/100*o+r.tp2/100*l+r.tp3/100*i+r.sl/100*c}function wa(e,t,s){const n=e.price,a=t.atr_14;let r=50;e.signal_type==="BUY"?(n>t.sma_20&&(r+=10),n>t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(r+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(r+=10),n<t.sma_50&&(r+=10),t.adx>25&&(r+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(r+=10)),r=Math.min(100,r);const o=s.slice(-50),l=[];for(let w=14;w<o.length;w++){const E=o.slice(w-14,w);let S=0;for(let v=1;v<E.length;v++){const R=Math.max(E[v].high-E[v].low,Math.abs(E[v].high-E[v-1].close),Math.abs(E[v].low-E[v-1].close));S+=R}l.push(S/14)}const i=l.reduce((w,E)=>w+E,0)/l.length,c=a/i,d=Pt(n,e.take_profit_1,a,r,c),m=Pt(n,e.take_profit_2,a,r,c),p=Pt(n,e.take_profit_3,a,r,c),u=ba(n,e.stop_loss,a,r,e.signal_type),f=Ea(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:m,tp3:p,sl:u}),h=(d+m+p)/3/u;let g;d>70&&f>5&&h>2?g="STRONG_TRADE":d>60&&f>0&&h>1.5?g="GOOD_TRADE":d>50&&f>-2?g="MARGINAL_TRADE":g="AVOID_TRADE";const y=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${f.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${g.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(m.toFixed(1)),tp3_probability:parseFloat(p.toFixed(1)),stop_loss_probability:parseFloat(u.toFixed(1)),expected_value:parseFloat(f.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:g,summary:y}}function ks(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=va(e),s=Ta(),n=Sa(e,s.session),a=xa(t,s.session),r=La(t,s),o=Ra(t,s,n,r),l=ka(o,t,s,n),i=Ia(o);return{liquidity_score:Math.round(o),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(r),optimal_for_trading:o>=70&&l.length===0,warnings:l,recommendation:i}}function va(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,a=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,r=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,o=a/n;let l;a>r*1.2?l="INCREASING":a<r*.8?l="DECREASING":l="STABLE";const i=Math.min(100,o*100);return{avg_volume:n,current_volume:a,volume_ratio:o,volume_spike:o>2,volume_drought:o<.5,trend:l,percentile:i}}function Ta(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,r;return n>=780&&n<960?(a="OVERLAP",r="HIGH"):n>=480&&n<780?(a="LONDON",r="HIGH"):n>=960&&n<1320?(a="NEW_YORK",r="HIGH"):n>=0&&n<480?(a="ASIA",r="MEDIUM"):(a="OFF_HOURS",r="LOW"),{zone:r,session:a}}function Sa(e,t){const s=e.slice(-20);let n=0;for(const d of s){const m=d.high-d.low;n+=m}const a=n/s.length,r=s[s.length-1].close,o=a/r*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const i=1+o*2,c=l*i;return{spread_pips:Math.round(c)}}function xa(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,r=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*r}function La(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function Ra(e,t,s,n){const a=e.percentile*.3,r=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,o=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+r+o+l}function ka(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function Ia(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const zt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Aa(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function Ot(e=30){const t=[],s=new Date;for(const a of zt){const r=new Date(a),o=Math.floor((r.getTime()-s.getTime())/(1e3*60*60*24));o>=0&&o<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const r=new Date(s.getTime()+a*24*60*60*1e3),o=r.getFullYear(),l=r.getMonth(),i=r.getDate(),c=r.getDay();if(i===Aa(o,l)&&c===5){const d=r.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}i===10&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),i===11&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),i===15&&t.push({date:r.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(i===1||i<=3&&c>=1&&c<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(i===3||i<=5&&c>=1&&c<=5)&&t.push({date:r.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,r,o)=>r===o.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,r)=>{const o=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${r.date}T${r.time}:00Z`);return o.getTime()-l.getTime()})}function Et(e=new Date,t=[]){const s=[...Ot(7),...t],n=s.filter(o=>new Date(`${o.date}T${o.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(o=>o.date===a&&o.impact==="high"),zt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:Da(a)};new Date(e.getTime()+7200*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`),i=(l.getTime()-e.getTime())/(1e3*60);if(o.impact==="high"&&i>0&&i<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${o.title} in ${Math.round(i)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(o.impact==="high"&&i>30&&i<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${o.title} in ${Math.round(i)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const r=new Date(e.getTime()-1800*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`);if(o.impact==="high"&&l>r&&l<e){const i=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${o.title} just happened ${Math.round(i)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function Da(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function It(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function $a(e){const t=e.toISOString().split("T")[0];return zt.includes(t)?!0:Ot(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Na(){const e=new Date().toISOString().split("T")[0];return Ot(7).filter(s=>s.date===e)}function Is(e=new Date){const t=Et(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const As=new _e;As.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const U of["5m","15m","1h","4h","daily"]){const O=await t.prepare(`
    ...
    `).first(),l=(o==null?void 0:o.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(o!=null&&o.timestamp){const U=new Date(o.timestamp).getTime(),O=(Date.now()-U)/(1e3*60);O>60&&r.push(`⚠️ WARNING: Price data is ${O.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${O.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const i=Et(),c=Is();let d=null,m=!1;i.riskLevel==="danger"?(m=!0,d=i.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",i.reason)):i.riskLevel==="caution"?(d=i.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",i.reason)):console.log("[ENHANCED] ✅ Calendar safe:",i.reason);const p=n["1h"];if(!p)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const u=qt(n,l),f=ae(l,p,"day_trade"),_=ae(l,p,"swing_trade"),h=Gt(f.signal_type,u),g=Gt(_.signal_type,u),y={...f,base_confidence:f.confidence,mtf_confidence:h.confidence,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:u.score,alignment_type:u.type},w={..._,base_confidence:_.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:u.score,alignment_type:u.type};let E=0,S="",v=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const O=la(a["1h"]);v=(O==null?void 0:O.patterns)||[]}catch(O){console.error("[ENHANCED] Pattern detection error:",O.message)}const U=v.filter(O=>O.confidence>=70&&O.endIndex>=a["1h"].length-5);for(const O of U)O.type==="bullish"&&y.signal_type==="BUY"?(E+=O.confidence*.1,S+=`${O.name} (${O.confidence.toFixed(0)}%), `):O.type==="bearish"&&y.signal_type==="SELL"&&(E+=O.confidence*.1,S+=`${O.name} (${O.confidence.toFixed(0)}%), `);E=Math.min(15,E)}let R=0,A="",I=null;if(a["1h"]&&a["1h"].length>=50){const U=be(a["1h"]);U&&(I=ma(a["1h"],U),I.trend==="STRONG_UPTREND"&&y.signal_type==="BUY"?(R=10,A="Strong Uptrend"):I.trend==="UPTREND"&&y.signal_type==="BUY"?(R=5,A="Uptrend"):I.trend==="STRONG_DOWNTREND"&&y.signal_type==="SELL"?(R=10,A="Strong Downtrend"):I.trend==="DOWNTREND"&&y.signal_type==="SELL"&&(R=5,A="Downtrend"))}let x=0,D="",N=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{N=ya(a["1h"],l),N.overall_direction==="BULLISH"&&y.signal_type==="BUY"?(x=N.confidence_boost,D=`ML predicts +${((N.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):N.overall_direction==="BEARISH"&&y.signal_type==="SELL"&&(x=N.confidence_boost,D=`ML predicts ${((N.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(U){console.error("[ENHANCED] ML prediction error:",U.message)}let B=0,j="",M=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const U=be(a["1h"]);U&&(M=wa(y,U,a["1h"]),M.tp1_probability>70?(B=10,j=`PoP: TP1 ${M.tp1_probability.toFixed(0)}%`):M.tp1_probability>60&&(B=5,j=`PoP: TP1 ${M.tp1_probability.toFixed(0)}%`))}catch(U){console.error("[ENHANCED] Probability of Profit error:",U.message)}let L=null,G=0,le=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{L=ks(a["1h"]),L.liquidity_score>=80?G=5:L.liquidity_score>=70?G=0:L.liquidity_score>=50?le=-5:le=-10,console.log(`[LIQUIDITY] Score: ${L.liquidity_score}/100, Session: ${L.session}, Adjust: ${G+le}%`)}catch(U){console.error("[ENHANCED] Liquidity Analysis error:",U.message)}let k=0,z=0,Q=0,te=0,re="";try{const U=await t.prepare(`
      ...
      `).all(),X=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(U&&O.results&&O.results.length>=10){const T=ea(O.results,U.balance);k=T.var_95,z=T.var_99;const oe=ta(U.balance,O.results);if(Q=oe.current_drawdown_pct,oe.is_within_limit||(re+=`⚠️ Drawdown ${Q.toFixed(1)}% exceeds limit. `),X.results){const ye=sa(X.results,U.balance);te=ye.total_risk_pct,ye.is_within_limit||(re+=`⚠️ Portfolio heat ${te.toFixed(1)}% exceeds limit. `)}}}catch(U){console.error("[ENHANCED] Risk metrics error (optional):",U.message)}const $=E+R+x+B+G+le,V={...y,pattern_boost:E,regime_boost:R,ml_boost:x,pop_boost:B,total_boost:$,enhanced_confidence:Math.min(98,y.final_confidence+$),var_95:k,var_99:z,current_drawdown_pct:Q,portfolio_heat_pct:te,risk_warning:re||null},H={...w,pattern_boost:E,regime_boost:R,ml_boost:x,pop_boost:B,total_boost:$,enhanced_confidence:Math.min(98,w.final_confidence+$),var_95:k,var_99:z,current_drawdown_pct:Q,portfolio_heat_pct:te,risk_warning:re||null};m?(V.signal_type="HOLD",H.signal_type="HOLD",V.enhanced_confidence=50,H.enhanced_confidence=50,V.reasoning=d||"Economic event nearby - trading paused",H.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(V.enhanced_confidence=Math.max(50,V.enhanced_confidence+c.adjustment),H.enhanced_confidence=Math.max(50,H.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),V.calendar_check={risk_level:i.riskLevel,should_trade:i.shouldTrade,reason:i.reason,confidence_adjustment:c.adjustment,upcoming_events:i.upcomingEvents.slice(0,3).map(U=>It(U))},H.calendar_check=V.calendar_check;let xe=!1;try{const U=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),O={};for(const X of U.results||[])O[X.setting_key]=X.setting_value;if(O.telegram_bot_token&&O.telegram_chat_id){const X=new Date().toLocaleString("en-US",{timeZone:"UTC"});let T=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${X} UTC

`;if(r.length>0){T+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const Z of r)T+=`${Z}
`;T+=`*→ Click "Generate Signal NOW" for fresh data*

`}i.riskLevel==="danger"?(T+=`🚨 *ECONOMIC CALENDAR ALERT*
`,T+=`${i.reason}
`,T+=`*→ NO TRADING RECOMMENDED*

`):i.riskLevel==="caution"?(T+=`⚠️ *ECONOMIC CALENDAR WARNING*
`,T+=`${i.reason}
`,T+=`*→ Reduce position size by 50%*

`):i.upcomingEvents.length>0&&(T+=`📅 *Economic Calendar:* ✅ Safe to trade
`,T+=`Next event: ${It(i.upcomingEvents[0])}

`),re&&(T+=`⚠️ *RISK ALERTS*
${re}

`),T+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,T+=`📊 *MULTI-TIMEFRAME ALIGNMENT*
`,T+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,T+=`${u.type} (${u.score}/5 timeframes)
`,T+=`Confidence Boost: +${u.confidenceBoost}%

`;for(const Z of u.trends){const ue=Z.trend==="BULLISH"?"📈":Z.trend==="BEARISH"?"📉":"➡️";T+=`${ue} *${Z.timeframe}*: ${Z.trend} (${Z.confidence.toFixed(0)}%)
`}T+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,T+=`📈 *DAY TRADE SIGNAL*
`,T+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,T+=`${V.isValid?"✅":"❌"} *${V.signal_type}* (${V.enhanced_confidence.toFixed(0)}% confidence)

`,T+=`*Entry:* $${V.price.toFixed(2)}
`,T+=`*Stop Loss:* $${V.stop_loss.toFixed(2)} (${((V.stop_loss/V.price-1)*100).toFixed(2)}%)
`,T+=`*TP1:* $${V.take_profit_1.toFixed(2)} (${((V.take_profit_1/V.price-1)*100).toFixed(2)}%)
`,T+=`*TP2:* $${V.take_profit_2.toFixed(2)} (${((V.take_profit_2/V.price-1)*100).toFixed(2)}%)
`,T+=`*TP3:* $${V.take_profit_3.toFixed(2)} (${((V.take_profit_3/V.price-1)*100).toFixed(2)}%)

`;const oe=candles1h.slice(-20),ye=oe.map(Z=>Z.high).sort((Z,ue)=>ue-Z),Ve=oe.map(Z=>Z.low).sort((Z,ue)=>Z-ue),Le=ye.slice(0,3),J=Ve.slice(0,3);if(T+=`📊 *Key Levels:*
`,T+=`🔴 *Resistance:* ${Le.map(Z=>`$${Z.toFixed(2)}`).join(", ")}
`,T+=`🟢 *Support:* ${J.map(Z=>`$${Z.toFixed(2)}`).join(", ")}

`,T+=`*📊 Confidence Breakdown:*
`,T+=`Base: ${V.base_confidence.toFixed(0)}%
`,T+=`MTF: ${V.mtf_confidence.toFixed(0)}%
`,E>0&&(T+=`Pattern: +${E.toFixed(0)}%
`),R>0&&(T+=`Regime: +${R.toFixed(0)}%
`),x>0&&(T+=`ML: +${x.toFixed(0)}%
`),B>0&&(T+=`PoP: +${B.toFixed(0)}%
`),G!==0||le!==0){const Z=G+le;T+=`Liquidity: ${Z>=0?"+":""}${Z.toFixed(0)}%
`}T+=`*FINAL: ${V.enhanced_confidence.toFixed(0)}%*

`,I&&(T+=`🌡️ *Market Regime:* ${I.trend||"N/A"}
`,T+=`Volatility: ${I.volatility}
`,T+=`Should Trade: ${I.should_trade?"✅ YES":"❌ NO"}

`),N&&N.overall_direction!=="NEUTRAL"&&(T+=`🤖 *ML Prediction:* ${N.overall_direction}
`,(s=N.predictions[0])!=null&&s.predicted_price&&(T+=`1h Target: $${N.predictions[0].predicted_price.toFixed(2)}
`),T+=`
`),M&&(T+=`🎯 *Probability of Profit:*
`,T+=`TP1: ${M.tp1_probability.toFixed(0)}%
`,T+=`TP2: ${M.tp2_probability.toFixed(0)}%
`,T+=`TP3: ${M.tp3_probability.toFixed(0)}%
`,T+=`Expected Value: ${M.expected_value.toFixed(2)}R

`),T+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,T+=`💡 *RECOMMENDATION*
`,T+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,V.isValid&&V.signal_type!=="HOLD"?(T+=`✅ *EXECUTE ${V.signal_type}*
`,T+=`All hedge fund features aligned!
`):(T+=`⚠️ *SKIP TRADE*
`,T+=`Reason: ${V.mtf_reason}
`),T+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",T.length,"characters");const vt=await q({botToken:O.telegram_bot_token,chatId:O.telegram_chat_id},T);let W=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if(L){const Z=L.liquidity_score>=80?"🟢":L.liquidity_score>=70?"🟡":L.liquidity_score>=50?"🟠":"🔴";if(W+=`🌊 *LIQUIDITY ANALYSIS*
`,W+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,W+=`${Z} *Score:* ${L.liquidity_score}/100
`,W+=`🕐 *Session:* ${L.session}
`,W+=`📊 *Time Zone:* ${L.time_of_day_zone} LIQUIDITY
`,W+=`📈 *Volume:* ${L.volume_trend} (${L.volume_percentile}%)
`,W+=`💰 *Spread:* ~${L.estimated_spread_pips} pips
`,W+=`📉 *Price Impact:* ~${L.price_impact_bps} bps per $100k
`,W+=`🎯 *Market Depth:* ${L.market_depth_score}/100
`,W+=`✅ *Optimal:* ${L.optimal_for_trading?"YES":"NO"}

`,L.warnings.length>0){W+=`⚠️ *Liquidity Warnings:*
`;for(const ue of L.warnings)W+=`• ${ue}
`;W+=`
`}W+=`💡 *Recommendation:*
${L.recommendation}
...
`,W+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",W.length,"characters");const ct=await q({botToken:O.telegram_bot_token,chatId:O.telegram_chat_id},W);xe=vt&&ct}}catch(U){console.error("[ENHANCED] Telegram error (optional):",U.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:xe,day_trade:V,swing_trade:H,alignment:{type:u.type,score:u.score,trends:u.trends},patterns:v.length>0?v.slice(0,3):null,regime:I?{trend:I.trend,volatility:I.volatility,should_trade:I.should_trade}:null,ml_prediction:N?{direction:N.overall_direction,predictions:N.predictions}:null,profit_probability:M?{tp1:M.tp1_probability,tp2:M.tp2_probability,tp3:M.tp3_probability,expected_value:M.expected_value}:null,liquidity:L?{score:L.liquidity_score,session:L.session,time_zone:L.time_of_day_zone,volume_trend:L.volume_trend,volume_percentile:L.volume_percentile,estimated_spread_pips:L.estimated_spread_pips,price_impact_bps:L.price_impact_bps,market_depth_score:L.market_depth_score,optimal_for_trading:L.optimal_for_trading,warnings:L.warnings,recommendation:L.recommendation}:null,risk_metrics:{var_95:k,var_99:z,drawdown_pct:Q,portfolio_heat_pct:te}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const Ds=new _e;Ds.post("/simple",async e=>{var s,n,a,r;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const o=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,w+=`⏰ ${y}`,console.log("[SIMPLE] Sending Telegram message, length:",w.length),f=await q({botToken:h.telegram_bot_token,chatId:h.telegram_chat_id},w),console.log("[SIMPLE] Telegram sent:",f),f||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(_){console.error("[SIMPLE] Telegram error:",_.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:f,day_trade:{signal_type:p.signal_type,confidence:Number(p.confidence),price:Number(c),stop_loss:Number(p.stop_loss),take_profit_1:Number(p.take_profit_1),take_profit_2:Number(p.take_profit_2),take_profit_3:Number(p.take_profit_3),reason:String(p.reason),trading_style:"day_trade"},swing_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"swing_trade"}})}catch(o){return console.error("[SIMPLE] Error:",o.message,o.stack),e.json({success:!1,error:o.message,stack:o.stack},500)}});function Ma(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Oa(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Fa(e,t){return e>t*1.1}function Ca(e){let t=0,s=0,n=0;for(const l of e){const i=l.volume||0;n+=i,l.close>l.open?t+=i:l.close<l.open&&(s+=i)}const a=s>0?t/s:t>0?10:1;let r="NEUTRAL";a>1.5?r="BUYING":a<.67&&(r="SELLING");let o=0;return a>3?o=100:a>1.5?o=50+(a-1.5)/1.5*50:a>.67?o=(a-.67)/.83*50:a>.33?o=50+(.67-a)/.34*50:o=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:r,strength:Math.round(o)}}function $s(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function Ha(e,t){const n=$s(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Ba(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Ua(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Pa(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),ja(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Wa(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Ya(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Ga(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Va(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),qa(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),za(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Xa(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Ua(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Pa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function ja(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Wa(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Ya(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),o=e.close<e.open,l=s.close>s.open;return o&&a<n*.5&&l&&r>n*.6&&s.close>(e.open+e.close)/2}function Ga(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),r=Math.abs(s.close-s.open),o=e.close>e.open,l=s.close<s.open;return o&&a<n*.5&&l&&r>n*.6&&s.close<(e.open+e.close)/2}function Va(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,r=t.low>e.low&&s.low>t.low,o=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&r&&o>c&&l>c&&i>c}function qa(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,r=t.low<e.low&&s.low<t.low,o=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&r&&o>c&&l>c&&i>c}function za(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Xa(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function Ka(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function Za(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),m=Math.max(...d.map(u=>u.high)),p=Math.min(...d.map(u=>u.low));s.push({level:m,type:"RESISTANCE",strength:85,distance:m-t,distancePercent:(m-t)/t*100}),s.push({level:p,type:"SUPPORT",strength:85,distance:t-p,distancePercent:(t-p)/t*100})}const n=e.slice(-50),a=ts(n,"HIGH"),r=ts(n,"LOW");if(a.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),r.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),Qa(t).forEach(d=>{const m=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:m,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),m=Ja(d);s.push({level:m.pp,type:"PIVOT",strength:80,distance:Math.abs(m.pp-t),distancePercent:Math.abs(m.pp-t)/t*100}),s.push({level:m.r1,type:"RESISTANCE",strength:70,distance:m.r1-t,distancePercent:(m.r1-t)/t*100}),s.push({level:m.s1,type:"SUPPORT",strength:70,distance:t-m.s1,distancePercent:(t-m.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const i=l.reduce((d,m)=>Math.abs(m.distancePercent)<Math.abs(d.distancePercent)?m:d),c=er(e,t,i);return{nearZone:!0,closestZone:i,zoneType:i.type,action:c,strength:i.strength,description:tr(i,c)}}function ts(e,t){const s=[];for(let r=5;r<e.length-5;r++){const o=t==="HIGH"?e[r].high:e[r].low;let l=!0;for(let i=r-5;i<=r+5;i++){if(i===r)continue;const c=t==="HIGH"?e[i].high:e[i].low;if(t==="HIGH"&&c>=o){l=!1;break}if(t==="LOW"&&c<=o){l=!1;break}}l&&s.push(o)}return Array.from(new Set(s)).slice(-3)}function Qa(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function Ja(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),n=e[e.length-1].close,a=(t+s+n)/3,r=2*a-s,o=2*a-t,l=a+(t-s),i=a-(t-s);return{pp:a,r1:r,s1:o,r2:l,s2:i}}function er(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function tr(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function sr(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function nr(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=ar(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const r=rr(s,a),o=or(s,a);return r.type!=="NONE"&&o.type===r.type?{type:r.type,category:r.category,indicator:"BOTH",strength:95,description:`${r.type} ${r.category} (RSI+MACD)`,confidence:90}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"RSI",strength:80,description:`${r.type} ${r.category} (RSI)`,confidence:75}:o.type!=="NONE"?{type:o.type,category:o.category,indicator:"MACD",strength:70,description:`${o.type} ${o.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function ar(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const r=e[a];let o=!0;for(let i=a-2;i<=a+2;i++)if(i!==a&&e[i].high>=r.high){o=!1;break}o&&t.push({index:a,price:r.high});let l=!0;for(let i=a-2;i<=a+2;i++)if(i!==a&&e[i].low<=r.low){l=!1;break}l&&s.push({index:a,price:r.low})}return{highs:t,lows:s}}function rr(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,r=e[n.index].rsi,o=e[a.index].rsi;if(a.price<n.price&&o>r)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&o<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,r=e[n.index].rsi,o=e[a.index].rsi;if(a.price>n.price&&o<r)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&o>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function or(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,r=e[n.index].macd_histogram,o=e[a.index].macd_histogram;if(a.price<n.price&&o>r)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&o<r)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,r=e[n.index].macd_histogram,o=e[a.index].macd_histogram;if(a.price>n.price&&o<r)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&o>r)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ir(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function lr(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,r=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${r}, ${e.strength}/100)`}function cr(e,t,s,n){const a=(h,g)=>{const y=parseFloat(String(h));return isNaN(y)?g:y},r=a(e.ema_12,n),o=a(t.ema_26,n),l=a(s.sma_200,n),i=jt(n,r),c=jt(n,o),d=jt(n,l),m=i===c&&c===d&&i!=="NEUTRAL",p=i===c&&i!=="NEUTRAL"||i===d&&i!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let u=0,f="",_="";return m?(u=100,f=`ALL ${i}`,_=`All 3 timeframes ${i.toLowerCase()} (perfect alignment)`):p?(u=65,i===c?(f=`5M+15M ${i}`,_=`5m & 15m ${i.toLowerCase()} (1h ${d.toLowerCase()})`):i===d?(f=`5M+1H ${i}`,_=`5m & 1h ${i.toLowerCase()} (15m ${c.toLowerCase()})`):(f=`15M+1H ${c}`,_=`15m & 1h ${c.toLowerCase()} (5m ${i.toLowerCase()})`)):(u=30,f="MIXED",_=`Mixed signals: 5m ${i.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:i,tf15m:c,tf1h:d,allAligned:m,twoAligned:p,alignment:f,strength:u,description:_}}function jt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function dr(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function ur(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function mr(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,r=(s.close-n.close)/n.close*100;let o="FLAT";r>.1?o="UP":r<-.1&&(o="DOWN");let l="NEUTRAL";o==="DOWN"?l="BULLISH":o==="UP"&&(l="BEARISH");const i=Math.abs(r);let c=-.8,d=0;i>.3?d=90:i>.2?d=75:i>.1?d=60:d=40;const m=new Date(s.timestamp),u=Math.floor((new Date().getTime()-m.getTime())/6e4),f=gr(a,r,o,l,d);return{dxyPrice:a,dxyChange:r,dxyTrend:o,goldSignalSupport:l,correlation:c,strength:d,description:f,dataAge:u}}function pr(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function gr(e,t,s,n,a){const r=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${r} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${r} → Gold BEARISH (${a}/100)`:`DXY flat ${r} → Neutral (${a}/100)`}async function fr(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(r=>({close:parseFloat(r.close),timestamp:r.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function _r(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function Dr(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function $r(e){const t=await Dr(e);if(t){const n=new Date(t.timestamp),r=(new Date().getTime()-n.getTime())/(1e3*60*60*24);if(r<7)return console.log(`[COT] Using cached data (${r.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await Ir();return s?(await Ar(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Nr(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const ot=new _e;ot.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER] Starting scan at",n),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).bind(m,"5m",d.signal,d.grade,d.score,c,d.stopLoss,d.tp1,d.tp2,d.tp3,d.confidence,d.layersPassed,d.liquidityScore,d.session,0).run();let p=!1;if(d.grade==="A"||d.grade==="A+")try{const f=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),_={};for(const h of f.results||[])_[h.setting_key]=h.setting_value;if(_.telegram_bot_token&&_.telegram_chat_id){const h=Ms(d,c);p=await q({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},h),await t.prepare(`
            UPDATE scanner_history 
            SET telegram_sent = ?
            WHERE timestamp = (SELECT MAX(timestamp) FROM scanner_history)
          `).bind(p?1:0).run(),console.log("[5M-SCANNER] Telegram alert sent:",p)}}catch(f){console.error("[5M-SCANNER] Telegram error:",f.message)}const u=new Date;return console.log("[5M-SCANNER] Scan complete, returning results"),e.json({success:!0,timestamp:u.toISOString(),scan_result:{grade:d.grade,score:d.score,signal:d.signal,confidence:d.confidence,entry:c,stop_loss:d.stopLoss,targets:[d.tp1,d.tp2,d.tp3],layers_passed:d.layersPassed,telegram_sent:p}})}catch(s){console.error("[5M-SCANNER] Error caught:",s);const n=(s==null?void 0:s.message)||String(s);return console.error("[5M-SCANNER] Error message:",n),e.json({success:!1,error:n},500)}});ot.get("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER-GET] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER-GET] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER-GET] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER-GET] Starting scan at",n),console.log("[5M-SCANNER-GET] Step 4: Creating table"),await t.prepare(`
      CREATE TABLE IF NOT EXISTS scanner_history (
        id INTEGER PRIMARY KEY AUTOINCREMENT,
        timestamp DATETIME NOT NULL,
        timeframe TEXT NOT NULL,
...
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC
          `.trim();await q(_,h,g),p=!0,console.log("[5M-SCANNER-GET] Telegram alert sent for",d.grade,"grade")}}catch(u){console.error("[5M-SCANNER-GET] Telegram error:",u)}return e.json({success:!0,timestamp:m,scan_result:{grade:d.grade,score:d.score,signal:d.signal,confidence:d.confidence,entry:c,stop_loss:d.stopLoss,targets:[d.tp1,d.tp2,d.tp3],layers_passed:d.layersPassed,telegram_sent:p}})}catch(s){console.error("[5M-SCANNER-GET] Fatal error:",s);const n=(s==null?void 0:s.message)||String(s);return console.error("[5M-SCANNER-GET] Error message:",n),e.json({success:!1,error:n},500)}});ot.get("/stats",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),o=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:n.results,session_stats:a.results,best_hours:r.results,recent_a_grade:o.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});ot.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});ot.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const c of s.results||[])n[c.setting_key]=c.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,r=15,o={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-r,tp1:a+r*2,tp2:a+r*3,tp3:a+r*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=Ms(o,a),i=await q({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:i,message:i?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Ns(e,t,s,n,a,r){console.log("[ANALYZE] Starting analysis");let o=0,l=0;const i=[],c=(ee,ze)=>{const St=parseFloat(String(ee));return isNaN(St)?ze:St};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,r),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},m={ema50:c(s.ema_26,r)},p={sma200:c(n.sma_200,r)},u=r>d.ema20&&r>m.ema50&&r>p.sma200,f=r<d.ema20&&r<m.ema50&&r<p.sma200;u||f?(o+=20,l++,i.push(`✅ Layer 1: Trend Aligned (${u?"BULLISH":"BEARISH"})`)):i.push("❌ Layer 1: Trend NOT aligned (conflicting)");const _=d.rsi>=40&&d.rsi<=60,h=d.macd>d.macd_signal&&d.macd_histogram>0,g=d.macd<d.macd_signal&&d.macd_histogram<0;_&&(u?h:g)?(o+=15,l++,i.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${u?"bullish":"bearish"} crossover`)):i.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${_?"no crossover":"extreme"}`);const y=a.slice(-20).reduce((ee,ze)=>ee+ze.volume,0)/20,w=a[a.length-1].volume;w>y*1.5?(o+=15,l++,i.push(`✅ Layer 3: Volume spike ${(w/y).toFixed(1)}x average`)):i.push(`❌ Layer 3: Volume ${(w/y).toFixed(1)}x (need 1.5x+)`);const S=Math.max(...a.slice(-20).map(ee=>ee.high)),v=Math.min(...a.slice(-20).map(ee=>ee.low)),R=r>S*.999,A=r<v*1.001;u&&R||f&&A?(o+=15,l++,i.push(`✅ Layer 4: ${u?"Broke above resistance":"Broke below support"}`)):i.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let I=null;try{I=await ks(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(ee){console.log("[5M-SCANNER] Liquidity calc failed:",ee)}const x=(I==null?void 0:I.liquidity_score)||50,D=(I==null?void 0:I.session)||"UNKNOWN";x>=70?(o+=15,l++,i.push(`✅ Layer 5: Liquidity ${x}/100 (${D} session)`)):i.push(`❌ Layer 5: Liquidity ${x}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const B=Et();console.log("[ANALYZE] Calendar check complete"),B.riskLevel==="safe"?(o+=10,l++,i.push("✅ Layer 6: No major news")):i.push(`❌ Layer 6: ${B.reason}`);const M=d.adx>25,L=d.adx>70;M&&!L?(o+=10,l++,i.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):L?i.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):i.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let G="HOLD";(u||f)&&l>=5&&(G=u?"BUY":"SELL");const le=new Date,k=Ma(le);k.hasBoost?(o+=8,l++,i.push(`✅ Layer 8: ${k.reason} (+${k.boost}% win)`)):i.push(`ℹ️ Layer 8: ${k.reason}`);const z=Oa(le);z.hasBoost?(o+=5,l++,i.push(`✅ Layer 9: ${z.reason} (+${z.boost}% win)`)):i.push(`ℹ️ Layer 9: ${z.reason}`);const Q=c(t.atr_14,r*.01),te=a.slice(-20).reduce((ee,ze)=>{const St=ze.high-ze.low;return ee+St},0)/20;if(Fa(Q,te)){o+=7,l++;const ee=((Q/te-1)*100).toFixed(1);i.push(`✅ Layer 10: ATR expanding ${ee}% (high volatility)`)}else{const ee=((1-Q/te)*100).toFixed(1);i.push(`❌ Layer 10: ATR compressed ${ee}% (skip low volatility)`)}const $=Ca(a.slice(-20));$s($,G)&&$.strength>=60&&(o+=10,l++),i.push(Ha($,G));const H=Ba(a.slice(-3)),{aligned:xe,strongestPattern:U}=Ka(H,G);xe&&U?(o+=12,l++,i.push(`✅ Layer 12: ${U.name} (${U.strength}/100)`)):H.length>0&&H[0].type==="INDECISION"?i.push(`⚠️ Layer 12: ${H[0].name} (indecision, wait)`):i.push("❌ Layer 12: No clear candlestick pattern");const O=Za(a,r);sr(O,G)&&O.nearZone?(o+=8,l++,i.push(`✅ Layer 13: ${O.description}`)):O.nearZone?i.push(`⚠️ Layer 13: ${O.description} (not aligned)`):i.push("ℹ️ Layer 13: No key zones nearby");const oe=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(ee=>({rsi:parseFloat(String(ee.rsi))||50,macd:parseFloat(String(ee.macd))||0,macd_histogram:parseFloat(String(ee.macd_histogram))||0})).reverse(),ye=nr(oe,a.slice(-10)),Le=ir(ye,G,u?"BULLISH":f?"BEARISH":"NEUTRAL");Le&&ye.strength>=70&&(o+=9,l++),i.push(lr(ye,Le));const J=cr(t,s,n,r),vt=dr(J,G);vt&&(J.allAligned||J.twoAligned)&&(o+=6,l++),i.push(ur(J,vt));const W=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),ct=(W==null?void 0:W.setting_value)||"70140f57bea54c5e90768de696487d8f",Z=await yr(e,ct,15),ue=mr(Z);pr(ue,G)&&ue.strength>=60?(o+=5,l++,i.push(`✅ Layer 18: ${ue.description}`)):ue.goldSignalSupport!=="NEUTRAL"?i.push(`⚠️ Layer 18: ${ue.description} (not aligned)`):i.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Zs=await ns(e,ct,"SILVER",15),Qs=await ns(e,ct,"OIL",15),qe=br(Zs,Qs,G);if(qe.aligned&&qe.alignmentCount>=1){const ee=qe.alignmentCount===2?5:3;o+=ee,l++,i.push(`✅ Layer 19: ${qe.description} (${qe.strength}/100)`)}else i.push(`❌ Layer 19: ${qe.description}`);const Js=await $r(e)||Nr(),Re=xr(Js);if(Rr(Re,G)&&Re.strength>=70){const ee=Re.positioning.includes("EXTREME")?7:4;o+=ee,l++,i.push(`✅ Layer 20: ${Re.description} (${Re.strength}/100)`)}else Re.goldSignalSupport!=="NEUTRAL"?i.push(`⚠️ Layer 20: ${Re.description} (not aligned)`):i.push(`ℹ️ Layer 20: ${Re.description}`);let Tt="C";o>=162?Tt="A+":o>=144?Tt="A":o>=126&&(Tt="B"),(u||f)&&l>=7&&(G=u?"BUY":"SELL");const ke=Math.max(Q*1.5,r*.003),en=G==="BUY"?r-ke:r+ke,tn=G==="BUY"?r+ke*2:r-ke*2,sn=G==="BUY"?r+ke*3:r-ke*3,nn=G==="BUY"?r+ke*4:r-ke*4;return{grade:Tt,score:o,signal:G,confidence:o,layersPassed:l,layers:i,stopLoss:en,tp1:tn,tp2:sn,tp3:nn,liquidityScore:x,session:D,adx:d.adx,rsi:d.rsi,volumeRatio:w/y}}function Ms(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,r=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let o=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,o+="Next scan in 5 minutes...",o}async function it(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(e).first();if(!a)return{success:!1,error:"Trade not found or already closed"};const r=a.trade_type==="BUY"?t-a.entry_price:a.entry_price-t,o=r*a.position_size,l=r/a.entry_price*100,i=o>0?1:0;await n.prepare(`
      ...
      WHERE id = ?
    `).bind(t,new Date().toISOString(),s,o,l,i,e).run();const d=(await it(n)).current_balance+o;return await n.prepare(`
      UPDATE risk_limits
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await Hs(n),await Or(n),await Fr(n),{success:!0,profit_loss:o}}catch(a){return{success:!1,error:a.message}}}async function Hs(e){const t=await it(e),s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,r=n.filter(u=>u.win===1).length,o=n.filter(u=>u.win===0).length,l=r/a*100,i=n.reduce((u,f)=>u+(f.profit_loss||0),0),c=Math.max(...n.map(u=>u.profit_loss||0)),d=Math.min(...n.map(u=>u.profit_loss||0)),m=n.reduce((u,f)=>u+(f.confidence||0),0)/a,p=n.reduce((u,f)=>u+(f.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,r,o,l,i,c,d,m,p).run()}async function Fr(e){const t=await it(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,r).run();let o=!1,l="";s>=t.max_drawdown_pct?(o=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):r>=t.max_daily_loss_pct&&(o=!0,l=`Daily loss ${r.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),o&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});he.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Oe=new _e;Oe.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=Ot(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:It(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Oe.get("/today",async e=>{try{const t=Na(),s=Et();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Oe.get("/check",async e=>{try{const t=Et(),s=Is();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Oe.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);$a(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Oe.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const wt=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Hr,calculatePositionSize:Ps,calculateProfitLoss:js,checkDailyLossLimit:Cr,formatPositionSize:Br},Symbol.toStringTag,{value:"Module"}));async function Ws(e,t,s){const n=Date.now(),a=[],r=[];let o=t.starting_balance,l=t.starting_balance;const i=e.filter(k=>{const z=new Date(k.timestamp);return z>=new Date(t.start_date)&&z<=new Date(t.end_date)});if(i.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${i.length}`);const c={current_balance:o,max_daily_loss_pct:2};for(let k=200;k<i.length;k++){const z=i.slice(k-200,k),Q=be(z);if(!Q)continue;const te=i[k],re=te.close,$=ae(re,Q,"day_trade"),V=ae(re,Q,"swing_trade");for(const H of[$,V]){if(H.signal_type==="HOLD"||H.confidence<t.min_confidence)continue;c.current_balance=o;const xe=Ps(c,{entry_price:H.price,stop_loss:H.stop_loss,take_profit_1:H.take_profit_1,take_profit_2:H.take_profit_2,take_profit_3:H.take_profit_3,confidence:H.confidence,signal_type:H.signal_type,trading_style:H.trading_style},s);if(!xe.is_valid)continue;const U=te.timestamp,O=H.price;let X=null,T=null,oe="UNKNOWN";const ye=Math.min(50,i.length-k-1);for(let Le=1;Le<=ye;Le++){const J=i[k+Le];if(H.signal_type==="BUY"){if(J.low<=H.stop_loss){X=H.stop_loss,T=J.timestamp,oe="STOP_LOSS";break}if(J.high>=H.take_profit_3){X=H.take_profit_3,T=J.timestamp,oe="TP3";break}if(J.high>=H.take_profit_2){X=H.take_profit_2,T=J.timestamp,oe="TP2";break}if(J.high>=H.take_profit_1){X=H.take_profit_1,T=J.timestamp,oe="TP1";break}}else{if(J.high>=H.stop_loss){X=H.stop_loss,T=J.timestamp,oe="STOP_LOSS";break}if(J.low<=H.take_profit_3){X=H.take_profit_3,T=J.timestamp,oe="TP3";break}if(J.low<=H.take_profit_2){X=H.take_profit_2,T=J.timestamp,oe="TP2";break}if(J.low<=H.take_profit_1){X=H.take_profit_1,T=J.timestamp,oe="TP1";break}}}if(!X||!T)continue;const Ve=js(O,X,xe.units,H.signal_type,t.commission_per_trade);o+=Ve.profit_loss,o>l&&(l=o),a.push({entry_time:U,entry_price:O,exit_time:T,exit_price:X,signal_type:H.signal_type,trading_style:H.trading_style,position_size:xe.units,profit_loss:Ve.profit_loss,profit_loss_pct:Ve.profit_loss_pct,exit_reason:oe,confidence:H.confidence}),r.push({date:T,balance:o})}}const d=a.filter(k=>k.profit_loss>0),m=a.filter(k=>k.profit_loss<0),p=d.reduce((k,z)=>k+z.profit_loss,0),u=Math.abs(m.reduce((k,z)=>k+z.profit_loss,0)),f=o-t.starting_balance,_=a.length>0?d.length/a.length*100:0,h=d.length>0?p/d.length:0,g=m.length>0?u/m.length:0,y=d.length>0?Math.max(...d.map(k=>k.profit_loss)):0,w=m.length>0?Math.min(...m.map(k=>k.profit_loss)):0,E=u>0?p/u:p,S=100-_,v=_/100*h-S/100*g;let R=0,A=0,I=t.starting_balance;for(const k of r){k.balance>I&&(I=k.balance);const z=I-k.balance,Q=z/I*100;z>R&&(R=z,A=Q)}const x=a.map(k=>k.profit_loss_pct),D=x.reduce((k,z)=>k+z,0)/x.length,N=Math.sqrt(x.reduce((k,z)=>k+Math.pow(z-D,2),0)/x.length),B=N>0?D/N:0;let j=0,M=0,L=0,G=0;for(const k of a)k.profit_loss>0?(L++,G=0,j=Math.max(j,L)):(G++,L=0,M=Math.max(M,G));const le=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:d.length,losing_trades:m.length,win_rate:parseFloat(_.toFixed(2)),net_profit:parseFloat(f.toFixed(2)),total_return_pct:parseFloat((f/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(h.toFixed(2)),avg_loss:parseFloat(g.toFixed(2)),largest_win:parseFloat(y.toFixed(2)),largest_loss:parseFloat(w.toFixed(2)),max_drawdown:parseFloat(R.toFixed(2)),max_drawdown_pct:parseFloat(A.toFixed(2)),profit_factor:parseFloat(E.toFixed(2)),sharpe_ratio:parseFloat(B.toFixed(2)),expectancy:parseFloat(v.toFixed(2)),max_consecutive_wins:j,max_consecutive_losses:M,starting_balance:t.starting_balance,ending_balance:parseFloat(o.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:r,execution_time_ms:le}}function Ys(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Ur=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Ys,runBacktest:Ws},Symbol.toStringTag,{value:"Module"})),lt=new _e;lt.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp ASC
    `).all();if(n.results.length<200)return e.json({success:!1,error:`Not enough historical data. Have ${n.results.length} candles, need at least 200. System has been collecting data since Dec 26 - wait a few more days or reduce timeframe.`},400);const a=n.results.map(d=>({timestamp:d.timestamp,open:d.open,high:d.high,low:d.low,close:d.close,volume:d.volume||0})),r={start_date:s.start_date||new Date(Date.now()-365*24*60*60*1e3).toISOString(),end_date:s.end_date||new Date().toISOString(),starting_balance:s.starting_balance||1e4,min_confidence:s.min_confidence||75,use_mtf_confirmation:s.use_mtf_confirmation!==!1,use_news_filter:s.use_news_filter!==!1,timeframe:s.timeframe||"1h",commission_per_trade:s.commission_per_trade||0},l=await Ws(a,r,[{confidence_min:90,confidence_max:100,risk_pct:2,max_position_pct:10},{confidence_min:80,confidence_max:89,risk_pct:1.5,max_position_pct:7.5},{confidence_min:75,confidence_max:79,risk_pct:1,max_position_pct:5},{confidence_min:70,confidence_max:74,risk_pct:.5,max_position_pct:2.5}]),i=await t.prepare(`
...
📅 Backtest ID: ${i.meta.last_row_id}
        `.trim();c=await q({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},_)}}catch(d){console.error("[BACKTEST] Telegram send failed:",d)}return e.json({success:!0,backtest_id:i.meta.last_row_id,result:l,formatted:Ys(l),telegram_sent:c})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});lt.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
      ...
      LIMIT ?
    `).bind(s).all();return e.json({success:!0,count:n.results.length,backtests:n.results})}catch(t){return e.json({success:!1,error:t.message},500)}});lt.get("/results/:id",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.param("id")),n=await t.prepare(`
      SELECT * FROM backtest_runs WHERE id = ?
    `).bind(s).first();return n?(n.trades=n.trades_json?JSON.parse(n.trades_json):[],n.equity_curve=n.equity_curve_json?JSON.parse(n.equity_curve_json):[],e.json({success:!0,backtest:n})):e.json({success:!1,error:"Backtest not found"},404)}catch(t){return e.json({success:!1,error:t.message},500)}});lt.delete("/results/:id",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.param("id"));return await t.prepare(`
      DELETE FROM backtest_runs WHERE id = ?
    `).bind(s).run(),e.json({success:!0,message:"Backtest deleted"})}catch(t){return e.json({success:!1,error:t.message},500)}});lt.get("/data-availability",async e=>{try{const{DB:t}=e.env,s=await t.prepare(`
      SELECT 
      ...
      FROM market_data
      WHERE timeframe = '1h'
    `).first();if(!s||s.total_candles===0)return e.json({success:!0,available:!1,message:"No historical data available. Fetch market data first.",total_candles:0});const n=new Date(s.earliest_date),a=new Date(s.latest_date),r=Math.floor((a.getTime()-n.getTime())/(1e3*60*60*24));return e.json({success:!0,available:s.total_candles>=200,total_candles:s.total_candles,earliest_date:s.earliest_date,latest_date:s.latest_date,days_covered:r,min_required:200,ready_for_backtest:s.total_candles>=200})}catch(t){return e.json({success:!1,error:t.message},500)}});const Gs=new _e;Gs.post("/webhook",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=s.message||s.edited_message;if(!n||!n.text)return e.json({ok:!0});const a=n.chat.id,r=n.text.trim(),o=await t.prepare(`
      SELECT setting_value FROM user_settings WHERE setting_key = 'telegram_bot_token'
    `).first();if(!o)return e.json({ok:!0});const l={botToken:o.setting_value,chatId:a.toString()};if(r.startsWith("/log_trade")){const i=r.split(" ");if(i.length<5)return await q(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const c=i[1].toUpperCase(),d=parseFloat(i[2]),m=parseFloat(i[3]),p=parseFloat(i[4]),u=await Fs({trade_type:c,trading_style:"day_trade",entry_price:d,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:m,take_profit_1:p,take_profit_2:p*1.002,take_profit_3:p*1.003,status:"OPEN",confidence:85},t);u.success?await q(l,`✅ *Trade #${u.trade_id} Logged*

${c} @ $${d}
Stop: $${m}
TP1: $${p}`):await q(l,`❌ Error: ${u.error}`)}else if(r.startsWith("/close_trade")){const i=r.split(" ");if(i.length<4)return await q(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const c=parseInt(i[1]),d=parseFloat(i[2]),m=i[3],p=await Cs(c,d,m,t);if(p.success){const u=p.profit_loss||0,f=u>0?"💰":"❌";await q(l,`${f} *Trade #${c} Closed*

Exit: $${d}
P&L: ${u>0?"+":""}$${u.toFixed(2)}
Result: ${u>0?"WIN ✅":"LOSS ❌"}`)}else await q(l,`❌ Error: ${p.error}`)}else if(r==="/open"){const i=await Us(t);if(i.length===0)await q(l,"📊 No open positions");else{let c=`📊 *Open Positions (${i.length})*

`;for(const d of i)c+=`#${d.id}: ${d.trade_type} @ $${d.entry_price}
`,c+=`Stop: $${d.stop_loss}
`,c+=`TP1: $${d.take_profit_1}

`;await q(l,c)}}else if(r==="/stats"){const i=await Bs(t);let c=`📊 *Trading Statistics*
...
`,await q(l,c)}else r==="/help"&&await q(l,`📚 *Available Commands*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Ft=new _e;Ft.post("/market-analysis",async e=>await Vs(e));Ft.get("/health",async e=>e.json({success:!0,status:"healthy",service:"ai-analysis",timestamp:new Date().toISOString()}));Ft.get("/auto-ai-scan",async e=>await Vs(e));async function Vs(e){const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
    ...
    `).all();let n="";for(const x of s.results||[])x.setting_key==="twelve_data_api_key"&&(n=x.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const x=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,N=await(await fetch(x)).json();N.values&&N.values.length>=50&&(a=N.values.reverse().map(B=>({timestamp:B.datetime,open:parseFloat(B.open),high:parseFloat(B.high),low:parseFloat(B.low),close:parseFloat(B.close),volume:parseFloat(B.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const x=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!x.results||x.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=x.results.reverse().map(D=>({timestamp:D.timestamp,open:D.open,high:D.high,low:D.low,close:D.close,volume:D.volume||0}))}const r=be(a);if(!r)return e.json({success:!1,error:"Failed to calculate indicators"},400);const o=a[a.length-1].close,l=ae(o,r,"day_trade");console.log("[AI-ANALYSIS] Current price:",o,"Signal:",l.signal_type,"Confidence:",l.confidence);const i={};for(const x of["5m","15m","1h","4h","daily"]){const D=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();D&&(i[x]=D)}const c=qt(i,o),d=a.slice(-50),m=d.map(x=>x.high).sort((x,D)=>D-x),p=d.map(x=>x.low).sort((x,D)=>x-D),u=[Math.max(...m.slice(0,10))],f=[Math.min(...p.slice(0,10))];o>r.sma_20?f.push(r.sma_20):u.push(r.sma_20),o>r.sma_50?f.push(r.sma_50):u.push(r.sma_50),o>r.vwap?f.push(r.vwap):u.push(r.vwap);const _=Math.round(o/10)*10;_>o?u.push(_):f.push(_);const h=[...new Set(u)].sort((x,D)=>x-D).filter(x=>x>o).slice(0,3),g=[...new Set(f)].sort((x,D)=>D-x).filter(x=>x<o).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",g,"Resistance:",h);const y=r.atr_14/o*100;let w="NORMAL";y>3?w="EXTREME":y>1.5?w="HIGH":y<.5&&(w="LOW");const E=[];let S=30,v=30,R=40;c.type==="ALL_BULLISH"?(S=60,v=20,R=20):c.type==="ALL_BEARISH"?(S=20,v=60,R=20):c.score>=4&&(c.trends.filter(x=>x.trend==="BULLISH").length>=4?(S=50,v=25,R=25):(S=25,v=50,R=25)),h.length>0&&E.push({name:"📈 BULLISH CONTINUATION",probability:S,description:`Price breaks above $${h[0].toFixed(2)} and rallies toward $${(h[h.length-1]||o*1.02).toFixed(2)}`,trigger:`Breakout above $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||o*1.02}),g.length>0&&E.push({name:"📉 BEARISH CORRECTION",probability:v,description:`Price breaks below $${g[0].toFixed(2)} and drops toward $${(g[g.length-1]||o*.98).toFixed(2)}`,trigger:`Breakdown below $${g[0].toFixed(2)} with volume`,target:g[g.length-1]||o*.98}),E.push({name:"↔️ CONTINUED RANGING",probability:R,description:`Price oscillates between $${(g[0]||o*.99).toFixed(2)} and $${(h[0]||o*1.01).toFixed(2)} with choppy action`,trigger:w==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),E.sort((x,D)=>D.probability-x.probability);let A={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=65?l.signal_type==="BUY"?A={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(o-5).toFixed(2)}-${o.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(A={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${o.toFixed(2)}-${(o+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):w==="EXTREME"?A.reason=`⚠️ EXTREME volatility (ADX ${r.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(A.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${h[0]?`breakout above $${h[0].toFixed(2)}`:g[0]?`breakdown below $${g[0].toFixed(2)}`:"clearer direction"}.`);let I=!1;if(l.confidence>=65)try{const x=await t.prepare(`
          SELECT setting_key, setting_value FROM user_settings
          WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
        `).all(),D={};for(const N of x.results||[])D[N.setting_key]=N.setting_value;if(D.telegram_bot_token&&D.telegram_chat_id&&D.telegram_bot_token!=="your_bot_token_here"){const N=l.signal_type==="BUY"?"🟢":l.signal_type==="SELL"?"🔴":"⚪",B=l.confidence>=85,j=B?`🔥 *HIGH CONVICTION AI* 🔥
...
`,M+=`🔴 *Resistance:* ${h.length>0?h.map(L=>`$${L.toFixed(2)}`).join(", "):"N/A"}
`,M+=`🟢 *Support:* ${g.length>0?g.map(L=>`$${L.toFixed(2)}`).join(", "):"N/A"}
...
`,M+=`🛡️ *Stop Loss:* $${A.stop_loss}`),I=await q({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},M),console.log("[AI-ANALYSIS] Telegram alert sent:",I,"for",l.signal_type,l.confidence+"%"),I&&B&&(l.signal_type==="BUY"||l.signal_type==="SELL")&&(console.log("[AI-ANALYSIS] 🔥 HIGH CONVICTION AI signal! Scheduling reminders..."),setTimeout(async()=>{let L=`${N} *⚠️ REMINDER: AI HIGH CONVICTION* ${N}
...
`),L+="⏰ Don't miss this AI signal!",await q({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},L)},120*1e3),setTimeout(async()=>{let L=`${N} *⚠️ FINAL: AI SIGNAL STILL VALID* ${N}
...
`,L+=`🛡️ *Stop:* $${A.stop_loss}`),await q({botToken:D.telegram_bot_token,chatId:D.telegram_chat_id},L)},300*1e3))}}catch(x){console.error("[AI-ANALYSIS] Telegram error:",x.message)}else console.log("[AI-ANALYSIS] No Telegram alert - Confidence:",l.confidence,"Signal:",l.signal_type);return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:o,signal:l.signal_type,confidence:l.confidence,volatility:w,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:h,support:g},scenarios:E,recommendation:A,telegram_sent:I}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}}const Fe=new _e;async function Pr(e){try{return await e.prepare("SELECT 1 FROM monitoring_config LIMIT 1").first(),!0}catch{return!1}}async function qs(e){try{const t=await e.prepare(`
  ...
  `).first();if(a){const l=a.last_timestamp,i=a.count,c=l?Math.floor((Date.now()-new Date(l).getTime())/6e4):9999;n.push({source:"market_data",timeframe:"1h",ageMinutes:c,isStale:c>s,lastTimestamp:l,count:i})}const r=["5m","15m","1h","4h","daily"];for(const l of r){const i=await e.prepare(`
    ...
    SELECT MAX(timestamp) as last_timestamp, COUNT(*) as count
    FROM signals
  `).first();if(o){const l=o.last_timestamp,i=o.count,c=l?Math.floor((Date.now()-new Date(l).getTime())/6e4):9999;n.push({source:"signals",ageMinutes:c,isStale:c>s,lastTimestamp:l,count:i})}return n}async function Wt(e,t,s,n,a,r){try{try{await e.prepare(`
...
⏰ ${new Date().toUTCString()}`;return await q(m,l,i),!0}}return!1}catch(o){return console.error("[MONITORING] Failed to send alert:",o),!1}}Fe.get("/health-check",async e=>{const{DB:t}=e.env;try{const s=await qs(t),n=e.req.url.replace("/api/monitoring/health-check",""),a=new Date().toISOString(),r=await Pr(t);console.log("[MONITORING] Starting comprehensive health check..."),console.log("[MONITORING] Tables exist:",r);const o=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}],l=[],i=s.telegram_alerts_enabled==="1",c=parseInt(s.slow_response_threshold_ms||"5000"),d=parseInt(s.max_failure_count||"3");console.log("[MONITORING] Fast mode: Checking 5 endpoints (MTF skipped)");for(const g of o){const y=await jr(t,g.name,g.url,n);let w=0,E="unknown",S=y.status==="down"?1:0;if(r)try{const v=await t.prepare(`
            SELECT failure_count, status FROM system_health
            WHERE endpoint_name = ?
            ORDER BY last_check_at DESC
            LIMIT 1
          `).bind(g.name).first();w=(v==null?void 0:v.failure_count)||0,E=(v==null?void 0:v.status)||"unknown",S=y.status==="down"?w+1:0}catch(v){console.log("[MONITORING] Could not read previous health check:",v)}if(r)try{await t.prepare(`
        ...
        `).bind(p,u,f,_,l.reduce((g,y)=>g+y.response_time_ms,0)/l.length).run()}catch(g){console.log("[MONITORING] Could not save metrics:",g)}return console.log(`[MONITORING] Health check complete: ${h}`),console.log(`[MONITORING] Tables exist: ${r}, Alerts enabled: ${i}`),e.json({success:!0,timestamp:a,overall_status:h,summary:{endpoints:{healthy:p,degraded:u,down:f,total:l.length},data:{fresh:m.length-_,stale:_,total:m.length}},endpoints:l,data_freshness:m,config:{stale_threshold_minutes:s.data_stale_threshold_minutes,slow_response_threshold_ms:s.slow_response_threshold_ms,max_failure_count:s.max_failure_count,telegram_alerts_enabled:i}})}catch(s){return console.error("[MONITORING] Health check failed:",s),e.json({success:!1,error:s.message,timestamp:new Date().toISOString()},500)}});Fe.get("/status",async e=>{const{DB:t}=e.env;try{let s,n,a;try{s=await t.prepare(`
        SELECT 
          endpoint_name,
          status,
          response_time_ms,
      ...
      `).all(),a=await t.prepare(`
        ...
        ORDER BY created_at DESC
        LIMIT 10
      `).all()}catch{const i=new URL(e.req.url),c=`${i.protocol}//${i.host}`,d=[{name:"auto-fetch",url:"/api/cron/auto-fetch"},{name:"ai-analysis",url:"/api/ai/health"},{name:"scanner",url:"/api/scanner/scan"},{name:"signals-recent",url:"/api/signals/recent"},{name:"indicators-latest",url:"/api/indicators/latest"}];s={results:await Promise.all(d.map(async({name:p,url:u})=>{try{const f=Date.now(),_=await fetch(`${c}${u}`,{method:"GET",signal:AbortSignal.timeout(1e4)}),h=Date.now()-f;return{endpoint_name:p,status:_.ok?"healthy":"degraded",response_time_ms:h,last_check_at:new Date().toISOString()}}catch{return{endpoint_name:p,status:"down",response_time_ms:0,last_check_at:new Date().toISOString()}}}))};try{const p=await t.prepare(`
          SELECT 
            '1h' as data_source,
            '1h' as timeframe,
        ...
        `).all(),f=await t.prepare(`
          SELECT 
            ...
            datetime('now') as last_fetch_at
          FROM signals
        `).first();n={results:[...p?[p]:[],...u.results||[],...f?[f]:[]]}}catch(p){console.log("[MONITORING] Data freshness check error:",p.message),n={results:[]}}a={results:[]}}const r=(s.results||[]).every(l=>l.status==="healthy"),o=(n.results||[]).every(l=>l.is_stale===0);return e.json({success:!0,overall_status:r&&o?"healthy":"degraded",endpoints:s.results,data_sources:n.results,unresolved_alerts:a.results,alert_count:(a.results||[]).length})}catch(s){return e.json({success:!1,error:s.message},500)}});Fe.get("/alerts",async e=>{const{DB:t}=e.env,s=e.req.query("resolved")==="true";try{const n=await t.prepare(`
    ...
    `).all();return e.json({success:!0,period_hours:s,metrics:n.results})}catch(n){return e.json({success:!1,error:n.message},500)}});Fe.get("/config",async e=>{const{DB:t}=e.env;try{const s=await qs(t);return e.json({success:!0,config:s})}catch(s){return e.json({success:!1,error:s.message},500)}});Fe.post("/config",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
        ...
        WHERE config_key = ?
      `).bind(a,n).run();return e.json({success:!0,message:"Configuration updated"})}catch(n){return e.json({success:!1,error:n.message},500)}});const P=new _e;P.use("/api/*",Pn());P.route("/api/signals/enhanced",As);P.route("/api/signals/simple",Ds);P.route("/api/scanner",ot);P.route("/api/trades",he);P.route("/api/calendar",Oe);P.route("/api/backtest",lt);P.route("/api/telegram",Gs);P.route("/api/ai",Ft);P.route("/api/monitoring",Fe);P.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));P.get("/api/signals/recent",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).all(),n={};for(const a of s.results||[])n[a.setting_key]=a.setting_value;return e.json({success:!0,settings:n})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/settings",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const r of s.results||[])n[r.setting_key]=r.setting_value;const a=await q({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},`🔔 <b>Test Alert</b>
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=(s==null?void 0:s.setting_value)||"";if(!n||n==="your_key_here")return e.json({success:!1,message:"NewsAPI key not configured. Using free tier (100 calls/day)",sentiment:{overall:"neutral",score:0,bullishCount:0,bearishCount:0,neutralCount:0,articles:[]}});const{fetchGoldNews:a,analyzeNewsSentiment:r}=await Promise.resolve().then(()=>Ks),o=await a(n),l=r(o);for(const i of l.articles.slice(0,10))await t.prepare(`
      ...
      VALUES (datetime('now'), ?, ?, ?, ?, ?)
    `).bind(l.overall,l.score,l.bullishCount,l.bearishCount,l.neutralCount).run(),e.json({success:!0,sentiment:l,articleCount:o.length})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/news/sentiment",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Ks),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});P.get("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),o=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f"}&outputsize=100`,i=await(await fetch(o)).json();if(i.code&&i.status==="error")return e.json({success:!1,error:i.message||"Twelve Data API error",count:0});if(!i.values||!Array.isArray(i.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const c=i.values,d=c.map(f=>t.prepare(`
        ...
        VALUES (?, ?, ?, ?, ?, ?, ?)
      `).bind(f.datetime,parseFloat(f.open)||0,parseFloat(f.high)||0,parseFloat(f.low)||0,parseFloat(f.close)||0,parseInt(f.volume||"0")||0,"1h"));await t.batch(d);const m=c.length,p=c[0],u=parseFloat(p.close)||0;return e.json({success:!0,count:m,price:u,message:"Data fetched successfully from cron job"})}catch(s){return console.error("Cron fetch error:",s),e.json({success:!1,error:s.message,count:0},500)}});P.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured. Please add it in settings.",count:0});const o=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&apikey=${n}&outputsize=100`,i=await(await fetch(o)).json();if(i.code&&i.status==="error")return e.json({success:!1,error:i.message||"Twelve Data API error",count:0});if(!i.values||!Array.isArray(i.values))return e.json({success:!1,error:"No data available from Twelve Data API",count:0});const d=i.values.map(u=>({timestamp:u.datetime,open:parseFloat(u.open)||0,high:parseFloat(u.high)||0,low:parseFloat(u.low)||0,close:parseFloat(u.close)||0,volume:0})),m=d.map(u=>t.prepare(`
      ...
      `).bind(u.timestamp,u.open,u.high,u.low,u.close,u.volume));await t.batch(m);const p=d.length;if(d.length>=50){const u=be(d.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const f=d[d.length-1].close,_=ae(f,u,"day_trade"),h=ae(f,u,"swing_trade"),g=70;for(const y of[_,h])if(y.confidence>=g&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const w=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),E={};for(const S of w.results||[])E[S.setting_key]=S.setting_value;E.telegram_bot_token&&E.telegram_chat_id&&await q({botToken:E.telegram_bot_token,chatId:E.telegram_chat_id},pt(y))}}}return e.json({success:!0,count:p})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/cron/ping",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT close, timestamp FROM market_data 
      WHERE timeframe = '1h' 
...
⏰ ${new Date().toLocaleString()}`,N=await q({botToken:r,chatId:o},D);v.day_trade_send_result=N,console.log("[AUTO-FETCH] Day trade alert result:",N),N?(E=!0,S.push("Day Trade"),I&&g.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION signal detected! Sending reminder alerts..."),setTimeout(async()=>{const B=`${A} <b>⚠️ REMINDER: HIGH CONVICTION SIGNAL</b> ${A}
...
⏰ Don't miss this trade!`;await q({botToken:r,chatId:o},B),console.log("[AUTO-FETCH] First reminder sent")},120*1e3),setTimeout(async()=>{const B=`${A} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${A}
...
🎯 TP1: $${g.take_profit_1.toFixed(2)}
🛡️ Stop: $${g.stop_loss.toFixed(2)}`;await q({botToken:r,chatId:o},B),console.log("[AUTO-FETCH] Final reminder sent")},300*1e3),S.push("High Conviction Reminders (2+5min)"))):console.error("[AUTO-FETCH] Failed to send day trade alert!")}if(v.swing_trade_checked=!0,console.log("[AUTO-FETCH] Checking swing trade...",{confidence:y.confidence,type:y.signal_type,threshold:80}),y.confidence>=80){v.swing_trade_send_attempted=!0,console.log("[AUTO-FETCH] Swing trade meets criteria! Sending alert...");const R=B=>B.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;"),A=y.signal_type==="BUY"?"🟢":y.signal_type==="SELL"?"🔴":"⚪",I=y.confidence>=85,x=I?"🔥 <b>HIGH CONVICTION</b> 🔥":"",D=`${A} <b>GOLD/USD ${y.signal_type} SIGNAL</b> ${A}
${x}
...
⏰ ${new Date().toLocaleString()}`,N=await q({botToken:r,chatId:o},D);v.swing_trade_send_result=N,N&&(E=!0,S.push("Swing Trade"),I&&y.signal_type!=="HOLD"&&(console.log("[AUTO-FETCH] 🔥 HIGH CONVICTION swing signal! Sending reminder alerts..."),setTimeout(async()=>{const B=`${A} <b>⚠️ REMINDER: HIGH CONVICTION SWING</b> ${A}
...
⏰ Don't miss this swing trade!`;await q({botToken:r,chatId:o},B),console.log("[AUTO-FETCH] Swing first reminder sent")},180*1e3),setTimeout(async()=>{const B=`${A} <b>⚠️ FINAL REMINDER: HIGH CONVICTION</b> ${A}
...
🛡️ Stop: $${y.stop_loss.toFixed(2)}`;await q({botToken:r,chatId:o},B),console.log("[AUTO-FETCH] Swing final reminder sent")},420*1e3),S.push("High Conviction Swing Reminders (3+7min)")))}}else console.log("[AUTO-FETCH] Telegram NOT configured or invalid token");return console.log(`[CRON] Processed ${u.length} candles, Telegram: ${E?"SENT":"NOT SENT"}, Alerts: ${S.join(", ")}`),e.json({success:!0,timestamp:new Date().toISOString(),data_fetched:{candles:u.length,latest_price:h,data_timestamp:u[0].timestamp},signals:{day_trade:{type:g.signal_type,confidence:g.confidence,price:h},swing_trade:{type:y.signal_type,confidence:y.confidence,price:h}},telegram:{configured:!!(r&&o),bot_token_set:!!r,chat_id_set:!!o,bot_token_valid:r!=="your_bot_token_here",sent:E,alerts:S},debug:{...v,day_trade_check:{confidence:g.confidence,min_confidence:w,meets_threshold:g.confidence>=w,signal_type:g.signal_type,sends_all_signals:!0,should_alert:g.confidence>=w},swing_trade_check:{confidence:y.confidence,min_confidence:80,meets_threshold:y.confidence>=80,signal_type:y.signal_type,sends_all_signals:!0,should_alert:y.confidence>=80}},message:E?`✅ Alerts sent: ${S.join(", ")}`:"⚪ No alerts sent (signals below confidence threshold)"})}catch(s){return console.error("[CRON] Error:",s),e.json({success:!1,error:s.message,telegram_sent:!1},500)}});P.get("/api/test/auto-fetch-settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",r=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let o=0;const l={};for(const i of r){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${i.interval}&apikey=${n}&outputsize=${i.outputsize}`,m=await(await fetch(c)).json();if(m.code&&m.status==="error"){l[i.dbKey]={success:!1,error:m.message,count:0};continue}if(!m.values||!Array.isArray(m.values)){l[i.dbKey]={success:!1,error:"No data",count:0};continue}const p=m.values;let u=0;const f=[];for(const _ of p){const h={timestamp:_.datetime,open:parseFloat(_.open)||0,high:parseFloat(_.high)||0,low:parseFloat(_.low)||0,close:parseFloat(_.close)||0,volume:0};f.push(h),await t.prepare(`
          ...
          VALUES (?, ?, ?, ?, ?, ?, ?)
          ON CONFLICT DO NOTHING
        `).bind(h.timestamp,h.open,h.high,h.low,h.close,h.volume,i.dbKey).run(),u++}if(f.length>=50){const _=be(f.reverse());_&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(i.dbKey,_.rsi_14,_.macd,_.macd_signal,_.macd_histogram,_.sma_20,_.sma_50,_.sma_200,_.ema_12,_.ema_26,_.bb_upper,_.bb_middle,_.bb_lower,_.atr_14,_.stochastic_k,_.stochastic_d,_.adx,_.plus_di,_.minus_di,_.ichimoku_tenkan,_.ichimoku_kijun,_.ichimoku_senkou_a,_.ichimoku_senkou_b,_.parabolic_sar,_.vwap,_.fib_382,_.fib_500,_.fib_618).run()}l[i.dbKey]={success:!0,count:u},o+=u,await new Promise(_=>setTimeout(_,500))}return e.json({success:!0,totalCount:o,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(i=>({timestamp:i.timestamp,open:i.open,high:i.high,low:i.low,close:i.close,volume:i.volume})),a=be(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const r=n[n.length-1].close,o=ae(r,a,"day_trade"),l=ae(r,a,"swing_trade");return e.json({success:!0,signals:{day_trade:o,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Rs),r=["5m","15m","1h","4h","daily"],o={};for(const v of r){const R=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(v).first();R&&(o[v]=R)}const l=Object.keys(o).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(o)});const i=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!i)return e.json({success:!1,error:"No market data available"});const c=i.close,d=s(o,c),m=o["1h"],p=ae(c,m,"day_trade"),u=ae(c,m,"swing_trade"),f=n(p.signal_type,d),_=n(u.signal_type,d),h={...p,base_confidence:p.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${p.reason}, MTF: ${f.reason}`},g={...u,base_confidence:u.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${_.reason}`},y=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),w={};for(const v of y.results||[])w[v.setting_key]=v.setting_value;let E=!1,S=[];w.telegram_bot_token&&w.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await q({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${pt({...h,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(S.push("day_trade"),E=!0),await new Promise(v=>setTimeout(v,1e3)),g.isValid&&g.signal_type!=="HOLD"&&await q({botToken:w.telegram_bot_token,chatId:w.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${pt({...g,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(S.push("swing_trade"),E=!0));for(const v of[h,g])v.isValid&&await t.prepare(`
    ...
    `).all();let n="";for(const f of s.results||[])f.setting_key==="twelve_data_api_key"&&(n=f.setting_value);let a,r=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const f=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,h=await(await fetch(f)).json();h.values&&h.values.length>=50?(a=h.values.reverse().map(g=>({timestamp:g.datetime,open:parseFloat(g.open)||0,high:parseFloat(g.high)||0,low:parseFloat(g.low)||0,close:parseFloat(g.close)||0,volume:parseFloat(g.volume)||0})),r=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(f){console.error("[GENERATE-NOW] API fetch failed:",f.message)}}if(!a){console.log("[GENERATE-NOW] Using database data (may be stale)");const f=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!f.results||f.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});a=f.results.reverse().map(_=>({timestamp:_.timestamp,open:_.open,high:_.high,low:_.low,close:_.close,volume:_.volume}))}const o=be(a);if(!o)return e.json({success:!1,error:"Failed to calculate indicators"});const l=a[a.length-1].close,i=ae(l,o,"day_trade"),c=ae(l,o,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",i.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),m={};for(const f of d.results||[])m[f.setting_key]=f.setting_value;let p=!1,u=[];m.telegram_bot_token&&m.telegram_chat_id&&(await q({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},pt({...i,timestamp:new Date().toISOString()}))&&(u.push("day_trade"),p=!0),await new Promise(h=>setTimeout(h,1e3)),await q({botToken:m.telegram_bot_token,chatId:m.telegram_chat_id},pt({...c,timestamp:new Date().toISOString()}))&&(u.push("swing_trade"),p=!0));for(const f of[i,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason, telegram_sent)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(f.signal_type,f.trading_style,f.price,f.stop_loss,f.take_profit_1,f.take_profit_2,f.take_profit_3,f.confidence,f.reason,p?1:0).run();return e.json({success:!0,signals:{day_trade:i,swing_trade:c},telegram_sent:p,sent_to_telegram:u})}catch(s){return e.json({success:!1,error:s.message},500)}});P.get("/api/trading/account/:id",async e=>{const{DB:t}=e.env,s=e.req.param("id");try{const n=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(s).first();return n?e.json({success:!0,account:n}):e.json({success:!1,error:"Account not found"},404)}catch(n){return e.json({success:!1,error:n.message},500)}});P.post("/api/trading/calculate-position",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal:a}=s,r=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!r)return e.json({success:!1,error:"Account not found"},404);const o=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = ? AND is_active = 1
      ORDER BY confidence_min DESC
    `).bind(n).all(),{calculatePositionSize:l,formatPositionSize:i}=await Promise.resolve().then(()=>wt),c=l(r,a,o.results);return e.json({success:!0,position:c,formatted:i(c)})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/trading/execute",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal_id:a,entry_price:r,stop_loss:o,take_profit_1:l,take_profit_2:i,take_profit_3:c,position_size:d,signal_type:m,trading_style:p,confidence:u}=s,f=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!f)return e.json({success:!1,error:"Account not found"},404);const _=new Date().toISOString().split("T")[0],h=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,_).all(),{checkDailyLossLimit:g}=await Promise.resolve().then(()=>wt),y=g(f,h.results);if(y.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${y.current_loss_pct}% (max ${f.max_daily_loss_pct}%)`},400);const w=d*r,E=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(n,a||null,m,p,r,d,w,o,l,i,c,u).run();return e.json({success:!0,trade_id:E.meta.last_row_id,message:"Trade executed successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});P.post("/api/trading/close/:trade_id",async e=>{const{DB:t}=e.env,s=e.req.param("trade_id");try{const n=await e.req.json(),{exit_price:a,exit_reason:r}=n,o=await t.prepare(`
      SELECT * FROM trades WHERE id = ?
    `).bind(s).first();if(!o)return e.json({success:!1,error:"Trade not found"},404);if(o.status==="CLOSED")return e.json({success:!1,error:"Trade already closed"},400);const{calculateProfitLoss:l}=await Promise.resolve().then(()=>wt),i=l(o.entry_price,a,o.position_size,o.trade_type,o.commission||0);return await t.prepare(`
      UPDATE trades 
      SET exit_price = ?,
    ...
    `).bind(a,r,i.profit_loss,i.profit_loss_pct,i.pips,s).run(),await t.prepare(`
      ...
      SET current_balance = current_balance + ?,
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(i.profit_loss,o.account_id).run(),e.json({success:!0,profit_loss:i.profit_loss,profit_loss_pct:i.profit_loss_pct,pips:i.pips})}catch(n){return e.json({success:!1,error:n.message},500)}});P.get("/api/trading/trades/open",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1";try{const n=await t.prepare(`
      SELECT * FROM trades 
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>wt),r=a(n.results);return e.json({success:!0,stats:r})}catch(n){return e.json({success:!1,error:n.message},500)}});P.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    `).bind(n.timeframe||"1h").all();if(!a.results||a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=a.results)==null?void 0:s.length)||0}`},400);const r=await t.prepare(`
      ...
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:o,formatBacktestResults:l}=await Promise.resolve().then(()=>Ur),i=await o(a.results,{start_date:n.start_date||"2024-01-01",end_date:n.end_date||new Date().toISOString().split("T")[0],starting_balance:n.starting_balance||1e4,min_confidence:n.min_confidence||75,use_mtf_confirmation:n.use_mtf_confirmation!==!1,use_news_filter:n.use_news_filter!==!1,timeframe:n.timeframe||"1h",commission_per_trade:n.commission_per_trade||0},r.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
    ...
    `).first(),o=!n&&(r==null?void 0:r.count)>0;let l=0;if(o)l=0,a.steps[0].cached=!0;else{a.steps[0].name="Fetching Fresh MTF Data (5 timeframes × 100 candles)",a.steps[0].fetching=!0;const j=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),M=(j==null?void 0:j.setting_value)||"70140f57bea54c5e90768de696487d8f",L=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];for(const G of L)try{const le=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${G.interval}&apikey=${M}&outputsize=100`,k=new AbortController,z=setTimeout(()=>k.abort(),1e4),Q=await fetch(le,{signal:k.signal});clearTimeout(z);const te=await Q.json();if(te.values&&Array.isArray(te.values)){const re=[];for(const $ of te.values)re.push({timestamp:$.datetime,open:parseFloat($.open)||0,high:parseFloat($.high)||0,low:parseFloat($.low)||0,close:parseFloat($.close)||0,volume:0});for(const $ of re)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind($.timestamp,$.open,$.high,$.low,$.close,$.volume,G.dbKey).run();if(re.length>=50){const $=be(re.reverse());$&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(p==null?void 0:p.close)||0,f=i(m,u),_=m["1h"],h=ae(u,_,"day_trade"),g=ae(u,_,"swing_trade"),y=c(h.signal_type,f),w=c(g.signal_type,f),E={...h,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:f.score,alignment_type:f.type},S={...g,final_confidence:Math.min(95,w.confidence),isValid:w.isValid,mtf_reason:w.reason,alignment_score:f.score,alignment_type:f.type};a.steps[1].status="completed",a.steps[1].data={dayTrade:E,swingTrade:S,alignment:f},a.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const v=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),R=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:A}=await Promise.resolve().then(()=>wt),I=A(v,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},R.results),x=A(v,{entry_price:S.price,stop_loss:S.stop_loss,take_profit_1:S.take_profit_1,take_profit_2:S.take_profit_2,take_profit_3:S.take_profit_3,confidence:S.final_confidence,signal_type:S.signal_type,trading_style:S.trading_style},R.results);a.steps[2].status="completed",a.steps[2].data={dayPosition:I,swingPosition:x},a.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const D=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),N={};for(const j of D.results||[])N[j.setting_key]=j.setting_value;let B=!1;if(N.telegram_bot_token&&N.telegram_chat_id){const j=await t.prepare(`
        SELECT high, low FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 20
      `).all();let M=[],L=[];if(j.results&&j.results.length>=20){const k=j.results.map(Q=>Q.high).sort((Q,te)=>te-Q),z=j.results.map(Q=>Q.low).sort((Q,te)=>Q-te);M=k.slice(0,3),L=z.slice(0,3)}const G=`
...
🔴 *Resistance:* ${M.map(k=>`$${k.toFixed(2)}`).join(", ")}
🟢 *Support:* ${L.map(k=>`$${k.toFixed(2)}`).join(", ")}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();B=await q({botToken:N.telegram_bot_token,chatId:N.telegram_chat_id},G)}if(a.steps[3].status=B?"completed":"failed",a.steps[3].data={telegramSent:B},E.isValid||S.isValid)for(const j of[E,S])j.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
