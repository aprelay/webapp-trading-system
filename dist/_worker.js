var Ss=Object.defineProperty;var Lt=e=>{throw TypeError(e)};var ks=(e,t,s)=>t in e?Ss(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var I=(e,t,s)=>ks(e,typeof t!="symbol"?t+"":t,s),vt=(e,t,s)=>t.has(e)||Lt("Cannot "+s);var _=(e,t,s)=>(vt(e,t,"read from private field"),s?s.call(e):t.get(e)),P=(e,t,s)=>t.has(e)?Lt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),D=(e,t,s,a)=>(vt(e,t,"write to private field"),a?a.call(e,s):t.set(e,s),s),W=(e,t,s)=>(vt(e,t,"access private method"),s);var $t=(e,t,s,a)=>({set _(n){D(e,t,n,s)},get _(){return _(e,t,a)}});var Mt=(e,t,s)=>(a,n)=>{let i=-1;return o(0);async function o(l){if(l<=i)throw new Error("next() called multiple times");i=l;let r,c=!1,d;if(e[l]?(d=e[l][0][0],a.req.routeIndex=l):d=l===e.length&&n||void 0,d)try{r=await d(a,()=>o(l+1))}catch(p){if(p instanceof Error&&t)a.error=p,r=await t(p,a),c=!0;else throw p}else a.finalized===!1&&s&&(r=await s(a));return r&&(a.finalized===!1||c)&&(a.res=r),a}},Ts=Symbol(),Rs=async(e,t=Object.create(null))=>{const{all:s=!1,dot:a=!1}=t,i=(e instanceof Kt?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?Fs(e,{all:s,dot:a}):{}};async function Fs(e,t){const s=await e.formData();return s?Ds(s,t):{}}function Ds(e,t){const s=Object.create(null);return e.forEach((a,n)=>{t.all||n.endsWith("[]")?Is(s,n,a):s[n]=a}),t.dot&&Object.entries(s).forEach(([a,n])=>{a.includes(".")&&(Ls(s,a,n),delete s[a])}),s}var Is=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},Ls=(e,t,s)=>{let a=e;const n=t.split(".");n.forEach((i,o)=>{o===n.length-1?a[i]=s:((!a[i]||typeof a[i]!="object"||Array.isArray(a[i])||a[i]instanceof File)&&(a[i]=Object.create(null)),a=a[i])})},Vt=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},$s=e=>{const{groups:t,path:s}=Ms(e),a=Vt(s);return As(a,t)},Ms=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,a)=>{const n=`@${a}`;return t.push([n,s]),n}),{groups:t,path:e}},As=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[a]=t[s];for(let n=e.length-1;n>=0;n--)if(e[n].includes(a)){e[n]=e[n].replace(a,t[s][1]);break}}return e},lt={},Os=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const a=`${e}#${t}`;return lt[a]||(s[2]?lt[a]=t&&t[0]!==":"&&t[0]!=="*"?[a,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:lt[a]=[e,s[1],!0]),lt[a]}return null},Ft=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},Cs=e=>Ft(e,decodeURI),zt=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let a=s;for(;a<t.length;a++){const n=t.charCodeAt(a);if(n===37){const i=t.indexOf("?",a),o=t.slice(s,i===-1?void 0:i);return Cs(o.includes("%25")?o.replace(/%25/g,"%2525"):o)}else if(n===63)break}return t.slice(s,a)},Ps=e=>{const t=zt(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},He=(e,t,...s)=>(s.length&&(t=He(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),Yt=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let a="";return t.forEach(n=>{if(n!==""&&!/\:/.test(n))a+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){s.length===0&&a===""?s.push("/"):s.push(a);const i=n.replace("?","");a+="/"+i,s.push(a)}else a+="/"+n}),s.filter((n,i,o)=>o.indexOf(n)===i)},wt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ft(e,Gt):e):e,qt=(e,t,s)=>{let a;if(!s&&t&&!/[%+]/.test(t)){let o=e.indexOf("?",8);if(o===-1)return;for(e.startsWith(t,o+1)||(o=e.indexOf(`&${t}`,o+1));o!==-1;){const l=e.charCodeAt(o+t.length+1);if(l===61){const r=o+t.length+2,c=e.indexOf("&",r);return wt(e.slice(r,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";o=e.indexOf(`&${t}`,o+1)}if(a=/[%+]/.test(e),!a)return}const n={};a??(a=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const o=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>o&&o!==-1&&(l=-1);let r=e.slice(i+1,l===-1?o===-1?void 0:o:l);if(a&&(r=wt(r)),i=o,r==="")continue;let c;l===-1?c="":(c=e.slice(l+1,o===-1?void 0:o),a&&(c=wt(c))),s?(n[r]&&Array.isArray(n[r])||(n[r]=[]),n[r].push(c)):n[r]??(n[r]=c)}return t?n[t]:n},Ns=qt,Hs=(e,t)=>qt(e,t,!0),Gt=decodeURIComponent,At=e=>Ft(e,Gt),Ue,ie,he,Xt,Qt,kt,be,Nt,Kt=(Nt=class{constructor(e,t="/",s=[[]]){P(this,he);I(this,"raw");P(this,Ue);P(this,ie);I(this,"routeIndex",0);I(this,"path");I(this,"bodyCache",{});P(this,be,e=>{const{bodyCache:t,raw:s}=this,a=t[e];if(a)return a;const n=Object.keys(t)[0];return n?t[n].then(i=>(n==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,D(this,ie,s),D(this,Ue,{})}param(e){return e?W(this,he,Xt).call(this,e):W(this,he,Qt).call(this)}query(e){return Ns(this.url,e)}queries(e){return Hs(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,a)=>{t[a]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await Rs(this,e))}json(){return _(this,be).call(this,"text").then(e=>JSON.parse(e))}text(){return _(this,be).call(this,"text")}arrayBuffer(){return _(this,be).call(this,"arrayBuffer")}blob(){return _(this,be).call(this,"blob")}formData(){return _(this,be).call(this,"formData")}addValidatedData(e,t){_(this,Ue)[e]=t}valid(e){return _(this,Ue)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[Ts](){return _(this,ie)}get matchedRoutes(){return _(this,ie)[0].map(([[,e]])=>e)}get routePath(){return _(this,ie)[0].map(([[,e]])=>e)[this.routeIndex].path}},Ue=new WeakMap,ie=new WeakMap,he=new WeakSet,Xt=function(e){const t=_(this,ie)[0][this.routeIndex][1][e],s=W(this,he,kt).call(this,t);return s&&/\%/.test(s)?At(s):s},Qt=function(){const e={},t=Object.keys(_(this,ie)[0][this.routeIndex][1]);for(const s of t){const a=W(this,he,kt).call(this,_(this,ie)[0][this.routeIndex][1][s]);a!==void 0&&(e[s]=/\%/.test(a)?At(a):a)}return e},kt=function(e){return _(this,ie)[1]?_(this,ie)[1][e]:e},be=new WeakMap,Nt),js={Stringify:1},Zt=async(e,t,s,a,n)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(n?n[0]+=e:n=[e],Promise.all(i.map(l=>l({phase:t,buffer:n,context:a}))).then(l=>Promise.all(l.filter(Boolean).map(r=>Zt(r,t,!1,a,n))).then(()=>n[0]))):Promise.resolve(e)},Bs="text/plain; charset=UTF-8",xt=(e,t)=>({"Content-Type":e,...t}),tt,st,pe,We,me,te,at,Ve,ze,Ie,nt,it,ve,je,Ht,Us=(Ht=class{constructor(e,t){P(this,ve);P(this,tt);P(this,st);I(this,"env",{});P(this,pe);I(this,"finalized",!1);I(this,"error");P(this,We);P(this,me);P(this,te);P(this,at);P(this,Ve);P(this,ze);P(this,Ie);P(this,nt);P(this,it);I(this,"render",(...e)=>(_(this,Ve)??D(this,Ve,t=>this.html(t)),_(this,Ve).call(this,...e)));I(this,"setLayout",e=>D(this,at,e));I(this,"getLayout",()=>_(this,at));I(this,"setRenderer",e=>{D(this,Ve,e)});I(this,"header",(e,t,s)=>{this.finalized&&D(this,te,new Response(_(this,te).body,_(this,te)));const a=_(this,te)?_(this,te).headers:_(this,Ie)??D(this,Ie,new Headers);t===void 0?a.delete(e):s!=null&&s.append?a.append(e,t):a.set(e,t)});I(this,"status",e=>{D(this,We,e)});I(this,"set",(e,t)=>{_(this,pe)??D(this,pe,new Map),_(this,pe).set(e,t)});I(this,"get",e=>_(this,pe)?_(this,pe).get(e):void 0);I(this,"newResponse",(...e)=>W(this,ve,je).call(this,...e));I(this,"body",(e,t,s)=>W(this,ve,je).call(this,e,t,s));I(this,"text",(e,t,s)=>!_(this,Ie)&&!_(this,We)&&!t&&!s&&!this.finalized?new Response(e):W(this,ve,je).call(this,e,t,xt(Bs,s)));I(this,"json",(e,t,s)=>W(this,ve,je).call(this,JSON.stringify(e),t,xt("application/json",s)));I(this,"html",(e,t,s)=>{const a=n=>W(this,ve,je).call(this,n,t,xt("text/html; charset=UTF-8",s));return typeof e=="object"?Zt(e,js.Stringify,!1,{}).then(a):a(e)});I(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});I(this,"notFound",()=>(_(this,ze)??D(this,ze,()=>new Response),_(this,ze).call(this,this)));D(this,tt,e),t&&(D(this,me,t.executionCtx),this.env=t.env,D(this,ze,t.notFoundHandler),D(this,it,t.path),D(this,nt,t.matchResult))}get req(){return _(this,st)??D(this,st,new Kt(_(this,tt),_(this,it),_(this,nt))),_(this,st)}get event(){if(_(this,me)&&"respondWith"in _(this,me))return _(this,me);throw Error("This context has no FetchEvent")}get executionCtx(){if(_(this,me))return _(this,me);throw Error("This context has no ExecutionContext")}get res(){return _(this,te)||D(this,te,new Response(null,{headers:_(this,Ie)??D(this,Ie,new Headers)}))}set res(e){if(_(this,te)&&e){e=new Response(e.body,e);for(const[t,s]of _(this,te).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const a=_(this,te).headers.getSetCookie();e.headers.delete("set-cookie");for(const n of a)e.headers.append("set-cookie",n)}else e.headers.set(t,s)}D(this,te,e),this.finalized=!0}get var(){return _(this,pe)?Object.fromEntries(_(this,pe)):{}}},tt=new WeakMap,st=new WeakMap,pe=new WeakMap,We=new WeakMap,me=new WeakMap,te=new WeakMap,at=new WeakMap,Ve=new WeakMap,ze=new WeakMap,Ie=new WeakMap,nt=new WeakMap,it=new WeakMap,ve=new WeakSet,je=function(e,t,s){const a=_(this,te)?new Headers(_(this,te).headers):_(this,Ie)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[o,l]of i)o.toLowerCase()==="set-cookie"?a.append(o,l):a.set(o,l)}if(s)for(const[i,o]of Object.entries(s))if(typeof o=="string")a.set(i,o);else{a.delete(i);for(const l of o)a.append(i,l)}const n=typeof t=="number"?t:(t==null?void 0:t.status)??_(this,We);return new Response(e,{status:n,headers:a})},Ht),K="ALL",Ws="all",Vs=["get","post","put","delete","options","patch"],Jt="Can not add a route since the matcher is already built.",es=class extends Error{},zs="__COMPOSED_HANDLER",Ys=e=>e.text("404 Not Found",404),Ot=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},re,X,ts,oe,Re,ct,dt,Ye,qs=(Ye=class{constructor(t={}){P(this,X);I(this,"get");I(this,"post");I(this,"put");I(this,"delete");I(this,"options");I(this,"patch");I(this,"all");I(this,"on");I(this,"use");I(this,"router");I(this,"getPath");I(this,"_basePath","/");P(this,re,"/");I(this,"routes",[]);P(this,oe,Ys);I(this,"errorHandler",Ot);I(this,"onError",t=>(this.errorHandler=t,this));I(this,"notFound",t=>(D(this,oe,t),this));I(this,"fetch",(t,...s)=>W(this,X,dt).call(this,t,s[1],s[0],t.method));I(this,"request",(t,s,a,n)=>t instanceof Request?this.fetch(s?new Request(t,s):t,a,n):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${He("/",t)}`,s),a,n)));I(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(W(this,X,dt).call(this,t.request,t,void 0,t.request.method))})});[...Vs,Ws].forEach(i=>{this[i]=(o,...l)=>(typeof o=="string"?D(this,re,o):W(this,X,Re).call(this,i,_(this,re),o),l.forEach(r=>{W(this,X,Re).call(this,i,_(this,re),r)}),this)}),this.on=(i,o,...l)=>{for(const r of[o].flat()){D(this,re,r);for(const c of[i].flat())l.map(d=>{W(this,X,Re).call(this,c.toUpperCase(),_(this,re),d)})}return this},this.use=(i,...o)=>(typeof i=="string"?D(this,re,i):(D(this,re,"*"),o.unshift(i)),o.forEach(l=>{W(this,X,Re).call(this,K,_(this,re),l)}),this);const{strict:a,...n}=t;Object.assign(this,n),this.getPath=a??!0?t.getPath??zt:Ps}route(t,s){const a=this.basePath(t);return s.routes.map(n=>{var o;let i;s.errorHandler===Ot?i=n.handler:(i=async(l,r)=>(await Mt([],s.errorHandler)(l,()=>n.handler(l,r))).res,i[zs]=n.handler),W(o=a,X,Re).call(o,n.method,n.path,i)}),this}basePath(t){const s=W(this,X,ts).call(this);return s._basePath=He(this._basePath,t),s}mount(t,s,a){let n,i;a&&(typeof a=="function"?i=a:(i=a.optionHandler,a.replaceRequest===!1?n=r=>r:n=a.replaceRequest));const o=i?r=>{const c=i(r);return Array.isArray(c)?c:[c]}:r=>{let c;try{c=r.executionCtx}catch{}return[r.env,c]};n||(n=(()=>{const r=He(this._basePath,t),c=r==="/"?0:r.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const l=async(r,c)=>{const d=await s(n(r.req.raw),...o(r));if(d)return d;await c()};return W(this,X,Re).call(this,K,He(t,"*"),l),this}},re=new WeakMap,X=new WeakSet,ts=function(){const t=new Ye({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,D(t,oe,_(this,oe)),t.routes=this.routes,t},oe=new WeakMap,Re=function(t,s,a){t=t.toUpperCase(),s=He(this._basePath,s);const n={basePath:this._basePath,path:s,method:t,handler:a};this.router.add(t,s,[a,n]),this.routes.push(n)},ct=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},dt=function(t,s,a,n){if(n==="HEAD")return(async()=>new Response(null,await W(this,X,dt).call(this,t,s,a,"GET")))();const i=this.getPath(t,{env:a}),o=this.router.match(n,i),l=new Us(t,{path:i,matchResult:o,env:a,executionCtx:s,notFoundHandler:_(this,oe)});if(o[0].length===1){let c;try{c=o[0][0][0][0](l,async()=>{l.res=await _(this,oe).call(this,l)})}catch(d){return W(this,X,ct).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:_(this,oe).call(this,l))).catch(d=>W(this,X,ct).call(this,d,l)):c??_(this,oe).call(this,l)}const r=Mt(o[0],this.errorHandler,_(this,oe));return(async()=>{try{const c=await r(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return W(this,X,ct).call(this,c,l)}})()},Ye),ss=[];function Gs(e,t){const s=this.buildAllMatchers(),a=((n,i)=>{const o=s[n]||s[K],l=o[2][i];if(l)return l;const r=i.match(o[0]);if(!r)return[[],ss];const c=r.indexOf("",1);return[o[1][c],r]});return this.match=a,a(e,t)}var pt="[^/]+",Ze=".*",Je="(?:|/.*)",Be=Symbol(),Ks=new Set(".\\+*[^]$()");function Xs(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===Ze||e===Je?1:t===Ze||t===Je?-1:e===pt?1:t===pt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Le,$e,le,Oe,Qs=(Oe=class{constructor(){P(this,Le);P(this,$e);P(this,le,Object.create(null))}insert(t,s,a,n,i){if(t.length===0){if(_(this,Le)!==void 0)throw Be;if(i)return;D(this,Le,s);return}const[o,...l]=t,r=o==="*"?l.length===0?["","",Ze]:["","",pt]:o==="/*"?["","",Je]:o.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(r){const d=r[1];let p=r[2]||pt;if(d&&r[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw Be;if(c=_(this,le)[p],!c){if(Object.keys(_(this,le)).some(u=>u!==Ze&&u!==Je))throw Be;if(i)return;c=_(this,le)[p]=new Oe,d!==""&&D(c,$e,n.varIndex++)}!i&&d!==""&&a.push([d,_(c,$e)])}else if(c=_(this,le)[o],!c){if(Object.keys(_(this,le)).some(d=>d.length>1&&d!==Ze&&d!==Je))throw Be;if(i)return;c=_(this,le)[o]=new Oe}c.insert(l,s,a,n,i)}buildRegExpStr(){const s=Object.keys(_(this,le)).sort(Xs).map(a=>{const n=_(this,le)[a];return(typeof _(n,$e)=="number"?`(${a})@${_(n,$e)}`:Ks.has(a)?`\\${a}`:a)+n.buildRegExpStr()});return typeof _(this,Le)=="number"&&s.unshift(`#${_(this,Le)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Le=new WeakMap,$e=new WeakMap,le=new WeakMap,Oe),_t,rt,jt,Zs=(jt=class{constructor(){P(this,_t,{varIndex:0});P(this,rt,new Qs)}insert(e,t,s){const a=[],n=[];for(let o=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,r=>{const c=`@\\${o}`;return n[o]=[c,r],o++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let o=n.length-1;o>=0;o--){const[l]=n[o];for(let r=i.length-1;r>=0;r--)if(i[r].indexOf(l)!==-1){i[r]=i[r].replace(l,n[o][1]);break}}return _(this,rt).insert(i,t,a,_(this,_t),s),a}buildRegExp(){let e=_(this,rt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],a=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,i,o)=>i!==void 0?(s[++t]=Number(i),"$()"):(o!==void 0&&(a[Number(o)]=++t),"")),[new RegExp(`^${e}`),s,a]}},_t=new WeakMap,rt=new WeakMap,jt),Js=[/^$/,[],Object.create(null)],ut=Object.create(null);function as(e){return ut[e]??(ut[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function ea(){ut=Object.create(null)}function ta(e){var c;const t=new Zs,s=[];if(e.length===0)return Js;const a=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[u,m])=>d?1:u?-1:p.length-m.length),n=Object.create(null);for(let d=0,p=-1,u=a.length;d<u;d++){const[m,g,f]=a[d];m?n[g]=[f.map(([y])=>[y,Object.create(null)]),ss]:p++;let h;try{h=t.insert(g,p,m)}catch(y){throw y===Be?new es(g):y}m||(s[p]=f.map(([y,E])=>{const v=Object.create(null);for(E-=1;E>=0;E--){const[w,j]=h[E];v[w]=j}return[y,v]}))}const[i,o,l]=t.buildRegExp();for(let d=0,p=s.length;d<p;d++)for(let u=0,m=s[d].length;u<m;u++){const g=(c=s[d][u])==null?void 0:c[1];if(!g)continue;const f=Object.keys(g);for(let h=0,y=f.length;h<y;h++)g[f[h]]=l[g[f[h]]]}const r=[];for(const d in o)r[d]=s[o[d]];return[i,r,n]}function Ne(e,t){if(e){for(const s of Object.keys(e).sort((a,n)=>n.length-a.length))if(as(s).test(t))return[...e[s]]}}var we,xe,ft,ns,Bt,sa=(Bt=class{constructor(){P(this,ft);I(this,"name","RegExpRouter");P(this,we);P(this,xe);I(this,"match",Gs);D(this,we,{[K]:Object.create(null)}),D(this,xe,{[K]:Object.create(null)})}add(e,t,s){var l;const a=_(this,we),n=_(this,xe);if(!a||!n)throw new Error(Jt);a[e]||[a,n].forEach(r=>{r[e]=Object.create(null),Object.keys(r[K]).forEach(c=>{r[e][c]=[...r[K][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const r=as(t);e===K?Object.keys(a).forEach(c=>{var d;(d=a[c])[t]||(d[t]=Ne(a[c],t)||Ne(a[K],t)||[])}):(l=a[e])[t]||(l[t]=Ne(a[e],t)||Ne(a[K],t)||[]),Object.keys(a).forEach(c=>{(e===K||e===c)&&Object.keys(a[c]).forEach(d=>{r.test(d)&&a[c][d].push([s,i])})}),Object.keys(n).forEach(c=>{(e===K||e===c)&&Object.keys(n[c]).forEach(d=>r.test(d)&&n[c][d].push([s,i]))});return}const o=Yt(t)||[t];for(let r=0,c=o.length;r<c;r++){const d=o[r];Object.keys(n).forEach(p=>{var u;(e===K||e===p)&&((u=n[p])[d]||(u[d]=[...Ne(a[p],d)||Ne(a[K],d)||[]]),n[p][d].push([s,i-c+r+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(_(this,xe)).concat(Object.keys(_(this,we))).forEach(t=>{e[t]||(e[t]=W(this,ft,ns).call(this,t))}),D(this,we,D(this,xe,void 0)),ea(),e}},we=new WeakMap,xe=new WeakMap,ft=new WeakSet,ns=function(e){const t=[];let s=e===K;return[_(this,we),_(this,xe)].forEach(a=>{const n=a[e]?Object.keys(a[e]).map(i=>[i,a[e][i]]):[];n.length!==0?(s||(s=!0),t.push(...n)):e!==K&&t.push(...Object.keys(a[K]).map(i=>[i,a[K][i]]))}),s?ta(t):null},Bt),Ee,_e,Ut,aa=(Ut=class{constructor(e){I(this,"name","SmartRouter");P(this,Ee,[]);P(this,_e,[]);D(this,Ee,e.routers)}add(e,t,s){if(!_(this,_e))throw new Error(Jt);_(this,_e).push([e,t,s])}match(e,t){if(!_(this,_e))throw new Error("Fatal error");const s=_(this,Ee),a=_(this,_e),n=s.length;let i=0,o;for(;i<n;i++){const l=s[i];try{for(let r=0,c=a.length;r<c;r++)l.add(...a[r]);o=l.match(e,t)}catch(r){if(r instanceof es)continue;throw r}this.match=l.match.bind(l),D(this,Ee,[l]),D(this,_e,void 0);break}if(i===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,o}get activeRouter(){if(_(this,_e)||_(this,Ee).length!==1)throw new Error("No active router has been determined yet.");return _(this,Ee)[0]}},Ee=new WeakMap,_e=new WeakMap,Ut),Qe=Object.create(null),Se,ee,Me,qe,Q,fe,Fe,Ge,na=(Ge=class{constructor(t,s,a){P(this,fe);P(this,Se);P(this,ee);P(this,Me);P(this,qe,0);P(this,Q,Qe);if(D(this,ee,a||Object.create(null)),D(this,Se,[]),t&&s){const n=Object.create(null);n[t]={handler:s,possibleKeys:[],score:0},D(this,Se,[n])}D(this,Me,[])}insert(t,s,a){D(this,qe,++$t(this,qe)._);let n=this;const i=$s(s),o=[];for(let l=0,r=i.length;l<r;l++){const c=i[l],d=i[l+1],p=Os(c,d),u=Array.isArray(p)?p[0]:c;if(u in _(n,ee)){n=_(n,ee)[u],p&&o.push(p[1]);continue}_(n,ee)[u]=new Ge,p&&(_(n,Me).push(p),o.push(p[1])),n=_(n,ee)[u]}return _(n,Se).push({[t]:{handler:a,possibleKeys:o.filter((l,r,c)=>c.indexOf(l)===r),score:_(this,qe)}}),n}search(t,s){var r;const a=[];D(this,Q,Qe);let i=[this];const o=Vt(s),l=[];for(let c=0,d=o.length;c<d;c++){const p=o[c],u=c===d-1,m=[];for(let g=0,f=i.length;g<f;g++){const h=i[g],y=_(h,ee)[p];y&&(D(y,Q,_(h,Q)),u?(_(y,ee)["*"]&&a.push(...W(this,fe,Fe).call(this,_(y,ee)["*"],t,_(h,Q))),a.push(...W(this,fe,Fe).call(this,y,t,_(h,Q)))):m.push(y));for(let E=0,v=_(h,Me).length;E<v;E++){const w=_(h,Me)[E],j=_(h,Q)===Qe?{}:{..._(h,Q)};if(w==="*"){const T=_(h,ee)["*"];T&&(a.push(...W(this,fe,Fe).call(this,T,t,_(h,Q))),D(T,Q,j),m.push(T));continue}const[x,C,H]=w;if(!p&&!(H instanceof RegExp))continue;const M=_(h,ee)[x],S=o.slice(c).join("/");if(H instanceof RegExp){const T=H.exec(S);if(T){if(j[C]=T[0],a.push(...W(this,fe,Fe).call(this,M,t,_(h,Q),j)),Object.keys(_(M,ee)).length){D(M,Q,j);const R=((r=T[0].match(/\//))==null?void 0:r.length)??0;(l[R]||(l[R]=[])).push(M)}continue}}(H===!0||H.test(p))&&(j[C]=p,u?(a.push(...W(this,fe,Fe).call(this,M,t,j,_(h,Q))),_(M,ee)["*"]&&a.push(...W(this,fe,Fe).call(this,_(M,ee)["*"],t,j,_(h,Q)))):(D(M,Q,j),m.push(M)))}}i=m.concat(l.shift()??[])}return a.length>1&&a.sort((c,d)=>c.score-d.score),[a.map(({handler:c,params:d})=>[c,d])]}},Se=new WeakMap,ee=new WeakMap,Me=new WeakMap,qe=new WeakMap,Q=new WeakMap,fe=new WeakSet,Fe=function(t,s,a,n){const i=[];for(let o=0,l=_(t,Se).length;o<l;o++){const r=_(t,Se)[o],c=r[s]||r[K],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),a!==Qe||n&&n!==Qe))for(let p=0,u=c.possibleKeys.length;p<u;p++){const m=c.possibleKeys[p],g=d[c.score];c.params[m]=n!=null&&n[m]&&!g?n[m]:a[m]??(n==null?void 0:n[m]),d[c.score]=!0}}return i},Ge),Ae,Wt,ia=(Wt=class{constructor(){I(this,"name","TrieRouter");P(this,Ae);D(this,Ae,new na)}add(e,t,s){const a=Yt(t);if(a){for(let n=0,i=a.length;n<i;n++)_(this,Ae).insert(e,a[n],s);return}_(this,Ae).insert(e,t,s)}match(e,t){return _(this,Ae).search(e,t)}},Ae=new WeakMap,Wt),ke=class extends qs{constructor(e={}){super(e),this.router=e.router??new aa({routers:[new sa,new ia]})}},ra=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},a=(i=>typeof i=="string"?i==="*"?()=>i:o=>i===o?o:null:typeof i=="function"?i:o=>i.includes(o)?o:null)(s.origin),n=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(o,l){var d;function r(p,u){o.res.headers.set(p,u)}const c=await a(o.req.header("origin")||"",o);if(c&&r("Access-Control-Allow-Origin",c),s.credentials&&r("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&r("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),o.req.method==="OPTIONS"){s.origin!=="*"&&r("Vary","Origin"),s.maxAge!=null&&r("Access-Control-Max-Age",s.maxAge.toString());const p=await n(o.req.header("origin")||"",o);p.length&&r("Access-Control-Allow-Methods",p.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const m=o.req.header("Access-Control-Request-Headers");m&&(u=m.split(/\s*,\s*/))}return u!=null&&u.length&&(r("Access-Control-Allow-Headers",u.join(",")),o.res.headers.append("Vary","Access-Control-Request-Headers")),o.res.headers.delete("Content-Length"),o.res.headers.delete("Content-Type"),new Response(null,{headers:o.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&o.header("Vary","Origin",{append:!0})}};function De(e,t){return e.length<t?0:e.slice(-t).reduce((a,n)=>a+n,0)/t}function mt(e,t){if(e.length<t)return 0;const s=2/(t+1);let a=De(e.slice(0,t),t);for(let n=t;n<e.length;n++)a=(e[n]-a)*s+a;return a}function oa(e,t=14){if(e.length<t+1)return 50;const s=[];for(let r=1;r<e.length;r++)s.push(e[r]-e[r-1]);let a=0,n=0;for(let r=0;r<t;r++)s[r]>0?a+=s[r]:n+=Math.abs(s[r]);let i=a/t,o=n/t;for(let r=t;r<s.length;r++){const c=s[r];i=(i*(t-1)+(c>0?c:0))/t,o=(o*(t-1)+(c<0?Math.abs(c):0))/t}return o===0?100:100-100/(1+i/o)}function la(e){const t=mt(e,12),s=mt(e,26),a=t-s,n=a*.9,i=a-n;return{macd:a,signal:n,histogram:i}}function ca(e,t=20,s=2){const a=De(e,t),i=e.slice(-t).reduce((l,r)=>l+Math.pow(r-a,2),0)/t,o=Math.sqrt(i);return{upper:a+o*s,middle:a,lower:a-o*s}}function da(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const o=e[i].high,l=e[i].low,r=e[i-1].close,c=Math.max(o-l,Math.abs(o-r),Math.abs(l-r));s.push(c)}const a=De(s,t);return Math.max(a,10)}function ua(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const a=e.slice(-t),n=a.map(p=>p.high),i=a.map(p=>p.low),o=e[e.length-1].close,l=Math.max(...n),r=Math.min(...i),c=(o-r)/(l-r)*100;return{k:c,d:c}}function pa(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,a=0,n=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,p=e[c].low,u=e[c-1].high,m=e[c-1].low,g=e[c-1].close,f=d-u,h=m-p;f>h&&f>0&&(s+=f),h>f&&h>0&&(a+=h),n+=Math.max(d-p,Math.abs(d-g),Math.abs(p-g))}const i=n>0?s/n*100:0,o=n>0?a/n*100:0;return{adx:i+o>0?Math.abs(i-o)/(i+o)*100:0,plusDI:i,minusDI:o}}function ma(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),a=Math.max(...s.map(y=>y.high)),n=Math.min(...s.map(y=>y.low)),i=(a+n)/2,o=Math.min(26,e.length),l=e.slice(-o),r=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(r+c)/2,p=(i+d)/2,u=Math.min(52,e.length),m=e.slice(-u),g=Math.max(...m.map(y=>y.high)),f=Math.min(...m.map(y=>y.low)),h=(g+f)/2;return{tenkan:i,kijun:d,senkouA:p,senkouB:h}}function _a(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const a=e[e.length-1],n=e[e.length-2];return a.close>n.close?a.low*.98:a.high*1.02}function fa(e){if(e.length===0)return 0;let t=0,s=0;for(const a of e){const n=(a.high+a.low+a.close)/3,i=a.volume||1;t+=n*i,s+=i}return s>0?t/s:e[e.length-1].close}function ga(e,t=50){const s=e.slice(-Math.min(t,e.length)),a=s.map(r=>r.high),n=s.map(r=>r.low),i=Math.max(...a),o=Math.min(...n),l=i-o;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:o}}function ge(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=la(t),a=ca(t),n=ua(e,14,3),i=pa(e,14),o=ma(e),l=_a(e),r=fa(e),c=ga(e,50);return{rsi_14:oa(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:De(t,20),sma_50:De(t,50),sma_200:e.length>=200?De(t,200):De(t,Math.min(100,e.length)),ema_12:mt(t,12),ema_26:mt(t,26),bb_upper:a.upper,bb_middle:a.middle,bb_lower:a.lower,atr_14:da(e,14),stochastic_k:n.k,stochastic_d:n.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:o.tenkan,ichimoku_kijun:o.kijun,ichimoku_senkou_a:o.senkouA,ichimoku_senkou_b:o.senkouB,parabolic_sar:l,vwap:r,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function se(e,t,s){const a=[];let n=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(a.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?n+=2:i+=2),t.stochastic_k<20?(a.push("Stochastic oversold (<20)"),n+=2):t.stochastic_k<30?(a.push("Stochastic approaching oversold"),n+=1):t.stochastic_k>80?(a.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(a.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(a.push("Stochastic bullish crossover"),n+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(a.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(a.push("Price above Ichimoku Cloud (bullish)"),n+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(a.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(a.push("Ichimoku bullish (Tenkan > Kijun)"),n+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(a.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(a.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),n+=1):e<t.vwap&&(a.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(a.push("Near 61.8% Fibonacci support"),n+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(a.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(a.push("RSI oversold (<30)"),n+=2):t.rsi_14<40?(a.push("RSI below 40"),n+=1):t.rsi_14>70?(a.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(a.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(a.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(a.push("MACD bullish crossover"),n+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(a.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(a.push("Price above SMA20 and SMA50"),n+=1):e<t.sma_20&&e<t.sma_50&&(a.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(a.push("Uptrend (above SMA200)"),n+=1):(a.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(a.push("Price at lower Bollinger Band"),n+=2):e>=t.bb_upper&&(a.push("Price at upper Bollinger Band"),i+=2);const o=n+i,l=o>0?n/o*100:50;let r="HOLD",c=50;n>i+1?(r="BUY",c=Math.min(l,95)):i>n+1&&(r="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(n-i)>4&&(c=Math.min(c+5,95),a.push("High conviction signal"));const d=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,f=e*(1/100);let h,y,E,v;if(r==="BUY"){const w=e-t.atr_14*d;h=Math.max(w,e-f),y=e+t.atr_14*p,E=e+t.atr_14*u,v=e+t.atr_14*m}else if(r==="SELL"){const w=e+t.atr_14*d;h=Math.min(w,e+f),y=e-t.atr_14*p,E=e-t.atr_14*u,v=e-t.atr_14*m}else h=e,y=e,E=e,v=e;return{signal_type:r,trading_style:s,price:e,stop_loss:parseFloat(h.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(E.toFixed(2)),take_profit_3:parseFloat(v.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:a.join(", ")}}async function G(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{return(await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json()).ok===!0}catch(a){return console.error("Failed to send Telegram message:",a),!1}}function ha(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function et(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
`)}const rs=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:Dt,determineTrend:is,formatAlignmentReport:ya,validateMultiTimeframeSignal:Tt},Symbol.toStringTag,{value:"Module"}));function Ct(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,o)=>i-o),a=Math.floor((1-t)*s.length);return Math.abs(s[a]||0)}function ba(e,t){const s=Ct(e,.95),a=Ct(e,.99),n=t*s,i=t*a;return{var_95:parseFloat(n.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function va(e,t,s,a){const n=t-e,i=n/t*100;let o=0;for(let c=a.length-1;c>=0&&a[c].balance<t;c--)o++;const l=i<=s,r=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(n.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:r,days_in_drawdown:o}}function wa(e,t,s=5){let a=0;const n=[];for(const r of e){const d=Math.abs(r.entry_price-r.stop_loss)*r.position_size,p=d/t*100;a+=d,n.push({position_id:r.id,entry_price:r.entry_price,stop_loss:r.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=a/t*100,o=i<=s,l=t*(s/100)-a;return{total_open_positions:e.length,total_risk_amount:parseFloat(a.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:o,available_risk:parseFloat(l.toFixed(2)),positions:n}}function xa(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.high),a=[];for(let r=2;r<s.length-2;r++)s[r]>s[r-1]&&s[r]>s[r-2]&&s[r]>s[r+1]&&s[r]>s[r+2]&&a.push({index:r,value:s[r]});if(a.length<3)return null;const n=a.slice(-3),[i,o,l]=n;if(o.value>i.value&&o.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(o.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(o.value.toFixed(2)),historical_win_rate:65}}return null}function Ea(e){if(e.length<20)return null;const s=e.slice(-20).map(o=>o.close),a=s.slice(0,10),n=s.slice(10);if((a[a.length-1]-a[0])/a[0]>.02&&(Math.max(...n)-Math.min(...n))/n[0]<.015){const r=s[s.length-1],c=a[a.length-1]-a[0],d=r+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((r*.98).toFixed(2)),historical_win_rate:68}}return null}function Sa(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),a=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),o=a.slice(0,6),l=a.slice(-6),r=(Math.min(...l)-Math.min(...o))/Math.min(...o);if(i<.01&&r>.015){const c=Math.max(...s),d=t[t.length-1].close,p=c+(c-Math.min(...a));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function ka(e){if(e.length<30)return null;const s=e.slice(-30).map(r=>r.low),a=[];for(let r=2;r<s.length-2;r++)s[r]<s[r-1]&&s[r]<s[r-2]&&s[r]<s[r+1]&&s[r]<s[r+2]&&a.push({index:r,value:s[r]});if(a.length<2)return null;const n=a.slice(-2),[i,o]=n;if(Math.abs(i.value-o.value)/i.value<.015){const r=Math.max(...s.slice(i.index,o.index))*1.005,c=r+(r-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+o.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function Ta(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),a=s[0],n=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(a-i)/a<.02&&n<a*.95){const l=s.slice(25),r=Math.min(...l),c=(i-r)/i;if(c>.01&&c<.05){const d=a-n,p=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(r.toFixed(2)),historical_win_rate:61}}}return null}function Ra(e){const t=[],s=xa(e);s&&t.push(s);const a=Ea(e);a&&t.push(a);const n=Sa(e);n&&t.push(n);const i=ka(e);i&&t.push(i);const o=Ta(e);o&&t.push(o);let l=0,r=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(r++,c+=m.confidence);let d="neutral",p=0;l>r?(d="bullish",p=Math.min(c/l/10,15)):r>l&&(d="bearish",p=Math.min(c/r/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const m=t.map(g=>g.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(p.toFixed(1)),summary:u}}function Fa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function Da(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const n=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=n*10}const a=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(a*10,30),Math.min(Math.round(s),100)}function Ia(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const a=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(a>.9||a<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function La(e,t,s){const a=Fa(t.atr_14,s),n=Da(t,s),i=Ia(t,s);let o,l,r,c,d,p;const u=e.slice(-10),m=u.map(y=>y.volume||0),g=m.reduce((y,E)=>y+E,0)/m.length,h=(u[u.length-1].volume||0)>g*1.5;return a==="EXTREME"&&h?s>t.bb_upper&&t.rsi_14>60?(o="BREAKOUT",l=75,r=!0,c="Trend-following (aggressive entry)",d=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(o="BREAKDOWN",l=75,r=!1,c="Wait for stabilization",d=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(o="RANGING",l=50,r=!1,c="Wait for direction",d=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&n>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(o="STRONG_UPTREND",l=90,r=!0,c="Trend-following (buy dips, trail stops)",d=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(o="STRONG_DOWNTREND",l=90,r=!1,c="Stay in cash or short",d=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&n>40?s>t.sma_50&&t.plus_di>t.minus_di?(o="WEAK_UPTREND",l=70,r=!0,c="Trend-following (selective entries)",d=1,p="Moderate bullish trend - trade with normal position sizing"):(o="WEAK_DOWNTREND",l=70,r=!1,c="Reduce exposure or stay flat",d=.5,p="Moderate bearish trend - reduce risk or wait"):(o="RANGING",l=80,i>60?(r=!0,c="Mean-reversion (fade extremes)",d=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(r=!1,c="Wait for trend to develop",d=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:o,confidence:l,volatility:a,trend_strength:n,mean_reversion_score:i,should_trade:r,recommended_strategy:c,risk_adjustment:d,description:p}}function $a(e){const t=e.length;let s=0,a=0,n=0,i=0;for(let r=0;r<t;r++)s+=r,a+=e[r],n+=r*e[r],i+=r*r;const o=(t*n-s*a)/(t*i-s*s),l=(a-o*s)/t;return{slope:o,intercept:l}}function Ma(e,t,s){const a=e.map(l=>l.close),n=2/(t+1);let i=a[0];for(let l=1;l<a.length;l++)i=(a[l]-i)*n+i;const o=(a[a.length-1]-a[a.length-10])/10;return i+o*s}function Aa(e,t){const s=e.map(l=>l.close).slice(-20),a=[];for(let l=1;l<s.length;l++)a.push(s[l]-s[l-1]);const o=a.slice(-5).reduce((l,r)=>l+r,0)/5*t*Math.pow(.8,t);return s[s.length-1]+o}function Oa(e,t,s){const a=e[e.length-1].close;e.map(o=>o.close).slice(-20);let n=0;t.rsi_14>50?n+=t.rsi_14-50:n-=50-t.rsi_14,t.macd>t.macd_signal?n+=20:n-=20,a>t.sma_20&&(n+=10),a>t.sma_50&&(n+=10);const i=n/100*s;return a+t.atr_14*i}function Ca(e,t){const s=e.map(u=>u.close),a=s[s.length-1],n=10,i=s.slice(-n),o=Math.min(...i),l=Math.max(...i),r=i.map(u=>(u-o)/(l-o));let c={index:0,similarity:-1/0};for(let u=n;u<s.length-n-t;u++){const m=s.slice(u-n,u),g=Math.min(...m),f=Math.max(...m),h=m.map(v=>(v-g)/(f-g));let y=0;for(let v=0;v<n;v++)y+=Math.pow(r[v]-h[v],2);const E=-y;E>c.similarity&&(c={index:u,similarity:E})}const p=(s[c.index+t]-s[c.index])*(a/s[c.index]);return a+p}function Et(e,t,s){const a=[],n=[],i=e.map(x=>x.close),{slope:o,intercept:l}=$a(i.slice(-20)),r=o*(i.length-1+s)+l;a.push(r),n.push(1);const c=Ma(e,12,s);a.push(c),n.push(1.5);const d=Aa(e,s);a.push(d),n.push(1.2);const p=Oa(e,t,s);a.push(p),n.push(1.8);const u=Ca(e,s);a.push(u),n.push(1.3);const m=n.reduce((x,C)=>x+C,0),f=a.reduce((x,C,H)=>x+C*n[H],0)/m,h=a.reduce((x,C)=>x+C,0)/a.length,y=a.reduce((x,C)=>x+Math.pow(C-h,2),0)/a.length,E=Math.sqrt(y),v=e[e.length-1].close,w=1-E/v,j=Math.max(50,Math.min(95,w*100));return{prediction:f,confidence:j}}function Pa(e,t){const s=e[e.length-1].close,a=[],n=Et(e,t,1),i=n.prediction-s,o=i/s*100;a.push({timeframe:"1h",predicted_price:parseFloat(n.prediction.toFixed(2)),confidence_interval_upper:parseFloat((n.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((n.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(n.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(o.toFixed(2)),method:"Ensemble (5 models)"});const l=Et(e,t,4),r=l.prediction-s,c=r/s*100;a.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:r>2?"UP":r<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Et(e,t,24),p=d.prediction-s,u=p/s*100;a.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const m=a.filter(E=>E.direction==="UP").length,g=a.filter(E=>E.direction==="DOWN").length;let f,h=0;m>g?(f="BULLISH",h=Math.min(m*5,15)):g>m?(f="BEARISH",h=Math.min(g*5,15)):f="NEUTRAL";const y=`ML models predict ${f} movement. 1h: ${a[0].direction} (${a[0].expected_move_pct.toFixed(2)}%), 4h: ${a[1].direction} (${a[1].expected_move_pct.toFixed(2)}%), 24h: ${a[2].direction} (${a[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:a,overall_direction:f,confidence_boost:parseFloat(h.toFixed(1)),summary:y}}function St(e,t,s,a,n){const o=Math.abs(t-e)/s;let l;o<1?l=80:o<2?l=65:o<3?l=50:o<4?l=35:l=20;const r=(a-50)/10;l+=r;const c=(n-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function Na(e,t,s,a,n){const o=Math.abs(e-t)/s;let l;if(o<1?l=60:o<1.5?l=40:o<2?l=25:l=15,n==="BUY"){const r=(a-50)/10;l-=r}else{const r=(a-50)/10;l-=r}return Math.max(5,Math.min(80,l))}function Ha(e,t,s,a,n,i){const o=(s-e)*.5,l=(a-e)*.3,r=(n-e)*.2,c=t-e;return i.tp1/100*o+i.tp2/100*l+i.tp3/100*r+i.sl/100*c}function ja(e,t,s){const a=e.price,n=t.atr_14;let i=50;e.signal_type==="BUY"?(a>t.sma_20&&(i+=10),a>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(a<t.sma_20&&(i+=10),a<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const o=s.slice(-50),l=[];for(let v=14;v<o.length;v++){const w=o.slice(v-14,v);let j=0;for(let x=1;x<w.length;x++){const C=Math.max(w[x].high-w[x].low,Math.abs(w[x].high-w[x-1].close),Math.abs(w[x].low-w[x-1].close));j+=C}l.push(j/14)}const r=l.reduce((v,w)=>v+w,0)/l.length,c=n/r,d=St(a,e.take_profit_1,n,i,c),p=St(a,e.take_profit_2,n,i,c),u=St(a,e.take_profit_3,n,i,c),m=Na(a,e.stop_loss,n,i,e.signal_type),g=Ha(a,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:p,tp3:u,sl:m}),h=(d+p+u)/3/m;let y;d>70&&g>5&&h>2?y="STRONG_TRADE":d>60&&g>0&&h>1.5?y="GOOD_TRADE":d>50&&g>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const E=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${g.toFixed(2)}. Risk-adjusted R:R: ${h.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(g.toFixed(2)),risk_reward_adjusted:parseFloat(h.toFixed(2)),recommendation:y,summary:E}}function Ba(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=Ua(e),s=Wa(),a=Va(e,s.session),n=za(t,s.session),i=Ya(t,s),o=qa(t,s,a,i),l=Ga(o,t,s,a),r=Ka(o);return{liquidity_score:Math.round(o),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:a.spread_pips,price_impact_bps:Math.round(n),market_depth_score:Math.round(i),optimal_for_trading:o>=70&&l.length===0,warnings:l,recommendation:r}}function Ua(e){const t=e.slice(-10),s=e.slice(-20,-10),a=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,n=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,o=n/a;let l;n>i*1.2?l="INCREASING":n<i*.8?l="DECREASING":l="STABLE";const r=Math.min(100,o*100);return{avg_volume:a,current_volume:n,volume_ratio:o,volume_spike:o>2,volume_drought:o<.5,trend:l,percentile:r}}function Wa(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),a=t*60+s;let n,i;return a>=780&&a<960?(n="OVERLAP",i="HIGH"):a>=480&&a<780?(n="LONDON",i="HIGH"):a>=960&&a<1320?(n="NEW_YORK",i="HIGH"):a>=0&&a<480?(n="ASIA",i="MEDIUM"):(n="OFF_HOURS",i="LOW"),{zone:i,session:n}}function Va(e,t){const s=e.slice(-20);let a=0;for(const d of s){const p=d.high-d.low;a+=p}const n=a/s.length,i=s[s.length-1].close,o=n/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const r=1+o*2,c=l*r;return{spread_pips:Math.round(c)}}function za(e,t){let s=10;const n={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*n*i}function Ya(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function qa(e,t,s,a){const n=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,o=Math.max(0,100-s.spread_pips)*.2,l=a*.2;return n+i+o+l}function Ga(e,t,s,a){const n=[];return e<50&&n.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&n.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&n.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),a.spread_pips>50&&n.push(`⚠️ WIDE SPREADS: Estimated ${a.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&n.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),n}function Ka(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const It=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Xa(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function gt(e=30){const t=[],s=new Date;for(const n of It){const i=new Date(n),o=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));o>=0&&o<=e&&(t.push({date:n,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:n,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let n=0;n<=e;n++){const i=new Date(s.getTime()+n*24*60*60*1e3),o=i.getFullYear(),l=i.getMonth(),r=i.getDate(),c=i.getDay();if(r===Xa(o,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}r===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),r===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),r===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(r===1||r<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(r===3||r<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((n,i,o)=>i===o.findIndex(l=>l.date===n.date&&l.time===n.time&&l.title===n.title)).sort((n,i)=>{const o=new Date(`${n.date}T${n.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return o.getTime()-l.getTime()})}function ht(e=new Date,t=[]){const s=[...gt(7),...t],a=s.filter(o=>new Date(`${o.date}T${o.time}:00Z`)>e).slice(0,10),n=e.toISOString().split("T")[0];if(s.filter(o=>o.date===n&&o.impact==="high"),It.includes(n))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:a,nextSafeTime:Qa(n)};new Date(e.getTime()+7200*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`),r=(l.getTime()-e.getTime())/(1e3*60);if(o.impact==="high"&&r>0&&r<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(o.impact==="high"&&r>30&&r<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${o.title} in ${Math.round(r)} minutes`,riskLevel:"caution",upcomingEvents:a,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const o of s){const l=new Date(`${o.date}T${o.time}:00Z`);if(o.impact==="high"&&l>i&&l<e){const r=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${o.title} just happened ${Math.round(r)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:a,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:a}}function Qa(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function Rt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let a="🔴";return e.impact==="medium"&&(a="🟡"),e.impact==="low"&&(a="🟢"),`${a} ${e.date} ${s} UTC - ${e.title}`}function Za(e){const t=e.toISOString().split("T")[0];return It.includes(t)?!0:gt(30).filter(n=>n.date===t&&n.impact==="high").length>=2}function Ja(){const e=new Date().toISOString().split("T")[0];return gt(7).filter(s=>s.date===e)}function os(e=new Date){const t=ht(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const ls=new ke;ls.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const a={},n={};for(const N of["5m","15m","1h","4h","daily"]){const O=await t.prepare(`
    ...
    `).first(),l=(o==null?void 0:o.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(o!=null&&o.timestamp){const N=new Date(o.timestamp).getTime(),O=(Date.now()-N)/(1e3*60);O>60&&i.push(`⚠️ WARNING: Price data is ${O.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${O.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const r=ht(),c=os();let d=null,p=!1;r.riskLevel==="danger"?(p=!0,d=r.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",r.reason)):r.riskLevel==="caution"?(d=r.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",r.reason)):console.log("[ENHANCED] ✅ Calendar safe:",r.reason);const u=a["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(a).join(", ")}`},400);const m=Dt(a,l),g=se(l,u,"day_trade"),f=se(l,u,"swing_trade"),h=Tt(g.signal_type,m),y=Tt(f.signal_type,m),E={...g,base_confidence:g.confidence,mtf_confidence:h.confidence,final_confidence:Math.min(95,h.confidence),isValid:h.isValid,mtf_reason:h.reason,alignment_score:m.score,alignment_type:m.type},v={...f,base_confidence:f.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type};let w=0,j="",x=[];if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20){try{const O=Ra(n["1h"]);x=(O==null?void 0:O.patterns)||[]}catch(O){console.error("[ENHANCED] Pattern detection error:",O.message)}const N=x.filter(O=>O.confidence>=70&&O.endIndex>=n["1h"].length-5);for(const O of N)O.type==="bullish"&&E.signal_type==="BUY"?(w+=O.confidence*.1,j+=`${O.name} (${O.confidence.toFixed(0)}%), `):O.type==="bearish"&&E.signal_type==="SELL"&&(w+=O.confidence*.1,j+=`${O.name} (${O.confidence.toFixed(0)}%), `);w=Math.min(15,w)}let C=0,H="",M=null;if(n["1h"]&&n["1h"].length>=50){const N=ge(n["1h"]);N&&(M=La(n["1h"],N),M.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(C=10,H="Strong Uptrend"):M.trend==="UPTREND"&&E.signal_type==="BUY"?(C=5,H="Uptrend"):M.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(C=10,H="Strong Downtrend"):M.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(C=5,H="Downtrend"))}let S=0,T="",R=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{R=Pa(n["1h"],l),R.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(S=R.confidence_boost,T=`ML predicts +${((R.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):R.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(S=R.confidence_boost,T=`ML predicts ${((R.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(N){console.error("[ENHANCED] ML prediction error:",N.message)}let k=0,ae="",z=null;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=50)try{const N=ge(n["1h"]);N&&(z=ja(E,N,n["1h"]),z.tp1_probability>70?(k=10,ae=`PoP: TP1 ${z.tp1_probability.toFixed(0)}%`):z.tp1_probability>60&&(k=5,ae=`PoP: TP1 ${z.tp1_probability.toFixed(0)}%`))}catch(N){console.error("[ENHANCED] Probability of Profit error:",N.message)}let L=null,Z=0,$=0;if(n["1h"]&&Array.isArray(n["1h"])&&n["1h"].length>=20)try{L=Ba(n["1h"]),L.liquidity_score>=80?Z=5:L.liquidity_score>=70?Z=0:L.liquidity_score>=50?$=-5:$=-10,console.log(`[LIQUIDITY] Score: ${L.liquidity_score}/100, Session: ${L.session}, Adjust: ${Z+$}%`)}catch(N){console.error("[ENHANCED] Liquidity Analysis error:",N.message)}let F=0,q=0,ne=0,de=0,ue="";try{const N=await t.prepare(`
      ...
      `).all(),V=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(N&&O.results&&O.results.length>=10){const b=ba(O.results,N.balance);F=b.var_95,q=b.var_99;const Y=va(N.balance,O.results);if(ne=Y.current_drawdown_pct,Y.is_within_limit||(ue+=`⚠️ Drawdown ${ne.toFixed(1)}% exceeds limit. `),V.results){const ye=wa(V.results,N.balance);de=ye.total_risk_pct,ye.is_within_limit||(ue+=`⚠️ Portfolio heat ${de.toFixed(1)}% exceeds limit. `)}}}catch(N){console.error("[ENHANCED] Risk metrics error (optional):",N.message)}const Ce=w+C+S+k+Z+$,B={...E,pattern_boost:w,regime_boost:C,ml_boost:S,pop_boost:k,total_boost:Ce,enhanced_confidence:Math.min(98,E.final_confidence+Ce),var_95:F,var_99:q,current_drawdown_pct:ne,portfolio_heat_pct:de,risk_warning:ue||null},A={...v,pattern_boost:w,regime_boost:C,ml_boost:S,pop_boost:k,total_boost:Ce,enhanced_confidence:Math.min(98,v.final_confidence+Ce),var_95:F,var_99:q,current_drawdown_pct:ne,portfolio_heat_pct:de,risk_warning:ue||null};p?(B.signal_type="HOLD",A.signal_type="HOLD",B.enhanced_confidence=50,A.enhanced_confidence=50,B.reasoning=d||"Economic event nearby - trading paused",A.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(B.enhanced_confidence=Math.max(50,B.enhanced_confidence+c.adjustment),A.enhanced_confidence=Math.max(50,A.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),B.calendar_check={risk_level:r.riskLevel,should_trade:r.shouldTrade,reason:r.reason,confidence_adjustment:c.adjustment,upcoming_events:r.upcomingEvents.slice(0,3).map(N=>Rt(N))},A.calendar_check=B.calendar_check;let Pe=!1;try{const N=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),O={};for(const V of N.results||[])O[V.setting_key]=V.setting_value;if(O.telegram_bot_token&&O.telegram_chat_id){let b=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC

`;if(i.length>0){b+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const Y of i)b+=`${Y}
`;b+=`*→ Click "Generate Signal NOW" for fresh data*

`}r.riskLevel==="danger"?(b+=`🚨 *ECONOMIC CALENDAR ALERT*
`,b+=`${r.reason}
`,b+=`*→ NO TRADING RECOMMENDED*

`):r.riskLevel==="caution"?(b+=`⚠️ *ECONOMIC CALENDAR WARNING*
`,b+=`${r.reason}
`,b+=`*→ Reduce position size by 50%*

`):r.upcomingEvents.length>0&&(b+=`📅 *Economic Calendar:* ✅ Safe to trade
`,b+=`Next event: ${Rt(r.upcomingEvents[0])}
...
`,b+=`${m.type} (${m.score}/5 timeframes)
`,b+=`Confidence Boost: +${m.confidenceBoost}%

`;for(const Y of m.trends){const ye=Y.trend==="BULLISH"?"📈":Y.trend==="BEARISH"?"📉":"➡️";b+=`${ye} *${Y.timeframe}*: ${Y.trend} (${Y.confidence.toFixed(0)}%)
`}if(b+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,b+=`📈 *DAY TRADE SIGNAL*
`,b+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,b+=`${B.isValid?"✅":"❌"} *${B.signal_type}* (${B.enhanced_confidence.toFixed(0)}% confidence)

`,b+=`*Entry:* $${B.price.toFixed(2)}
`,b+=`*Stop Loss:* $${B.stop_loss.toFixed(2)} (${((B.stop_loss/B.price-1)*100).toFixed(2)}%)
`,b+=`*TP1:* $${B.take_profit_1.toFixed(2)} (${((B.take_profit_1/B.price-1)*100).toFixed(2)}%)
`,b+=`*TP2:* $${B.take_profit_2.toFixed(2)} (${((B.take_profit_2/B.price-1)*100).toFixed(2)}%)
`,b+=`*TP3:* $${B.take_profit_3.toFixed(2)} (${((B.take_profit_3/B.price-1)*100).toFixed(2)}%)

`,b+=`*📊 Confidence Breakdown:*
`,b+=`Base: ${B.base_confidence.toFixed(0)}%
`,b+=`MTF: ${B.mtf_confidence.toFixed(0)}%
`,w>0&&(b+=`Pattern: +${w.toFixed(0)}%
`),C>0&&(b+=`Regime: +${C.toFixed(0)}%
`),S>0&&(b+=`ML: +${S.toFixed(0)}%
`),k>0&&(b+=`PoP: +${k.toFixed(0)}%
`),Z!==0||$!==0){const Y=Z+$;b+=`Liquidity: ${Y>=0?"+":""}${Y.toFixed(0)}%
`}if(b+=`*FINAL: ${B.enhanced_confidence.toFixed(0)}%*

`,M&&(b+=`🌡️ *Market Regime:* ${M.trend||"N/A"}
`,b+=`Volatility: ${M.volatility}
`,b+=`Should Trade: ${M.should_trade?"✅ YES":"❌ NO"}

`),R&&R.overall_direction!=="NEUTRAL"&&(b+=`🤖 *ML Prediction:* ${R.overall_direction}
`,(s=R.predictions[0])!=null&&s.predicted_price&&(b+=`1h Target: $${R.predictions[0].predicted_price.toFixed(2)}
`),b+=`
`),z&&(b+=`🎯 *Probability of Profit:*
`,b+=`TP1: ${z.tp1_probability.toFixed(0)}%
`,b+=`TP2: ${z.tp2_probability.toFixed(0)}%
`,b+=`TP3: ${z.tp3_probability.toFixed(0)}%
`,b+=`Expected Value: ${z.expected_value.toFixed(2)}R

`),L){const Y=L.liquidity_score>=80?"🟢":L.liquidity_score>=70?"🟡":L.liquidity_score>=50?"🟠":"🔴";if(b+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,b+=`🌊 *LIQUIDITY ANALYSIS*
`,b+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,b+=`${Y} *Score:* ${L.liquidity_score}/100
`,b+=`🕐 *Session:* ${L.session}
`,b+=`📊 *Time Zone:* ${L.time_of_day_zone} LIQUIDITY
`,b+=`📈 *Volume:* ${L.volume_trend} (${L.volume_percentile}%)
`,b+=`💰 *Spread:* ~${L.estimated_spread_pips} pips
`,b+=`📉 *Price Impact:* ~${L.price_impact_bps} bps
`,b+=`✅ *Optimal:* ${L.optimal_for_trading?"YES":"NO"}

`,L.warnings.length>0){b+=`⚠️ *Liquidity Warnings:*
`;for(const ye of L.warnings)b+=`${ye}
`;b+=`
`}b+=`💡 ${L.recommendation}
...
`,b+=`VaR(95%): $${F.toFixed(2)}
`,b+=`VaR(99%): $${q.toFixed(2)}
`,b+=`Drawdown: ${ne.toFixed(2)}%
`,b+=`Portfolio Heat: ${de.toFixed(1)}%

`,b+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,b+=`💡 *RECOMMENDATION*
`,b+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,B.isValid&&B.signal_type!=="HOLD"?(b+=`✅ *EXECUTE ${B.signal_type}*
`,b+=`All hedge fund features aligned!
`):(b+=`⚠️ *SKIP TRADE*
`,b+=`Reason: ${B.mtf_reason}
`),b+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,Pe=await G({botToken:O.telegram_bot_token,chatId:O.telegram_chat_id},b)}}catch(N){console.error("[ENHANCED] Telegram error (optional):",N.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Pe,day_trade:B,swing_trade:A,alignment:{type:m.type,score:m.score,trends:m.trends},patterns:x.length>0?x.slice(0,3):null,regime:M?{trend:M.trend,volatility:M.volatility,should_trade:M.should_trade}:null,ml_prediction:R?{direction:R.overall_direction,predictions:R.predictions}:null,profit_probability:z?{tp1:z.tp1_probability,tp2:z.tp2_probability,tp3:z.tp3_probability,expected_value:z.expected_value}:null,liquidity:L?{score:L.liquidity_score,session:L.session,time_zone:L.time_of_day_zone,volume_trend:L.volume_trend,volume_percentile:L.volume_percentile,estimated_spread_pips:L.estimated_spread_pips,price_impact_bps:L.price_impact_bps,market_depth_score:L.market_depth_score,optimal_for_trading:L.optimal_for_trading,warnings:L.warnings,recommendation:L.recommendation}:null,risk_metrics:{var_95:F,var_99:q,drawdown_pct:ne,portfolio_heat_pct:de}})}catch(a){return console.error("[ENHANCED] Error:",a.message,a.stack),e.json({success:!1,error:a.message,stack:a.stack},500)}});async function Ke(e){const t=await e.prepare(`
  ...
  `).bind(s,i).run();let o=!1,l="";s>=t.max_drawdown_pct?(o=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(o=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),o&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});ce.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Te=new ke;Te.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=gt(t);return e.json({success:!0,count:s.length,events:s.map(a=>({...a,formatted:Rt(a)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Te.get("/today",async e=>{try{const t=Ja(),s=ht();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Te.get("/check",async e=>{try{const t=ht(),s=os();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Te.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let a=0;a<30;a++){const n=new Date(t.getTime()+a*24*60*60*1e3);Za(n)&&s.push(n.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Te.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ot=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:nn,calculatePositionSize:fs,calculateProfitLoss:gs,checkDailyLossLimit:an,formatPositionSize:rn},Symbol.toStringTag,{value:"Module"}));async function hs(e,t,s){const a=Date.now(),n=[],i=[];let o=t.starting_balance,l=t.starting_balance;const r=e.filter(F=>{const q=new Date(F.timestamp);return q>=new Date(t.start_date)&&q<=new Date(t.end_date)});if(r.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${r.length}`);const c={current_balance:o,max_daily_loss_pct:2};for(let F=200;F<r.length;F++){const q=r.slice(F-200,F),ne=ge(q);if(!ne)continue;const de=r[F],ue=de.close,Ce=se(ue,ne,"day_trade"),B=se(ue,ne,"swing_trade");for(const A of[Ce,B]){if(A.signal_type==="HOLD"||A.confidence<t.min_confidence)continue;c.current_balance=o;const Pe=fs(c,{entry_price:A.price,stop_loss:A.stop_loss,take_profit_1:A.take_profit_1,take_profit_2:A.take_profit_2,take_profit_3:A.take_profit_3,confidence:A.confidence,signal_type:A.signal_type,trading_style:A.trading_style},s);if(!Pe.is_valid)continue;const N=de.timestamp,O=A.price;let V=null,b=null,Y="UNKNOWN";const ye=Math.min(50,r.length-F-1);for(let bt=1;bt<=ye;bt++){const J=r[F+bt];if(A.signal_type==="BUY"){if(J.low<=A.stop_loss){V=A.stop_loss,b=J.timestamp,Y="STOP_LOSS";break}if(J.high>=A.take_profit_3){V=A.take_profit_3,b=J.timestamp,Y="TP3";break}if(J.high>=A.take_profit_2){V=A.take_profit_2,b=J.timestamp,Y="TP2";break}if(J.high>=A.take_profit_1){V=A.take_profit_1,b=J.timestamp,Y="TP1";break}}else{if(J.high>=A.stop_loss){V=A.stop_loss,b=J.timestamp,Y="STOP_LOSS";break}if(J.low<=A.take_profit_3){V=A.take_profit_3,b=J.timestamp,Y="TP3";break}if(J.low<=A.take_profit_2){V=A.take_profit_2,b=J.timestamp,Y="TP2";break}if(J.low<=A.take_profit_1){V=A.take_profit_1,b=J.timestamp,Y="TP1";break}}}if(!V||!b)continue;const yt=gs(O,V,Pe.units,A.signal_type,t.commission_per_trade);o+=yt.profit_loss,o>l&&(l=o),n.push({entry_time:N,entry_price:O,exit_time:b,exit_price:V,signal_type:A.signal_type,trading_style:A.trading_style,position_size:Pe.units,profit_loss:yt.profit_loss,profit_loss_pct:yt.profit_loss_pct,exit_reason:Y,confidence:A.confidence}),i.push({date:b,balance:o})}}const d=n.filter(F=>F.profit_loss>0),p=n.filter(F=>F.profit_loss<0),u=d.reduce((F,q)=>F+q.profit_loss,0),m=Math.abs(p.reduce((F,q)=>F+q.profit_loss,0)),g=o-t.starting_balance,f=n.length>0?d.length/n.length*100:0,h=d.length>0?u/d.length:0,y=p.length>0?m/p.length:0,E=d.length>0?Math.max(...d.map(F=>F.profit_loss)):0,v=p.length>0?Math.min(...p.map(F=>F.profit_loss)):0,w=m>0?u/m:u,j=100-f,x=f/100*h-j/100*y;let C=0,H=0,M=t.starting_balance;for(const F of i){F.balance>M&&(M=F.balance);const q=M-F.balance,ne=q/M*100;q>C&&(C=q,H=ne)}const S=n.map(F=>F.profit_loss_pct),T=S.reduce((F,q)=>F+q,0)/S.length,R=Math.sqrt(S.reduce((F,q)=>F+Math.pow(q-T,2),0)/S.length),k=R>0?T/R:0;let ae=0,z=0,L=0,Z=0;for(const F of n)F.profit_loss>0?(L++,Z=0,ae=Math.max(ae,L)):(Z++,L=0,z=Math.max(z,Z));const $=Date.now()-a;return{config:t,total_trades:n.length,winning_trades:d.length,losing_trades:p.length,win_rate:parseFloat(f.toFixed(2)),net_profit:parseFloat(g.toFixed(2)),total_return_pct:parseFloat((g/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(h.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(E.toFixed(2)),largest_loss:parseFloat(v.toFixed(2)),max_drawdown:parseFloat(C.toFixed(2)),max_drawdown_pct:parseFloat(H.toFixed(2)),profit_factor:parseFloat(w.toFixed(2)),sharpe_ratio:parseFloat(k.toFixed(2)),expectancy:parseFloat(x.toFixed(2)),max_consecutive_wins:ae,max_consecutive_losses:z,starting_balance:t.starting_balance,ending_balance:parseFloat(o.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:n,equity_curve:i,execution_time_ms:$}}function ys(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const on=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:ys,runBacktest:hs},Symbol.toStringTag,{value:"Module"})),Xe=new ke;Xe.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const vs=new ke;vs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
    ...
    `).all();let a="";for(const S of s.results||[])S.setting_key==="twelve_data_api_key"&&(a=S.setting_value);let n=[];if(a&&a!=="your_api_key_here")try{const S=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,R=await(await fetch(S)).json();R.values&&R.values.length>=50&&(n=R.values.reverse().map(k=>({timestamp:k.datetime,open:parseFloat(k.open),high:parseFloat(k.high),low:parseFloat(k.low),close:parseFloat(k.close),volume:parseFloat(k.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",n.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(n.length===0){const S=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!S.results||S.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);n=S.results.reverse().map(T=>({timestamp:T.timestamp,open:T.open,high:T.high,low:T.low,close:T.close,volume:T.volume||0}))}const i=ge(n);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const o=n[n.length-1].close,l=se(o,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",o,"Signal:",l.signal_type,"Confidence:",l.confidence);const r={};for(const S of["5m","15m","1h","4h","daily"]){const T=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(S).first();T&&(r[S]=T)}const c=Dt(r,o),d=n.slice(-50),p=d.map(S=>S.high).sort((S,T)=>T-S),u=d.map(S=>S.low).sort((S,T)=>S-T),m=[Math.max(...p.slice(0,10))],g=[Math.min(...u.slice(0,10))];o>i.sma_20?g.push(i.sma_20):m.push(i.sma_20),o>i.sma_50?g.push(i.sma_50):m.push(i.sma_50),o>i.vwap?g.push(i.vwap):m.push(i.vwap);const f=Math.round(o/10)*10;f>o?m.push(f):g.push(f);const h=[...new Set(m)].sort((S,T)=>S-T).filter(S=>S>o).slice(0,3),y=[...new Set(g)].sort((S,T)=>T-S).filter(S=>S<o).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",h);const E=i.atr_14/o*100;let v="NORMAL";E>3?v="EXTREME":E>1.5?v="HIGH":E<.5&&(v="LOW");const w=[];let j=30,x=30,C=40;c.type==="ALL_BULLISH"?(j=60,x=20,C=20):c.type==="ALL_BEARISH"?(j=20,x=60,C=20):c.score>=4&&(c.trends.filter(S=>S.trend==="BULLISH").length>=4?(j=50,x=25,C=25):(j=25,x=50,C=25)),h.length>0&&w.push({name:"📈 BULLISH CONTINUATION",probability:j,description:`Price breaks above $${h[0].toFixed(2)} and rallies toward $${(h[h.length-1]||o*1.02).toFixed(2)}`,trigger:`Breakout above $${h[0].toFixed(2)} with volume`,target:h[h.length-1]||o*1.02}),y.length>0&&w.push({name:"📉 BEARISH CORRECTION",probability:x,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||o*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||o*.98}),w.push({name:"↔️ CONTINUED RANGING",probability:C,description:`Price oscillates between $${(y[0]||o*.99).toFixed(2)} and $${(h[0]||o*1.01).toFixed(2)} with choppy action`,trigger:v==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),w.sort((S,T)=>T.probability-S.probability);let H={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?H={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(o-5).toFixed(2)}-${o.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(H={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${o.toFixed(2)}-${(o+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):v==="EXTREME"?H.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(H.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${h[0]?`breakout above $${h[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let M=!1;try{const S=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
`,R+=`${H.reason}`,M=await G({botToken:T.telegram_bot_token,chatId:T.telegram_chat_id},R),console.log("[AI-ANALYSIS] Telegram sent:",M)}}catch(S){console.error("[AI-ANALYSIS] Telegram error:",S.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:o,signal:l.signal_type,confidence:l.confidence,volatility:v,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:h,support:y},scenarios:w,recommendation:H,telegram_sent:M}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const U=new ke;U.use("/api/*",ra());U.route("/api/signals/enhanced",ls);U.route("/api/trades",ce);U.route("/api/calendar",Te);U.route("/api/backtest",Xe);U.route("/api/telegram",bs);U.route("/api/ai",vs);U.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
...
✅ Telegram alerts are active.`);return e.json({success:n})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),a=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:a.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});U.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Es),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});U.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume).run(),d++}if(p.length>=50){const u=ge(p.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const m=p[p.length-1].close,g=se(m,u,"day_trade"),f=se(m,u,"swing_trade"),h=70;for(const y of[g,f])if(y.confidence>=h&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const E=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),v={};for(const w of E.results||[])v[w.setting_key]=w.setting_value;v.telegram_bot_token&&v.telegram_chat_id&&await G({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},et(y))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let a=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!a||a==="your_key_here"||a==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const n="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let o=0;const l={};for(const r of i){const c=`https://api.twelvedata.com/time_series?symbol=${n}&interval=${r.interval}&apikey=${a}&outputsize=${r.outputsize}`,p=await(await fetch(c)).json();if(p.code&&p.status==="error"){l[r.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[r.dbKey]={success:!1,error:"No data",count:0};continue}const u=p.values;let m=0;const g=[];for(const f of u){const h={timestamp:f.datetime,open:parseFloat(f.open),high:parseFloat(f.high),low:parseFloat(f.low),close:parseFloat(f.close),volume:0};g.push(h),await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const a=s.results.reverse().map(r=>({timestamp:r.timestamp,open:r.open,high:r.high,low:r.low,close:r.close,volume:r.volume})),n=ge(a);if(!n)return e.json({success:!1,error:"Failed to calculate indicators"});const i=a[a.length-1].close,o=se(i,n,"day_trade"),l=se(i,n,"swing_trade");return e.json({success:!0,signals:{day_trade:o,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:a,formatAlignmentReport:n}=await Promise.resolve().then(()=>rs),i=["5m","15m","1h","4h","daily"],o={};for(const x of i){const C=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();C&&(o[x]=C)}const l=Object.keys(o).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(o)});const r=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!r)return e.json({success:!1,error:"No market data available"});const c=r.close,d=s(o,c),p=o["1h"],u=se(c,p,"day_trade"),m=se(c,p,"swing_trade"),g=a(u.signal_type,d),f=a(m.signal_type,d),h={...u,base_confidence:u.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${g.reason}`},y={...m,base_confidence:m.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${f.reason}`},E=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),v={};for(const x of E.results||[])v[x.setting_key]=x.setting_value;let w=!1,j=[];v.telegram_bot_token&&v.telegram_chat_id&&(h.isValid&&h.signal_type!=="HOLD"&&await G({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${et({...h,timestamp:new Date().toISOString()})}

📊 ${n(d)}`)&&(j.push("day_trade"),w=!0),await new Promise(x=>setTimeout(x,1e3)),y.isValid&&y.signal_type!=="HOLD"&&await G({botToken:v.telegram_bot_token,chatId:v.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${et({...y,timestamp:new Date().toISOString()})}

📊 ${n(d)}`)&&(j.push("swing_trade"),w=!0));for(const x of[h,y])x.isValid&&await t.prepare(`
    ...
    `).all();let a="";for(const g of s.results||[])g.setting_key==="twelve_data_api_key"&&(a=g.setting_value);let n,i=!1;if(a&&a!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const g=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${a}`,h=await(await fetch(g)).json();h.values&&h.values.length>=50?(n=h.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",n[n.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(g){console.error("[GENERATE-NOW] API fetch failed:",g.message)}}if(!n){console.log("[GENERATE-NOW] Using database data (may be stale)");const g=await t.prepare(`
        ...
        ORDER BY timestamp DESC 
        LIMIT 200
      `).all();if(!g.results||g.results.length<50)return e.json({success:!1,error:"Not enough data. Please configure Twelve Data API key or fetch market data first."});n=g.results.reverse().map(f=>({timestamp:f.timestamp,open:f.open,high:f.high,low:f.low,close:f.close,volume:f.volume}))}const o=ge(n);if(!o)return e.json({success:!1,error:"Failed to calculate indicators"});const l=n[n.length-1].close,r=se(l,o,"day_trade"),c=se(l,o,"swing_trade");console.log("[GENERATE-NOW] Signals generated - Day:",r.signal_type,"Swing:",c.signal_type);const d=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    ...
    `).bind(a).first();if(!g)return e.json({success:!1,error:"Account not found"},404);const f=new Date().toISOString().split("T")[0],h=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(a,f).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>ot),E=y(g,h.results);if(E.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${E.current_loss_pct}% (max ${g.max_daily_loss_pct}%)`},400);const v=d*i,w=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(a,n||null,p,u,i,d,v,o,l,r,c,m).run();return e.json({success:!0,trade_id:w.meta.last_row_id,message:"Trade executed successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/trading/close/:trade_id",async e=>{const{DB:t}=e.env,s=e.req.param("trade_id");try{const a=await e.req.json(),{exit_price:n,exit_reason:i}=a,o=await t.prepare(`
    ...
    `).bind(s).all(),{calculatePortfolioMetrics:n}=await Promise.resolve().then(()=>ot),i=n(a.results);return e.json({success:!0,stats:i})}catch(a){return e.json({success:!1,error:a.message},500)}});U.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const a=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    ...
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});U.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Fetch MTF Data",status:"running"});const a=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first(),n=(a==null?void 0:a.setting_value)||"70140f57bea54c5e90768de696487d8f",i=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"},{interval:"4h",dbKey:"4h"},{interval:"1day",dbKey:"daily"}];let o=0;for(const k of i){const ae=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${k.interval}&apikey=${n}&outputsize=100`,L=await(await fetch(ae)).json();if(L.values&&Array.isArray(L.values)){const Z=[];for(const $ of L.values){const F={timestamp:$.datetime,open:parseFloat($.open),high:parseFloat($.high),low:parseFloat($.low),close:parseFloat($.close),volume:0};Z.push(F),await t.prepare(`
            INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
            VALUES (?, ?, ?, ?, ?, ?, ?)
            ON CONFLICT DO NOTHING
          `).bind(F.timestamp,F.open,F.high,F.low,F.close,F.volume,k.dbKey).run()}if(Z.length>=50){const $=ge(Z.reverse());$&&await t.prepare(`
              INSERT INTO multi_timeframe_indicators 
              (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
               sma_20, sma_50, sma_200, ema_12, ema_26,
               bb_upper, bb_middle, bb_lower, atr_14,
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),u=(p==null?void 0:p.close)||0,m=l(d,u),g=d["1h"],f=se(u,g,"day_trade"),h=se(u,g,"swing_trade"),y=r(f.signal_type,m),E=r(h.signal_type,m),v={...f,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type},w={...h,final_confidence:Math.min(95,E.confidence),isValid:E.isValid,mtf_reason:E.reason,alignment_score:m.score,alignment_type:m.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:v,swingTrade:w,alignment:m},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const j=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),x=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:C}=await Promise.resolve().then(()=>ot),H=C(j,{entry_price:v.price,stop_loss:v.stop_loss,take_profit_1:v.take_profit_1,take_profit_2:v.take_profit_2,take_profit_3:v.take_profit_3,confidence:v.final_confidence,signal_type:v.signal_type,trading_style:v.trading_style},x.results),M=C(j,{entry_price:w.price,stop_loss:w.stop_loss,take_profit_1:w.take_profit_1,take_profit_2:w.take_profit_2,take_profit_3:w.take_profit_3,confidence:w.final_confidence,signal_type:w.signal_type,trading_style:w.trading_style},x.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:H,swingPosition:M},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const S=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();R=await G({botToken:T.telegram_bot_token,chatId:T.telegram_chat_id},k)}if(s.steps[3].status=R?"completed":"failed",s.steps[3].data={telegramSent:R},v.isValid||w.isValid)for(const k of[v,w])k.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
