var Js=Object.defineProperty;var Vt=e=>{throw TypeError(e)};var en=(e,t,s)=>t in e?Js(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var M=(e,t,s)=>en(e,typeof t!="symbol"?t+"":t,s),$t=(e,t,s)=>t.has(e)||Vt("Cannot "+s);var h=(e,t,s)=>($t(e,t,"read from private field"),s?s.call(e):t.get(e)),B=(e,t,s)=>t.has(e)?Vt("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s),I=(e,t,s,n)=>($t(e,t,"write to private field"),n?n.call(e,s):t.set(e,s),s),q=(e,t,s)=>($t(e,t,"access private method"),s);var Gt=(e,t,s,n)=>({set _(a){I(e,t,a,s)},get _(){return h(e,t,n)}});var qt=(e,t,s)=>(n,a)=>{let i=-1;return r(0);async function r(l){if(l<=i)throw new Error("next() called multiple times");i=l;let o,c=!1,d;if(e[l]?(d=e[l][0][0],n.req.routeIndex=l):d=l===e.length&&a||void 0,d)try{o=await d(n,()=>r(l+1))}catch(p){if(p instanceof Error&&t)n.error=p,o=await t(p,n),c=!0;else throw p}else n.finalized===!1&&s&&(o=await s(n));return o&&(n.finalized===!1||c)&&(n.res=o),n}},tn=Symbol(),sn=async(e,t=Object.create(null))=>{const{all:s=!1,dot:n=!1}=t,i=(e instanceof ps?e.raw.headers:e.headers).get("Content-Type");return i!=null&&i.startsWith("multipart/form-data")||i!=null&&i.startsWith("application/x-www-form-urlencoded")?nn(e,{all:s,dot:n}):{}};async function nn(e,t){const s=await e.formData();return s?an(s,t):{}}function an(e,t){const s=Object.create(null);return e.forEach((n,a)=>{t.all||a.endsWith("[]")?rn(s,a,n):s[a]=n}),t.dot&&Object.entries(s).forEach(([n,a])=>{n.includes(".")&&(on(s,n,a),delete s[n])}),s}var rn=(e,t,s)=>{e[t]!==void 0?Array.isArray(e[t])?e[t].push(s):e[t]=[e[t],s]:t.endsWith("[]")?e[t]=[s]:e[t]=s},on=(e,t,s)=>{let n=e;const a=t.split(".");a.forEach((i,r)=>{r===a.length-1?n[i]=s:((!n[i]||typeof n[i]!="object"||Array.isArray(n[i])||n[i]instanceof File)&&(n[i]=Object.create(null)),n=n[i])})},os=e=>{const t=e.split("/");return t[0]===""&&t.shift(),t},ln=e=>{const{groups:t,path:s}=cn(e),n=os(s);return dn(n,t)},cn=e=>{const t=[];return e=e.replace(/\{[^}]+\}/g,(s,n)=>{const a=`@${n}`;return t.push([a,s]),a}),{groups:t,path:e}},dn=(e,t)=>{for(let s=t.length-1;s>=0;s--){const[n]=t[s];for(let a=e.length-1;a>=0;a--)if(e[a].includes(n)){e[a]=e[a].replace(n,t[s][1]);break}}return e},Et={},un=(e,t)=>{if(e==="*")return"*";const s=e.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(s){const n=`${e}#${t}`;return Et[n]||(s[2]?Et[n]=t&&t[0]!==":"&&t[0]!=="*"?[n,s[1],new RegExp(`^${s[2]}(?=/${t})`)]:[e,s[1],new RegExp(`^${s[2]}$`)]:Et[n]=[e,s[1],!0]),Et[n]}return null},Ht=(e,t)=>{try{return t(e)}catch{return e.replace(/(?:%[0-9A-Fa-f]{2})+/g,s=>{try{return t(s)}catch{return s}})}},pn=e=>Ht(e,decodeURI),ls=e=>{const t=e.url,s=t.indexOf("/",t.indexOf(":")+4);let n=s;for(;n<t.length;n++){const a=t.charCodeAt(n);if(a===37){const i=t.indexOf("?",n),r=t.slice(s,i===-1?void 0:i);return pn(r.includes("%25")?r.replace(/%25/g,"%2525"):r)}else if(a===63)break}return t.slice(s,n)},mn=e=>{const t=ls(e);return t.length>1&&t.at(-1)==="/"?t.slice(0,-1):t},Ge=(e,t,...s)=>(s.length&&(t=Ge(t,...s)),`${(e==null?void 0:e[0])==="/"?"":"/"}${e}${t==="/"?"":`${(e==null?void 0:e.at(-1))==="/"?"":"/"}${(t==null?void 0:t[0])==="/"?t.slice(1):t}`}`),cs=e=>{if(e.charCodeAt(e.length-1)!==63||!e.includes(":"))return null;const t=e.split("/"),s=[];let n="";return t.forEach(a=>{if(a!==""&&!/\:/.test(a))n+="/"+a;else if(/\:/.test(a))if(/\?/.test(a)){s.length===0&&n===""?s.push("/"):s.push(n);const i=a.replace("?","");n+="/"+i,s.push(n)}else n+="/"+a}),s.filter((a,i,r)=>r.indexOf(a)===i)},Nt=e=>/[%+]/.test(e)?(e.indexOf("+")!==-1&&(e=e.replace(/\+/g," ")),e.indexOf("%")!==-1?Ht(e,us):e):e,ds=(e,t,s)=>{let n;if(!s&&t&&!/[%+]/.test(t)){let r=e.indexOf("?",8);if(r===-1)return;for(e.startsWith(t,r+1)||(r=e.indexOf(`&${t}`,r+1));r!==-1;){const l=e.charCodeAt(r+t.length+1);if(l===61){const o=r+t.length+2,c=e.indexOf("&",o);return Nt(e.slice(o,c===-1?void 0:c))}else if(l==38||isNaN(l))return"";r=e.indexOf(`&${t}`,r+1)}if(n=/[%+]/.test(e),!n)return}const a={};n??(n=/[%+]/.test(e));let i=e.indexOf("?",8);for(;i!==-1;){const r=e.indexOf("&",i+1);let l=e.indexOf("=",i);l>r&&r!==-1&&(l=-1);let o=e.slice(i+1,l===-1?r===-1?void 0:r:l);if(n&&(o=Nt(o)),i=r,o==="")continue;let c;l===-1?c="":(c=e.slice(l+1,r===-1?void 0:r),n&&(c=Nt(c))),s?(a[o]&&Array.isArray(a[o])||(a[o]=[]),a[o].push(c)):a[o]??(a[o]=c)}return t?a[t]:a},gn=ds,fn=(e,t)=>ds(e,t,!0),us=decodeURIComponent,zt=e=>Ht(e,us),Xe,ce,we,ms,gs,Ut,Le,ts,ps=(ts=class{constructor(e,t="/",s=[[]]){B(this,we);M(this,"raw");B(this,Xe);B(this,ce);M(this,"routeIndex",0);M(this,"path");M(this,"bodyCache",{});B(this,Le,e=>{const{bodyCache:t,raw:s}=this,n=t[e];if(n)return n;const a=Object.keys(t)[0];return a?t[a].then(i=>(a==="json"&&(i=JSON.stringify(i)),new Response(i)[e]())):t[e]=s[e]()});this.raw=e,this.path=t,I(this,ce,s),I(this,Xe,{})}param(e){return e?q(this,we,ms).call(this,e):q(this,we,gs).call(this)}query(e){return gn(this.url,e)}queries(e){return fn(this.url,e)}header(e){if(e)return this.raw.headers.get(e)??void 0;const t={};return this.raw.headers.forEach((s,n)=>{t[n]=s}),t}async parseBody(e){var t;return(t=this.bodyCache).parsedBody??(t.parsedBody=await sn(this,e))}json(){return h(this,Le).call(this,"text").then(e=>JSON.parse(e))}text(){return h(this,Le).call(this,"text")}arrayBuffer(){return h(this,Le).call(this,"arrayBuffer")}blob(){return h(this,Le).call(this,"blob")}formData(){return h(this,Le).call(this,"formData")}addValidatedData(e,t){h(this,Xe)[e]=t}valid(e){return h(this,Xe)[e]}get url(){return this.raw.url}get method(){return this.raw.method}get[tn](){return h(this,ce)}get matchedRoutes(){return h(this,ce)[0].map(([[,e]])=>e)}get routePath(){return h(this,ce)[0].map(([[,e]])=>e)[this.routeIndex].path}},Xe=new WeakMap,ce=new WeakMap,we=new WeakSet,ms=function(e){const t=h(this,ce)[0][this.routeIndex][1][e],s=q(this,we,Ut).call(this,t);return s&&/\%/.test(s)?zt(s):s},gs=function(){const e={},t=Object.keys(h(this,ce)[0][this.routeIndex][1]);for(const s of t){const n=q(this,we,Ut).call(this,h(this,ce)[0][this.routeIndex][1][s]);n!==void 0&&(e[s]=/\%/.test(n)?zt(n):n)}return e},Ut=function(e){return h(this,ce)[1]?h(this,ce)[1][e]:e},Le=new WeakMap,ts),_n={Stringify:1},fs=async(e,t,s,n,a)=>{typeof e=="object"&&!(e instanceof String)&&(e instanceof Promise||(e=e.toString()),e instanceof Promise&&(e=await e));const i=e.callbacks;return i!=null&&i.length?(a?a[0]+=e:a=[e],Promise.all(i.map(l=>l({phase:t,buffer:a,context:n}))).then(l=>Promise.all(l.filter(Boolean).map(o=>fs(o,t,!1,n,a))).then(()=>a[0]))):Promise.resolve(e)},hn="text/plain; charset=UTF-8",Ft=(e,t)=>({"Content-Type":e,...t}),ct,dt,he,Ke,ye,oe,ut,Ze,Qe,Oe,pt,mt,ke,qe,ss,yn=(ss=class{constructor(e,t){B(this,ke);B(this,ct);B(this,dt);M(this,"env",{});B(this,he);M(this,"finalized",!1);M(this,"error");B(this,Ke);B(this,ye);B(this,oe);B(this,ut);B(this,Ze);B(this,Qe);B(this,Oe);B(this,pt);B(this,mt);M(this,"render",(...e)=>(h(this,Ze)??I(this,Ze,t=>this.html(t)),h(this,Ze).call(this,...e)));M(this,"setLayout",e=>I(this,ut,e));M(this,"getLayout",()=>h(this,ut));M(this,"setRenderer",e=>{I(this,Ze,e)});M(this,"header",(e,t,s)=>{this.finalized&&I(this,oe,new Response(h(this,oe).body,h(this,oe)));const n=h(this,oe)?h(this,oe).headers:h(this,Oe)??I(this,Oe,new Headers);t===void 0?n.delete(e):s!=null&&s.append?n.append(e,t):n.set(e,t)});M(this,"status",e=>{I(this,Ke,e)});M(this,"set",(e,t)=>{h(this,he)??I(this,he,new Map),h(this,he).set(e,t)});M(this,"get",e=>h(this,he)?h(this,he).get(e):void 0);M(this,"newResponse",(...e)=>q(this,ke,qe).call(this,...e));M(this,"body",(e,t,s)=>q(this,ke,qe).call(this,e,t,s));M(this,"text",(e,t,s)=>!h(this,Oe)&&!h(this,Ke)&&!t&&!s&&!this.finalized?new Response(e):q(this,ke,qe).call(this,e,t,Ft(hn,s)));M(this,"json",(e,t,s)=>q(this,ke,qe).call(this,JSON.stringify(e),t,Ft("application/json",s)));M(this,"html",(e,t,s)=>{const n=a=>q(this,ke,qe).call(this,a,t,Ft("text/html; charset=UTF-8",s));return typeof e=="object"?fs(e,_n.Stringify,!1,{}).then(n):n(e)});M(this,"redirect",(e,t)=>{const s=String(e);return this.header("Location",/[^\x00-\xFF]/.test(s)?encodeURI(s):s),this.newResponse(null,t??302)});M(this,"notFound",()=>(h(this,Qe)??I(this,Qe,()=>new Response),h(this,Qe).call(this,this)));I(this,ct,e),t&&(I(this,ye,t.executionCtx),this.env=t.env,I(this,Qe,t.notFoundHandler),I(this,mt,t.path),I(this,pt,t.matchResult))}get req(){return h(this,dt)??I(this,dt,new ps(h(this,ct),h(this,mt),h(this,pt))),h(this,dt)}get event(){if(h(this,ye)&&"respondWith"in h(this,ye))return h(this,ye);throw Error("This context has no FetchEvent")}get executionCtx(){if(h(this,ye))return h(this,ye);throw Error("This context has no ExecutionContext")}get res(){return h(this,oe)||I(this,oe,new Response(null,{headers:h(this,Oe)??I(this,Oe,new Headers)}))}set res(e){if(h(this,oe)&&e){e=new Response(e.body,e);for(const[t,s]of h(this,oe).headers.entries())if(t!=="content-type")if(t==="set-cookie"){const n=h(this,oe).headers.getSetCookie();e.headers.delete("set-cookie");for(const a of n)e.headers.append("set-cookie",a)}else e.headers.set(t,s)}I(this,oe,e),this.finalized=!0}get var(){return h(this,he)?Object.fromEntries(h(this,he)):{}}},ct=new WeakMap,dt=new WeakMap,he=new WeakMap,Ke=new WeakMap,ye=new WeakMap,oe=new WeakMap,ut=new WeakMap,Ze=new WeakMap,Qe=new WeakMap,Oe=new WeakMap,pt=new WeakMap,mt=new WeakMap,ke=new WeakSet,qe=function(e,t,s){const n=h(this,oe)?new Headers(h(this,oe).headers):h(this,Oe)??new Headers;if(typeof t=="object"&&"headers"in t){const i=t.headers instanceof Headers?t.headers:new Headers(t.headers);for(const[r,l]of i)r.toLowerCase()==="set-cookie"?n.append(r,l):n.set(r,l)}if(s)for(const[i,r]of Object.entries(s))if(typeof r=="string")n.set(i,r);else{n.delete(i);for(const l of r)n.append(i,l)}const a=typeof t=="number"?t:(t==null?void 0:t.status)??h(this,Ke);return new Response(e,{status:a,headers:n})},ss),ee="ALL",bn="all",En=["get","post","put","delete","options","patch"],_s="Can not add a route since the matcher is already built.",hs=class extends Error{},vn="__COMPOSED_HANDLER",wn=e=>e.text("404 Not Found",404),Xt=(e,t)=>{if("getResponse"in e){const s=e.getResponse();return t.newResponse(s.body,s)}return console.error(e),t.text("Internal Server Error",500)},de,te,ys,ue,$e,vt,wt,Je,Sn=(Je=class{constructor(t={}){B(this,te);M(this,"get");M(this,"post");M(this,"put");M(this,"delete");M(this,"options");M(this,"patch");M(this,"all");M(this,"on");M(this,"use");M(this,"router");M(this,"getPath");M(this,"_basePath","/");B(this,de,"/");M(this,"routes",[]);B(this,ue,wn);M(this,"errorHandler",Xt);M(this,"onError",t=>(this.errorHandler=t,this));M(this,"notFound",t=>(I(this,ue,t),this));M(this,"fetch",(t,...s)=>q(this,te,wt).call(this,t,s[1],s[0],t.method));M(this,"request",(t,s,n,a)=>t instanceof Request?this.fetch(s?new Request(t,s):t,n,a):(t=t.toString(),this.fetch(new Request(/^https?:\/\//.test(t)?t:`http://localhost${Ge("/",t)}`,s),n,a)));M(this,"fire",()=>{addEventListener("fetch",t=>{t.respondWith(q(this,te,wt).call(this,t.request,t,void 0,t.request.method))})});[...En,bn].forEach(i=>{this[i]=(r,...l)=>(typeof r=="string"?I(this,de,r):q(this,te,$e).call(this,i,h(this,de),r),l.forEach(o=>{q(this,te,$e).call(this,i,h(this,de),o)}),this)}),this.on=(i,r,...l)=>{for(const o of[r].flat()){I(this,de,o);for(const c of[i].flat())l.map(d=>{q(this,te,$e).call(this,c.toUpperCase(),h(this,de),d)})}return this},this.use=(i,...r)=>(typeof i=="string"?I(this,de,i):(I(this,de,"*"),r.unshift(i)),r.forEach(l=>{q(this,te,$e).call(this,ee,h(this,de),l)}),this);const{strict:n,...a}=t;Object.assign(this,a),this.getPath=n??!0?t.getPath??ls:mn}route(t,s){const n=this.basePath(t);return s.routes.map(a=>{var r;let i;s.errorHandler===Xt?i=a.handler:(i=async(l,o)=>(await qt([],s.errorHandler)(l,()=>a.handler(l,o))).res,i[vn]=a.handler),q(r=n,te,$e).call(r,a.method,a.path,i)}),this}basePath(t){const s=q(this,te,ys).call(this);return s._basePath=Ge(this._basePath,t),s}mount(t,s,n){let a,i;n&&(typeof n=="function"?i=n:(i=n.optionHandler,n.replaceRequest===!1?a=o=>o:a=n.replaceRequest));const r=i?o=>{const c=i(o);return Array.isArray(c)?c:[c]}:o=>{let c;try{c=o.executionCtx}catch{}return[o.env,c]};a||(a=(()=>{const o=Ge(this._basePath,t),c=o==="/"?0:o.length;return d=>{const p=new URL(d.url);return p.pathname=p.pathname.slice(c)||"/",new Request(p,d)}})());const l=async(o,c)=>{const d=await s(a(o.req.raw),...r(o));if(d)return d;await c()};return q(this,te,$e).call(this,ee,Ge(t,"*"),l),this}},de=new WeakMap,te=new WeakSet,ys=function(){const t=new Je({router:this.router,getPath:this.getPath});return t.errorHandler=this.errorHandler,I(t,ue,h(this,ue)),t.routes=this.routes,t},ue=new WeakMap,$e=function(t,s,n){t=t.toUpperCase(),s=Ge(this._basePath,s);const a={basePath:this._basePath,path:s,method:t,handler:n};this.router.add(t,s,[n,a]),this.routes.push(a)},vt=function(t,s){if(t instanceof Error)return this.errorHandler(t,s);throw t},wt=function(t,s,n,a){if(a==="HEAD")return(async()=>new Response(null,await q(this,te,wt).call(this,t,s,n,"GET")))();const i=this.getPath(t,{env:n}),r=this.router.match(a,i),l=new yn(t,{path:i,matchResult:r,env:n,executionCtx:s,notFoundHandler:h(this,ue)});if(r[0].length===1){let c;try{c=r[0][0][0][0](l,async()=>{l.res=await h(this,ue).call(this,l)})}catch(d){return q(this,te,vt).call(this,d,l)}return c instanceof Promise?c.then(d=>d||(l.finalized?l.res:h(this,ue).call(this,l))).catch(d=>q(this,te,vt).call(this,d,l)):c??h(this,ue).call(this,l)}const o=qt(r[0],this.errorHandler,h(this,ue));return(async()=>{try{const c=await o(l);if(!c.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return c.res}catch(c){return q(this,te,vt).call(this,c,l)}})()},Je),bs=[];function xn(e,t){const s=this.buildAllMatchers(),n=((a,i)=>{const r=s[a]||s[ee],l=r[2][i];if(l)return l;const o=i.match(r[0]);if(!o)return[[],bs];const c=o.indexOf("",1);return[r[1][c],o]});return this.match=n,n(e,t)}var Tt="[^/]+",rt=".*",ot="(?:|/.*)",ze=Symbol(),Tn=new Set(".\\+*[^]$()");function Ln(e,t){return e.length===1?t.length===1?e<t?-1:1:-1:t.length===1||e===rt||e===ot?1:t===rt||t===ot?-1:e===Tt?1:t===Tt?-1:e.length===t.length?e<t?-1:1:t.length-e.length}var Ce,Be,pe,He,kn=(He=class{constructor(){B(this,Ce);B(this,Be);B(this,pe,Object.create(null))}insert(t,s,n,a,i){if(t.length===0){if(h(this,Ce)!==void 0)throw ze;if(i)return;I(this,Ce,s);return}const[r,...l]=t,o=r==="*"?l.length===0?["","",rt]:["","",Tt]:r==="/*"?["","",ot]:r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let c;if(o){const d=o[1];let p=o[2]||Tt;if(d&&o[2]&&(p===".*"||(p=p.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(p))))throw ze;if(c=h(this,pe)[p],!c){if(Object.keys(h(this,pe)).some(u=>u!==rt&&u!==ot))throw ze;if(i)return;c=h(this,pe)[p]=new He,d!==""&&I(c,Be,a.varIndex++)}!i&&d!==""&&n.push([d,h(c,Be)])}else if(c=h(this,pe)[r],!c){if(Object.keys(h(this,pe)).some(d=>d.length>1&&d!==rt&&d!==ot))throw ze;if(i)return;c=h(this,pe)[r]=new He}c.insert(l,s,n,a,i)}buildRegExpStr(){const s=Object.keys(h(this,pe)).sort(Ln).map(n=>{const a=h(this,pe)[n];return(typeof h(a,Be)=="number"?`(${n})@${h(a,Be)}`:Tn.has(n)?`\\${n}`:n)+a.buildRegExpStr()});return typeof h(this,Ce)=="number"&&s.unshift(`#${h(this,Ce)}`),s.length===0?"":s.length===1?s[0]:"(?:"+s.join("|")+")"}},Ce=new WeakMap,Be=new WeakMap,pe=new WeakMap,He),Rt,gt,ns,Rn=(ns=class{constructor(){B(this,Rt,{varIndex:0});B(this,gt,new kn)}insert(e,t,s){const n=[],a=[];for(let r=0;;){let l=!1;if(e=e.replace(/\{[^}]+\}/g,o=>{const c=`@\\${r}`;return a[r]=[c,o],r++,l=!0,c}),!l)break}const i=e.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let r=a.length-1;r>=0;r--){const[l]=a[r];for(let o=i.length-1;o>=0;o--)if(i[o].indexOf(l)!==-1){i[o]=i[o].replace(l,a[r][1]);break}}return h(this,gt).insert(i,t,n,h(this,Rt),s),n}buildRegExp(){let e=h(this,gt).buildRegExpStr();if(e==="")return[/^$/,[],[]];let t=0;const s=[],n=[];return e=e.replace(/#(\d+)|@(\d+)|\.\*\$/g,(a,i,r)=>i!==void 0?(s[++t]=Number(i),"$()"):(r!==void 0&&(n[Number(r)]=++t),"")),[new RegExp(`^${e}`),s,n]}},Rt=new WeakMap,gt=new WeakMap,ns),An=[/^$/,[],Object.create(null)],St=Object.create(null);function Es(e){return St[e]??(St[e]=new RegExp(e==="*"?"":`^${e.replace(/\/\*$|([.\\+*[^\]$()])/g,(t,s)=>s?`\\${s}`:"(?:|/.*)")}$`))}function In(){St=Object.create(null)}function Dn(e){var c;const t=new Rn,s=[];if(e.length===0)return An;const n=e.map(d=>[!/\*|\/:/.test(d[0]),...d]).sort(([d,p],[u,m])=>d?1:u?-1:p.length-m.length),a=Object.create(null);for(let d=0,p=-1,u=n.length;d<u;d++){const[m,f,g]=n[d];m?a[f]=[g.map(([y])=>[y,Object.create(null)]),bs]:p++;let _;try{_=t.insert(f,p,m)}catch(y){throw y===ze?new hs(f):y}m||(s[p]=g.map(([y,E])=>{const b=Object.create(null);for(E-=1;E>=0;E--){const[T,P]=_[E];b[T]=P}return[y,b]}))}const[i,r,l]=t.buildRegExp();for(let d=0,p=s.length;d<p;d++)for(let u=0,m=s[d].length;u<m;u++){const f=(c=s[d][u])==null?void 0:c[1];if(!f)continue;const g=Object.keys(f);for(let _=0,y=g.length;_<y;_++)f[g[_]]=l[f[g[_]]]}const o=[];for(const d in r)o[d]=s[r[d]];return[i,o,a]}function Ve(e,t){if(e){for(const s of Object.keys(e).sort((n,a)=>a.length-n.length))if(Es(s).test(t))return[...e[s]]}}var Re,Ae,At,vs,as,Mn=(as=class{constructor(){B(this,At);M(this,"name","RegExpRouter");B(this,Re);B(this,Ae);M(this,"match",xn);I(this,Re,{[ee]:Object.create(null)}),I(this,Ae,{[ee]:Object.create(null)})}add(e,t,s){var l;const n=h(this,Re),a=h(this,Ae);if(!n||!a)throw new Error(_s);n[e]||[n,a].forEach(o=>{o[e]=Object.create(null),Object.keys(o[ee]).forEach(c=>{o[e][c]=[...o[ee][c]]})}),t==="/*"&&(t="*");const i=(t.match(/\/:/g)||[]).length;if(/\*$/.test(t)){const o=Es(t);e===ee?Object.keys(n).forEach(c=>{var d;(d=n[c])[t]||(d[t]=Ve(n[c],t)||Ve(n[ee],t)||[])}):(l=n[e])[t]||(l[t]=Ve(n[e],t)||Ve(n[ee],t)||[]),Object.keys(n).forEach(c=>{(e===ee||e===c)&&Object.keys(n[c]).forEach(d=>{o.test(d)&&n[c][d].push([s,i])})}),Object.keys(a).forEach(c=>{(e===ee||e===c)&&Object.keys(a[c]).forEach(d=>o.test(d)&&a[c][d].push([s,i]))});return}const r=cs(t)||[t];for(let o=0,c=r.length;o<c;o++){const d=r[o];Object.keys(a).forEach(p=>{var u;(e===ee||e===p)&&((u=a[p])[d]||(u[d]=[...Ve(n[p],d)||Ve(n[ee],d)||[]]),a[p][d].push([s,i-c+o+1]))})}}buildAllMatchers(){const e=Object.create(null);return Object.keys(h(this,Ae)).concat(Object.keys(h(this,Re))).forEach(t=>{e[t]||(e[t]=q(this,At,vs).call(this,t))}),I(this,Re,I(this,Ae,void 0)),In(),e}},Re=new WeakMap,Ae=new WeakMap,At=new WeakSet,vs=function(e){const t=[];let s=e===ee;return[h(this,Re),h(this,Ae)].forEach(n=>{const a=n[e]?Object.keys(n[e]).map(i=>[i,n[e][i]]):[];a.length!==0?(s||(s=!0),t.push(...a)):e!==ee&&t.push(...Object.keys(n[ee]).map(i=>[i,n[ee][i]]))}),s?Dn(t):null},as),Ie,be,is,$n=(is=class{constructor(e){M(this,"name","SmartRouter");B(this,Ie,[]);B(this,be,[]);I(this,Ie,e.routers)}add(e,t,s){if(!h(this,be))throw new Error(_s);h(this,be).push([e,t,s])}match(e,t){if(!h(this,be))throw new Error("Fatal error");const s=h(this,Ie),n=h(this,be),a=s.length;let i=0,r;for(;i<a;i++){const l=s[i];try{for(let o=0,c=n.length;o<c;o++)l.add(...n[o]);r=l.match(e,t)}catch(o){if(o instanceof hs)continue;throw o}this.match=l.match.bind(l),I(this,Ie,[l]),I(this,be,void 0);break}if(i===a)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,r}get activeRouter(){if(h(this,be)||h(this,Ie).length!==1)throw new Error("No active router has been determined yet.");return h(this,Ie)[0]}},Ie=new WeakMap,be=new WeakMap,is),it=Object.create(null),De,ie,Ue,et,se,Ee,Ne,tt,Nn=(tt=class{constructor(t,s,n){B(this,Ee);B(this,De);B(this,ie);B(this,Ue);B(this,et,0);B(this,se,it);if(I(this,ie,n||Object.create(null)),I(this,De,[]),t&&s){const a=Object.create(null);a[t]={handler:s,possibleKeys:[],score:0},I(this,De,[a])}I(this,Ue,[])}insert(t,s,n){I(this,et,++Gt(this,et)._);let a=this;const i=ln(s),r=[];for(let l=0,o=i.length;l<o;l++){const c=i[l],d=i[l+1],p=un(c,d),u=Array.isArray(p)?p[0]:c;if(u in h(a,ie)){a=h(a,ie)[u],p&&r.push(p[1]);continue}h(a,ie)[u]=new tt,p&&(h(a,Ue).push(p),r.push(p[1])),a=h(a,ie)[u]}return h(a,De).push({[t]:{handler:n,possibleKeys:r.filter((l,o,c)=>c.indexOf(l)===o),score:h(this,et)}}),a}search(t,s){var o;const n=[];I(this,se,it);let i=[this];const r=os(s),l=[];for(let c=0,d=r.length;c<d;c++){const p=r[c],u=c===d-1,m=[];for(let f=0,g=i.length;f<g;f++){const _=i[f],y=h(_,ie)[p];y&&(I(y,se,h(_,se)),u?(h(y,ie)["*"]&&n.push(...q(this,Ee,Ne).call(this,h(y,ie)["*"],t,h(_,se))),n.push(...q(this,Ee,Ne).call(this,y,t,h(_,se)))):m.push(y));for(let E=0,b=h(_,Ue).length;E<b;E++){const T=h(_,Ue)[E],P=h(_,se)===it?{}:{...h(_,se)};if(T==="*"){const k=h(_,ie)["*"];k&&(n.push(...q(this,Ee,Ne).call(this,k,t,h(_,se))),I(k,se,P),m.push(k));continue}const[S,R,U]=T;if(!p&&!(U instanceof RegExp))continue;const O=h(_,ie)[S],x=r.slice(c).join("/");if(U instanceof RegExp){const k=U.exec(x);if(k){if(P[R]=k[0],n.push(...q(this,Ee,Ne).call(this,O,t,h(_,se),P)),Object.keys(h(O,ie)).length){I(O,se,P);const w=((o=k[0].match(/\//))==null?void 0:o.length)??0;(l[w]||(l[w]=[])).push(O)}continue}}(U===!0||U.test(p))&&(P[R]=p,u?(n.push(...q(this,Ee,Ne).call(this,O,t,P,h(_,se))),h(O,ie)["*"]&&n.push(...q(this,Ee,Ne).call(this,h(O,ie)["*"],t,P,h(_,se)))):(I(O,se,P),m.push(O)))}}i=m.concat(l.shift()??[])}return n.length>1&&n.sort((c,d)=>c.score-d.score),[n.map(({handler:c,params:d})=>[c,d])]}},De=new WeakMap,ie=new WeakMap,Ue=new WeakMap,et=new WeakMap,se=new WeakMap,Ee=new WeakSet,Ne=function(t,s,n,a){const i=[];for(let r=0,l=h(t,De).length;r<l;r++){const o=h(t,De)[r],c=o[s]||o[ee],d={};if(c!==void 0&&(c.params=Object.create(null),i.push(c),n!==it||a&&a!==it))for(let p=0,u=c.possibleKeys.length;p<u;p++){const m=c.possibleKeys[p],f=d[c.score];c.params[m]=a!=null&&a[m]&&!f?a[m]:n[m]??(a==null?void 0:a[m]),d[c.score]=!0}}return i},tt),Pe,rs,Fn=(rs=class{constructor(){M(this,"name","TrieRouter");B(this,Pe);I(this,Pe,new Nn)}add(e,t,s){const n=cs(t);if(n){for(let a=0,i=n.length;a<i;a++)h(this,Pe).insert(e,n[a],s);return}h(this,Pe).insert(e,t,s)}match(e,t){return h(this,Pe).search(e,t)}},Pe=new WeakMap,rs),_e=class extends Sn{constructor(e={}){super(e),this.router=e.router??new $n({routers:[new Mn,new Fn]})}},On=e=>{const s={...{origin:"*",allowMethods:["GET","HEAD","PUT","POST","DELETE","PATCH"],allowHeaders:[],exposeHeaders:[]},...e},n=(i=>typeof i=="string"?i==="*"?()=>i:r=>i===r?r:null:typeof i=="function"?i:r=>i.includes(r)?r:null)(s.origin),a=(i=>typeof i=="function"?i:Array.isArray(i)?()=>i:()=>[])(s.allowMethods);return async function(r,l){var d;function o(p,u){r.res.headers.set(p,u)}const c=await n(r.req.header("origin")||"",r);if(c&&o("Access-Control-Allow-Origin",c),s.credentials&&o("Access-Control-Allow-Credentials","true"),(d=s.exposeHeaders)!=null&&d.length&&o("Access-Control-Expose-Headers",s.exposeHeaders.join(",")),r.req.method==="OPTIONS"){s.origin!=="*"&&o("Vary","Origin"),s.maxAge!=null&&o("Access-Control-Max-Age",s.maxAge.toString());const p=await a(r.req.header("origin")||"",r);p.length&&o("Access-Control-Allow-Methods",p.join(","));let u=s.allowHeaders;if(!(u!=null&&u.length)){const m=r.req.header("Access-Control-Request-Headers");m&&(u=m.split(/\s*,\s*/))}return u!=null&&u.length&&(o("Access-Control-Allow-Headers",u.join(",")),r.res.headers.append("Vary","Access-Control-Request-Headers")),r.res.headers.delete("Content-Length"),r.res.headers.delete("Content-Type"),new Response(null,{headers:r.res.headers,status:204,statusText:"No Content"})}await l(),s.origin!=="*"&&r.header("Vary","Origin",{append:!0})}};function Fe(e,t){return e.length<t?0:e.slice(-t).reduce((n,a)=>n+a,0)/t}function Lt(e,t){if(e.length<t)return 0;const s=2/(t+1);let n=Fe(e.slice(0,t),t);for(let a=t;a<e.length;a++)n=(e[a]-n)*s+n;return n}function Cn(e,t=14){if(e.length<t+1)return 50;const s=[];for(let o=1;o<e.length;o++)s.push(e[o]-e[o-1]);let n=0,a=0;for(let o=0;o<t;o++)s[o]>0?n+=s[o]:a+=Math.abs(s[o]);let i=n/t,r=a/t;for(let o=t;o<s.length;o++){const c=s[o];i=(i*(t-1)+(c>0?c:0))/t,r=(r*(t-1)+(c<0?Math.abs(c):0))/t}return r===0?100:100-100/(1+i/r)}function Bn(e){const t=Lt(e,12),s=Lt(e,26),n=t-s,a=n*.9,i=n-a;return{macd:n,signal:a,histogram:i}}function Un(e,t=20,s=2){const n=Fe(e,t),i=e.slice(-t).reduce((l,o)=>l+Math.pow(o-n,2),0)/t,r=Math.sqrt(i);return{upper:n+r*s,middle:n,lower:n-r*s}}function Pn(e,t=14){if(e.length<t+1)return 10;const s=[];for(let i=1;i<e.length;i++){const r=e[i].high,l=e[i].low,o=e[i-1].close,c=Math.max(r-l,Math.abs(r-o),Math.abs(l-o));s.push(c)}const n=Fe(s,t);return Math.max(n,10)}function Hn(e,t=14,s=3){if(e.length<t)return{k:50,d:50};const n=e.slice(-t),a=n.map(p=>p.high),i=n.map(p=>p.low),r=e[e.length-1].close,l=Math.max(...a),o=Math.min(...i),c=(r-o)/(l-o)*100;return{k:c,d:c}}function jn(e,t=14){if(e.length<t+1)return{adx:0,plusDI:0,minusDI:0};let s=0,n=0,a=0;for(let c=1;c<Math.min(t+1,e.length);c++){const d=e[c].high,p=e[c].low,u=e[c-1].high,m=e[c-1].low,f=e[c-1].close,g=d-u,_=m-p;g>_&&g>0&&(s+=g),_>g&&_>0&&(n+=_),a+=Math.max(d-p,Math.abs(d-f),Math.abs(p-f))}const i=a>0?s/a*100:0,r=a>0?n/a*100:0;return{adx:i+r>0?Math.abs(i-r)/(i+r)*100:0,plusDI:i,minusDI:r}}function Wn(e){if(e.length<52)return{tenkan:0,kijun:0,senkouA:0,senkouB:0};const t=Math.min(9,e.length),s=e.slice(-t),n=Math.max(...s.map(y=>y.high)),a=Math.min(...s.map(y=>y.low)),i=(n+a)/2,r=Math.min(26,e.length),l=e.slice(-r),o=Math.max(...l.map(y=>y.high)),c=Math.min(...l.map(y=>y.low)),d=(o+c)/2,p=(i+d)/2,u=Math.min(52,e.length),m=e.slice(-u),f=Math.max(...m.map(y=>y.high)),g=Math.min(...m.map(y=>y.low)),_=(f+g)/2;return{tenkan:i,kijun:d,senkouA:p,senkouB:_}}function Yn(e,t=.02,s=.2){if(e.length<2)return e[e.length-1].close;const n=e[e.length-1],a=e[e.length-2];return n.close>a.close?n.low*.98:n.high*1.02}function Vn(e){if(e.length===0)return 0;let t=0,s=0;for(const n of e){const a=(n.high+n.low+n.close)/3,i=n.volume||1;t+=a*i,s+=i}return s>0?t/s:e[e.length-1].close}function Gn(e,t=50){const s=e.slice(-Math.min(t,e.length)),n=s.map(o=>o.high),a=s.map(o=>o.low),i=Math.max(...n),r=Math.min(...a),l=i-r;return{fib_0:i,fib_236:i-l*.236,fib_382:i-l*.382,fib_500:i-l*.5,fib_618:i-l*.618,fib_100:r}}function ve(e){if(e.length<50)return null;const t=e.map(d=>d.close),s=Bn(t),n=Un(t),a=Hn(e,14,3),i=jn(e,14),r=Wn(e),l=Yn(e),o=Vn(e),c=Gn(e,50);return{rsi_14:Cn(t,14),macd:s.macd,macd_signal:s.signal,macd_histogram:s.histogram,sma_20:Fe(t,20),sma_50:Fe(t,50),sma_200:e.length>=200?Fe(t,200):Fe(t,Math.min(100,e.length)),ema_12:Lt(t,12),ema_26:Lt(t,26),bb_upper:n.upper,bb_middle:n.middle,bb_lower:n.lower,atr_14:Pn(e,14),stochastic_k:a.k,stochastic_d:a.d,adx:i.adx,plus_di:i.plusDI,minus_di:i.minusDI,ichimoku_tenkan:r.tenkan,ichimoku_kijun:r.kijun,ichimoku_senkou_a:r.senkouA,ichimoku_senkou_b:r.senkouB,parabolic_sar:l,vwap:o,fib_382:c.fib_382,fib_500:c.fib_500,fib_618:c.fib_618}}function ne(e,t,s){const n=[];let a=0,i=0;if(t.adx<20)return{signal_type:"HOLD",trading_style:s,price:e,stop_loss:e,take_profit_1:e,take_profit_2:e,take_profit_3:e,confidence:30,reason:`Weak trend (ADX ${t.adx.toFixed(1)} < 20) - Ranging market, wait for stronger trend`};t.adx>25&&(n.push(`Strong trend (ADX ${t.adx.toFixed(1)})`),t.plus_di>t.minus_di?a+=2:i+=2),t.stochastic_k<20?(n.push("Stochastic oversold (<20)"),a+=2):t.stochastic_k<30?(n.push("Stochastic approaching oversold"),a+=1):t.stochastic_k>80?(n.push("Stochastic overbought (>80)"),i+=3):t.stochastic_k>70&&(n.push("Stochastic approaching overbought"),i+=2),t.stochastic_k>t.stochastic_d&&t.stochastic_k<50?(n.push("Stochastic bullish crossover"),a+=2):t.stochastic_k<t.stochastic_d&&t.stochastic_k>50&&(n.push("Stochastic bearish crossover"),i+=2),e>t.ichimoku_senkou_a&&e>t.ichimoku_senkou_b?(n.push("Price above Ichimoku Cloud (bullish)"),a+=2):e<t.ichimoku_senkou_a&&e<t.ichimoku_senkou_b&&(n.push("Price below Ichimoku Cloud (bearish)"),i+=2),t.ichimoku_tenkan>t.ichimoku_kijun?(n.push("Ichimoku bullish (Tenkan > Kijun)"),a+=1):t.ichimoku_tenkan<t.ichimoku_kijun&&(n.push("Ichimoku bearish (Tenkan < Kijun)"),i+=1),e>t.vwap?(n.push(`Price above VWAP ($${t.vwap.toFixed(2)})`),a+=1):e<t.vwap&&(n.push(`Price below VWAP ($${t.vwap.toFixed(2)})`),i+=1),t.fib_618&&e<=t.fib_618&&e>=t.fib_618*.99?(n.push("Near 61.8% Fibonacci support"),a+=2):t.fib_382&&e>=t.fib_382&&e<=t.fib_382*1.01&&(n.push("Near 38.2% Fibonacci resistance"),i+=2),t.rsi_14<30?(n.push("RSI oversold (<30)"),a+=2):t.rsi_14<40?(n.push("RSI below 40"),a+=1):t.rsi_14>70?(n.push("RSI overbought (>70)"),i+=3):t.rsi_14>65?(n.push("RSI approaching overbought (>65)"),i+=2):t.rsi_14>60&&(n.push("RSI above 60"),i+=1),t.macd>t.macd_signal&&t.macd_histogram>0?(n.push("MACD bullish crossover"),a+=2):t.macd<t.macd_signal&&t.macd_histogram<0&&(n.push("MACD bearish crossover"),i+=2),e>t.sma_20&&e>t.sma_50?(n.push("Price above SMA20 and SMA50"),a+=1):e<t.sma_20&&e<t.sma_50&&(n.push("Price below SMA20 and SMA50"),i+=1),e>t.sma_200?(n.push("Uptrend (above SMA200)"),a+=1):(n.push("Downtrend (below SMA200)"),i+=1),e<=t.bb_lower?(n.push("Price at lower Bollinger Band"),a+=2):e>=t.bb_upper&&(n.push("Price at upper Bollinger Band"),i+=2);const r=a+i,l=r>0?a/r*100:50;let o="HOLD",c=50;a>i+1?(o="BUY",c=Math.min(l,95)):i>a+1&&(o="SELL",c=Math.min(100-l,95)),t.adx>30&&Math.abs(a-i)>4&&(c=Math.min(c+5,95),n.push("High conviction signal"));const d=s==="day_trade"?1.5:2,p=s==="day_trade"?3:4,u=s==="day_trade"?4:5.5,m=s==="day_trade"?5:7,g=e*(1/100);let _,y,E,b;if(o==="BUY"){const T=e-t.atr_14*d;_=Math.max(T,e-g),y=e+t.atr_14*p,E=e+t.atr_14*u,b=e+t.atr_14*m}else if(o==="SELL"){const T=e+t.atr_14*d;_=Math.min(T,e+g),y=e-t.atr_14*p,E=e-t.atr_14*u,b=e-t.atr_14*m}else _=e,y=e,E=e,b=e;return{signal_type:o,trading_style:s,price:e,stop_loss:parseFloat(_.toFixed(2)),take_profit_1:parseFloat(y.toFixed(2)),take_profit_2:parseFloat(E.toFixed(2)),take_profit_3:parseFloat(b.toFixed(2)),confidence:parseFloat(c.toFixed(1)),reason:n.join(", ")}}async function Z(e,t){if(!e.botToken||!e.chatId||e.botToken==="your_bot_token_here")return console.log("Telegram not configured, skipping notification"),!1;const s=`https://api.telegram.org/bot${e.botToken}/sendMessage`;try{const a=await(await fetch(s,{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({chat_id:e.chatId,text:t,parse_mode:"HTML"})})).json();return a.ok||console.error("[Telegram] Send failed:",JSON.stringify(a)),a.ok===!0}catch(n){return console.error("Failed to send Telegram message:",n),!1}}function qn(e){return e.replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;")}function lt(e){const t=e.signal_type==="BUY"?"🟢":e.signal_type==="SELL"?"🔴":"⚪",s=e.trading_style==="day_trade"?"📊 Day Trade":"📈 Swing Trade";return`
...
⏰ ${new Date().toLocaleString()}
  `.trim()}function ws(e,t){if(!e)throw console.error("[determineTrend] indicators is null/undefined!"),new Error("Indicators is undefined");if(e.rsi_14===void 0)throw console.error("[determineTrend] rsi_14 is undefined! Indicators:",Object.keys(e)),new Error("rsi_14 is undefined in indicators");let s=0,n=0,a=0;e.macd>e.macd_signal&&e.macd_histogram>0?s+=3:e.macd<e.macd_signal&&e.macd_histogram<0&&(n+=3),a+=3,t>e.sma_20?s+=2:n+=2,a+=2,t>e.sma_50?s+=2:n+=2,a+=2,t>e.sma_200?s+=3:n+=3,a+=3,e.adx&&e.adx>25&&e.plus_di&&e.minus_di&&(e.plus_di>e.minus_di?s+=2:n+=2,a+=2),e.rsi_14>50?s+=1:n+=1,a+=1;const i=s/a*100,r=n/a*100,l=Math.abs(i-r);let o,c;return i>60?(o="BULLISH",c=i):r>60?(o="BEARISH",c=r):(o="NEUTRAL",c=50),{timeframe:"1h",trend:o,strength:l,confidence:c}}function jt(e,t){console.log("[analyzeTimeframeAlignment] START"),console.log("[analyzeTimeframeAlignment] indicators keys:",Object.keys(e||{})),console.log("[analyzeTimeframeAlignment] currentPrice:",t);const s=[],n=["5m","15m","1h","4h","daily"];for(const d of n){console.log(`[analyzeTimeframeAlignment] Processing ${d}`);const p=e[d];if(p){console.log(`[analyzeTimeframeAlignment] ${d} has indicators, calling determineTrend`),console.log(`[analyzeTimeframeAlignment] ${d} rsi_14:`,p.rsi_14,typeof p.rsi_14);const u=ws(p,t);u.timeframe=d,s.push(u)}else console.log(`[analyzeTimeframeAlignment] ${d} missing indicators`)}const a=s.filter(d=>d.trend==="BULLISH").length,i=s.filter(d=>d.trend==="BEARISH").length;s.filter(d=>d.trend==="NEUTRAL").length;const r=s.length,l=Math.max(a,i);let o,c;return a===r?(o="ALL_BULLISH",c=20):i===r?(o="ALL_BEARISH",c=20):a>=r*.8?(o="ALL_BULLISH",c=15):i>=r*.8?(o="ALL_BEARISH",c=15):a>=r*.6||i>=r*.6?(o="MIXED",c=10):(o="CONFLICTING",c=0),{score:l,type:o,confidenceBoost:c,trends:s}}function Pt(e,t){if(e==="HOLD")return{isValid:!1,confidence:50,reason:"HOLD signal - no trade"};const{trends:s,type:n,confidenceBoost:a}=t,i=s.find(p=>p.timeframe==="daily"),r=s.find(p=>p.timeframe==="4h"),l=s.find(p=>p.timeframe==="1h"),o=s.find(p=>p.timeframe==="15m"),c=s.find(p=>p.timeframe==="5m"),d=e==="BUY"&&(c==null?void 0:c.trend)==="BULLISH"&&(o==null?void 0:o.trend)==="BULLISH"&&(l==null?void 0:l.trend)==="BULLISH"&&(c.strength>70||o.strength>70||l.strength>70)||e==="SELL"&&(c==null?void 0:c.trend)==="BEARISH"&&(o==null?void 0:o.trend)==="BEARISH"&&(l==null?void 0:l.trend)==="BEARISH"&&(c.strength>70||o.strength>70||l.strength>70);return e==="BUY"?i&&i.trend==="BEARISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BEARISH - opposing BUY signal"}:r&&r.trend==="BEARISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BEARISH - opposing BUY signal"}:l&&l.trend==="BEARISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BEARISH - weak BUY setup"}:n==="ALL_BULLISH"?{isValid:!0,confidence:85+a,reason:`All timeframes BULLISH - high probability BUY (${t.score}/${s.length} aligned)`}:n==="MIXED"&&a>=15?{isValid:!0,confidence:75+a,reason:`Strong multi-timeframe BULLISH alignment (${t.score}/${s.length})`}:n==="MIXED"&&d?{isValid:!0,confidence:70+a,reason:`Lower timeframes (5m/15m/1h) strongly aligned BUY - immediate opportunity (${t.score}/${s.length})`}:a>=10?{isValid:!0,confidence:65+a,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip BUY (${t.score}/${s.length})`}:e==="SELL"?i&&i.trend==="BULLISH"&&i.strength>70?{isValid:!1,confidence:40,reason:"Daily timeframe strongly BULLISH - opposing SELL signal"}:r&&r.trend==="BULLISH"&&r.strength>70?{isValid:!1,confidence:45,reason:"4h timeframe strongly BULLISH - opposing SELL signal"}:l&&l.trend==="BULLISH"&&l.strength>60?{isValid:!1,confidence:50,reason:"1h timeframe BULLISH - weak SELL setup"}:n==="ALL_BEARISH"?{isValid:!0,confidence:85+a,reason:`All timeframes BEARISH - high probability SELL (${t.score}/${s.length} aligned)`}:n==="MIXED"&&a>=15?{isValid:!0,confidence:75+a,reason:`Strong multi-timeframe BEARISH alignment (${t.score}/${s.length})`}:n==="MIXED"&&d?{isValid:!0,confidence:70+a,reason:`Lower timeframes (5m/15m/1h) strongly aligned SELL - immediate opportunity (${t.score}/${s.length})`}:a>=10?{isValid:!0,confidence:65+a,reason:`Moderate multi-timeframe alignment (${t.score}/${s.length})`}:{isValid:!1,confidence:55,reason:`Weak timeframe alignment - skip SELL (${t.score}/${s.length})`}:{isValid:!1,confidence:50,reason:"Unknown signal type"}}function zn(e){const t=[`Multi-Timeframe Alignment: ${e.type}`];t.push(`Score: ${e.score}/${e.trends.length}`),t.push(`Confidence Boost: +${e.confidenceBoost}%`),t.push(""),t.push("Timeframe Analysis:");for(const s of e.trends){const n=s.trend==="BULLISH"?"📈":s.trend==="BEARISH"?"📉":"➡️";t.push(`  ${n} ${s.timeframe.padEnd(6)}: ${s.trend.padEnd(8)} (${s.confidence.toFixed(0)}% confident, ${s.strength.toFixed(0)}% strength)`)}return t.join(`
`)}const Ss=Object.freeze(Object.defineProperty({__proto__:null,analyzeTimeframeAlignment:jt,determineTrend:ws,formatAlignmentReport:zn,validateMultiTimeframeSignal:Pt},Symbol.toStringTag,{value:"Module"}));function Kt(e,t=.95){if(e.length===0)return 0;const s=[...e].sort((i,r)=>i-r),n=Math.floor((1-t)*s.length);return Math.abs(s[n]||0)}function Xn(e,t){const s=Kt(e,.95),n=Kt(e,.99),a=t*s,i=t*n;return{var_95:parseFloat(a.toFixed(2)),var_99:parseFloat(i.toFixed(2)),confidence_95:95,confidence_99:99,method:"historical",calculation_date:new Date().toISOString()}}function Kn(e,t,s,n){const a=t-e,i=a/t*100;let r=0;for(let c=n.length-1;c>=0&&n[c].balance<t;c--)r++;const l=i<=s,o=i>s;return{current_balance:parseFloat(e.toFixed(2)),peak_balance:parseFloat(t.toFixed(2)),current_drawdown:parseFloat(a.toFixed(2)),current_drawdown_pct:parseFloat(i.toFixed(2)),max_allowed_drawdown_pct:s,is_within_limit:l,should_pause_trading:o,days_in_drawdown:r}}function Zn(e,t,s=5){let n=0;const a=[];for(const o of e){const d=Math.abs(o.entry_price-o.stop_loss)*o.position_size,p=d/t*100;n+=d,a.push({position_id:o.id,entry_price:o.entry_price,stop_loss:o.stop_loss,risk_amount:parseFloat(d.toFixed(2)),risk_pct:parseFloat(p.toFixed(2))})}const i=n/t*100,r=i<=s,l=t*(s/100)-n;return{total_open_positions:e.length,total_risk_amount:parseFloat(n.toFixed(2)),total_risk_pct:parseFloat(i.toFixed(2)),max_allowed_risk_pct:s,is_within_limit:r,available_risk:parseFloat(l.toFixed(2)),positions:a}}function Qn(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.high),n=[];for(let o=2;o<s.length-2;o++)s[o]>s[o-1]&&s[o]>s[o-2]&&s[o]>s[o+1]&&s[o]>s[o+2]&&n.push({index:o,value:s[o]});if(n.length<3)return null;const a=n.slice(-3),[i,r,l]=a;if(r.value>i.value&&r.value>l.value&&Math.abs(i.value-l.value)/i.value<.02){const c=Math.min(i.value,l.value)*.995,d=c-(r.value-c);return{pattern_type:"Head and Shoulders",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+l.index,direction:"bearish",description:"Bearish reversal pattern with clear head and shoulders formation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat(r.value.toFixed(2)),historical_win_rate:65}}return null}function Jn(e){if(e.length<20)return null;const s=e.slice(-20).map(r=>r.close),n=s.slice(0,10),a=s.slice(10);if((n[n.length-1]-n[0])/n[0]>.02&&(Math.max(...a)-Math.min(...a))/a[0]<.015){const o=s[s.length-1],c=n[n.length-1]-n[0],d=o+c;return{pattern_type:"Bullish Flag",confidence:80,start_index:e.length-20,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern - strong uptrend followed by consolidation",target_price:parseFloat(d.toFixed(2)),invalidation_price:parseFloat((o*.98).toFixed(2)),historical_win_rate:68}}return null}function ea(e){if(e.length<25)return null;const t=e.slice(-25),s=t.map(c=>c.high),n=t.map(c=>c.low),i=(Math.max(...s)-Math.min(...s))/Math.max(...s),r=n.slice(0,6),l=n.slice(-6),o=(Math.min(...l)-Math.min(...r))/Math.min(...r);if(i<.01&&o>.015){const c=Math.max(...s),d=t[t.length-1].close,p=c+(c-Math.min(...n));return{pattern_type:"Ascending Triangle",confidence:70,start_index:e.length-25,end_index:e.length-1,direction:"bullish",description:"Bullish breakout pattern with rising support and flat resistance",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat((d*.975).toFixed(2)),historical_win_rate:72}}return null}function ta(e){if(e.length<30)return null;const s=e.slice(-30).map(o=>o.low),n=[];for(let o=2;o<s.length-2;o++)s[o]<s[o-1]&&s[o]<s[o-2]&&s[o]<s[o+1]&&s[o]<s[o+2]&&n.push({index:o,value:s[o]});if(n.length<2)return null;const a=n.slice(-2),[i,r]=a;if(Math.abs(i.value-r.value)/i.value<.015){const o=Math.max(...s.slice(i.index,r.index))*1.005,c=o+(o-i.value);return{pattern_type:"Double Bottom",confidence:75,start_index:e.length-30+i.index,end_index:e.length-30+r.index,direction:"bullish",description:"Bullish reversal pattern with two equal lows",target_price:parseFloat(c.toFixed(2)),invalidation_price:parseFloat(i.value.toFixed(2)),historical_win_rate:66}}return null}function sa(e){if(e.length<40)return null;const s=e.slice(-40).map(l=>l.close),n=s[0],a=Math.min(...s.slice(10,25)),i=s[25];if(Math.abs(n-i)/n<.02&&a<n*.95){const l=s.slice(25),o=Math.min(...l),c=(i-o)/i;if(c>.01&&c<.05){const d=n-a,p=i+d;return{pattern_type:"Cup and Handle",confidence:65,start_index:e.length-40,end_index:e.length-1,direction:"bullish",description:"Bullish continuation pattern with cup and handle formation",target_price:parseFloat(p.toFixed(2)),invalidation_price:parseFloat(o.toFixed(2)),historical_win_rate:61}}}return null}function na(e){const t=[],s=Qn(e);s&&t.push(s);const n=Jn(e);n&&t.push(n);const a=ea(e);a&&t.push(a);const i=ta(e);i&&t.push(i);const r=sa(e);r&&t.push(r);let l=0,o=0,c=0;for(const m of t)m.direction==="bullish"?(l++,c+=m.confidence):m.direction==="bearish"&&(o++,c+=m.confidence);let d="neutral",p=0;l>o?(d="bullish",p=Math.min(c/l/10,15)):o>l&&(d="bearish",p=Math.min(c/o/10,15));let u="";if(t.length===0)u="No significant chart patterns detected";else{const m=t.map(f=>f.pattern_type).join(", ");u=`Detected ${t.length} pattern(s): ${m}. Overall ${d} bias.`}return{patterns:t,overall_sentiment:d,confidence_boost:parseFloat(p.toFixed(1)),summary:u}}function aa(e,t){const s=e/t*100;return s<.3?"LOW":s<.6?"MEDIUM":s<1?"HIGH":"EXTREME"}function ia(e,t){let s=0;if(s+=Math.min(e.adx,40),t>e.sma_20&&e.sma_20>e.sma_50&&e.sma_50>e.sma_200)s+=30;else if(t<e.sma_20&&e.sma_20<e.sma_50&&e.sma_50<e.sma_200)s+=30;else{const a=[t>e.sma_20,e.sma_20>e.sma_50,e.sma_50>e.sma_200].filter(Boolean).length;s+=a*10}const n=Math.abs(e.macd_histogram)/e.atr_14;return s+=Math.min(n*10,30),Math.min(Math.round(s),100)}function ra(e,t){let s=0;e.rsi_14>70?s+=Math.min((e.rsi_14-70)*2,40):e.rsi_14<30&&(s+=Math.min((30-e.rsi_14)*2,40));const n=(t-e.bb_lower)/(e.bb_upper-e.bb_lower);return(n>.9||n<.1)&&(s+=30),e.stochastic_k>80?s+=Math.min((e.stochastic_k-80)*1.5,30):e.stochastic_k<20&&(s+=Math.min((20-e.stochastic_k)*1.5,30)),Math.min(Math.round(s),100)}function oa(e,t,s){const n=aa(t.atr_14,s),a=ia(t,s),i=ra(t,s);let r,l,o,c,d,p;const u=e.slice(-10),m=u.map(y=>y.volume||0),f=m.reduce((y,E)=>y+E,0)/m.length,_=(u[u.length-1].volume||0)>f*1.5;return n==="EXTREME"&&_?s>t.bb_upper&&t.rsi_14>60?(r="BREAKOUT",l=75,o=!0,c="Trend-following (aggressive entry)",d=1.3,p="Explosive upside breakout with volume - ride the momentum"):s<t.bb_lower&&t.rsi_14<40?(r="BREAKDOWN",l=75,o=!1,c="Wait for stabilization",d=.5,p="Sharp breakdown in progress - avoid trading until dust settles"):(r="RANGING",l=50,o=!1,c="Wait for direction",d=.5,p="Extreme volatility without clear direction - wait for clarity"):t.adx>30&&a>70?s>t.sma_20&&t.sma_20>t.sma_50&&t.plus_di>t.minus_di?(r="STRONG_UPTREND",l=90,o=!0,c="Trend-following (buy dips, trail stops)",d=1.5,p="Strong bullish trend confirmed - ideal for aggressive long positions"):(r="STRONG_DOWNTREND",l=90,o=!1,c="Stay in cash or short",d=.3,p="Strong bearish trend - avoid long positions"):t.adx>20&&a>40?s>t.sma_50&&t.plus_di>t.minus_di?(r="WEAK_UPTREND",l=70,o=!0,c="Trend-following (selective entries)",d=1,p="Moderate bullish trend - trade with normal position sizing"):(r="WEAK_DOWNTREND",l=70,o=!1,c="Reduce exposure or stay flat",d=.5,p="Moderate bearish trend - reduce risk or wait"):(r="RANGING",l=80,i>60?(o=!0,c="Mean-reversion (fade extremes)",d=.8,p="Choppy market with mean-reversion opportunities - trade extremes only"):(o=!1,c="Wait for trend to develop",d=.5,p="Choppy market without clear opportunity - stay on sidelines")),{regime:r,confidence:l,volatility:n,trend_strength:a,mean_reversion_score:i,should_trade:o,recommended_strategy:c,risk_adjustment:d,description:p}}function la(e){const t=e.length;let s=0,n=0,a=0,i=0;for(let o=0;o<t;o++)s+=o,n+=e[o],a+=o*e[o],i+=o*o;const r=(t*a-s*n)/(t*i-s*s),l=(n-r*s)/t;return{slope:r,intercept:l}}function ca(e,t,s){const n=e.map(l=>l.close),a=2/(t+1);let i=n[0];for(let l=1;l<n.length;l++)i=(n[l]-i)*a+i;const r=(n[n.length-1]-n[n.length-10])/10;return i+r*s}function da(e,t){const s=e.map(l=>l.close).slice(-20),n=[];for(let l=1;l<s.length;l++)n.push(s[l]-s[l-1]);const r=n.slice(-5).reduce((l,o)=>l+o,0)/5*t*Math.pow(.8,t);return s[s.length-1]+r}function ua(e,t,s){const n=e[e.length-1].close;e.map(r=>r.close).slice(-20);let a=0;t.rsi_14>50?a+=t.rsi_14-50:a-=50-t.rsi_14,t.macd>t.macd_signal?a+=20:a-=20,n>t.sma_20&&(a+=10),n>t.sma_50&&(a+=10);const i=a/100*s;return n+t.atr_14*i}function pa(e,t){const s=e.map(u=>u.close),n=s[s.length-1],a=10,i=s.slice(-a),r=Math.min(...i),l=Math.max(...i),o=i.map(u=>(u-r)/(l-r));let c={index:0,similarity:-1/0};for(let u=a;u<s.length-a-t;u++){const m=s.slice(u-a,u),f=Math.min(...m),g=Math.max(...m),_=m.map(b=>(b-f)/(g-f));let y=0;for(let b=0;b<a;b++)y+=Math.pow(o[b]-_[b],2);const E=-y;E>c.similarity&&(c={index:u,similarity:E})}const p=(s[c.index+t]-s[c.index])*(n/s[c.index]);return n+p}function Ot(e,t,s){const n=[],a=[],i=e.map(S=>S.close),{slope:r,intercept:l}=la(i.slice(-20)),o=r*(i.length-1+s)+l;n.push(o),a.push(1);const c=ca(e,12,s);n.push(c),a.push(1.5);const d=da(e,s);n.push(d),a.push(1.2);const p=ua(e,t,s);n.push(p),a.push(1.8);const u=pa(e,s);n.push(u),a.push(1.3);const m=a.reduce((S,R)=>S+R,0),g=n.reduce((S,R,U)=>S+R*a[U],0)/m,_=n.reduce((S,R)=>S+R,0)/n.length,y=n.reduce((S,R)=>S+Math.pow(R-_,2),0)/n.length,E=Math.sqrt(y),b=e[e.length-1].close,T=1-E/b,P=Math.max(50,Math.min(95,T*100));return{prediction:g,confidence:P}}function ma(e,t){const s=e[e.length-1].close,n=[],a=Ot(e,t,1),i=a.prediction-s,r=i/s*100;n.push({timeframe:"1h",predicted_price:parseFloat(a.prediction.toFixed(2)),confidence_interval_upper:parseFloat((a.prediction+t.atr_14*.8).toFixed(2)),confidence_interval_lower:parseFloat((a.prediction-t.atr_14*.8).toFixed(2)),confidence:parseFloat(a.confidence.toFixed(1)),direction:i>.5?"UP":i<-.5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(r.toFixed(2)),method:"Ensemble (5 models)"});const l=Ot(e,t,4),o=l.prediction-s,c=o/s*100;n.push({timeframe:"4h",predicted_price:parseFloat(l.prediction.toFixed(2)),confidence_interval_upper:parseFloat((l.prediction+t.atr_14*1.5).toFixed(2)),confidence_interval_lower:parseFloat((l.prediction-t.atr_14*1.5).toFixed(2)),confidence:parseFloat(l.confidence.toFixed(1)),direction:o>2?"UP":o<-2?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(c.toFixed(2)),method:"Ensemble (5 models)"});const d=Ot(e,t,24),p=d.prediction-s,u=p/s*100;n.push({timeframe:"24h",predicted_price:parseFloat(d.prediction.toFixed(2)),confidence_interval_upper:parseFloat((d.prediction+t.atr_14*2.5).toFixed(2)),confidence_interval_lower:parseFloat((d.prediction-t.atr_14*2.5).toFixed(2)),confidence:parseFloat(d.confidence.toFixed(1)),direction:p>5?"UP":p<-5?"DOWN":"NEUTRAL",expected_move_pct:parseFloat(u.toFixed(2)),method:"Ensemble (5 models)"});const m=n.filter(E=>E.direction==="UP").length,f=n.filter(E=>E.direction==="DOWN").length;let g,_=0;m>f?(g="BULLISH",_=Math.min(m*5,15)):f>m?(g="BEARISH",_=Math.min(f*5,15)):g="NEUTRAL";const y=`ML models predict ${g} movement. 1h: ${n[0].direction} (${n[0].expected_move_pct.toFixed(2)}%), 4h: ${n[1].direction} (${n[1].expected_move_pct.toFixed(2)}%), 24h: ${n[2].direction} (${n[2].expected_move_pct.toFixed(2)}%)`;return{current_price:parseFloat(s.toFixed(2)),predictions:n,overall_direction:g,confidence_boost:parseFloat(_.toFixed(1)),summary:y}}function Ct(e,t,s,n,a){const r=Math.abs(t-e)/s;let l;r<1?l=80:r<2?l=65:r<3?l=50:r<4?l=35:l=20;const o=(n-50)/10;l+=o;const c=(a-1)*5;return l+=c,Math.max(5,Math.min(95,l))}function ga(e,t,s,n,a){const r=Math.abs(e-t)/s;let l;if(r<1?l=60:r<1.5?l=40:r<2?l=25:l=15,a==="BUY"){const o=(n-50)/10;l-=o}else{const o=(n-50)/10;l-=o}return Math.max(5,Math.min(80,l))}function fa(e,t,s,n,a,i){const r=(s-e)*.5,l=(n-e)*.3,o=(a-e)*.2,c=t-e;return i.tp1/100*r+i.tp2/100*l+i.tp3/100*o+i.sl/100*c}function _a(e,t,s){const n=e.price,a=t.atr_14;let i=50;e.signal_type==="BUY"?(n>t.sma_20&&(i+=10),n>t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd>t.macd_signal&&(i+=10)):e.signal_type==="SELL"&&(n<t.sma_20&&(i+=10),n<t.sma_50&&(i+=10),t.adx>25&&(i+=Math.min(t.adx-25,20)),t.macd<t.macd_signal&&(i+=10)),i=Math.min(100,i);const r=s.slice(-50),l=[];for(let b=14;b<r.length;b++){const T=r.slice(b-14,b);let P=0;for(let S=1;S<T.length;S++){const R=Math.max(T[S].high-T[S].low,Math.abs(T[S].high-T[S-1].close),Math.abs(T[S].low-T[S-1].close));P+=R}l.push(P/14)}const o=l.reduce((b,T)=>b+T,0)/l.length,c=a/o,d=Ct(n,e.take_profit_1,a,i,c),p=Ct(n,e.take_profit_2,a,i,c),u=Ct(n,e.take_profit_3,a,i,c),m=ga(n,e.stop_loss,a,i,e.signal_type),f=fa(n,e.stop_loss,e.take_profit_1,e.take_profit_2,e.take_profit_3,{tp1:d,tp2:p,tp3:u,sl:m}),_=(d+p+u)/3/m;let y;d>70&&f>5&&_>2?y="STRONG_TRADE":d>60&&f>0&&_>1.5?y="GOOD_TRADE":d>50&&f>-2?y="MARGINAL_TRADE":y="AVOID_TRADE";const E=`TP1 has ${d.toFixed(0)}% chance of hitting. Expected value: $${f.toFixed(2)}. Risk-adjusted R:R: ${_.toFixed(2)}:1. Recommendation: ${y.replace(/_/g," ")}`;return{tp1_probability:parseFloat(d.toFixed(1)),tp2_probability:parseFloat(p.toFixed(1)),tp3_probability:parseFloat(u.toFixed(1)),stop_loss_probability:parseFloat(m.toFixed(1)),expected_value:parseFloat(f.toFixed(2)),risk_reward_adjusted:parseFloat(_.toFixed(2)),recommendation:y,summary:E}}function xs(e){if(!e||e.length<20)return{liquidity_score:50,volume_trend:"STABLE",volume_percentile:50,time_of_day_zone:"MEDIUM",session:"OFF_HOURS",estimated_spread_pips:50,price_impact_bps:20,market_depth_score:50,optimal_for_trading:!1,warnings:["Insufficient data for liquidity analysis"],recommendation:"Use caution - limited liquidity data available"};const t=ha(e),s=ya(),n=ba(e,s.session),a=Ea(t,s.session),i=va(t,s),r=wa(t,s,n,i),l=Sa(r,t,s,n),o=xa(r);return{liquidity_score:Math.round(r),volume_trend:t.trend,volume_percentile:Math.round(t.percentile),time_of_day_zone:s.zone,session:s.session,estimated_spread_pips:n.spread_pips,price_impact_bps:Math.round(a),market_depth_score:Math.round(i),optimal_for_trading:r>=70&&l.length===0,warnings:l,recommendation:o}}function ha(e){const t=e.slice(-10),s=e.slice(-20,-10),n=e.reduce((c,d)=>c+(d.volume||1),0)/e.length,a=t.reduce((c,d)=>c+(d.volume||1),0)/t.length,i=s.reduce((c,d)=>c+(d.volume||1),0)/s.length,r=a/n;let l;a>i*1.2?l="INCREASING":a<i*.8?l="DECREASING":l="STABLE";const o=Math.min(100,r*100);return{avg_volume:n,current_volume:a,volume_ratio:r,volume_spike:r>2,volume_drought:r<.5,trend:l,percentile:o}}function ya(){const e=new Date,t=e.getUTCHours(),s=e.getUTCMinutes(),n=t*60+s;let a,i;return n>=780&&n<960?(a="OVERLAP",i="HIGH"):n>=480&&n<780?(a="LONDON",i="HIGH"):n>=960&&n<1320?(a="NEW_YORK",i="HIGH"):n>=0&&n<480?(a="ASIA",i="MEDIUM"):(a="OFF_HOURS",i="LOW"),{zone:i,session:a}}function ba(e,t){const s=e.slice(-20);let n=0;for(const d of s){const p=d.high-d.low;n+=p}const a=n/s.length,i=s[s.length-1].close,r=a/i*100;let l=0;switch(t){case"OVERLAP":l=20;break;case"LONDON":case"NEW_YORK":l=30;break;case"ASIA":l=40;break;case"OFF_HOURS":l=60;break;default:l=40}const o=1+r*2,c=l*o;return{spread_pips:Math.round(c)}}function Ea(e,t){let s=10;const a={OVERLAP:.5,LONDON:.7,NEW_YORK:.7,ASIA:1.2,OFF_HOURS:2}[t]||1,i=e.volume_ratio<.5?2:e.volume_ratio<.8?1.5:e.volume_ratio>1.5?.8:1;return s*a*i}function va(e,t){let s=50;return e.volume_ratio>1.5?s+=30:e.volume_ratio>1.2?s+=20:e.volume_ratio>.8?s+=10:e.volume_ratio<.5&&(s-=20),t.zone==="HIGH"?s+=20:t.zone==="MEDIUM"?s+=10:s-=10,Math.max(0,Math.min(100,s))}function wa(e,t,s,n){const a=e.percentile*.3,i=(t.zone==="HIGH"?100:t.zone==="MEDIUM"?60:30)*.3,r=Math.max(0,100-s.spread_pips)*.2,l=n*.2;return a+i+r+l}function Sa(e,t,s,n){const a=[];return e<50&&a.push("⚠️ LOW LIQUIDITY: Reduce position size by 50%"),t.volume_drought&&a.push("⚠️ VOLUME DROUGHT: Current volume <50% of average"),s.session==="OFF_HOURS"&&a.push("⚠️ OFF-HOURS TRADING: Spreads are wider, slippage risk high"),n.spread_pips>50&&a.push(`⚠️ WIDE SPREADS: Estimated ${n.spread_pips} pips - costs are high`),s.zone==="LOW"&&t.volume_ratio<.8&&a.push("🔴 EXTREME LOW LIQUIDITY: Consider waiting for better conditions"),a}function xa(e,t,s){return e>=80?"✅ EXCELLENT LIQUIDITY - Optimal for trading. Full position size OK.":e>=70?"✅ GOOD LIQUIDITY - Safe to trade. Normal position size.":e>=60?"⚠️ MODERATE LIQUIDITY - Trade with caution. Reduce position size by 25%.":e>=50?"⚠️ LOW LIQUIDITY - High risk. Reduce position size by 50%.":"🔴 POOR LIQUIDITY - Avoid trading. Wait for better conditions."}const Wt=["2025-01-28","2025-01-29","2025-03-18","2025-03-19","2025-04-29","2025-04-30","2025-06-17","2025-06-18","2025-07-29","2025-07-30","2025-09-16","2025-09-17","2025-10-28","2025-10-29","2025-12-09","2025-12-10"];function Ta(e,t){let s=1;for(;s<=7;){if(new Date(e,t,s).getDay()===5)return s;s++}return 1}function It(e=30){const t=[],s=new Date;for(const a of Wt){const i=new Date(a),r=Math.floor((i.getTime()-s.getTime())/(1e3*60*60*24));r>=0&&r<=e&&(t.push({date:a,time:"19:00",title:"FOMC Interest Rate Decision",country:"USD",impact:"high",source:"static"}),t.push({date:a,time:"19:30",title:"FOMC Press Conference (Powell)",country:"USD",impact:"high",source:"static"}))}for(let a=0;a<=e;a++){const i=new Date(s.getTime()+a*24*60*60*1e3),r=i.getFullYear(),l=i.getMonth(),o=i.getDate(),c=i.getDay();if(o===Ta(r,l)&&c===5){const d=i.toISOString().split("T")[0];t.push({date:d,time:"13:30",title:"US Non-Farm Payrolls (NFP)",country:"USD",impact:"high",source:"static"}),t.push({date:d,time:"13:30",title:"US Unemployment Rate",country:"USD",impact:"high",source:"static"})}o===10&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Consumer Price Index (CPI)",country:"USD",impact:"high",source:"static"}),o===11&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Producer Price Index (PPI)",country:"USD",impact:"high",source:"static"}),o===15&&t.push({date:i.toISOString().split("T")[0],time:"13:30",title:"US Retail Sales",country:"USD",impact:"high",source:"static"}),(o===1||o<=3&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Manufacturing PMI",country:"USD",impact:"high",source:"static"}),(o===3||o<=5&&c>=1&&c<=5)&&t.push({date:i.toISOString().split("T")[0],time:"15:00",title:"US ISM Services PMI",country:"USD",impact:"high",source:"static"})}return t.filter((a,i,r)=>i===r.findIndex(l=>l.date===a.date&&l.time===a.time&&l.title===a.title)).sort((a,i)=>{const r=new Date(`${a.date}T${a.time}:00Z`),l=new Date(`${i.date}T${i.time}:00Z`);return r.getTime()-l.getTime()})}function ft(e=new Date,t=[]){const s=[...It(7),...t],n=s.filter(r=>new Date(`${r.date}T${r.time}:00Z`)>e).slice(0,10),a=e.toISOString().split("T")[0];if(s.filter(r=>r.date===a&&r.impact==="high"),Wt.includes(a))return{shouldTrade:!1,reason:"🚨 FOMC Meeting Day - No trading recommended",riskLevel:"danger",upcomingEvents:n,nextSafeTime:La(a)};new Date(e.getTime()+7200*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`),o=(l.getTime()-e.getTime())/(1e3*60);if(r.impact==="high"&&o>0&&o<=30)return{shouldTrade:!1,reason:`🚨 HIGH IMPACT: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()};if(r.impact==="high"&&o>30&&o<=120)return{shouldTrade:!0,reason:`⚠️ CAUTION: ${r.title} in ${Math.round(o)} minutes`,riskLevel:"caution",upcomingEvents:n,nextSafeTime:void 0}}const i=new Date(e.getTime()-1800*1e3);for(const r of s){const l=new Date(`${r.date}T${r.time}:00Z`);if(r.impact==="high"&&l>i&&l<e){const o=(e.getTime()-l.getTime())/6e4;return{shouldTrade:!1,reason:`🚨 ${r.title} just happened ${Math.round(o)} min ago - Wait for volatility to settle`,riskLevel:"danger",upcomingEvents:n,nextSafeTime:new Date(l.getTime()+1800*1e3).toISOString()}}}return{shouldTrade:!0,reason:"✅ No major economic events - Safe to trade",riskLevel:"safe",upcomingEvents:n}}function La(e){const t=new Date(e);return t.setDate(t.getDate()+1),t.toISOString().split("T")[0]}function xt(e){const s=new Date(`${e.date}T${e.time}:00Z`).toLocaleTimeString("en-US",{hour:"2-digit",minute:"2-digit",timeZone:"UTC"});let n="🔴";return e.impact==="medium"&&(n="🟡"),e.impact==="low"&&(n="🟢"),`${n} ${e.date} ${s} UTC - ${e.title}`}function ka(e){const t=e.toISOString().split("T")[0];return Wt.includes(t)?!0:It(30).filter(a=>a.date===t&&a.impact==="high").length>=2}function Ra(){const e=new Date().toISOString().split("T")[0];return It(7).filter(s=>s.date===e)}function Ts(e=new Date){const t=ft(e);return t.riskLevel==="danger"?{adjustment:-30,reason:t.reason}:t.riskLevel==="caution"?{adjustment:-15,reason:t.reason}:{adjustment:0,reason:t.reason}}const Ls=new _e;Ls.post("/enhanced",async e=>{var s;const{DB:t}=e.env;try{console.log("[ENHANCED] Starting request, DB:",!!t),console.log("[ENHANCED] Step 1: Fetching MTF data");const n={},a={};for(const C of["5m","15m","1h","4h","daily"]){const A=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(C).first();A&&(n[C]=A);const V=await t.prepare(`
      ...
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),l=(r==null?void 0:r.close)||0;if(!l)return e.json({success:!1,error:"Current price not available"},400);if(r!=null&&r.timestamp){const C=new Date(r.timestamp).getTime(),A=(Date.now()-C)/(1e3*60);A>60&&i.push(`⚠️ WARNING: Price data is ${A.toFixed(0)} minutes old`),console.log(`[ENHANCED] Price freshness: ${A.toFixed(1)} minutes old`)}console.log("[ENHANCED] Step 1.5: Checking economic calendar");const o=ft(),c=Ts();let d=null,p=!1;o.riskLevel==="danger"?(p=!0,d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR DANGER:",o.reason)):o.riskLevel==="caution"?(d=o.reason,console.log("[ENHANCED] ⚠️ CALENDAR CAUTION:",o.reason)):console.log("[ENHANCED] ✅ Calendar safe:",o.reason);const u=n["1h"];if(!u)return e.json({success:!1,error:`1h indicators not found. Available timeframes: ${Object.keys(n).join(", ")}`},400);const m=jt(n,l),f=ne(l,u,"day_trade"),g=ne(l,u,"swing_trade"),_=Pt(f.signal_type,m),y=Pt(g.signal_type,m),E={...f,base_confidence:f.confidence,mtf_confidence:_.confidence,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:m.score,alignment_type:m.type},b={...g,base_confidence:g.confidence,mtf_confidence:y.confidence,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:m.score,alignment_type:m.type};let T=0,P="",S=[];if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20){try{const A=na(a["1h"]);S=(A==null?void 0:A.patterns)||[]}catch(A){console.error("[ENHANCED] Pattern detection error:",A.message)}const C=S.filter(A=>A.confidence>=70&&A.endIndex>=a["1h"].length-5);for(const A of C)A.type==="bullish"&&E.signal_type==="BUY"?(T+=A.confidence*.1,P+=`${A.name} (${A.confidence.toFixed(0)}%), `):A.type==="bearish"&&E.signal_type==="SELL"&&(T+=A.confidence*.1,P+=`${A.name} (${A.confidence.toFixed(0)}%), `);T=Math.min(15,T)}let R=0,U="",O=null;if(a["1h"]&&a["1h"].length>=50){const C=ve(a["1h"]);C&&(O=oa(a["1h"],C),O.trend==="STRONG_UPTREND"&&E.signal_type==="BUY"?(R=10,U="Strong Uptrend"):O.trend==="UPTREND"&&E.signal_type==="BUY"?(R=5,U="Uptrend"):O.trend==="STRONG_DOWNTREND"&&E.signal_type==="SELL"?(R=10,U="Strong Downtrend"):O.trend==="DOWNTREND"&&E.signal_type==="SELL"&&(R=5,U="Downtrend"))}let x=0,k="",w=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{w=ma(a["1h"],l),w.overall_direction==="BULLISH"&&E.signal_type==="BUY"?(x=w.confidence_boost,k=`ML predicts +${((w.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`):w.overall_direction==="BEARISH"&&E.signal_type==="SELL"&&(x=w.confidence_boost,k=`ML predicts ${((w.predictions[0].predicted_price/l-1)*100).toFixed(2)}% in 1h`)}catch(C){console.error("[ENHANCED] ML prediction error:",C.message)}let W=0,re="",z=null;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=50)try{const C=ve(a["1h"]);C&&(z=_a(E,C,a["1h"]),z.tp1_probability>70?(W=10,re=`PoP: TP1 ${z.tp1_probability.toFixed(0)}%`):z.tp1_probability>60&&(W=5,re=`PoP: TP1 ${z.tp1_probability.toFixed(0)}%`))}catch(C){console.error("[ENHANCED] Probability of Profit error:",C.message)}let $=null,G=0,le=0;if(a["1h"]&&Array.isArray(a["1h"])&&a["1h"].length>=20)try{$=xs(a["1h"]),$.liquidity_score>=80?G=5:$.liquidity_score>=70?G=0:$.liquidity_score>=50?le=-5:le=-10,console.log(`[LIQUIDITY] Score: ${$.liquidity_score}/100, Session: ${$.session}, Adjust: ${G+le}%`)}catch(C){console.error("[ENHANCED] Liquidity Analysis error:",C.message)}let D=0,Y=0,K=0,L=0,ge="";try{const C=await t.prepare(`
      ...
      `).all(),V=await t.prepare(`
        ...
        WHERE account_id = 1
      `).all();if(C&&A.results&&A.results.length>=10){const v=Xn(A.results,C.balance);D=v.var_95,Y=v.var_99;const ae=Kn(C.balance,A.results);if(K=ae.current_drawdown_pct,ae.is_within_limit||(ge+=`⚠️ Drawdown ${K.toFixed(1)}% exceeds limit. `),V.results){const F=Zn(V.results,C.balance);L=F.total_risk_pct,F.is_within_limit||(ge+=`⚠️ Portfolio heat ${L.toFixed(1)}% exceeds limit. `)}}}catch(C){console.error("[ENHANCED] Risk metrics error (optional):",C.message)}const fe=T+R+x+W+G+le,j={...E,pattern_boost:T,regime_boost:R,ml_boost:x,pop_boost:W,total_boost:fe,enhanced_confidence:Math.min(98,E.final_confidence+fe),var_95:D,var_99:Y,current_drawdown_pct:K,portfolio_heat_pct:L,risk_warning:ge||null},N={...b,pattern_boost:T,regime_boost:R,ml_boost:x,pop_boost:W,total_boost:fe,enhanced_confidence:Math.min(98,b.final_confidence+fe),var_95:D,var_99:Y,current_drawdown_pct:K,portfolio_heat_pct:L,risk_warning:ge||null};p?(j.signal_type="HOLD",N.signal_type="HOLD",j.enhanced_confidence=50,N.enhanced_confidence=50,j.reasoning=d||"Economic event nearby - trading paused",N.reasoning=d||"Economic event nearby - trading paused",console.log("[ENHANCED] ⚠️ SIGNALS FORCED TO HOLD due to calendar")):c.adjustment<0&&(j.enhanced_confidence=Math.max(50,j.enhanced_confidence+c.adjustment),N.enhanced_confidence=Math.max(50,N.enhanced_confidence+c.adjustment),console.log("[ENHANCED] Applied calendar adjustment:",c.adjustment)),j.calendar_check={risk_level:o.riskLevel,should_trade:o.shouldTrade,reason:o.reason,confidence_adjustment:c.adjustment,upcoming_events:o.upcomingEvents.slice(0,3).map(C=>xt(C))},N.calendar_check=j.calendar_check;let Se=!1;try{const C=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),A={};for(const V of C.results||[])A[V.setting_key]=V.setting_value;if(A.telegram_bot_token&&A.telegram_chat_id){const V=new Date().toLocaleString("en-US",{timeZone:"UTC"});let v=`🏦 *HEDGE FUND GRADE SIGNAL*
⏰ ${V} UTC

`;if(i.length>0){v+=`⚠️ *DATA FRESHNESS WARNING*
`;for(const J of i)v+=`${J}
...
`,v+=`Next event: ${xt(o.upcomingEvents[0])}
...
`;for(const J of m.trends){const X=J.trend==="BULLISH"?"📈":J.trend==="BEARISH"?"📉":"➡️";v+=`${X} *${J.timeframe}*: ${J.trend} (${J.confidence.toFixed(0)}%)
`}if(v+=`
━━━━━━━━━━━━━━━━━━━━━━━━━
`,v+=`📈 *DAY TRADE SIGNAL*
`,v+=`━━━━━━━━━━━━━━━━━━━━━━━━━
...
`,T>0&&(v+=`Pattern: +${T.toFixed(0)}%
`),R>0&&(v+=`Regime: +${R.toFixed(0)}%
`),x>0&&(v+=`ML: +${x.toFixed(0)}%
`),W>0&&(v+=`PoP: +${W.toFixed(0)}%
`),G!==0||le!==0){const J=G+le;v+=`Liquidity: ${J>=0?"+":""}${J.toFixed(0)}%
`}v+=`*FINAL: ${j.enhanced_confidence.toFixed(0)}%*

`,O&&(v+=`🌡️ *Market Regime:* ${O.trend||"N/A"}
`,v+=`Volatility: ${O.volatility}
`,v+=`Should Trade: ${O.should_trade?"✅ YES":"❌ NO"}

`),w&&w.overall_direction!=="NEUTRAL"&&(v+=`🤖 *ML Prediction:* ${w.overall_direction}
`,(s=w.predictions[0])!=null&&s.predicted_price&&(v+=`1h Target: $${w.predictions[0].predicted_price.toFixed(2)}
`),v+=`
`),z&&(v+=`🎯 *Probability of Profit:*
`,v+=`TP1: ${z.tp1_probability.toFixed(0)}%
`,v+=`TP2: ${z.tp2_probability.toFixed(0)}%
`,v+=`TP3: ${z.tp3_probability.toFixed(0)}%
`,v+=`Expected Value: ${z.expected_value.toFixed(2)}R
...
`),v+=`
🌐 Dashboard: ${e.req.url.replace("/api/signals/enhanced/enhanced","")}`,console.log("[TELEGRAM] Message 1 length:",v.length,"characters");const ae=await Z({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},v);let F=`📊 *ADDITIONAL ANALYSIS*
━━━━━━━━━━━━━━━━━━━━━━━━━

`;if($){const J=$.liquidity_score>=80?"🟢":$.liquidity_score>=70?"🟡":$.liquidity_score>=50?"🟠":"🔴";if(F+=`🌊 *LIQUIDITY ANALYSIS*
`,F+=`━━━━━━━━━━━━━━━━━━━━━━━━━

`,F+=`${J} *Score:* ${$.liquidity_score}/100
`,F+=`🕐 *Session:* ${$.session}
`,F+=`📊 *Time Zone:* ${$.time_of_day_zone} LIQUIDITY
`,F+=`📈 *Volume:* ${$.volume_trend} (${$.volume_percentile}%)
`,F+=`💰 *Spread:* ~${$.estimated_spread_pips} pips
`,F+=`📉 *Price Impact:* ~${$.price_impact_bps} bps per $100k
`,F+=`🎯 *Market Depth:* ${$.market_depth_score}/100
`,F+=`✅ *Optimal:* ${$.optimal_for_trading?"YES":"NO"}

`,$.warnings.length>0){F+=`⚠️ *Liquidity Warnings:*
`;for(const X of $.warnings)F+=`• ${X}
`;F+=`
`}F+=`💡 *Recommendation:*
${$.recommendation}
...
`,F+=`• VaR(95%): $${D.toFixed(2)}
`,F+=`• VaR(99%): $${Y.toFixed(2)}
`,F+=`• Max Drawdown: ${K.toFixed(2)}%
`,F+=`• Portfolio Heat: ${L.toFixed(1)}%

`,o.upcomingEvents.length>0){F+=`📅 *Upcoming Events:*
`;for(const J of o.upcomingEvents.slice(0,3))F+=`• ${xt(J)}
`;F+=`
`}F+=`━━━━━━━━━━━━━━━━━━━━━━━━━
`,F+=`✅ Signal generated at ${V} UTC
`,F+="🤖 Powered by Hedge Fund Grade AI",console.log("[TELEGRAM] Message 2 length:",F.length,"characters");const je=await Z({botToken:A.telegram_bot_token,chatId:A.telegram_chat_id},F);Se=ae&&je}}catch(C){console.error("[ENHANCED] Telegram error (optional):",C.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:l,telegram_sent:Se,day_trade:j,swing_trade:N,alignment:{type:m.type,score:m.score,trends:m.trends},patterns:S.length>0?S.slice(0,3):null,regime:O?{trend:O.trend,volatility:O.volatility,should_trade:O.should_trade}:null,ml_prediction:w?{direction:w.overall_direction,predictions:w.predictions}:null,profit_probability:z?{tp1:z.tp1_probability,tp2:z.tp2_probability,tp3:z.tp3_probability,expected_value:z.expected_value}:null,liquidity:$?{score:$.liquidity_score,session:$.session,time_zone:$.time_of_day_zone,volume_trend:$.volume_trend,volume_percentile:$.volume_percentile,estimated_spread_pips:$.estimated_spread_pips,price_impact_bps:$.price_impact_bps,market_depth_score:$.market_depth_score,optimal_for_trading:$.optimal_for_trading,warnings:$.warnings,recommendation:$.recommendation}:null,risk_metrics:{var_95:D,var_99:Y,drawdown_pct:K,portfolio_heat_pct:L}})}catch(n){return console.error("[ENHANCED] Error:",n.message,n.stack),e.json({success:!1,error:n.message,stack:n.stack},500)}});const ks=new _e;ks.post("/simple",async e=>{var s,n,a,i;const{DB:t}=e.env;try{console.log("[SIMPLE] Starting simple signal generation");const r=await t.prepare(`
      SELECT * FROM multi_timeframe_indicators 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
...
`,b+=`📝 <b>Reason:</b>
`;const T=String(u.reason).replace(/&/g,"&amp;").replace(/</g,"&lt;").replace(/>/g,"&gt;");b+=T+`

`,b+=`⏰ ${E}`,console.log("[SIMPLE] Sending Telegram message, length:",b.length),f=await Z({botToken:_.telegram_bot_token,chatId:_.telegram_chat_id},b),console.log("[SIMPLE] Telegram sent:",f),f||console.log("[SIMPLE] Telegram send failed - checking response")}else console.log("[SIMPLE] Telegram not configured")}catch(g){console.error("[SIMPLE] Telegram error:",g.message)}return e.json({success:!0,timestamp:new Date().toISOString(),current_price:c,telegram_sent:f,day_trade:{signal_type:u.signal_type,confidence:Number(u.confidence),price:Number(c),stop_loss:Number(u.stop_loss),take_profit_1:Number(u.take_profit_1),take_profit_2:Number(u.take_profit_2),take_profit_3:Number(u.take_profit_3),reason:String(u.reason),trading_style:"day_trade"},swing_trade:{signal_type:m.signal_type,confidence:Number(m.confidence),price:Number(c),stop_loss:Number(m.stop_loss),take_profit_1:Number(m.take_profit_1),take_profit_2:Number(m.take_profit_2),take_profit_3:Number(m.take_profit_3),reason:String(m.reason),trading_style:"swing_trade"}})}catch(r){return console.error("[SIMPLE] Error:",r.message,r.stack),e.json({success:!1,error:r.message,stack:r.stack},500)}});function Aa(e=new Date){const t=e.getUTCHours();return t===8?{hasBoost:!0,boost:8,reason:"London open hour"}:t===13?{hasBoost:!0,boost:7,reason:"NY open hour"}:t>=14&&t<16?{hasBoost:!0,boost:6,reason:"London/NY overlap"}:t>=9&&t<13||t>=16&&t<17?{hasBoost:!0,boost:3,reason:"Active trading hours"}:t>=0&&t<7?{hasBoost:!1,boost:0,reason:"Asia session (low liquidity)"}:t>=18||t<8?{hasBoost:!1,boost:0,reason:"Off hours (reduced activity)"}:{hasBoost:!1,boost:0,reason:"Standard trading hours"}}function Ia(e=new Date){const t=e.getUTCDay(),n=["Sunday","Monday","Tuesday","Wednesday","Thursday","Friday","Saturday"][t];return t>=2&&t<=4?{hasBoost:!0,boost:5,reason:`${n} (optimal trending day)`}:t===1?{hasBoost:!0,boost:2,reason:`${n} (post-weekend momentum)`}:t===5?{hasBoost:!1,boost:0,reason:`${n} (profit-taking day, caution)`}:t===0||t===6?{hasBoost:!1,boost:0,reason:`${n} (market closed)`}:{hasBoost:!1,boost:0,reason:`${n} (standard day)`}}function Da(e,t){return e>t*1.1}function Ma(e){let t=0,s=0,n=0;for(const l of e){const o=l.volume||0;n+=o,l.close>l.open?t+=o:l.close<l.open&&(s+=o)}const a=s>0?t/s:t>0?10:1;let i="NEUTRAL";a>1.5?i="BUYING":a<.67&&(i="SELLING");let r=0;return a>3?r=100:a>1.5?r=50+(a-1.5)/1.5*50:a>.67?r=(a-.67)/.83*50:a>.33?r=50+(.67-a)/.34*50:r=100,{uptickVolume:t,downtickVolume:s,totalVolume:n,pressureRatio:a,signal:i,strength:Math.round(r)}}function Rs(e,t){return t==="BUY"&&e.signal==="BUYING"||t==="SELL"&&e.signal==="SELLING"}function $a(e,t){const n=Rs(e,t)?"✅":"❌";return e.signal==="BUYING"?`${n} Layer 11: Buying pressure ${e.pressureRatio.toFixed(2)}x (${e.strength}/100)`:e.signal==="SELLING"?`${n} Layer 11: Selling pressure ${(1/e.pressureRatio).toFixed(2)}x (${e.strength}/100)`:`${n} Layer 11: Neutral pressure ${e.pressureRatio.toFixed(2)}x (weak)`}function Na(e){if(e.length<3)return[];const t=[],s=e[e.length-3],n=e[e.length-2],a=e[e.length-1];return Fa(a)&&t.push({name:"Hammer",type:"BULLISH_REVERSAL",strength:80,description:"Strong bullish reversal signal",confidence:75}),Oa(a)&&t.push({name:"Shooting Star",type:"BEARISH_REVERSAL",strength:80,description:"Strong bearish reversal signal",confidence:75}),Ca(n,a)&&t.push({name:"Bullish Engulfing",type:"BULLISH_REVERSAL",strength:85,description:"Very strong bullish reversal",confidence:80}),Ba(n,a)&&t.push({name:"Bearish Engulfing",type:"BEARISH_REVERSAL",strength:85,description:"Very strong bearish reversal",confidence:80}),Ua(s,n,a)&&t.push({name:"Morning Star",type:"BULLISH_REVERSAL",strength:90,description:"Major bullish reversal (3-candle)",confidence:85}),Pa(s,n,a)&&t.push({name:"Evening Star",type:"BEARISH_REVERSAL",strength:90,description:"Major bearish reversal (3-candle)",confidence:85}),Ha(s,n,a)&&t.push({name:"Three White Soldiers",type:"BULLISH_CONTINUATION",strength:85,description:"Strong bullish momentum",confidence:80}),ja(s,n,a)&&t.push({name:"Three Black Crows",type:"BEARISH_CONTINUATION",strength:85,description:"Strong bearish momentum",confidence:80}),Wa(a)&&t.push({name:"Doji",type:"INDECISION",strength:50,description:"Market indecision, wait for confirmation",confidence:60}),Ya(a)&&t.push({name:"Spinning Top",type:"INDECISION",strength:50,description:"Market indecision, reduced momentum",confidence:60}),t}function Fa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low,n=e.high-Math.max(e.open,e.close);return s>=t*2&&n<=t*.1&&t>0}function Oa(e){const t=Math.abs(e.close-e.open),s=Math.min(e.open,e.close)-e.low;return e.high-Math.max(e.open,e.close)>=t*2&&s<=t*.1&&t>0}function Ca(e,t){const s=e.close<e.open,n=t.close>t.open;return s&&n&&t.open<e.close&&t.close>e.open}function Ba(e,t){const s=e.close>e.open,n=t.close<t.open;return s&&n&&t.open>e.close&&t.close<e.open}function Ua(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close<e.open,l=s.close>s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close>(e.open+e.close)/2}function Pa(e,t,s){const n=Math.abs(e.close-e.open),a=Math.abs(t.close-t.open),i=Math.abs(s.close-s.open),r=e.close>e.open,l=s.close<s.open;return r&&a<n*.5&&l&&i>n*.6&&s.close<(e.open+e.close)/2}function Ha(e,t,s){const n=e.close>e.open&&t.close>t.open&&s.close>s.open,a=t.high>e.high&&s.high>t.high,i=t.low>e.low&&s.low>t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function ja(e,t,s){const n=e.close<e.open&&t.close<t.open&&s.close<s.open,a=t.high<e.high&&s.high<t.high,i=t.low<e.low&&s.low<t.low,r=Math.abs(e.close-e.open),l=Math.abs(t.close-t.open),o=Math.abs(s.close-s.open),c=e.high-e.low>0?(e.high-e.low)*.3:1;return n&&a&&i&&r>c&&l>c&&o>c}function Wa(e){const t=Math.abs(e.close-e.open),s=e.high-e.low;return s>0&&t<=s*.05}function Ya(e){const t=Math.abs(e.close-e.open),s=e.high-e.low,n=Math.min(e.open,e.close)-e.low,a=e.high-Math.max(e.open,e.close);return s>0&&t>=s*.1&&t<=s*.3&&n>t*.5&&a>t*.5}function Va(e,t){if(e.length===0||t==="HOLD")return{aligned:!1,strongestPattern:null};let s=e[0];for(const n of e)n.strength>s.strength&&(s=n);if(t==="BUY"){const n=e.some(a=>a.type==="BULLISH_REVERSAL"||a.type==="BULLISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}if(t==="SELL"){const n=e.some(a=>a.type==="BEARISH_REVERSAL"||a.type==="BEARISH_CONTINUATION");return{aligned:n,strongestPattern:n?s:null}}return{aligned:!1,strongestPattern:null}}function Ga(e,t){if(e.length<20)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"Insufficient data for zone analysis"};const s=[];if(e.length>=288){const d=e.slice(-288),p=Math.max(...d.map(m=>m.high)),u=Math.min(...d.map(m=>m.low));s.push({level:p,type:"RESISTANCE",strength:85,distance:p-t,distancePercent:(p-t)/t*100}),s.push({level:u,type:"SUPPORT",strength:85,distance:t-u,distancePercent:(t-u)/t*100})}const n=e.slice(-50),a=Zt(n,"HIGH"),i=Zt(n,"LOW");if(a.forEach(d=>{s.push({level:d,type:"RESISTANCE",strength:75,distance:d-t,distancePercent:(d-t)/t*100})}),i.forEach(d=>{s.push({level:d,type:"SUPPORT",strength:75,distance:t-d,distancePercent:(t-d)/t*100})}),qa(t).forEach(d=>{const p=d>t?"RESISTANCE":"SUPPORT";s.push({level:d,type:p,strength:70,distance:Math.abs(d-t),distancePercent:Math.abs(d-t)/t*100})}),e.length>=288){const d=e.slice(-288),p=za(d);s.push({level:p.pp,type:"PIVOT",strength:80,distance:Math.abs(p.pp-t),distancePercent:Math.abs(p.pp-t)/t*100}),s.push({level:p.r1,type:"RESISTANCE",strength:70,distance:p.r1-t,distancePercent:(p.r1-t)/t*100}),s.push({level:p.s1,type:"SUPPORT",strength:70,distance:t-p.s1,distancePercent:(t-p.s1)/t*100})}const l=s.filter(d=>Math.abs(d.distancePercent)<=.5);if(l.length===0)return{nearZone:!1,closestZone:null,zoneType:"NONE",action:"NONE",strength:0,description:"No key zones nearby"};const o=l.reduce((d,p)=>Math.abs(p.distancePercent)<Math.abs(d.distancePercent)?p:d),c=Xa(e,t,o);return{nearZone:!0,closestZone:o,zoneType:o.type,action:c,strength:o.strength,description:Ka(o,c)}}function Zt(e,t){const s=[];for(let i=5;i<e.length-5;i++){const r=t==="HIGH"?e[i].high:e[i].low;let l=!0;for(let o=i-5;o<=i+5;o++){if(o===i)continue;const c=t==="HIGH"?e[o].high:e[o].low;if(t==="HIGH"&&c>=r){l=!1;break}if(t==="LOW"&&c<=r){l=!1;break}}l&&s.push(r)}return Array.from(new Set(s)).slice(-3)}function qa(e){const t=[],s=Math.floor(e/100)*100;t.push(s),t.push(s+100),t.push(s-100);const n=Math.floor(e/50)*50;return t.includes(n)||t.push(n),t.includes(n+50)||t.push(n+50),t.filter(a=>Math.abs((a-e)/e)*100<=2)}function za(e){const t=Math.max(...e.map(c=>c.high)),s=Math.min(...e.map(c=>c.low)),n=e[e.length-1].close,a=(t+s+n)/3,i=2*a-s,r=2*a-t,l=a+(t-s),o=a-(t-s);return{pp:a,r1:i,s1:r,r2:l,s2:o}}function Xa(e,t,s){if(e.length<3)return"NONE";const n=e.slice(-3),a=n[1];if(n[0],!(Math.abs(s.distancePercent)<=.2))return"NONE";if(s.type==="RESISTANCE"){if(t>s.level&&a.close<=s.level)return"BREAKOUT";if(t<s.level&&a.close>=s.level)return"BOUNCE"}if(s.type==="SUPPORT"){if(t<s.level&&a.close>=s.level)return"BREAKOUT";if(t>s.level&&a.close<=s.level)return"BOUNCE"}return"NONE"}function Ka(e,t){const s=e.level.toFixed(2),n=Math.abs(e.distancePercent).toFixed(2);return t==="BREAKOUT"?`${e.type} breakout at $${s} (+${e.strength}/100)`:t==="BOUNCE"?`${e.type} bounce at $${s} (+${e.strength}/100)`:`Near ${e.type} $${s} (${n}% away)`}function Za(e,t){return t==="HOLD"||!e.nearZone?!1:t==="BUY"&&(e.zoneType==="SUPPORT"&&e.action==="BOUNCE"||e.zoneType==="RESISTANCE"&&e.action==="BREAKOUT")||t==="SELL"&&(e.zoneType==="RESISTANCE"&&e.action==="BOUNCE"||e.zoneType==="SUPPORT"&&e.action==="BREAKOUT")}function Qa(e,t){if(e.length<10||t.length<10)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"Insufficient data for divergence",confidence:0};const s=e.slice(-10),n=t.slice(-10),a=Ja(n);if(a.highs.length<2&&a.lows.length<2)return{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No clear swings for divergence",confidence:0};const i=ei(s,a),r=ti(s,a);return i.type!=="NONE"&&r.type===i.type?{type:i.type,category:i.category,indicator:"BOTH",strength:95,description:`${i.type} ${i.category} (RSI+MACD)`,confidence:90}:i.type!=="NONE"?{type:i.type,category:i.category,indicator:"RSI",strength:80,description:`${i.type} ${i.category} (RSI)`,confidence:75}:r.type!=="NONE"?{type:r.type,category:r.category,indicator:"MACD",strength:70,description:`${r.type} ${r.category} (MACD)`,confidence:70}:{type:"NONE",category:"NONE",indicator:"RSI",strength:0,description:"No divergence detected",confidence:0}}function Ja(e){const t=[],s=[];for(let a=2;a<e.length-2;a++){const i=e[a];let r=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].high>=i.high){r=!1;break}r&&t.push({index:a,price:i.high});let l=!0;for(let o=a-2;o<=a+2;o++)if(o!==a&&e[o].low<=i.low){l=!1;break}l&&s.push({index:a,price:i.low})}return{highs:t,lows:s}}function ei(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].rsi,r=e[a.index].rsi;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function ti(e,t){if(t.lows.length>=2){const s=t.lows.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price<n.price&&r>i)return{type:"BULLISH",category:"REGULAR"};if(a.price>n.price&&r<i)return{type:"BULLISH",category:"HIDDEN"}}if(t.highs.length>=2){const s=t.highs.slice(-2),[n,a]=s,i=e[n.index].macd_histogram,r=e[a.index].macd_histogram;if(a.price>n.price&&r<i)return{type:"BEARISH",category:"REGULAR"};if(a.price<n.price&&r>i)return{type:"BEARISH",category:"HIDDEN"}}return{type:"NONE",category:"NONE"}}function si(e,t,s){return t==="HOLD"||e.type==="NONE"?!1:e.category==="REGULAR"&&(e.type==="BULLISH"&&t==="BUY"||e.type==="BEARISH"&&t==="SELL")||e.category==="HIDDEN"&&(e.type==="BULLISH"&&t==="BUY"&&s==="BULLISH"||e.type==="BEARISH"&&t==="SELL"&&s==="BEARISH")}function ni(e,t){if(e.type==="NONE")return"❌ Layer 14: No divergence detected";const s=t?"✅":"⚠️",n=e.type,a=e.category,i=e.indicator;return`${s} Layer 14: ${n} ${a} divergence (${i}, ${e.strength}/100)`}function ai(e,t,s,n){const a=(_,y)=>{const E=parseFloat(String(_));return isNaN(E)?y:E},i=a(e.ema_12,n),r=a(t.ema_26,n),l=a(s.sma_200,n),o=Bt(n,i),c=Bt(n,r),d=Bt(n,l),p=o===c&&c===d&&o!=="NEUTRAL",u=o===c&&o!=="NEUTRAL"||o===d&&o!=="NEUTRAL"||c===d&&c!=="NEUTRAL";let m=0,f="",g="";return p?(m=100,f=`ALL ${o}`,g=`All 3 timeframes ${o.toLowerCase()} (perfect alignment)`):u?(m=65,o===c?(f=`5M+15M ${o}`,g=`5m & 15m ${o.toLowerCase()} (1h ${d.toLowerCase()})`):o===d?(f=`5M+1H ${o}`,g=`5m & 1h ${o.toLowerCase()} (15m ${c.toLowerCase()})`):(f=`15M+1H ${c}`,g=`15m & 1h ${c.toLowerCase()} (5m ${o.toLowerCase()})`)):(m=30,f="MIXED",g=`Mixed signals: 5m ${o.toLowerCase()}, 15m ${c.toLowerCase()}, 1h ${d.toLowerCase()}`),{tf5m:o,tf15m:c,tf1h:d,allAligned:p,twoAligned:u,alignment:f,strength:m,description:g}}function Bt(e,t){const s=(e-t)/t*100;return s>.1?"BULLISH":s<-.1?"BEARISH":"NEUTRAL"}function ii(e,t){return t==="HOLD"?!1:!!(e.allAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH")||e.twoAligned&&(t==="BUY"&&e.tf5m==="BULLISH"||t==="SELL"&&e.tf5m==="BEARISH"))}function ri(e,t){const s=t?"✅":"❌";return e.allAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:e.twoAligned?`${s} Layer 15: ${e.description} (${e.strength}/100)`:`${s} Layer 15: ${e.description}`}function oi(e,t){if(e.length<2)return{dxyPrice:0,dxyChange:0,dxyTrend:"FLAT",goldSignalSupport:"NEUTRAL",correlation:0,strength:0,description:"Insufficient DXY data",dataAge:999};const s=e[e.length-1],n=e[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.1?r="UP":i<-.1&&(r="DOWN");let l="NEUTRAL";r==="DOWN"?l="BULLISH":r==="UP"&&(l="BEARISH");const o=Math.abs(i);let c=-.8,d=0;o>.3?d=90:o>.2?d=75:o>.1?d=60:d=40;const p=new Date(s.timestamp),m=Math.floor((new Date().getTime()-p.getTime())/6e4),f=ci(a,i,r,l,d);return{dxyPrice:a,dxyChange:i,dxyTrend:r,goldSignalSupport:l,correlation:c,strength:d,description:f,dataAge:m}}function li(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function ci(e,t,s,n,a){const i=t>=0?`+${t.toFixed(2)}%`:`${t.toFixed(2)}%`;return e.toFixed(2),s==="DOWN"?`DXY down ${i} → Gold BULLISH (${a}/100)`:s==="UP"?`DXY up ${i} → Gold BEARISH (${a}/100)`:`DXY flat ${i} → Neutral (${a}/100)`}async function di(e){try{const t=`https://api.twelvedata.com/time_series?symbol=DXY&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[DXY] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[DXY] Error fetching DXY data:",t.message),[]}}async function ui(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[DXY] Error storing DXY data:",s.message)}}async function pi(e){try{const t=await e.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!t.results||t.results.length===0?[]:t.results.map(s=>({close:s.close,timestamp:s.timestamp})).reverse()}catch(t){return console.error("[DXY] Error fetching cached DXY data:",t.message),[]}}async function mi(e,t,s=15){const n=await pi(e);if(n.length>0){const i=new Date(n[n.length-1].timestamp),l=(new Date().getTime()-i.getTime())/6e4;if(l<s)return console.log(`[DXY] Using cached data (${l.toFixed(1)}min old)`),n}console.log("[DXY] Fetching fresh DXY data from API...");const a=await di(t);return a.length>0?(await ui(e,a),a):(console.log("[DXY] Fetch failed, using stale cache"),n)}function gi(e,t,s){const n=Qt("Silver (XAG/USD)",e),a=Qt("Crude Oil (WTI)",t);let i=0;n&&kt(n.trend,s)&&i++,a&&kt(a.trend,s)&&i++;let r=0;const l=i>=1;i===2?r=95:i===1?r=70:r=30;const o=fi(n,a,i,s);return{silver:n,oil:a,aligned:l,alignmentCount:i,strength:r,description:o}}function Qt(e,t){if(t.length<2)return null;const s=t[t.length-1],n=t[0],a=s.close,i=(s.close-n.close)/n.close*100;let r="FLAT";i>.2?r="UP":i<-.2&&(r="DOWN");const l=Math.abs(i);let o=0;return l>1?o=90:l>.5?o=75:l>.2?o=60:o=40,{symbol:e,price:a,change:i,trend:r,strength:o}}function kt(e,t){return t==="HOLD"||e==="FLAT"?!1:t==="BUY"&&e==="UP"||t==="SELL"&&e==="DOWN"}function fi(e,t,s,n){if(s===2)return`Silver & Oil both ${n==="BUY"?"up":"down"} (strong confirmation)`;if(s===1){if(e&&kt(e.trend,n))return`Silver ${e.trend.toLowerCase()} confirms Gold ${n}`;if(t&&kt(t.trend,n))return`Oil ${t.trend.toLowerCase()} confirms Gold ${n}`}const a=e?`Silver ${e.trend.toLowerCase()}`:"Silver N/A",i=t?`Oil ${t.trend.toLowerCase()}`:"Oil N/A";return`${a}, ${i} (mixed signals)`}async function _i(e){try{const t=`https://api.twelvedata.com/time_series?symbol=XAG/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[SILVER] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[SILVER] Error fetching Silver data:",t.message),[]}}async function hi(e){try{const t=`https://api.twelvedata.com/time_series?symbol=WTI/USD&interval=5min&outputsize=10&apikey=${e}`,n=await(await fetch(t)).json();return!n.values||n.values.length===0?(console.error("[OIL] No data returned from API"),[]):n.values.map(i=>({close:parseFloat(i.close),timestamp:i.datetime})).reverse()}catch(t){return console.error("[OIL] Error fetching Oil data:",t.message),[]}}async function yi(e,t,s){try{const n=t==="SILVER"?"silver_cache":"oil_cache";await e.prepare(`
    ...
    `).run();for(const a of s)await e.prepare(`
      ...
      DELETE FROM ${n}
      WHERE timestamp < datetime('now', '-1 day')
    `).run()}catch(n){console.error(`[${t}] Error storing data:`,n.message)}}async function bi(e,t){try{const s=t==="SILVER"?"silver_cache":"oil_cache",n=await e.prepare(`
      SELECT timestamp, close
      FROM ${s}
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return!n.results||n.results.length===0?[]:n.results.map(a=>({close:a.close,timestamp:a.timestamp})).reverse()}catch(s){return console.error(`[${t}] Error fetching cached data:`,s.message),[]}}async function Jt(e,t,s,n=15){const a=await bi(e,s);if(a.length>0){const r=new Date(a[a.length-1].timestamp),o=(new Date().getTime()-r.getTime())/6e4;if(o<n)return console.log(`[${s}] Using cached data (${o.toFixed(1)}min old)`),a}console.log(`[${s}] Fetching fresh data from API...`);const i=s==="SILVER"?await _i(t):await hi(t);return i.length>0?(await yi(e,s,i),i):(console.log(`[${s}] Fetch failed, using stale cache`),a)}function Ei(e,t){if(!e)return{currentPosition:null,positioning:"NEUTRAL",goldSignalSupport:"NEUTRAL",strength:0,description:"No COT data available",dataAge:999};const s=new Date(e.timestamp),a=Math.floor((new Date().getTime()-s.getTime())/(1e3*60*60*24));let i="NEUTRAL",r="NEUTRAL",l=50;const o=e.percentile;if(o>=90?(i="EXTREME_BULLISH",r="BULLISH",l=95):o>=70?(i="BULLISH",r="BULLISH",l=80):o<=30?(i="BEARISH",r="BEARISH",l=80):o<=10?(i="EXTREME_BEARISH",r="BEARISH",l=95):(i="NEUTRAL",r="NEUTRAL",l=50),e.largeSpecNet>0){const d=vi(e.largeSpecNet);d>=95?r==="BEARISH"?l+=10:r==="BULLISH"&&(l-=15):d<=5&&(r==="BULLISH"?l+=10:r==="BEARISH"&&(l-=15))}l=Math.min(100,Math.max(0,l));const c=Si(i,o,a);return{currentPosition:e,positioning:i,goldSignalSupport:r,strength:l,description:c,dataAge:a}}function vi(e){return e>1e5?98:e>5e4?85:e>2e4?70:e>0?55:e>-2e4?45:e>-5e4?30:e>-1e5?15:2}function wi(e,t){return t==="HOLD"||e.goldSignalSupport==="NEUTRAL"||e.dataAge>14?!1:t==="BUY"&&e.goldSignalSupport==="BULLISH"||t==="SELL"&&e.goldSignalSupport==="BEARISH"}function Si(e,t,s){const n=s===0?"today":s===1?"1 day ago":`${s} days ago`;return e==="EXTREME_BULLISH"?`COT: Commercials EXTREME LONG (${t}th percentile) - BULLISH [${n}]`:e==="BULLISH"?`COT: Commercials net long (${t}th percentile) - Bullish [${n}]`:e==="EXTREME_BEARISH"?`COT: Commercials EXTREME SHORT (${t}th percentile) - BEARISH [${n}]`:e==="BEARISH"?`COT: Commercials net short (${t}th percentile) - Bearish [${n}]`:`COT: Neutral positioning (${t}th percentile) [${n}]`}async function xi(){return null}async function Ti(e,t){try{await e.prepare(`
    ...
    `).run()}catch(s){console.error("[COT] Error storing COT data:",s.message)}}async function Li(e){try{const t=await e.prepare(`
      SELECT 
        timestamp,
      ...
      ORDER BY timestamp DESC
      LIMIT 1
    `).first();return t?{commercialNet:t.commercialNet,largeSpecNet:t.largeSpecNet,smallSpecNet:t.smallSpecNet,timestamp:t.timestamp,percentile:t.percentile}:null}catch(t){return console.error("[COT] Error fetching cached COT data:",t.message),null}}async function ki(e){const t=await Li(e);if(t){const n=new Date(t.timestamp),i=(new Date().getTime()-n.getTime())/(1e3*60*60*24);if(i<7)return console.log(`[COT] Using cached data (${i.toFixed(1)} days old)`),t}console.log("[COT] Fetching fresh COT data...");const s=await xi();return s?(await Ti(e,s),s):(console.log("[COT] Fetch failed, using stale cache"),t)}function Ri(e){return{commercialNet:5e3,largeSpecNet:-2e3,smallSpecNet:1e3,timestamp:new Date().toISOString(),percentile:50}}const _t=new _e;_t.post("/scan",async e=>{const{DB:t}=e.env;try{console.log("[5M-SCANNER] Step 1: Creating Date object");const s=new Date;console.log("[5M-SCANNER] Step 2: Date object created:",typeof s),console.log("[5M-SCANNER] Step 3: Converting to ISO string");const n=s.toISOString();console.log("[5M-SCANNER] Starting scan at",n),console.log("[5M-SCANNER] Step 4: Creating table"),await t.prepare(`
    ...
    `).all(),r=await t.prepare(`
      ...
      ORDER BY timestamp DESC
      LIMIT 10
    `).all();return e.json({success:!0,stats:{total_scans:(s==null?void 0:s.count)||0,grade_distribution:n.results,session_stats:a.results,best_hours:i.results,recent_a_grade:r.results}})}catch(s){return console.error("[5M-SCANNER] Stats error:",s.message),e.json({success:!1,error:s.message},500)}});_t.get("/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT *
      FROM scanner_history
      ORDER BY timestamp DESC
      LIMIT 100
    `).all();return e.json({success:!0,history:s.results})}catch(s){return e.json({success:!1,error:s.message},500)}});_t.post("/test-alert",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),n={};for(const c of s.results||[])n[c.setting_key]=c.setting_value;if(!n.telegram_bot_token||!n.telegram_chat_id)return e.json({success:!1,error:"Telegram not configured. Please set Bot Token and Chat ID in settings."});const a=4386.5,i=15,r={grade:"A",signal:"BUY",confidence:87,session:"LONDON",layersPassed:6,layers:["✅ Layer 1: Trend Aligned (BULLISH)","✅ Layer 2: RSI 54, MACD bullish crossover","✅ Layer 3: Volume spike 1.9x average","✅ Layer 4: Broke above resistance","✅ Layer 5: Liquidity 89/100 (LONDON session)","✅ Layer 6: No major news","❌ Layer 7: ADX 72.3 (extreme, reversal risk)"],stopLoss:a-i,tp1:a+i*2,tp2:a+i*3,tp3:a+i*4,liquidityScore:89,adx:72.3,rsi:54.2,volumeRatio:1.9},l=As(r,a),o=await Z({botToken:n.telegram_bot_token,chatId:n.telegram_chat_id},l);return e.json({success:o,message:o?"Test A-grade alert sent to Telegram!":"Failed to send alert. Check your Telegram settings."})}catch(s){return console.error("[TEST-ALERT] Error:",s),e.json({success:!1,error:s.message},500)}});async function Ai(e,t,s,n,a,i){console.log("[ANALYZE] Starting analysis");let r=0,l=0;const o=[],c=(Q,Ye)=>{const bt=parseFloat(String(Q));return isNaN(bt)?Ye:bt};console.log("[ANALYZE] parseNum defined");const d={ema20:c(t.ema_12,i),rsi:c(t.rsi_14,50),macd:c(t.macd,0),macd_signal:c(t.macd_signal,0),macd_histogram:c(t.macd_histogram,0),adx:c(t.adx,25)},p={ema50:c(s.ema_26,i)},u={sma200:c(n.sma_200,i)},m=i>d.ema20&&i>p.ema50&&i>u.sma200,f=i<d.ema20&&i<p.ema50&&i<u.sma200;m||f?(r+=20,l++,o.push(`✅ Layer 1: Trend Aligned (${m?"BULLISH":"BEARISH"})`)):o.push("❌ Layer 1: Trend NOT aligned (conflicting)");const g=d.rsi>=40&&d.rsi<=60,_=d.macd>d.macd_signal&&d.macd_histogram>0,y=d.macd<d.macd_signal&&d.macd_histogram<0;g&&(m?_:y)?(r+=15,l++,o.push(`✅ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${m?"bullish":"bearish"} crossover`)):o.push(`❌ Layer 2: RSI ${d.rsi.toFixed(0)}, MACD ${g?"no crossover":"extreme"}`);const E=a.slice(-20).reduce((Q,Ye)=>Q+Ye.volume,0)/20,b=a[a.length-1].volume;b>E*1.5?(r+=15,l++,o.push(`✅ Layer 3: Volume spike ${(b/E).toFixed(1)}x average`)):o.push(`❌ Layer 3: Volume ${(b/E).toFixed(1)}x (need 1.5x+)`);const P=Math.max(...a.slice(-20).map(Q=>Q.high)),S=Math.min(...a.slice(-20).map(Q=>Q.low)),R=i>P*.999,U=i<S*1.001;m&&R||f&&U?(r+=15,l++,o.push(`✅ Layer 4: ${m?"Broke above resistance":"Broke below support"}`)):o.push("❌ Layer 4: No clear breakout"),console.log("[ANALYZE] Layer 5: Calculating liquidity");let O=null;try{O=await xs(a),console.log("[ANALYZE] Liquidity calculated successfully")}catch(Q){console.log("[5M-SCANNER] Liquidity calc failed:",Q)}const x=(O==null?void 0:O.liquidity_score)||50,k=(O==null?void 0:O.session)||"UNKNOWN";x>=70?(r+=15,l++,o.push(`✅ Layer 5: Liquidity ${x}/100 (${k} session)`)):o.push(`❌ Layer 5: Liquidity ${x}/100 (too low)`),console.log("[ANALYZE] Layer 6: Checking economic calendar");const W=ft();console.log("[ANALYZE] Calendar check complete"),W.riskLevel==="safe"?(r+=10,l++,o.push("✅ Layer 6: No major news")):o.push(`❌ Layer 6: ${W.reason}`);const z=d.adx>25,$=d.adx>70;z&&!$?(r+=10,l++,o.push(`✅ Layer 7: ADX ${d.adx.toFixed(1)} (strong trend)`)):$?o.push(`⚠️ Layer 7: ADX ${d.adx.toFixed(1)} (extreme, reversal risk)`):o.push(`❌ Layer 7: ADX ${d.adx.toFixed(1)} (weak trend)`);let G="HOLD";(m||f)&&l>=5&&(G=m?"BUY":"SELL");const le=new Date,D=Aa(le);D.hasBoost?(r+=8,l++,o.push(`✅ Layer 8: ${D.reason} (+${D.boost}% win)`)):o.push(`ℹ️ Layer 8: ${D.reason}`);const Y=Ia(le);Y.hasBoost?(r+=5,l++,o.push(`✅ Layer 9: ${Y.reason} (+${Y.boost}% win)`)):o.push(`ℹ️ Layer 9: ${Y.reason}`);const K=c(t.atr_14,i*.01),L=a.slice(-20).reduce((Q,Ye)=>{const bt=Ye.high-Ye.low;return Q+bt},0)/20;if(Da(K,L)){r+=7,l++;const Q=((K/L-1)*100).toFixed(1);o.push(`✅ Layer 10: ATR expanding ${Q}% (high volatility)`)}else{const Q=((1-K/L)*100).toFixed(1);o.push(`❌ Layer 10: ATR compressed ${Q}% (skip low volatility)`)}const fe=Ma(a.slice(-20));Rs(fe,G)&&fe.strength>=60&&(r+=10,l++),o.push($a(fe,G));const N=Na(a.slice(-3)),{aligned:Se,strongestPattern:C}=Va(N,G);Se&&C?(r+=12,l++,o.push(`✅ Layer 12: ${C.name} (${C.strength}/100)`)):N.length>0&&N[0].type==="INDECISION"?o.push(`⚠️ Layer 12: ${N[0].name} (indecision, wait)`):o.push("❌ Layer 12: No clear candlestick pattern");const A=Ga(a,i);Za(A,G)&&A.nearZone?(r+=8,l++,o.push(`✅ Layer 13: ${A.description}`)):A.nearZone?o.push(`⚠️ Layer 13: ${A.description} (not aligned)`):o.push("ℹ️ Layer 13: No key zones nearby");const ae=(await e.prepare(`
    SELECT rsi_14 as rsi, macd, macd_histogram
    FROM multi_timeframe_indicators
    WHERE timeframe = '5m'
    ORDER BY timestamp DESC
    LIMIT 10
  `).all()).results.map(Q=>({rsi:parseFloat(String(Q.rsi))||50,macd:parseFloat(String(Q.macd))||0,macd_histogram:parseFloat(String(Q.macd_histogram))||0})).reverse(),F=Qa(ae,a.slice(-10)),J=si(F,G,m?"BULLISH":f?"BEARISH":"NEUTRAL");J&&F.strength>=70&&(r+=9,l++),o.push(ni(F,J));const X=ai(t,s,n,i),Yt=ii(X,G);Yt&&(X.allAligned||X.twoAligned)&&(r+=6,l++),o.push(ri(X,Yt));const Dt=await e.prepare(`
    SELECT setting_value FROM user_settings
    WHERE setting_key = 'twelve_data_api_key'
  `).first(),Mt=(Dt==null?void 0:Dt.setting_value)||"70140f57bea54c5e90768de696487d8f",Vs=await mi(e,Mt,15),at=oi(Vs);li(at,G)&&at.strength>=60?(r+=5,l++,o.push(`✅ Layer 18: ${at.description}`)):at.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 18: ${at.description} (not aligned)`):o.push("ℹ️ Layer 18: DXY flat (neutral for Gold)");const Gs=await Jt(e,Mt,"SILVER",15),qs=await Jt(e,Mt,"OIL",15),We=gi(Gs,qs,G);if(We.aligned&&We.alignmentCount>=1){const Q=We.alignmentCount===2?5:3;r+=Q,l++,o.push(`✅ Layer 19: ${We.description} (${We.strength}/100)`)}else o.push(`❌ Layer 19: ${We.description}`);const zs=await ki(e)||Ri(),xe=Ei(zs);if(wi(xe,G)&&xe.strength>=70){const Q=xe.positioning.includes("EXTREME")?7:4;r+=Q,l++,o.push(`✅ Layer 20: ${xe.description} (${xe.strength}/100)`)}else xe.goldSignalSupport!=="NEUTRAL"?o.push(`⚠️ Layer 20: ${xe.description} (not aligned)`):o.push(`ℹ️ Layer 20: ${xe.description}`);let yt="C";r>=162?yt="A+":r>=144?yt="A":r>=126&&(yt="B"),(m||f)&&l>=7&&(G=m?"BUY":"SELL");const Te=Math.max(K*1.5,i*.003),Xs=G==="BUY"?i-Te:i+Te,Ks=G==="BUY"?i+Te*2:i-Te*2,Zs=G==="BUY"?i+Te*3:i-Te*3,Qs=G==="BUY"?i+Te*4:i-Te*4;return{grade:yt,score:r,signal:G,confidence:r,layersPassed:l,layers:o,stopLoss:Xs,tp1:Ks,tp2:Zs,tp3:Qs,liquidityScore:x,session:k,adx:d.adx,rsi:d.rsi,volumeRatio:b/E}}function As(e,t){const s=e.signal==="BUY"?"🟢":"🔴",n=e.grade==="A+"?"💎":e.grade==="A"?"⭐":"📊",a=new Date,i=`${a.getUTCHours().toString().padStart(2,"0")}:${a.getUTCMinutes().toString().padStart(2,"0")}`;let r=`🚨 <b>${e.grade}-GRADE 5M SETUP DETECTED!</b> 🚨
...
`,r+="Next scan in 5 minutes...",r}async function st(e){const t=await e.prepare(`
  ...
  `).first();return t||(await e.prepare(`
    ...
    `).bind(e).first();if(!a)return{success:!1,error:"Trade not found or already closed"};const i=a.trade_type==="BUY"?t-a.entry_price:a.entry_price-t,r=i*a.position_size,l=i/a.entry_price*100,o=r>0?1:0;await n.prepare(`
      ...
      WHERE id = ?
    `).bind(t,new Date().toISOString(),s,r,l,o,e).run();const d=(await st(n)).current_balance+r;return await n.prepare(`
      UPDATE risk_limits
      SET current_balance = ?,
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).bind(d).run(),await $s(n),await Di(n),await Mi(n),{success:!0,profit_loss:r}}catch(a){return{success:!1,error:a.message}}}async function $s(e){const t=await st(e),s=await e.prepare(`
  ...
  `).all();let n=0;for(const i of s.results||[]){const r=i,o=Math.abs(r.entry_price-r.stop_loss)*r.position_size;n+=o}const a=n/t.current_balance*100;await e.prepare(`
    ...
    SET current_portfolio_risk = ?,
        updated_at = CURRENT_TIMESTAMP
    WHERE id = 1
  `).bind(a).run()}async function Di(e){const t=new Date().toISOString().split("T")[0],s=await e.prepare(`
  ...
  `).bind(t).all();if(s.results.length===0)return;const n=s.results,a=n.length,i=n.filter(m=>m.win===1).length,r=n.filter(m=>m.win===0).length,l=i/a*100,o=n.reduce((m,f)=>m+(f.profit_loss||0),0),c=Math.max(...n.map(m=>m.profit_loss||0)),d=Math.min(...n.map(m=>m.profit_loss||0)),p=n.reduce((m,f)=>m+(f.confidence||0),0)/a,u=n.reduce((m,f)=>m+(f.mtf_score||0),0)/a;await e.prepare(`
    ...
    ON CONFLICT(trade_date) DO UPDATE SET
      ...
      updated_at = CURRENT_TIMESTAMP
  `).bind(t,a,i,r,l,o,c,d,p,u).run()}async function Mi(e){const t=await st(e),s=(t.starting_balance-t.current_balance)/t.starting_balance*100,n=new Date().toISOString().split("T")[0],a=await e.prepare(`
  ...
  `).bind(s,i).run();let r=!1,l="";s>=t.max_drawdown_pct?(r=!0,l=`Max drawdown ${s.toFixed(1)}% reached (limit ${t.max_drawdown_pct}%)`):i>=t.max_daily_loss_pct&&(r=!0,l=`Daily loss ${i.toFixed(1)}% reached (limit ${t.max_daily_loss_pct}%)`),r&&t.trading_enabled===1&&await e.prepare(`
    ...
    `).bind(s.max_position_risk_pct||2,s.max_portfolio_risk_pct||10,s.max_daily_loss_pct||5,s.max_drawdown_pct||10).run(),e.json({success:!0,message:"Risk limits updated"})}catch(t){return e.json({success:!1,error:t.message},500)}});me.post("/limits/resume",async e=>{try{const{DB:t}=e.env;return await t.prepare(`
      ...
      SET trading_enabled = 1,
          ...
          updated_at = CURRENT_TIMESTAMP
      WHERE id = 1
    `).run(),e.json({success:!0,message:"Trading resumed"})}catch(t){return e.json({success:!1,error:t.message},500)}});const Me=new _e;Me.get("/events",async e=>{try{const t=parseInt(e.req.query("days")||"7"),s=It(t);return e.json({success:!0,count:s.length,events:s.map(n=>({...n,formatted:xt(n)}))})}catch(t){return e.json({success:!1,error:t.message},500)}});Me.get("/today",async e=>{try{const t=Ra(),s=ft();return e.json({success:!0,date:new Date().toISOString().split("T")[0],event_count:t.length,events:t,trading_safety:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Me.get("/check",async e=>{try{const t=ft(),s=Ts();return e.json({success:!0,timestamp:new Date().toISOString(),should_trade:t.shouldTrade,risk_level:t.riskLevel,reason:t.reason,confidence_adjustment:s.adjustment,upcoming_events:t.upcomingEvents.slice(0,5),next_safe_time:t.nextSafeTime})}catch(t){return e.json({success:!1,error:t.message},500)}});Me.get("/high-risk-days",async e=>{try{const t=new Date,s=[];for(let n=0;n<30;n++){const a=new Date(t.getTime()+n*24*60*60*1e3);ka(a)&&s.push(a.toISOString().split("T")[0])}return e.json({success:!0,count:s.length,high_risk_days:s})}catch(t){return e.json({success:!1,error:t.message},500)}});Me.post("/add-event",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
...
${e.warning?`⚠️ ${e.warning}`:"✅ Valid position"}
  `.trim():`❌ Invalid: ${e.warning}`}const ht=Object.freeze(Object.defineProperty({__proto__:null,calculatePortfolioMetrics:Ni,calculatePositionSize:Os,calculateProfitLoss:Cs,checkDailyLossLimit:$i,formatPositionSize:Fi},Symbol.toStringTag,{value:"Module"}));async function Bs(e,t,s){const n=Date.now(),a=[],i=[];let r=t.starting_balance,l=t.starting_balance;const o=e.filter(D=>{const Y=new Date(D.timestamp);return Y>=new Date(t.start_date)&&Y<=new Date(t.end_date)});if(o.length<200)throw new Error(`Not enough candles for backtest. Need at least 200, got ${o.length}`);const c={current_balance:r,max_daily_loss_pct:2};for(let D=200;D<o.length;D++){const Y=o.slice(D-200,D),K=ve(Y);if(!K)continue;const L=o[D],ge=L.close,fe=ne(ge,K,"day_trade"),j=ne(ge,K,"swing_trade");for(const N of[fe,j]){if(N.signal_type==="HOLD"||N.confidence<t.min_confidence)continue;c.current_balance=r;const Se=Os(c,{entry_price:N.price,stop_loss:N.stop_loss,take_profit_1:N.take_profit_1,take_profit_2:N.take_profit_2,take_profit_3:N.take_profit_3,confidence:N.confidence,signal_type:N.signal_type,trading_style:N.trading_style},s);if(!Se.is_valid)continue;const C=L.timestamp,A=N.price;let V=null,v=null,ae="UNKNOWN";const F=Math.min(50,o.length-D-1);for(let J=1;J<=F;J++){const X=o[D+J];if(N.signal_type==="BUY"){if(X.low<=N.stop_loss){V=N.stop_loss,v=X.timestamp,ae="STOP_LOSS";break}if(X.high>=N.take_profit_3){V=N.take_profit_3,v=X.timestamp,ae="TP3";break}if(X.high>=N.take_profit_2){V=N.take_profit_2,v=X.timestamp,ae="TP2";break}if(X.high>=N.take_profit_1){V=N.take_profit_1,v=X.timestamp,ae="TP1";break}}else{if(X.high>=N.stop_loss){V=N.stop_loss,v=X.timestamp,ae="STOP_LOSS";break}if(X.low<=N.take_profit_3){V=N.take_profit_3,v=X.timestamp,ae="TP3";break}if(X.low<=N.take_profit_2){V=N.take_profit_2,v=X.timestamp,ae="TP2";break}if(X.low<=N.take_profit_1){V=N.take_profit_1,v=X.timestamp,ae="TP1";break}}}if(!V||!v)continue;const je=Cs(A,V,Se.units,N.signal_type,t.commission_per_trade);r+=je.profit_loss,r>l&&(l=r),a.push({entry_time:C,entry_price:A,exit_time:v,exit_price:V,signal_type:N.signal_type,trading_style:N.trading_style,position_size:Se.units,profit_loss:je.profit_loss,profit_loss_pct:je.profit_loss_pct,exit_reason:ae,confidence:N.confidence}),i.push({date:v,balance:r})}}const d=a.filter(D=>D.profit_loss>0),p=a.filter(D=>D.profit_loss<0),u=d.reduce((D,Y)=>D+Y.profit_loss,0),m=Math.abs(p.reduce((D,Y)=>D+Y.profit_loss,0)),f=r-t.starting_balance,g=a.length>0?d.length/a.length*100:0,_=d.length>0?u/d.length:0,y=p.length>0?m/p.length:0,E=d.length>0?Math.max(...d.map(D=>D.profit_loss)):0,b=p.length>0?Math.min(...p.map(D=>D.profit_loss)):0,T=m>0?u/m:u,P=100-g,S=g/100*_-P/100*y;let R=0,U=0,O=t.starting_balance;for(const D of i){D.balance>O&&(O=D.balance);const Y=O-D.balance,K=Y/O*100;Y>R&&(R=Y,U=K)}const x=a.map(D=>D.profit_loss_pct),k=x.reduce((D,Y)=>D+Y,0)/x.length,w=Math.sqrt(x.reduce((D,Y)=>D+Math.pow(Y-k,2),0)/x.length),W=w>0?k/w:0;let re=0,z=0,$=0,G=0;for(const D of a)D.profit_loss>0?($++,G=0,re=Math.max(re,$)):(G++,$=0,z=Math.max(z,G));const le=Date.now()-n;return{config:t,total_trades:a.length,winning_trades:d.length,losing_trades:p.length,win_rate:parseFloat(g.toFixed(2)),net_profit:parseFloat(f.toFixed(2)),total_return_pct:parseFloat((f/t.starting_balance*100).toFixed(2)),avg_win:parseFloat(_.toFixed(2)),avg_loss:parseFloat(y.toFixed(2)),largest_win:parseFloat(E.toFixed(2)),largest_loss:parseFloat(b.toFixed(2)),max_drawdown:parseFloat(R.toFixed(2)),max_drawdown_pct:parseFloat(U.toFixed(2)),profit_factor:parseFloat(T.toFixed(2)),sharpe_ratio:parseFloat(W.toFixed(2)),expectancy:parseFloat(S.toFixed(2)),max_consecutive_wins:re,max_consecutive_losses:z,starting_balance:t.starting_balance,ending_balance:parseFloat(r.toFixed(2)),peak_balance:parseFloat(l.toFixed(2)),trades:a,equity_curve:i,execution_time_ms:le}}function Us(e){return["🎯 BACKTEST RESULTS","","📊 Configuration:",`   Period: ${e.config.start_date} to ${e.config.end_date}`,`   Starting Balance: $${e.starting_balance.toLocaleString()}`,`   Min Confidence: ${e.config.min_confidence}%`,`   Commission: $${e.config.commission_per_trade} per trade`,"","📈 Performance:",`   Total Trades: ${e.total_trades}`,`   Winning Trades: ${e.winning_trades} (${e.win_rate}%)`,`   Losing Trades: ${e.losing_trades}`,`   Net Profit: $${e.net_profit.toLocaleString()} (${e.total_return_pct}%)`,`   Ending Balance: $${e.ending_balance.toLocaleString()}`,"","💰 Profit Metrics:",`   Average Win: $${e.avg_win.toLocaleString()}`,`   Average Loss: $${e.avg_loss.toLocaleString()}`,`   Largest Win: $${e.largest_win.toLocaleString()}`,`   Largest Loss: $${e.largest_loss.toLocaleString()}`,`   Profit Factor: ${e.profit_factor}`,`   Expectancy: $${e.expectancy.toFixed(2)} per trade`,"","⚠️ Risk Metrics:",`   Max Drawdown: $${e.max_drawdown.toLocaleString()} (${e.max_drawdown_pct}%)`,`   Sharpe Ratio: ${e.sharpe_ratio.toFixed(2)}`,`   Max Consecutive Wins: ${e.max_consecutive_wins}`,`   Max Consecutive Losses: ${e.max_consecutive_losses}`,"",`⏱️ Execution Time: ${e.execution_time_ms}ms`].join(`
`)}const Oi=Object.freeze(Object.defineProperty({__proto__:null,formatBacktestResults:Us,runBacktest:Bs},Symbol.toStringTag,{value:"Module"})),nt=new _e;nt.post("/run",async e=>{try{const{DB:t}=e.env,s=await e.req.json(),n=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume
      FROM market_data
      WHERE timeframe = '1h'
      ORDER BY timestamp ASC
    `).all();if(n.results.length<200)return e.json({success:!1,error:`Not enough historical data. Have ${n.results.length} candles, need at least 200. System has been collecting data since Dec 26 - wait a few more days or reduce timeframe.`},400);const a=n.results.map(d=>({timestamp:d.timestamp,open:d.open,high:d.high,low:d.low,close:d.close,volume:d.volume||0})),i={start_date:s.start_date||new Date(Date.now()-365*24*60*60*1e3).toISOString(),end_date:s.end_date||new Date().toISOString(),starting_balance:s.starting_balance||1e4,min_confidence:s.min_confidence||75,use_mtf_confirmation:s.use_mtf_confirmation!==!1,use_news_filter:s.use_news_filter!==!1,timeframe:s.timeframe||"1h",commission_per_trade:s.commission_per_trade||0},l=await Bs(a,i,[{confidence_min:90,confidence_max:100,risk_pct:2,max_position_pct:10},{confidence_min:80,confidence_max:89,risk_pct:1.5,max_position_pct:7.5},{confidence_min:75,confidence_max:79,risk_pct:1,max_position_pct:5},{confidence_min:70,confidence_max:74,risk_pct:.5,max_position_pct:2.5}]),o=await t.prepare(`
...
📅 Backtest ID: ${o.meta.last_row_id}
        `.trim();c=await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},g)}}catch(d){console.error("[BACKTEST] Telegram send failed:",d)}return e.json({success:!0,backtest_id:o.meta.last_row_id,result:l,formatted:Us(l),telegram_sent:c})}catch(t){return console.error("[BACKTEST ERROR]",t),e.json({success:!1,error:t.message},500)}});nt.get("/results",async e=>{try{const{DB:t}=e.env,s=parseInt(e.req.query("limit")||"10"),n=await t.prepare(`
      SELECT 
    ...
    `).first();if(!r)return e.json({ok:!0});const l={botToken:r.setting_value,chatId:a.toString()};if(i.startsWith("/log_trade")){const o=i.split(" ");if(o.length<5)return await Z(l,"❌ Usage: /log_trade <BUY|SELL> <entry> <stop> <tp1>"),e.json({ok:!0});const c=o[1].toUpperCase(),d=parseFloat(o[2]),p=parseFloat(o[3]),u=parseFloat(o[4]),m=await Ds({trade_type:c,trading_style:"day_trade",entry_price:d,entry_time:new Date().toISOString(),position_size:0,position_value:0,stop_loss:p,take_profit_1:u,take_profit_2:u*1.002,take_profit_3:u*1.003,status:"OPEN",confidence:85},t);m.success?await Z(l,`✅ *Trade #${m.trade_id} Logged*

${c} @ $${d}
Stop: $${p}
TP1: $${u}`):await Z(l,`❌ Error: ${m.error}`)}else if(i.startsWith("/close_trade")){const o=i.split(" ");if(o.length<4)return await Z(l,"❌ Usage: /close_trade <id> <exit_price> <reason>"),e.json({ok:!0});const c=parseInt(o[1]),d=parseFloat(o[2]),p=o[3],u=await Ms(c,d,p,t);if(u.success){const m=u.profit_loss||0,f=m>0?"💰":"❌";await Z(l,`${f} *Trade #${c} Closed*

Exit: $${d}
P&L: ${m>0?"+":""}$${m.toFixed(2)}
Result: ${m>0?"WIN ✅":"LOSS ❌"}`)}else await Z(l,`❌ Error: ${u.error}`)}else if(i==="/open"){const o=await Fs(t);if(o.length===0)await Z(l,"📊 No open positions");else{let c=`📊 *Open Positions (${o.length})*

`;for(const d of o)c+=`#${d.id}: ${d.trade_type} @ $${d.entry_price}
`,c+=`Stop: $${d.stop_loss}
`,c+=`TP1: $${d.take_profit_1}

`;await Z(l,c)}}else if(i==="/stats"){const o=await Ns(t);let c=`📊 *Trading Statistics*
...
/help - Show this message`);return e.json({ok:!0})}catch(t){return console.error("[TELEGRAM WEBHOOK] Error:",t),e.json({ok:!0})}});const Hs=new _e;Hs.post("/market-analysis",async e=>{const{DB:t}=e.env;try{console.log("[AI-ANALYSIS] Starting comprehensive market analysis");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key = 'twelve_data_api_key'
    `).all();let n="";for(const x of s.results||[])x.setting_key==="twelve_data_api_key"&&(n=x.setting_value);let a=[];if(n&&n!=="your_api_key_here")try{const x=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,w=await(await fetch(x)).json();w.values&&w.values.length>=50&&(a=w.values.reverse().map(W=>({timestamp:W.datetime,open:parseFloat(W.open),high:parseFloat(W.high),low:parseFloat(W.low),close:parseFloat(W.close),volume:parseFloat(W.volume)||0})),console.log("[AI-ANALYSIS] Fresh data fetched:",a.length,"candles"))}catch{console.error("[AI-ANALYSIS] API fetch failed, falling back to database")}if(a.length===0){const x=await t.prepare(`
        SELECT * FROM market_data 
        WHERE timeframe = '1h'
        ORDER BY timestamp DESC 
        LIMIT 100
      `).all();if(!x.results||x.results.length<50)return e.json({success:!1,error:"Not enough market data available"},400);a=x.results.reverse().map(k=>({timestamp:k.timestamp,open:k.open,high:k.high,low:k.low,close:k.close,volume:k.volume||0}))}const i=ve(a);if(!i)return e.json({success:!1,error:"Failed to calculate indicators"},400);const r=a[a.length-1].close,l=ne(r,i,"day_trade");console.log("[AI-ANALYSIS] Current price:",r,"Signal:",l.signal_type,"Confidence:",l.confidence);const o={};for(const x of["5m","15m","1h","4h","daily"]){const k=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(x).first();k&&(o[x]=k)}const c=jt(o,r),d=a.slice(-50),p=d.map(x=>x.high).sort((x,k)=>k-x),u=d.map(x=>x.low).sort((x,k)=>x-k),m=[Math.max(...p.slice(0,10))],f=[Math.min(...u.slice(0,10))];r>i.sma_20?f.push(i.sma_20):m.push(i.sma_20),r>i.sma_50?f.push(i.sma_50):m.push(i.sma_50),r>i.vwap?f.push(i.vwap):m.push(i.vwap);const g=Math.round(r/10)*10;g>r?m.push(g):f.push(g);const _=[...new Set(m)].sort((x,k)=>x-k).filter(x=>x>r).slice(0,3),y=[...new Set(f)].sort((x,k)=>k-x).filter(x=>x<r).slice(0,3);console.log("[AI-ANALYSIS] Key levels - Support:",y,"Resistance:",_);const E=i.atr_14/r*100;let b="NORMAL";E>3?b="EXTREME":E>1.5?b="HIGH":E<.5&&(b="LOW");const T=[];let P=30,S=30,R=40;c.type==="ALL_BULLISH"?(P=60,S=20,R=20):c.type==="ALL_BEARISH"?(P=20,S=60,R=20):c.score>=4&&(c.trends.filter(x=>x.trend==="BULLISH").length>=4?(P=50,S=25,R=25):(P=25,S=50,R=25)),_.length>0&&T.push({name:"📈 BULLISH CONTINUATION",probability:P,description:`Price breaks above $${_[0].toFixed(2)} and rallies toward $${(_[_.length-1]||r*1.02).toFixed(2)}`,trigger:`Breakout above $${_[0].toFixed(2)} with volume`,target:_[_.length-1]||r*1.02}),y.length>0&&T.push({name:"📉 BEARISH CORRECTION",probability:S,description:`Price breaks below $${y[0].toFixed(2)} and drops toward $${(y[y.length-1]||r*.98).toFixed(2)}`,trigger:`Breakdown below $${y[0].toFixed(2)} with volume`,target:y[y.length-1]||r*.98}),T.push({name:"↔️ CONTINUED RANGING",probability:R,description:`Price oscillates between $${(y[0]||r*.99).toFixed(2)} and $${(_[0]||r*1.01).toFixed(2)} with choppy action`,trigger:b==="EXTREME"?"High volatility continues":"No clear breakout/breakdown",target:null}),T.sort((x,k)=>k.probability-x.probability);let U={action:"WAIT",reason:"Market conditions unclear - wait for better setup",entry_range:null,stop_loss:null};l.confidence>=70?l.signal_type==="BUY"?U={action:"BUY",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${(r-5).toFixed(2)}-${r.toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}:l.signal_type==="SELL"&&(U={action:"SELL",reason:`Strong ${l.signal_type} signal with ${l.confidence}% confidence. ${c.type} MTF alignment.`,entry_range:`${r.toFixed(2)}-${(r+5).toFixed(2)}`,stop_loss:l.stop_loss.toFixed(2)}):b==="EXTREME"?U.reason=`⚠️ EXTREME volatility (ADX ${i.adx.toFixed(1)}) - Too risky to trade. Wait for market to calm down.`:(c.type==="MIXED"||c.type==="CONFLICTING")&&(U.reason=`⏰ Timeframes conflicting (${c.score}/5 aligned). Wait for ${_[0]?`breakout above $${_[0].toFixed(2)}`:y[0]?`breakdown below $${y[0].toFixed(2)}`:"clearer direction"}.`);let O=!1;try{const x=await t.prepare(`
        SELECT setting_key, setting_value FROM user_settings
        WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
      `).all(),k={};for(const w of x.results||[])k[w.setting_key]=w.setting_value;if(k.telegram_bot_token&&k.telegram_chat_id){let w=`🤖 *AI MARKET ANALYSIS*
⏰ ${new Date().toLocaleString("en-US",{timeZone:"UTC"})} UTC

`;w+=`📊 *Current Price:* $${r.toFixed(2)}
`,w+=`📈 *Signal:* ${l.signal_type} (${l.confidence}%)
`,w+=`⚡ *Volatility:* ${b}
`,w+=`🎯 *MTF Alignment:* ${c.type} (${c.score}/5)

`,w+=`🔴 *Resistance:* ${_.map(W=>`$${W.toFixed(2)}`).join(", ")}
`,w+=`🟢 *Support:* ${y.map(W=>`$${W.toFixed(2)}`).join(", ")}

`,w+=`*Scenarios:*
`;for(const W of T)w+=`${W.name} (${W.probability}%)
`;w+=`
💡 *Recommendation:* ${U.action==="WAIT"?"⏰":U.action==="BUY"?"📈":"📉"} ${U.action}
`,w+=`${U.reason}`,O=await Z({botToken:k.telegram_bot_token,chatId:k.telegram_chat_id},w),console.log("[AI-ANALYSIS] Telegram sent:",O)}}catch(x){console.error("[AI-ANALYSIS] Telegram error:",x.message)}return e.json({success:!0,analysis:{timestamp:new Date().toISOString(),current_price:r,signal:l.signal_type,confidence:l.confidence,volatility:b,mtf_alignment:{type:c.type,score:c.score,trends:c.trends},key_levels:{resistance:_,support:y},scenarios:T,recommendation:U,telegram_sent:O}})}catch(s){return console.error("[AI-ANALYSIS] Error:",s.message),e.json({success:!1,error:s.message},500)}});const H=new _e;H.use("/api/*",On());H.route("/api/signals/enhanced",Ls);H.route("/api/signals/simple",ks);H.route("/api/scanner",_t);H.route("/api/trades",me);H.route("/api/calendar",Me);H.route("/api/backtest",nt);H.route("/api/telegram",Ps);H.route("/api/ai",Hs);H.get("/",e=>e.html(`
    <!DOCTYPE html>
    <html lang="en">
    <head>
        <meta charset="UTF-8">
  ...
  `));H.get("/api/signals/recent",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first();return e.json({success:!0,indicators:s})}catch(s){return e.json({success:!1,error:s.message},500)}});H.get("/api/settings",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
    `).all(),n={};for(const a of s.results||[])n[a.setting_key]=a.setting_value;return e.json({success:!0,settings:n})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/settings",async e=>{const{DB:t}=e.env,s=await e.req.json();try{for(const[n,a]of Object.entries(s))await t.prepare(`
        INSERT INTO user_settings (setting_key, setting_value, updated_at)
        VALUES (?, ?, datetime('now'))
        ON CONFLICT(setting_key) 
        DO UPDATE SET setting_value = ?, updated_at = datetime('now')
      `).bind(n,a,a).run();return e.json({success:!0})}catch(n){return e.json({success:!1,error:n.message},500)}});H.post("/api/telegram/test",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
...
✅ Telegram alerts are active.`);return e.json({success:a})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/news/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'news_api_key'
    `).first(),n=(s==null?void 0:s.setting_value)||"";if(!n||n==="your_key_here")return e.json({success:!1,message:"NewsAPI key not configured. Using free tier (100 calls/day)",sentiment:{overall:"neutral",score:0,bullishCount:0,bearishCount:0,neutralCount:0,articles:[]}});const{fetchGoldNews:a,analyzeNewsSentiment:i}=await Promise.resolve().then(()=>Ys),r=await a(n),l=i(r);for(const o of l.articles.slice(0,10))await t.prepare(`
      ...
      VALUES (datetime('now'), ?, ?, ?, ?, ?)
    `).bind(l.overall,l.score,l.bullishCount,l.bearishCount,l.neutralCount).run(),e.json({success:!0,sentiment:l,articleCount:r.length})}catch(s){return e.json({success:!1,error:s.message},500)}});H.get("/api/news/sentiment",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
    ...
    `).first(),n=await t.prepare(`
      ...
      LIMIT 10
    `).all();return e.json({success:!0,sentiment:s||{overall_sentiment:"neutral",sentiment_score:0},articles:n.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});H.get("/api/news/events",async e=>{try{const{getEconomicEvents:t}=await Promise.resolve().then(()=>Ys),s=await t();return e.json({success:!0,events:s})}catch(t){return e.json({success:!1,error:t.message},500)}});H.post("/api/market/fetch",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
      ...
      `).bind(m.timestamp,m.open,m.high,m.low,m.close,m.volume).run(),d++}if(p.length>=50){const u=ve(p.reverse());if(u){await t.prepare(`
        ...
        `).bind(u.rsi_14,u.macd,u.macd_signal,u.macd_histogram,u.sma_20,u.sma_50,u.sma_200,u.ema_12,u.ema_26,u.bb_upper,u.bb_middle,u.bb_lower,u.atr_14,u.stochastic_k,u.stochastic_d,u.adx,u.plus_di,u.minus_di,u.ichimoku_tenkan,u.ichimoku_kijun,u.ichimoku_senkou_a,u.ichimoku_senkou_b,u.parabolic_sar,u.vwap,u.fib_382||0,u.fib_500||0,u.fib_618||0).run();const m=p[p.length-1].close,f=ne(m,u,"day_trade"),g=ne(m,u,"swing_trade"),_=70;for(const y of[f,g])if(y.confidence>=_&&y.signal_type!=="HOLD"){await t.prepare(`
            ...
            `).bind(y.signal_type,y.trading_style,y.price,y.stop_loss,y.take_profit_1,y.take_profit_2,y.take_profit_3,y.confidence,y.reason).run();const E=await t.prepare(`
              SELECT setting_key, setting_value FROM user_settings
              WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
            `).all(),b={};for(const T of E.results||[])b[T.setting_key]=T.setting_value;b.telegram_bot_token&&b.telegram_chat_id&&await Z({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},lt(y))}}}return e.json({success:!0,count:d})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/market/fetch-mtf",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT setting_value FROM user_settings 
      WHERE setting_key = 'twelve_data_api_key'
    `).first();let n=(s==null?void 0:s.setting_value)||"70140f57bea54c5e90768de696487d8f";if(!n||n==="your_key_here"||n==="")return e.json({success:!1,error:"Twelve Data API key not configured.",count:0});const a="XAU/USD",i=[{interval:"5min",dbKey:"5m",outputsize:100},{interval:"15min",dbKey:"15m",outputsize:100},{interval:"1h",dbKey:"1h",outputsize:100},{interval:"4h",dbKey:"4h",outputsize:100},{interval:"1day",dbKey:"daily",outputsize:100}];let r=0;const l={};for(const o of i){const c=`https://api.twelvedata.com/time_series?symbol=${a}&interval=${o.interval}&apikey=${n}&outputsize=${o.outputsize}`,p=await(await fetch(c)).json();if(p.code&&p.status==="error"){l[o.dbKey]={success:!1,error:p.message,count:0};continue}if(!p.values||!Array.isArray(p.values)){l[o.dbKey]={success:!1,error:"No data",count:0};continue}const u=p.values;let m=0;const f=[];for(const g of u){const _={timestamp:g.datetime,open:parseFloat(g.open),high:parseFloat(g.high),low:parseFloat(g.low),close:parseFloat(g.close),volume:0};f.push(_),await t.prepare(`
        ...
        `).bind(_.timestamp,_.open,_.high,_.low,_.close,_.volume,o.dbKey).run(),m++}if(f.length>=50){const g=ve(f.reverse());g&&await t.prepare(`
            ...
            (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
             ...
             parabolic_sar, vwap, fib_382, fib_500, fib_618)
            VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
          `).bind(o.dbKey,g.rsi_14,g.macd,g.macd_signal,g.macd_histogram,g.sma_20,g.sma_50,g.sma_200,g.ema_12,g.ema_26,g.bb_upper,g.bb_middle,g.bb_lower,g.atr_14,g.stochastic_k,g.stochastic_d,g.adx,g.plus_di,g.minus_di,g.ichimoku_tenkan,g.ichimoku_kijun,g.ichimoku_senkou_a,g.ichimoku_senkou_b,g.parabolic_sar,g.vwap,g.fib_382,g.fib_500,g.fib_618).run()}l[o.dbKey]={success:!0,count:m},r+=m,await new Promise(g=>setTimeout(g,500))}return e.json({success:!0,totalCount:r,timeframes:l,message:"Multi-timeframe data fetched successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/signals/generate",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 200
    `).all();if(!s.results||s.results.length<50)return e.json({success:!1,error:"Not enough data. Please fetch market data first (need at least 50 candles)."});const n=s.results.reverse().map(o=>({timestamp:o.timestamp,open:o.open,high:o.high,low:o.low,close:o.close,volume:o.volume})),a=ve(n);if(!a)return e.json({success:!1,error:"Failed to calculate indicators"});const i=n[n.length-1].close,r=ne(i,a,"day_trade"),l=ne(i,a,"swing_trade");return e.json({success:!0,signals:{day_trade:r,swing_trade:l}})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/signals/generate-mtf",async e=>{const{DB:t}=e.env;try{const{analyzeTimeframeAlignment:s,validateMultiTimeframeSignal:n,formatAlignmentReport:a}=await Promise.resolve().then(()=>Ss),i=["5m","15m","1h","4h","daily"],r={};for(const S of i){const R=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(S).first();R&&(r[S]=R)}const l=Object.keys(r).length;if(l<3)return e.json({success:!1,error:`Need at least 3 timeframes. Found: ${l}. Please fetch multi-timeframe data first.`,available:Object.keys(r)});const o=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first();if(!o)return e.json({success:!1,error:"No market data available"});const c=o.close,d=s(r,c),p=r["1h"],u=ne(c,p,"day_trade"),m=ne(c,p,"swing_trade"),f=n(u.signal_type,d),g=n(m.signal_type,d),_={...u,base_confidence:u.confidence,mtf_confidence:f.confidence,final_confidence:Math.min(95,f.confidence),isValid:f.isValid,mtf_reason:f.reason,alignment_score:d.score,alignment_type:d.type,reason:`${u.reason}, MTF: ${f.reason}`},y={...m,base_confidence:m.confidence,mtf_confidence:g.confidence,final_confidence:Math.min(95,g.confidence),isValid:g.isValid,mtf_reason:g.reason,alignment_score:d.score,alignment_type:d.type,reason:`${m.reason}, MTF: ${g.reason}`},E=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),b={};for(const S of E.results||[])b[S.setting_key]=S.setting_value;let T=!1,P=[];b.telegram_bot_token&&b.telegram_chat_id&&(_.isValid&&_.signal_type!=="HOLD"&&await Z({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({..._,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(P.push("day_trade"),T=!0),await new Promise(S=>setTimeout(S,1e3)),y.isValid&&y.signal_type!=="HOLD"&&await Z({botToken:b.telegram_bot_token,chatId:b.telegram_chat_id},`🎯 MULTI-TIMEFRAME CONFIRMED

${lt({...y,timestamp:new Date().toISOString()})}

📊 ${a(d)}`)&&(P.push("swing_trade"),T=!0));for(const S of[_,y])S.isValid&&await t.prepare(`
          ...
          VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
        `).bind(S.signal_type,S.trading_style,S.price,S.stop_loss,S.take_profit_1,S.take_profit_2,S.take_profit_3,S.base_confidence,S.mtf_confidence,S.final_confidence,S.alignment_score,S.alignment_type,S.reason,T?1:0).run();return e.json({success:!0,signals:{day_trade:_,swing_trade:y},alignment:d,alignment_report:a(d),telegram_sent:T,sent_to_telegram:P,available_timeframes:Object.keys(r)})}catch(s){return e.json({success:!1,error:s.message,stack:s.stack},500)}});H.post("/api/signals/generate-now",async e=>{const{DB:t}=e.env;try{console.log("[GENERATE-NOW] Step 1: Fetching FRESH data from Twelve Data API");const s=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
    ...
    `).all();let n="";for(const f of s.results||[])f.setting_key==="twelve_data_api_key"&&(n=f.setting_value);let a,i=!1;if(n&&n!=="your_api_key_here"){console.log("[GENERATE-NOW] Fetching FRESH data from Twelve Data API");try{const f=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=1h&outputsize=100&apikey=${n}`,_=await(await fetch(f)).json();_.values&&_.values.length>=50?(a=_.values.reverse().map(y=>({timestamp:y.datetime,open:parseFloat(y.open),high:parseFloat(y.high),low:parseFloat(y.low),close:parseFloat(y.close),volume:parseFloat(y.volume)||0})),i=!0,console.log("[GENERATE-NOW] ✅ Fresh data fetched! Price:",a[a.length-1].close)):console.log("[GENERATE-NOW] ⚠️ API returned insufficient data, falling back to database")}catch(f){console.error("[GENERATE-NOW] API fetch failed:",f.message)}}if(!a){console.log("[GENERATE-NOW] Using database data (may be stale)");const f=await t.prepare(`
      ...
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),p={};for(const f of d.results||[])p[f.setting_key]=f.setting_value;let u=!1,m=[];p.telegram_bot_token&&p.telegram_chat_id&&(await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...o,timestamp:new Date().toISOString()}))&&(m.push("day_trade"),u=!0),await new Promise(_=>setTimeout(_,1e3)),await Z({botToken:p.telegram_bot_token,chatId:p.telegram_chat_id},lt({...c,timestamp:new Date().toISOString()}))&&(m.push("swing_trade"),u=!0));for(const f of[o,c])await t.prepare(`
        INSERT INTO signals 
        (timestamp, signal_type, trading_style, price, stop_loss, 
         take_profit_1, take_profit_2, take_profit_3, confidence, reason, telegram_sent)
        VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `).bind(f.signal_type,f.trading_style,f.price,f.stop_loss,f.take_profit_1,f.take_profit_2,f.take_profit_3,f.confidence,f.reason,u?1:0).run();return e.json({success:!0,signals:{day_trade:o,swing_trade:c},telegram_sent:u,sent_to_telegram:m})}catch(s){return e.json({success:!1,error:s.message},500)}});H.get("/api/trading/account/:id",async e=>{const{DB:t}=e.env,s=e.req.param("id");try{const n=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(s).first();return n?e.json({success:!0,account:n}):e.json({success:!1,error:"Account not found"},404)}catch(n){return e.json({success:!1,error:n.message},500)}});H.post("/api/trading/calculate-position",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal:a}=s,i=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!i)return e.json({success:!1,error:"Account not found"},404);const r=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = ? AND is_active = 1
      ORDER BY confidence_min DESC
    `).bind(n).all(),{calculatePositionSize:l,formatPositionSize:o}=await Promise.resolve().then(()=>ht),c=l(i,a,r.results);return e.json({success:!0,position:c,formatted:o(c)})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/trading/execute",async e=>{const{DB:t}=e.env;try{const s=await e.req.json(),{account_id:n,signal_id:a,entry_price:i,stop_loss:r,take_profit_1:l,take_profit_2:o,take_profit_3:c,position_size:d,signal_type:p,trading_style:u,confidence:m}=s,f=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = ?
    `).bind(n).first();if(!f)return e.json({success:!1,error:"Account not found"},404);const g=new Date().toISOString().split("T")[0],_=await t.prepare(`
      ...
      AND date(entry_time) = ?
      AND status = 'CLOSED'
    `).bind(n,g).all(),{checkDailyLossLimit:y}=await Promise.resolve().then(()=>ht),E=y(f,_.results);if(E.limit_exceeded)return e.json({success:!1,error:`Daily loss limit exceeded: ${E.current_loss_pct}% (max ${f.max_daily_loss_pct}%)`},400);const b=d*i,T=await t.prepare(`
      INSERT INTO trades (
    ...
    `).bind(n,a||null,p,u,i,d,b,r,l,o,c,m).run();return e.json({success:!0,trade_id:T.meta.last_row_id,message:"Trade executed successfully"})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/trading/close/:trade_id",async e=>{const{DB:t}=e.env,s=e.req.param("trade_id");try{const n=await e.req.json(),{exit_price:a,exit_reason:i}=n,r=await t.prepare(`
      SELECT * FROM trades WHERE id = ?
    `).bind(s).first();if(!r)return e.json({success:!1,error:"Trade not found"},404);if(r.status==="CLOSED")return e.json({success:!1,error:"Trade already closed"},400);const{calculateProfitLoss:l}=await Promise.resolve().then(()=>ht),o=l(r.entry_price,a,r.position_size,r.trade_type,r.commission||0);return await t.prepare(`
      UPDATE trades 
      SET exit_price = ?,
    ...
    `).bind(a,i,o.profit_loss,o.profit_loss_pct,o.pips,s).run(),await t.prepare(`
      ...
      SET current_balance = current_balance + ?,
          updated_at = datetime('now')
      WHERE id = ?
    `).bind(o.profit_loss,r.account_id).run(),e.json({success:!0,profit_loss:o.profit_loss,profit_loss_pct:o.profit_loss_pct,pips:o.pips})}catch(n){return e.json({success:!1,error:n.message},500)}});H.get("/api/trading/trades/open",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1";try{const n=await t.prepare(`
      SELECT * FROM trades 
      WHERE account_id = ? AND status = 'OPEN'
      ORDER BY entry_time DESC
    `).bind(s).all();return e.json({success:!0,trades:n.results||[]})}catch(n){return e.json({success:!1,error:n.message},500)}});H.get("/api/trading/trades/history",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1",n=parseInt(e.req.query("limit")||"50");try{const a=await t.prepare(`
      SELECT * FROM trades 
      WHERE account_id = ?
      ORDER BY entry_time DESC
      LIMIT ?
    `).bind(s,n).all();return e.json({success:!0,trades:a.results||[]})}catch(a){return e.json({success:!1,error:a.message},500)}});H.get("/api/trading/stats",async e=>{const{DB:t}=e.env,s=e.req.query("account_id")||"1";try{const n=await t.prepare(`
      SELECT * FROM trades 
      WHERE account_id = ? AND status = 'CLOSED'
    `).bind(s).all(),{calculatePortfolioMetrics:a}=await Promise.resolve().then(()=>ht),i=a(n.results);return e.json({success:!0,stats:i})}catch(n){return e.json({success:!1,error:n.message},500)}});H.post("/api/trading/backtest",async e=>{var s;const{DB:t}=e.env;try{const n=await e.req.json(),a=await t.prepare(`
      SELECT timestamp, open, high, low, close, volume 
      FROM market_data 
      WHERE timeframe = ?
      ORDER BY timestamp ASC
    `).bind(n.timeframe||"1h").all();if(!a.results||a.results.length<200)return e.json({success:!1,error:`Not enough historical data. Need at least 200 candles, got ${((s=a.results)==null?void 0:s.length)||0}`},400);const i=await t.prepare(`
      ...
      ORDER BY confidence_min DESC
    `).all(),{runBacktest:r,formatBacktestResults:l}=await Promise.resolve().then(()=>Oi),o=await r(a.results,{start_date:n.start_date||"2024-01-01",end_date:n.end_date||new Date().toISOString().split("T")[0],starting_balance:n.starting_balance||1e4,min_confidence:n.min_confidence||75,use_mtf_confirmation:n.use_mtf_confirmation!==!1,use_news_filter:n.use_news_filter!==!1,timeframe:n.timeframe||"1h",commission_per_trade:n.commission_per_trade||0},i.results);return await t.prepare(`
      INSERT INTO backtest_runs (
        run_name, start_date, end_date, starting_balance,
        min_confidence, use_mtf_confirmation, use_news_filter, timeframe,
    ...
    `).bind(n.run_name||`Backtest ${new Date().toISOString()}`,o.config.start_date,o.config.end_date,o.starting_balance,o.config.min_confidence,o.config.use_mtf_confirmation?1:0,o.config.use_news_filter?1:0,o.config.timeframe,o.total_trades,o.winning_trades,o.win_rate,o.net_profit,o.total_return_pct,o.max_drawdown_pct,o.profit_factor,o.sharpe_ratio,JSON.stringify(o.trades),JSON.stringify(o.equity_curve)).run(),e.json({success:!0,result:o,formatted:l(o)})}catch(n){return e.json({success:!1,error:n.message,stack:n.stack},500)}});H.get("/api/trading/backtest/history",async e=>{const{DB:t}=e.env;try{const s=await t.prepare(`
      ...
      ORDER BY created_at DESC 
      LIMIT 20
    `).all();return e.json({success:!0,runs:s.results||[]})}catch(s){return e.json({success:!1,error:s.message},500)}});H.post("/api/automation/analyze-and-notify",async e=>{const{DB:t}=e.env;try{const s={timestamp:new Date().toISOString(),steps:[]};s.steps.push({step:1,name:"Load Cached MTF Data",status:"running"});const n=await t.prepare(`
      SELECT COUNT(*) as count FROM multi_timeframe_indicators 
      WHERE timestamp > datetime('now', '-5 minutes')
    `).first(),a=(n==null?void 0:n.count)>0;let i=0;if(a)i=0,s.steps[0].cached=!0;else{s.steps[0].name="Fetching Fresh MTF Data";const w=await t.prepare(`
        SELECT setting_value FROM user_settings 
        WHERE setting_key = 'twelve_data_api_key'
      `).first(),W=(w==null?void 0:w.setting_value)||"70140f57bea54c5e90768de696487d8f",re=[{interval:"5min",dbKey:"5m"},{interval:"15min",dbKey:"15m"},{interval:"1h",dbKey:"1h"}];for(const z of re)try{const $=`https://api.twelvedata.com/time_series?symbol=XAU/USD&interval=${z.interval}&apikey=${W}&outputsize=50`,G=new AbortController,le=setTimeout(()=>G.abort(),1e4),D=await fetch($,{signal:G.signal});clearTimeout(le);const Y=await D.json();if(Y.values&&Array.isArray(Y.values)){const K=[];for(const L of Y.values)K.push({timestamp:L.datetime,open:parseFloat(L.open),high:parseFloat(L.high),low:parseFloat(L.low),close:parseFloat(L.close),volume:0});for(const L of K)await t.prepare(`
                INSERT INTO market_data (timestamp, open, high, low, close, volume, timeframe)
                VALUES (?, ?, ?, ?, ?, ?, ?)
                ON CONFLICT DO NOTHING
              `).bind(L.timestamp,L.open,L.high,L.low,L.close,L.volume,z.dbKey).run();if(K.length>=30){const L=ve(K.reverse());L&&await t.prepare(`
                  INSERT INTO multi_timeframe_indicators 
                  (timestamp, timeframe, rsi_14, macd, macd_signal, macd_histogram,
                   sma_20, sma_50, sma_200, ema_12, ema_26,
                   bb_upper, bb_middle, bb_lower, atr_14,
                   ...
                   parabolic_sar, vwap, fib_382, fib_500, fib_618)
                  VALUES (datetime('now'), ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
                `).bind(z.dbKey,L.rsi_14,L.macd,L.macd_signal,L.macd_histogram,L.sma_20,L.sma_50,L.sma_200,L.ema_12,L.ema_26,L.bb_upper,L.bb_middle,L.bb_lower,L.atr_14,L.stochastic_k,L.stochastic_d,L.adx,L.plus_di,L.minus_di,L.ichimoku_tenkan,L.ichimoku_kijun,L.ichimoku_senkou_a,L.ichimoku_senkou_b,L.parabolic_sar,L.vwap,L.fib_382,L.fib_500,L.fib_618).run()}i+=Y.values.length}await new Promise(K=>setTimeout(K,100))}catch($){console.error(`[MTF] Error fetching ${z.dbKey}:`,$)}}s.steps[0].status="completed",s.steps[0].data={totalCandles:i},s.steps.push({step:2,name:"Generate MTF Signal",status:"running"});const{analyzeTimeframeAlignment:r,validateMultiTimeframeSignal:l,formatAlignmentReport:o}=await Promise.resolve().then(()=>Ss),c={};for(const w of["5m","15m","1h","4h","daily"]){const W=await t.prepare(`
        SELECT * FROM multi_timeframe_indicators 
        WHERE timeframe = ?
        ORDER BY timestamp DESC 
        LIMIT 1
      `).bind(w).first();W&&(c[w]=W)}const d=await t.prepare(`
      SELECT * FROM market_data 
      WHERE timeframe = '1h'
      ORDER BY timestamp DESC 
      LIMIT 1
    `).first(),p=(d==null?void 0:d.close)||0,u=r(c,p),m=c["1h"],f=ne(p,m,"day_trade"),g=ne(p,m,"swing_trade"),_=l(f.signal_type,u),y=l(g.signal_type,u),E={...f,final_confidence:Math.min(95,_.confidence),isValid:_.isValid,mtf_reason:_.reason,alignment_score:u.score,alignment_type:u.type},b={...g,final_confidence:Math.min(95,y.confidence),isValid:y.isValid,mtf_reason:y.reason,alignment_score:u.score,alignment_type:u.type};s.steps[1].status="completed",s.steps[1].data={dayTrade:E,swingTrade:b,alignment:u},s.steps.push({step:3,name:"Calculate Position Sizes",status:"running"});const T=await t.prepare(`
      SELECT * FROM trading_accounts WHERE id = 1
    `).first(),P=await t.prepare(`
      SELECT * FROM position_sizing_rules 
      WHERE account_id = 1 AND is_active = 1
      ORDER BY confidence_min DESC
    `).all(),{calculatePositionSize:S}=await Promise.resolve().then(()=>ht),R=S(T,{entry_price:E.price,stop_loss:E.stop_loss,take_profit_1:E.take_profit_1,take_profit_2:E.take_profit_2,take_profit_3:E.take_profit_3,confidence:E.final_confidence,signal_type:E.signal_type,trading_style:E.trading_style},P.results),U=S(T,{entry_price:b.price,stop_loss:b.stop_loss,take_profit_1:b.take_profit_1,take_profit_2:b.take_profit_2,take_profit_3:b.take_profit_3,confidence:b.final_confidence,signal_type:b.signal_type,trading_style:b.trading_style},P.results);s.steps[2].status="completed",s.steps[2].data={dayPosition:R,swingPosition:U},s.steps.push({step:4,name:"Send Telegram Alert",status:"running"});const O=await t.prepare(`
      SELECT setting_key, setting_value FROM user_settings
      WHERE setting_key IN ('telegram_bot_token', 'telegram_chat_id')
    `).all(),x={};for(const w of O.results||[])x[w.setting_key]=w.setting_value;let k=!1;if(x.telegram_bot_token&&x.telegram_chat_id){const w=`
...
${u.trends.map(re=>`${re.trend==="BULLISH"?"📈":re.trend==="BEARISH"?"📉":"➡️"} *${re.timeframe}*: ${re.trend} (${re.confidence.toFixed(0)}%)`).join(`
`)}
...
🌐 Dashboard: ${e.req.url.replace("/api/automation/analyze-and-notify","")}
      `.trim();k=await Z({botToken:x.telegram_bot_token,chatId:x.telegram_chat_id},w)}if(s.steps[3].status=k?"completed":"failed",s.steps[3].data={telegramSent:k},E.isValid||b.isValid)for(const w of[E,b])w.isValid&&await t.prepare(`
            INSERT INTO mtf_signals 
            (timestamp, signal_type, trading_style, price, stop_loss, 
             take_profit_1, take_profit_2, take_profit_3, 
             base_confidence, mtf_confidence, final_confidence,
